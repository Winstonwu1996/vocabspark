...
// —— 2026-06 美国史缺口课 ——
import { VIEW as VIETNAM_WAR_VIEW }        from '../data/atlas/views/vietnam-war.js';
import { VIEW as COLD_WAR_HOME_FRONT_VIEW } from '../data/atlas/views/cold-war-home-front.js';
import { VIEW as SPANISH_AMER_WAR_VIEW }   from '../data/atlas/views/spanish-american-war.js';
import { VIEW as ROAD_TO_REVOLUTION_VIEW } from '../data/atlas/views/road-to-revolution.js';
import { VIEW as COLONIAL_AMERICA_VIEW }   from '../data/atlas/views/colonial-america.js';
import { VIEW as EARLY_REPUBLIC_VIEW }     from '../data/atlas/views/early-republic.js';
...
export const ALL_VIEWS = [
  ...
  // 美国史缺口课 (2026-06)
  ROAD_TO_REVOLUTION_VIEW, COLONIAL_AMERICA_VIEW, EARLY_REPUBLIC_VIEW, SPANISH_AMER_WAR_VIEW,
  COLD_WAR_HOME_FRONT_VIEW, VIETNAM_WAR_VIEW,
];
...
export async function getEffectiveKeyFigures(view) {
  ...
  try {
    ...
    // STORYBOARDS 已改为按需 loader（见该文件顶部）——这里改成显式预加载取模块
    var storyboardModule = await mod.preloadStoryboard(historyTopicId);
