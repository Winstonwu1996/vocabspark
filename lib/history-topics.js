...
export var CRUSADES_1099 = {
  ...
  geography: {
    ...
    // 5-5: 暂用 europe-1200 共用地图(europe-1099.svg + middle-east-modern.svg 未画)
    // 用户来 atlas → role 进入,深度地图已在 atlas-lab/[topicId] 看过——history 这里不再重画
    primaryMap: "europe-1200",
    flipMap: null,
...
export var BLACK_DEATH_1347 = {
  ...
  geography: {
    ...
    primaryMap: "europe-1200",
    flipMap: null,           // europe-modern 已存在,但黑死病的故事不需要"翻到今天"
