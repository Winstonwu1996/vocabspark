    ...
    primarySources: [
      {
        ...
        enSimplified: "It is not enough that we drove out the men who spilled our blood for two hundred years. With one last act as a nation, we must make liberty permanent in the land where we were born. \u2014 Jean-Jacques Dessalines, 1 January 1804",
        cnGloss: "「把两百年来血洗这片土地的人赶出去，还不够\u2026\u2026我们必须用最后一次国家行动，"
          + "在我们出生的这片土地上，永远确立自由的领域。」\u2014\u2014 让-雅克·德萨林，1804 年 1 月 1 日\n\n"
          + "\u2014\u2014 你刚读到「我们赢了、把殖民地名字扔掉、换回这片土地最早的名字」，"
          + "指的就是这一天。**这是世界历史上唯一一次，被奴役者自己打赢、自己建国。**\n"
          + "注意它和 1789 年法国那句「人生而自由」的关系：那句话是别人写的、没打算算上他们；"
          + "这句话是他们自己写的。",
        keyTerms: [
          { word: "expel", cn: "驱逐、赶出去", etym: "ex-(向外)+pel(推) \u2014 推出去" },
          { word: "liberty", cn: "自由", etym: "跟 freedom 常混用；这里指政治意义上的「不受奴役」" },
          { word: "declaration of independence", cn: "独立宣言", etym: "跟美国 1776 那份是同一种文体 \u2014 可以对照读" },
          { word: "national authority", cn: "国家权力", etym: "关键在「国家」\u2014 他们不只是造反，是建国" },
        ],
    ...
    primarySources: [
      {
        ...
        en: "At what age did you first go to work in one? \u2014 Eight.\n"
          + "Will you state the hours of labour at the period when you first went to the factory? \u2014 From 6 in the morning to 8 at night.\n"
          + "Fourteen hours? \u2014 Yes.\n"
        ...
        cnGloss: "「你第一次进工厂几岁？——八岁。」\n"
          + "「工作时间？——早上六点到晚上八点。」「十四个小时？——是。」\n"
          + "「就算监工本性善良，也仍然必须打孩子吗？——是的。机器一天出定量的活，孩子必须跟上机器。"
          + "所以监工再善良，也得催他们；而他通常用的办法，就是在他们犯困的时候用皮带抽。」\n\n"
          + "\u2014\u2014 你刚才读到 Ellen 背上挨的那一下，就是这句话里的 strap。这不是故事，是 1832 年一个 22 岁的人在议会上说的话。",
        keyTerms: [
          { word: "overlooker", cn: "监工", etym: "over(在上)+look(看)+er(人) \u2014 站在上面盯着人干活的" },
          { word: "strap", cn: "皮带；用皮带抽", etym: "既是名词（皮带）也是动词（抽打）" },
          { word: "drowsy", cn: "昏昏欲睡的", etym: "困得睁不开眼，但还没睡着" },
          { word: "testimony", cn: "证词", etym: "test(见证)+mony \u2014 在正式场合作证说的话" },
        ],
        image: {
          ...
          captionCn: "\u26a0\ufe0f 注意时间地点：这不是 Ellen。摄影术 1839 年才出现，"
            + "1832 年的英国工厂没有留下照片。这张是 1909 年美国佐治亚州一家棉纺厂的纺纱女童，"
            + "Lewis Hine 摄。晚了 77 年、隔了一个大洋 \u2014\u2014 同样的活，同样的年纪。",
    ...
    primarySources: [
      {
        ...
        cnGloss: "「兹授权陆军部长\u2026\u2026划定军事区域\u2026\u2026得将任何人或所有人排除在外；"
          + "任何人进入、留在或离开该区域的权利，均须服从陆军部长或相应军事指挥官自行裁量施加的任何限制。」"
          + "\u2014\u2014 富兰克林·罗斯福\n\n"
          + "读一遍你会发现：**这份命令里没有出现「日本」两个字**，也没有「日裔」。"
          + "它只说「任何人或所有人」。正是这种不点名，让它看起来像一条中立的战时措施 \u2014\u2014 "
          + "而执行下去，被装进火车的是十二万日裔，其中三分之二是美国公民。",
        keyTerms: [
          { word: "authorize", cn: "授权", etym: "author(创设者)+ize \u2014 给某人「可以这么做」的正式权力" },
          { word: "exclude", cn: "排除；把\u2026\u2026赶出去", etym: "ex-(向外)+clude(关) \u2014 关在外面" },
          { word: "discretion", cn: "自行裁量（想怎么定就怎么定）", etym: "这个词是这份命令里最要命的一个" },
          { word: "military area", cn: "军事区域", etym: "命令没写是哪儿 \u2014 留给执行者去划" },
        ],
        image: {
          ...
          captionCn: "1942 年，加州街角贴出的「第 5 号平民排斥令」\u2014\u2014 "
            + "你上一节读到的「墙上贴出告示」，就是这个东西。注意它的样子：白纸黑字、"
            + "公文格式、盖着章。**它不是暴徒写的，它是政府发的。**",
    ...
    primarySources: [
      {
        ...
        cnGloss: "「人生而自由，并且在权利上始终平等。社会差别只能建立在公共利益之上。」\n\n"
          + "\u2014\u2014 这句话 1789 年 8 月在巴黎写下时，Saint-Domingue 岛上有大约五十万被奴役的人。"
          + "写这句话的人，没有把他们算进「人」里面。\n"
          + "你刚读到的这个人（Toussaint），识字，读到了这张纸。他要做的事，"
          + "是把写这句话的人**没打算给他的那部分**，自己拿回来。",
        keyTerms: [
          { word: "declaration", cn: "宣言", etym: "de-(彻底)+clare(清楚) \u2014 公开讲清楚的正式声明" },
          { word: "equal in rights", cn: "权利上平等", etym: "注意是「权利平等」，不是「境遇平等」" },
          { word: "common good", cn: "公共利益", etym: "留一道口子 \u2014 谁来定义什么算「公共」？" },
        ...
        image: {
          ...
          captionCn: "\u26a0\ufe0f 这是 1870 年美国底特律印制的杜桑肖像石版画 \u2014\u2014 "
            + "印制时他已去世 67 年。当年没有他的照片，所有「杜桑长什么样」都是后人根据描述画的。"
            + "这张由废奴运动者 George DeBaptiste 出版，本身就是一份史料：它告诉你半个多世纪后，"
            + "美国的黑人废奴者仍然把他当旗帜。",
