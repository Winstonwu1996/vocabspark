...
export var buildPreviewTopic = function(id) {
  var meta = PREVIEW_TOPIC_META[id];
  if (!meta) return null;
  return {
    id: id,
    title: { en: meta.titleEn, cn: meta.titleCn },
    oneLineHook: { cn: meta.hook },
    curriculumUnit: meta.unit,
    hssStandard: meta.hss,
    year: meta.year,
    difficulty: 3,
    throughLine: "",
    estimatedMinutes: 25,
    ...
    isPreview: true,            // 标记：Gate 3 hidden preview → 跳过 mastery
    mustMemorize: { vocab: [], concepts: [] },
    conversationTurns: [],
    xpRewards: { base: 0, perVocabPass: 0, perConceptPass: 0, perApplicationPass: 0 },
  };
};
