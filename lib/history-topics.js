...
// 轻量标题索引（8KB）——课程列表只需标题，不必把 3.5MB 笔记本拖进包。见该文件顶部说明。
import { NOTEBOOK_NAMES } from './history-storyboards/notebooks/light-index.js';
...
export var THROUGH_LINES = {
  ...
  "civilization-peak-collapse": { en: "Civilization: Peak & Collapse", cn: "文明的巅峰与衰落", color: "#b5654d" },
  "encounter-vs-conquest":      { en: "Encounter vs Conquest",         cn: "相遇还是征服",     color: "#6b8e9b" },
  "imperial-projection":        { en: "Imperial Power & Prestige",     cn: "帝国的声望与影响", color: "#c39b4e" },
  // ── 全量上线分组 (2026-05-24, 按年代分组, 待线上细化) ──
  "ancient-civ":        { en: "Ancient Civilizations",   cn: "古代文明",       color: "#b8935f" },
  "medieval-world":     { en: "Medieval World",          cn: "中世纪与世界",   color: "#7a9b76" },
  "early-modern":       { en: "Early Modern & Ideas",    cn: "近代早期与思想", color: "#9a7bb0" },
  "us-history":         { en: "U.S. History",            cn: "美国史",         color: "#5b8db8" },
  "modern-world":       { en: "Modern World",            cn: "近现代世界",     color: "#c46b30" },
};
...
export var TOPIC_REGISTRY = [
  ...
  // ═══ 全量上线 (2026-05-24): 33 个 Gate-3 验证过的 topic 全部 available。按年代分组, 线上看后再细化 ═══
  // 古代文明
  { id: "ancient-egypt-2550bce",    available: true, order: 10, throughLine: "ancient-civ",   note: "古埃及大金字塔 — G6 古代史", narrativeRequired: true },
  { id: "hammurabi-code-1754bce",   available: true, order: 11, throughLine: "ancient-civ",   note: "汉谟拉比法典 — G6 古代史", narrativeRequired: true },
  { id: "babylonian-exile-586bce",  available: true, order: 12, throughLine: "ancient-civ",   note: "巴比伦之囚 — G6 古代史", narrativeRequired: true },
  { id: "ancient-greece-480bce",    available: true, order: 13, throughLine: "ancient-civ",   note: "希波战争与雅典民主 — G6 古代史", narrativeRequired: true },
  { id: "mauryan-india-261bce",     available: true, order: 14, throughLine: "ancient-civ",   note: "阿育王与羯陵伽 — G6 古代史", narrativeRequired: true },
  { id: "qin-china-221bce",         available: true, order: 15, throughLine: "ancient-civ",   note: "秦统一中国 — G6 古代史", narrativeRequired: true },
  { id: "roman-republic-fall-44bce",available: true, order: 16, throughLine: "ancient-civ",   note: "罗马共和国崩溃 — G6 古代史", narrativeRequired: true },
  // 中世纪与世界
  { id: "byzantine-rise",           available: true, order: 20, throughLine: "medieval-world", note: "拜占庭崛起", narrativeRequired: true },
  { id: "islamic-rise",             available: true, order: 21, throughLine: "medieval-world", note: "伊斯兰文明兴起", narrativeRequired: true },
  { id: "mongol-empire",            available: true, order: 22, throughLine: "medieval-world", note: "蒙古帝国", narrativeRequired: true },
  { id: "medieval-japan",           available: true, order: 23, throughLine: "medieval-world", note: "中世纪日本", narrativeRequired: true },
  { id: "pre-columbian",            available: true, order: 24, throughLine: "medieval-world", note: "前哥伦布美洲", narrativeRequired: true },
  // 近代早期与思想
  { id: "scientific-revolution",    available: true, order: 30, throughLine: "early-modern",   note: "科学革命", narrativeRequired: true },
  { id: "enlightenment",            available: true, order: 31, throughLine: "early-modern",   note: "启蒙运动", narrativeRequired: true },
  // 美国史
  { id: "constitutional-convention-1787", available: true, order: 40, throughLine: "us-history", note: "费城制宪 — Gate3 样板", narrativeRequired: true },
  { id: "hamilton-jefferson-1790s", available: true, order: 41, throughLine: "us-history",     note: "建国财政与党争", narrativeRequired: true },
  { id: "jackson-indian-removal-1830", available: true, order: 42, throughLine: "us-history",  note: "杰克逊与印第安人迁移", narrativeRequired: true },
  { id: "slavery-abolition-1850",   available: true, order: 43, throughLine: "us-history",     note: "奴隶制与废奴", narrativeRequired: true },
  { id: "civil-war-1861",           available: true, order: 44, throughLine: "us-history",     note: "南北战争", narrativeRequired: true },
  { id: "reconstruction-1877",      available: true, order: 45, throughLine: "us-history",     note: "重建与背叛", narrativeRequired: true },
  { id: "chinese-exclusion-1882",   available: true, order: 46, throughLine: "us-history",     note: "铁路华工与排华法案 — dark 边界验证", narrativeRequired: true },
  { id: "gilded-age-1890",          available: true, order: 47, throughLine: "us-history",     note: "镀金时代与劳工", narrativeRequired: true },
  { id: "progressive-era-1910",     available: true, order: 48, throughLine: "us-history",     note: "进步时代", narrativeRequired: true },
  { id: "womens-suffrage-1920",     available: true, order: 49, throughLine: "us-history",     note: "妇女选举权", narrativeRequired: true },
  { id: "great-depression-1933",    available: true, order: 50, throughLine: "us-history",     note: "大萧条与新政", narrativeRequired: true },
  { id: "civil-rights-1965",        available: true, order: 51, throughLine: "us-history",     note: "民权运动", narrativeRequired: true },
  // 近现代世界
  { id: "french-revolution-1789",   available: true, order: 60, throughLine: "modern-world",   note: "法国大革命与拿破仑", narrativeRequired: true },
  { id: "industrial-revolution-1800",available: true, order: 61, throughLine: "modern-world",  note: "工业革命", narrativeRequired: true },
  { id: "scramble-for-africa-1884", available: true, order: 62, throughLine: "modern-world",   note: "瓜分非洲", narrativeRequired: true },
  { id: "world-war-one-1914",       available: true, order: 63, throughLine: "modern-world",   note: "第一次世界大战", narrativeRequired: true },
  { id: "world-war-two-1942",       available: true, order: 64, throughLine: "modern-world",   note: "二战与大屠杀 — dark 边界验证", narrativeRequired: true },
  { id: "decolonization-1960",      available: true, order: 65, throughLine: "modern-world",   note: "去殖民化与不结盟", narrativeRequired: true },
  { id: "cold-war-1962",            available: true, order: 66, throughLine: "modern-world",   note: "冷战", narrativeRequired: true },
  // ── 全覆盖第一批 (2026-05-25): atlas-only → 补 history 深度学课 ──
  { id: "roman-empire-peak-117",    available: true, order: 17, throughLine: "ancient-civ",   note: "罗马帝国巅峰 (Pax Romana) — 区别于罗马共和国崩溃", narrativeRequired: true },
  { id: "gunpowder-empires-1600",   available: true, order: 35, throughLine: "early-modern",  note: "火药帝国 (奥斯曼/萨非/莫卧儿) — AP World U3", narrativeRequired: true },
  { id: "manifest-destiny-1845",    available: true, order: 42, throughLine: "us-history",     note: "昭昭天命与西扩 (墨美战争/瓜分墨西哥)", narrativeRequired: true },
  { id: "reform-movements-1840",    available: true, order: 43, throughLine: "us-history",     note: "改革运动时代 (废奴/女权/禁酒/教育)", narrativeRequired: true },
  // ── 全覆盖第二批 (2026-05-25) ──
  { id: "han-china-130bce",         available: true, order: 18, throughLine: "ancient-civ",   note: "汉朝盛世 (汉武帝/丝绸之路/独尊儒术) — 区别于秦统一", narrativeRequired: true },
  { id: "thirteen-colonies-1700",   available: true, order: 38, throughLine: "us-history",     note: "十三殖民地 (三区域/契约奴→奴隶制)", narrativeRequired: true },
  { id: "american-revolution-1776", available: true, order: 39, throughLine: "us-history",     note: "美国独立战争 (独立宣言/被排除的人)", narrativeRequired: true },
  { id: "westward-expansion-1869",  available: true, order: 52, throughLine: "us-history",     note: "西进运动 (横贯铁路/平原战争) — 区别于昭昭天命 1840s", narrativeRequired: true },
  // ── 全覆盖第三批 (2026-05-25): 最后 2 门 (最难格式化的) ──
  { id: "native-americans-pre1500", available: true, order: 25, throughLine: "medieval-world", note: "北美原住民文明 (Haudenosaunee/great dying) — 区别于 pre-columbian 中美洲", narrativeRequired: true },
  { id: "globalization-1995",       available: true, order: 67, throughLine: "modern-world",   note: "全球化 (WTO/供应链/Rana Plaza) — AP World U9", narrativeRequired: true },

  // ─── 下一轮内容路线图 (升学规划专家 2026-05-25 覆盖度审计标出的 4 个真实缺口) ───
  // 不阻塞当前上线; available:false 让它们出现在 ThroughLineView 的「🔒 即将上线」区,
  // 家长能看到我们的承诺。新课上线只需 flip available:true + 接 storyboard/notebook/narrative。
  { id: "haitian-revolution-1791", available: true, order: 60, throughLine: "modern-world", note: "海地革命 — AP World U5 高频考点(2024 真题), 革命三角链上的关键空缺", narrativeRequired: true },
  { id: "meiji-restoration-1868",  available: true, order: 61, throughLine: "modern-world", note: "明治维新 — AP World U6 亚洲学生必考点; 跟洋务运动对照非常强", narrativeRequired: true },
  { id: "russian-revolution-1917", available: true, order: 62, throughLine: "modern-world", note: "俄国革命 — AP World U7 / APUSH P7, 现在被 WWII 课捎带, 应独立成课", narrativeRequired: true },
  { id: "contemporary-us-1980",    available: true, order: 70, throughLine: "us-history",   note: "Reagan / 911 / Obama 当代美国 — APUSH P9 占比小(~5%)但是断层", narrativeRequired: true },
  // ─── 2026-06 World 缺口新课 (审计 §1.4 只投世界史; Codex #7/#10 + CA G6 古代文明) ───
  { id: "trade-networks-1200",     available: true, order: 71, throughLine: "medieval-world", note: "丝路·印度洋·跨撒哈拉贸易网络 — AP World U2 最大结构缺口, 印度洋圈线上全空白", narrativeRequired: true },
  { id: "asian-imperialism-1839",  available: true, order: 72, throughLine: "modern-world",  note: "鸦片战争与英属印度 — AP World U6 必考, 华裔关联最强 (中国近代史开端)", narrativeRequired: true },
  { id: "mesopotamia-3500bce",     available: true, order: 73, throughLine: "ancient-civ",   note: "两河·苏美尔文明起点 — CA 6.2; 现仅 hammurabi 法典切片, 缺文明起源整体", narrativeRequired: true },
  { id: "indus-valley-2600bce",    available: true, order: 74, throughLine: "ancient-civ",   note: "印度河·哈拉帕 — CA 6.5 古印度起点; 现只有 mauryan(前261), 独缺印度河", narrativeRequired: true },
  { id: "early-humans-10000bce",   available: true, order: 75, throughLine: "ancient-civ",   note: "早期人类与新石器革命 — CA 6.1 古代轨开篇, 整条古代轨原缺开篇", narrativeRequired: true },
  { id: "ancient-israel-1000bce",  available: true, order: 76, throughLine: "ancient-civ",   note: "古以色列与一神教起源 — CA 6.3 独立单元, 宗教 through-line 源头", narrativeRequired: true },
  // —— 2026-06 World [med] 缺口课 (续) ——
  { id: "gupta-india-320",         available: true, order: 77, throughLine: "ancient-civ",   note: "笈多王朝·印度黄金时代 — CA 6.5; 古典印度断在 Mauryan, 补黄金时代", narrativeRequired: true },
  { id: "persian-empire-550bce",   available: true, order: 78, throughLine: "ancient-civ",   note: "波斯帝国·阿契美尼德 — 古典帝国行政, 与秦汉郡县制强对照", narrativeRequired: true },
  { id: "latin-american-independence-1810", available: true, order: 79, throughLine: "modern-world", note: "拉美独立 — AP World U5 革命链补角 (Bolívar/San Martín)", narrativeRequired: true },
  { id: "interwar-totalitarianism-1919", available: true, order: 80, throughLine: "modern-world", note: "战间期与极权兴起 — AP World U7, 填 WWI→WWII 因果断档", narrativeRequired: true },
  // —— 2026-06 美国史缺口课 (APUSH P2-P8, 创始人破例) ——
  { id: "road-to-revolution-1763",  available: true, order: 81, throughLine: "us-history", note: "通往独立之路 — APUSH P3; 补 thirteen-colonies→american-revolution 间「革命无因」", narrativeRequired: true },
  { id: "colonial-america-1650",    available: true, order: 82, throughLine: "us-history", note: "殖民地美洲成形 — APUSH P2; 三角贸易/大觉醒/Bacon, 深化 P2", narrativeRequired: true },
  { id: "early-republic-1800",      available: true, order: 83, throughLine: "us-history", note: "早期共和国 — APUSH P4; 补 Jefferson→Jackson 断层", narrativeRequired: true },
  { id: "spanish-american-war-1898", available: true, order: 84, throughLine: "us-history", note: "美西战争与海外帝国 — APUSH P7; 门户开放桥接瓜分中国", narrativeRequired: true },
  { id: "cold-war-home-front-1950", available: true, order: 85, throughLine: "us-history", note: "冷战国内战线 — APUSH P8; 麦卡锡主义+郊区化, 呼应排华史", narrativeRequired: true },
  { id: "vietnam-war-1965",         available: true, order: 86, throughLine: "us-history", note: "越战与 1960s-70s 动荡 — APUSH P8 最大空白", narrativeRequired: true },
];
...
export var TANG_SONG_CHINA = {
  ...
  mustMemorize: {
    ...
    concepts: [
      ...
      {
        // 5-26 (Codex P1): 概念名 + 定义改 within-Topic — 原 cross-Topic 假设学过 Mali/Renaissance/
        // Reformation/AoE 4 课对照, lens-based 一次学一个 topic 不合理。题面、概念名、标准定义三处
        // 同步 within-topic 化,避免 GPT 评估器按跨 topic 定义误判学生的「徽宗集中 / 李清照分散」回答。
        // conceptId 保留(避免 reviewPool 等他处引用断裂),只改展示名 + 定义。
        id: "five-topic-information-preservation",
        en: "Information preservation: concentration vs dispersal",
        ipa: "",
        cn: "信息保存:集中 vs 分散",
        definition: {
          en: "Tang-Song shows two opposite ways to preserve a precious collection. Concentration: Huizong amassed 6,396 paintings + 1,344 calligraphy works in the Hanlin Art Academy at Kaifeng — when the Jurchen Jin army fell on the city in 1126, the entire collection was lost in one night. Dispersal: Li Qingzhao spent 1129-1135 carrying her late husband's *Records on Metal and Stone* southward across war zones, losing pieces along the way but saving a significant portion. Same decade, same fate of preserving Song-era artifacts, two opposite strategies — concentration fails to one catastrophe, dispersal accepts losses but survives.",
          cn: "唐宋这一课呈现了两种相反的「保收藏」做法。集中:徽宗在开封翰林图画院攒了 6,396 幅画 + 1,344 件书法,1126 年金军一夜陷开封时整库一次性全失。分散:李清照 1129-1135 拼命把丈夫赵明诚的《金石录》南运过战区,沿途丢了不少但保下了相当大一部分。同一个十年、同样要保宋代文物的命题,两种相反的策略——集中败给一次灾难,分散接受损耗但活了下来。"
        }
      },
    ]
  },
  ...
  masteryChecks: {
    required: [
      ...
      },
      {
        type: "definition",
        items: [
          { conceptId: "joseph-needham-question",      prompt: "Joseph Needham 在问什么？用一句话答就行（想想 Huizong 那一节末尾说的「中国领先 600 年却没催生工业革命」）。\n\n如果还有力气，再举：①唐宋领先的一个发明 ②欧洲后来反超的一个原因（各一个就够）。" },
          { conceptId: "five-topic-information-preservation", prompt: "唐宋这一课里出现了两种「信息保存」的对照:一种是把所有好东西集中藏在一个地方,另一种是拼命分散往各地搬。\n\n哪个人代表哪一种?最后哪一种保下来的东西更多?" },
        ]
      },
      {
        type: "application",
        items: [
          { prompt: "想想 Huizong 1126 那一夜全失,跟李清照 1129-1135 拼命南运。\n\n你的某个珍贵东西(可以是回忆、可以是作品、可以是一段对话)——你会选「集中收好」还是「分散保存」?为什么?\n\n(想 30 秒,1-2 句话就行)" },
        ]
      }
    ]
  },
...
var PREVIEW_TOPIC_META = {
  ...
  "haitian-revolution-1791": {
    primarySources: [
      {
        id: "haiti-independence-1804",
        title: {
          en: "Haitian Declaration of Independence (January 1, 1804)",
          cn: "海地独立宣言（1804 年 1 月 1 日）",
        },
        // 逐字法文原文，取两段：一段自由，一段复仇 —— 它们在同一份文件里。
        // 原来只摘了漂亮那句，而课文刚诚实讲完独立后屠杀三千到七千法国人。
        // 用史料把课文刚承认的黑暗按回去，正好砸掉「给材料让孩子自己判断」这块招牌。
        verbatim: {
          lang: "fr",
          text: "LIBERT\u00c9 OU LA MORT. ARM\u00c9E INDIG\u00c8NE.\n"
            + "\uff08\u4e0d\u81ea\u7531\uff0c\u6bcb\u5b81\u6b7b\u3002\u672c\u571f\u519b\u961f\u3002\uff09\n\n"
            + "\u3010\u4e00\u3011CE n\u2019est pas assez d\u2019avoir expuls\u00e9 de votre pays les barbares qui l\u2019ont "
            + "ensanglant\u00e9 depuis deux si\u00e8cles [...] il faut par un dernier acte d\u2019autorit\u00e9 nationale, "
            + "assurer \u00e0 jamais l\u2019empire de la libert\u00e9 dans le pays qui nous a vu na\u00eetre.\n\n"
            + "\u3010\u4e8c\u3011[...] sachez que vous n\u2019avez rien fait, si vous ne donnez aux nations un exemple "
            + "terrible, mais juste, de la vengeance que doit exercer un peuple fier d\u2019avoir recouvr\u00e9 sa libert\u00e9 "
            + "[...] commen\u00e7ons par les fran\u00e7ais [...] la r\u00e9solution terrible que nous allons prendre de "
            + "d\u00e9vouer \u00e0 la mort, quiconque n\u00e9 fran\u00e7ais, souillerait de son pied sacril\u00e8ge le "
            + "territoire de la libert\u00e9.",
          note: "\u2014\u2014 两段出自同一份文件、同一天、同一个人（德萨林，秘书布瓦龙-通内尔执笔）。[...] 处为删节。",
        },
        en: "It is not enough to have expelled the barbarians who have bloodied our land for two centuries... We must, with one last act of national authority, forever assure the empire of liberty in the country of our birth. \u2014 Jean-Jacques Dessalines, Gonaïves, 1 January 1804",
        enSimplified: "LIBERTY OR DEATH. THE INDIGENOUS ARMY.\n\n"
          + "[1] It is not enough to have driven out the men who bled this country for two hundred years [...] "
          + "By one last act of national authority we must secure liberty forever in the land where we were born.\n\n"
          + "[2] [...] know that you have done nothing unless you give the nations a terrible \u2014 but just \u2014 example "
          + "of the vengeance a free people owes [...] let us begin with the French [...] we will take this terrible "
          + "resolution: to put to death anyone born French who sets a sacrilegious foot on this territory of liberty.",
        cnGloss: "\u26a0\ufe0f **先说一句**：下面这份文件里，有按国籍处死平民的命令。"
          + "在这之前，法国军队曾试图在岛上恢复奴隶制——海地人怕他们再回来，这份恐惧是真的；"
          + "而后来被杀的人里，也有已经放下武器的平民。看懂恐惧从哪来，不等于替杀人下结论。"
          + "你可以先读下面的「读得懂的版本」，也可以停在这里。\n\n"
          + "文件抬头：**「不自由，毋宁死。本土军队。」**（indig\u00e8ne 指「本地出生的」，"
          + "是革命者自己挑的称呼，用来跟「法国殖民者」划清界限 \u2014 不是指岛上更早的原住民泰诺人。）\n\n"
          + "【一】「把两百年来血洗这片土地的人赶出去，还不够……我们必须用最后一次国家行动，"
          + "让自由在这片生养我们的土地上永远立住。」\n\n"
          + "【二】「……要知道，你们什么也没做成——除非你们让各国看到一个**可怕、然而公正的复仇**范例，"
          + "一个刚夺回自由的民族应当施行的复仇……**就从法国人开始**……"
          + "我们将下这样一个可怕的决心：**凡生为法国人者，只要把脚踏上这片自由的土地，一律处死。**」\n\n"
          + "\u2014\u2014 这两段在同一天、同一篇《告海地人民书》里，署名德萨林（一般认为由他的秘书布瓦龙-通内尔执笔）。\n"
          + "你上一节读到独立之后岛上「剩下的法国白人几乎被杀光」。那不是打完仗之后失控的意外——"
          + "**建国的这份文件里就写着。** 这两段，一段写他们要守住什么，一段写他们准备怎样守住。\n"
          + "另外，把它和 1789 年巴黎那句「人生而且始终自由」放在一起看：那句是别人写的，"
          + "没打算算上他们；这句是他们自己写的。",
        closingQuestion: {
          cn: "同一天、同一篇文件，为什么容得下「让自由永远立住」和「就从法国人开始」这两句话？\n它们在写这份文件的人心里，是一回事还是两回事？",
          en: "Same day, same document \u2014 how does it hold both \u201csecure liberty forever\u201d and \u201clet us begin with the French\u201d?\nTo the people writing it, were those one thing, or two?",
        },
        keyTerms: [
          { word: "expuls\u00e9 / expelled", cn: "驱逐、赶出去", etym: "ex-(向外)+pel(推)。法文原文用的就是 expuls\u00e9" },
          { word: "autorit\u00e9 nationale", cn: "（法）国家权力", etym: "关键在「国家」\u2014 他们不只是造反，是建国" },
          { word: "vengeance", cn: "复仇", etym: "原文紧跟着 terrible, mais juste（可怕、然而公正）\u2014 他们没打算把它说成正当防卫" },
          { word: "libert\u00e9 ou la mort", cn: "（法）不自由，毋宁死", etym: "文件抬头第一行，不是后人加的标语" },
          { word: "indig\u00e8ne", cn: "（法）本地出生的", etym: "革命者自称「本土军队」，跟「法国殖民者」划清界限 \u2014 不是指泰诺原住民" },
        ],
        credit: "文本：Acte de l'Ind\u00e9pendance d'Ha\u00efti, Gona\u00efves, 1er janvier 1804（公有领域）"
          + "\u3000\u00b7\u3000法文转录据 slaverylawpower.org 所载 1804 年印本",
      },
    ],
    titleEn: "The Haitian Revolution", titleCn: "海地革命 1791",
    hook: "1791 年加勒比一座糖殖民地，几十万被奴役者同时点起火把 — 这是历史上唯一一场被奴役者自己打赢、自己建国的革命。",
    unit: "HS 世界史 · AP World", hss: "AP World Unit 5 · 大西洋革命", year: 1791,
  },
  "meiji-restoration-1868": {
    titleEn: "The Meiji Restoration", titleCn: "明治维新 1868",
    hook: "1853 年美国黑船一来，日本用十年推翻幕府 — 然后一群下级武士亲手废掉了把自己变成武士的整套制度。",
    unit: "HS 世界史 · AP World", hss: "AP World Unit 6 · 亚洲现代化", year: 1868,
  },
  "russian-revolution-1917": {
    titleEn: "The Russian Revolution", titleCn: "俄国革命 1917",
    hook: "1917 年彼得格勒，一群纺织女工为了面包走出工厂 — 几天后，统治俄国 300 年的沙皇王朝塌了。",
    unit: "HS 世界史 · AP World / APUSH", hss: "AP World Unit 7 · APUSH Period 7", year: 1917,
  },
  "contemporary-us-1980": {
    titleEn: "Contemporary US", titleCn: "当代美国 1980-至今",
    hook: "1980 到今天，美国整体更富了 — 可有些小城的工厂一座座关掉，付账的是留在那里的人家。",
    unit: "11 年级 · 美国史 · APUSH", hss: "APUSH Period 9（1980-至今）", year: 1980,
  },
  "trade-networks-1200": {
    titleEn: "Afro-Eurasian Trade Networks", titleCn: "三网相连 1200-1450",
    hook: "1324 年，一个西非皇帝带着成吨黄金路过开罗 — 一路撒金，竟把当地金价压垮了十几年。三张商路把半个地球缝成了一张网。",
    unit: "HS 世界史 · AP World", hss: "AP World Unit 2 · 贸易网络", year: 1324,
  },
  "asian-imperialism-1839": {
    titleEn: "Imperialism in Asia", titleCn: "亚洲的帝国主义 1839",
    hook: "1839 年虎门，林则徐把两万箱鸦片倒进海里 — 三年后，一纸《南京条约》割走香港岛。同一台机器，也碾过了印度。",
    unit: "HS 世界史 · AP World", hss: "AP World Unit 6 · 工业化的后果", year: 1839,
  },
  "mesopotamia-3500bce": {
    titleEn: "Mesopotamia & Sumer", titleCn: "美索不达米亚 · 苏美尔",
    hook: "约 5500 年前的两河之间，人类第一次把「谁交了多少大麦」压进湿泥板 — 这是最早的文字，第一批字全是账，不是诗。",
    unit: "6 年级 · 古代世界", hss: "CA HSS-6.2 · 文明起源", year: -3500,
  },
  "indus-valley-2600bce": {
    titleEn: "Indus Valley (Harappa)", titleCn: "印度河 · 哈拉帕",
    hook: "4500 年前的印度河边，一座座城市有网格街道和领先千年的下水道 — 却找不到一座王宫、一个国王的名字。谁在管这一切？",
    unit: "6 年级 · 古代世界", hss: "CA HSS-6.5 · 古印度起点", year: -2600,
  },
  "early-humans-10000bce": {
    titleEn: "Early Humans & the Neolithic Revolution", titleCn: "早期人类与新石器革命",
    hook: "一万多年前，人类第一次不再追着猎物跑，而是把种子埋进土里、住下来 — 这一步带来了文明，也带来了更矮的身体和新的病。",
    unit: "6 年级 · 古代世界", hss: "CA HSS-6.1 · 古代轨开篇", year: -10000,
  },
  "ancient-israel-1000bce": {
    titleEn: "Ancient Israel & the Origins of Monotheism", titleCn: "古以色列与一神教起源",
    hook: "公元前 586 年，圣殿被巴比伦夷平、人被掳走 — 一个民族在废墟和流放中，反而锻造出一个影响后世几十亿人的「唯一神」信仰。",
    unit: "6 年级 · 古代世界", hss: "CA HSS-6.3 · 宗教 through-line 源头", year: -586,
  },
  "gupta-india-320": {
    titleEn: "Gupta India: A Golden Age", titleCn: "笈多王朝 · 印度黄金时代",
    hook: "1600 年前的印度，一个数学家算出地球在自转、圆周率精确到小数点后四位 — 还把「空位」一步步变成了今天全世界都在用的「0」。",
    unit: "6 年级 · 古代世界", hss: "CA HSS-6.5 · 古典印度", year: 320,
  },
  "persian-empire-550bce": {
    titleEn: "The Persian (Achaemenid) Empire", titleCn: "波斯帝国 · 阿契美尼德",
    hook: "2500 年前，波斯王居鲁士放被掳的犹太人回家、不强令大家改信 — 他和大流士用「容得下各自的根」统治了横跨三洲的大帝国。",
    unit: "6 年级 · 古代世界", hss: "CA HSS-6.x · 古典帝国行政", year: -550,
  },
  "latin-american-independence-1810": {
    titleEn: "Latin American Independence", titleCn: "拉丁美洲独立",
    hook: "海地点起的火越过加勒比海 — 玻利瓦尔和圣马丁从南北两头打穿一个大陆，赶走了西班牙；可种族的旧秩序，并没有跟着一起倒。",
    unit: "HS 世界史 · AP World", hss: "AP World Unit 5 · 大西洋革命", year: 1810,
  },
  "interwar-totalitarianism-1919": {
    titleEn: "The Interwar Years & the Rise of Totalitarianism", titleCn: "战间期与极权主义兴起",
    hook: "一战刚停、大萧条又砸下来 — 二十年里，好几个国家的人亲手把自己的自由交了出去，换一个承诺「让一切重新强大」的强人。",
    unit: "HS 世界史 · AP World", hss: "AP World Unit 7 · 全球危机", year: 1919,
  },
  "road-to-revolution-1763": {
    titleEn: "The Road to Revolution", titleCn: "通往独立之路 1763",
    hook: "打赢了法印战争，英国却背上巨债 — 于是一条条新税伸向殖民地。十二年里，「忠诚的臣民」一步步被逼成了「反叛者」。",
    unit: "8 年级 · 美国史 · APUSH", hss: "APUSH Period 3 · HSS-8.1", year: 1763,
  },
  "colonial-america-1650": {
    titleEn: "Colonial America Takes Shape", titleCn: "殖民地美洲的成形",
    hook: "一条横跨大西洋的三角航线，把朗姆酒、奴隶和糖绑在一起 — 北美殖民地的繁荣，从一开始就压在被掳者的身上。",
    unit: "8 年级 · 美国史 · APUSH", hss: "APUSH Period 2 · HSS-8.1", year: 1650,
  },
  "early-republic-1800": {
    titleEn: "The Early Republic", titleCn: "早期共和国 1800-1828",
    hook: "新国家刚站稳，就用一笔钱买下半个大陆、又打了一场没赢没输的仗 — 向西扩张的每一步，背后都是被推开的原住民和被带走的奴隶。",
    unit: "8 年级 · 美国史 · APUSH", hss: "APUSH Period 4 · HSS-8.4", year: 1803,
  },
  "spanish-american-war-1898": {
    titleEn: "The Spanish-American War & American Empire", titleCn: "美西战争与美国海外帝国",
    hook: "1898 年一艘军舰爆炸，把美国推进一场「光辉小战争」 — 打完，美国第一次在海外有了殖民地，也第一次为「帝国」这两个字吵翻了天。",
    unit: "8 年级 · 美国史 · APUSH", hss: "APUSH Period 7 · HSS-8.12", year: 1898,
  },
  "cold-war-home-front-1950": {
    titleEn: "The Cold War Home Front", titleCn: "冷战国内战线 · 麦卡锡主义",
    hook: "冷战不只在海外打 — 在国内，对「内部敌人」的恐惧让一份名单、一次质询就能毁掉一个人的事业。恐惧如何一点点吃掉自由？",
    unit: "11 年级 · 美国史 · APUSH", hss: "APUSH Period 8 · HSS-11.8", year: 1950,
  },
  "vietnam-war-1965": {
    titleEn: "The Vietnam War & the 1960s-70s", titleCn: "越南战争与 1960s-70s 动荡",
    hook: "电视第一次把战争搬进客厅 — 前线的村庄、被征召的青年、街头的反战者，整整一代美国人因为同一场远方的战争被撕成两半。",
    unit: "11 年级 · 美国史 · APUSH", hss: "APUSH Period 8 · HSS-11.9", year: 1965,
  },
  ...
  "hamilton-jefferson-1790s": {
    titleEn: "Hamilton vs Jefferson", titleCn: "建国财政与第一次党争",
    hook: "国家刚成立就差点散伙 — 两个开国元勋为「钱归谁管、政府该多大」吵到分裂出两个党。",
    unit: "8 年级 · 美国史", hss: "HSS-8.3 · APUSH Period 3", year: "1790s",
  },
  "jackson-indian-removal-1830": {
    titleEn: "Andrew Jackson & Indian Removal", titleCn: "杰克逊民主与印第安人迁移",
    hook: "一个「平民英雄」总统，签字把几万原住民赶上千里死亡之路 — 民主扩大的同一年，另一群人被彻底踢出局。",
    unit: "8 年级 · 美国史", hss: "HSS-8.5 · APUSH Period 4", year: 1830,
  },
  "slavery-abolition-1850": {
    titleEn: "Slavery, Abolition & the Underground Railroad", titleCn: "奴隶制与废奴",
    hook: "半个国家把人当财产买卖 — 一条看不见的「地下铁路」，靠暗号和勇气把人偷渡向自由。",
    unit: "8 年级 · 美国史", hss: "HSS-8.7 · APUSH Period 4-5", year: "1830-1860",
  },
  "civil-war-1861": {
    titleEn: "The Civil War", titleCn: "南北战争",
    hook: "美国人自己打自己，死了 60 多万 — 为了「人到底算不算人」这一个问题，打了四年。",
    unit: "8 年级 · 美国史", hss: "HSS-8.10 · APUSH Period 5", year: 1861,
  },
  "reconstruction-1877": {
    titleEn: "Reconstruction & Its Betrayal", titleCn: "重建与背叛",
    hook: "内战赢了、奴隶自由了 — 可不到十二年，胜利被一笔政治交易出卖，黑人重新被按回底层。",
    unit: "8 年级 · 美国史", hss: "HSS-8.11 · APUSH Period 5-6", year: "1865-1877",
  },
  "gilded-age-1890": {
    titleEn: "The Gilded Age — Robber Barons & Labor", titleCn: "镀金时代与劳工",
    hook: "钢铁大王富可敌国，工人却在工厂里拿命换工资 — 「镀金」的表面下，是谁在流血。",
    unit: "8 年级 · 美国史", hss: "HSS-8.12 · APUSH Period 6", year: "1870-1900",
  },
  "womens-suffrage-1920": {
    titleEn: "Women's Suffrage", titleCn: "妇女选举权",
    hook: "一半人口，争一张选票，争了 72 年 — 从被嘲笑、被关押，到第 19 修正案。",
    unit: "8 年级 · 美国史", hss: "HSS-8.8 · APUSH Period 4-7", year: "1848-1920",
  },
  "industrial-revolution-1800": {
    titleEn: "The Industrial Revolution", titleCn: "工业革命",
    hook: "机器轰鸣、财富暴涨 — 代价是几岁的孩子每天在纺织厂站 14 小时。",
    unit: "HS 9-10 · AP World/Euro", hss: "AP World Modern Unit 5", year: "1760-1840",
    // ─── 一手史料（2026-08-17）────────────────────────────────────────
    // 孩子先跟 Ellen 经历，再看到「这不是编的，1832 年的原件长这样」——
    // 故事负责带进去，史料负责站得住。这也正是美国课堂 DBQ 考的能力（读原始文档）。
    // 版权：Sadler 报告是 1832 年英国议会文件（公有领域）；照片取自美国国会图书馆
    // NCLC 馆藏，rights_advisory 为 "No known restrictions on publication"，
    // 且 Hine 卒于 1940、摄于 1908-1924，两条路径均已过期。只从有明确权利记录的机构取图。
    primarySources: [
      {
        id: "sadler-crabtree-1832",
        title: {
          en: "Sadler Committee Testimony — Matthew Crabtree",
          cn: "1832 年英国议会童工听证 · 马修·克拉布特里的证词",
        },
        // 逐字原文：删节处一律用 [...] 标出，不做无痕压缩。
        // 压缩过的引文摆成引文，就是把改写冒充原件——这张卡唯一的价值就没了。
        verbatim: {
          lang: "en",
          text: "At what age did you first go to work in one? \u2014 Eight.\n"
          ...
          note: "\u2014\u2014 议会速记员当场记下的问答，1832 年印成议会报告。说话的人叫马修·克拉布特里，作证那年 22 岁，讲的是他 8 岁起的事。[...] 处略去了中间关于旺季工时、吃饭、迟到挨打等多组问答。",
        },
        en: "At what age did you first go to work in one? \u2014 Eight.\n"
          + "Will you state the hours of labour at the period when you first went to the factory, in ordinary times? \u2014 From 6 in the morning to 8 at night.\n"
          + "Fourteen hours? \u2014 Yes.\n"
          + "Do you think that if the overlooker were naturally a humane person it would still be found necessary for him to beat the children? \u2014 Yes; the machine turns off a regular quantity of cardings, and they must keep with the machine, and therefore however humane the slubber may be, he spurs the children to keep up also by various means, but that which he commonly resorts to is to strap them when they become drowsy.",
        enSimplified: "How old were you when you first went to work in a factory? \u2014 Eight.\n"
          + "What were your hours? \u2014 From 6 in the morning to 8 at night.\n"
          + "Fourteen hours? \u2014 Yes.\n"
          + "Even a kind overlooker had to beat the children? \u2014 Yes. The machine makes a set amount, and the children must keep up with the machine. So however kind the man is, he pushes them \u2014 and what he usually does is strap them when they get drowsy.",
        cnGloss: "「你第一次进工厂几岁？——八岁。」\n"
          + "「你刚进厂那阵子，平常日子上工几点到几点？——早上六点到晚上八点。」「十四个小时？——是。」\n"
          + "「假如那个监工本性是个厚道人，在超长工时快结束的时候，他是不是仍然非打孩子不可？"
          + "——是的。机器按固定速度不停地出活，孩子一整天都得照着这个速度跟。他们必须跟住机器；"
          + "所以那个粗纱工（slubber）人再厚道，他自己也得跟住机器、否则要挨说，"
          + "于是他就用各种办法催孩子——而他通常用的那个办法，就是趁他们犯困的时候用皮带抽。」\n\n"
          + "\u2014\u2014 Ellen 背上挨的那一下，不是凭空编的：strap 这个词就来自这段证词。\n"
          + "但请你注意一件事——问话的人问的是 overlooker（监工），克拉布特里答的却是 slubber（粗纱工）。"
          + "证词里说得很清楚：粗纱工自己**也得跟住机器，跟不上要挨说**。",
        closingQuestion: {
          cn: "这段证词里出现了三种人：粗纱工（slubber，动手打的）、监工（overlooker，管事的）、厂主（master，发工钱的）。他们各自在做什么？如果三个人干的事不一样，那这件事的责任该怎么分？——也可能你觉得根本不该这么分。你怎么想？",
          en: "Three kinds of people appear in this testimony: the slubber (who does the hitting), the overlooker (who supervises), and the master (who pays the wages). What is each of them doing? If they are doing different things, how should the responsibility be divided \u2014 or do you think it shouldn\u2019t be divided at all?",
        },
        keyTerms: [
          { word: "overlooker", cn: "监工", etym: "over+look+er \u2014 「看管的人」。\u26a0\ufe0f 别被带偏：现代英文动词 overlook 最常见的意思是「没看见、漏掉」，正好相反" },
          { word: "slubber", cn: "粗纱工", etym: "纺纱厂里做粗纱这道工序的工人 \u2014 他自己也是计件拿钱的工人，不是老板" },
          { word: "strap", cn: "皮带；用皮带抽", etym: "既是名词（皮带）也是动词（抽打）" },
          { word: "drowsy", cn: "昏昏欲睡的", etym: "困得睁不开眼，但还没睡着" },
        ],
        image: {
          src: "/history-images/nclc-01638-georgia-spinner-1909.jpg",
          altCn: "一个小女孩站在高大的纺纱机前，机器比她高出许多",
          altEn: "A small girl standing at a spinning frame that towers over her",
          captionCn: "\u26a0\ufe0f 不是 Ellen：1832 年摄影还很新，没有留下这家工厂的照片。图为 1909 年美国佐治亚州棉纺厂的纺纱女童，Lewis Hine 摄，用来看同类工作的样子。",
          captionEn: "\u26a0\ufe0f Note the time and place: this is not Ellen. Photography did not exist in 1832, "
            + "so no photographs of English mills from that year survive. This is a girl spinner in a Georgia "
            + "cotton mill, USA, photographed by Lewis Hine in 1909 \u2014 77 years later, an ocean away. Same work, same age.",
        },
        credit: "证词：Sadler Committee Report, House of Commons, 1832（公有领域）\u3000\u00b7\u3000"
          + "照片：Lewis W. Hine, \u201cA little spinner in a Georgia Cotton Mill\u201d, 1909. "
          + "National Child Labor Committee Collection, Library of Congress, LC-DIG-nclc-01638（无已知发表限制）",
      },
    ],
  },
  "french-revolution-1789": {
    titleEn: "The French Revolution & Napoleon", titleCn: "法国大革命与拿破仑",
    hook: "「自由平等博爱」的口号下，断头台一天天落下 — 一场革命怎么一步步吃掉自己的孩子。",
    unit: "HS 9-10 · AP World/Euro", hss: "AP World Modern Unit 5", year: "1789-1815",
  },
  "scramble-for-africa-1884": {
    titleEn: "The Scramble for Africa", titleCn: "瓜分非洲与新帝国主义",
    hook: "几个欧洲人围着一张地图，把整个非洲分了 — 没有一个非洲人在场。",
    unit: "HS 9-10 · AP World/Euro", hss: "AP World Modern Unit 6", year: "1870-1914",
  },
  "world-war-one-1914": {
    titleEn: "The Great War (WWI)", titleCn: "第一次世界大战",
    hook: "一颗子弹点燃整个欧洲，几百万年轻人死在泥泞的战壕里 — 为了谁也说不清的理由。",
    unit: "HS · AP World/APUSH", hss: "AP World Unit 7 · APUSH Period 7", year: "1914",
  },
  "progressive-era-1910": {
    titleEn: "The Progressive Era", titleCn: "进步时代",
    hook: "一场工厂大火烧死 146 个女工，逼出了一个时代的改革 — 「进步」是怎么从灾难里长出来的。",
    unit: "11 年级 · 美国史", hss: "APUSH Period 7", year: "1890-1920",
  },
  "world-war-two-1942": {
    primarySources: [
      {
        id: "eo-9066-1942",
        title: {
          en: "Executive Order 9066 (February 19, 1942)",
          cn: "第 9066 号行政命令（1942 年 2 月 19 日）",
        },
        // 逐字原文（美国国家档案馆）。这段公文腔本身就是教学内容——
        // 关押十二万人的那份文件，读起来就是这个样子。
        verbatim: {
          lang: "en",
          text: "Now, therefore, by virtue of the authority vested in me as President of the United States, "
            + "and Commander in Chief of the Army and Navy, I hereby authorize and direct the Secretary of War, "
            + "and the Military Commanders whom he may from time to time designate, whenever he or any designated "
            ...
            + "excluded therefrom, such transportation, food, shelter, and other accommodations as may be necessary, "
            + "in the judgment of the Secretary of War or the said Military Commander, and until other arrangements "
            + "are made, to accomplish the purpose of this order.",
          note: "\u2014\u2014 以上两句在原件里是连着的，中间没有删节。命令后面还有几段（覆盖司法部长原先划的区域、可动用联邦军队、要求各部门配合等），这里没有引。",
        },
        en: "I hereby authorize and direct the Secretary of War... to prescribe military areas... from which any or all persons may be excluded, and with respect to which, the right of any person to enter, remain in, or leave shall be subject to whatever restrictions the Secretary of War or the appropriate Military Commander may impose in his discretion. \u2014 Franklin D. Roosevelt",
        enSimplified: "I authorize the Secretary of War to name military areas from which any or all persons may be excluded. Whether a person may enter, stay, or leave is up to whatever restrictions the Secretary of War decides. \u2014 Franklin D. Roosevelt",
        cnGloss: "**说人话版**：总统授权陆军部长，以及陆军部长随时指定的任何军事指挥官——"
          + "只要他或那位指挥官「认为有必要或觉得这样比较好」，就可以自己决定在哪儿划军事区、划多大；"
          + "区里的人「任何人或所有人」都可以被赶出去；谁能进、谁能留、谁能走，"
          + "全看陆军部长或那位指挥官**自己判断**要加什么限制。\n\n"
          + "第二段说：被赶出来的居民，陆军部长可以为他们「提供交通、食物、住所和其他必要的安排」。\n\n"
          + "\u2014\u2014 请特别盯住两个地方。第一个是 **in his discretion（由他自己判断）**："
          + "文件写了一个很宽的目的（防间谍、防破坏），但**没有写**判断某个人的证据门槛是什么、"
          + "期限多长、谁能推翻这个决定。\n"
          + "第二个是「交通、食物、住所和其他必要的安排」这几个字。"
          + "注意：**这几个字本身的意思，就是给被迁走的居民做安置**，不等于「拘留营」。"
          + "拘留营是这道授权加上后面一连串公告、排斥令和执行机构，一步步做出来的结果。"
          + "把这两件事对着看，是我们知道后来发生了什么才做得到的——1942 年 2 月读到这份文件的人，看不到这一层。",
        closingQuestion: {
          cn: "只看这份文件本身：它明确授权了什么？它**没有**直接下令做什么？——从这一纸授权，走到十二万人真的被装上火车，中间还必须有人再做哪些事？把这些空白列出来之后，你觉得该负责的是写这份文件的人，还是填上空白的那些人？",
          en: "Looking only at this document: what does it actually authorize? What does it not directly order? \u2014 to get from this one page to 120,000 people on trains, what else had to happen, and who had to do it? Once you list those gaps, who do you think is responsible: the person who wrote this, or the people who filled the gaps in?",
        },
        keyTerms: [
          { word: "authorize", cn: "授权", etym: "author(创设者)+ize \u2014 给某人「可以这么做」的正式权力" },
          { word: "exclude", cn: "排除；把\u2026\u2026赶出去", etym: "ex-(向外)+clude(关) \u2014 关在外面" },
          { word: "discretion", cn: "自行裁量", etym: "由那名官员按自己的判断决定 \u2014 文件里没有给他任何标准" },
          { word: "deems such action necessary or desirable", cn: "认为有必要、或认为适当可取", etym: "necessary(必要)已经很宽，desirable(可取)更宽 \u2014 两个词并排，门槛很低" },
          { word: "accommodations", cn: "食宿安排", etym: "住处、膳食一类的安置。后来这套「安置」变成了拘留营 \u2014 但那是执行的结果，不是这个词的意思" },
        ],
        image: {
          src: "/history-images/loc-3a35053-exclusion-order-1942.jpg",
          altCn: "街角墙上张贴的排斥令告示，路人在看",
          altEn: "A civilian exclusion order posted on a wall at a street corner, with passersby reading it",
          captionCn: "1942 年加州街角的「第 5 号平民排斥令」\u2014\u2014 你上一节读到「墙上贴出告示」，就是这张纸的样子。",
          captionEn: "\u201cCivilian Exclusion Order No. 5\u201d posted at a street corner in California, 1942 \u2014 "
            + "this is the notice on the wall. Look at what it is: printed, official, stamped. "
            + "It was not written by a mob. It was issued by a government.",
        },
        credit: "文本：Executive Order 9066, Franklin D. Roosevelt, 1942（美国联邦政府作品，公有领域）\u3000\u00b7\u3000"
          + "图：\u201cCivilian exclusion order #5\u2026\u201d, 1942. Library of Congress, LC-USZ62-34565"
          + "（无已知发表限制）",
      },
    ],
    titleEn: "World War II & the Holocaust", titleCn: "二战与大屠杀",
    hook: "人类最大的战争，也犯下最大的罪 — 600 万人被系统屠杀，而美国把自己的日裔公民关进了拘留营。",
    unit: "HS 10-11 · AP World/APUSH", hss: "AP World Unit 7 · APUSH Period 7-8", year: "1939-1945",
  },
  "cold-war-1962": {
    titleEn: "The Cold War", titleCn: "冷战",
    hook: "两个超级大国没直接开火，却把世界推到核战边缘 — 真正流血的，是夹在中间的小国百姓。",
    unit: "HS 10-11 · AP World/APUSH", hss: "AP World Unit 8 · APUSH Period 8", year: "1947-1991",
  },
  "decolonization-1960": {
    titleEn: "Decolonization & the Non-Aligned World", titleCn: "去殖民化与不结盟",
    hook: "几十个国家一夜独立 — 可帝国一走，留下的是仓促画下的国界和回不去的难民。",
    unit: "HS 10 · AP World", hss: "AP World Modern Unit 8", year: "1947-1975",
  },
  "civil-rights-1965": {
    titleEn: "The Civil Rights Movement", titleCn: "民权运动",
    hook: "一群人靠「不还手」赢了 — 在桥上挨打、在监狱里写信，把「人人平等」从纸上拽进现实。",
    unit: "11 年级 · 美国史", hss: "CA HSS G11 · APUSH Period 8", year: "1954-1968",
  },
  "great-depression-1933": {
    titleEn: "The Great Depression & the New Deal", titleCn: "大萧条与新政",
    hook: "一夜之间银行关门、农场荒废、千万人失业 — 一个国家怎么从崩溃里重新站起来。",
    unit: "11 年级 · 美国史", hss: "APUSH Period 7", year: "1929-1939",
  },
  "hammurabi-code-1754bce": {
    titleEn: "Mesopotamia & Hammurabi's Code", titleCn: "美索不达米亚与汉谟拉比法典",
    hook: "近 4000 年前，一个国王把 282 条法律刻在石柱上 — 同一颗牙，贵族和平民赔的不一样。",
    unit: "6 年级 · 古代史", hss: "AP World 史前根 · 最早成文法之一", year: "前 1754",
  },
  "babylonian-exile-586bce": {
    titleEn: "Ancient Israel & the Babylonian Exile", titleCn: "古以色列与巴比伦之囚",
    hook: "圣殿被烧、整个民族被掳走 — 可他们没消失，因为他们学会了「把家装进一本书里」。",
    unit: "6 年级 · 古代史", hss: "HSS-6.3 · AP World 史前根", year: "前 586",
  },
  "roman-republic-fall-44bce": {
    titleEn: "The Roman Republic & Its Fall", titleCn: "罗马共和国与崩溃",
    hook: "一个靠「制衡」运转了 500 年的共和国，怎么一步步把权力交给了一个独裁者。",
    unit: "6 年级 · 古代史", hss: "AP World Unit 1 · 古典政治", year: "前 44",
  },
  "ancient-egypt-2550bce": {
    titleEn: "Old Kingdom Egypt & the Great Pyramid", titleCn: "古埃及与大金字塔",
    hook: "一座 4500 年前的石山，靠的不是皮鞭下的奴隶 — 是一群按尼罗河汛期被征调来的农民，用命垒起了法老的永生。",
    unit: "6 年级 · 古代史", hss: "HSS-6.2 · AP World 古代文明", year: "前 2550",
  },
  "ancient-greece-480bce": {
    titleEn: "Persian Wars & Athenian Democracy", titleCn: "希波战争与雅典民主",
    hook: "希腊人喊着「自由」打退了波斯大军 — 可在那座被称作民主摇篮的城里，女人、奴隶和外邦人，一票都没有。",
    unit: "6 年级 · 古代史", hss: "HSS-6.4 · AP World 古典政治", year: "前 480",
  },
  "mauryan-india-261bce": {
    titleEn: "Ashoka & the Kalinga War", titleCn: "阿育王与羯陵伽之战",
    hook: "一个国王打赢了一场死了十万人的仗 — 然后他在石头上刻下「我后悔了」。被他毁掉的人，该信吗？",
    unit: "6 年级 · 古代史", hss: "HSS-6.5 · AP World 古代帝国", year: "前 261",
  },
  "qin-china-221bce": {
    titleEn: "Qin Unification of China", titleCn: "秦统一中国",
    hook: "一个人把七国捏成一个中国，统一了文字和度量 — 两千年都在用。可垒起这一切的，是数不清没人问过的民夫。",
    unit: "6 年级 · 古代史", hss: "HSS-6.6 · AP World 古代帝国", year: "前 221",
  },
  "byzantine-rise": {
    titleEn: "The Rise of Byzantium", titleCn: "拜占庭的崛起",
    hook: "罗马在西边亡了，东边却又活了一千年 — 一个常被忽略的帝国，怎么把文明续上。",
    unit: "7 年级 · 世界史", hss: "CA HSS 7 · AP World", year: "约 527",
  },
  "islamic-rise": {
    titleEn: "The Rise of Islam", titleCn: "伊斯兰文明的兴起",
    hook: "一个商队领袖带来的信仰，一百年内连起三大洲 — 它是怎么做到的。",
    unit: "7 年级 · 世界史", hss: "CA HSS 7 · AP World", year: "约 610–750",
  },
  "mongol-empire": {
    titleEn: "The Mongol Empire", titleCn: "蒙古帝国",
    hook: "草原骑兵建起人类史上最大的陆地帝国 — 是屠城者，还是把世界连起来的人？",
    unit: "7 年级 · 世界史", hss: "CA HSS 7 · AP World", year: "1206",
  },
  "medieval-japan": {
    titleEn: "Medieval Japan & the Mongol Invasions", titleCn: "中世纪日本与蒙古来袭",
    hook: "两次台风挡住了横扫世界的蒙古大军 — 武士、天皇与「神风」背后的真相。",
    unit: "7 年级 · 世界史", hss: "CA HSS 7 · AP World", year: "1274",
  },
  "pre-columbian": {
    titleEn: "Pre-Columbian Americas", titleCn: "哥伦布之前的美洲",
    hook: "哥伦布到来之前，美洲早已有庞大的帝国和城市 — 它们是谁，又怎么消失的。",
    unit: "7 年级 · 世界史", hss: "CA HSS 7 · AP World", year: "约 1492",
  },
  "scientific-revolution": {
    titleEn: "The Scientific Revolution", titleCn: "科学革命",
    hook: "几个人用望远镜和数学改写了人类看宇宙的方式 — 也跟教会撞了个正着。",
    unit: "HS · AP World/Euro", hss: "AP World/Euro", year: "1543–1687",
  },
  "enlightenment": {
    primarySources: [
      {
        id: "ddhc-1789-art1",
        title: {
          en: "Declaration of the Rights of Man and of the Citizen (1789), Article 1",
          cn: "《人和公民权利宣言》（1789）第一条",
        },
        latin: "Les hommes naissent et demeurent libres et \u00e9gaux en droits.",
        // 法文逐字原文（法国政府 L\u00e9gifrance 现行文本）。原件是法文，英文都是翻译——
        // 所以给孩子看的「原文」必须是这一行。
        verbatim: {
          lang: "fr",
          text: "Les hommes naissent et demeurent libres et \u00e9gaux en droits. "
            + "Les distinctions sociales ne peuvent \u00eatre fond\u00e9es que sur l\u2019utilit\u00e9 commune.",
          note: "\u2014\u2014 naissent et demeurent = 「生而且始终」。中文和英文的转述常常只剩「生而自由」，"
            + "把 demeurent（始终、一直是）丢掉了 \u2014\u2014 而这恰恰是最要紧的那个词。",
        },
        en: "Men are born and remain free and equal in rights. Social distinctions may be founded only on the common good.",
        enSimplified: "Men are born free and equal in rights. Differences in rank can only exist for the common good.",
        cnGloss: "「人生来并且始终享有自由，在权利上平等。社会差别只能建立在公共利益之上。」\n\n"
          + "\u2014\u2014 先看你刚才那句话里少掉的一个词。法文写的是 naissent **et demeurent** libres："
          + "生来并**始终**享有自由。只说「生而自由」，可以理解成出生那一刻是自由的、后来怎样另说；"
          + "写上「始终」，就等于说自由不会因为你后来被卖掉而失效。差一个词，能不能拿它说事，完全不同。\n\n"
          + "再看第二句——这一句很少被人引用。它说：社会差别**只能**建立在「公共利益」之上。"
          + "它首先是在**给特权设条件**：以前贵族的特权是天生的，现在得说出个为公众好的理由才算数。\n"
          + "不过后来很多人读到这句会追问一层：**这个理由由谁来认定？**（这是后人的一种读法，条文本身没写。）",
        closingQuestion: {
          cn: "把两句话连起来读：第一句说所有人生而且始终权利平等，第二句说人和人之间还是可以有差别、只要是为了公共利益。这两句话彼此矛盾吗，还是其实说得通？\n再想一层：如果你是 1789 年读到这张纸的杜桑，你会更看重哪一句？",
          en: "Read the two sentences together: the first says all men are born and remain equal in rights; the second says differences between people may still exist, so long as they serve the common good. Do these two contradict each other, or do they hold together?\nAnd one layer further: if you were Toussaint reading this page in 1789, which sentence would matter more to you?",
        },
        keyTerms: [
          { word: "demeurent", cn: "（法）始终是、一直是", etym: "英文常译作 remain。转述时最容易被丢掉的一个词" },
          { word: "utilit\u00e9 commune", cn: "（法）公共利益", etym: "英文 common good。文件没有写谁来定义它" },
          { word: "declaration", cn: "宣言", etym: "de-(彻底)+clare(清楚) \u2014 公开讲清楚的正式声明" },
          { word: "citizen", cn: "公民", etym: "标题里是「人和公民」两个词 \u2014 谁是人？谁是公民？不是一回事" },
        ],
        image: {
          src: "/history-images/loc-pga05834-toussaint-1870.jpg",
          altCn: "杜桑·卢维杜尔的肖像版画，军装，侧身",
          altEn: "Engraved portrait of Toussaint Louverture in military uniform",
          captionCn: "\u26a0\ufe0f 不是写生：杜桑没有留下照片。这是他去世 67 年后（1870）美国底特律印的石版画，"
            + "出版人是黑人废奴运动者 George DeBaptiste \u2014\u2014 这张画本身也是一份史料。",
          captionEn: "\u26a0\ufe0f This lithograph was printed in Detroit in 1870 \u2014 67 years after Toussaint died. "
            + "No photograph of him exists; every image is a later artist's reconstruction. It was published by "
            + "abolitionist George DeBaptiste, which makes the print itself a source: it shows that decades later, "
            + "Black abolitionists in the United States still held him up as a banner.",
        },
        credit: "文本：D\u00e9claration des droits de l'homme et du citoyen, 1789（公有领域）\u3000\u00b7\u3000"
          + "图：Corrie's Detroit Chromo Lith. office / George DeBaptiste 出版, 1870. "
          + "Library of Congress, LC-DIG-pga-05834（无已知发表限制）",
      },
    ],
    titleEn: "The Enlightenment", titleCn: "启蒙运动",
    hook: "一群人开始相信：用理性，普通人也能重新设计国家 — 这个念头点燃了好几场革命。",
    unit: "HS · AP World/Euro", hss: "AP World/Euro", year: "1685–1789",
  },
  "roman-empire-peak-117": {
    titleEn: "The Roman Empire at Its Peak", titleCn: "罗马帝国巅峰",
    hook: "一个靠道路、法律和军团运转的庞大帝国 — 它的「和平」与「荣耀」，是踩着征服和奴隶堆起来的。",
    unit: "6 年级 · 古代史", hss: "HSS-6.7 · AP World U1", year: "117",
  },
  "gunpowder-empires-1600": {
    titleEn: "The Gunpowder Empires", titleCn: "火药帝国",
    hook: "奥斯曼、萨非、莫卧儿 — 三个靠火炮崛起的穆斯林大帝国，怎么统治成千上万不同信仰的人？",
    unit: "7 年级 · 世界史", hss: "AP World U3 · HSS-7.2", year: "1600",
  },
  "manifest-destiny-1845": {
    titleEn: "Manifest Destiny", titleCn: "昭昭天命与西扩",
    hook: "「上天注定美国要扩张到太平洋」 — 可那片土地上原本住着的人，谁问过他们？",
    unit: "8 年级 · 美国史", hss: "HSS-8.5/8.8 · APUSH P4-5", year: "1845",
  },
  "reform-movements-1840": {
    titleEn: "The Reform Movements", titleCn: "改革运动时代",
    hook: "一个相信「人能被改造得更好」的年代 — 废奴、女权、禁酒一起涌现，可改革是为了谁、又把谁漏在了门外？",
    unit: "8 年级 · 美国史", hss: "HSS-8.6 · APUSH P4", year: "1830s–50s",
  },
  "han-china-130bce": {
    titleEn: "Han China at Its Height", titleCn: "汉朝盛世与代价",
    hook: "一个被传颂两千年的盛世 — 丝绸之路、独尊儒术、横扫匈奴。可这份荣光，是谁在底下扛着？",
    unit: "6 年级 · 古代史", hss: "HSS-6.6 · AP World U1", year: "前 130",
  },
  "american-revolution-1776": {
    titleEn: "The American Revolution", titleCn: "美国独立战争",
    hook: "「人人生而平等」 — 喊出这句话的人，自己却蓄着奴。一场为「自由」而战的革命，是谁的自由？",
    unit: "5 年级 · 美国史", hss: "HSS-5.5 · APUSH P3", year: "1776",
  },
  "thirteen-colonies-1700": {
    titleEn: "The Thirteen Colonies", titleCn: "十三殖民地",
    hook: "三块殖民地，三种活法 — 可这片「机会之地」的繁荣，建在谁的土地和谁的劳作上？",
    unit: "5 年级 · 美国史", hss: "HSS-5.3 · APUSH P2", year: "约 1700",
  },
  "westward-expansion-1869": {
    titleEn: "Westward Expansion", titleCn: "西进运动",
    hook: "一条铁路把大陆连起来，「免费土地」招来无数移民 — 可这片地原本是谁的，野牛去哪了？",
    unit: "5/8 年级 · 美国史", hss: "HSS-5.8/8.5 · APUSH P6", year: "1869",
  },
  "globalization-1995": {
    titleEn: "Globalization", titleCn: "全球化",
    hook: "你身上的衣服、手里的手机，零件来自几十个国家 — 这张网让几亿人脱贫，也让另一些人付出代价。是同一个人吗？",
    unit: "HS 10-11 · AP World U9", hss: "AP-WHAP-9 · CA HSS-10/11", year: "1995",
  },
  "native-americans-pre1500": {
    titleEn: "Native North America Before Contact", titleCn: "北美原住民文明",
    hook: "欧洲人「发现」之前，这片大陆早已有几百个不同的民族、城市和议会 — 「空旷的荒野」是怎么变成故事的？",
    unit: "5 年级 · 美国史前", hss: "HSS-5.1 · AP", year: "约 1450",
  },
};
...
export var buildPreviewTopic = function(id) {
  ...
  //
  // ⚠️ 2026-08-05 瘦身后：notebook 改为按需加载，本函数在**课程列表页**也会被调用
  // （getTopic → 63 门 base-content 课全靠它）。所以：
  //   · 存在性判定改用 light-index（8KB，同步）—— 不能再用 mastery 是否存在来判，
  //     否则列表页拿不到 notebook → 63 门课直接从课程列表消失。
  //   · 标题走 light-index。
  //   · mustMemorize / masteryChecks 只在 notebook 已加载时填（课内才需要；
  //     课页在进课前 preloadNotebook）。
  var names = NOTEBOOK_NAMES[id];
  if (!names) return null;                   // 没笔记本 → 不是可预览的 base-content topic
  var mastery = buildMasteryFromNotebook(id) || {};   // 未加载时为空，列表页不需要
  var nb = loadNotebook(id) || {};
  var meta = PREVIEW_TOPIC_META[id] || {};   // 2 个 Gate-3 样板有更精的 hook/unit/hss override
  return {
    id: id,
    title: { en: meta.titleEn || names.en || id, cn: meta.titleCn || names.cn || id },
    oneLineHook: { cn: meta.hook || (names.cn ? (names.cn + (names.en ? "（" + names.en + "）" : "")) : id) },
    ...
    // 一手史料：base-content 课的史料写在 PREVIEW_TOPIC_META 里（HISTORY_TOPICS 那 8 门
    // 自带 primarySources）。渲染由 ConversationStream 的 SourceCard 负责，按节点的
    // sourceRef 精确匹配。没配的课这里是空数组 —— 渲染层已做空值加固，不会崩。
    primarySources: meta.primarySources || [],
...
export var getAvailableTopics = function() {
  // getTopic 回退到 preview shim — 让 base-content (无完整 HISTORY_TOPICS 条目) 的 topic 也算"已上线"
  return TOPIC_REGISTRY.filter(t => t.available).map(t => getTopic(t.id)).filter(Boolean);
};

// ─── 必背词查找（给对话里 auto-mark 用） ──────────────────────────────
// 给定 Topic 和文本，返回 [{word/concept, type, start, end, data}]
// 长词优先匹配（避免 "rule of law" 内嵌 "law" 被捷足先登）
// ── 从 concept 复合标题抽"可内联匹配的专名/距离短语" ──────────────────────
// 部分 concept 的 en 是复合描述标题 (如 "al-Khwarizmi / Algebra"、"Hagia Sophia / Church of Holy
// Wisdom")，整串永远不会逐字出现在正文 → 内联金色高亮抓不到。这里从标题抽 Capitalized 专名/短语
// (距离词，误报率低) 作为额外内联匹配项，指向同一 concept。只抽多词短语 + 距离单词专名；
// 单个常见词 (Empire/Power/War…) 与框架词 (causes/legacy/vs…) 一律不抽，防过度高亮。
// 连接词 (含介词)：保持 title 大写串整体, 避免 "Barriers to Women in Science" 裂成单词 (Codex P2)
var _CONCEPT_CONNECTOR = { of:1, the:1, a:1, an:1, and:1, de:1, al:1, el:1, ibn:1, bin:1, von:1, van:1, da:1,
  "&":1, to:1, in:1, "for":1, on:1, at:1, with:1, by:1, as:1, "no":1, "no.":1, "#":1,
  "v":1, "v.":1 }; // 法律案件 "Brown v. Board" 的 v. 是连接词 (vs/versus 仍是比较分隔, 不在此)
var _ERA = /^(bce|ce|bc|ad)$/i;
// 只抽"多词短语"(够具体, 误报低); 单词派生 (专名 vs 普通名词无法语法区分: Brown↔brown / Algebra↔algebra,
// Codex 5 轮验证) 一律不抽 —— 单专名标记留作"专名词典"专项。所以不再需要单词停用词表。
var _isConn = function(w) { return !!_CONCEPT_CONNECTOR[w.toLowerCase()]; };
// 修掉派生短语两端标点 (括注别名如 "O'Sullivan, 1845" / '"the People"' 残留逗号引号 — Codex P2)
var _trimPunct = function(s) { return s.replace(/^[\s,.;:!?'"“”‘’`()[\]{}]+|[\s,.;:!?'"“”‘’`()[\]{}]+$/g, ""); };
// 通用"主题名"短语 (太泛, 满屏出现且会错配到旁系 concept — Codex P2)：派生时丢弃。
var _CONCEPT_GENERIC = {
  "cold war":1, "world war":1, "civil war":1, "great war":1, "world war i":1, "world war ii":1,
  "world war one":1, "world war two":1, "first world war":1, "second world war":1, "korean war":1,
  "vietnam war":1, "trade routes":1, "middle ages":1, "new world":1, "old world":1, "the war":1,
};
var _isNum = function(w) { return /^\d+(st|nd|rd|th)?$/.test(w); };
function deriveConceptInlineTerms(en) {
  if (!en || typeof en !== "string") return [];
  var composite = /[/(—:&]| - /.test(en) || en.split(/\s+/).length > 4;
  if (!composite) return []; // 干净的 en 本就直接匹配，不另抽
  // 括注内常是别名 (如 "Great Compromise (Connecticut Compromise)") → 先抽出来当额外 segment, 别丢 (Codex P2)。
  var parenAliases = [];
  var mainStr = en.replace(/\(([^)]*)\)/g, function(_m, inner) {
    if (inner && inner.trim()) parenAliases.push(inner.trim());
    return " ";
  }).replace(/[()]/g, " ");
  var out = [];
  // 括注别名也要按同样的分隔符再拆 (否则 "(Factions & the Large Republic)" 整串当一段, 丢 "Large Republic" — Codex P2)
  var combined = mainStr + (parenAliases.length ? " / " + parenAliases.join(" / ") : "");
  var segs = combined.split(/\s*[/—:&]\s*| - /);
  segs.forEach(function(seg) {
    // 只去双引号 (保留撇号: Tom's / O'Sullivan 不裂; Codex P2)
    seg = seg.replace(/["“”]/g, " ").trim();
    if (!seg) return;
    var run = [];
    var flush = function() {
      while (run.length && _isConn(run[0])) run.shift();
      while (run.length && _isConn(run[run.length - 1])) run.pop();
      // 剥末尾日期 (Codex P2): BCE/CE/BC/AD 纪元标记 (+ 其前数字 / "c.") 与真年份 (4 位 1000-2099);
      // 保留 "No. 10" 编号 / "EO 9066" / "Psalm 137" 这种非年份数字。
      var dropping = true;
      while (dropping && run.length > 1) {
        dropping = false;
        var last = run[run.length - 1];
        if (_ERA.test(last)) {
          run.pop();
          if (run.length && /^\d+$/.test(run[run.length - 1])) run.pop();
          if (run.length && /^c\.?$/i.test(run[run.length - 1])) run.pop();
          dropping = true;
        } else if (/^\d{4}$/.test(last)) {
          var y = parseInt(last, 10);
          var prev = run[run.length - 2].toLowerCase();
          if (y >= 1000 && y <= 2099 && prev !== "no." && prev !== "no" && prev !== "#") {
            run.pop(); dropping = true;
          }
        }
      }
      while (run.length && _isConn(run[run.length - 1])) run.pop();
      if (!run.length) { run = []; return; }
      // 只收多词短语 (含 "Federalist No. 10"、"EO 9066"、"Five Pillars of Islam"): 含字母 + 总长 ≥4。
      // 单词不收 (专名 vs 普通词无法区分)。
      if (run.length >= 2) {
        var phrase = _trimPunct(run.join(" "));
        if (/[a-zA-Z]/.test(phrase) && phrase.length >= 4 && !_CONCEPT_GENERIC[phrase.toLowerCase()]) out.push(phrase);
      }
      run = [];
    };
    seg.split(/\s+/).forEach(function(tk) {
      // 大写判断支持 Unicode 大写 (Ñ/Ö 等), 否则 "Qhapaq Ñan" 在 Ñan 处断 run (Codex P2)
      var isCap = /^\p{Lu}/u.test(tk) || /^[a-z]+-\p{Lu}/u.test(tk) || /^al-/i.test(tk) ||
        /^[A-Z](\.[A-Z])+\.?$/.test(tk) || /^(I|II|III|IV|V|VI|VII|VIII|IX|X)$/.test(tk);
      // 数字可起头 (让 "15th Amendment" 成整体)；纯数字 run 在 flush 会被丢
      if (isCap || _isNum(tk) || (run.length && _isConn(tk))) run.push(tk);
      else flush();
    });
    flush();
  });
  var seen = {};
  return out.filter(function(p) { var k = p.toLowerCase(); if (seen[k]) return false; seen[k] = 1; return true; });
}
export var _deriveConceptInlineTerms = deriveConceptInlineTerms; // 供审计/测试

// 显式 **word** / ⭐**word** 反查 (renderBilingualText 用): 派生短语命中哪个 concept → 让显式标记也成 chip (Codex P2)
export var findConceptByInlineTerm = function(topic, word) {
  if (!topic || !topic.mustMemorize || !word) return null;
  var wl = String(word).toLowerCase();
  var concepts = topic.mustMemorize.concepts || [];
  for (var i = 0; i < concepts.length; i++) {
    var terms = deriveConceptInlineTerms(concepts[i].en);
    for (var j = 0; j < terms.length; j++) { if (terms[j].toLowerCase() === wl) return concepts[i]; }
  }
  return null;
};
...
export var findMustMemorizeHits = function(topic, text) {
  ...
  (topic.mustMemorize.concepts || []).forEach(function(c) {
    ...
    // 复合标题额外抽多词短语作内联匹配项 (指向同一 concept)
    deriveConceptInlineTerms(c.en).forEach(function(term) {
      // exact: 整词边界精确匹配, 不向右扩展 → 防 "Civil Rights Act" 吃掉 "civil rights activists" (Codex P2)
      targets.push({ key: term, type: "concept", data: c, exact: true });
    });
  });
  ...
  targets.forEach(function(t) {
    ...
    while ((idx = textLower.indexOf(key, idx)) !== -1) {
      // 左边界：不在另一个英文单词中间 (放宽以匹配 baron + barons)
      var before = idx === 0 ? " " : text[idx - 1];
      if (/[a-zA-Z]/.test(before)) { idx += t.key.length; continue; }
      // 派生短语 (exact) 需右边界为非字母, 且不向右扩展 (vocab/concept-en 仍按原扩展逻辑认复数)
      var rightChar = text[idx + t.key.length];
      if (t.exact && rightChar != null && /[a-zA-Z]/.test(rightChar)) { idx += t.key.length; continue; }
      ...
      if (!conflict) {
        ...
        // 词形可能是 plural（barons）→ 扩展含尾字母; exact 派生短语不扩展
        if (!t.exact) { while (endIdx < text.length && /[a-zA-Z]/.test(text[endIdx])) endIdx++; }
        hits.push({
          term: t.key,
