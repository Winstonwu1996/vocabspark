...
export var TOPIC_REGISTRY = [
  ...
  { id: "tang-song-china",  available: true,  unit: "7.4",    order: 1, note: "唐宋盛世 — home advantage",            narrativeRequired: false /* TODO: 待写 narrative；写完改 true */ },
  ...
  { id: "renaissance-1500", available: false, unit: "7.8",    order: 5, note: "文艺复兴 — narrative v0 done (2405 行明朝密度)，待 Topic 数据结构 review", narrativeRequired: true },
  { id: "reformation-1517", available: false, unit: "7.9",    order: 6, note: "宗教改革 — narrative v0 done (2487 行明朝密度)，待 Topic 数据结构 review", narrativeRequired: true },
  { id: "age-of-exploration-1492", available: false, unit: "7.11", order: 7, note: "大航海时代 — narrative v0 done (2342 行明朝密度)，待 Topic 数据结构 review", narrativeRequired: true },
  { id: "mali-empire-1235", available: false, unit: "7.4", order: 8, note: "马里帝国 — narrative §0-§4 done (923 行)，§5-§11 暂停 — 优先修对话逻辑", narrativeRequired: true },
];
...
export var BLACK_DEATH_1347 = {
  ...
  // ─── mustMemorize（必背词列表）——auto-mark 用 ──
  // 占位 minimal 表，实际 lens 内容已经显式 gloss 了所有外语术语
  mustMemorize: {
    words: [
      { word: "plague", cn: "瘟疫", ipa: "/pleɪɡ/", definition: { en: "A widespread, contagious, often fatal disease.", cn: "大规模传染、致死率高的疾病。" } },
      { word: "chronicler", cn: "编年史家", ipa: "/ˈkrɒnɪklər/", definition: { en: "A person who records historical events in chronological order.", cn: "按时间顺序记录历史事件的人。" } },
      { word: "pogrom", cn: "屠犹（系统性反犹屠杀）", ipa: "/ˈpɒɡrəm/", definition: { en: "An organized massacre of an ethnic group, especially Jews.", cn: "对某一族群的有组织屠杀，特别指针对犹太人。" } },
    ],
    concepts: [
      { concept: "banality of evil", cn: "恶的平庸性", definition: { en: "Hannah Arendt's term: ordinary people doing terrible things under structural pressure.", cn: "Hannah Arendt 提出的概念：普通人在结构压力下做出极坏的事。" } },
      { concept: "scapegoat mechanism", cn: "替罪羊机制", definition: { en: "Society in crisis blaming a minority group for the disaster.", cn: "社会在灾难中把责任推给少数族群的结构性模式。" } },
    ]
  },
