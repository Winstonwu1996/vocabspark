...
// 字体层次体系（6 级字阶）
export var T = {
  display:  { fontSize: 40, fontWeight: 900, lineHeight: 1.1,  letterSpacing: "-0.035em" },
  hero:     { fontSize: 32, fontWeight: 800, lineHeight: 1.15, letterSpacing: "-0.03em"  },
  h2:       { fontSize: 22, fontWeight: 800, lineHeight: 1.3,  letterSpacing: "-0.02em"  },
