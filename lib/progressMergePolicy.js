...
/* ─── 单词条 SRS recency：srsUpdatedAt > max(reviewHistory.date) > nextReviewDate > fallback ───
   只看 srsUpdatedAt (真实复习事件时间)，绝不看通用 updatedAt。
   原因 (Codex P1)：meaning/phonetic 懒加载会刷新通用 updatedAt，若用它做 recency，
