  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我笔下写"一个坑"。但下面我说给你听的——是那 9 天我自己经历的样子——比我笔下的字多。\n\n' +
      ...
      en:
        ...
        'I wrote "one pit." But what I tell you below is what those nine days were actually like for me — more than the words on the page.\n\n' +
...
export var lenses = {
  'agnolo-siena': {
    ...
    description: '14 世纪 Siena 真实历史人物，35 岁，鞋匠工会账房 + 业余编年史家。1348 年 7 月底到 8 月初亲手埋了自己 5 个孩子，9 天后他重新拿起鹅毛笔。这个视角让你经历从"30 死，60 死"的 6 月到 1351 年终于停笔的那一夜，以及 700 年后他写下的字活到了今天。',
  ...
  'konrad-strasbourg': {
    ...
    description: '虚构的 Strasbourg 38 岁屠夫工会代表，4 代屠夫家族。1340 年他从犹太银匠 Yitzhak 手里接过一对刻字银鞋扣（"信得过的人"）。1349 年 2 月 9 日他投赞成票罢免反对屠犹的市长，5 天后站在 Werd 岛木堆边看见 Yitzhak 那一眼。这个视角让你从 perpetrator 内部经历"真心相信"机制，和它被 plague 证伪之后的 25 年沉默。',
  ...
  'devorah-strasbourg': {
    ...
    description: '虚构的 14 岁 Strasbourg 犹太女孩。父亲 Yitzhak 是 Judengasse 的银匠。1349 年 2 月 14 日屠杀那天，她在基督徒邻居 Brigitta 家地窖里念《诗篇》第 23 篇 30 多遍。这个视角让你从受害方内部经历那 4 个月、半夜父亲跪给邻居换到天亮、森林边帮母亲用 30 块石头堆父亲的坟，以及 59 年后 1408 年她 74 岁对孙女说的最后那一句话。',
