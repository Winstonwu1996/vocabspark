  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '到 1348 年 5 月，我们家有 5 个孩子。**这个 lens 给了他们名字和年龄。但你必须知道：documented record 只确认 5 个孩子这件事，名字和年龄是这个 lens 给你听见这一家具体的样子的虚构补充**：\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '到墓园，没有教士做最后告解。Domus（大教堂）的老神父也死了。墓园里挖了一个大坑，fossa comune（共葬坑）：10 具尸体一层，上面盖一层薄土，再 10 具，再一层。Boccaccio 在 Florence 见过同样的事，他在《Decameron》里管这叫"像做千层糕一样葬人"。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我那一刻——我可以告诉你，这是 lens 让你听见的——一个失去 5 个孩子的人在 1348 年 8 月一个傍晚的脑子里只想到一件事：\n\n' +
        '**我不知道明天太阳出来我要不要起来**。\n\n' +
        '我没回 Niccoluccia 的话。\n\n' +
      ...
      en:
        ...
        'In that moment — I can tell you, this lens lets you hear — what was inside the head of a man who had lost five children, on a summer evening in 1348, was only one thing:\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '她说了一句话。\n\n' +
        '这一句话，你猜？\n\n' +
        'Devorah 1408 年那一刻给 13 岁孙女讲完故事，她说的最后一句话是这个 lens 的 emotional payoff。下一节我会让你思考。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我**不告诉你**是什么。\n' +
        '让你自己 connect。\n\n' +
        '这个 connect 的瞬间，是 Story-First Pedagogy lens 体系给你的最强一击，比一个 narrator 直接告诉你"这两个 lens 是相连的"重 100 倍。\n\n' +
