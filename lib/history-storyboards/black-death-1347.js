  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '**这一节绝大多数细节是这个视角 让你听见。documented record 只有 Agnolo 自己后来在 Cronaca 里那一句**：\n\n' +
        ...
        '这一段历史上保存下来了，是黑死病文献里最锋利的几行意大利文字。其他细节我现在跟你讲的，是这个视角 让你**站在那 9 天里**，不是史料能给的。\n\n' +
        '**重要史实校对**：documented 记录是 Agnolo 把孩子们埋进**同一个 fossa comune**（城内集体大坟）。下面这一遍 让你"看见"的"我家西田 5 个分坑"是叙事性合成，让你感受**一个父亲连续 9 天的劳作**。真实的史料只确认"一个坑，亲手，5 个孩子"。\n\n' +
      ...
      en:
        ...
        '(The documented record is only one sentence, what Agnolo himself later wrote in his Cronaca. Everything else below is narrative reconstruction.)\n\n' +
        '> "E io, Agnolo di Tura, detto el grasso, soppellii con le mie mane cinque mei figliuoli **in una fossa**; e così fece molti altri ancora. E furono molti che furono coperti di terra così poco, che e cani li discivellavano e mangiavano per la città molti corpi."\n\n' +
        ...
        '(One historical note: the chronicle says Agnolo buried his children **in one fossa comune** (the city\'s mass grave). The "five separate pits in our family\'s west field" you are about to read is dramatic invention to let you feel a father\'s nine days of labor. The documented record only confirms "one pit, by his own hand, five children.")\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我得告诉你那一刻发生了什么。这是这个视角 让你听见的。Cronaca 上那一段我后来写的话非常短，但**那一刻**脑子里的东西，比我笔下的字多。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '但**这个视角 让你听见我那一刻心里在想的（documented record 只有事实没有评论）**。我那天合上笔记本之前在心里说了一句话：\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '但 Cronaca 我没再写一笔。\n\n' +
        '为什么停笔？这个问题我自己没在书里答，这个视角 让你听见我心里**真正**的答。documented record 只是"1351 stopped"。\n\n' +
  ...
  // ═════ Meta（反思 + 桥）═════
  {
    ...
    content: {
      cn:
        ...
        '(2) 换视角重玩——同一场 1348 plague，不同视角。Strasbourg 1349/02/14 烧 2000 个犹太人那天，一个普通 Strasbourg 公民的视角（他不是凶手，但他没拦，这个视角 让你感受"在场而不阻止"）；或者 Devorah——一个虚构的 14 岁 Strasbourg 犹太女孩（她躲在地窖里活下来，爬出来看见家人尸体，她跟 Aisha 一样是受害方）。\n\n' +
...
//     未给名字——这个视角 给了名字 Yitzhak 但**显式标记**为 lens 创作）
...
export var lenses = {
  'agnolo-siena': {
    ...
    description: '14 世纪 Siena 真实历史人物，35 岁，鞋匠工会账房 + 业余编年史家。1348 年 7 月底到 8 月初亲手埋了自己 5 个孩子，9 天后他重新拿起鹅毛笔。这个视角 让你经历从"30 死，60 死"的 6 月到 1351 年终于停笔的那一夜，以及 700 年后他写下的字活到了今天。',
  ...
  'konrad-strasbourg': {
    ...
    description: '虚构的 Strasbourg 38 岁屠夫工会代表，4 代屠夫家族。1340 年他从犹太银匠 Yitzhak 手里接过一对刻字银鞋扣（"信得过的人"）。1349 年 2 月 9 日他投赞成票罢免反对屠犹的市长，5 天后站在 Werd 岛木堆边看见 Yitzhak 那一眼。这个视角 让你从 perpetrator 内部经历"真心相信"机制，和它被 plague 证伪之后的 25 年沉默。',
  ...
  'devorah-strasbourg': {
    ...
    description: '虚构的 14 岁 Strasbourg 犹太女孩。父亲 Yitzhak 是 Judengasse 的银匠。1349 年 2 月 14 日屠杀那天，她在基督徒邻居 Brigitta 家地窖里念《诗篇》第 23 篇 30 多遍。这个视角 让你从受害方内部经历那 4 个月、半夜父亲跪给邻居换到天亮、森林边帮母亲用 30 块石头堆父亲的坟，以及 59 年后 1408 年她 74 岁对孙女说的最后那一句话。',
