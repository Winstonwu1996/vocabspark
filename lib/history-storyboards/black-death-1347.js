...
var agnoloSienaStoryboard = [
  ...
  },
  {
    ...
    phase: 'story',
    cosplay: 'Agnolo di Tura',
    narrativeRef: '§3 Boccaccio 出身（同代 Tuscany 城邦商人社会）+ §2 制度 L3',
    content: {
      cn:
  ...
  },
  {
    ...
    phase: 'story',
    cosplay: 'Agnolo di Tura',
    narrativeRef: '§3 Boccaccio "父亲赶生病儿子" + Agnolo documented quote: "buried my five children with my own hands"',
    content: {
      cn:
        '这一节最难写。\n\n' +
  ...
  },
  {
    ...
    phase: 'story',
    cosplay: 'Agnolo di Tura',
    narrativeRef: '§4 1351 第一波结束 + §6 Statute of Laborers + Agnolo 真实生平 1351 停笔',
    content: {
      cn:
  ...
  // ═════ Synthesis（真 Socratic）═════
  {
    ...
    content: {
      cn:
        ...
        '——这两种读法**都有真证据**——心理学家跟历史学家在这个问题上**吵了 100 年**——\n\n' +
        '**读法 A — 编年史家精神 / Boccaccio 同代人文主义传统**：Agnolo 那一刻面对的现实——35000 个 Siena 死人没人记录就**等于没活过**——他自己 5 个孩子是这 35000 里的 5 个——如果他不写——他孩子也**等于没活过**——他选择写下来——是**承担一个知识分子的责任**——是给死者一个"活过"的证据——这是他作为一个父亲能给他孩子的**最后一件礼物**——700 年后我们还能停下来看那 11 个意大利文字——证明他**做对了**——同年 Florence 的 Boccaccio 写《Decameron》是同一种本能——**用书写抗拒虚无**——这是人文主义（humanism）的起点——Agnolo 那一刻是**伟大**的。\n\n' +
        '**读法 B — 创伤心理学派 / 现代 trauma studies（Judith Herman / Bessel van der Kolk）**：失去 5 个孩子是 trauma 顶级强度——人在这种 trauma 下大脑会做的最常见的事是**麻木 + 逃避** + **找一个可以掌控的小事重复做**来稳住自己——Agnolo 写 *Cronaca* 是他**之前**就熟悉的动作——这种**重复一个熟悉的动作**是 trauma response 的典型表现——"我不去想孩子——我去数城里今天死了多少人"——他**不是**在伟大地承担知识分子责任——他是在**用一个比孩子还小的事**填补孩子留下的空——这不是英雄行为——是**幸存者的自我保护**——把这种行为浪漫化叫"历史使命"是后人的**误读**——Agnolo 自己很可能**也不知道**他为什么继续写——他只是没办法停。\n\n' +
        '两种读法都站得住——读法 A 走"知识分子的尊严"看，读法 B 走"trauma response 的本能"看。\n\n' +
        '你怎么看？Agnolo 1348 年 8 月 13 日早上拿起鹅毛笔——更靠近读法 A（伟大的承担）还是读法 B（创伤的逃避）？想 30 秒答——你的论证比结论重要。',
      en:
        ...
        'What do you think? Agnolo picking up the quill on the morning of August 13, 1348 — closer to Reading A (great burden-bearing) or Reading B (traumatic avoidance)? Take thirty seconds. Your reasoning matters more than your conclusion.',
    },
    deliverGoal:
      '你扮演了 Agnolo 9 节——一个失去 5 个孩子之后 5 天又拿起笔的 Siena 编年史家——' +
      '历史学界对这件事**两极分化**：' +
      '**读法 A（编年史家精神 / 人文主义起点）**：他承担一个知识分子的责任——给死者一个"活过"的证据——这是 humanism 的起点——他做对了。' +
      '**读法 B（trauma response 学派）**：失去 5 个孩子是 trauma 顶级——人在这种 trauma 下会**麻木 + 重复熟悉的动作**——他不是英雄——他是在用一个小事填补孩子留下的空。' +
      '——你怎么看，Agnolo 那一刻是伟大的承担还是创伤的逃避？',
    engagementHook:
      '**你怎么看**——Agnolo 那天早上拿起笔，是知识分子的尊严还是创伤的逃避？没有标准答案——给你的理由说服我。想 30 秒答',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '**读法 A — "灾难推进步"派（Walter Scheidel《The Great Leveler》/ Boccaccio 同代人本主义传统）**：Black Death 是欧洲历史一次**真正的大重置（great leveler）**——它**强迫**了一些 1346 年看起来根本不可能的事——农奴解放——女性进入手工业（因为男性死太多）——教会权威被质疑——古希腊罗马手稿被重新阅读——**没有这场灾难——这些 1346 年所有人都习以为常的"封建结构"会再撑 200 年**——Black Death 是**残酷的解放**——25 million 死了——但活下来的人和他们的孩子的**生活机会****比 1346 年好太多**——这是历史的不舒服真相——**有时候只有大灾难才能**打破固化的不公**。\n\n' +
        '**读法 B — "幸存者幻觉"派（Samuel Cohn《The Black Death Transformed》/ 现代历史学批评派）**：所谓"Black Death 推动进步"是**活下来的人写的故事**——25 million 死了的人**没有 voice**——他们死了——他们没办法说"这不公平"——我们今天看到的"农奴解放 + Renaissance + 公共卫生"——只是**幸存者**的视角——一个 8 岁就死的 Caterina——一个 3 岁就死的 Tommaso——他们**没**经历"工资上涨 4 倍"——他们没看到 Brunelleschi 圆顶——他们没活到 Renaissance——**任何把他们的死说成"为后世进步铺路"的叙事——是对死者的二次伤害**——Black Death 不是"残酷的解放"——是**纯粹的损失**——任何把它说成"必要"的论调——是**幸存者写的安慰自己的故事**。\n\n' +
        '两种读法都站得住——读法 A 是**结构进步**优先（看 1352 之后整体），读法 B 是**死者尊严**优先（看 1352 之前那 25 million）。\n\n' +
        '你怎么看？Black Death 后 200 年欧洲的"进步"——更靠近读法 A（残酷的解放）还是读法 B（幸存者的幻觉）？想 30 秒答。\n\n' +
    ...
    deliverGoal:
      ...
      '**读法 A（灾难推进步派 / Walter Scheidel）**：Black Death 是 great leveler——强迫了 1346 年看起来不可能的事——是残酷的解放——没有这场灾难封建结构会再撑 200 年。' +
      '**读法 B（幸存者幻觉派 / Samuel Cohn）**：进步是活下来的人写的故事——25 million 死了的人没 voice——8 岁就死的 Caterina 没经历"进步"——任何把他们的死说成"为后世铺路"的叙事是对死者的二次伤害。' +
      '——你怎么看，是残酷的解放还是幸存者的幻觉？',
    engagementHook:
      '**你怎么看**——Black Death 后欧洲的"进步"，是残酷的解放还是幸存者的幻觉？想 30 秒答',
