...
var agnoloSienaStoryboard = [
  {
    ...
    content: {
      cn:
        ...
        '我把传话员说的全写下。日期：1348 年 5 月 8 日。死者名字：Bartolomeo di Niccolò，商人，*da Genova*。我用鹅毛笔，黑铁胆墨水，写在羊皮纸左上角。三行字。\n\n' +
      ...
      en:
        ...
        'My name is Agnolo di Tura. People call me *il Grasso* ("Agnolo the Fat"). That is the name I wrote on the first page of my own *Cronaca* notebook. I work as a *bookkeeper* (an accountant) for the Siena Cobblers\' Guild (*Arte dei Calzolai*). Every Tuesday and Friday morning I go to the *Palazzo Pubblico* (the City Hall) to check records and balance accounts. The rest of my time, I write the *Cronaca senese*, a chronicle of Siena, this independent city-state.\n\n' +
        ...
        'I wrote down what the messenger told me. Date: May 8, 1348. Dead man\'s name: Bartolomeo di Niccolò, merchant, *da Genova* (from Genoa). I used a goose quill, black iron-gall ink, the upper-left corner of a parchment sheet. Three lines.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '> 中文意思：**"我，Agnolo di Tura，绰号胖子，亲手把我五个孩子埋进一个坑（*fossa comune*——城里的公共大坟）。许多别的人也是这样做。还有许多尸体盖土太浅——狗把他们扒出来在城里吃。"**\n\n' +
        '这一段历史上保存下来了——是黑死病文献里最锋利的几行意大利文字——其他细节我现在跟你讲的——是这个 lens 让你**站在那 9 天里**，不是史料能给的。\n\n' +
        '**重要史实校对**：documented 记录是 Agnolo 把孩子们埋进**同一个 *fossa comune***（城内集体大坟）——下面 lens 让你"看见"的"我家西田 5 个分坑"是叙事性合成，让你感受**一个父亲连续 9 天的劳作**。真实的史料只确认"一个坑——亲手——5 个孩子"。\n\n' +
      ...
      en:
        ...
        'These lines are what history preserved — among the sharpest sentences in the Black Death record. The other details I am about to tell you are this lens letting you **stand inside those nine days**. The historical sources cannot give you that.\n\n' +
        '**An important note on the historical record:** the chronicle says Agnolo buried his children **in one *fossa comune*** (the city\'s mass grave). What this lens shows you below — "five separate pits in our family\'s west field" — is dramatic invention, designed to let you feel **what nine days of a father\'s labor was like**. The documented record only confirms "one pit — by his own hand — five children."\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '——也许是——我那一年终于"写够了"——30000 笔——5 个坑——一段反犹屠杀——一段制度坍塌——一段 *flagellanti*——一段 Niccoluccia 树下 9 天——一段我**亲手**做的事——一段 *"scrissi questo perché altrimenti non lo crederebbe nessuno"*——这些事我都写下了——后人有人想看——他可以看——我做完了我能做的——\n\n' +
        '——也许三个原因都有。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '——这就是 Renaissance 起点。**没有 plague——可能没有 Renaissance**——Brunelleschi 的圆顶（1436）/ Donatello 的雕塑 / Botticelli / Leonardo da Vinci / Michelangelo——他们的整个文化运动——在某种意义上是**1348 年那 30000 个 Siena 死人 + 50000 个 Florence 死人 + 整个欧洲 2500 万死人留下的真空被人**重新填出来的样子**。\n\n' +
  ...
  // ═════ Synthesis（真 Socratic）═════
  {
    ...
    content: {
      cn:
        ...
        '**一种说法 — 编年史家精神 / Boccaccio 同代人文主义传统**：Agnolo 那一刻面对的现实——30000 个 Siena 死人没人记录就**等于没活过**——他自己 5 个孩子是这 30000 里的 5 个——如果他不写——他孩子也**等于没活过**——他选择写下来——是**承担一个知识分子的责任**——是给死者一个"活过"的证据——这是他作为一个父亲能给他孩子的**最后一件礼物**——700 年后我们还能停下来看那 11 个意大利文字——证明他**做对了**——同年 Florence 的 Boccaccio 写《Decameron》是同一种本能——**用书写抗拒虚无**——这是人文主义（humanism）的起点——Agnolo 那一刻是**伟大**的。\n\n' +
...
var konradStrasbourgStoryboard = [
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '——**1938 年纳粹 Kristallnacht**（"水晶之夜"）：德国全境一夜——上千犹太教堂烧——91 死 + 30000 抓——\n\n' +
        '——**1942 年 Wannsee Conference**：纳粹高级官员开会——把已经在进行的杀戮（1941 年夏 Einsatzgruppen 大规模枪决 + 1941 年 12 月 Chełmno 毒气）系统化为工业流程——决定"最终解决犹太人问题"——到 1945 年共 600 万犹太人死——\n\n' +
        '——\n\n' +
        '——\n\n' +
  ...
  },
  {
    ...
    engagementHook:
      '**你怎么看**——Konrad 余生 25 年没公开承认错——是未尽公开承认责任，还是 medieval 时代约束之内已尽力？想 30 秒',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '*Ima* 站住——\n\n' +
        '我 14 岁——我在屋角整理 *Aba* 铺子的银针——我那一刻——是这辈子第一次听到"Schwarber"这个名字——*Aba* 后来跟我解释：他是 *Bürgermeister*——市长——50 岁——他在市议会反对"屠犹"——他说"井下毒"是谣言——是 Italy plague 已经在路上——\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我 14 岁——我那一刻明白了："冒生命危险"不是一句话——是这个具体的男人——这一刻——他在算——他能不能用我们换他的命。\n\n' +
        '*Aba* 推开我——他从地窖梯子上去——\n\n' +
...
export var lenses = {
  'agnolo-siena': {
    ...
    role: 'Siena 鞋匠工会账房 / 业余 chronicler / 1348 intellectual witness 视角',
    description: '14 世纪 Siena 真实历史人物，35 岁，鞋匠工会账房 + 业余编年史家。1348 年 7 月底到 8 月初亲手埋了自己 5 个孩子，9 天后他重新拿起鹅毛笔。这个 lens 让你经历从"30 死，60 死"的 6 月到 1351 年终于停笔的那一夜，以及 700 年后他写下的字活到了今天。',
  ...
  'konrad-strasbourg': {
    ...
    role: 'Strasbourg 屠夫工会代表 / 1349 反犹屠杀 perpetrator-actor 视角',
    description: '虚构的 Strasbourg 38 岁屠夫工会代表，4 代屠夫家族。1340 年他从犹太银匠 Yitzhak 手里接过一对刻字银鞋扣（"信得过的人"）。1349 年 2 月 9 日他投赞成票罢免反对屠犹的市长，5 天后站在 Werd 岛木堆边看见 Yitzhak 那一眼。这个 lens 让你从 perpetrator 内部经历"真心相信"机制，和它被 plague 证伪之后的 25 年沉默。',
  ...
  'devorah-strasbourg': {
    ...
    role: 'Strasbourg 14 岁犹太女孩 / 1349 屠杀幸存者 / receiving end 视角',
    description: '虚构的 14 岁 Strasbourg 犹太女孩。父亲 Yitzhak 是 *Judengasse* 的银匠。1349 年 2 月 14 日屠杀那天，她在基督徒邻居 Brigitta 家地窖里念《诗篇》第 23 篇 30 多遍。这个 lens 让你从受害方内部经历那 4 个月、半夜父亲跪给邻居换到天亮、森林边帮母亲用 30 块石头堆父亲的坟，以及 59 年后 1408 年她 74 岁对孙女说的最后那一句话。',
