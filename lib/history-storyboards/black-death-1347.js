  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '**1349 年 2 月 14 日（Saint Valentine\'s Day）——Strasbourg（今天德国-法国交界的城）——在他们最大的犹太会堂里——2000 个犹太人——男人 + 女人 + 孩子——被活活烧死**——\n\n' +
      ...
      en:
        ...
        '**On February 14, 1349 (Saint Valentine\'s Day), in Strasbourg (a city on what is today the French-German border), inside the largest synagogue in town, two thousand Jews — men, women, and children — were burned alive.**\n\n' +
  ...
  },
  {
    ...
    content: {
      ...
      en:
        ...
        'Both sides stand. The first view puts **structural progress** first (looking at the whole picture after 1352). The other viewputs **the dignity of the dead** first (looking at the twenty-five million who died before 1352).\n\n' +
  ...
  // ═════ Meta（反思 + 桥）═════
  {
    ...
    content: {
      cn:
        ...
        '(2) 换 lens 重玩——同一场 1348 plague——不同视角——Strasbourg 1349/02/14 烧 2000 个犹太人那天——一个普通 Strasbourg 公民的视角（他不是凶手——但他没拦——这个 lens 让你感受"在场而不阻止"）——或者 Devorah——一个虚构的 14 岁 Strasbourg 犹太女孩（她躲在地窖里活下来——爬出来看见家人尸体——她跟 Aisha 一样是受害方）。\n\n' +
    ...
    deliverGoal:
      ...
      '现在你可以选：' +
      '(1) 进 mastery 通关 / ' +
      '(2) 换 lens 重玩——比如 Strasbourg burgher（1349/02/14 屠犹见证者）或 Devorah（虚构 14 岁犹太女孩幸存者）—— ' +
...
//     这是他唯一公开做的承认
//
// 这个 lens 是 perpetrator-actor 视角（平行于 Crusades Roger）：
...
//     未给名字——这个 lens 给了名字 Yitzhak 但**显式标记**为 lens 创作）
//   - Schwarber 是 documented 真实历史人物——1349/2/9-10 罢免事件 documented
//   - 2000 人 + 犹太墓地 + 火烧 documented（narrative kernel §3 + §4）
//
// 与 Devorah lens 的对位 echo：
//   - Devorah 父亲 Yitzhak（银匠）= Konrad 烧的那个银匠
//   - Devorah lens 不让 Devorah 知道父亲被 Konrad 投票
//   - Yitzhak 那一眼——Konrad lens 描写；Devorah lens 不描写（她没在场）
//   - 用户做完两个 lens 才能在 meta connect——不要 4th-wall break 直接告诉用户
//
...
var konradStrasbourgStoryboard = [
  {
    ...
    content: {
      cn:
        ...
        '我叫 Konrad——人家叫我 *Konrad der Metzger*——"屠夫 Konrad"——我家 4 代住 Strasbourg——4 代都是屠夫——我是 Strasbourg *Metzgerzunft*（屠夫工会，德语区城邦的"行业自治组织"）的代表 + city council（市议会）11 个成员之一。\n\n' +
        '今天早上我妻子 Margarete 给我端了一碗汤——羊脂 + 大麦——她平时不熬这种汤——这是 Strasbourg 这边只有大事日子才熬的"出门汤"。\n\n' +
        '我喝完。\n\n' +
        '我手在抖。\n\n' +
        '不是冷——壁炉烧着——窗外雪下了一夜还在下——但我手抖不是因为冷。\n\n' +
        '我今天要去 Werd（韦尔德岛——Strasbourg 城西面的一座小岛，犹太墓地就在那里）。\n\n' +
        '我今天要做的事——5 天前——1349 年 2 月 9 日——市议会已经投票通过——我**投了赞成票**——*Bürgermeister*（市长）Schwarber 被罢免——他反对——他被赶出议会——新的领导班子那天下午就发了告示——"所有 Strasbourg 犹太人——男女老幼——明天开始 5 天内集中到 Werd 岛"——\n\n' +
        '——今天是第 5 天。\n\n' +
        'Margarete 没问我去哪里。她知道。她把 Wilhelm（我儿子，8 岁）抱在怀里——她让 Wilhelm 别看我。她对我说了一句——"*Heilige Maria* 看着——你做你认为对的事——我不会问。"\n\n' +
        '——但她这句话里有一个字——她没说——\n\n' +
        '——"*回来*"——\n\n' +
        '我穿上厚毛斗篷——出门——雪——靴子在木板路上踩出的声音——清楚得像我心跳——\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我 1330 年娶 Margarete——她爸是城南磨坊主 Albrecht——她比我矮一头——她不识字——但她算账比我还快。\n\n' +
        ...
        '——那里有一家银匠铺——主人叫 Yitzhak ben Abraham——他比我大 5 岁——我跟他做生意 8 年——我家屠夫工会的银扣 + 银针 + 银钉——都从他那儿买。\n\n' +
        'Yitzhak 那天看见我抱着 Wilhelm 进门——他没说话——他从柜台后面拿出一对银鞋扣——他自己提前打的——他一直不告诉我——他知道我们等了 10 年——他打了一对银鞋扣——一只刻 *Margarete*——一只刻 *Konrad*——他说："拿回去给 Margarete——等 Wilhelm 学走路——给他穿上——这是 Strasbourg 这边的旧规矩——*生子礼* 必须从一个**信得过的人**手里出来。"\n\n' +
        '——*信得过的人*——\n\n' +
        '——这 5 个字 1340 年我没多想——\n\n' +
      ...
      en:
        ...
        'Nine years later — the morning of February 14, 1349 — after I finished Margarete\'s soup — those four words came back into my head.\n\n' +
        'From that day on, they never left.',
    },
    deliverGoal: '[fallback]',
    engagementHook: 'Yitzhak 那年说"信得过的人"——9 年后我喝完汤——这 5 个字回来——我那天还没出门——你已经知道接下来会怎么样了',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我第一次听到是 9 月 18 日。地方是城南 *Marktplatz*（集市广场）——一个从 Basel（巴塞尔——莱茵河上游瑞士边境一个城邦）回来的酒商 Hans——他坐在我屠夫铺子台阶上喝啤酒——他说："Konrad——Basel 那边——三个井——三个犹太人被抓——拷打——他们承认了——他们说**犹太长老在 Toledo（西班牙南部）配毒药**——给所有欧洲犹太社区**分发**——让他们投井——为什么——因为犹太人想**毁了基督教世界**——"\n\n' +
        '我那天喝着啤酒。我笑了。\n\n' +
        ...
        '我那天没接他这句。\n\n' +
        '我那天回家——经过 *Judengasse*——我特意拐进去——到 Yitzhak 铺子门口——\n\n' +
        '——Yitzhak 那天在井边打水——Strasbourg 犹太区有自己的井——我朝他走过去——\n\n' +
        '——他递给我一个木瓢——他自己先喝了一口——他说："Konrad——你听到那个谣言了吧。"\n\n' +
        '我说："听到了。"\n\n' +
        '他说："你**信吗**？"\n\n' +
        '我说："不信。"\n\n' +
        '我接过木瓢——把他井里的水喝了一大口——\n\n' +
        '——水是甜的。Strasbourg 犹太区那口井是 Yitzhak 爷爷 1280 年代挖的——这是 Strasbourg 全城最甜的几口井之一——\n\n' +
      ...
      en:
        ...
        '*Not believing*, and *not believing five months later* — those are two different things.',
    },
    deliverGoal: '[fallback]',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我说："什么病？"\n\n' +
        'Margarete 说："发烧。咳嗽。Hans 老婆今天哭着来借蜂蜜——她说 Klaus 脖子下面起了一个红疙瘩——还不大——但她怕——她哭着问我——"她哭着问我——*Konrad 那个犹太人朋友的井——你最近还去喝吗*——"\n\n' +
        '——\n\n' +
        '——我没接她话。\n\n' +
        '我盯着壁炉里的火——\n\n' +
        '——红疙瘩——脖子下面——\n\n' +
        ...
        '——\n\n' +
        'Margarete 织了 5 分钟没说话——然后她说——"Konrad——我不是说 Yitzhak——Yitzhak 我也认识——他打的鞋扣 Wilhelm 还穿着——但**如果**——只是**如果**——*Heilige Maria* 不在场的时候——这种事**只要可能**——你能不能——下礼拜那个银扣——你能不能让 Margarethe（她妹妹）她男人去取——你别去那条街——就这一段时间——"\n\n' +
        '——*就这一段时间*——\n\n' +
        '——\n\n' +
        '我那天晚上躺在床上——Margarete 已经睡了——我盯着天花板——\n\n' +
        '——我心里**清楚**——\n\n' +
        '——Yitzhak 不会下毒——\n\n' +
        '——Hans 家 Klaus 病——跟 Yitzhak 没关系——可能是 Hans 老婆煮的水煮得不够——可能是 Klaus 在外面雪里玩太久——可能是 Strasbourg 这一年冬天太冷小孩子本来就容易病——\n\n' +
        '——但是——\n\n' +
        '——我第二天**没**去 *Judengasse*——\n\n' +
        '——我让 Margarete 妹妹的男人 Friedrich 去取了那对银扣——\n\n' +
        '——这是我跟 Yitzhak 8 年生意里——**第一次**——\n\n' +
        '——我**没自己去**。\n\n' +
        '——这一次"没自己去"——表面上是给 Margarete 一个安心——\n\n' +
        '——但其实——是我心里那块东西**第一次松动**——\n\n' +
        '——它松了 1 毫米——\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '1349 年 2 月 9 日——下午——Strasbourg *Rathaus*（市政厅）二楼会议厅——市议会 11 个人——*Bürgermeister* Schwarber + 10 个工会代表（屠夫 / 鞋匠 / 铁匠 / 羊毛 / 银匠等等——我是屠夫这一席）——\n\n' +
        '我们已经吵了 2 周。\n\n' +
        '*Bürgermeister* Schwarber——他 50 岁——他是 documented 历史人物，名字进了 Strasbourg 城市档案——他那天 5 分钟讲完他的立场——\n\n' +
        ...
        '——他说完。\n\n' +
        '——会议厅安静了 30 秒——\n\n' +
        '——然后铁匠工会的 Bertold 站起来——他声音很大——他说："Schwarber——你这是为犹太人**说话**——你拿了他们多少钱——"\n\n' +
        '——Bertold 这一句——不是**论证**——是**人身攻击**——但它有用——因为会议厅里 11 个人 9 个人**已经**被妻子 + 邻居 + 教士 4 个月磨过——\n\n' +
        '——Schwarber 站起来要回答——主教的代表 Friedrich 打断他——他说："Schwarber 失去市议会的信任。我提议罢免。投票。"\n\n' +
        '——\n\n' +
        '——*投票*——\n\n' +
        '——\n\n' +
        '——我那一刻——我心里告诉自己——\n\n' +
        '——"Konrad——你**只是**在投票罢免一个市长——你**不是**在投票屠人——下一步具体怎么处置犹太人——后面再讨论——你今天投的票——只是**程序问题**——"\n\n' +
        '——\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我得直接告诉你——我用 25 年时间想过该不该告诉你——但这是 lens——我必须直接说——否则我就在骗你。\n\n' +
        'Werd 岛——莱茵河西岸——河水冬天还在流——但靠岸的地方结了冰——岛上犹太墓地——平时安静——今天早上开始——*Strasbourg* 城里所有犹太人——男人 + 女人 + 孩子——被 *Stadtwache*（城卫队）+ 工会武装人员赶过来——\n\n' +
        '——\n\n' +
        '——大约 2000 人——\n\n' +
        '——历史 documented：narrative kernel §3 Rachel 章节确认这个数字——男人 + 女人 + 孩子——一个不留——*Strasbourg 整个犹太社区在那一天结束*——\n\n' +
        '——\n\n' +
        '我站在木堆边——\n\n' +
        '——木堆是前一天 *Metzgerzunft*（屠夫工会——*我*这个工会——我的人）+ 几个木匠工会的人一起架的——*Strasbourg* 城外的橡树砍下来劈成 1.5 米长的方木——堆成 8 个大堆——每堆围一圈干稻草——\n\n' +
        '——官员宣读了一段：那些**愿意接受洗礼**的人——可以活——**少数同意**——多数是老人和孩子——他们被领到一边——\n\n' +
        '——剩下的——**大多数**——他们说："*Adonai*（犹太人对神的称呼）不会让我们 deny 信仰救命"——他们站着——他们没跪下——男人开始念 *Sh\'ma Yisrael*——女人抱住孩子——\n\n' +
        '——\n\n' +
        '——我看见 Yitzhak。\n\n' +
        '——他在第三堆木堆前面——他妻子 Rachel 34 岁——挨着他——两个孩子 6 岁 4 岁——夹在两人中间——\n\n' +
        '——Yitzhak 看见我——\n\n' +
        '——\n\n' +
        '——他**没**喊——\n\n' +
        '——他**没**骂——\n\n' +
        ...
        '——*"我以为你不会"*——\n\n' +
        '——\n\n' +
        '——我那一秒——我心里那 9 月喝过的他井里那口水的甜味——回来——\n\n' +
        '——我那一秒——他 1340 年说的"信得过的人"5 个字——回来——\n\n' +
        '——\n\n' +
        '——我没动——\n\n' +
        '——我没说话——\n\n' +
        '——我没拦——\n\n' +
        ...
        '——火点起来——\n\n' +
        '——我没看完——\n\n' +
        '——我转身——我离开木堆——我走过岛上结冰的小桥——我走回 Strasbourg 城里——\n\n' +
        '——我背后——风把烟吹过来——我闻到——\n\n' +
        '——\n\n' +
        '——\n\n' +
        '——Yitzhak 那**一眼**——\n\n' +
      ...
      en:
        ...
        'This number is documented. The narrative kernel §3 chapter on Rachel confirms it. Men, women, and children. None left. *The entire Jewish community of Strasbourg ended on that day.*\n\n' +
    ...
    deliverGoal: '[fallback]',
    engagementHook: 'Yitzhak 那一眼——不是恨——是"我以为你不会"——25 年我闭眼能看见——你听过这种眼神吗',
    expectedLength: '380-420 字',
    expectsRealAnswer: false,
  },
  {
    ...
    content: {
      cn:
        ...
        '我点头。\n\n' +
        '她**没**回头——她说："汤好了。"\n\n' +
        'Wilhelm 8 岁——他从他卧室门里探出头——他看了我一眼——他**没**喊"*Vater*"——他**没**跑过来——\n\n' +
        '——他看了我一眼——然后他退回卧室——把门关上。\n\n' +
        '——\n\n' +
        '我坐到桌前。\n\n' +
        'Margarete 把一碗汤放到我面前——她终于转身看我——\n\n' +
        '——她看了我**整整 5 秒**——\n\n' +
        '——她**没**说话——\n\n' +
        '——她转身——回灶台——继续切萝卜——\n\n' +
        '——\n\n' +
        ...
        '——这个话题没有名字——\n\n' +
        '——但我们两人都知道——\n\n' +
        '——你不能提——你不能问——你不能哭——你不能道歉——\n\n' +
        '——你只能**绕开**——\n\n' +
        '——\n\n' +
        '——这是 1349 年 2 月 14 日傍晚——我家——*Strasbourg*——\n\n' +
        '——这一晚开始——我家这扇门——再没**真的**打开过——\n\n' +
        '——它每天还在物理上**开**和**关**——\n\n' +
        '——但门里那个家——\n\n' +
        '——\n\n' +
        '——已经**死**了。',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '——\n\n' +
        '6 月底——城南先开始——一个鞋匠学徒发烧——脖子下面——红疙瘩——3 天死——\n\n' +
        '——他没去过 *Judengasse*——\n\n' +
        ...
        '——但 plague **没**问我想换什么——它不挑——它只是**穿过**我的城——它带走了它要带走的——\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '——他 1349 年 2 月 14 日做的事——是一个**模板**——\n\n' +
        '——\n\n' +
        '——*这个模板被反复用*——\n\n' +
        '——\n\n' +
        '——**1881 年沙俄 pogrom**：俄罗斯沙皇 Alexander II 被刺——经济不好——找替罪羊——一年内乌克兰 / 俄罗斯 200+ 城镇屠杀犹太人——\n\n' +
        '——**1903 年 Kishinev pogrom**：摩尔多瓦一个小城——一个基督徒男孩被杀——谣言"犹太人杀基督徒小孩取血做无酵饼"——3 天屠杀 + 强奸——49 死——这是 20 世纪第一场被全球新闻报道的反犹屠杀——\n\n' +
        '——**1933 年纳粹 Kristallnacht**（"水晶之夜"）：德国全境一夜——上千犹太教堂烧——91 死 + 30000 抓——\n\n' +
        '——**1942 年 Wannsee Conference**：纳粹高级官员开会——决定"最终解决犹太人问题"——Holocaust 启动——600 万犹太人在 3 年内死——\n\n' +
        '——\n\n' +
        '——\n\n' +
        ...
        '——\n\n' +
        '——但这两件事都是真的——\n\n' +
        '——他**真心**相信——他**做了**——我们今天读懂了——我们没法假装他**没做**——\n\n' +
        '——\n\n' +
      ...
      en:
        ...
        '**1942 — Wannsee Conference.** Senior Nazi officials meet. They decide on the "Final Solution to the Jewish Question." The Holocaust begins. Six million Jews die in three years.\n\n' +
  ...
  // ═════ Synthesis（真 Socratic）═════
  {
    ...
    content: {
      cn:
        '你刚扮演了 Konrad——一个 38 岁的 Strasbourg 屠夫工会代表 + 市议会成员——他在 1349 年 2 月 9 日**投了赞成票**罢免 Schwarber——5 天后他站在 Werd 岛木堆旁——他**亲眼看着** Yitzhak 被烧——他**没**说话——他**没**拦——他余生 25 年闭眼能看到 Yitzhak 那一眼。\n\n' +
        '问题来了。Konrad 1349 年 2 月 9 日下午举手投票——\n\n' +
        '——这是 (a) **结构压力下的从众**（市议会 + 妻子 + 邻居孩子病——他个人拒绝意味着自我孤立——他可能丢掉议会席位 + 工会代表 + 在 Strasbourg 的社会位置）——\n\n' +
        '——还是 (b) **个人道德选择的失败**（他 10 年认识 Yitzhak——他 1340 年喝过他井里的水——他知道 Yitzhak 的为人——他选择**相信谣言**而**不**相信自己 10 年的观察）？\n\n' +
        '——历史学家跟伦理学家在这个问题上**两边都站得住**——\n\n' +
        '**一种说法 — 结构受害者读法（Hannah Arendt《Eichmann in Jerusalem》传统 / 社会心理学 Stanley Milgram 服从实验之后建立的"结构暴力"框架）**：Konrad 不是一个**特别坏**的人——他是一个**普通**人——*Strasbourg* 城邦 1349 年 2 月那 4 个月——市议会 + 主教 + 工会 + 妻子 + 邻居——5 个不同方向的压力**同时**指向他——任何一个个体都极难抵抗这种**多通道结构压力**——Schwarber **抵抗了**——Schwarber **被罢免了**——这就是 Strasbourg 这种从众体系**对个体抵抗的成本设计**——Konrad 投票——是一个普通人在**完全可预测**的结构压力下做出的**完全可预测**的选择——这个选择是**糟糕**的——但**主要责任在结构**——不在个体——Hannah Arendt 把这种现象叫"the banality of evil"（恶的平庸性）——Konrad 是这种现象 600 年前的一个早期标本——\n\n' +
        '**另一种说法 — moral agent 读法（亚里士多德传统 + 现代道德哲学 Bernard Williams）**：动机理由从不能洗白选择——Konrad 不是 14 岁少年——他**38 岁**——他认识 Yitzhak **10 年**——他**自己**1348 年 9 月**还**喝过 Yitzhak 井里的水——他**自己**1340 年从 Yitzhak 手里接过那对银鞋扣——他**有**完整的反证——他**有**自己 10 年的观察——他**有**Schwarber 那天在议会读出来的论证——他**选择**相信谣言而**不**相信自己——这**不是**结构压力下的"被迫"——这是**主动**的认知失败——他选择**逃避**自己已经知道的——把责任归给"结构"是 600 年后历史学家的**话术**——Konrad **自己**那一刻——他**知道**他在做什么——证据是他 25 年闭眼能看到 Yitzhak 那一眼——如果他真是"被迫"——他**不会**有这种持续 25 年的**自我审判**——他 25 年里**自己**给自己做了陪审员——他**自己**判了自己有罪——只是他**没**公开宣判。\n\n' +
        '两边都站得住——一种说法 走"结构压力下的普通人"看，另一种说法 走"moral agent 拥有完整反证仍然选择相信谣言"看。\n\n' +
      ...
      en:
        ...
        '**One view — the structural-victim reading (the tradition of Hannah Arendt\'s *Eichmann in Jerusalem*; the framework of "structural violence" that grew out of social-psychology experiments by Stanley Milgram on obedience).** Konrad was not an **unusually bad** man. He was an **ordinary** man. In the four months before February 9, 1349, five different vectors of pressure — the council, the bishop, the guilds, his wife, his neighbors — all pointed at him at once. Almost no individual can resist this kind of **multi-channel structural pressure**. Schwarber **did** resist. Schwarber **was removed**. That was Strasbourg\'s **cost-design for individual resistance** in a conformist system. Konrad\'s vote was an ordinary person\'s **fully predictable** response to **fully predictable** pressure. The choice was **bad**, but the **main responsibility lies with the structure**, not with the individual. Hannah Arendt called this phenomenon *the banality of evil*. Konrad is an early specimen of it from six hundred years before her writing.\n\n' +
    ...
    deliverGoal:
      ...
      '**另一种说法（moral agent / 亚里士多德伦理传统）**：他有 10 年观察 Yitzhak——他喝过他井里的水——他有 Schwarber 那天的反证——他选择相信谣言而不相信自己——这是主动的认知失败——他 25 年闭眼能看到 Yitzhak 一眼证明他自己知道。' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '——他只在遗嘱里悄悄做了一点事——一笔每年 2 月 14 日的弥撒（不指明为谁）+ 一对刻 Margarete / Konrad 的银鞋扣放进自己棺材——\n\n' +
        '——\n\n' +
        '——这一点事——是大是小？\n\n' +
        '——\n\n' +
        '**一种说法 — 道德上的懦夫读法（modern transitional justice tradition / Truth-and-Reconciliation 框架，Desmond Tutu / 南非真相与和解委员会的"公开承认是和解前提"立场）**：明知道错了**不公开承认**——是对那 2000 个死者的**二次伤害**——*Strasbourg* 后来 600 年里学校里的孩子们被告诉的是"1349 年屠犹是因为犹太人下毒"或者"是因为大众恐慌没人能制止"——这些**模糊的集体性叙事**——一直让**反犹的种子在结构里活下来**——直到 1942 年又长出 Holocaust——*如果*Konrad 1374 年遗嘱里**说清楚**——"我 1349 年 2 月 9 日投票罢免 Schwarber 那一票是错的——我 1349 年 2 月 14 日没拦那场屠杀是错的——犹太人没下毒——plague 来 Strasbourg 不是因为他们——我请求宽恕"——*这一份遗嘱*——会成为 Strasbourg 城市档案——1881 年沙俄 pogrom 时 + 1933 年纳粹 Kristallnacht 时——会有人**找出来读**——会有人说"600 年前已经有 perpetrator 自己说过这是错的"——*公开承认*是反 Holocaust 教育最有力的武器——Konrad 选择**沉默**——是把这个武器**留在地里 600 年**——Konrad 是**道德上的懦夫**——他对死者的二次伤害——比他原先那一次更长——\n\n' +
        '**另一种说法 — medieval contextualism 读法（中世纪社会史学派，特别是 R.I. Moore《The Formation of a Persecuting Society》传统）**：1374 年的 Strasbourg——**没有**21 世纪意义的"truth-and-reconciliation 委员会"——**没有**报刊——**没有**"个人公开忏悔"的社会概念（当时的忏悔是**私下**对神父说——不是对城邦说）——*Konrad 公开承认错*会被理解为**亵渎神明**（"如果 1349 年屠犹是错的——那等于说当年市议会 + 主教 + 教会全部错了——这是质疑教会权威——这是异端"）——他会被**烧死**——他儿子 Wilhelm 会失去屠夫铺子——他孙子会被赶出 Strasbourg——他公开承认错的代价——是**他家几代人**承担——**没有**任何 14 世纪 Strasbourg 公民会把"我个人公开承认错"当成有意义的选项——Konrad 在他的**时代约束**内**做了他能做的最大补偿**——一笔每年弥撒 + 银鞋扣陪葬——这是 medieval 道德语法允许的最大公开行为——把他用 21 世纪 truth-and-reconciliation 的标准评判——是**时代错置**（anachronism）——Konrad 不是**懦夫**——他是一个**做了能做的所有事的人**——只是 medieval 社会能允许的"承认"——比 21 世纪我们想象的**小得多**——\n\n' +
        '两边都站得住——一种说法 走"公开承认是反复发生悲剧的唯一武器"看，另一种说法 走"medieval 时代约束之内 Konrad 已经做了能做的所有事"看。\n\n' +
        '你怎么看？Konrad 余生 25 年没公开承认错——更靠近一种说法（道德上的懦夫）还是另一种说法（medieval 时代约束之内已尽力）？想 30 秒。\n\n' +
      ...
      en:
        ...
        '**One view — the moral-coward reading (modern transitional justice tradition; the position taken by Desmond Tutu and the South African Truth and Reconciliation Commission, that "public admission is the prerequisite for reconciliation").** To know you were wrong and **not publicly say so** is a **second injury** to the dead. For six hundred years afterward, the children of Strasbourg were told either "1349 happened because the Jews poisoned the wells" or "1349 was a panic no one could stop." These vague collective narratives **kept the seeds of antisemitism alive in the structure** — until they grew into the Holocaust in 1942. If Konrad\'s 1374 will had said clearly: "My vote to remove Schwarber on February 9, 1349 was wrong. My silence at the burning on February 14, 1349 was wrong. The Jews did not poison the wells. Plague did not come to Strasbourg because of them. I ask forgiveness." — that document would have entered the Strasbourg city archive. In 1881, during the Russian pogroms; in 1933, during Kristallnacht — someone could have **pulled it out and read it**. Someone could have said, "Six hundred years ago a perpetrator already said this was wrong." **Public admission** is the strongest weapon against the next Holocaust. Konrad chose **silence**. He left that weapon **in the ground for six hundred years**. He was a **moral coward**, and his second injury to the dead lasted longer than the first.\n\n' +
        ...
        'What do you think? Konrad\'s twenty-five years of silence — closer to the first view (moral coward) or the other view(within his time, he did all he could)? Take thirty seconds.\n\n' +
    ...
    deliverGoal:
      ...
      '**一种说法（道德上的懦夫 / truth-and-reconciliation 传统）**：公开承认是反复发生悲剧的唯一武器——他选择沉默——把这武器留在地里 600 年——他对死者的二次伤害比第一次更长。' +
      '**另一种说法（medieval contextualism / R.I. Moore 传统）**：14 世纪 Strasbourg 没有"公开忏悔"的社会概念——他公开承认会被烧死——他在时代约束内做了能做的所有事——一笔弥撒 + 银鞋扣陪葬——是 medieval 道德语法允许的最大公开行为——用 21 世纪标准评判他是 anachronism。' +
      '——你怎么看，是道德上的懦夫还是 medieval 时代之内已尽力？',
    engagementHook:
      '**你怎么看**——Konrad 余生 25 年没公开承认错——是道德上的懦夫还是 medieval 时代约束之内已尽力？想 30 秒',
  ...
  // ═════ Meta（反思 + 桥）═════
  {
    ...
    content: {
      cn:
        ...
        '(2) **换 lens 重玩——同一场 1349 Strasbourg 屠杀——但从另一个视角**：Devorah——一个 14 岁 Strasbourg 犹太女孩——她的父亲是一个银匠——她爬出地窖看见一个城里没有犹太人的世界——她跟你刚演完的 Konrad 是**同一天**——但她**没**站在木堆边——她**藏在**地窖里——你做完 Devorah 这一遍——你会**自己**connect 一些事——这一遍 Konrad 没告诉你的——Devorah lens 也不会**直接**告诉你——但**两个 lens 走完**——你会**自己**看见——\n\n' +
        '(3) 也可以问自己一个真问题：你身边——你的同学 / 邻居 / 家人——有没有人因为某个**谣言**或者某个**集体情绪**——做过一件他们后来**知道是错**的事？他们**公开承认**了吗？他们**没**公开承认——你怎么看他们？\n\n' +
        '——这个问题——是 Konrad 这一遍 lens 留给你的最后一份礼物。',
      en:
    ...
    deliverGoal:
      ...
      '(2) 换 lens 重玩——Devorah（14 岁 Strasbourg 犹太女孩幸存者）——同一天但从地窖里看 / ' +
      '(3) 想想你身边——有没有人因为谣言或集体情绪做过一件后来知道是错的事——他们公开承认了吗——没有的话你怎么看他们',
    engagementHook:
      '**Konrad 这一遍——最让你停一下的是什么**？是早上手抖出门？1340 银鞋扣"信得过的人"5 个字？12 月 Margarete 那句"就这一段时间"？2 月 9 日"我只是投程序"？2 月 14 日 Yitzhak 那一眼"我以为你不会"？傍晚 Margarete 看他 5 秒？7 月 5 日 Margarete 凉的手？还是 1374 银鞋扣陪葬？说一句话',
...
//
// fourth-wall break 留在 N12——让用户做完两个 lens 自己 connect Yitzhak = Devorah 父亲
...
var devorahStrasbourgStoryboard = [
  {
    ...
    content: {
      cn:
        ...
        '我 14 岁。我叫 Devorah。\n\n' +
        '*Ima*（妈妈，希伯来语）正在教我念 *Tehillim* 第 23 篇——"耶和华是我的牧者，我必不至缺乏"——这是我从 5 岁就开始念的——但今天她念得特别慢——她一句一句让我重复——我没问她为什么。\n\n' +
        '厨房窗外——8 岁的 Klara——基督徒——她妈妈是 Schmidt 太太——上个月她还会跟我隔着窗户笑——上礼拜还会喊"Devorah!"——\n\n' +
        '今天早上 Klara 走过我家窗户——她低头——她没看我——\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '*Ima* 叫 Miryam——36 岁——她不识字（女孩家里学的是织布 + 唱 *Tehillim*——不是读书）——但她会唱 50 首 *Tehillim* + 缝衣服 + 主持 *Shabbos*（安息日）餐桌。\n\n' +
        '我弟弟 Asher 11 岁——跟 *Aba* 学银匠手艺——他敲扁银片的时候很认真——他认真起来不眨眼。\n\n' +
        '我妹妹 Sarah 4 岁——她最爱跟我编辫子——她编不进去就哭——我每天给她编两次。\n\n' +
        '我自己——14 岁——识希伯来字——会一点德语——*Ima* 教我针线和 *Tehillim*——*Aba* 教我怎么擦银器（用一种灰色的粉，叫 *rouge*）——他说："Devorah——你 14 岁了——明年开始我教你算账。"\n\n' +
        '隔壁住一个基督徒邻居——叫 Brigitta——30 岁——织布女工——她是 *Ima* 的"商业邻居"——*Ima* 给她做银扣——Brigitta 给我们换布——10 年了。\n\n' +
        '这就是我 14 岁的世界。\n\n' +
      ...
      en:
        ...
        'Myself — fourteen — I read Hebrew, a little German. *Ima* teaches me sewing and *Tehillim*. *Aba* teaches me how to polish silver (with a grey powder called *rouge*). He says: "Devorah — you are fourteen now — next year I will teach you accounts."\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '*Ima* 那一刻没说话——她点头——然后回家——她没告诉我她和 Schmidt 太太说了什么——但我从厨房门缝里看到——她眼睛红了。\n\n' +
        '我 14 岁——我**第一次**懂"邻居"是会变的。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '1349 年 2 月 9 日——傍晚——*Aba* 从市集回来——\n\n' +
        '他**没脱外套**就坐下——他脸色不对——他喝了一口 *Ima* 给他的水——他放下杯子——他对 *Ima* 说："Schwarber 被罢免了。"\n\n' +
        '*Ima* 站住——\n\n' +
        '我 14 岁——我在屋角整理 *Aba* 铺子的银针——我**第一次**听到"Schwarber"这个名字——*Aba* 后来跟我解释：他是 *Bürgermeister*——市长——50 岁——他在市议会反对"屠犹"——他说"井下毒"是谣言——是 Italy plague 已经在路上——\n\n' +
        '——但他被罢免——10:1——一个老铁匠的代表 Bertold 当面骂他"拿了犹太人多少钱"——*Aba* 知道这件事是因为 Strasbourg 城里基督徒商人朋友 Hans Becker 那天下午回来路上告诉他的。\n\n' +
        '*Aba* 那天晚上——第一次——直接对我说话：\n\n' +
        '"Devorah——你 14 岁了——你要听我说一些事——"\n\n' +
        '我 14 岁——*Aba* 一辈子从来不直接对我说"你要听我说一些事"——他一直只对 *Ima* 说——我那一刻**心里炸了一下**——\n\n' +
        '*Aba* 说：\n\n' +
        '"我们家 Yitzhak ben Abraham 这一支——在 Strasbourg 已经 200 年——你的曾祖父 Avram ben Yosef 1149 年从 Worms 搬来——他和 Strasbourg 大主教是朋友——我们家给 Strasbourg 大教堂打过 50 件银器——这是我们 200 年的家——但今年——不一样——你要懂——一个 200 年的家——可能在 5 天内变成不是家——这种事在历史上发生过——你是 Yitzhak ben Abraham 的女儿——你必须知道——这种事可能发生——也可能在你身上发生。"\n\n' +
        '我 14 岁——我没说话——我只是把那些银针——一根一根——放进盒子。',
      en:
  ...
  },
  {
    ...
    content: {
      cn:
        '2 月 13 日——傍晚——Brigitta 来了。\n\n' +
        '我们家——*Judengasse* 第三家——夜里——\n\n' +
        '她进门——*Ima* 还没说话——Brigitta 已经在哭——她抓住 *Ima* 的手——她说："Miryam——明天——市议会在 *Rathaus* 决定——他们要把所有犹太人聚到 Werd 岛——架木堆——明天早上——"\n\n' +
        '*Ima* 站住——*Aba* 从铺子那边走过来——他听到了——他没说话——\n\n' +
    ...
    deliverGoal: '[fallback]',
    engagementHook: 'Brigitta 来——10 年的基督徒邻居——冒生命危险藏我们——14 岁的我第一次懂"基督徒不是 binary 的"——下一节是 2 月 14 日地窖里那一整天',
    expectedLength: '320-360 字',
    expectsRealAnswer: false,
  },
  {
    ...
    content: {
      cn:
        ...
        '地窖很小——有一袋面粉——一袋盐——一桶酒——空气是冷的——但更冷的是——窗框里漏进来的光——一整天——慢慢从灰变到黄——再到红。\n\n' +
        '上午——大概 9 点——我们听见——\n\n' +
        ...
        '——火——\n\n' +
        '——\n\n' +
        '4 岁的 Sarah——她想哭——*Ima* 用手堵她的嘴——*Ima* 的手在抖——\n\n' +
        '我 14 岁——我抱住 Sarah——Sarah 咬我手——她的眼泪流到我手上——是温的——\n\n' +
        '我开始念。\n\n' +
        '*Adonai roi lo echsar* —— 耶和华是我的牧者，我必不至缺乏——\n\n' +
        '一遍。\n\n' +
        '*Adonai roi lo echsar* —— 耶和华是我的牧者，我必不至缺乏——\n\n' +
        '两遍。\n\n' +
        '我念到第 30 多遍——我自己分不清——这句话——是不是真的。\n\n' +
        '空气里——一种味道——飘进来——一种 14 岁的我——这辈子——永远忘不了的味道。\n\n' +
        '地窖里——*Aba* 闭着眼——他没念 *Tehillim*——他只是闭眼——他的嘴在动——但没有声音——\n\n' +
        '——傍晚——光从红变成深红——再到黑——\n\n' +
        '——外面安静下来。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '是 Hans。\n\n' +
        '我们 5 个人在地窖里——屏住呼吸——\n\n' +
        'Brigitta 在上面跟 Hans 说话——她的声音低——她说："Hans——我求你——10 年——Miryam 给我们家做的银扣——"\n\n' +
        'Hans 的声音不低——他说："Brigitta——你藏犹太人——明天有人发现——他们会烧我们——"\n\n' +
        '我 14 岁——我那一刻**第一次**懂："冒生命危险"不是 abstract——是这个具体的男人——这一刻——他在算——他能不能用我们换他的命。\n\n' +
        '*Aba* 推开我——他从地窖梯子上去——\n\n' +
        '我看着我爸——39 岁——一辈子做银匠——我从来没看过他跪——\n\n' +
        '他上去了——\n\n' +
        '——3 分钟后——\n\n' +
        '——他下来——他手里有一个东西——他打开——\n\n' +
        '——一对银耳坠——\n\n' +
        '——这是 *Ima* 的妈妈 25 年前给 *Ima* 做的——*Ima* 一辈子就戴这一对——*Ima* 一辈子说："这是我从我妈那里带过来 Strasbourg 的唯一一件——"\n\n' +
        '*Aba* 把银耳坠递给 *Ima*——\n\n' +
        '*Ima* 看着银耳坠——她没哭——她**摘下**自己耳朵上的那一对——她递给 *Aba*——\n\n' +
        '*Aba* 上去——\n\n' +
        '——5 分钟——\n\n' +
    ...
    deliverGoal: '[fallback]',
    engagementHook: '半夜 Hans 回家——*Aba* 一辈子没跪过——今天晚上他跪了——他用 *Ima* 妈妈 25 年前的银耳坠换我们到天亮——下一节是 4 点钟出 Strasbourg 东门',
    expectedLength: '360-400 字',
    expectsRealAnswer: false,
  },
  {
    ...
    content: {
      cn:
        '2 月 15 日——凌晨 4 点——Strasbourg 东门——\n\n' +
        '——城外——黑——雪刚停——空气干——\n\n' +
        '我们 5 个人——*Aba* 抱 Sarah——*Ima* 牵 Asher——我自己走——\n\n' +
        '——往东——\n\n' +
        '*Aba* 跟 *Ima* 说："Krakow——波兰国王 Casimir III 收容犹太人——一路东走——大概 6 个礼拜——"\n\n' +
        '我 14 岁——我那一刻知道——"6 个礼拜"——这种数字——不是计划——是一种"我们必须相信能到的距离"。\n\n' +
        '——一个礼拜——我们在 Black Forest 边——\n\n' +
        '——两个礼拜——我们到 Bavaria——\n\n' +
        '——三个礼拜——\n\n' +
        '2 月底——某个森林边——晚上——\n\n' +
        '*Aba*——倒下了——\n\n' +
        '他 39 岁——他没病——他只是——走不动了——他对 *Ima* 说："Miryam——你带孩子——继续走——"\n\n' +
        '*Ima* 摇头——\n\n' +
        '*Aba* 说："Krakow——犹太社区——他们会收你们——你只要——到——就行——"\n\n' +
        '——他闭眼——\n\n' +
        '——一夜——\n\n' +
        '——天亮——他凉了。\n\n' +
        '我 14 岁——帮 *Ima* 埋 *Aba*——\n\n' +
        '——森林边——地是冻的——我们挖不动——\n\n' +
        '——*Ima* 说："用石头——"\n\n' +
        '我和 *Ima* 用石头——堆了一个小坟——大概 30 块石头——14 岁的我那一刻**意识到**——\n\n' +
        '我以后想 *Aba*——\n\n' +
        '——只能想到这个石头堆。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '1349 年春——Devorah 14 岁——Miryam 36 岁——Asher 11 岁——Sarah 4 岁——4 个人——走了 6 个礼拜——到了 Krakow（克拉科夫——波兰南部）——\n\n' +
        '波兰国王 Casimir III "the Great"——1334 年颁布 *Statute of Kalisz*（卡利什法令）保护犹太人——这是中世纪欧洲最早的犹太人保护法。Krakow 犹太社区收容了他们——Miryam 做了 Krakow 一个犹太家庭的女佣——Devorah 14-18 岁帮母亲 + 学希伯来语 + 学一点波兰语——\n\n' +
        '1352 年 18 岁——Devorah 嫁给 Krakow 一个犹太商人 Avram ben Shimon——30 岁——他妻子也死于 plague 第二波——他需要新妻子——Devorah 需要家——\n\n' +
        'Devorah 18-74 岁——56 年——4 个孩子——8 个孙子孙女——\n\n' +
        '——1408 年——Devorah 74 岁——\n\n' +
        '孙女 Rivka 13 岁——夏天某个下午——她坐在 Devorah 床边——她问："Bubbe——为什么我们家在 Krakow 不在 Strasbourg？"\n\n' +
        'Devorah 那一刻——59 年了——\n\n' +
        '——**第一次**——给孙女讲那个 1349 年 2 月 14 日——\n\n' +
        '——Brigitta——地窖——*Tehillim* 第 23 篇 30 多遍——半夜 Hans——*Aba* 跪——银耳坠——4 点出门——森林——*Aba* 在森林边倒下——30 块石头——\n\n' +
        '——讲完——Devorah 看着 13 岁的 Rivka——\n\n' +
        '——她说了一句话——\n\n' +
        '——这一句话——你猜——\n\n' +
        'Devorah 1408 年那一刻给 13 岁孙女讲完故事——她说的最后一句话——是这个 lens 的 emotional payoff——下一节我会让你思考。\n\n' +
        ...
        '这个机制——不是个别坏人——是**结构性的**——灾难时找替罪羊——这一机制 600 年间反复用——Holocaust 是终极版本。\n\n' +
        '这个机制——今天还在——只是替罪羊换人——逻辑不变。\n\n' +
      ...
      en:
        ...
        'Polish king Casimir III "the Great" had issued the *Statute of Kalisz* in 1334 — a charter protecting Jews — the earliest legal protection of Jews in medieval Europe. The Krakow Jewish community took them in. Miryam became a servant in a Krakow Jewish household. From fourteen to eighteen, Devorah helped her mother, learned more Hebrew, and learned a little Polish.\n\n' +
  ...
  },
  {
    ...
    content: {
      ...
      en:
        ...
        '**The other view — the collapse of faith.** Modern trauma psychology (Bessel van der Kolk, *The Body Keeps the Score*; Judith Herman, *Trauma and Recovery*) teaches us: under the deepest trauma, the most common thing the brain does is **repetition of a familiar action**. Saying a line thirty-some times — not because you believe the line — but because you **cannot stop**. Your brain uses the action to fill the space the fear has left. At thirty-some, Devorah herself **could no longer tell whether the line was true** (the lens text says this directly). This is not faith. This is traumatic grasping — the muscle memory left over after faith has already collapsed. In that moment she no longer believed. But she kept reciting because she did not know what else to do.\n\n' +
        'Both readings stand —\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '两种说法都站得住——\n\n' +
        '——59 年了——Devorah 活到 74 岁——她在 Krakow 重建了家——她生了 4 个孩子 + 8 个孙子孙女——\n' +
        ...
        'narrator 这里要诚实告诉你：**Devorah 1408 年那一刻到底说了什么**——lens 不告诉你——因为这个**取决于你怎么读 Devorah**——\n\n' +
        '——她经历了那 4 个月——她跨过了 59 年——她坐在 Krakow 一张床上——她看着 13 岁的孙女——她要把什么留给她？\n\n' +
        '一句"放下"——还是一句"识别"？\n\n' +
        '你给孙女选哪一句？\n\n' +
        '——这一题**没有正确答案**——但你的选择**说出你怎么理解 Devorah 这个 lens**——\n\n' +
        '想 30 秒。',
      en:
    ...
    deliverGoal:
      ...
      '——你给孙女选哪一句？',
    engagementHook: '**你怎么看**——你给 13 岁孙女 Rivka 选哪一句？"放下"还是"识别"？想 30 秒',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '是地窖里 *Tehillim* 第 23 篇——念到第 30 多遍——你自己分不清这句话是不是真的？\n\n' +
        '是半夜 *Aba* 跪给 Hans——你一辈子没看过他跪？\n\n' +
        '是森林边——*Aba* 39 岁倒下——30 块石头——你从此想他只能想到这个石头堆？\n\n' +
        '还是 1408 年 74 岁的你坐在 Krakow 一张床上——看着 13 岁的 Rivka——你说的那一句话？\n\n' +
        '说一句话告诉我。\n\n' +
        '\n\n' +
        '——\n\n' +
        '\n\n' +
        ...
        '——如果你做完 Konrad lens——你会发现一个 micro-detail——\n' +
        '——我**不告诉你**是什么——\n' +
        '——让你自己 connect——\n\n' +
        '——这个 connect 的瞬间——是 Story-First Pedagogy lens 体系给你的最强一击——\n' +
        '——比一个 narrator 直接告诉你"这两个 lens 是相连的"——重 100 倍。\n\n' +
        '然后——准备好了吗？记忆考核：拼写、定义、应用题——把今天演过的——变成你真正记得的。',
      en:
    ...
    deliverGoal:
      '你扮演了 Devorah bat Yitzhak 9 节——14 岁的 4 个月 + 59 年后的最后一句——' +
      '现在你可以选：' +
      '(1) 进 mastery 通关 / ' +
      '(2) 换 lens 重玩——比如 Agnolo（Siena chronicler）或 Konrad（Strasbourg perpetrator）——' +
      '——做完 Konrad 你会发现一个 micro-detail——这个 connect 是 lens 体系最强一击',
    engagementHook:
      '**Devorah 这一遍——最让你停一下的是什么**？是 Klara 不打招呼？*Aba* 第一次直接对你说话？地窖 *Tehillim* 30 多遍？*Aba* 跪给 Hans？森林 30 块石头？还是 1408 年最后那一句？说一句话',
    expectedLength: '440-500 字',
    expectsRealAnswer: true,
  },
];
...
export var lenses = {
  ...
  'konrad-strasbourg': {
    ...
    name: 'Konrad of Strasbourg',
    nameCn: 'Konrad（Strasbourg 屠夫工会代表 / 1349 反犹屠杀 perpetrator）',
    role: 'Strasbourg 屠夫工会代表 + 市议会成员 / 1349/02/14 反犹屠杀 perpetrator-actor 视角',
    description:
      '你扮演 Konrad——一个虚构的 Strasbourg 38 岁屠夫工会代表 + 市议会成员（4 代屠夫家族 / 城邦 1334 年改革后工会有议会席位）——他 1340 年从犹太银匠 Yitzhak 手里接过那对刻字银鞋扣——他 1348 年 9 月还喝过 Yitzhak 井里的水——但他 1349 年 2 月 9 日下午**投了赞成票**罢免反对屠犹的 *Bürgermeister* Schwarber——5 天后他站在 Werd 岛木堆边看见 Yitzhak 那一眼——他 7 月 5 日凌晨握着已经凉的 Margarete 的手第一次问"为什么犹太人也死了那么多"——他活到 1374 年——25 年没公开承认错——只在遗嘱里把那对银鞋扣放进自己棺材陪葬。这个 lens 让你从 perpetrator 内部经历"真心相信"机制——和它被现实证伪之后的 25 年。',
    storyboard: konradStrasbourgStoryboard,
  },
  'devorah-strasbourg': {
    id: 'devorah-strasbourg',
    name: 'Devorah bat Yitzhak',
    nameCn: 'Devorah（虚构 14 岁 Strasbourg 犹太女孩 / 1349 屠杀幸存者）',
    role: 'Strasbourg 14 岁犹太女孩 / 1349/02/14 屠杀幸存者 / receiving end 视角',
    description:
      '你扮演 Devorah bat Yitzhak——一个虚构的 14 岁 Strasbourg 犹太女孩（与用户女儿 Willow 同龄段代入设计）——她父亲 Yitzhak ben Abraham 是 *Judengasse* 的银匠——1348 年 11 月某日早上 8 岁基督徒邻居 Klara 走过她家窗户没看她——她 14 岁第一次懂"邻居会变"——1349 年 2 月 13 日晚基督徒邻居 Brigitta 冒生命危险藏她家 5 口在地窖——2 月 14 日地窖里念 *Tehillim* 第 23 篇 30 多遍——半夜父亲跪给 Hans 用 *Ima* 妈妈 25 年前的银耳坠换到天亮——2 月 15 日凌晨 4 点出 Strasbourg 东门往 Krakow——2 月底父亲在森林边倒下——她 14 岁帮母亲用 30 块石头堆了父亲的坟——59 年后 1408 年她 74 岁——孙女 Rivka 13 岁问她"为什么我们家在 Krakow 不在 Strasbourg"——她说的最后一句话——是这个 lens 的 emotional payoff。**跟 Konrad lens 形成对位 echo——做完两个 lens 用户会发现 Yitzhak 是同一个人。**',
