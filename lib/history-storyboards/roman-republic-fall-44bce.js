...
export var landlessPlebeianLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是一个挤在罗马城出租屋里饿着肚子的失地平民（合成人物，把那年代成千上万失地农民和退伍兵的真实遭遇凑成一个具体的人）。祖上有过一小块地，他自己替罗马当过兵打过几年仗，回家发现地已经被旁边大贵族低价吞走了。这一遍让你站在他攥着一张投票小木牌、今天有人要花一袋面包钱来买它的位置，看他要不要把这张选票卖出去，看一个共和国是怎么从最底下被一张一张选票卖空的。',
