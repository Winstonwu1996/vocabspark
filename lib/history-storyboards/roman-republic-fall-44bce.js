...
export var landlessPlebeianLens = {
  ...
  description: {
    ...
    en: 'He is a landless Roman plebeian crowded into a rented room and going hungry (a composite figure, gathering the real experiences of thousands of landless farmers and discharged veterans of that age into one). His family once held a small plot; he soldiered for Rome and came home to find the great noble next door had bought it out cheap. This pass puts you with him as he clutches a small wooden voting token that someone today wants to buy with a sack of grain, watching whether he sells this vote, the way a republic is sold empty from the very bottom, one vote at a time.',
  },
  storyboard: [
    {
      id: 'lp-n1',
