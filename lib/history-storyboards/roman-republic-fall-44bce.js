...
export var juliusCaesarLens = {
  ...
  icon: '🗡️',
  description: {
    cn: '他是站在一条窄得能蹚过去的小河边的罗马将军,身后是跟了他九年打遍高卢的军团,前面是元老院刚下的「交出兵权一个人回罗马」的命令,还有 500 年的共和国。这一遍让你坐进他在 Rubicon 河边那一刻的位置,交兵权就是案板上的肉、不交就是叛国,他清楚自己借了天文数字的债办过最大的竞技和宴席收买了平民的选票,看他下一步要不要说出那句「骰子已经掷出去了」。',
    en: 'He is a Roman general standing at a river so narrow he can wade across, behind him the legions who have followed him nine years across all of Gaul, before him the Senate\'s fresh order to "surrender your command and return to Rome alone," and five hundred years of Republic. This pass puts you in his place at the bank of the Rubicon: to surrender is to be meat on the block, to refuse is treason, and he knows full well he has borrowed sums beyond counting to throw the grandest games and feasts and buy the votes of the common people, and you watch whether he is about to speak the line, "the die is cast."',
  },
  storyboard: [
    {
      id: 'jc-n1',
...
export var ciceroLens = {
  ...
  icon: '📜',
  description: {
    cn: '他是一个站在元老院里的罗马人,周围坐的不是将军就是大贵族,他来自城外小镇 Arpinum,这辈子没带过兵也没握过剑,手里只有一样东西:语言。这一遍让你坐进他刚用一连串演说当场拆掉 Catiline 武装政变的高光时刻冷静下来的位置,他赢了这一仗可看清不断生产「Catiline 追随者」的根一点没动,看他要靠什么撑住「好的演说和法律能把这个国家从悬崖边拉回来」这件越来越没人信的事。',
    en: 'He is a Roman in the Senate surrounded by generals and great nobles, himself from a small town outside the city called Arpinum, who has never commanded a soldier or gripped a sword, holding only one thing in his hand: language. This pass puts you in his seat as he cools down from the shining moment when his string of speeches dismantled Catiline\'s armed coup on the spot; he won that fight, yet sees that the root which keeps producing "followers of Catiline" has not moved at all, and you watch what he holds on to in order to keep believing the thing fewer and fewer believe, that a speech good enough and a law just enough can pull this country back from the cliff edge.',
  },
  storyboard: [
    {
      id: 'ci-n1',
...
export var landlessPlebeianLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是一个挤在罗马城出租屋里饿着肚子的失地平民,祖上有过一小块地,他自己替罗马当过兵打过几年仗,回家发现地已经被旁边大贵族低价吞走了(一个合成人物,把那年代成千上万失地农民和退伍兵的真实遭遇凑成一个具体的人)。这一遍让你站在他攥着一张投票小木牌、今天有人要花一袋面包钱来买它的位置,听他知道父辈把希望押在格拉古兄弟那场合法改革上、结果带头的人被当街打死,看他要不要把这张选票卖出去:一个共和国是怎么从最底下被一张一张选票卖空的。',
    en: 'He is a landless Roman plebeian crowded into a rented room in the city and going hungry, his family once held a small plot of land, and he himself soldiered for Rome through years of war and came home to find the great noble next door had bought the land out cheap (a composite figure, gathering the real experiences of thousands of landless farmers and discharged veterans of that age into one specific person). This pass puts you with him as he clutches a small wooden token for voting that someone today wants to buy with a sack of grain; he knows his father\'s generation staked all their hope on the Gracchi\'s lawful reform and watched the brothers clubbed to death in the street, and you watch whether he is about to sell this vote, the way a republic is sold empty from the very bottom, one vote at a time.',
  },
  storyboard: [
    {
      id: 'lp-n1',
