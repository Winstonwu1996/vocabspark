...
export var albertSpeerLens = {
  ...
  description: {
    ...
    en: 'He is the one senior Nazi at the 1945 Nuremberg dock who stood and took the count while others blamed the dead Hitler. People called him "the good Nazi," yet he was no thug, but a respectable architect Hitler picked at a glance to run all of Germany\'s war production. This pass sits you in court with him, watching a cultured man hand his skill, step by step, to a machine for killing.',
  },
  storyboard: [
    {
      id: 'speer-n1',
...
export var chiuneSugiharaLens = {
  ...
  description: {
    ...
    en: 'One summer morning in 1940 he drew back the curtain of Japan\'s consulate in Lithuania to find hundreds, then thousands, of Jewish refugees pressed against the iron gate, the Nazis behind them, asking only for a visa that could let them leave the continent alive. He is the vice-consul, a rule-following diplomat. Three times he has cabled Tokyo, three times been told no. This pass sits you with him at the desk: a thousand lives outside, a pen in his hand, a "do not" on the desk, and he must choose, obey and keep his career, or pick up the pen.',
  },
  storyboard: [
    {
      id: 'sugihara-n1',
...
export var manzanarNiseiGirlLens = {
  ...
  description: {
    ...
    en: 'She is the child who, on the evening of 7 December 1941, watched her mother burn everything Japanese in their California yard (a composite figure standing for the ten thousand real Japanese-American children sent to the camps). Born in California, she can recite the Pledge of Allegiance and loves hot dogs, an American citizen from birth. Yet after Pearl Harbor the way people on the street looked at her changed overnight, because she wore "the enemy\'s face." This pass walks her through one reckoning: by what right does her own country lock her up by a face?',
  },
  storyboard: [
    {
      id: 'mn-n1',
    ...
    {
      id: 'mn-n3',
      // 孩子刚读到「这是政府盖了章的」，紧接着看命令原文
      sourceRef: 'eo-9066-1942',
      type: 'narrative',
      phase: 'setup',
      content: {
