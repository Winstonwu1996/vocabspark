...
export var albertSpeerLens = {
  ...
  icon: '📐',
  description: {
    cn: '他是 1945 年纽伦堡被告席上唯一站起来认账的纳粹高官，旁边一排人都喊冤或推责给已自杀的希特勒，只有他说「作为这个政府的领导人之一，我有责任」。他从此被叫「好纳粹」，可他不是街头暴徒，是个体面的建筑师，被希特勒一眼选中后管整个德国的战争生产。这一遍让你跟他一起坐进法庭，看一个会算账的体面人，把本事一步步交给一架杀人的机器，然后认账。',
    en: 'He is the one senior Nazi who stood up and took the count at Nuremberg in 1945, while the men beside him cried innocence or shoved blame onto the already-dead Hitler. From then on people called him "the good Nazi." He was no street thug but a respectable architect Hitler picked at a glance in 1933, later running Germany\'s entire war production. This pass puts you with him in that courtroom, watching a calculating, cultured man hand his skill, step by step, to a machine for killing, and then take the count.',
  },
  storyboard: [
    {
      id: 'speer-n1',
...
export var chiuneSugiharaLens = {
  ...
  icon: '🖋️',
  description: {
    cn: '1940 年夏天那个清早，他拉开立陶宛领事馆的窗帘，外面铁门挤满几百、后来上千的犹太难民，纳粹在后面追，求一张能让他们离开大陆活下去的签证。他是日本副领事，按规矩办事，三次电报回东京请示，三次被明确拒绝。这一遍让你跟他一起坐在那张桌前，窗外是上千条命，手里是一支笔，桌上是一道「不准」，他要决定听话保前途，还是动手写。',
    en: 'One summer morning in 1940, he drew back the curtain of Japan\'s consulate in Kaunas, Lithuania, to find hundreds and later thousands of Jewish refugees pressed against the iron gate, fled from Poland with the Nazis behind, asking only for a visa that could let them leave the continent alive. He is the vice-consul, a career diplomat who follows the rules. Three times he has cabled Tokyo, three times told no. This pass sits you with him at the desk, a thousand lives outside, a pen in his hand, a "do not" on the desk, and he must choose, obey and keep his career, or pick up the pen.',
  },
  storyboard: [
    {
      id: 'sugihara-n1',
...
export var manzanarNiseiGirlLens = {
  ...
  icon: '🏜️',
  description: {
    cn: '她是 1941 年 12 月 7 日傍晚，看着妈妈在加州家院子里烧掉所有跟日本有关的东西的孩子（合成人物，代表一万多个被关进拘留营的真实日裔美国孩子）。她生在加州，会背效忠誓词、爱吃热狗，按美国法律生下来就是美国公民。可珍珠港之后，街上看她的眼神一夜变了，因为她长着一张「敌人的脸」。这一遍让你跟她算一笔账，自己的国家凭什么按一张脸把她锁起来。',
    en: 'She is the child who, on the Sunday evening of 7 December 1941, watched her mother burn everything Japanese in their California yard (a composite figure standing for over ten thousand real Japanese-American children sent to the camps). Born in California, she can recite the Pledge of Allegiance and loves hot dogs, an American citizen from birth. Yet after Pearl Harbor the way people on the street looked at her changed overnight, because she wore "the enemy\'s face." This pass walks her through one question, by what right does her own country lock her up by a face?',
  },
  storyboard: [
    {
      id: 'mn-n1',
