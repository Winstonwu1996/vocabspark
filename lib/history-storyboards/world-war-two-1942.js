...
//   - chiune-sugihara                 (lonely-mediator)   — Chiune Sugihara 1900-1986 日本驻立陶宛领事 / 1940 违令签数千签证救犹太人 / 战后被解职
...
export var albertSpeerLens = {
  ...
  icon: '📐',
  description: {
    cn: '德国人，1905 年生，受过良好教育的建筑师，出身体面中产家庭。1933 年他遇见希特勒，被一眼看中，成了纳粹的御用建筑师，后来当上军备部长，管着整个德国的战争生产。他不是街头打手，不是狂热分子，是个有才华、有教养、会算账的技术官僚。1945 年战败后，在纽伦堡审判上，他是唯一一个站起来说「我有责任」的纳粹高官，因此被叫作「好纳粹」。这一遍让你从一个受过良好教育的人内部，看他怎么一步步为暴行服务，又怎么在战后给自己造了一个神话。',
    en: 'A German, born 1905, a well-educated architect from a respectable middle-class family. In 1933 he met Hitler, was chosen at a glance, and became the Nazis\' favored architect, later rising to Minister of Armaments in charge of all of Germany\'s war production. He was not a street thug, not a fanatic. He was a talented, cultured, calculating technocrat. After the defeat in 1945, at the Nuremberg trials, he was the one senior Nazi who stood and said "I bear responsibility," which earned him the name "the good Nazi." This pass lets you watch, from inside a well-educated man, how he came step by step to serve atrocity, and how after the war he built a myth around himself.',
  },
  storyboard: [
    {
      id: 'speer-n1',
...
export var chiuneSugiharaLens = {
  ...
  icon: '🖋️',
  description: {
    cn: '日本人，1900 年生，外交官。1939 年被派到立陶宛一个叫考纳斯的小城当领事。1940 年夏天，成千上万为逃命而来的犹太难民，挤在他领事馆的铁门外，求一张能离开欧洲的签证。他三次发电报回东京请示，三次被明确拒绝：不准发。他没有听。接下来快一个月，他几乎不睡觉，一笔一笔手写签证，写到手抽筋，直到领事馆被关、火车开动他还在从车窗往外递。他知道这会断送自己的前途。战后他果然被解职，回国默默无闻。这一遍让你坐进一个普通公职人员的位置，看他怎么在一道明确的命令面前，做出违令救人的选择。',
    en: 'A Japanese man, born 1900, a diplomat. In 1939 he was posted to a small city in Lithuania called Kaunas as consul. In the summer of 1940, thousands upon thousands of Jewish refugees who had fled for their lives crowded outside the iron gate of his consulate, begging for a visa that could get them out of Europe. Three times he cabled Tokyo for instructions, and three times he was plainly refused: do not issue them. He did not listen. For nearly a month after that he barely slept, writing visas out by hand one by one until his hand cramped, and as the consulate closed and the train pulled away he was still handing them out the carriage window. He knew it would ruin his career. After the war he was indeed dismissed and went home into obscurity. This pass puts you in the seat of an ordinary public servant, watching how, facing a plain order, he made the choice to disobey and save lives.',
  },
  storyboard: [
    {
      id: 'sugihara-n1',
...
export var manzanarNiseiGirlLens = {
  ...
  icon: '🏜️',
  description: {
    cn: '一个虚构但贴着真实拘留营记录写成的人物，约 1928 年生在加州，是日本移民的女儿，在美国出生、长大，是个不折不扣的美国公民。她爱吃热狗，会背效忠誓词，跟同学一起在学校升国旗。1941 年珍珠港事件后，因为长着一张「敌人的脸」，1942 年她和家人被美国政府用一道总统命令，从家里赶出来，关进加州沙漠里一个叫 Manzanar 的拘留营，住在铺着柏油纸的简易棚屋里，外面是铁丝网和持枪的哨兵。她没犯任何罪。这一遍，你站在一个被自己的国家关起来的美国孩子这边，看那场被叫作「善的战争」的二战。',
    en: 'A made-up character written close to the real records of the camps, born around 1928 in California, the daughter of Japanese immigrants, born and raised in America, an American citizen through and through. She loved hot dogs, could recite the Pledge of Allegiance, and raised the flag at school with her classmates. After the attack on Pearl Harbor in 1941, because she wore "the enemy\'s face," in 1942 she and her family were driven from their home by a single presidential order and shut into a camp in the California desert called Manzanar, living in a bare tar-paper barrack with barbed wire and armed sentries outside. She had committed no crime. This pass lets you stand with an American child locked up by her own country, and look at the Second World War that is called "the good war."',
  },
  storyboard: [
    {
      id: 'mn-n1',
