...
export var workerHomesteaderLens = {
  ...
  icon: '⚒️',
  description: {
    cn: '一个修铁路的华工，和一户追免费土地的拓荒家庭——同一段历史里，机器里的两种普通人。华工远渡重洋来到加州，在零下的高山里凿隧道、铺铁轨，工钱比白人工人还低。拓荒家庭挤上火车，奔向宅地法承诺的 160 英亩免费土地，想在草原上重新活一次。他们都在「机会」「免费」的招牌下出力，也都不是制定规则的人。这一遍让你站在不上不下的中间位置：你是这台大机器的一部分，可你既不是赢家，也不完全是被碾过去的那一方。',
