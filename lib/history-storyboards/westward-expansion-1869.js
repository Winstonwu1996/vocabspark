...
export var railroadBaronLens = {
  ...
  icon: '🚂',
  description: {
    cn: '他是一个修横贯大陆铁路的大老板（合成人物，代表那一代真实存在的几位铁路巨头），1869 年 5 月 10 日，他站在犹他州一片荒地上，看一根金道钉砸下去，把东西两段铁轨接成一条。他相信这一锤把刚打完内战、差点散掉的国家重新缝成了一个。这一遍让你从他这里看：联邦给的钱按里程算、沿线大片土地归他卖，他越修越快、越拿越多,,而他嘴上一直说的「空地」「免费土地」「文明」这几个词，每一个都压着另一群人的命，他自己也越来越分不清账本上的数字和那套漂亮说辞。',
...
export var workerHomesteaderLens = {
  ...
  icon: '⚒️',
  description: {
    cn: '他是两双手合到一起的人（合成视角，把两类真实存在的普通人放进一个声音里）：一双手在加州一座结冰的高山里凿隧道，是从大洋彼岸来加州修铁路的华工；另一双手攥着一张地契和一把犁，是坐火车来追宅地法承诺的 160 英亩免费地的拓荒户。两双手都在「机会」「免费」这几个字底下出力，也都不是定规则的人。这一遍让你站在他这个不上不下的位置：他既被剥削，又得了好处；他不是最大赢家，也不是最惨输家,,他要诚实回答，他到底是受害者，还是那只夺地的手的一部分。',
...
export var plainsNativeLens = {
  ...
  icon: '🐎',
  description: {
    cn: '他是一个 Lakota（拉科塔）平原民族的人（合成的声音，但里面的山坡、野牛、条约和猎手都是史料里真切发生过的），小时候他站在一道小山坡上，望出去是黑压压、走大半天才走得完的野牛群；老了再回到同一道山坡，他看见的是一片空。这一遍让你跟他一起站在那道山坡上，看远处地平线上忽然多出的那两道闪光铁条，看沿着铁路涌进来的拿枪猎手、扛犁农民、穿军装的兵，看他赖以为生的整个世界，怎么在他眼前被一片一片拆光,,而他要决定，是束手就擒，还是用一辈子打一场明知道会输的仗。',
