...
export var railroadBaronLens = {
  ...
  icon: '🚂',
  description: {
    cn: '一个横贯大陆铁路的大老板，也是西进的鼓吹者。内战刚打完，他相信一件事：一条横穿整片大陆的铁轨，会把这个国家从大西洋缝到太平洋。他拿到联邦给的钱和沿线大片土地，雇上万工人在荒野里铺路，1869 年把东西两段接在一起。在他嘴里，西部是一片「空地」，等着被「进步」和「文明」填满。可那片地从来不空。这一遍让你从一个赢家、一个把国家缝起来的人内部，看一项伟大的工程和它压在谁身上的代价，怎么同时长出来。',
    en: 'A boss of a transcontinental railroad, and a booster of westward expansion. The Civil War had just ended, and he believed one thing: a line of rails running across the whole continent would stitch the nation from the Atlantic to the Pacific. He took federal money and huge tracts of land along the route, hired tens of thousands of workers to lay track across the wilderness, and in 1869 joined the eastern and western halves together. In his mouth, the West was "empty land," waiting to be filled by "progress" and "civilization." But that land was never empty. This pass lets you watch, from inside a winner, a man who stitched a country together, how a great work and the cost it lays on someone grow at the same time.',
  },
  storyboard: [
    {
      id: 'rb-n1',
...
export var workerHomesteaderLens = {
  ...
  icon: '⚒️',
  description: {
    cn: '一个修铁路的华工，和一户追免费土地的拓荒家庭，是同一段历史里，机器里的两种普通人。华工远渡重洋来到加州，在零下的高山里凿隧道、铺铁轨，工钱比白人工人还低。拓荒家庭挤上火车，奔向宅地法承诺的 160 英亩免费土地，想在草原上重新活一次。他们都在「机会」「免费」的招牌下出力，也都不是制定规则的人。这一遍让你站在不上不下的中间位置：你是这台大机器的一部分，可你既不是赢家，也不完全是被碾过去的那一方。',
    en: 'A Chinese laborer building the railroad, and a homesteading family chasing free land, two kinds of ordinary people inside the same machine, in the same stretch of history. The Chinese laborer crossed an ocean to California, tunneling through subzero mountains and laying track for wages lower than the white workers got. The homesteading family crowded onto a train toward the 160 acres of free land the Homestead Act promised, hoping to live again on the prairie. Both put out their labor under the banner of "opportunity" and "free," and neither made the rules. This pass puts you in the in-between seat: you are part of this great machine, yet you are neither a winner nor entirely the one ground beneath it.',
  },
  storyboard: [
    {
      id: 'wh-n1',
...
export var plainsNativeLens = {
  ...
  icon: '🐎',
  description: {
    cn: '一个 Lakota（拉科塔）平原民族的人，世世代代生活在大平原上。在他们的活法里，土地不是谁的财产，是大家共有的家；野牛不是猎物，是吃的、穿的、用的，是整套生活的根。然后铁路修过来了，白人猎手涌进来了，几千万头野牛在几十年里被打到近乎没有。一份份说「这地永远归你们」的条约，一份份被撕掉。这一遍，你站在那部宪法、那条铁路、那句「免费土地」从来没打算算进去的人这边，看 1869 年以后的西部。免费，对谁免费？在谁的土地上？',
    en: 'A Lakota of the Plains nations, who had lived on the Great Plains for generation upon generation. In their way of life, the land was no one\'s property but a home held in common; the bison was no mere game but food, clothing, tools, the root of an entire way of living. Then the railroad came, and white hunters poured in, and tens of millions of bison were shot down to almost nothing in a few decades. Treaty after treaty that said "this land is yours forever" was torn up one by one. This pass puts you on the side of the people the Constitution, the railroad, and the words "free land" never planned to count in, looking at the West after 1869. Free, free for whom? On whose land?',
  },
  storyboard: [
    {
      id: 'pn-n1',
