...
export var railroadBaronLens = {
  ...
  description: {
    ...
    en: 'He is the boss of a transcontinental railroad (a composite figure, standing for the handful of real magnates of that generation). On 10 May 1869 he stands on a stretch of empty ground in Utah and watches a golden spike come down, joining east and west into one line. He believes that one blow stitched back together a country that had just fought a civil war. This pass lets you watch him from inside: each word on his lips, "empty land," "free land," "civilization," presses down on another people\'s lives, and he can less and less tell the numbers in his ledger from his own fine speech.',
  },
  storyboard: [
    {
      id: 'rb-n1',
...
export var workerHomesteaderLens = {
  ...
  description: {
    ...
    en: 'He is two pairs of hands joined into one (a composite voice, putting two kinds of real ordinary people into a single speaker): one pair grips chisel and fuse in a frozen California mountain, a Chinese laborer who crossed the ocean to build the railroad; the other grips a deed and a plow, a homesteader chasing the 160 acres the Homestead Act promised. Both labor under the words "opportunity" and "free," and neither made the rules. This pass puts you in his in-between seat, where he must answer honestly: am I a victim, or am I also part of the hand that took the land?',
  },
  storyboard: [
    {
      id: 'wh-n1',
...
export var plainsNativeLens = {
  ...
  description: {
    ...
    en: 'He is one of the Lakota of the Plains (a composite voice, though the rise, the bison, the treaties and the hunters in it all truly happened in the record). As a child he stood on a low rise and looked out at bison so dense and dark one herd took most of a day to pass; old now, he stands on the same rise and sees only emptiness. This pass puts you with him on that rise, watching two iron rails appear on the horizon and the whole world he lives on taken apart piece by piece, while he must decide: give in, or spend his life fighting a war he knows he will lose.',
  },
  storyboard: [
    {
      id: 'pn-n1',
