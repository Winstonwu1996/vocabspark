...
//   Savonarola N6+N7: 60 米火堆里"虚妄"代号 (没看见 Lucia 的脸)
...
//   - 7thgrader (小薇 / 13 岁中国转学加州): 4 P0 + 5 P1 全 fix
...
var lorenzoStoryboard = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '到我祖父 Cosimo 五十岁的时候，整个西欧三成的国际汇款经过我们家。Cosimo 1464 年死时，Florence 政府正式封他 Pater Patriae——祖国之父。罗马帝国奥古斯都之后，1500 年里第一个非帝王获这个头衔的人。\n\n' +
      ...
      en:
        ...
        'By the time my grandfather Cosimo was fifty, roughly thirty percent of every long-distance payment in western Europe flowed through our family. When Cosimo died in 1464, Florence formally awarded him the title Pater Patriae — Father of the Fatherland. The first non-emperor to receive that title in the fifteen hundred years since the Roman emperor Augustus.\n\n' +
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    engagementHook: {
      cn: '接下来 80 天，Florence 没有任何法庭程序——直接处决了 90 个人。',
      en: 'For the next 80 days there were no trials in Florence — ninety people were simply put to death.',
    },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '接下来 80 天里，市政厅一共审判并处决了 90 个人。Pazzi 家被全部抄家、流放，名字从所有公共记录里抹掉——Pazzi 在 Florence 拥有的店铺，门楣上的家徽被一锤一锤凿平。\n\n' +
      ...
      en:
        ...
        'Over the next eighty days, the city tried and executed ninety people. The Pazzi family was wiped out, exiled, their name erased from every public record. Their family crest, carved above doorways across Florence, was chiseled off stone by stone.\n\n' +
    ...
    deliverGoal: {
      cn: '90 人被处死、Salviati 穿教士袍挂窗外、Botticelli 画耻辱壁画——我用极端报复树立威权。',
      en: 'Ninety executions, an archbishop hanged in vestments, Botticelli\'s shame-fresco — I used violent display as politics.',
    },
    engagementHook: {
  ...
  // ═══════════════════════════════════════════════════
  // N6 — STORY: Naples 单人外交 + Pater Patriae
  // ═══════════════════════════════════════════════════
  {
    id: 6,
    phase: 'story',
    ...
    content: {
      cn:
        ...
        'Florence 民众在城门口举着火把迎接我。市政厅当晚通过决议，授予我跟我祖父 Cosimo 同样的头衔，Pater Patriae，祖国之父。我是历史上第二个非帝王获这个头衔的人。\n\n' +
      ...
      en:
        ...
        'Florentines met me at the gate with torches. That same night the Signoria voted to give me the same title my grandfather Cosimo had received, Pater Patriae, Father of the Fatherland. I was the second non-emperor in history to receive it.\n\n' +
        'I was thirty-one. From 1480 until my death, no one moved against Florence.',
    },
    deliverGoal: {
      cn: '我一个人骑去敌国跟 Ferrante 谈了 3 个月——回来时被授予国父头衔，从此 12 年没人敢动 Florence。',
      en: 'I rode alone into enemy territory, negotiated three months, and came back with the title Father of the Fatherland.',
    },
    engagementHook: {
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        '你刚演完 Lorenzo de\' Medici——一个把 90 个尸体挂出窗外，又给 14 岁的 Michelangelo 一间自己的房间的人。\n\n' +
        ...
        '另一边，他赞助来的钱是高利贷 + 复式记账法垄断 + 跟教皇的政治交易，他对政敌的处理是 90 颗人头一句话挂出窗外。\n\n' +
        '两种说法都能拿出真证据：\n\n' +
      ...
      en:
        'You have just played Lorenzo de\' Medici — a man who hung ninety bodies out a window and also gave a fourteen-year-old Michelangelo his own room.\n\n' +
        ...
        'On the other side: the money that paid for all of it came from interest-bearing loans, a monopoly on double-entry bookkeeping, and political deals with the popes. And his way of handling political enemies was ninety severed lives in eighty days.\n\n' +
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    engagementHook: {
      cn: '哪一种更说服你？想 30 秒。',
      en: 'Which view is more persuasive to you? Take thirty seconds.',
    },
    expectedLength: '320-380 字 CN + 真问题',
    expectsRealAnswer: true,
  },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '你死后 5 年，1497 年 2 月 7 日，Savonarola 在 Florence 中心广场点起一堆几百米高的木头堆，让全城把"虚妄之物"上交。镶金小镜子、化妆品、古典书、异教雕像，还有 Botticelli 自己烧自己的几幅画，都在那把火里。这是你统治了 23 年的城市。\n\n' +
        '——\n\n' +
        '放下这一遍之前，给我说一件事。\n\n' +
    ...
    engagementHook: {
      cn: '**这次扮演里——哪个瞬间最让你停了一下**？一句话告诉我就行——不用展开。',
...
var savonarolaStoryboard = [
  ...
  // ═════ N5 story — 1492-1494 真空 + Charles VIII + 我接见法王 ═════
  {
    ...
    content: {
      ...
      en:
        ...
        'I received him.\n\n' +
        'Charles was eighteen, short, with a slight limp. But he commanded the first European army to use gunpowder to fully rewrite warfare; Italian mercenaries stood no chance against his cannon. I was forty-two, only a friar, no army, no public office. I walked into the great hall of the Palazzo della Signoria in my black-and-white Dominican robe.\n\n' +
  ...
  // ═════ N6 story — 1494-1497 Christian Republic + Vanity Boys + 镶金小镜子 ═════
  {
    ...
    content: {
      cn:
        ...
        '她交。她哭着交。\n\n' +
        '我从讲坛上看下去。我看见的不是她的脸，我看见的是几百件镜子、几百本古典书、几百盒化妆品、几百件丝绸，堆成一座大约 60 米高的木堆。\n\n' +
      ...
      en:
        ...
        'I look down from the pulpit. I do not see her face. I see hundreds of mirrors, hundreds of classical books, hundreds of boxes of cosmetics, hundreds of silk garments, piled into a wooden tower roughly sixty meters high.\n\n' +
  ...
  // ═════ N7 story — 1497/2/7 Bonfire of the Vanities ═════
  {
    ...
    content: {
      cn:
        ...
        '木堆已经搭了 3 天，约 60 米高，8 边形，分 7 层。最底下是棋盘和乐器，中间是化妆品和镜子，上面是古典文学和异教神话画，最高一层是异教神话雕塑小像。木堆中央是一根高耸的木柱，柱上挂着一个稻草人，画着魔鬼的脸。\n\n' +
  ...
  // ═════ N11 synthesis — 跨文化锚:为什么欧洲会出 Savonarola 而中国不会 ═════
  {
    ...
    deliverGoal:
      ...
      '两边都站得住。想 30 秒。',
    engagementHook:
      '**你愿意要哪种代价**？欧洲式碎片化（创新 + 暴政）还是中国式大一统（稳定 + 没爆发）？想 30 秒。',
  ...
  // ═════ N12 meta — 我是 Reformation 早期 echo + 桥到下一 Topic ═════
  {
    ...
    content: {
      cn:
        ...
        '放下这个视角之前，给我一句话：这次扮演里，哪个瞬间最让你停了一下？是我 1492 年 4 月 8 日没给 Lorenzo 赦免、转身离开他病床？是 1494 年 11 月 17 日我对 24 岁 Charles VIII 用拉丁文说"你只是上帝派来的工具"？是 1497 年 2 月 7 日我从讲坛上看那座 60 米高木堆，但没看见任何一张脸？还是 1498 年 5 月 23 日我闻见自己头发的焦味？\n\n' +
        '一句话就行。\n\n' +
...
var luciaStoryboard = [
  ...
  },
  {
    ...
    content: {
      ...
      en:
        ...
        'In the piazza: a wooden pyre several stories high. Tens of thousands watching.\n\n' +
  ...
  },
  {
    ...
    deliverGoal:
      ...
      '——两边的脆弱不一样，两边的可能性也不一样，两边都站得住。',
    engagementHook: '**你怎么看**——1497 生在 Florence 还是苏州，两边都站得住吗？想 30 秒。',
    expectedLength: '300-360 字 + 真问题',
    expectsRealAnswer: true,
  },
  {
    ...
    content: {
      cn:
        ...
        '在 atlas-lab/renaissance 里**没有**。Atlas 大多数 Topic 写的是 perpetrator-actor 视角（Lorenzo / Savonarola / Da Vinci / Michelangelo / Pope / Erasmus）——这些是史书有名字的人。\n\n' +
        'Lucia 这种没名字的家庭主妇——只有这种"视角学法"才能让你完整经历她的一天。\n\n' +
        '这个 Topic 还有另外两个视角：Lorenzo（Florence 文化载体）和 Savonarola（虚妄之火点火人）。\n\n' +
    ...
    engagementHook:
      '**Lucia 这一遍最让你停一下的是什么**？是 Caterina 问"奶奶给的东西去哪了"？火堆边镶金边闪一下？穿画家围裙的男人边走边哭？1510 年 Caterina 嫁农民那一刻？说一句话',
...
export var lenses = {
  'lorenzo-medici': {
    ...
    description: {
      cn: 'Medici 银行家家族第三代族长。20 岁接班 Florence,没任何官位但用钱实控全城 23 年。1478 年 Pazzi 阴谋大教堂被刺杀,弟弟当场死,他活下来,80 天处决约 80 名阴谋者。同一双手赞助 Botticelli + Michelangelo,把镶金小镜子从 Antwerp/Venice 引进中产家庭。1492 年临终拒绝 Savonarola 三个条件,死了。',
      en: 'Third-generation patriarch of the Medici banking family. At twenty he took over Florence with no formal title, ruling through money for 23 years. In the 1478 Pazzi conspiracy he was attacked at Easter Mass; his brother was killed, he survived, and over 80 days executed roughly 80 conspirators. The same hands funded Botticelli and Michelangelo, and imported small gilded mirrors from Antwerp and Venice for middle-class homes. In 1492 he refused Savonarola\'s three conditions on his deathbed and died.',
    },
  ...
  'savonarola': {
    ...
    description: {
      cn: 'Ferrara 公爵御医的反叛儿子,23 岁雨夜出走进多明我会修道院。1492 年 Lorenzo 临终他拒绝给最后赦免;两年后 Florence 真空里他实际接管这座 Renaissance 中心城。从内部反扑者的视角看 Renaissance 真实的伦理矛盾:奢华、教会腐败、民众饥饿在同一座城里共存。1497 年点火烧 Vanities,1498 年自己在同一广场被绞死烧尸。',
      en: 'The rebellious son of the Duke of Ferrara\'s personal physician, who walked out at twenty-three on a rainy night and entered the Dominican order. In 1492 he refused absolution to the dying Lorenzo de\' Medici; two years later, in the political vacuum, he took de facto control of Renaissance Florence. The lens of internal pushback that named the Renaissance\'s real ethical contradictions: luxury, church corruption, and hunger living in the same city. In 1497 he lit the Bonfire of the Vanities; in 1498 he was himself hanged and burned in the same piazza.',
    },
  ...
  'lucia-widow': {
    ...
    description: {
      cn: '虚构合成人物,代表 Florence 几万个被路过 Renaissance 的普通家庭主妇。28 岁单亲妈妈,1496 丈夫死小型 plague,5 岁女儿 + 3 岁儿子。镶金小镜子是娘家给的最后嫁妆——也是 1497 Bonfire 那天她被迫交出去的最后退路。从无名无姓的普通女人视角看"伟大时代"对她们意味着什么。',
      en: 'A fictional composite character representing the tens of thousands of ordinary Florentine housewives whom Renaissance history passes over. A 28-year-old single mother whose husband died of a minor plague flare in 1496; she has a five-year-old daughter and a three-year-old son. A small gilded mirror is the last piece of her dowry from her mother — and the last safety net she is forced to surrender on the morning of the 1497 Bonfire. The lens of the nameless ordinary woman, asking what a "great age" meant to her.',
    },
