...
//
// 4-agent review (5-7+ TBD): 7thgrader (小 U) / AP teacher (Dr. Park) / ESL teacher (Maria) / Chinese teacher (赵老师)
//
...
export var emperorHuizongLens = {
  ...
  perspectiveTag: 'aesthete-emperor',
  description: {
    cn: '他是一个 18 岁那天因为哥哥哲宗咳血而死无嗣、被太皇太后一句「先帝尝言端王有福寿」从端王府推上龙椅的画家亲王，宰相章惇当场说他「轻佻不可以君天下」也没拦住。这一遍让你坐进他刚即位、以为接手的是一个艺术爱好者的最高位置（全国所有名画可以收、所有名家可以召进画院），看他下一步要不要把翰林图画院扩成中国历史上第一所国家美术学院、要不要慢慢把财政从军备转去养画师。',
    en: 'He is the painter prince who, on the day his elder brother Emperor Zhezong died coughing blood without an heir, was lifted onto the throne at eighteen by one line from the Grand Empress Dowager, "the late emperor said the Prince of Duan has good fortune and long life," even after the chancellor Zhang Dun told him to his face he was "frivolous and cannot govern the realm." This pass puts you in his seat the moment he takes the throne, believing he has inherited an art-lover\'s dream, and watches whether he is about to expand the Hanlin Art Academy into China\'s first state art school and pull the budget from the army into painters\' salaries.',
  },
  storyboard: [
    // ═══════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1100 年 2 月 23 日, 开封 (北宋首都, 今河南) 福宁殿。\n\n我哥哥哲宗皇帝 25 岁, 躺床上咳血, 无嗣。\n\n我 18 岁, 神宗皇帝第 11 子, 母亲是普通妃子, 我自己是个看戏画画写字的闲散端王。我从没想过会做皇帝: 北宋立国 140 年, 11 子做皇帝几乎不可能。\n\n但那天太皇太后向氏主持商议, 宰相章惇当场反对, 据后世史书记载他留下一句流传很广的话, 大意是「端王轻佻, 不可以君天下」。但太皇太后说: 「先帝尝言, 端王有福寿。」一句话定了。\n\n哲宗当天死, 我从端王府入宫坐上龙椅。\n\n那一刻我以为我接手的是艺术爱好者的最高位置: 全国名画可以收藏, 全国名家可以召进画院。我以为天下太平。\n\n我不知道接下来 27 年我会把北宋艺术推到顶峰, 也亲手推下深渊。我不知道 26 年后 1126 年, 同样这座开封会被金军攻陷, 我收的 7000 多件名画书法全部被劫往北方。我不知道 1135 年我会死在黑龙江一个叫五国城的木栅小屋里, 54 岁, 望着南方。\n\n接下来 12 节, 你跟我走 53 年——从 18 岁意外接位的画家亲王, 到 54 岁死在异乡的亡国太上皇。你会知道我为什么至今争议: 我既是中国艺术史最高峰皇帝之一, 也是最大政治灾难的责任人之一。',
        en: 'February 23, 1100. Kaifeng, the Northern Song capital (modern Kaifeng, Henan). The Funing Palace Hall.\n\nMy elder brother, Emperor Zhezong, twenty-five years old, lies in bed coughing blood. He has no son.\n\nI am eighteen. Eleventh son of the late Emperor Shenzong. My mother, Consort Chen, was a minor concubine. I myself am the Prince of Duan — an idle prince who watches operas, paints, writes calligraphy. I never imagined I would be emperor. The Northern Song has stood one hundred forty years; an eleventh son taking the throne is almost impossible under our ancestral rules.\n\nBut that day, Grand Empress Dowager Xiang (the principal wife of my father Emperor Shenzong) presides over the council. Chancellor Zhang Dun openly opposes me — and later histories record a much-repeated line, roughly: "The Prince of Duan is frivolous; he cannot govern the realm." Given my reputation as a painter and calligrapher, the chancellor is not wrong. But the Grand Empress Dowager replies: "The late emperor said the Prince of Duan has good fortune and long life." One sentence settles it.\n\nZhezong dies that day. I move from the Prince of Duan residence into the palace and seat myself on the dragon throne; the next year, 1101, I change the era name to Jianzhong Jingguo. I am eighteen.\n\nIn this moment I think I have inherited the highest position an art-loving man could hold: every famous painting in the empire I can collect, every great master I can summon to the academy. I think the realm is at peace.\n\nI do not know that over the next twenty-seven years I will push Northern Song art to its highest peak — and push it into the abyss with the same hands. I do not know that twenty-six years from now, in 1126, this same city of Kaifeng will fall to the Jin army, and the more than seven thousand paintings and calligraphies I gathered will be looted north. I do not know that in 1135 I will die in a small wooden-fenced hut at the Five Kingdoms City in modern Heilongjiang, fifty-four years old, looking south.\n\nOver the next twelve sections, you will walk fifty-three years with me. From the eighteen-year-old painter prince who took the throne by accident, to the fifty-four-year-old retired emperor dying in foreign land — by the end you will know why I am still debated: I am one of the highest peaks of Chinese art history, and also one of the men most responsible for the largest political catastrophe in Chinese history.',
      },
      deliverGoal: 'N1 hook — 1100.2.23 哥哥哲宗死无嗣 + 18 岁端王意外接位 + 章惇反对 (「轻佻不可」系后世史书所记, 已标注相传) + 太皇太后一锤定音 + 27 年艺术黄金 + 1126 全失伏笔',
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1100 年即位到 1102 年, 这两年是我政治学步期。\n\n太皇太后向氏 1101 年 1 月去世, 临死前一年垂帘听政——这一年朝廷在新党 (王安石变法派) 和旧党 (司马光保守派) 之间来回拉扯。1100 年我先用旧党的韩忠彦做宰相, 1102 年又转向新党, 把蔡京推上首相。\n\n蔡京 (1047-1126), 王安石变法核心干将, 但他有个特点: 谁当政就附和谁。我用他是因为宠信的太监童贯举荐, 说他字好画也好, 跟我谈得来。\n\n蔡京从 1102 到 1126, 24 年里 4 次罢相 4 次复相——「四度入相」是中国宰相史唯一一例。每次被弹劾我都罢他, 过几个月又召回。为什么? 因为他办的两件事别人办不了:\n\n第一, 重启王安石变法——但这次不为富国强兵, 是为筹钱。我要扩翰林图画院、修《宣和画谱》、建艮岳、资助道教, 都要钱。蔡京靠茶盐专卖、铸大钱、加征田赋, 把钱从民间抽到国库。\n\n第二, 帮我把批评变法的人全部清出去——「元祐党人」名单 309 人, 含司马光、苏轼、黄庭坚, 全部刻碑立在端礼门, 子孙不许做官进京 (1102 年 9 月「元祐党碑」立)。\n\n这一刻我没听见我该听的。我以为在清出政治杂音让自己专心画画——却不知道我清掉的那些名字, 是北宋最后能挡住金军的政治大脑。',
        en: 'From taking the throne in 1100 to May 1102, these two years are my political apprenticeship.\n\nGrand Empress Dowager Xiang dies in January 1101. In her final year she rules from behind the curtain, and my court swings between the New Party (Wang Anshi reformers) and the Old Party (Sima Guang conservatives). In 1100 I use the Old Party, calling Han Zhongyan, a senior disciple of Sima Guang, as chancellor. In 1102 I swing to the New Party and push a man named Cai Jing into the chief chancellor position.\n\nCai Jing (1047-1126), born in Xianyou, Fujian, 1070 jinshi (the imperial-exam degree), a core operator of the Wang Anshi reforms. But he has one defining trait: he agrees with whoever holds power — a Wang man under Wang, a Sima man under Sima, a Zhang Dun man under Zhang Dun. In May 1102 I use him because my favored eunuch Tong Guan recommends him, saying Cai writes calligraphy and paints well and we will get along.\n\nFrom 1102 to 1126, Cai Jing is dismissed four times and recalled four times — four chancellorships, the only case in the entire history of Chinese chancellors. Every time he is impeached I dismiss him; a few months later I call him back. Why? Because he handles two things no one else can:\n\nFirst, restart the Wang Anshi reforms — but this time not for a strong state, only to raise money. I want to expand the Hanlin Art Academy, compile the Xuanhe catalogues, build Genyue (an artificial imperial mountain-park north of Kaifeng), patronize Daoism. All of it needs money. Cai Jing concentrates revenue through tea and salt monopolies, large copper coins, and heavier land taxes, pulling silver from the countryside into the treasury.\n\nSecond, sweep out everyone who criticizes the reforms — the Yuanyou Party Member List, three hundred nine names including Sima Guang, Su Shi, Huang Tingjian, carved into a stele at the Duanli Gate, their descendants barred from office and from the capital. The Yuanyou Party Stele is erected in September 1102.\n\nIn this moment I do not hear what I should be hearing. I think I am doing what an art-loving emperor should do — clearing the political noise so I can focus on painting. I do not know that the names I am sweeping out are the last political minds in the Northern Song capable of holding back the Jin.',
      },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1102 到 1110 这 8 年, 我做了一件中国艺术史上前无古人的事: 把画家变成国家公务员。\n\n翰林图画院唐代就有, 但那时只是宫廷画师的小作坊。1104 年 6 月我下诏: 扩到三层楼, 招画师 200 多人, 按级别发俸禄——一级画师月俸约 30 贯, 跟翰林学士相等。\n\n同年我又设了「画学」——中国历史第一所国家美术学校。考试是一道古诗题, 让考生用画来答。比如「踏花归去马蹄香」, 怎么画「香」? 那年的状元画了几只蝴蝶飞绕马蹄——这就是答案。\n\n画学分六科: 道释、人物、山水、鸟兽、花竹、屋木。这 8 年我招进的人有几个会刻进美术史: 王希孟 (1096-1119, 18 岁画《千里江山图》, 23 岁早死)、张择端 (《清明上河图》作者, 5.28 米长卷画尽开封市井)、李唐 (后来南宋四大家之一)。\n\n这事了不起: 21 世纪的国家美术学院模式我 1104 年就在做, 比欧洲 (1648 法国 Académie Royale) 早约 6 个世纪。\n\n但我没看见: 我把财政相当大一块从军备转到画院。北宋禁军从神宗时 80 万缩到我朝中期约 40 万, 装备训练都废弛。我每月给一级画师 30 贯——同样 30 贯能装备 6 个步兵——这个交换我做了 27 年, 不知道。',
        en: 'In the eight years from 1102 to 1110, I do something unprecedented in the history of Chinese art: I turn painters into state officials.\n\nThe Hanlin Art Academy existed in the Tang and was expanded under Southern Tang, but before me it was just a small workshop for palace painters. In June 1104 I issue an edict: expand the academy into a three-story building, recruit more than two hundred painters, pay each by rank. A first-rank painter earns the same as a Hanlin Academician — about thirty strings of cash a month (one string equals one thousand coins), enough to buy a mid-grade plow ox in Kaifeng.\n\nMore importantly, in 1104 I establish the Painting School — the first state art academy in Chinese history. The exam is an ancient line of poetry; candidates must answer with a painting. For "Treading flowers home, the horse hooves carry fragrance" — how do you paint fragrance? The top scorer that year painted butterflies fluttering around the hooves. That was the answer.\n\nThe Painting School has six departments: Daoist-Buddhist, figure, landscape, bird-and-beast, flower-and-bamboo, architectural. Students graduate in three years; the best stay at the academy.\n\nAmong the painters I bring in over these eight years, several names will be carved into the history of art: Wang Ximeng (1096-1119, who at eighteen paints A Thousand Miles of Rivers and Mountains, dies at twenty-three); Zhang Zeduan (whose Along the River During the Qingming Festival is a 5.28-meter handscroll panorama of Kaifeng street life); Li Tang (later one of the Four Great Masters of Southern Song).\n\nIn this moment what I am doing is remarkable. The model of a twenty-first-century state art academy, I am building it in 1104, about six centuries before Europe (the French Académie Royale was founded in 1648).\n\nBut what I do not see: I am pulling a substantial portion of the budget from military preparation into the painting academy. The Northern Song imperial army shrinks from eight hundred thousand in Shenzong\'s reign to about four hundred thousand in mid-reign, half with rotten equipment, half with neglected training. I pay a first-rank painter thirty strings a month — the same thirty strings could equip six infantrymen — I make this trade for twenty-seven years, and I do not know it.',
      },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1102 到 1110 之间某一年, 我在福宁殿东暖阁, 开始写一种没人写过的字。\n\n我从小学黄庭坚 (1045-1105, 苏轼门生, 北宋大书法家), 他横画收笔重; 又学薛稷 (649-713, 唐初书法家), 他笔画细如金丝。20 多岁我把两家融合再加进自己——笔锋更细, 竖钩更长更利。\n\n这种字今天叫「瘦金体」(shou jin ti, Slender-Gold Script)。「瘦」是字形细, 「金」是金属感——一笔下去像把金线拉直。\n\n1112 年我用瘦金体题《瑞鹤图》, 字跟画里的天空、宫殿、仙鹤合成一张完整画面。这是中国艺术史第一次「皇帝的字 + 画 + 印」三合一, 后世帝王画家都学。\n\n这一刻让你看见我才华到了什么地步。21 世纪你在 macOS 字体本找「华文细黑」「方正瘦金」——源头都是我在那间东暖阁磨出来的。我是书法史上创立独立字体的极少数皇帝之一。\n\n但还有一件事让你想 30 秒——同样这双手, 14 年后在五国城木屋写最后一首诗 (《在北题壁》「彻夜西风撼破扉, 萧条孤馆一灯微」), 还在用瘦金体。54 岁的我在金人监视下用同样的字写流亡诗。一种字体跟一个人走完一生, 从 18 岁意外即位到 54 岁异乡死亡。\n\n才华不会救命。这是 1135 年五国城那间木屋告诉我的事。',
        en: 'Sometime between 1102 and 1110, in the East Warm Chamber of Funing Hall, I begin writing a kind of script no one has written before.\n\nFrom childhood I studied Huang Tingjian (1045-1105, one of the Four Disciples of the Su Shi Gate, a great Northern Song calligrapher), whose horizontal strokes end heavy and slanting strokes run long and sharp. I also studied Xue Ji (649-713, an early Tang calligrapher), whose strokes are thin as gold wire. In my twenties I merge the two and add myself — pulling the brush tip thinner, sharpening the horizontal starts, lengthening the vertical hook, shaping the slanted strokes into willow leaves.\n\nThis script is now called shou jin ti, the Slender-Gold Script. Slender for the shape, gold for the metallic feel — every stroke pulled like a gold wire drawn straight, like a knife cut.\n\nIn 1112 I inscribe the Cranes of Good Omen handscroll in Slender-Gold, the script at the head and tail joined with the sky, the palace, and the cranes into one complete image. This is the first time in Chinese art history that emperor\'s calligraphy + painting + seal merge into one — every later emperor-painter copies the template.\n\nIn this moment you can see how far my talent goes. Twenty-first century you open the macOS Font Book and search Huawen Slender Black, Founder Slender-Gold — every one traces back to what I slowly forged in the East Warm Chamber between 1102 and 1110. I am one of the very few emperors who founded an independent script (Han Wudi standardized Clerical Script before me; no one after).\n\nBut here is one more thing to think about for thirty seconds — the same hand, fourteen years later, in a wooden hut in the Five Kingdoms City writing his last poem (Inscribed on the Wall in the North: "All night the western wind shakes the broken door, in this lonely hut a single lamp grows dim"), is still using Slender-Gold. At fifty-four, under Jin guard, I write my exile poem in the same script. One script walks an entire life — from the eighteen-year-old who took the throne by accident, to the fifty-four-year-old dying in foreign land.\n\nTalent does not save your life. This is what the wooden hut in the Five Kingdoms City tells me in 1135.',
      },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1112 年正月十六, 上元节后一天, 开封宣德门上空。\n\n清晨我在福宁殿登楼, 看见宣德门顶飘来一群仙鹤——20 只白鹤盘旋在朱红门楼上, 一组站在两端正脊的鸱尾上 (屋脊兽形装饰), 一组在天空盘绕。全城都看见, 百官说是太平盛世的祥瑞。\n\n我立刻动笔。工笔花鸟 (gong bi, 细线精描), 绢本设色, 51 厘米高 138.2 厘米宽。天空石青打底, 鹤用白粉。我画了几个月, 卷末用瘦金体题字记下时间地点。\n\n这就是《瑞鹤图》, 今藏辽宁省博物馆, 是我现存最重要的真迹。\n\n4 年后我画《听琴图》, 画的是我自己——穿道袍坐松树下抚琴, 蔡京 (正第三次入相) 立左, 童贯立右。\n\n这一刻让你看见我画里的世界观。我相信「天人合一」: 天上的祥瑞 (仙鹤)、地上的政治 (我)、自然的秩序 (松、琴、风) 是一个整体, 画《听琴图》时我以为自己是宇宙秩序的中心——皇帝 + 道士 + 艺术家三位一体。\n\n但 21 世纪你站在故宫博物院《听琴图》前会看见另一个东西: 一个 35 岁皇帝抚琴, 两个政治助手站两边——画里没有边境, 没有军队, 没有 1115 年金太祖完颜阿骨打刚建立的金国。他就在我画这幅画前一年称帝, 我画里没有他。\n\n这就是「天人合一」的盲点: 我相信宇宙和谐, 所以看不见准备打我的人。',
        en: 'January 16, 1112. The day after the Lantern Festival. Above the Xuande Gate (the main southern gate of the imperial palace), Kaifeng.\n\nThat morning I climb a tower in Funing Hall and see a flock of cranes drift over the Xuande Gate — twenty white cranes circling above the vermilion gate-tower, one group standing on the chiwen (the beast-shaped ornaments at the ends of the main ridge), the other circling in the sky. The whole city sees them. The officials all say this is an auspicious sign of a golden age.\n\nI start painting at once. Fine-line meticulous (gong bi) bird-and-flower painting on silk, fifty-one centimeters high, one hundred thirty-eight point two wide. Mineral azurite for the sky, lead white for the cranes, soft gold for the chiwen. I paint stroke by stroke for months. At the end I inscribe in Slender-Gold: "On the evening following the Lantern Festival of the renchen year of the Zhenghe era…" recording the time and place of the omen.\n\nThis is Cranes of Good Omen. Today it is held in the Liaoning Provincial Museum, the most important surviving authentic work of mine.\n\nFour years later, in 1116, I paint Listening to the Qin. This time the subject is myself — wearing a Daoist robe, seated under a pine, playing the qin. Cai Jing (in his third chancellorship) stands listening on the left, Tong Guan on the right. Cai Jing inscribes a poem at the top.\n\nIn this moment you can see the worldview inside my paintings. I believe in the unity of heaven and humanity: the omen in the sky (the cranes), the politics on the ground (me), and the order of nature (pine, qin, wind) are one whole. While painting Listening to the Qin, I think of myself as the center of a cosmic order — emperor, Daoist, artist, three in one body.\n\nBut twenty-first century, when you stand before Listening to the Qin in the Palace Museum, you will see something else: a thirty-five-year-old emperor playing the qin under a pine, his two most important political aides flanking him — and there is no border, no army, no Jin state, no Wanyan Aguda, who founded the Jin in 1115, one year before this painting. He was crowned the year before I painted it. He is not in my painting.\n\nThis is the blind spot of "the unity of heaven and humanity": I believe the cosmos is harmonious, so I cannot see the man preparing to attack me.',
      },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1102 年起, 我开始一项后来 27 年都做的事: 把全国名画名书集中到我的内府。\n\n方式有 4 个: 抄家 (元祐党人被抄, 苏轼黄庭坚米芾家里的字画我都拿了)、进献 (地方官升迁拿名画来献)、收购 (蔡京设「书画局」收购民间)、接旧朝 (南唐、后蜀、北宋初几代皇帝的内府收藏全归我)。\n\n1110 年代我让翰林书画院编两部目录, 数字写在卷首:\n- 《宣和画谱》收画家 231 人, 名画 6,396 幅。\n- 《宣和书谱》收书法家 197 人, 名作 1,344 件。\n\n这是中国第一次国家级书画总目录, 每幅记作者、尺寸、印鉴、流传, 今天还在。\n\n我想做的事是高贵的: 把人类最美的东西集中起来传给后代——这就是 21 世纪大博物馆的逻辑。\n\n但请想 30 秒——把最珍贵的东西全集中在一处, 是巨大的风险。亚历山大图书馆所有书集中, 一把火全没。我是同一种逻辑, 只是它用了 1000 年才毁, 我的内府只用了 7 年。\n\n1126 年闰 11 月 25 日开封陷, 6,396 幅画 + 1,340 件书法 + 翰林图画院全部艺术家被金军劫往北方。中国艺术史最大单次损失。\n\n21 世纪故宫博物院 (北京 + 台北) 唐宋元三代名画存世量, 大约只剩我 1119 年内府的 5%。我集中起来, 也帮金军一次劫光。',
        en: 'From 1102 onward, I begin something I will continue for the next twenty-seven years: pulling the famous paintings and calligraphies of the empire into my inner palace collection.\n\nFour methods. First, confiscation — the three hundred nine Yuanyou Party members are stripped of property, and the works in the homes of Su Shi, Huang Tingjian, Mi Fu come to me. Second, tribute — provincial officials wanting promotion present paintings. Third, purchase — Cai Jing sets up a Painting and Calligraphy Bureau to buy from private hands. Fourth, inheritance — the inner-palace collections of Li Yu of Southern Tang, Meng Chang of Later Shu, and the early Song emperors all flow into mine.\n\nIn the 1110s I order the Hanlin Academy to compile two catalogues: the Xuanhe Catalogue of Paintings and the Xuanhe Catalogue of Calligraphy, twenty volumes each. Xuanhe is the era name I adopted in 1119. The numbers are inscribed at the head:\n- The Catalogue of Paintings holds 231 painters and 6,396 paintings.\n- The Catalogue of Calligraphy holds 197 calligraphers and 1,344 works.\n\nThis is the first state-level master catalogue of painting and calligraphy in Chinese history, each work recording author, dimensions, seal marks, transmission. Both survive today, the earliest systematic documents in the history of Chinese art.\n\nIn this moment, what I am trying to do is noble: gather the most beautiful things made by human hands and pass them to the future. Twenty-first century Louvre, the Met, the Palace Museum — the logic of the great museum, I am building it in Kaifeng between 1102 and 1119.\n\nBut think for thirty seconds. Concentrating the most precious things in one place is an enormous risk. You have heard of the Library of Alexandria (founded in the third century BCE, destroyed in successive fires and wars between the third and seventh centuries) — gather every book, one fire and they are gone. What I am doing is the same logic — except Alexandria took a thousand years to lose, and my inner palace will only take seven.\n\nOn the twenty-fifth day of the intercalary eleventh month of 1126, Kaifeng falls. My 6,396 paintings + 1,340 calligraphies + the entire Hanlin Painting Academy of artists — the Jin army carries all of it north. The largest single loss in the history of Chinese art.\n\nIn the twenty-first century, the Palace Museum (Beijing and Taipei combined), the surviving major paintings of Tang, Song, Yuan total roughly five percent of what I had collected by 1119. I gathered, and I also helped the Jin army loot it all in one stroke.',
      },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1116 年某一天, 开封宫中。\n\n一个叫林灵素 (1075-1119) 的温州道士被引荐到我面前。他自称见过太上老君 (道教最高神)——太上老君告诉他, 我是「长生大帝君」下凡, 责任是把人间变成道教的「神霄世界」。\n\n21 世纪你听这个会笑。但 1116 年的我, 35 岁, 当了 16 年皇帝, 国家看上去太平, 我信他。\n\n从 1116 到 1119 这 4 年:\n- 全国诸州一律建神霄宫共 320 余座 (《宋会要辑稿》), 每个供我的塑像, 国库出钱。\n- 1117 年自封「教主道君皇帝」, 中国第一个皇帝兼宗教领袖, 类似同代欧洲教皇 + 皇帝合一。\n- 全国佛寺改名「宫」, 佛像改穿道袍。1119 年达顶峰——我下诏废佛。\n\n蔡京从财政角度反对——三百多个神霄宫总计数百万贯, 相当于全国一年田赋的相当一部分。但我听不进。\n\n1119 年北方民变频起, 林灵素被贬回温州, 年底死。我 1120 年起停止废佛——但 4 年财政浪费已经造成。\n\n这一刻让你看见我盲点的另一面: 我已相信自己是宇宙秩序的中心 (天人合一), 现在又相信自己是宗教秩序的顶点。\n\n一个有才华的领导者在权力顶峰逐渐相信自己是宇宙中心——心理学叫「grandiosity 自大幻觉」。我 35-38 岁是典型样本。',
        en: 'A day in 1116, inside the palace at Kaifeng.\n\nA Wenzhou Daoist named Lin Lingsu (1075-1119) is introduced to me. He claims he has seen Taishang Laojun (one of the highest deities of Daoism, Laozi deified) — and that Taishang Laojun told him I am the Great Emperor of Long Life descended into the human world, my duty to turn the human realm into the Daoist Shenxiao World.\n\nTwenty-first century you laugh at this. But the 1116 me, thirty-five, sixteen years on the throne, the realm looking peaceful, believes him.\n\nIn the four years from 1116 to 1119:\n- A Shenxiao Palace is decreed in every prefecture — about three hundred twenty in all (per the Song Huiyao Jigao), each housing a statue of me, all paid for by the treasury.\n- In 1117 I title myself Lord-of-the-Way Daoist Emperor, the first emperor in Chinese history to merge head of state and head of religion, like the European pope-and-emperor merger of the same era.\n- Every Buddhist temple is renamed Palace, every Buddha statue dressed in Daoist robes, every monk renamed deshi (Man of the Way). In 1119 this peaks — I order the abolition of Buddhism nationwide.\n\nCai Jing opposes on fiscal grounds — over three hundred Shenxiao Palaces totaling several million strings, a substantial share of one year of national land tax. I do not listen.\n\nIn 1119 uprisings flare in the north, Lin Lingsu\'s magic fails, he is demoted to Wenzhou, and dies at year\'s end. From 1120 I stop the abolition of Buddhism — but four years of fiscal waste are already done.\n\nIn this moment you see another face of my blindness. I already believe I am the center of cosmic order (the unity of heaven and humanity); now I also believe I am the apex of religious order: I am building a perfect spiritual world for myself — art, Daoism, sovereignty fused in one body.\n\nA talented leader at the peak of power who slowly believes he is the center of the cosmos — psychology calls it grandiosity. The me of ages thirty-five through thirty-eight is a textbook sample.',
      },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1120 年 10 月, 江南睦州青溪 (今浙江淳安)。一个 40 多岁的漆园工人方腊 (?-1121), 因为「花石纲」发不出工人工钱, 在山中聚徒起义。\n\n「花石纲」是我宠爱的事: 我建艮岳 (1117 起在开封城北建的人造皇家山林) 需要奇石异花, 让朱勔 (1075-1126) 在江浙搜集——民间一块好看的太湖石, 他都派人拆屋运回开封, 4 年压得江浙倾家荡产。\n\n方腊聚的人 10 天内从几百到几万, 1120 年 11 月青溪陷, 12 月攻下睦州、杭州, 1121 年 1 月占领江南 6 州 52 县, 部众号称百万。\n\n消息传来我震惊, 让童贯 (1054-1126, 我宠信的太监) 带 15 万禁军南下, 1121 年 8 月抓住方腊, 押回开封处死。\n\n但童贯做了一件我不知道的事: 他看见花石纲危害, 立刻假传我的命令暂停——太监替我承担了我该承担的责任。\n\n这一刻我盲点暴露了一次, 但我没听懂: 我因为爱奇石引发百万人起义, 太监替我擦屁股, 而他也开始把皇帝看成要别人擦屁股的人。起义被镇压, 但艮岳在建, 花石纲又恢复——我还要石头。\n\n所谓「无法学习的领导者」——我 1120-1121 是典型样本: 一次危机过去什么都没改, 1125 金军南下还会重复。',
        en: 'October 1120, in Qingxi, Muzhou (modern Chunan, Zhejiang), south of the Yangtze. A forty-something lacquer-grove worker named Fang La (?-1121), unable to pay his workers because of the Flowery Stone Convoys, gathers followers in the mountains and rises in revolt.\n\nThe Flowery Stone Convoys are a project of mine: I am building Genyue (an artificial imperial mountain-park started in 1117 north of Kaifeng) and need rare stones and exotic plants. I send Zhu Mian (1075-1126) to gather them in Jiangsu and Zhejiang. Any beautiful Taihu stone, Zhu Mian sends men to break walls and tear roofs to ship it to Kaifeng, the cost assessed on local households, and across four years grinds the two provinces into ruin.\n\nFang La\'s followers go from a few hundred to tens of thousands in ten days. November 1120 Qingxi falls, December Muzhou and Hangzhou, and by January 1121 the rebels hold six prefectures and fifty-two counties, claiming a million followers.\n\nThe news reaches me. I am shocked. I send Tong Guan (1054-1126, my favored eunuch) south with one hundred fifty thousand imperial troops, who captures Fang La in August 1121 and escorts him to Kaifeng for execution.\n\nBut Tong Guan does one thing I do not know about: seeing the damage of the convoys, he immediately, falsely transmitting my order, suspends them — a eunuch carrying my political responsibility for me.\n\nIn this moment my blind spot is exposed once, but I do not understand it. Because I love rare stones I trigger a revolt of a million people; a eunuch cleans up after me, and he begins to think the emperor is someone whose mess others must clean. The revolt is crushed, but Genyue is still under construction and the convoys resume — I still want my stones.\n\nThe "unable-to-learn leader" — the me of 1120-1121 is a textbook sample: one crisis passes and I change nothing. In 1125 when the Jin army marches south, I will repeat the same reaction.',
      },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1118-1125 这 7 年, 我跟童贯做了后来史书钉死我的事:「海上之盟」联金灭辽。\n\n辽国 (916-1125, 契丹建国) 跟北宋自「澶渊之盟」(1005) 是百年兄弟之邦, 每年给辽银绢换北方太平。但 1118 年金人 (女真人, 完颜阿骨打 1115 建国) 已打到辽河, 辽国摇摇欲坠。我和童贯想趁辽弱联金灭辽, 收回燕云十六州 (今北京、大同一带, 936 年割给契丹的故土)。\n\n1123 年签盟: 一起打辽, 灭辽后燕云归宋。\n\n1125 年 2 月金军俘辽天祚帝, 辽亡。但金军发现宋军腐烂——燕京是金军打下来再「卖」给宋的, 宋军连辽残兵都打不过。金人看穿了: 北宋表面富庶, 内里空壳。\n\n1125 年 12 月金军分两路南下, 1126 年 1 月东路逼近开封。我 44 岁, 还在画画收画, 消息传来惊慌。\n\n1126 年 1 月 18 日半夜, 我在福宁殿写禅位诏书, 把皇位传给 25 岁的长子赵桓 (是为钦宗, 改元靖康), 自号「太上皇」, 连夜南逃。\n\n这是我政治生命最赤裸的一刻。我不是死于战场, 不是被赶下台, 是 44 岁主动把责任甩给 25 岁的儿子自己跑路。这个签字是中国历史上「压力下逃避」最有名的样本之一。25 年后钦宗死在金国冰湖, 用一生承担我那一夜甩出去的事。',
        en: 'In the seven years from 1118 to 1125, Tong Guan and I do something the later histories will pin on me forever: the Treaty of the Sea, allying with the Jin to destroy the Liao.\n\nLiao (916-1125, founded by the Khitan) had been the brother-state of Northern Song for a century under the 1005 Treaty of Chanyuan, Northern Song paying silver and silk each year to buy peace on the northern border. But in 1118 the Jurchen (Wanyan Aguda, who founded Jin in 1115) had pushed to the Liao River, and Liao was tottering. Tong Guan and I thought: while Liao is weak, ally with Jin to destroy it and recover the Sixteen Prefectures of Yan-Yun (modern Beijing and Datong, the central-plains land ceded to the Khitan in 936).\n\nIn 1123 the alliance is formalized: attack Liao together, and after Liao falls Yan-Yun reverts to Song.\n\nIn February 1125 the Jin capture the Liao Emperor Tianzuo. Liao is gone. But the Jin discover the Song army is rotten — Yanjing was taken by the Jin first and then "sold" to Song, because Song could not even beat the remnants of a defeated Liao. The Jin see through it: Northern Song looks rich and is hollow inside.\n\nIn December 1125 the Jin split in two and march south; in January 1126 the eastern column closes on Kaifeng. I am forty-four, still painting and collecting — the news arrives, and I panic.\n\nAt midnight on January 18, 1126, in Funing Hall, I write an abdication edict and pass the throne to my twenty-five-year-old eldest son Zhao Huan (who becomes Emperor Qinzong, era name Jingkang), title myself Retired Emperor, and flee south through the night.\n\nThis is the most naked moment of my political life. I do not die on a battlefield, I am not deposed — at forty-four I voluntarily hand the disaster to my twenty-five-year-old son and run. This signature is one of the most famous samples of abdication-under-pressure in Chinese history. Twenty-five years later, Qinzong will die on a frozen lake in the Jin lands, carrying for a lifetime what I dumped on him in one night.',
      },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1126 年闰 11 月 25 日 (1127 年 1 月 9 日)。\n\n金军第二次围开封, 围了 3 个月。守城的是我 25 岁的儿子钦宗。这一年他做了我没做的事——亲自登城、下诏割地求和——但已经晚了, 我留给他的是空壳国家。\n\n这一天外城陷, 几天后内城陷, 钦宗赴金营谈判被扣留。北宋实质亡于 1127 年 4 月二帝北迁。\n\n金军要的贡品是天文数字, 全国一年税收都凑不出, 于是改要「内府所有」: 我 27 年集中的书画、青铜、玉瓷、古籍。\n\n1127 年 4 月 20 日金军押解北上的清单: 我 (太上皇) + 钦宗 + 后妃宗室约 3,000 人; 翰林图画院全部画师 (张择端被押北上后下落不明) + 工匠乐师约 4,000 人;《宣和画谱》6,396 画 +《宣和书谱》1,344 书; 内府青铜玉瓷约 2 万件 + 皇家藏书——几乎全部。\n\n停 30 秒。21 世纪故宫博物院现存全部唐宋顶级真品——27 件唐代真迹、49 件北宋名画——对照我 1119 年内府的 6,396 幅, 只剩被劫后的 1.2%。\n\n这是我 1119 年没看见的事: 把所有东西放进一个篮子不是保护, 是风险。当年若把这 6,396 幅画分藏全国十处, 烧九处还能留一处; 全集中, 一击就尽。',
        en: 'On the twenty-fifth day of the intercalary eleventh month of 1126 (January 9, 1127).\n\nThe Jin army has laid its second siege on Kaifeng for three months. The defender is my twenty-five-year-old son Qinzong. This year he has done what I did not — climbed the walls in person, signed cession edicts. But he has come to it too late, and what I left him is a hollow state.\n\nThe outer wall falls; a few days later the inner wall. Qinzong goes to the Jin camp to negotiate and is held there. The Northern Song dies in substance in the fourth month of 1127, when the two emperors are marched north.\n\nThe tribute the Jin demand is astronomical, more than the entire annual tax revenue of Northern Song. So they demand "everything in the inner palace": all the paintings, calligraphies, bronzes, jades, porcelains, ancient books I had concentrated for twenty-seven years.\n\nApril 20, 1127, the Jin convoy north: me (Retired Emperor) + Qinzong + consorts and clan, about three thousand; the entire Hanlin Painting Academy of painters (Zhang Zeduan marched north, his fate after unknown) + craftsmen and musicians, about four thousand; the 6,396 paintings + 1,344 calligraphies of the Xuanhe catalogues; about twenty thousand inner-palace bronzes, jades, porcelains + the imperial library — almost everything.\n\nPause for thirty seconds. The total surviving top-grade Tang-Song originals in the Palace Museum — twenty-seven authentic Tang works, forty-nine famous Northern Song paintings — against the 6,396 in my 1119 inner palace, is one point two percent of what I gathered and lost.\n\nThis is what I did not see in 1119: putting everything in one basket is not protection, it is risk. Had I split those 6,396 paintings among ten provinces, nine could burn and one would remain; all concentrated, a single siege took them all.',
      },
      deliverGoal: 'N10 ⭐ CROSS-LENS ECHO: 1126.闰11.25 开封陷 + 翰林图画院全失 + 6,396 画 + 1,340 书 + 故宫今存 1.2% + 5-Topic 信息保全五面体反例',
      engagementHook: '你最珍贵的东西(一段记忆 / 一张照片 / 一份手稿)—— 你想全存一个地方, 还是分几处各放一份?',
      expectsRealAnswer: false,
    },
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '1127 年 4 月 20 日, 我 44 岁跟 25 岁的钦宗上金军囚车北上流亡。1130 年被押到五国城 (今黑龙江依兰), 冬天零下 30 度, 1134 年金人封我侮辱性的「昏德公」。\n\n这 5 年我用瘦金体写诗, 最著名《在北题壁》: 「彻夜西风撼破扉, 萧条孤馆一灯微。家山回首三千里, 目断天南无雁飞。」我写信求南宋的儿子高宗赵构北伐救我, 但他 1141 跟金签「绍兴和议」不要我回去——我回去他就得让位。1135 年 6 月 4 日我死在五国城, 终年 54。\n\n看我整个人。我是中国艺术史的最高峰之一: 创瘦金体、设画学、画《瑞鹤图》《听琴图》, 每件后人单独做都是大师。我也是中国最大政治灾难的责任人之一: 用蔡京 24 年, 神霄宫废佛、花石纲压破江浙、海上之盟联金灭辽自掘坟墓, 1126 甩锅给儿子——北宋 167 年亡在我手。\n\n两边都是真的, 这就是「极致才华 + 系统性盲点」。掂量两种读法: 一种说: 该主要记住我的艺术高峰, 它走了 900 年还在; 治国失败是制度共业, 一人扛不动北宋的崩。另一种说: 该主要记住我葬送 167 年王朝、3,000 万人受难、靖康耻——才华再高也抵不过把一国带进深渊。\n\n你更偏向哪一种? 给我你最有力的一条理由, 想 30 秒写下来。',
        en: 'Dawn, April 20, 1127. At forty-four I climb onto Jin prison wagons with my twenty-five-year-old son Qinzong and begin an exile north. In 1130 we are moved to the Five Kingdoms City (modern Yilan, Heilongjiang); winters reach minus thirty degrees Celsius, and in 1134 the Jin give me the humiliating title Duke of Hunde.\n\nIn these five years I write poems in Slender-Gold, the most famous Inscribed on the Wall in the North: "All night the western wind shakes the broken door, in this lonely hut a single lamp grows dim. Looking back at home three thousand li away, my eye strains toward the far south — no wild geese fly." I write to my son Zhao Gou (Emperor Gaozong), newly enthroned in the Southern Song, begging him to march north and rescue me — but in 1141 he signs the Treaty of Shaoxing with Jin and does not want me back: if I return, his throne must yield to mine. On June 4, 1135, I die in the Five Kingdoms City, fifty-four.\n\nSee the whole of me. I am one of the highest peaks of Chinese art history: founder of Slender-Gold, builder of the Painting School, painter of Cranes of Good Omen and Listening to the Qin — each alone would make a master. I am also one of the men most responsible for the largest political catastrophe in Chinese history: twenty-four years with Cai Jing, the Shenxiao Palaces and Buddhist abolition, the Flowery Stone Convoys grinding two provinces, the 1118-1125 Treaty of the Sea that destroyed Liao and dug my own grave, and in 1126 dumping the disaster on my son — Northern Song stood one hundred sixty-seven years and ended in my hands.\n\nBoth are true — this is what extreme talent and systemic blindness look like together. Weigh two readings. One says: remember me mainly by my artistic peak, which has walked nine hundred years and survives; the failure of governance was the shared karma of a system, and one man cannot carry the entire collapse of Northern Song. The other says: remember me mainly as the man who buried a one-hundred-sixty-seven-year dynasty — thirty million suffered, the shame of Jingkang carved into national memory; no talent outweighs the responsibility of leading a state into the abyss.\n\nWhich do you lean toward? Give me your strongest single reason. Take thirty seconds, and write it down.',
      },
      deliverGoal: 'N11 SYNTHESIS (真问题) — 1127.4 北上 + 1130 五国城 + 1135.6.4 死 54 岁 + 「在北题壁」+ 高宗不要我回 + 极致才华 + 系统性盲点两边都站 + 真问题: 历史该主要记住艺术高峰还是亡国责任, 你更偏向哪一种?',
      // 5-24 第12条 2-per-lens 正则化：N11 恢复为真问题写作节点，提「艺术高峰 vs 亡国责任 哪个更该被记住」的掂量两读法问题，
      //   与 N12 的「如何评价 + 如何对待身边这种人」明确区分（N11 权衡两读法 / N12 评价+迁移）。
      engagementHook: '历史该主要记住我的艺术高峰，还是我葬送了 167 年王朝的责任？你更偏向哪一种？想 30 秒，写下来。',
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      type: 'narrative',
      content: {
        cn: '你走完了我 53 年。我留下来的东西: 文物——《瑞鹤图》《听琴图》等 10 多件真迹; 字体——21 世纪 macOS、微信里的「瘦金体」; 制度——翰林图画院的国家美术学院模式; 成语——岳飞《满江红》的「靖康耻」始于 1126 我那夜甩锅。\n\n21 世纪对我有三种看法: 一种说我是亡国之君,《宋史》说我「诸事皆能, 独不能为君耳」; 一种说我是天才皇帝, 政治悲剧抹杀不了艺术成就; 一种说才华和盲点同时为真, 不做单一道德评价——这是我倾向的, 但我承认有私心。\n\n跨文化对照: 佛罗伦萨 Lorenzo de\' Medici (1449-1492) 艺术赞助人 + 政治灾难, 路易十六钟表匠 + 断头台——同样「极致才华 + 系统性盲点」。\n\n停 30 秒, 想 Joseph Needham 的问题: 宋代印刷、火药、指南针领先世界 600 年, 为什么 1840 年后被欧洲反超? 文明的盛衰是政治选择的总和, 不是命运。\n\n最后 30 秒。你认识谁是我这种人——有极致才华、也有系统性盲点的家人、创始人或艺术家? 你怎么对待他? 你不必有答案, 900 年了我也没有; 但你愿意想 30 秒, 就是我希望你带走的。\n\n我是赵佶, 1082-1135。北宋最后一个皇帝, 才华和盲点同体的样本。',
        en: 'You have walked through my fifty-three years. What I leave behind: artifacts — Cranes of Good Omen, Listening to the Qin, and a dozen surviving authentic works; a typeface — the Slender-Gold font in every twenty-first century macOS and WeChat is the brush tip I forged nine hundred years ago, now in your phone; an institution — the Hanlin Art Academy as a state academy of art shaped every later age; an idiom — "the shame of Jingkang" in Yue Fei\'s Manjianghong begins on the night I dumped my disaster in 1126.\n\nThree views of me in the twenty-first century: one says I am the emperor who lost the dynasty, the Song History saying I was "capable in everything except being a sovereign"; one says I am an irreplaceable artistic genius whose political tragedy cannot erase the art (Patricia Ebrey, Emperor Huizong, 2014); one says talent and blindness are simultaneously true, no single moral verdict — this is the view I lean toward, though I admit my motive is self-interested.\n\nCross-cultural comparison: Lorenzo de\' Medici (1449-1492, Florence), art patron + political catastrophe; Louis XVI, clockmaker + guillotine — all the same extreme talent plus systemic blindness.\n\nPause thirty seconds and think of Joseph Needham\'s question: Song-era printing, gunpowder, the compass led the world by six hundred years; why did Europe overtake China after 1840? A civilization\'s rise and fall is the sum of political choices, not its fate.\n\nLast thirty seconds. Do you know someone like me — a family member, a founder, an artist you admire, with extreme talent and systemic blindness? How do you treat them? You do not need an answer; nine hundred years on, I do not have one either. But that you are willing to sit and think is what I hope you take away.\n\nI am Zhao Ji, 1082-1135. The last emperor of the Northern Song, a sample of talent and blindness in the same body.',
      },
...
//     苏门四学士 (黄庭坚 / 秦观 / 张耒 / 晁补之) /
//     1057 进士 21 岁 + 制科第三等「百年第一」/ 1037 眉山生 1101 常州死
...
export var suShiLens = {
  ...
  perspectiveTag: 'scholar-exile',
  description: {
    en: 'He is a man who at twenty-one came out of Meishan, a small town in Sichuan, passed the imperial exam in the same year as his younger brother, and stunned the chief examiner Ouyang Xiu into the line, "thirty years from now, people will only remember Su Shi." This pass puts you in his place a few years into Wang Anshi\'s New Policies, when the Green Sprouts Law\'s nominal twenty percent annual interest is being squeezed in practice to fifty or sixty percent on the peasants, and he submits a ten-thousand-character memorial against this kind of reform; the Reform Party calls him a Conservative, yet years later when Sima Guang tries to scrap every New Policy wholesale he refuses that too. You watch a man both factions will not keep, asking what he will do when his only place left to stand is in exile.',
    cn: '他是一个 21 岁从四川眉山走出来、跟弟弟同年中进士、把主考官欧阳修震到留下「三十年后世人但知有苏轼」一句的眉山小城读书人。这一遍让你坐进他在王安石新法推行几年后的位置,看见青苗法名义年息 20% 在地方被压榨到农民实际负担 50-60%,他上一万多字奏章反对「这种改革」;变法派把他打成旧党,可几年后司马光要全废新法他又站出来反对,看他两边都不容、剩下唯一一条路是流放的时候,要靠什么撑住自己。',
  },
  storyboard: [
    {
      id: 'ss-n1',
    ...
    },
    {
      ...
      engagementHook: '从「百年第一」到 130 天死囚——你怎么从这种崩塌站起来？',
      expectsRealAnswer: false,
    },
    {
      id: 'ss-n5',
...
var liQingzhaoStoryboard = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '今天的我, 不知道接下来 56 年会发生什么——不知道 2 年后我会嫁太学生赵明诚; 不知道 27 年后金兵会攻陷开封; 不知道 30 年后我会在建康守着丈夫的灵柩; 不知道 49 岁那年我会因为告夫坐牢 9 天; 不知道我会用一生守一本叫《金石录》的书。\n\n' +
        '接下来 12 节——你跟我走 56 年。',
      en:
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    engagementHook: {
      cn: '3 年 4 城——越州抱箱睡 / 台州一夜丢 50 件 / 温州少 5 卷 / 临安清波门小屋。25 卷 + 200 件——是我接下来要守的。下一节: 1132 春——一个叫张汝舟的人。',
      en: 'Three years, four cities — Yuezhou holding the chest in bed; Taizhou losing fifty in a night; Wenzhou losing five volumes; Lin\'an, a small house at Qingbo Gate. Twenty-five volumes and two hundred inscriptions — what I have left to watch. Next: spring 1132 — a man named Zhang Ruzhou.',
    },
  ...
  // ═══════════════════════════════════════════════════
  // N9 — STORY: 1132 春 张汝舟骗婚 100 天 + 想夺《金石录》
  // ═══════════════════════════════════════════════════
  {
    id: 'lqz-n9',
    type: 'narrative',
    phase: 'story',
    cosplay: 'Li Qingzhao',
    narrativeRef: '§3.8 line 550 1132 年 48/49 岁张汝舟 + 100 天',
    content: {
      cn:
        '1132 年春——我 49 岁。颠沛三年, 刚逃到临安, 在清波门安顿下来。\n\n' +
        '我寡居 3 年——一个人, 没孩子, 没父母, 没婆家。手里 25 卷《金石录》草稿、不到 200 件金石。\n\n' +
        ...
        '我去了临安府的官署。',
      en:
        'Spring 1132 — I was forty-nine. After three years of flight I had just reached Lin\'an and settled at Qingbo Gate.\n\n' +
        'Three years a widow — alone, no child, no parents, no husband\'s family. Twenty-five volumes of Records on Metal and Stone drafts, fewer than two hundred inscriptions.\n\n' +
        ...
        'I hesitated. Forty-nine, a widow, alone.\n\n' +
    ...
    deliverGoal: {
      cn: '1132 春 49 岁我寡居 3 年。张汝舟自称右承奉郎来求婚说「景仰《金石录》愿帮你完成」——我犹豫但答应了。婚后第 2 天他翻樟木箱, 第 3 天用重话, 1 月骂「老寡妇」想拿樟木箱卖。临安老书商告诉我他是伪造文书冒名入仕 + 科举舞弊。100 天看清——他来夺书。',
      en: 'Spring 1132, forty-nine, three years a widow. A man named Zhang Ruzhou, self-styled Right Receiving-Honor Gentleman, came to ask for my hand, saying: "I revere the Records on Metal and Stone — I will help you finish it." I hesitated but agreed. The second day after the wedding he opened the camphor chest. On the third he used hard words. Within a month he was calling me an "old widow," trying to carry the chest out to sell. An old bookseller in Lin\'an told me: he had entered office through forged papers and had cheated in the examinations. A hundred days. He had come for the book.',
    },
    engagementHook: {
  ...
  // ═══════════════════════════════════════════════════
  // N10 — STORY: 1132 夏 妻告夫 9 天牢 綦崇礼营救
  // ═══════════════════════════════════════════════════
  {
    id: 'lqz-n10',
    type: 'narrative',
    phase: 'story',
    cosplay: 'Li Qingzhao',
    narrativeRef: '§3.8 line 550 + §3.8 line 寡妇离婚要坐牢, 她坐 9 天',
    content: {
      cn:
        '1132 年夏——我去了临安府。\n\n' +
      ...
      en:
        ...
        'The cell was a small stone room. I sat on a straw mat nine days. I was forty-nine, three years a widow, now nine days in jail.\n\n' +
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        '在继续之前——停 30 秒。\n\n' +
        '我是 12 世纪的女性, 李清照, 1132 年 49 岁, 9 天前刚出狱。你是 21 世纪的读者, 大概率是中学生。我们之间隔 880 多年。\n\n' +
        '12 世纪的我有什么? 我能读、能写、能学《诗经》《楚辞》、能跟丈夫一起编 30 卷书, 有自己的字号「易安居士」, 我的词晁补之说不输李后主。\n\n' +
        '我没有什么? 没有合法离婚的权利, 告丈夫即使胜诉也要坐牢两年; 49 岁, 没孩子、没父母、没婆家——临安城里我没有任何法律上的「靠山」。\n\n' +
        '21 世纪你呢? 你可以投票, 可以离婚不坐牢, 可以独自出门, 可以署自己的名字发表作品。你还没有什么? 这一题你比我想得多——也许是同工不同酬, 也许是别的, 我不替你回答。\n\n' +
        '我不是想说「我跟你一样」——我们不一样, 880 年的距离是真实的。\n\n' +
        '现在掂量两种读法。一种说: 我这个 12 世纪没有法律地位的女性, 跟 21 世纪的你之间有一条真实的线——同样在受限里坚持读、写、守住自己看重的东西, 隔着 880 年彼此照见。另一种说: 把我和你连起来是危险的拉平——我连合法离婚都没有, 你能投票、能署名、能独自出门, 强行说「我们是一类人」会抹掉我所受那种不公的具体分量。\n\n' +
        '你更偏向哪一种? 给我你最有力的一条理由。想 30 秒, 写下来。',
      en:
        'Before we go on — stop for thirty seconds.\n\n' +
        'I am a twelfth-century woman, Li Qingzhao, 1132, forty-nine, nine days out of jail. You are a twenty-first-century reader, most likely a middle school student. There are more than eight hundred and eighty years between us.\n\n' +
        'What did the twelfth-century me have? I could read, write, study the Book of Songs and the Songs of Chu, compile a thirty-volume book with my husband, and had my own studio name, Yi-an Jushi; Chao Buzhi said my lyrics would not be shamed beside Li Yu.\n\n' +
        'What did I not have? No legal right to divorce; if I accused my husband, even winning meant two years in jail. At forty-nine, no child, no parents, no husband\'s family — in Lin\'an no legal "shelter" of any kind.\n\n' +
        'And you, in the twenty-first century? You can vote, divorce without jail, walk out alone, publish under your own name. And what do you still not have? You can think about this further than I can — perhaps unequal pay, perhaps something else. I do not answer for you.\n\n' +
        'I am not saying "we are the same." We are not. The eight hundred and eighty years between us are real.\n\n' +
        'Now weigh two readings. One says: there is a real line between this twelfth-century woman with no legal standing and the twenty-first-century you — both, under their limits, kept reading, writing, and guarding what they valued, recognizing each other across eight hundred and eighty years. The other says: connecting me to you is a dangerous flattening — I had no legal divorce, while you can vote, publish under your name, walk out alone; forcing "we are one kind of person" erases the specific weight of the injustice I lived under.\n\n' +
        'Which do you lean toward? Give me your strongest single reason. Take thirty seconds, and write it down.',
    },
    deliverGoal: {
      cn: '880 年距离——12 世纪我能读、写、学、跟丈夫共编 30 卷书、有自己字号「易安居士」, 但没合法离婚权 + 告夫坐牢 2 年。21 世纪你能投票 / 离婚不坐牢 / 选学校 / 发表署自己名字。真问题: 把我和你连起来, 是隔 880 年的彼此照见, 还是一种抹掉我所受不公的危险拉平? 你更偏向哪一种, 给一条最有力的理由。',
      en: 'Eight hundred and eighty years apart. The twelfth-century me could read and write, study the classics, compile thirty volumes with her husband, have a studio name — but no legal divorce, two years in jail for accusing her husband. The twenty-first-century you can vote, divorce without jail, choose a school, publish under your name. Real question: is connecting me to you a recognition across eight hundred and eighty years, or a dangerous flattening that erases the injustice I lived under? Which do you lean toward, and your strongest reason.',
    },
    engagementHook: {
      cn: '把我这个 12 世纪没有合法地位的女性, 跟 21 世纪的你连起来——是隔 880 年的彼此照见, 还是抹掉我所受不公的危险拉平? 你更偏向哪一种? 想 30 秒, 写下来。',
      en: 'Connecting this twelfth-century woman with no legal standing to the twenty-first-century you — is it recognition across eight hundred and eighty years, or a dangerous flattening that erases the injustice I lived under? Which do you lean toward? Take thirty seconds, and write it down.',
    },
  ...
  // ═══════════════════════════════════════════════════
  // N12 — CLOSING META: 1132 出狱后《金石录后序》(初稿 1134, 定稿 1135) + 5 Topic information preservation 五面体
  // ═══════════════════════════════════════════════════
  {
    id: 'lqz-n12',
    type: 'narrative',
    ...
    content: {
      cn:
        '1132 年出狱后, 我写《金石录后序》(1134 初稿、1135 定稿), 把跟赵明诚 28 年金石收藏——从 1101 新婚到 1129 他在建康死——整理成序文。\n\n' +
        '序文末尾我写:「然有有必有无, 有聚必有散, 乃理之常……亦欲为后世好古博雅者之戒云。」意思是: 拥有必然变失去; 我记下这一切, 是想给后世爱古物的人一个警戒。\n\n' +
        '1155 年我 71 岁死于临安清波门小屋。25 卷《金石录》草稿后来由朝廷收, 流传到今天——我守了 26 年, 守住了。你 21 世纪读到「然有有必有无」, 这 12 个字穿过 890 年到你, 就是「后世之戒」的兑现。\n\n' +
        '5 门课在做同一件事: 我用《金石录后序》, Mali 用沙漠藏书, Renaissance 用古登堡印刷, Reformation 用 95 Theses, AoE 用哥伦布信——把信息熬过暴力送到几百年后的你。\n\n' +
        '30 秒翻回去想同一批 1126 文物的三种声音: Huizong 是国家收藏者, Su Shi 的书法在我家收藏里 1126 一并失去、是解读者, 我颠沛中守、是受影响者——正是 AP DBQ 的 producer + interpreter + affected party。\n\n' +
        '我守的 26 年, 到你今天读到, 守到了。',
      en:
        'In 1132, after I left jail, I wrote the postface to the Records on Metal and Stone (first draft 1134, final 1135), setting down the whole twenty-eight years of collecting Zhao Mingcheng and I had done — from the thirty rubbings he showed me at our 1101 wedding to his death at Jiankang in 1129.\n\n' +
        'I ended it: "Where there is having, there must be losing; where there is gathering, there must be scattering — this is the way of things … and I leave a warning for later lovers of antiquity." Meaning: having must become losing; I record all of it carefully to leave a warning for later lovers of old things.\n\n' +
        'In 1155, at seventy-one, I died at Qingbo Gate in Lin\'an. The twenty-five volumes of drafts were later taken into the imperial collection and have come down to today — I guarded them twenty-six years, and they were saved. When you, in the twenty-first century, read "Where there is having, there must be losing," these twelve characters cross eight hundred and ninety years to reach you — that is the fulfillment of "a warning for later ages."\n\n' +
        'Five Topics are doing the same thing: I with the postface, Mali with the desert manuscripts, the Renaissance with Gutenberg\'s movable type, the Reformation with the 95 Theses, the Age of Exploration with Columbus\'s letter — five people across five times and places carrying information through violence to you, centuries later.\n\n' +
        'Pause thirty seconds for the three voices over the same 1126 artifacts: Huizong is the state collector, Su Shi\'s calligraphy lost in our collection in 1126 makes him the interpreter, and I who guarded them in flight am the affected party — exactly the AP DBQ producer + interpreter + affected party.\n\n' +
        'My twenty-six years of guarding — until you read these twelve characters today — I kept faith.',
    },
    deliverGoal: {
      cn: '1134 初稿 / 1135 定稿《金石录后序》。原文末尾「然有有必有无, 有聚必有散, 乃理之常。人亡弓, 人得之」+「为后世好古博雅者之戒」。1155 71 岁我死临安清波门——25 卷被朝廷收, 流传到今天。守了 26 年, 守住了。你 21 世纪读到这 12 个字——序文兑现。5 门课五面体: Tang-Song《金石录后序》/ Mali al-Sa\'di 1655 沙漠藏书 / Renaissance 1440 古登堡 / Reformation 1517 95 Theses 14 天 / AoE 1493 哥伦布信 8 月 7 种语言——5 个时空的人做同一件事: 把信息熬过暴力, 送到 400 年后的你。',
...
export var liQingzhaoLens = {
  ...
  description: {
    cn: '她是一个 15 岁就让父亲放下笔、说「这孩子写词比我强」的山东济南女孩，家里四面墙到顶都是书。这一遍让你坐进她 43 岁那年开封陷落、跟丈夫赵明诚用 3 天 3 夜从《金石录》挑出 15 车文物准备南运的位置；丈夫几年后会死在赴任途中，她要抱着樟木箱一路逃过 4 座城，49 岁还会被图谋《金石录》的男人骗婚，看一个守了 26 年书誓的女人要怎么守住一本书。',
    en: 'She is a girl from Jinan in Shandong who at fifteen made her father set down his brush with the line "this child writes ci better than I do," the walls of the house full of books to the ceiling. This pass puts you in her seat at forty-three, the year Kaifeng falls, when she and her husband Zhao Mingcheng spend three days and nights choosing fifteen carts from the Records on Metal and Stone to send south. He will soon die on the road; she will carry a camphor-wood chest alone through four cities, and at forty-nine a man scheming for the Records will trick her into marriage. You watch a woman with a twenty-six-year vow to guard a book, asking how she will keep it.',
  },
