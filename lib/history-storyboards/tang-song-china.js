...
export var emperorHuizongLens = {
  ...
  perspectiveTag: 'aesthete-emperor',
  description: {
    cn: '他是一个 18 岁那天因为哥哥哲宗咳血而死无嗣、被太皇太后一句「先帝尝言端王有福寿」从端王府推上龙椅的画家亲王,宰相章惇当场说他「轻佻不可以君天下」也没拦住。这一遍让你坐进他刚即位、以为接手的是一个艺术爱好者的最高位置(全国所有名画可以收、所有名家可以召进画院)的位置,看他下一步要不要把翰林图画院扩成中国历史上第一所国家美术学院、要不要慢慢把财政从军备转去养画师,而他不知道 26 年后开封会被金军攻陷、自己 44 岁会被押向北方一个叫五国城的小屋。',
    en: 'He is the painter prince who, on the day his elder brother Emperor Zhezong died at twenty-five coughing blood and without an heir, was lifted onto the dragon throne at eighteen by a single line from the Grand Empress Dowager, "the late emperor said the Prince of Duan has good fortune and long life," even after the chancellor Zhang Dun said openly to his face that he was "frivolous and cannot govern the realm." This pass puts you in his seat the moment he takes the throne, believing he has inherited an art-lover\'s dream, every famous painting in the empire to collect, every great master to summon to the academy, and you watch whether he is about to expand the Hanlin Art Academy into the first state art school in Chinese history, slowly pull the fiscal budget from military preparation into painters\' salaries, with no idea that twenty-six years from now Kaifeng will fall to the Jin and he will be marched north at forty-four to a small hut in a place called the Five Kingdoms City.',
  },
  storyboard: [
    // ═══════════════════════════════════════════════════
...
export var liQingzhaoLens = {
  ...
  description: {
    cn: '她是一个 15 岁就让父亲把笔放下、说出「这孩子写词比我强」的山东济南女孩,母亲是状元的孙女,家里四面墙到顶都是书。这一遍让你坐进她 43 岁那年(1126 年闰 11 月 25 日)开封陷落,她跟丈夫赵明诚用 3 天 3 夜从他们 28 年抄成的 2000 件 30 卷《金石录》里挑出 15 车文物准备南运的位置;丈夫几年后会在赴任途中染疫死在建康,她要靠一双手抱着樟木箱一路逃过 4 座城,51 岁还会被一个图谋《金石录》的男人骗婚,看一个有名字、有易安居士字号、有 26 年守书誓言的女人,要怎么守住一本书。',
    en: 'She is a girl from Jinan in Shandong who at fifteen made her father set down his brush with the line "this child writes ci better than I do," her mother the granddaughter of an examination laureate, the four walls of the house full of books to the ceiling. This pass puts you in her seat at forty-three, on the leap eleventh month twenty-fifth day of 1126 when Kaifeng falls; she and her husband Zhao Mingcheng spend three days and three nights choosing fifteen carts from the two thousand inscriptions in thirty volumes of the Records on Metal and Stone they have copied together for twenty-eight years, to send south. A few years later he will die of plague at Jiankang on the road to a posting, and she will carry a camphor-wood chest alone through four cities; at fifty-one a man scheming for the Records will trick her into marriage, and you watch a woman with a name, with the studio name Yi-an Jushi, with a twenty-six-year vow to guard a book, asking how she will keep it.',
  },
