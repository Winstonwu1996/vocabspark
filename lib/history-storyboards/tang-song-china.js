...
var liQingzhaoStoryboard = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '现在掂量两种读法。一种说: 我这个 12 世纪没有法律地位的女性, 跟 21 世纪的你之间有一条真实的线——同样在受限里坚持读、写、守住自己看重的东西, 隔着 880 年仍然彼此照见。另一种说: 把我和你连起来是一种危险的拉平——我连合法离婚都没有, 你能投票、能署名、能独自出门, 强行说「我们是一类人」会抹掉我所受的那种 categorical 不公的具体分量。\n\n' +
        '你更偏向哪一种? 给我你最有力的一条理由。想 30 秒, 写下来。',
      en:
        'Before we go on — I ask you to stop for thirty seconds.\n\n' +
        'I am a twelfth-century woman — Li Qingzhao, 1132, forty-nine, nine days out of jail.\n\n' +
        ...
        'What did the twelfth-century me not have? I had no legal right to divorce. If I accused my husband, even when I won the case, I served two years in jail. At forty-nine, I had no child, no parents, no husband\'s family — in Lin\'an I had no legal "shelter" of any kind.\n\n' +
        ...
        'Now weigh two readings. One says: there is a real line between this twelfth-century woman with no legal standing and the twenty-first-century you — both, under their limits, kept reading, writing, and guarding what they valued, and across eight hundred and eighty years they still recognize each other. The other says: connecting me to you is a dangerous flattening — I had no legal divorce, while you can vote, publish under your name, walk out alone; forcing "we are one kind of person" erases the specific weight of the categorical injustice I lived under.\n\n' +
        'Which do you lean toward? Give me your strongest single reason. Take thirty seconds, and write it down.',
    },
    deliverGoal: {
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        '1132 年——出狱后——我开始写《金石录后序》。1134 年初稿, 1135 年定稿。\n\n' +
        '我把跟赵明诚 28 年金石收藏的全过程——从 1101 年新婚他拿出 30 多张拓片, 到 1129 年他在建康死, 到 1132 年我在临安清波门——整理成一篇序文。\n\n' +
        ...
        '5 门课在做同一件事:Tang-Song 我用《金石录后序》, Mali al-Sa\'di 1655 用《Tarikh es-Sudan》+ 沙漠藏书, Renaissance 1440 用古登堡印刷, Reformation 1517 用 95 Theses + 14 天传遍德意志, Age of Exploration 1493 用哥伦布信 + 8 月 7 种语言。\n\n' +
      ...
      en:
        '1132 — after I left jail — I began writing the postface to the Records on Metal and Stone. The first draft in 1134, the final version in 1135.\n\n' +
        'I set down the whole twenty-eight-year story of the metal-and-stone collecting that Zhao Mingcheng and I had done — from the thirty rubbings he showed me three days after our wedding in 1101, to his death at Jiankang in 1129, to me at Qingbo Gate in Lin\'an in 1132 — and shaped it into one preface.\n\n' +
