...
to the poor, officials, and scholars that Cairo's gold price fell by ~12% —
...
the Griot oral tradition, not written records.`,
    ...
    // ── 考点 NEW-A：库鲁坎富加宪章 / 曼登宪章（高频 DBQ 考点，现无独立卡）──
    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'mansa-musa-perpetrator', nodeId: 'mansa-musa-N1', context: '曼萨穆萨引用松迪亚塔的合法性时曾提及宪章精神' },
        ],
      },
      standaloneText: {
...
**与 Magna Carta 对比**——AP DBQ 经典比较角度：
...
clans to an assembly on the plain of Kurukan Fuga, where he promulgated what later
came to be known as the Manden Charter.

**Core provisions (7 clauses)**:
1. Protection of human dignity — no person may be enslaved or humiliated
2. Equal right of women to speak
3. Children may not be abused or abandoned
4. Protection of trees, water, and animals (environmental clause)
5. Different clans shall not attack one another — peaceful coexistence
6. Prisoners of war must be treated humanely and not killed
7. The emperor is bound by law and may not kill arbitrarily

**Comparison with Magna Carta (1215)** — a classic AP DBQ comparative angle:
- Timing: Magna Carta 1215, Kurukan Fuga 1235 (20 years later)
- Beneficiaries: Magna Carta protected only barons; Kurukan Fuga protected all people
...
Comparative law angle: its protections are broader than Magna Carta's, yet it has long
been overlooked.`,
      },
      xiaoweiNote: {
        cn: `这张卡专门从松迪亚塔考点卡里独立出来——因为 AP DBQ 非常爱考
"比较两个不同文明的法律文件"。
...
记忆锚：库鲁坎富加（Kurukan Fuga）= 平原的名字。
2009 年 UNESCO 列入非物质文化遗产 = 考试可引用的国际权威背书。`,
        en: `This card is pulled out of the Sundiata card specifically because AP DBQ loves
"compare legal documents from different civilizations."
...
Answer: Kurukan Fuga — not the famous Magna Carta — which is exactly the point
the question is testing.

Memory anchor: Kurukan Fuga = name of the plain where it was proclaimed.
2009 UNESCO Intangible Heritage listing = internationally authorized citation for your essay.`,
    ...
    // ── 考点 NEW-B：加纳帝国（Ghana Empire，马里前身）──────────────
    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'mansa-musa-perpetrator', nodeId: 'mansa-musa-N1', context: '曼萨穆萨的财富继承了加纳帝国奠定的黄金贸易传统' },
        ],
      },
      standaloneText: {
...
**核心事实**：
- 位置：今毛里塔尼亚南部、马里西部（非今天的加纳共和国——名字 1957 年后殖民时代借用，
  地理上古加纳在现加纳共和国以西约 800 公里）
...
**"帝国接力"（Imperial Relay）**——AP 比较帝国经典框架：
加纳（c.300-1235）→ 马里（1235-约1400）→ 桑海（约1400-1591）
三代帝国均依托撒哈拉黄金贸易，逐代继承贸易路线与控制权。

考点关键句：马里帝国不是凭空出现的——它继承了加纳
近千年积累的撒哈拉贸易网络与黄金控制模式。`,
        en: `The Ghana Empire (known internally as Wagadou, in Soninke) was West Africa's first
...
- Location: southern Mauritania and western Mali today (not modern Ghana — the name
  was borrowed in 1957 during decolonization, some 800 km east of ancient Ghana's territory)
- Capital: Kumbi Saleh
...
- 1235: Sundiata defeated the Sosso Kingdom (Ghana's successor state); the Mali name
  replaced "Ghana," but the gold trade tradition was inherited intact
...
**Modern Ghana** (independent 1957) chose the Ghana name as a post-colonial act of
cultural reclamation — but geographically it lies roughly 800 km east of ancient
Ghana Empire's core territory.
...
如果曼萨穆萨当时选择低调出行，历史会不同吗？`,
      en: `In 1324, Mansa Musa's Hajj procession caused Cairo's gold price to fall by ~12%,
...
(University of Sankore, ~5,000-10,000 scholars in the 14th century, tens of thousands of manuscripts).
