...
Form ≠ substance — that runs through the whole topic.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['lp-n4', 'jc-n3'],
        xiaoweiNote: {
          cn: `这个故事里讲得很重——平民 lens 第 4 节、Caesar lens 第 3 节都有。
...
life.** The first de facto emperor was his adopted heir, Octavian. Don't mix the two up.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是默认那一遍（失地平民）整条线，也是这个 topic 我最被打动的角度。重点：N1、N6（卖票）、N7（当炮灰）、N9（结局）。
...
the Gracchi's deaths) and **only then** sold. It's a **structural** problem, not a moral failing.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个 Caesar lens 第 9 节讲到了（他死后的事），失地平民 N9 也从穷人角度补了一笔。
...
（Gilded Age）几乎一模一样。如果你跑过那个 Topic，想想：单靠"宪法设计"挡得住这条循环吗？`,
