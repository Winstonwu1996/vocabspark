...
just call him a "hypocrite" in an essay; that's oversimplifying and loses points.`,
    ...
    // ── 卡 4（故事覆盖）：Social Darwinism + Gospel of Wealth 的意识形态 ──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个三个视角的 N6 都讲到了，是这一课设计得最巧的一处——同一句"适者生存"，
三个人三个方向。
...
**考点关键句**：Populism 是农民对镀金时代不平等的直接政治反击；1896 是第一次真正的"穷人 vs 金融资本"全国大选。`,
        en: `Who were the Populists? In the 1870s-1890s, railroad companies charged farmers high freight rates, bank interest crushed small farms, and crop prices kept falling. Farmers could not recover — they erupted.

The **1892 Omaha Platform** was the People's Party's manifesto. Core demands:
- Monetary policy: free coinage of silver to expand the money supply, letting farm debts deflate;
- Railroad nationalization: government takeover to stop monopoly pricing;
- A graduated income tax: the rich pay more.

The **1896 election** was the showdown. Democratic candidate **William Jennings Bryan** ran with People's Party backing and delivered the thundering "Cross of Gold" speech: "You shall not crucify mankind upon a cross of gold!"

Result: Republican McKinley, backed by industrial capital, won; the gold standard held; the People's Party dissolved. But its demands — graduated tax, railroad regulation, direct election of senators — were all enacted in the Progressive Era.

Key exam sentence: Populism was farmers' direct political pushback against Gilded Age inequality; 1896 was the first true "poor vs. financial capital" national election.`,
      },
      xiaoweiNote: {
...
AP often asks: what was the People's Party's biggest historical impact? Answer: they lost, but their policy demands all became 20th-century law.`,
      },
    },
...
**"新南方"（New South）** 是南方精英的宣传词，声称南方要工业化、向前看。现实是：棉花仍主导，佃农制（sharecropping）把黑人和白人穷人都困在债务循环里，旧的种族等级换了法律外壳重新巩固。
...
**关键判例 Plessy v. Ferguson（1896）**：最高法院裁定"隔离但平等"（separate but equal）合宪，给 Jim Crow 体系提供了联邦背书，直到 1954 年 Brown v. Board 才推翻。

**考点关键句**：Jim Crow 不是内战前的延续，而是重建失败之后**重新建造**的种族压迫制度；Plessy 1896 是它的法律基石。`,
        en: `Reconstruction ended in 1877 and federal troops left the South. What followed?

"New South" was a slogan of Southern elites claiming the region would industrialize and move forward. The reality: cotton still dominated, the sharecropping system trapped Black and poor white farmers in debt cycles, and the old racial hierarchy was rebuilt with a legal shell.
...
Key case Plessy v. Ferguson (1896): the Supreme Court ruled "separate but equal" constitutional, giving federal backing to the Jim Crow system — until Brown v. Board overturned it in 1954.

Key exam sentence: Jim Crow was not a continuation of pre-Civil War slavery — it was a system of racial oppression rebuilt after Reconstruction's failure; Plessy 1896 is its legal cornerstone.`,
      },
      xiaoweiNote: {
...
记忆口诀："重建结束 → 联邦撤手 → 各州立 Jim Crow → Plessy 背书 → 1954 才打破。"`,
        en: `Teacher said this card connects the long arc from Reconstruction through the Gilded Age to Civil Rights — must know cold.
Three anchors:
- Sharecropping: the debt chain that trapped Black economic life after Reconstruction;
- Jim Crow laws: segregated every public space + the menu of disenfranchisement tools;
- Plessy v. Ferguson 1896: "separate but equal" ruled constitutional — memorize this year!

Big trap: Jim Crow was not a direct continuation of slavery — it was a new system built after Reconstruction collapsed. That distinction shows up in DBQs.
