...
🔗 故事连接：卡内基在 Lens 1 说他"用最新炼钢法把成本压到全行业最低，把对手一个个挤垮"——
...
🔗 故事连接：Lens 1 卡内基自己的 N10 就是活的双叙事——
...
最难也最重要的一点（Lens 1 N8）：他**真心相信**自己在做时代最大的善事，
...
just call him a "hypocrite" in an essay; that's oversimplifying and loses points.`,
    ...
    // ── 卡 4（故事覆盖）：Social Darwinism + Gospel of Wealth 的意识形态 ──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个三个 Lens 的 N6 都讲到了，是这个 Topic 设计得最巧的一处——同一句"适者生存"，
三个人三个方向。
...
跨 Lens 对位（这个我超喜欢）：
- Carnegie（Lens 1 N6）用"适者生存"证明"我该富"；
- Gompers（Lens 2 N6）一边恨它替富人撑腰，一边用它的逻辑给工人划"保得住/放弃"的门槛；
- Homestead 工人（Lens 3 N6）躺在血泊里看清：在河岸边，"适者"就是手里握枪的那一方。
...
papers and the public sympathized with workers and damned Frick and the Pinkertons.`,
    ...
    // ── 卡 6（故事覆盖 + 部分独立）：劳工运动两条线 — Knights of Labor / AFL / Gompers ──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Gompers 那条 Lens 2 讲透了 AFL，我把另一个必考工会（Knights of Labor）补在下面。
