...
Tea ceremony and ikebana also appear as answer choices — know all three.`,
    ...
    // ─ 9. 战国三杰与下克上（standaloneText — NOT covered）────────
    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'sesshu-mediator', nodeId: 'sesshu-N2', context: '雪舟晚年经历应仁之乱（1467），战国时代的序幕' },
        ],
      },
      standaloneText: {
...
考点：三杰顺序"信长开局、秀吉统一、家康收盘"——AP 常以此考 continuity and change。`,
...
The defining phenomenon of this era is **gekokujo** (/ɡɛkɒkuːdʒoʊ/) — literally "those below overthrowing those above," describing lower-ranking warriors and even men of peasant origin overthrowing their superiors and seizing power. The entire feudal hierarchy was inverted: birth no longer determined destiny; capability was the currency.

The three figures who successively brought this chaos to resolution are known as the "Three Unifiers":

**Oda Nobunaga (1534-1582)**
The man who made unification imaginable. Key moves:
- Abolished guild monopolies in his territories (raku-ichi raku-za free-market policy), attracting population and tax revenue
- First to systematically deploy the matchlock musket (tanegashima, introduced from Portugal in 1543): at the 1575 Battle of Nagashino, his volley-firing infantry formations broke Takeda cavalry, transforming Japanese warfare
- Killed in 1582 by his own general Akechi Mitsuhide in a sudden betrayal at Honnoji (Honnoji Incident), leaving the unification mission unfinished

**Toyotomi Hideyoshi (1537-1598)**
The most extreme gekokujo case — of peasant origin, rising to Taiko (supreme regent).
- By 1590 eliminated the last resistant power (the Odawara Hojo clan), achieving tenka toitsu (unification under one rule)
- Launched invasions of Korea (1592, 1597) aiming at Ming China — ultimately withdrew in failure, with severe damage to both Korea and the Ming dynasty
- Died in 1598, leaving a power vacuum

**Tokugawa Ieyasu (1543-1616)**
The ultimate winner. Won the 1600 Battle of Sekigahara, received appointment as Seii Taishogun in 1603, established the Edo Bakufu.
...
- 1603 → Edo Bakufu established`,
    ...
    // ─ 10. 江户幕府与锁国（standaloneText — NOT covered）────────
    {
      id: 'edo-sakoku',
      termCn: '江户幕府与锁国',
...
**锁国（sakoku，1635 年令）**：原则上禁止日本人出国、外国人入境；只留长崎（Nagasaki）一口岸对荷兰和中国开放。动机：防止天主教渗透（幕府视其为瓦解政治忠诚的外来意识形态），防止外样大名借贸易积累武力。

**锁国后果**：国内文化繁盛（浮世绘 ukiyo-e、歌舞伎 kabuki、俳句 haiku 均在江户时代达顶峰）；商人阶层（町人 chonin）积累大量财富。1853 年美国黑船（Perry's Black Ships）强行打开口岸，锁国终结，引发 1868 年明治维新。

AP 考点：sakoku 是"受控接触"非"完全隔绝"——兰学（rangaku，通过荷兰人学欧洲科学）始终延续，为明治快速现代化埋下伏笔。`,
...
**Bakuhan taisei (shogunate-domain system)**: the shogun's direct domain combined with the semi-autonomous domains of regional daimyo. Daimyo were classified as "shinpan" (Tokugawa relatives), "fudai" (retainers who pledged loyalty before Sekigahara), and "tozama" (those who submitted only after Sekigahara). Tozama daimyo were positioned in remote regions to limit their threat.

**Sankin-kotai (/sɑːŋkɪn kɒtaɪ/, alternate-attendance system)**: daimyo were required to alternate residence between Edo (the shogunate capital) and their home domain every other year. Their families were kept in Edo as de facto hostages. This institutional design prevented daimyo from accumulating resources for rebellion, and as a side effect generated an extensive road network and a thriving commercial culture.

**Sakoku (/sɑːkɒkuː/, 1635 edict, "closed country" policy)**:
...
- Motivation: prevent Catholic (Christian) infiltration — the shogunate viewed Christianity as a foreign ideology that dissolved political loyalty; also prevent tozama daimyo from accumulating wealth and weapons through trade
...
- Economically: the merchant class (chonin) accumulated substantial wealth, despite their nominally low social status relative to samurai
- 1853: Perry's Black Ships arrived, forcing an end to sakoku, directly triggering the late-shogunate crisis and the 1868 Meiji Restoration

Key AP exam sentence: sakoku was not "total isolation" but "controlled contact" — the Nagasaki port stayed open throughout, and Japan continued learning about European science through Dutch traders (rangaku, "Dutch learning").`,
      },
      xiaoweiNote: {
        cn: `锁国（sakoku）是 CA 7.5 考点。记住两件事：
(1) 为什么锁国？防基督教 + 防外样大名变强。
(2) 锁国不等于"完全关门"——长崎始终开着，荷兰和中国可以贸易。
...
(1) Why sakoku? Block Christianity + prevent tozama daimyo from growing stronger.
(2) Sakoku does not mean "complete closure" — Nagasaki stayed open; Dutch and Chinese trade continued.
