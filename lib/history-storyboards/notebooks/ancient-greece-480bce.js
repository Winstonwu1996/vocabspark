...
not the representative system we have today.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `metic 那一遍整条线就是这个，第 3、6、8 节最戳人。这是整门课最锋利的考点：
...
误：「雅典和斯巴达一样，温泉关赢了」→ 正：真正**扭转战局**的是海上的 **Salamis**，是**雅典**的功劳。
...
Wrong: "The 300 Spartans held Thermopylae." → Right: **Thermopylae was a loss** — the men all died and the
road was not held.
Wrong: "Athens was like Sparta, they won at Thermopylae." → Right: The battle that truly **turned the war**
...
won by clever strategy at sea.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是整门课最核心的一条**事实链**，Themistocles 那一遍第 3 节和 Laurion 矿奴那一遍第 3、6 节
...
故事连接：metic 第 9 节、Laurion 矿奴第 9 节都把这条线接到了 1776 《独立宣言》和 1787 费城那段历史。你跑过那段历史
...
- Philadelphia: the 1776 Declaration of Independence cried "**all men are created equal**"; the 1787 Constitution opened with "**We the People**" — yet that "people" counted only **propertied white men** at the time. The enslaved, women, and native peoples were drawn outside the line, and the Constitution counted the enslaved as **three-fifths of a person**. (Note: "all men are created equal" is in the Declaration, not the Constitution — keep the two documents straight.)
...
Story link: the metic's Node 9 and the Laurion miner's Node 9 both connect this line to the 1776 Declaration and the 1787 Philadelphia topic. If you have run that topic, you'll recognize "We the People" and the "Three-Fifths
Compromise."`,
      },
      xiaoweiNote: {
