  ...
  mainConcepts: [
    {
      ...
      defCn: '城邦（polis）是古希腊的一种独立小国：一座城 + 周围的农村土地 + 自己的一套法律和政府，打包成一个能自己管自己的小国家。希腊不是一个大国，而是几百个这样的城邦各自为政。',
      defEn: 'A polis (city-state) was an independent mini-country in ancient Greece: one city plus its surrounding farmland plus its own laws and government — all bundled into a self-ruling unit. Greece was not one big country but hundreds of these poleis, each running its own affairs.',
      standardRef: ['CA HSS 6.4 — Ancient Greece', 'AP World Unit 1 — state-building'],
      examFrequency: 'high',
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { storyLine: 'Themistocles 那条故事线', nodeId: 'them-n2', context: 'Themistocles 讲希腊不是一个国家，是 Athens / Sparta / Corinth 等几百个互相打仗的城邦' },
          { storyLine: 'metic 那条故事线', nodeId: 'mt-n2', context: 'metic 讲雅典是个地少粮缺、靠海运买粮卖橄榄油和陶器的贸易城邦' },
        ],
      },
      standaloneText: {
        cn: `**城邦（polis）** 是理解整个古希腊的钥匙，故事里反复提到，值得单独弄清楚。
...
故事连接：Themistocles 那条故事线第 2 节讲「希腊不是国家，是几百个互相打仗的城邦」；metic 那条故事线第 2 节让你看见雅典作为贸易城邦的样子。`,
        en: `**The polis (city-state)** is the key to all of ancient Greece. The stories mention it
over and over — worth understanding on its own.
...
scattered among mountains and islands. Each ran its own affairs — its own laws, its own gods,
its own army — and in normal times they often fought one another. The most famous: Athens,
Sparta, Corinth.
...
vote** — that is the physical reason "direct democracy" was possible. A country too large cannot
...
Themistocles' story explains "Greece is not a country, but hundreds of
city-states that fought one another." The metic's story lets you see Athens as a
trading polis.`,
      },
      xiaoweiNote: {
...
Must-memorize cause-effect: small polis → citizens can meet face to face and vote → that's why
...
alliance to hold off the Persian Empire. Lock in the word "small" and half the point is yours.`,
...

    {
      ...
      defCn: '雅典民主（democracy，demokratia）是公元前 508 年前后由 Cleisthenes（克利斯提尼）建立的一套制度：把大事的决定权从少数贵族手里交给全体公民，所有符合资格的公民可以在公民大会（Assembly）投票。这是人类历史上最早有文献记录的公民集体自治实验之一。',
      defEn: 'Athenian democracy (demokratia) was a system created around 508 BCE by Cleisthenes: it moved decision-making power from a few aristocrats to all citizens, who could vote in the Assembly (ekklesia) on major matters. It is one of the earliest documented experiments in citizens ruling themselves collectively.',
      standardRef: ['CA HSS 6.4 — Athenian democracy', 'AP World Unit 1 — participatory government'],
      examFrequency: 'highest',
      storyAnchor: {
        covered: true,
        storyLine: 'Themistocles + metic 两条故事线',
        nodeIds: ['them-n8', 'mt-n3'],
        xiaoweiNote: {
          cn: `Themistocles 那条故事线第 8 节、metic 那条故事线第 3 节都讲到了，我把它压成一条时间线：
...
注意时间陷阱（老师反复纠正）：**508 比 480 更早。** 公元前的数字越大越早！
...
雅典是 **直接民主**（公民亲自到场投票、抽签任职），不是我们今天的代议制。`,
          en: `Themistocles' story and the metic's story both cover this. I compress it
into one timeline:
...
big decisions — whether to go to war, who would be general, whether to build ships — were decided
...
Date trap (teacher kept correcting it): **508 is earlier than 480.** The bigger the BCE number,
...
not the representative system we have today.`,
...

    {
      ...
      defCn: '雅典的「公民」（citizen）只包括：成年 + 男性 + 父母都是雅典人。符合这三条的人才能在公民大会投票。女性、被奴役者、metic（居留外邦人）全部被排除，他们加在一起是全城人口的绝大多数。',
      defEn: 'In Athens, a "citizen" meant only: adult + male + both parents Athenian. Only those three conditions together gave you a vote in the Assembly. Women, enslaved people, and metics (resident foreigners) were all excluded — together they made up the vast majority of the city\'s population.',
      standardRef: ['CA HSS 6.4 — Athenian society', 'AP World Unit 1 — social structures', 'AP DBQ rubric'],
      examFrequency: 'highest',
      storyAnchor: {
        covered: true,
        storyLine: 'metic 那条故事线',
        nodeIds: ['mt-n3', 'mt-n6', 'mt-n8'],
        xiaoweiNote: {
          cn: `metic 那条故事线整条都在讲这个，第 3、6、8 节最戳人。这是整门课最锋利的考点：
...
它发明的不只是「让公民参与」，还有一条特别清楚的线：**谁算人民，谁不算。** 光荣和排除，是同一套制度的两面。`,
          en: `The metic's whole story is about this, and hit hardest. This is the
sharpest point in the whole topic: **"citizens governing themselves" is true in every word — what
trips you up is how small the word "citizen" was drawn.**
...
- **The enslaved** — not counted as "people" at all, but property (about a quarter to a third of
...
are two faces of one system.`,
...

    {
      ...
      defCn: '公元前 480-479 年的希波战争里有三场关键战役。① Thermopylae（温泉关）：陆地，斯巴达带头，输了。② Salamis（萨拉米斯）：海战，雅典带头，决胜——全歼波斯舰队，扭转整场战争。③ Plataea（普拉提亚）：陆地，斯巴达带头，赢，终结战争。',
      defEn: 'Three battles decided the Persian Wars of 480-479 BCE. ① Thermopylae: land battle, Sparta led, a loss. ② Salamis: sea battle, Athens led — a decisive win that destroyed the Persian fleet and turned the war. ③ Plataea: land battle, Sparta led, a win that ended the war.',
      standardRef: ['CA HSS 6.4 — Persian Wars', 'AP World Unit 1 — empire vs city-states'],
      examFrequency: 'highest',
      storyAnchor: {
        covered: true,
        storyLine: 'Themistocles 那条故事线',
        nodeIds: ['them-n4', 'them-n6', 'them-n7'],
        xiaoweiNote: {
          cn: `Themistocles 那条故事线第 4、6、7 节把整场战争串起来了。背景：波斯大王 **Xerxes（薛西斯）**
...
两个高频错误：
① 误：「斯巴达 300 勇士守住了温泉关」→ 正：**Thermopylae 是输的**——人全死了，路没守住。
② 误：「真正扭转战局的是 Thermopylae」→ 正：真正**扭转战局**的是海上的 **Salamis**，是**雅典**的功劳。

记忆锚：**陆地（斯巴达，Thermopylae 输 / Plataea 收尾）vs 海上（雅典，Salamis 决胜）。**
后人爱讲「300 勇士」那个悲壮的失败，却常忘了真正赢仗的是海上的精明谋略。`,
          en: `Themistocles' story string the whole war together. Background: Persian
king **Xerxes** wanted to settle the old score from the 490 BCE battle of Marathon, and in 480 BCE
led the largest army of the age against Greece.
...
① Wrong: "The 300 Spartans held Thermopylae." → Right: **Thermopylae was a loss** — everyone died
and the road was not held.
② Wrong: "Thermopylae turned the war." → Right: The battle that truly **turned the war** was
**Salamis** at sea — and that was **Athens'** doing.
...
won by clever strategy at sea.`,
...

    {
      ...
      defCn: '三列桨战船（trireme）是雅典海军用的战船，靠几百名划桨手驱动，船小灵活。公元前 483 年，雅典在城南 Laurion 银矿挖到富矿脉；Themistocles 说服公民大会用这笔银造约 200 条三列桨战船，这支海军在公元前 480 年 Salamis 海战中打垮了波斯舰队。',
      defEn: 'The trireme was the war-galley of Athens\' navy — driven by hundreds of rowers, small and nimble. In 483 BCE, Athens struck a rich vein at the Laurion silver mines south of the city; Themistocles persuaded the Assembly to use that money to build about 200 triremes, and this navy destroyed the Persian fleet at Salamis in 480 BCE.',
      standardRef: ['CA HSS 6.4 — Persian Wars / Athenian navy', 'AP World Unit 1 — economy & state power'],
      examFrequency: 'high',
      storyAnchor: {
        covered: true,
        storyLine: 'Themistocles + Laurion 矿奴两条故事线',
        nodeIds: ['them-n3', 'ls-n3', 'ls-n6'],
        xiaoweiNote: {
          cn: `这是整门课最核心的一条**事实链**，Themistocles 那条故事线第 3 节和 Laurion 矿奴那条故事线第 3、6 节
...
同一点银子，两种完全相反的意思（第 6 节）：**在 Themistocles 手里是「救希腊的本钱、雅典的光荣」；在矿奴手里是「用我的命换的，救的从来不是我」。**

考点关键句：雅典的海上霸权不是凭空来的——**底下垫着 Laurion 的银，银底下垫着挖银人的命。**`,
          en: `This is the most central **chain of facts** in the whole topic. Themistocles' story
and the Laurion miner's story tell the same thing from two ends. I memorize it as a
**cause-effect chain**:
...
Break it down:
- **Trireme**: a warship driven by hundreds of rowers straining together. It was **small and
  nimble** — in the **narrow strait** at Salamis, Persia's many large ships jammed into a mass,
  too cramped to turn, ramming one another, while Athens' small ships darted in to ram and won.
- **Where the money came from**: in 483 BCE Athens struck a rich vein at the **Laurion silver
  mines** south of the city. Most citizens wanted to share the silver out per head; **Themistocles**
  persuaded the Assembly not to, and to build a navy with it instead.
- **The price**: that silver was dug with their lives by **the enslaved miners of Laurion**.

The same silver, two opposite meanings (Node 6): **in Themistocles' hands it is "the capital that
saved Greece, Athens' glory"; in the miner's hands it is "bought with my life, and what it saved
was never me."**
...
silver, and under the silver lay the lives of the people who dug it.**`,
...

    {
      ...
      defCn: '雅典（Athens）和斯巴达（Sparta）是古希腊最有名的两座城邦，但制度完全不同。雅典是民主制，靠海上贸易和海军；斯巴达是军事寡头制，靠陆地重装步兵和被奴役的 helot（希洛人）。两者都是蓄奴社会。',
      defEn: 'Athens and Sparta were the two most famous Greek city-states, but they were completely different. Athens was a democracy relying on sea trade and its navy; Sparta was a military oligarchy relying on land infantry and enslaved helots. Both were slaveholding societies.',
      standardRef: ['CA HSS 6.4 — Sparta and Athens', 'AP World Unit 1 — comparative state types'],
      examFrequency: 'high',
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { storyLine: 'Themistocles 那条故事线', nodeId: 'them-n4', context: 'Themistocles 讲斯巴达是陆地最强、只信硬碰硬，Leonidas 率约 300 人守 Thermopylae' },
          { storyLine: 'Laurion 矿奴那条故事线', nodeId: 'ls-n8', context: 'Laurion 矿奴那条故事线拆穿斯巴达靠数倍于己的 helot 国家奴隶养着全职战士，甚至每年合法杀一些防造反' },
        ],
      },
      standaloneText: {
...
故事连接：Themistocles 那条故事线第 4 节让你看见斯巴达「只信陆地硬碰硬」；
Laurion 矿奴那条故事线第 8 节专门拆穿斯巴达 300 勇士背后的 helot。`,
        en: `In the stories Athens and Sparta keep appearing together, but they were in fact **two
utterly different kinds of polis** — teacher said never lump them together as "both Greek heroes."
...
neighbors and turned whole peoples into **state slaves (helots)** to till the land and labor,
feeding the full-time Spartan warriors. The helots outnumbered the Spartans **several times over** —
and the Spartans, fearing revolt, even "lawfully" killed some helots each year.

Why this matters for the exam: many people assume "Sparta = Athens, both Greek heroes who fought
for freedom." In fact:
① The two cities had completely different systems (one a democracy, one a military oligarchy).
② Both cities were **slaveholding societies** — Athens on the Laurion miners, Sparta on the helots.
"Free Greece" itself stood on slaves.

Themistocles' story shows Sparta "believing only in a head-to-head stand on
land"; the Laurion miner's story takes apart the helots behind the 300 Spartans.`,
      },
      xiaoweiNote: {
...
line is gold for a DBQ essay.`,
...

    {
      ...
      termEn: 'Ostracism',
      defCn: '陶片放逐（ostracism）是雅典民主的一种投票机制：公民每年有一次机会，把想赶走的人的名字刻在碎陶片（ostrakon）上投票；得名最多的人被放逐出城十年，不用审判、不用定罪。目的是防止任何一个人权力太大、变成独裁者（tyrant）。',
      defEn: 'Ostracism was a yearly Athenian vote: citizens scratched the name of the man they wanted gone onto a broken potsherd (ostrakon); whoever got the most names was exiled from the city for ten years — no trial, no conviction needed. The point was to stop any one person from gaining too much power and becoming a tyrant.',
      ...
      storyAnchor: {
        ...
        nodeIds: ['them-n9'],
        xiaoweiNote: {
          cn: `Themistocles 那条故事线第 9 节讲到了，结局特别讽刺，所以单列一张卡。
...
讽刺的结局（DBQ 爱用的张力）：救了雅典、赢了 Salamis 的英雄 **Themistocles**，约公元前 471 年
...
这两面同时成立。（考古真的挖出过刻着 Themistocles 名字的陶片。）`,
          en: `Themistocles' story covers this, and the ending is so ironic it gets its own card.
...
**ten years** — **no trial, no conviction** — purely because "you are too powerful and we don't
trust it."
...
Key exam sentence: ostracism was both democracy's **wisdom in guarding against tyranny** and a way
for **a city's savior to be exiled without any crime, by the same people he saved** — both faces at
once. (Archaeologists really have dug up potsherds scratched with Themistocles' name.)`,
        },
      },
    },

    {
      ...
      defCn: '雅典被后世称为「民主的摇篮」，demokratia 这个理念影响了后世整个西方政治。但雅典同时留下了一道难题：一个自由的共同体，凭什么决定「谁算人民、谁被排除」？这条「谁在里面、谁在外面」的线，从雅典一直被重画到今天——包括 1787 年美国宪法的「We the People」。',
      defEn: 'Athens is called the "cradle of democracy," and the idea of demokratia shaped Western politics for centuries. But Athens also left a hard question: on what grounds does a free community decide who counts as "the people" and who gets left out? That line — who is in, who is out — has been redrawn from Athens all the way to today, including the 1787 U.S. Constitution\'s "We the People."',
      standardRef: ['CA HSS 6.4 — legacy of Greece', 'AP World Unit 1 — long-term continuity', 'AP DBQ rubric'],
      examFrequency: 'high',
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { storyLine: 'metic 那条故事线', nodeId: 'mt-n9', context: 'metic 把「谁算自己人」这条线从雅典连到 1787 费城 We the People' },
          { storyLine: 'Laurion 矿奴那条故事线', nodeId: 'ls-n9', context: 'Laurion 矿奴把「自由踩在不自由人身上」连到 1787 宪法 3/5 妥协 + 种棉花奴隶' },
        ],
      },
      standaloneText: {
        cn: `这一张卡讲「**so what？这一切跟两千多年后的我们有什么关系**」——AP World 最看重的「长期影响」。
metic 那条故事线第 9 节和 Laurion 矿奴那条故事线第 9 节都点到了，但没系统讲，所以单独掌握。
...
- 1776 年《独立宣言》喊「**人人生而平等**」；1787 年《宪法》开头喊「**We the People（我们人民）**」——可那个「人民」当时只算**有产白人男性**，
  被奴役者、女人、原住民被画在线外，《宪法》还把被奴役者算成 **3/5 个人**。（注意：「人人生而平等」在《独立宣言》，不在《宪法》——两份文件要分清。）
- 直到今天：公民权、投票权的辩论，还在继续画这条线。

考点金句：**「谁被算进政治共同体」是一道跨两千年的同一道题**——从雅典的 metic 和矿奴，到费城的
「We the People」。这条线**从来不是天经地义的，它是人画的；是人画的，就能被人重新画。**

故事连接：metic 那条故事线第 9 节、Laurion 矿奴那条故事线第 9 节都把这条线接到了 1776 《独立宣言》和 1787 费城那段历史。你跑过那段历史
的话会认得「We the People」「3/5 妥协」。`,
        en: `This card answers "**so what — what does all this have to do with us two thousand years
later**" — the "long-term impact" AP World prizes most. The metic's story and the
Laurion miner's story both touch it, but don't lay it out fully, so master it separately.
...
What Athens left was not only "participation," but also a hard question: **on what grounds does a
free community decide "who counts as the people and who is excluded"?** This line has been redrawn
from Athens to today:
- Athens: **citizen = adult Athenian male** (women / the enslaved / metics excluded).
- The 1776 Declaration of Independence cried "**all men are created equal**"; the 1787 Constitution
  opened with "**We the People**" — yet that "people" counted only **propertied white men** at the
  time. The enslaved, women, and native peoples were drawn outside the line, and the Constitution
  counted the enslaved as **three-fifths of a person**. (Note: "all men are created equal" is in
  the Declaration, not the Constitution — keep the two documents straight.)
- To this day: debates over citizenship and voting rights are still drawing this line.

Key exam line: **"who is counted into the political community" is one and the same question across
two thousand years** — from Athens' metics and miners to Philadelphia's "We the People." That line
**was never fixed by nature; it was drawn by people, and what people draw, people can redraw.**

the metic's story and the Laurion miner's story both connect this line
to the 1776 Declaration and the 1787 Philadelphia topic. If you have run that topic, you'll
recognize "We the People" and the "Three-Fifths Compromise."`,
      },
      xiaoweiNote: {
        cn: `老师说 AP 评分最爱看「**跨时空对位**」——能把雅典和 1787 费城放在一起比，立刻就是高分答案里的
复杂性（complexity）。我的口诀：**雅典「公民 = 成年男性」 ↔ 费城「We the People = 有产白人男性」**，
同一道「谁算人民」的题，隔了两千年。

记两件事就够：
① 雅典是民主的源头（但直接民主 ≠ 现代代议制）；
② 那条「谁在里、谁在外」的排除线，两千年来一直被重画——既然是人画的，今天还能继续画。`,
        en: `Teacher said AP scoring loves a **cross-time pairing** — putting Athens and 1787 Philadelphia
side by side instantly shows the kind of complexity that earns top marks. My mnemonic:
**Athens "citizen = adult male" ↔ Philadelphia "We the People = propertied white men"** — the same
"who counts as the people" question, two thousand years apart.

Two things are enough:
① Athens is the source of democracy (but direct democracy is not modern representative democracy).
② That line of "who is in, who is out" has been redrawn for two thousand years — and since people
draw it, people can keep drawing it.`,
      },
    },
  ],
...
高分写法：承认两边都站得住，再说明你为什么更倾向某一边——AP 把这叫 complexity（复杂性），是顶分必须有的。`,
...
- Evidence for "it deserves it": a scatter of small city-states really did hold off the largest empire
  of the age; it preserved "citizens governing themselves," something humankind had never truly tried,
  which later grew into democracy that shaped the whole world.
...
High-scoring move: acknowledge both sides stand, then explain why you lean one way — AP calls this
complexity, and you need it to hit the top score.`,
...
each? Which is fairer? Then connect to today: how long must a person live in a country, and how much
must they give, to count as "one of us"? AP wants you to "pin" the abstract question to real evidence
with one concrete situation — the metic.`,
...
history."
For the second part, cite one specific mechanism: ostracism — a yearly vote, names on potsherds, the
most-named exiled for ten years, no trial. It is at once the **wisdom of guarding against tyranny** and
a way for **a city's savior to be driven out without a crime** (Themistocles is the example). Going
deeper: in your school, team, or clubs today, is there a design that "uses rules to keep any one person
from growing too powerful"? Do you think such guarding is necessary, or does it chill the people who
actually get things done? AP wants you to pin the abstract claim to evidence with one real mechanism.`,
