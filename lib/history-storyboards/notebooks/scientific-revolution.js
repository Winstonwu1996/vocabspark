...
他被迫公开宣布放弃日心说，被判终身软禁在佛罗伦萨郊外。（伽利略从未被判火刑——火刑是混淆了布鲁诺 Giordano Bruno 1600 年被烧死一事产生的神话。）
...
He was forced to publicly recant the heliocentric view. He spent the rest of his life under house arrest outside Florence. (Galileo was never sentenced to burning at the stake — that myth comes from confusion with Giordano Bruno, who was burned in 1600.)
...
Mnemonic: **"Kepler changed circles to ellipses; Newton explained why."**`,
...

    {
      ...
      termCn: '科学革命→启蒙运动：方法论怀疑迁移到社会政治',
      termEn: 'Scientific Revolution to Enlightenment: Methodological Doubt Applied to Society',
      standardRef: ['AP World KC-4.5', 'AP World KC-5.3', 'CA HSS 7.7', 'AP DBQ rubric'],
      examFrequency: 'highest',
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'mersenne-mediator', nodeId: 'mersenne-N6', context: '梅森与笛卡尔通信讨论"怀疑一切权威"的方法论' },
          { lens: 'newton-perpetrator', nodeId: 'newton-N10', context: '牛顿晚年被启蒙哲学家奉为"理性力量"的象征' },
        ],
      },
      standaloneText: {
        cn: `这张卡连接两门课：科学革命（约 1500-1700）和启蒙运动（约 1680-1800）。
AP World KC-4.5 考科学革命，KC-5.3 考启蒙运动——两者之间的因果链，
是 AP 最爱考的 causation（因果）和 continuity（延续）题型。

**核心逻辑：方法论怀疑的迁移**

笛卡尔的那句话——"我思，故我在"——背后有一个激进的方法论前提：
他要怀疑一切被接受的权威，包括教会、传统、亚里士多德，直到找到不可推翻的基础。
培根说：不要引用权威，去做实验，让事实说话。
伽利略被审判，但他坚持"地球还是在动"——用观测证据对抗宗教权威。

这套"不接受权威，要求证据和理性"的方法论，在 17 世纪用于自然科学。
启蒙哲学家做了一件事：把同一把刀砍向社会和政治权威。

**因果链（AP 必背）**

科学革命确立：自然世界由可发现的理性规律支配，人类理性能够理解这些规律。
↓
启蒙哲学家推论：如果自然世界有理性规律，人类社会也应该有——君主的权力、
教会的权威、贵族的特权，都不是"天然正确"的，应该用理性检验。
↓
洛克（John Locke）：人生来有自然权利（生命、自由、财产），
政府的权力来自被统治者同意——这是科学革命"实验检验权威"的社会政治版本。
↓
孟德斯鸠（Montesquieu）：用观察比较各国政府制度，得出"三权分立"
——他在做的，是对政治制度做"科学分析"。
↓
美国《独立宣言》（1776）和法国《人权宣言》（1789）：
把启蒙运动的"自然权利+理性政府"变成政治现实。

**关键概念对照（选择题高频）**

科学革命的工具 → 启蒙运动的用法
- 观察/实验取代引用权威 → 理性检验君主制/教会
- 普遍自然规律 → 普遍人权（natural rights）
- 哥白尼推翻宇宙中心论 → 启蒙推翻"君权神授"
- 伽利略被审判仍坚持证据 → 启蒙思想家批评宗教不宽容

考点关键句：启蒙运动不是从天而降的，它是把科学革命的"方法论怀疑"
从研究自然世界迁移到批判社会政治秩序——同一把工具，不同的对象。`,
...
KC-5.3 tests the Enlightenment. The causal chain between them is exactly what AP
loves to test as causation and continuity questions.

**Core logic: the migration of methodological doubt**

Behind Descartes's "I think, therefore I am" sat a radical methodological premise:
he would doubt every accepted authority — the Church, tradition, Aristotle — until
he found an unshakeable foundation. Bacon said: stop citing authorities, run experiments,
let the evidence speak. Galileo was tried but held that "the Earth still moves" —
using observational evidence against religious authority.

This methodology of "reject authority, demand evidence and reason" was applied to natural
science in the 17th century. The Enlightenment philosophers did one thing: they picked up
the same instrument and turned it on social and political authority.

**The causal chain (AP must-memorize)**

Scientific Revolution established: the natural world is governed by discoverable rational
laws, and human reason can find them.
↓
Enlightenment philosophers reasoned: if the natural world has rational laws, human society
should too — the power of monarchs, the authority of the Church, the privileges of nobility
are not "naturally correct"; they should be tested by reason.
↓
John Locke: people are born with natural rights (life, liberty, property); government
power comes from the consent of the governed — the social-political version of the
Scientific Revolution's "test authority with experiment."
↓
Montesquieu: he observed and compared governments across countries and derived
separation of powers — he was applying "scientific analysis" to political systems.
↓
The U.S. Declaration of Independence (1776) and France's Declaration of the Rights of
Man (1789): Enlightenment "natural rights + rational government" became political reality.

**Key concept comparison (high-frequency multiple choice)**

Scientific Revolution tool → Enlightenment application
- Observation/experiment replaces citing authority → Reason tests monarchy and the Church
- Universal natural laws → Universal natural rights
- Copernicus overturns the geocentric universe → Enlightenment overturns divine-right monarchy
- Galileo tried but holds to evidence → Enlightenment thinkers criticize religious intolerance

Key exam sentence: the Enlightenment did not appear from nowhere — it transferred the
Scientific Revolution's "methodological doubt" from studying the natural world to
critiquing the social and political order. Same instrument, different target.`,
      },
      xiaoweiNote: {
        cn: `老师说 AP 最爱出的 causation 题型之一就是："科学革命如何导致了启蒙运动？"
我的记法：**科学方法 = 用证据挑战权威。启蒙 = 把同一招用在国王和教会上。**

选择题常考：洛克的"自然权利"和牛顿的"自然规律"有什么共同的思维基础？
答案：都相信存在普遍的、理性可发现的规律，人类不需要依赖传统权威才能理解世界。

还有一个记忆钩子：孟德斯鸠写《论法的精神》，他研究了大量国家的政治制度，
就像一个科学家做比较实验——这不是巧合，他自己说受到了牛顿方法论的启发。`,
        en: `Teacher said one of AP's most common causation questions is: "How did the Scientific
Revolution lead to the Enlightenment?" My version: scientific method = using evidence to
challenge authority. Enlightenment = applying that same move to kings and the Church.

Multiple choice often asks: what shared intellectual foundation links Locke's "natural rights"
and Newton's "natural laws"? Answer: both assume that universal, rationally discoverable
principles exist, and that humans don't need traditional authority to understand the world.

One more memory hook: Montesquieu wrote The Spirit of the Laws after studying political
systems across many countries, like a scientist running comparative experiments — this
was no accident. He said himself that Newton's methodology inspired him.`,
      },
    },
