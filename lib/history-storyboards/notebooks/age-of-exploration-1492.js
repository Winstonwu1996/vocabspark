...
Multiple-choice favorite: who was the first to round the Cape of Good Hope? Answer: **Dias**, NOT da Gama. Da Gama was the first to reach India — different thing!`,
...

    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { storyLine: '哥伦布那条故事线', nodeId: 'columbus-N2', context: '哥伦布站在圣玛利亚号（caravel）的甲板上，用星盘测量纬度' },
        ],
      },
      standaloneText: {
...
**caravel（卡拉维尔帆船）**：
15 世纪葡萄牙人改进的新型帆船，比之前的船更小、更灵活，吃水浅（可以进入浅海岸线探索），同时能抗风浪。哥伦布的旗舰"圣玛利亚号"是 caravel，另外两艘"尼尼亚号"和"平塔号"也是。
...
**Caravel**:
A new type of sailing ship improved by the Portuguese in the 15th century. Smaller and more maneuverable than earlier ships, with a shallow draft (good for exploring coastlines) but still capable of handling rough seas. Columbus's flagship, the Santa María, was a caravel — so were the Niña and the Pinta.
