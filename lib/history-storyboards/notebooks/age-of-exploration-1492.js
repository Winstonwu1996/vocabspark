...
**为什么中国要白银？**
明朝"一条鞭法"规定税收必须用白银缴纳，而中国自己没有大银矿。
美洲约 1/3 的白银最终流入中国。

**Potosí 银矿（1545，今玻利维亚）**：
此后 200 年全球 ~50% 白银来自这里；约 800 万 Quechua 原住民死于矿井强制劳动。
...
考点关键句：马尼拉大帆船证明 1492 年后世界贸易从"区域性"变成"真正全球性"——KC-4.3 核心例子。`,
        en: `**Why was silver the "blood" of the Age of Exploration?**

In 1545, the Spanish discovered the largest silver deposit in human history at Potosí
(in modern Bolivia). Over the next 200 years, roughly 50% of the world's silver came
from this one mountain. The miners were mainly conscripted Quechua Indigenous people;
an estimated 8 million died in the mines.

**The Manila Galleon**:
In 1571, after Spain seized Manila in the Philippines, Spain opened the
Acapulco (Mexico) ↔ Manila (Philippines) trade route.
This route operated for 250 years (1565-1815) and was the first truly global
trade route in human history.

Trade flow:
- American silver (Potosí) → Acapulco → Manila → China
- Chinese silk + porcelain + tea → Manila → Acapulco → Spain

**Why did China need silver?**
In the 16th century, the Ming dynasty shifted to the "Single Whip Law" tax reform,
requiring all taxes to be paid in silver. China needed vast amounts of silver
but had no major silver mines of its own —
American silver filled the gap perfectly.
Estimates suggest roughly one-third of all American silver ultimately flowed into China.

**Global impact (KC-4.3 core)**:
- The flood of silver into China drove up prices (inflation)
- Spain received so much silver it neglected manufacturing, leading to long-term
  economic decline (an early version of "Dutch Disease")
- Manila became the world's first trade hub connecting the Americas, Asia, and Europe

Key exam sentence: The Manila Galleon route is the signature KC-4.3 example —
it proves that after 1492, world trade shifted from "regional" to "truly global":
a chunk of Peruvian silver could become Manila silk, then become a cathedral in Seville.`,
      },
      xiaoweiNote: {
        cn: `AP 常考：马尼拉大帆船航线证明了什么？
答案不只是"贸易扩张"——要答到"第一条连接三大洲的全球贸易系统"。

记忆方法：**Potosí（银）→ Acapulco → Manila → 中国（丝绸）**——画一个三角形，
三个顶点分别是美洲 / 菲律宾 / 中国。
KC-4.3 考的就是这种"洲际贸易网络"，马尼拉大帆船是最经典例子。`,
        en: `AP favorite: what does the Manila Galleon route prove?
Don't just say "trade expanded" — answer "the first global trade system
connecting three continents."

Memory trick: **Potosí (silver) → Acapulco → Manila → China (silk)** —
draw a triangle with three points: Americas / Philippines / China.
KC-4.3 tests exactly this kind of "intercontinental trade network";
the Manila Galleon is the most classic example.`,
      },
    },
...
1405 年明朝宦官郑和率 317 艘船 + 27,800 人七下西洋（1405-1433）。
宝船长约 130 米，是哥伦布圣玛利亚号的 7 倍。
足迹遍及东南亚、印度、中东、东非，目的是朝贡外交而非殖民掠夺。

**1433 年，一切停了。**
- 永乐帝 1424 年去世，继任者无海洋野心
- 儒家士大夫：远航耗费国库，"天朝无需向夷狄学习"
...
考点关键句：1433 年中国主动撤退时技术和财力均领先欧洲；
欧洲扩张不是因为"更先进"，而是被奥斯曼封锁逼到大西洋后别无选择。
AP Comparison / Causation 经典案例。`,
        en: `**Zheng He (1371-1433): roughly 70 years before Columbus**

In 1405, Ming dynasty eunuch admiral Zheng He led the largest fleet in history:
317 ships, 27,800 sailors. His flagship "treasure ship" was about 130 meters long —
seven times the length of Columbus's Santa María (19 meters).

Seven voyages from 1405 to 1433 reached Southeast Asia, India, the Middle East,
and as far as East Africa (modern Kenya and Somalia).
The goal was tribute diplomacy — displaying Ming power and attracting vassal states —
not colonization or resource extraction.

**Then, in 1433, everything stopped.**

Why:
- The Yongle Emperor died in 1424; his successors lacked his maritime ambitions
- Confucian scholars argued the voyages drained the treasury and that the "Celestial Empire
  had nothing to learn from barbarians"
- By 1474, a ban declared "no plank shall be permitted on the open sea";
  around 1525, some sources record that voyage records were destroyed

**Why did Europe keep going while China stepped back?** (Rule 0: compare without judging)
...
Key exam sentence: When China voluntarily stepped back in 1433, it held superior technology
and wealth compared to Europe; Europe's continued expansion was not because it was "more advanced"
but because — with the Mediterranean blocked by the Ottomans — it had no other choice.
This is a classic AP World Comparison and Causation prompt.`,
      },
      xiaoweiNote: {
        cn: `这张卡是华裔学生的超强入口——郑和是很多华裔家庭耳熟能详的人物。

AP 常问：为什么中国没有殖民美洲？
不能只写"中国停止航海了"——要答到制度/意识形态/经济动机三层。

比较题陷阱：不要说郑和"比哥伦布强"或"欧洲更先进"——
Rule 0: 两条路径各有各的逻辑，AP 考的是你能不能不带偏见地解释两边。

时间线口诀：**郑和 1405，哥伦布 1492，中间差约 87 年——但 1433 后中国主动退出。**`,
        en: `This card is a strong entry point for students with Chinese heritage —
Zheng He is a familiar figure in many Chinese-American families.

AP often asks: why didn't China colonize the Americas?
Don't just write "China stopped sailing" — answer with three layers:
political structure, ideology, and economic motivation.

Comparison trap: don't say Zheng He was "better" or that "Europe was more advanced" —
Rule 0: both paths had their own logic, and AP rewards explaining both without bias.

Timeline mnemonic: **Zheng He 1405, Columbus 1492, roughly 87 years apart —
but China voluntarily exited after 1433.**`,
      },
    },
