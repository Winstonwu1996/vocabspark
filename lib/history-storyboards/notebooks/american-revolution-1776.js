  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['jef-n2'],
        xiaoweiNote: {
          cn: `这个 Jefferson Lens 第 2 节讲了。起因是钱：英国打完跟法国的大仗（1763 年结束）
...
the final push.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Jefferson Lens 第 1、3、5 节就是这个。1776 年 6 月，大陆会议派了五人起草委员会
...
天赋人权、政府权力来自被统治者的同意、人民有权推翻暴政。（跑过 enlightenment 那个 Topic 会认得他。）
...
to be fought to 1781 and 1783 to actually win it.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Jefferson Lens 第 5、8 节讲了整场仗。我把它压成一条时间线背：
...
independence 1783.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['loy-n2'],
        xiaoweiNote: {
          cn: `Loyalist Lens 第 2 节专门讲这个，也是最颠覆我直觉的一节。
...
Memory anchor: **Patriot = wanted independence; Loyalist (also called Tory) = loyal to the king.**`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `被奴役者 Lens 第 4、5 节讲的就是这个，是我读完最忘不掉的一节。
...
"freedom" was the very Britain the colonists meant to resist.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['jef-n7'],
        xiaoweiNote: {
          cn: `Jefferson Lens 第 7 节他自己一笔笔算了这本账。那句「人人生而平等」当时到底指谁？
诚实地说，范围窄得多。
...
and the note later generations used to collect the debt.`,
...

    {
      ...
      standaloneText: {
        cn: `这条故事里只一笔带过（Jefferson Lens 第 7 节），但它是 AP 利益相关方分析的高频反直觉点，
值得单独掌握。
...
🔗 故事连接：Jefferson Lens 第 7 节，他算「人人平等」把谁排除在外时，
