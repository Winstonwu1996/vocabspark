...
more question: whose liberty?"`,
    ...
    keyFigures: [
      ...
      },
      {
        ...
        nameEn: 'Thomas Paine',
        ipa: '/ˈtɒməs peɪn/',
        roleCn: '英国移民，1776 年 1 月写《常识》小册子，把「独立」的道理用大白话讲给普通殖民者听，三个月卖出约 10 万册，直接加速独立决议',
        roleEn: 'English immigrant who wrote Common Sense in January 1776, making the case for independence in plain language; sold roughly 100,000 copies in three months and directly accelerated the vote for independence',
        mustKnow: true,
        audioKey: 'thomas-paine',
      },
      {
        nameCn: '亚伯拉罕·林肯',
  ...
  mainConcepts: [
    {
      ...
      defCn: '英国打完七年战争欠下巨债，转向 13 个殖民地连续加税，殖民者以「无代表，不纳税」为由一步步抗议升级，最终走向独立战争。',
      defEn: 'After the Seven Years\' War left Britain in deep debt, it taxed the 13 colonies one law after another; colonists pushed back with "no taxation without representation," and protests escalated step by step into armed revolution.',
      ...
      storyAnchor: {
        ...
        nodeIds: ['jef-n2'],
        xiaoweiNote: {
          cn: `Jefferson 那条故事线里讲了这个。起因是钱：英国打完跟法国的大仗（1763 年结束）
...
AP 常问"哪些是远因，哪些是导火索"——加税是远因，Intolerable Acts 是临门一脚。`,
          en: `Jefferson's story covers this. The cause was money: after a great war with
France (ended 1763) Britain was buried in debt, and turned to the 13 colonies to tax them,
one tax after another.

I memorize the causation chain as one line (AP loves causation questions):
...
step, "tax → protest → punishment → protest again." AP often asks "which are long-term causes
and which are the trigger" — the taxes are the long-term cause, the Intolerable Acts the final push.`,
        },
      },
    },

    {
      ...
      defCn: '1776 年 7 月 4 日，大陆会议通过的文件，宣告 13 个殖民地脱离英国独立，核心是「人人生而平等」那句话。这是 APUSH 必读文件，逐字考。',
      defEn: 'The document adopted by the Continental Congress on July 4, 1776, announcing that the 13 colonies were breaking from Britain. Its core line — "all men are created equal" — is tested word-for-word on APUSH as a required document.',
...
仗还要打到 1781、1783 才真赢。`,
          en: `Jefferson's story covers this in several parts. In June 1776 the Continental
...
tyranny. (You'll recognize him if you've done the Enlightenment topic.)

Key exam sentence: **on July 4, 1776** the Continental Congress formally adopted the Declaration.
But watch a misconception trap — ❌ "signing the Declaration meant independence"
...
to be fought to 1781 and 1783 to actually win it.`,
...

    {
      ...
      defCn: '美国独立战争从 1775 年第一枪打到 1783 年巴黎和约，靠法国结盟才扭转劣势，最终赢得独立。',
      defEn: 'The Revolutionary War ran from the first shots in 1775 to the Treaty of Paris in 1783. A French alliance in 1778 turned the tide, and the war ended with American independence.',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Jefferson 那条故事线里讲了整场仗。我把它压成一条时间线背：

**1775.4 Lexington / Concord（莱克星顿与康科德）第一枪**——「响彻世界的一枪」。
注意：仗比宣言早打了一年多，宣言不是空谈，是「已经动手了，告诉世界为什么动手」。

前期很惨：英军是当时世界最强，这边是临时凑的民兵（militia，就是平民组成的战斗队）和大陆军，缺枪缺钱缺粮。
...
记忆锚：第一枪 1775 → 宣言 1776 → 法国 1778 → 决战 1781 → 独立 1783。`,
          en: `Jefferson's story covers the whole war. I compress it into a timeline:
...
(ordinary civilians organized into fighting units) and a Continental Army short of guns, money,
and food. **In the winter of 1777 to 1778 at Valley Forge**, thousands froze or starved.
...
independence 1783.`,
...

    {
      ...
      defCn: '独立派（Patriot）支持脱离英国，保皇派（Loyalist，又叫 Tory）效忠英王，中立者两边都不站。John Adams 粗略估计三方各占三分之一左右——这是估计，不是精确数据。',
      defEn: 'Patriots wanted independence from Britain; Loyalists (also called Tories) stayed loyal to the king; neutrals chose neither side. John Adams roughly estimated each group was about a third — treat this as an estimate, not exact data.',
      ...
      storyAnchor: {
        ...
        nodeIds: ['loy-n2'],
        xiaoweiNote: {
          cn: `Loyalist 那条故事线里专门讲这个，也是最颠覆我直觉的部分。
...
记忆锚：**Patriot = 要独立；Loyalist（又叫 Tory 托利党人）= 效忠英王。**`,
          en: `The Loyalist's story covers this — and it overturned my gut sense the most.
...
Memory anchor: **Patriot = wanted independence; Loyalist (also called Tory) = loyal to the king.**`,
...

    {
      ...
      defCn: '1775 年 11 月，英国派驻弗吉尼亚的总督邓莫尔勋爵宣布：凡属于反叛殖民者的被奴役者，逃出并加入英军即可获得自由。这是一步军事棋，不是出于善心，但对被奴役者来说是当时唯一够得着的自由。',
      defEn: 'In November 1775, Lord Dunmore — Britain\'s royal governor in Virginia — declared that enslaved people belonging to rebel colonists who fled and joined the British army would be freed. It was a military tactic, not mercy, but for the enslaved it was the one thread of freedom within reach.',
      standardRef: ['CA HSS 5.5', 'APUSH Period 3 Topic 3.6', 'AP DBQ rubric'],
      examFrequency: 'mid',
      storyAnchor: {
        covered: true,
        ...
        xiaoweiNote: {
          cn: `被奴役者那条故事线里讲的就是这个，是我读完最忘不掉的部分。
...
给被奴役者开「自由」支票的，恰恰是殖民者要反抗的那个英国。`,
          en: `The enslaved person's story covers this — the part I could not forget.
...
"freedom" was the very Britain the colonists meant to resist.`,
...

    {
      ...
      defCn: '独立宣言里的「人人生而平等」，当时实际上只指有产的白人男性。被奴役者（约占总人口五分之一）、女性、原住民、无产白人男性，全都被排除在「人人」之外。',
      defEn: '"All men are created equal" in the Declaration applied, in practice, only to propertied white men. The enslaved (about a fifth of the population), women, Native peoples, and propertyless white men were all shut out of "all men."',
      standardRef: ['CA HSS 5.5', 'APUSH Period 3 — Required Document', 'AP DBQ rubric'],
      examFrequency: 'highest',
      storyAnchor: {
        covered: true,
        ...
        nodeIds: ['jef-n7'],
        xiaoweiNote: {
          cn: `Jefferson 那条故事线里他自己一笔笔算了这本账。那句「人人生而平等」当时到底指谁？
诚实地说，范围窄得多。
...
所以这句话既是当时的空头支票，也是后人讨债的凭据。`,
          en: `Jefferson's story has him reckon this ledger himself. Whom did "all men are
...
3. **Native nations** — colonists pushed west seizing their land (its own card below).
...
and the note later generations used to collect the debt.`,
...

    {
      ...
      defCn: '美国独立战争期间，大多数原住民部族选择支持英国，而不是殖民者。原因很简单：一直在向西扩张、抢夺他们土地的，是殖民者，而英国曾划线限制殖民者西进。',
      defEn: 'During the Revolutionary War, most Native nations sided with Britain rather than the colonists. The reason: it was the colonists who kept pushing west and taking their land, while Britain had tried to limit that westward expansion.',
      ...
      standaloneText: {
        cn: `这条在故事里只一笔带过（Jefferson 那条故事线里算谁被「人人平等」排除时提到），
但它是 AP 利益相关方分析的高频反直觉点，值得单独掌握。
...
- 英国在 1763 年曾划过一条线（Proclamation Line，公告线），试图限制殖民者越过阿巴拉契亚山向西占地。
...
🔗 故事连接：Jefferson 那条故事线里算「人人平等」把谁排除在外时，
亲口承认殖民者西进抢地、大多数原住民部族因此站到了英国那边。`,
        en: `The story only mentions this in passing — in the part where Jefferson's story reckons
who "all men are equal" left out — but it's a high-frequency, counter-intuitive point for AP
stakeholder analysis, worth mastering on its own.
...
- In 1763 Britain had drawn a line (the Proclamation Line) trying to limit colonists from
  ...
  tried to hold back colonial expansion.
...
🔗 in Jefferson's story, when he reckons who "all men are equal" left out, he
admits the colonists pushed west seizing land, which is why most Native nations took Britain's side.`,
      },
      xiaoweiNote: {
...
land is smaller.**`,
...

    {
      ...
      defCn: '1776 年 1 月，英国移民 Thomas Paine 出版小册子《常识》，用大白话把独立的理由讲给普通殖民者听。三个月卖出约 10 万册，把独立从精英辩论变成了普通人的话题，直接推动当年夏天的独立决议。',
      defEn: 'In January 1776, English immigrant Thomas Paine published the pamphlet Common Sense, making the case for independence in plain language for ordinary colonists. It sold roughly 100,000 copies in three months, turning independence from elite debate into a mass movement, and directly helped push the Congress\'s independence vote that summer.',
      ...
      standaloneText: {
        cn: `故事里没讲，但它是 APUSH Period 3 最高频考点之一，这门课没提到它，必须补上。
...
✅ 想法早存在，《常识》让它**大规模扩散**并赋予道德正当性。`,
        en: `The story doesn't cover this, but it is one of the single highest-frequency APUSH
Period 3 exam points — and this whole topic has zero mention of it, so it needs to be here.

**On January 10, 1776**, English immigrant **Thomas Paine** published the pamphlet
*Common Sense*. He had arrived in America only two years earlier.

*Common Sense* did one decisive thing: it took the argument for independence out of
elite debate and put it, in **plain English**, directly in front of ordinary colonists.
...
The scale: roughly **100,000 copies** sold within three months (total colonial population
about 2.5 million). This directly accelerated the Continental Congress's vote for independence
in summer 1776.

Key exam sentences:
- ***Common Sense* turned independence from "a debate among political elites" into
  "a mass popular movement."**
- Timeline: *Common Sense* January 1776 → Declaration of Independence July 1776 — public
  opinion came first, then the Declaration.

⚠️ Misconception trap: ❌ "*Common Sense* gave people the idea of independence for the
first time" → ✅ the idea existed before; *Common Sense* **spread it at mass scale**
...
public opinion came first, then the Declaration.
...
institution of monarchy itself — Paine was more radical.`,
...

    {
      ...
      defCn: '美国革命后的第一部成文宪法，1781 年生效。因为殖民者怕再来一个强权中心，所以故意把联邦政府造得很弱：不能收税、不能强制各州服从。弱到无法运转，1789 年被联邦宪法取代。',
      defEn: 'The first written constitution of the United States, taking effect in 1781. Because colonists feared a powerful central government, they deliberately made it weak — no power to tax, no way to force states to comply. It was too weak to work and was replaced by the federal Constitution in 1789.',
...
为 1787 年宪法埋下直接原因。**
跨课指针：制宪细节在 constitutional-convention-1787 那门课，本课只需掌握「为什么失败」。`,
        en: `The story doesn't cover this — it focuses on the 1775–1783 war and the Declaration.
But "the first framework of government after the Revolution" is a standalone high-frequency
APUSH Period 3 point that can't be skipped.

**The Articles of Confederation**:
drafted in 1777, took effect in 1781 (after all states ratified it), and was replaced by the
federal Constitution in 1789. It was the first written constitution of the United States.

**Why was it so weak?**
The Revolution was fought to escape "one powerful center" — what colonists feared most was
another London, so they **deliberately** built the central government weak:

| What the Confederation had | What it lacked |
|---|---|
| Diplomacy / war / treaty power | Power to tax citizens directly |
| Could request funds from states | A unified executive (no president) |
| Managed western lands | Federal courts |
| | A common currency or trade rules |

Three key weaknesses (AP must-knows):
- **No power to tax**: could only "request" money from states, which often refused.
- **One vote per state**: major decisions required nine states; **amending the Articles required
  unanimous consent of all thirteen.**
- **No enforcement mechanism**: the central government could not make any state comply.
...
powerless to stop them. This produced a consensus that "this framework must be replaced"
— and directly drove the Constitutional Convention of 1787.

Key exam sentences:
- **The Articles were a product of the Revolution's fear of strong power; they were too weak
  to function and became the direct cause of the 1787 Constitution.**
- Cross-topic pointer: the 1787 Constitutional Convention is its own topic
  (constitutional-convention-1787); here you only need to master "why the Articles failed."`,
      },
      xiaoweiNote: {
        cn: `这条故事里没有，老师单独补的。
...
to the Convention.`,
...

    {
      ...
      defCn: '1776 年，清乾隆皇帝在位，正值「康乾盛世」高峰，是当时世界最大的中央集权帝国之一。把美国革命（天赋人权立国）和清代（天命皇权立国）并排对照，帮我们看见两套文明各自的「纸面理想」与「现实排除」之间的裂缝。',
      defEn: 'In 1776, the Qianlong Emperor ruled at the height of the Qing dynasty\'s golden age — one of the world\'s largest centralized empires. Placing the American Revolution (founded on natural rights) beside Qing China (founded on the Mandate of Heaven) shows how very different political systems both had a gap between their stated ideals and whom they left out.',
