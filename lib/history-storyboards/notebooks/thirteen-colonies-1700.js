  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['is-n8'],
        xiaoweiNote: {
          cn: `这个我读过！契约奴 Lens 第 8 节专门把三块地讲清楚了。
...
they were three completely different societies.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是全 topic 最重的一张卡，种植园主 Lens 第 4、5、9 节从「设计者」内部讲了全过程。
三个 lens 都从各自一面碰到它，但精英这条线最完整。
...
South slid step by step into chattel slavery.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ce-n7'],
        xiaoweiNote: {
          cn: `种植园主 Lens 第 7 节讲「地是从哪来的」，最戳人。
...
Equiano left a firsthand account of the Middle Passage.)`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ce-n8'],
        xiaoweiNote: {
          cn: `种植园主 Lens 第 8 节讲到了——连「赢家」头上也压着英国这道天花板。
...
**本 topic 只讲约 1700 的殖民地社会，不碰独立战争。** 别写串了。
...
🔗 故事连接：契约奴 Lens 第 8 节讲三大区时点到 Quaker 和 Puritan；
种植园主 Lens 第 10 节自评里提到自己「守法、上教堂」——殖民地精英的生活围着教会转。`,
