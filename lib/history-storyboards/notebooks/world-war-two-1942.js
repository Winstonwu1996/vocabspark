...
export var notebook = {
  ...
  preview: {
    cn: `今天老师说我们要学二战（World War II, 1939-1945）。她说这是个很大、很重的主题，要花好几节课，因为它不只是打仗，还连着人类做过的最黑的一件事。
...
🔗 跨主题连接：第 10 节 Speer 自己点了——他和黑死病那段历史（black-death-1347）里那个 14 世纪投票参与屠杀犹太邻居的屠夫 Konrad，隔 600 年，是同一种"平庸之恶"标本。`,
...
🔗 跨主题连接：第 10 节他自己点了——他和废奴那段历史的 Harriet Tubman（违法把奴隶带向自由）、scramble-for-africa 的 George Washington Williams（揭露刚果暴行）是同一种人：当法律和命令在错的一边，他们选择站到人的一边，并为此付代价。`,
