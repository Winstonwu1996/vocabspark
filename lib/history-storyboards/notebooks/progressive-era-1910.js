...
**1908 年斯普林菲尔德种族暴动** — 导火索：林肯家乡伊利诺伊州斯普林菲尔德，白人暴徒袭击黑人社区，杀害至少 2 人、烧毁数十栋房屋。发生在"进步"的北方，让全国自由派深感震惊。
...
**Woodrow Wilson 的联邦再隔离（1913）** — 这是常被教材省略的硬事实。Wilson（民主党，南方人）上任不到一个月，内阁就开始推行联邦公务员队伍的种族隔离：邮政总局、财政部等机构分开工作区、洗手间、午餐室，黑人雇员被降职或解雇。内战后好不容易建立起来的联邦政府黑人中产阶层被系统性打击。这发生在同一个"进步时代"。

考点关键句：进步主义改革了很多——但几乎所有联邦层面的改革都建立在默许或强化种族隔离的基础上。NAACP 是那个时代少数正面对抗这一盲区的力量。AP 常考：为什么进步主义者能推动劳工保护、女性投票，却对系统性种族歧视沉默？`,
        en: `Progressive Era textbooks usually focus on TR's trust-busting and Jane Addams's settlement houses — and barely mention what Black Americans experienced during the same years. This "blind spot of progress" is a question that appears frequently on recent APUSH exams.
...
Key exam sentence: Progressivism reformed a great deal — but nearly every federal reform was built on a foundation that tolerated or strengthened racial segregation. The NAACP was one of the few forces in that era that directly confronted this blind spot. AP often asks: how could Progressives push for labor protections and women's suffrage while staying silent on systemic racial discrimination?`,
      ...
      xiaoweiNote: {
        cn: `老师说这张卡就是"进步，到底进步到了谁身上"这个问题的最直接答案。NAACP 1909 成立、Wilson 1913 再隔离——两件事年份别搞混。Du Bois（杜波依斯）是 NAACP 最重要的黑人创始人，他那年已经在写《黑人的灵魂》，主张直接争取完整公民权（和 Booker T. Washington 的"先经济后政治"路线是对立面，这个对比 AP 也爱考）。`,
        en: `My teacher said this card is the most direct answer to the question "progress — exactly whom did it reach?" NAACP founded 1909, Wilson resegregates 1913 — don't mix up the years. Du Bois is the NAACP's most important Black founder; by then he had already written The Souls of Black Folk and argued for demanding full civil rights directly (the opposite of Booker T. Washington's "economic first, politics later" approach — AP loves that contrast too).`,
      },
    },
...
- **William Howard Taft（共和党现任总统）**
  TR 的继任者，被认为背离了进步主义路线——对大企业太软、解雇了 TR 任命的森林局长 Pinchot（保护自然的人）。TR 对他极度失望，才决定参选挑战他。
...
- **William Howard Taft (Republican incumbent)**
  TR's chosen successor, seen as having abandoned the progressive course — too soft on big business and dismissing TR's appointed Forest Service chief Gifford Pinchot (a conservationist). TR's deep disillusionment drove him to challenge Taft.

- **Woodrow Wilson (Democrat)**
  Platform: New Freedom. Called for breaking up big business (not just regulating it), tariff reduction, banking reform, and new antitrust law. Won the election because TR and Taft split the Republican vote.
...
**Result:** Wilson won 40 states with 41.8% of the popular vote (a landslide in the Electoral College). TR finished second (27.4%, 88 electoral votes). Taft third, winning only 2 states — the lowest popular-vote share of any two-party-era Republican nominee ever.

Key exam sentence: the real significance of 1912 = Progressivism had multiple versions; TR's New Nationalism ("regulate big business") versus Wilson's New Freedom ("break up big business") represents two different visions of the government's role — AP loves testing this contrast.`,
      },
      xiaoweiNote: {
        cn: `这场选举 AP 至少有两种考法：一是选择题问"谁是谁的平台"，二是 SAQ/LEQ 让你分析 1912 年大选如何反映进步主义内部分歧。记忆钩子：TR = 管（New Nationalism 管大企业），Wilson = 拆（New Freedom 拆大企业），Taft = 不动（被认为保守了）。公鹿党名字别混——Bull Moose 是公麋鹿，不是公牛。`,
        en: `AP tests this election at least two ways: multiple-choice on who had which platform, and SAQ/LEQ asking how 1912 reflects divisions within Progressivism. Memory hook: TR = regulate (New Nationalism controls big business), Wilson = break up (New Freedom dismantles it), Taft = do little (seen as backing off). And the name: Bull Moose is an adult male moose, not a bull — don't mix that up.`,
      },
    },
