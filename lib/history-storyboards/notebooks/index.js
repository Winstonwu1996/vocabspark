...
import * as haitianRevolutionNb from './haitian-revolution-1791.js';
import * as meijiRestorationNb from './meiji-restoration-1868.js';
import * as russianRevolutionNb from './russian-revolution-1917.js';
import * as contemporaryUsNb from './contemporary-us-1980.js';
...
import * as hanChinaNb from './han-china-130bce.js';
import * as americanRevolutionNb from './american-revolution-1776.js';
import * as thirteenColoniesNb from './thirteen-colonies-1700.js';
import * as westwardExpansionNb from './westward-expansion-1869.js';
import * as globalizationNb from './globalization-1995.js';
import * as nativeAmericansNb from './native-americans-pre1500.js';
// ── 2026-06 World 缺口新课 ──
import * as tradeNetworksNb from './trade-networks-1200.js';
import * as asianImperialismNb from './asian-imperialism-1839.js';
import * as mesopotamiaNb from './mesopotamia-3500bce.js';
import * as indusValleyNb from './indus-valley-2600bce.js';
import * as earlyHumansNb from './early-humans-10000bce.js';
import * as ancientIsraelNb from './ancient-israel-1000bce.js';
// —— 2026-06 World [med] 缺口课 ——
import * as guptaIndiaNb from './gupta-india-320.js';
import * as persianEmpireNb from './persian-empire-550bce.js';
import * as latinAmericanIndependenceNb from './latin-american-independence-1810.js';
import * as interwarTotalitarianismNb from './interwar-totalitarianism-1919.js';
// —— 2026-06 美国史缺口课 ——
import * as vietnamWarNb from './vietnam-war-1965.js';
import * as coldWarHomeFrontNb from './cold-war-home-front-1950.js';
import * as spanishAmericanWarNb from './spanish-american-war-1898.js';
import * as roadToRevolutionNb from './road-to-revolution-1763.js';
import * as colonialAmericaNb from './colonial-america-1650.js';
import * as earlyRepublicNb from './early-republic-1800.js';
...
export var NOTEBOOKS = {
  ...
  'haitian-revolution-1791': haitianRevolutionNb,
  'meiji-restoration-1868': meijiRestorationNb,
  'russian-revolution-1917': russianRevolutionNb,
  'contemporary-us-1980': contemporaryUsNb,
  ...
  'han-china-130bce': hanChinaNb,
  'american-revolution-1776': americanRevolutionNb,
  'thirteen-colonies-1700': thirteenColoniesNb,
  'westward-expansion-1869': westwardExpansionNb,
  'globalization-1995': globalizationNb,
  'native-americans-pre1500': nativeAmericansNb,
  'trade-networks-1200': tradeNetworksNb,
  'asian-imperialism-1839': asianImperialismNb,
  'mesopotamia-3500bce': mesopotamiaNb,
  'indus-valley-2600bce': indusValleyNb,
  'early-humans-10000bce': earlyHumansNb,
  'ancient-israel-1000bce': ancientIsraelNb,
  'gupta-india-320': guptaIndiaNb,
  'persian-empire-550bce': persianEmpireNb,
  'latin-american-independence-1810': latinAmericanIndependenceNb,
  'interwar-totalitarianism-1919': interwarTotalitarianismNb,
  'vietnam-war-1965': vietnamWarNb,
  'cold-war-home-front-1950': coldWarHomeFrontNb,
  'spanish-american-war-1898': spanishAmericanWarNb,
  'road-to-revolution-1763': roadToRevolutionNb,
  'colonial-america-1650': colonialAmericaNb,
  'early-republic-1800': earlyRepublicNb,
};
...
export var buildMasteryFromNotebook = function (topicId) {
  ...
  var concepts = cards.map(function (c) {
    ...
    var defCn = (typeof c.defCn === 'string' && c.defCn)
      || _nbStr(c.standaloneText) || _nbStr(sa.standaloneText) || (c.termCn || "");
    var defEn = (typeof c.defEn === 'string' && c.defEn)
      || _nbStrEn(c.standaloneText) || _nbStrEn(sa.standaloneText) || (c.termEn || "");
    return {
      id: c.id,
