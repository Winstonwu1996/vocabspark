...
//   小薇的笔记里美苏并列、两套叙事框架都呈现、不下"谁对谁错"结论。
...
我先记下来，等下读三个故事——肯尼迪、那个潜艇副长、还有一个代理战争里的农民——
...
things. Your job isn't to pick a side — it's to understand both."`,
    ...
    keyFigures: [
      ...
      },
      {
        ...
        roleCn: '苏联潜艇 B-59 副长，1962 年三军官里唯一拒绝发射核鱼雷的人',
        roleEn: 'Soviet submarine B-59 second-in-command; the one officer of three who refused to fire the nuclear torpedo in 1962',
        mustKnow: true,
        audioKey: 'arkhipov',
      },
      {
  ...
  mainConcepts: [
    // ── 卡 1：起源（雅尔塔 / 铁幕 / 意识形态）— 故事部分覆盖 ──
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['jfk-n2'],
        xiaoweiNote: {
          cn: `这个我在 Lens 1 第 2 节读到过——肯尼迪自己解释"我们为什么走到这一步"。
我把故事没细讲、但考试要补的几块拼上：
...
🔗 故事连接：Lens 1 第 2 节肯尼迪一句话带过杜鲁门主义，
...
is a common misconception — don't write it that way.`,
    ...
    // ── 卡 4：核军备竞赛 / MAD — 故事覆盖 ──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 1 第 6 节讲得最清楚。我把定义和考点拎出来：

**核军备竞赛**：1945 年美国在广岛、长崎扔了原子弹（你跑过二战那个 Topic）；
...
但代价是把暴力**挤压到第三世界**（看 Lens 3 的农民），还让全人类长期活在核阴影下。
"MAD 很疯狂所以没用"是误解——别这么简单地写。

🔗 跨 Topic 锚：原子弹（二战）→ MAD（冷战）是直接续接。`,
...
🔗 Cross-topic anchor: the atomic bomb (WWII) → MAD (Cold War) connect directly.`,
    ...
    // ── 卡 5：代理战争（朝鲜 / 越南）— 部分覆盖 ──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 1 第 8 节讲了代理战争和越南，Lens 3 整条线就是代理战争里的农民。
故事没单独讲**朝鲜战争**，我把它补上：
...
考点关键句：代理战争里，**真正付代价的是第三世界平民**（Lens 3 的农民）——
死的平民远多于两个超级大国自己的士兵。`,
...
(the peasant in Lens 3) — far more civilians died than soldiers of the two superpowers.`,
    ...
    // ── 卡 6：去殖民与冷战交织 / 不结盟运动 — 独立 mini-lesson ──
    {
      ...
      standaloneText: {
        cn: `这块故事只在 Lens 3 第 9 节点了一下"殖民→冷战是同一条线"，
...
**Bandung 1955 (the start), formally founded 1961, three faces: Nehru / Nasser / Tito.**`,
    ...
    // ── 卡 7：冷战结束 1991 — 故事覆盖 ──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 1 第 10 节肯尼迪替我们把故事讲到头，Lens 3 第 10、11 节农民从底层看结局。
考点骨架：
...
- 从白宫/全球看（Lens 1）：1991 没有蘑菇云，人类躲过核毁灭，值得庆幸。
- 从代理战争的村子看（Lens 3）：大国一走，留下的是打烂的国家、埋在地里的地雷、
...
and for the Third World.`,
    ...
    // ── 卡 8：冷战的人命账 / 双框架中立 — 故事覆盖（综合卡）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这张是老师说"AP 一定考"的综合卡——也是这个 Topic 最考验你"会不会中立"的地方。

**冷战不是"好人 vs 坏人"。** 两个大国都自认正义，都做过同样的事：
- 美国：猪湾入侵、暗杀外国领导人计划、支持反共独裁政权、越南升级（Lens 1 第 8、9 节）
- 苏联：1956 年开坦克镇压匈牙利、扶持自己阵营的独裁者、把核鱼雷开到别人家门口
  （Lens 2 第 11 节 Arkhipov 自己承认"我的军队"也是疯狂体制一部分）
Lens 1 第 9 节肯尼迪直接说："两个都自认正义的大国，都在自己阵营里做着同样的事。"

**人命账（Lens 3 第 6、7、8 节）**：
...
button a Soviet submarine officer named Arkhipov did not press.
...
（Lens 3 那个农民的村子，就是为一场他根本不认识的大国争斗被烧掉的。）
...
是同一种"超级大国领袖"的两面（Lens 1 第 11 节肯尼迪自己说"同一双手"）。
