...
//
// 与 storyboard 的关系：
//   - storyboard 提供情感锚点（Roosevelt 扩张推手 / Twain 良心反对者 / 吕宋少年 receiving-end 三条线）
//   - notebook 提供考点闭环（黄色新闻 / Maine / Teller↔Platt / 马尼拉湾 / 巴黎条约 / 菲美战争 /
//     反帝大辩论 / 门户开放 + 夏威夷吞并 / 波多黎各领地身份 / 「漂亮小仗 vs 被遗忘的战争」— 补完 APUSH Period 7）
//
// 课纲对齐：
  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Roosevelt 那一遍第 2 节讲到了。当时纽约有一种便宜的大众报纸，
一两美分一份，靠最耸动的大标题和插画抢读者——这就是 yellow journalism（黄色新闻）。
代表是 Hearst（赫斯特）的《纽约日报》和 Pulitzer（普利策）的《纽约世界报》。

他们天天把古巴的惨状放上头版，把民意点着，整个国家开始喊「救古巴、打西班牙」。
...
它是民意催化剂之一，和 Maine 爆炸、市场野心一起起作用。`,
          en: `Roosevelt's Lens Node 2 covers this. New York then had cheap mass papers,
one or two cents each, fighting for readers with the most shocking headlines and
pictures — that's yellow journalism. The leaders were Hearst's New York Journal and
Pulitzer's New York World.

They put Cuba's horrors on the front page every day, lit public feeling on fire, and
the whole nation began to cry "save Cuba, fight Spain."

Key exam sentence: yellow journalism = the press force that magnified the Cuban crisis
with sensational coverage and pushed America toward war. AP loves "how media shapes
public opinion and foreign-policy decisions" — this is the classic evidence.

Watch one misconception: yellow journalism didn't single-handedly "cause" the war; it
was one catalyst of public feeling, working together with the Maine explosion and
market ambitions.`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Roosevelt 那一遍第 4 节，是我代入他、最难的一个选择点。
...
答题千万别写成"西班牙炸了 Maine"，会被扣分。`,
          en: `Roosevelt's Lens Node 4 is the hardest choice point where I step into him.
On the night of February 15, 1898, the U.S. battleship USS Maine, in Havana harbor in
Cuba, exploded and sank, killing more than 260 American sailors. "Remember the Maine!"
...
✓ At the time no one could determine the cause; a 1976 U.S. Navy study leaned toward an
internal coal-bunker fire igniting the ammunition, not Spain — and scholars reach no
final verdict to this day.

Key exam sentence: the Maine was the trigger and a catalyst of public opinion, NOT a
proven Spanish attack. Never write "Spain blew up the Maine" on the exam — it loses points.`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Roosevelt 那一遍第 8 节把这两份文件放在了一起。
...
直接把这两份文件并排放——AP 评分最奖励这种 complexity。`,
          en: `Roosevelt's Lens Node 8 puts these two documents side by side.
This is AP's classic "self-contradiction" evidence pair, and DBQs love it.

- Teller Amendment (1898, at the war's start): stated plainly that the U.S. had "no
  intention of annexing Cuba" and would let Cuba go free — to block the charge "this is
  just a land grab."
- Platt Amendment (1901, three years later): wrote the opposite — Cuba's domestic and
  foreign affairs were America's to settle, plus a naval base on the island (today's
  Guantánamo).

Key exam sentence: Teller (we don't want Cuba) ↔ Platt (Cuba's affairs are ours to
decide) = the same nation's "split mind," wanting both the image of a liberator and to
never quite let go. This is what historians call the "reluctant empire."

DBQ use: to argue "the tension between America's idea (consent of the governed) and its
practice (controlling Cuba)," lay these two documents side by side — AP scoring rewards
this complexity most.`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `三个视角都讲到了同一声炮——这是这一课的"跨视角锚点"，最值得回味。
1898 年 5 月 1 日，Dewey 的舰队突袭马尼拉湾，几个小时全歼西班牙整支太平洋舰队，
美方在战斗中无一人死亡。（注意"在战斗中"这个限定，是标准教学表述。）

同一声炮，三个人听见的完全不同：
- Roosevelt（第 6 节）：听成他二月那道越权电报"终于响了"，命运的回声。
- Twain（第 6 节）：先听成"解放"，后来才听出是帝国到来的第一声枪。
- 吕宋少年（第 6 节）：先欢呼，看清巴黎条约后才懂是"换了个主人"。

考点关键句：马尼拉湾是美西战争第一场大胜，第一枪却打在菲律宾——
说明这场"古巴战争"从一开始就连着更大的太平洋/中国市场野心。

AP 爱考"为什么一场为古巴的战争，第一仗在菲律宾打"——答案就是太平洋跳板。`,
          en: `All three lenses hit the same gunfire — this is the topic's "cross-lens
anchor," the most worth replaying. On May 1, 1898, Dewey's fleet surprised Manila Bay
and, in a few hours, destroyed Spain's entire Pacific fleet, with not one American
killed in the fighting. (Note the qualifier "in the fighting" — that's the standard
teaching phrasing.)

The same boom, heard utterly differently by three people:
- Roosevelt (Node 6): heard his February telegram "finally going off," an echo of destiny.
- Twain (Node 6): first heard "liberation," later heard the first gunshot of empire.
- The Luzon youth (Node 6): cheered first, then understood — after the Treaty of Paris —
  it meant "a change of masters."

Key exam sentence: Manila Bay was the war's first great victory, yet the first shot fell
in the Philippines — showing this "Cuba war" was tied from the start to a larger
Pacific/China-market ambition.

AP loves "why did a war for Cuba open its first battle in the Philippines" — the answer
is the Pacific stepping-stone.`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `三个视角都讲到这份条约，但吕宋少年那一遍第 5 节最戳人。
1898 年 12 月 10 日，巴黎条约签字。我把它的四件事背成一串：
西班牙①放弃古巴，②割波多黎各、③割关岛给美国，④以 2000 万美元把菲律宾"卖"给美国。

考点关键句：巴黎条约是美国一夜之间获得海外属地（横跨加勒比和太平洋）的法律节点。

最戳人的一个细节（Twain 第 7 节）：1899 年 2 月，美国参议院批准这份条约，
仅以超过三分之二门槛一票的微弱优势通过——美国要不要做帝国，悬在了一票上。

吕宋少年的角度（第 5 节）逼我想一个问题：整笔交易里，
没有一个菲律宾人被问过"愿不愿意"——一个民族能不能被"买卖"？
这正好接上反帝派那句"被治者同意"。`,
          en: `All three lenses reach this treaty, but the Luzon youth's Node 5 hits hardest.
On December 10, 1898, the Treaty of Paris was signed. I memorize its four pieces in a
chain: Spain ① gave up Cuba, ② ceded Puerto Rico, ③ ceded Guam to the U.S., and ④ "sold"
the Philippines to the U.S. for twenty million dollars.
...
The most striking detail (Twain's Node 7): in February 1899, the U.S. Senate ratified
this treaty by just one vote above the two-thirds threshold — whether America would
become an empire hung on a single vote.

The Luzon youth's angle (Node 5) forces a question: in the whole bargain, not one
Filipino was ever asked "are you willing" — can a whole people be "bought and sold"?
That connects right back to the anti-imperialists' line "consent of the governed."`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Twain 那一遍第 3、5 节整条线就是这个——这是 APUSH 第七单元的"心脏考点"。
老师说阅卷反复奖励的不是结论，而是"1898 年的美国人自己怎么吵这件事"。

我背成一张对照表：
- 扩张派（expansionists）：海军战略家、报业大亨、要中国市场的工厂主、传教士。
  理由 = 命运 destiny + 海军安全 + 市场（中国）+ 文明使命 missionary。
- 反帝派（anti-imperialists）：Twain、Carnegie、Bryan，1898 年成立反帝同盟。
  理由 = 统治不肯被统治的人，背叛了「被治者同意」的立国原则。

老师说一个最高级的层次（AP 最爱）：反帝派内部动机也不一致——
有人像 Twain 是出于原则；也有人是出于种族偏见，不想要"非白人"当美国国民。
能写出"同一阵营内部分裂"，就是 AP 评分里的 complexity。

记忆锚：扩张 = 命运/海军/市场/传教；反帝 = 被治者同意/背叛 1776/（内部又分原则 vs 种族）。`,
          en: `Twain's Lens Nodes 3 and 5 are the whole spine of this — the "heart" exam point
of APUSH Period 7. Teacher said graders keep rewarding not a conclusion, but "how
Americans in 1898 argued about it themselves."

I memorize it as a compare table:
- Expansionists: naval strategists, press tycoons, factory owners wanting the China
  market, missionaries. Reasons = destiny + naval security + markets (China) + civilizing
  mission.
- Anti-imperialists: Twain, Carnegie, Bryan, who founded the Anti-Imperialist League in
  1898. Reason = ruling people who refuse to be ruled betrays the founding principle of
  "consent of the governed."

Teacher named the highest layer (AP's favorite): the anti-imperialists' own motives were
not unified — some, like Twain, acted from principle; others were racist and simply did
not want "non-white" people becoming American citizens. Writing "a split within one camp"
is the complexity AP scoring wants.

Memory anchor: expansion = destiny/navy/markets/missions; anti-imperialism = consent of
the governed / betrayal of 1776 / (internally split between principle vs. race).`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `吕宋少年那一遍第 7 节、Roosevelt 第 9 节都讲到了。
...
把两者合起来看，1898 一点都不"小"。这就是"被记住的 vs 被遗忘的"那道 DBQ。`,
          en: `The Luzon youth's Node 7 and Roosevelt's Node 9 both cover this. Filipinos
refused to be "bought and sold." In February 1899, U.S. and Filipino forces opened fire,
the Philippine-American War broke out, and it ran to 1902; Aguinaldo was captured in 1901.
This war was far bloodier than the "little war" with Spain.

Casualties (teacher demands the precise phrasing): over 4,200 U.S. troops and about
20,000 Filipino fighters died, and at least 200,000 Filipino civilians died — most from
the famine and disease the war brought (including a cholera epidemic near the end).

Red-flag reminder (the highest-risk number): always write "at least 200,000," keeping the
words "at least." Scholarly estimates run wide, some as high as 250,000 to over a million
— 200,000 is only the conservative floor; never write it as a fixed number.

Key exam sentence: the "splendid little war" with Spain lasted about ten weeks, but the
Philippine-American War that followed ran three years with far heavier death. Taken
together, 1898 was not "little" at all. This is the "remembered vs. forgotten" DBQ.`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Twain 第 9 节、吕宋少年第 8 节都把这一条拉到了中国——这就是这一课的"中国桥"，
对很多华裔同学最近。
...
老师强调一个误解（高频）：❌「门户开放是美国保护中国」→
✅ 它从没问过中国，中国是"被开放"的那扇门；客观上它确实收敛了赤裸瓜分，但动机是商业利益。

我自己的关联（最有感）：菲律宾"被解放成属地"，中国"被开放成市场"——
同一双帝国的手。而几乎同时，美国还用排华法案（1882）把中国人挡在国门外：
要中国的市场，却不要中国的人。`,
          en: `Twain's Node 9 and the Luzon youth's Node 8 both pull this thread to China —
this is the topic's "China bridge," closest to many Chinese-heritage students.

Background: in 1898 (the 24th year of the Guangxu reign), after the Qing's defeat by
Japan, the powers "carved up China" — Germany forced a lease on Jiaozhou Bay, Russia
leased Port Arthur and Dalian, Britain leased Weihaiwei, France leased Guangzhouwan.
America arrived too late and could grab no land, so Secretary of State John Hay proposed
the "Open Door": instead of a "sphere of influence," demand that all nations let everyone
trade throughout all of China.

Key exam sentence: the Open Door = a latecomer's cleverness — don't grab land, keep "the
whole door open," at its core to preserve America's chance at the entire China market.

Teacher stressed a misconception (high frequency): ✗ "the Open Door protected China" →
✓ it never asked China; China was the door being "opened." It did objectively restrain
naked carving-up, but its motive was commercial interest.
...
time, America used the Chinese Exclusion Act (1882) to bar Chinese people from its gates:
it wanted China's market, but not China's people.`,
        },
      },
    },
...
**时间线（AP 爱考的两步）：**
1. **1893 年**：在美国军舰和陆战队撑腰下，一批美裔商人推翻了夏威夷女王
   **Liliʻuokalani（利留卡拉尼）**，建立亲美的临时政府。
2. **1898 年 7 月 7 日**：美国趁美西战争凸显"太平洋加煤站"的价值，用一纸
...
1. **1893**: backed by U.S. warships and marines, American businessmen overthrew Queen
   **Liliʻuokalani** and set up a pro-American provisional government.
2. **July 7, 1898**: with the war highlighting the value of a Pacific coaling station,
...
Key exam sentence: Hawaii did not "peacefully and willingly join" — it was overthrown in
1893 and annexed in 1898 by bypassing the treaty threshold, against the wishes of most
...
Memory anchor: **1893 overthrow the queen → 1898 annex by joint resolution (bypassing
2/3) → most Natives opposed.** This chain earns direct AP points on "how America acquired
overseas territory."

Don't mix up: Hawaii was "annexed" (made U.S. territory); the Philippines was "bought and
suppressed" (Treaty of Paris $20M + the Philippine-American War) — two different modes of
acquisition.`,
      },
    },
...
elections** and have no voting representative in Congress. "U.S. citizens who cannot vote
for president" is the most vivid institutional paradox 1898's expansion left behind.
...
Key exam sentence: Puerto Rico = a living specimen of 1898's "promise not yet kept" — a
nation founded on "consent of the governed" still rules citizens who cannot vote for
president. This lines up exactly with the anti-imperialists' old challenge: what is it to
rule people who never fully consented?`,
      },
      xiaoweiNote: {
...
exactly where that principle still isn't fully honored today.`,
...

    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'roosevelt-actor', nodeId: 'saw-roosevelt-n10', context: 'Roosevelt synthesis 末尾点出历史学家至今在吵 1898 是意外还是必然' },
...
"历史学家怎么吵 / 谁的故事被记住"这一层。故事里 Roosevelt 第 10 节、
吕宋少年开场都点到了，但没展开，单独掌握更稳。
...
**历史学家在争什么（不必记学者名，记立场）：**
1. **"不情愿的帝国"派**：1898 是被黄色新闻、Maine 爆炸、一时民意"卷"进去的意外。
2. **"市场扩张"派**：1898 不是意外，而是工业过剩、系统性找海外市场的必然（门户开放是纲领）。
3. **"文化/种族"派**：种族主义和"文明使命"观念同时驱动了扩张派和某些反帝派。
4. **菲律宾/后殖民视角**：主张这是一场被主流叙事淡化的殖民战争，不是"小插曲"。
...
remembered." Roosevelt's Node 10 and the Luzon youth's opening both touch it, but without
unpacking, so master it separately.
...
- The Philippine-American War that followed ran three years with at least 200,000 Filipino
  civilian deaths, often dismissed in a single line — the downplayed, nearly "forgotten
  war."

**What historians argue (no need to memorize names, just positions):**
1. **"Reluctant empire"**: 1898 was an accident, a country swept in by yellow journalism,
   the Maine, and a momentary public mood.
2. **"Market expansion"**: 1898 wasn't an accident but the inevitable result of industrial
   overflow systematically hunting overseas markets (the Open Door is its program).
3. **"Cultural/racial"**: racism and the "civilizing mission" drove both expansionists and
   some anti-imperialists.
4. **Filipino/postcolonial**: argues this was a colonial war downplayed by the mainstream
...
counter-evidence to show memory is selective — then pick one interpretation and give evidence.

Don't memorize this as an "event" with dates; it tests whether you can explain one history
