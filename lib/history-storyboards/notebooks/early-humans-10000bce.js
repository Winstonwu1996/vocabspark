...
她在白板上写了一串词：
新石器革命（Neolithic Revolution）、驯化（domestication）、
狩猎采集者（hunter-gatherer）、肥沃新月地带（Fertile Crescent）、
哥贝克力石阵（Göbekli Tepe）、剩余粮食（surplus）、
多中心起源（multiple origins）。
...
see both its greatness for all of humankind and its cost on the individual, at the same time."
    ...
    keyFigures: [
      {
        ...
        roleEn: 'The last generation of hunters before farming arrived, who thinks settling and farming is "self-inflicted suffering"',
        mustKnow: false,
        audioKey: null,
      },
      {
      ...
      {
        nameCn: '第一代村庄的农家少女（合成桥接人物，无名字）',
        nameEn: 'The First-Generation Farm Girl (composite, no name)',
        ipa: null,
  ...
  mainConcepts: [
    {
      ...
      defCn: '人类从「狩猎采集」转向「农业定居」的那次大转变，约一万年前开始，横跨数千年慢慢发生——不是一夜之间的发明。',
      defEn: 'The great shift from hunting and gathering to farming and settling down, beginning around ten thousand years ago — a slow change over thousands of years, not an overnight invention.',
...
老师反复纠正两个误解：
①「这是一夜之间的发明」→ 正：它横跨**数千年**、反复试错的慢渐变；
  「革命」是相对人类几百万年而言的「快」，不是字面的一夜。
②「农业一来人就过得更好了」→ 正：它**养活了更多人**，但每个人未必更健康。
...
① "It was an overnight invention" → Right: it was a slow change across **thousands of
  years** of trial and error; "revolution" means "fast" relative to humanity's millions of
  years, not literally overnight.
② "Once farming came, people lived better" → Right: it **fed more people**, but each
...
the **species**, but often a step backward for the **individual** of that time."`,
...

    {
      ...
      defCn: '农业出现前人类的活法：跟着季节和兽群游动，以几十人的小队为单位，吃大地给的食物，没有固定的家。',
      defEn: 'The way humans lived before farming: roaming with the seasons in bands of a few dozen people, eating whatever the land offered, with no fixed home.',
      ...
      xiaoweiNote: {
        cn: `老猎人那条故事线前两节就是这个。我本来以为「原始人 = 又穷又苦、整天为吃饭发愁」，
...
对照锚：和农民比，猎人是「自由+健康+平等」，农民是「人多+粮多+不平等」。`,
        en: `The old hunter's story shows this right at the start. I used to think "primitive people =
...
farmers = more people + more grain + inequality.`,
...

    {
      ...
      defCn: '智人（Homo sapiens）= 现代人，约 30 万年前在非洲出现；约 6-7 万年前走出非洲、扩散到全世界，全程都是狩猎采集者。',
      defEn: 'Homo sapiens (modern humans) appeared in Africa about 300,000 years ago; around 60,000-70,000 years ago they left Africa and spread across the world — as hunter-gatherers the entire time.',
      ...
      standaloneText: {
        cn: `这张卡是 CA HSS 6.1 的开头硬点，必须单独掌握。

**两个核心事实：**
①**智人（Homo sapiens / 现代人）约 30 万年前起源于非洲**——
  最早化石之一来自摩洛哥的 Jebel Irhoud。注意：人类的故事起点在**非洲**，不是别处。
②**走出非洲（Out of Africa）约 6-7 万年前**——
...
注意时间尺子：这一段用「**年前（years ago）**」，到了农业段才切换成「**公元前（BCE）**」。`,
        en: `This card covers a hard opening point of CA HSS 6.1 — master it on its own.

**Two core facts:**
① **Homo sapiens (modern humans) originated in Africa about 300,000 years ago** — one of the
  earliest fossils is from Jebel Irhoud, Morocco. Note: humanity's story begins in
  **Africa**, nowhere else.
② **Out of Africa, about 60,000-70,000 years ago** — a group of Homo sapiens left Africa
...
**appeared in Africa 300,000 years ago → left Africa 60-70,000 years ago.** Misconception:
"humans' homeland isn't Africa" is always wrong. My mnemonic: first **roam the globe as
hunters**, **then** independently learn farming in several places — don't reverse the order.`,
      },
    },

    {
      ...
      defCn: '西亚一片弯成月牙形的土地，是世界上最早开始种地养牲口的地区之一（约公元前 10000-8000 年），因为这里天生就有可驯化的野生小麦、大麦和牲畜。',
      defEn: 'A crescent-shaped strip of land in western Asia, one of the first places on Earth where people started farming (around 10000-8000 BCE), because it naturally had wild wheat, barley, and animals that could be domesticated.',
      standardRef: ['CA HSS 6.1', 'AP World CED Unit 1 (前置)'],
      examFrequency: 'high',
      storyAnchor: {
        covered: true,
...
origins" card). Memory anchor: Crescent = moon shape; the shape is the name.`,
...

    {
      ...
      defCn: '把野生动植物一代一代改造成作物或家畜的过程。人年复一年只留最好的种子、最听话的动物，几百年慢慢把野草变成庄稼、把野兽变成家畜。',
      defEn: 'The process of reshaping wild plants and animals into crops and livestock, generation by generation. People kept only the best seeds and most manageable animals year after year, slowly turning wild grasses into crops and wild animals into livestock over centuries.',
      ...
      xiaoweiNote: {
        cn: `老猎人那条故事线里，他孙辈撒野麦、年年只留「最听话」的种子——讲的就是这个，
...
老师反复敲的高阶点（AP 因果题王牌）：**到底是谁驯化了谁？**
我们改造了小麦，可小麦也把我们从游动的猎人，**改造成了离不开它的农民**——
这叫「**互相驯化**」。故事里老猎人那句点睛我抄下来了：
「他以为是他在改造麦，可我看，是麦也在把他一点点拴在这块地上。」`,
        en: `In the old hunter's story, his grandchild scatters wild wheat and keeps only the most
"obedient" seeds year after year — that's this concept, and it names them: **einkorn and
emmer**, the two earliest wheats domesticated in western Asia.
...
The high-level point teacher hammered (an AP causation ace): **who domesticated whom?**
We reshaped wheat, but wheat also reshaped us from roaming hunters into **farmers who can't
leave it** — this is "**mutual domestication.**" I copied the hunter's clinching line: "He
thinks he is reshaping the wheat; but the way I see it, the wheat is also tying him, bit by
bit, to this land."`,
      },
    },

    {
      ...
      defCn: '哥贝克力石阵（Göbekli Tepe）是约公元前 9500 年建在今土耳其东南的一组巨型石阵，由还没种地的狩猎采集者建成，比农业早了至少一千年。它提出了一个有争议的可能：是人们想聚集在一起办仪式的需求，推动了就近多种粮——也就是「信仰/聚集可能先于、并推动了农业」。',
      defEn: 'Göbekli Tepe is a set of giant stone rings built around 9500 BCE in what is now southeastern Turkey, by hunter-gatherers who did not yet farm — predating broad farming by at least a thousand years. It raises a contested possibility: the desire to gather for ceremonies may have pushed people to grow more grain nearby, meaning "faith/gathering may have come before, and driven, farming."',
      ...
      xiaoweiNote: {
        cn: `工匠那条故事线整条就是讲它的。**Göbekli Tepe（哥贝克力石阵）**：约公元前 9500 年，
...
高分写法：用同一批没字的石头，论证**两个相反方向**的因果——这就是 AP 要的高阶思维。`,
        en: `The stone-carver's whole story line is about this. **Göbekli Tepe**: around 9500 BCE, in
today's southeastern Turkey, built by hunter-gatherers who **did not yet farm in earnest** —
T-shaped pillars weighing several tons, carved with foxes/boar/snakes/vultures, raised in
rings. It predates broad farming by at least a thousand years.
...
- Old script: farming → surplus → leisure → only then the strength to build temples and pursue
  faith (belly first).
- The possibility Göbekli raises: to **gather for great ceremonies** and feed the crowds,
  people were driven to **grow more grain close by** → farming. That is, "**faith/gathering
  may have come before, and driven, farming.**"
...
view holds**," and **never** write "science has proven religion came before farming." Even
"the rings were deliberately buried" is only an early guess — recent excavations lean toward
natural accumulation, so don't state it as fact either. High-scoring move: use the same
wordless stones to argue **two opposite directions** of causation — that's the higher-order
thinking AP wants.`,
      },
    },

    {
      ...
      defCn: '定居（sedentism）= 不再到处游动、固定住在一个地方。农业让人第一次能在同一块地上住下来——耶利哥（Jericho）和恰塔霍裕克（Çatalhöyük）是目前已知最早的大型定居点之一。',
      defEn: 'Sedentism = no longer roaming, staying fixed in one place. Farming let people settle down for the first time. Jericho and Çatalhöyük are among the earliest known large settlements.',
      standardRef: ['CA HSS 6.1', 'AP World CED Unit 1 (前置)'],
      examFrequency: 'high',
      storyAnchor: {
        covered: true,
      ...
      xiaoweiNote: {
        cn: `农家少女那条故事线里专门讲她住的地方。两个必背的真实遗址：
...
因为它还没有后来「城市」该有的公共/行政建筑和中央权力。AP/老师都爱抠这个词。`,
        en: `The farm girl's story covers where she lives in detail. Two must-memorize real sites:
...
central power a later "city" has. AP and teachers love nitpicking this word.`,
...

    {
      ...
      defCn: '剩余粮食（surplus）= 农业产出第一次超过当下要吃的，多出来的粮能存起来。有了存粮，不是每个人都要下地，有人可以专门做陶器、当祭司、管仓库——这叫分工，从这里长出了城市、文字、国王等文明的所有零件。',
      defEn: 'Surplus = farm output exceeds what people need right now, so extra grain can be stored. With stored grain, not everyone has to farm — people can specialize in pottery, priesthood, or keeping the storehouse. This division of labor is where cities, writing, and kings all come from.',
      standardRef: ['CA HSS 6.1', 'AP World CED Unit 1 (前置)', 'AP DBQ — causation'],
      examFrequency: 'highest',
      storyAnchor: {
        covered: false,
...
故事里反复出现（老猎人看见粮进罐子、少女把粮交给管粮仓的人），但没把整条链讲全，
所以单独拉一张卡，必须能**一口气说顺**。
...
一环一环拆：
①**剩余（surplus）**：农业产出第一次能超过当下要吃的，多出来的粮能**存**起来。
②**分工（division of labor）**：有了存粮，就不必人人种地——
  有人可以专做陶器、盖房、当祭司、当兵、**管仓库**。
③**文明零件**：从「剩余粮食」这**一个**源头，长出了**城市、文字、国王、军队、税收**。
...
hunter sees grain go into jars, the girl hands grain to the granary-keeper) but don't lay
out the full chain, so here's its own card — you must be able to **say it in one breath.**
...
Link by link:
① **Surplus**: for the first time, farm output exceeds what's needed right now, and the extra
  grain can be **stored**.
② **Division of labor**: with stored grain, not everyone must farm — some can specialize in
  pottery, building, priesthood, soldiering, **keeping the storehouse**.
③ **Parts of civilization**: from that **single** source, surplus, grow **cities, writing,
...
surplus to exist first**. Without this link, none of the later "why are there kings and
temples" can be explained.
...
it **in order** — skip a link and you lose points. My mnemonic: **"Surplus feeds the idle,
the idle build civilization."** (surplus → people who don't farm → cities, writing, kings)
The most common phrasing: "Why is farming the precondition for civilization?" — always start
the answer from surplus, the master switch.`,
      },
    },

    {
      ...
      defCn: '社会分层（social stratification）= 人和人之间出现固定的高低之分。农业带来剩余粮食之后，谁管粮仓谁有权——这是最早的不平等，比国王和城市还要早，在最早的农业村子里就已经出现。',
      defEn: 'Social stratification = a fixed gap appearing between people. Once farming created surplus grain, whoever controlled the granary gained power — this earliest inequality appeared in the very first farming villages, before kings or cities existed.',
      ...
      xiaoweiNote: {
        cn: `农家少女那条故事线第 5 节和老猎人故事线第 7 节都讲到它。这是「进步的账单」里最关键的一笔。
...
就是 AP 要的「复杂性（complexity）」——即同一件事同时有好处和代价两面。`,
        en: `The farm girl's story section 5 and the hunter's story section 7 both cover this. It's
the most crucial entry in "the bill for progress."

Chain: **storable grain → whoever keeps the granary gains power → for the first time people
split into "those whose word others must obey" and "those who can only obey."** The girl says
a part of the grain she grinds all day must go to the granary-keeper, who "doesn't go to the
fields yet eats fuller and grows taller than anyone."

The hardest evidence (AP loves it): **bones**. In the village skeletons later dug up, "the
high" clearly **ate better and grew taller**, "the low" were shorter — **inequality can be
told right from the bone.**

Misconception teacher corrected: "inequality and class were created later by kings" → wrong!
**The root of inequality was laid in the earliest farming towns**, appearing **almost at the
same time** as settling and stored grain.

DBQ balance point (I noted it on purpose): the granary-keeper **also has a line that stands**
— in the story he says "it's precisely because someone keeps the grain that no one starves in
a lean year." So inequality isn't purely bad; it's tied to "centralized management and
disaster resistance." Seeing both **the side that pays (the girl) and the side that benefits
(the keeper)** is what AP calls "complexity" — one event having both a cost and a benefit at
the same time.`,
      },
    },

    {
      ...
      defCn: '考古挖出的人骨显示，最早那批定居农民比狩猎采集的祖辈更矮、牙更坏、传染病更多。农业养活了更多人，但它同时也让最初的农民付出了健康代价——这两件事都是真的。',
      defEn: 'Excavated bones show the first settled farmers were shorter, had worse teeth, and suffered more disease than their hunter-gatherer ancestors. Farming fed more people but also made the first farmers pay a health cost — both things are true at the same time.',
      ...
      xiaoweiNote: {
        cn: `农家少女那条故事线第 3 节把账单「一笔一笔」摊开了——这是这门课最反直觉、最 AP-friendly 的一节。
全部证据来自**真实挖出来的人骨**（少女说「骨头不会说谎」）。

**三笔账（背成三个字：矮、牙、病）：**
①**矮**：定居农民比狩猎采集祖辈**矮**。一项希腊/土耳其骨骼研究估计，
  男性平均身高约从 **1.78 米降到 1.68 米**（注意：这是**某些遗址样本**的估计，幅度各地不同；
  但「农民更矮」这个**方向**是古病理学广泛共识）。
②**牙**：天天吃麦糊，淀粉黏牙 → 牙比祖辈坏得多。
③**病**：几百上千人挤一村、和牲口同住、共用水源 → **传染病第一次有了温床**
  （祖辈几十人一直在走的小队根本囤不住病菌）。

代表学者：**Jared Diamond**（1987）直接把农业叫「**人类历史上最严重的错误**」。
（提醒：这是**学者的论点/立场**，不是已证实的事实——AP 答题可以引用，但要标明这是 Diamond 的论点。）

考点关键句（AP 因果题王牌）：「**养活更多人**」和「**让每个人更健康**」是**两件不同的事**——
农业做到了前者，却在很长时间里牺牲了后者。这就是 AP 要的「同一件事，两个相反的真相」。`,
        en: `The farm girl's story section 3 lays out the bill "entry by entry" — the most
counter-intuitive, most AP-friendly section in the topic. All evidence comes from **real
excavated bones** (the girl says "bone does not lie").

**Three entries (memorize as: short, teeth, disease):**
① **Short**: settled farmers were **shorter** than their hunter-gatherer ancestors. One
...
② **Teeth**: eating wheat gruel daily, starch sticking to teeth → far worse teeth than
  ancestors.
③ **Disease**: hundreds-to-thousands packed into one village, living with livestock, sharing
...
Representative scholar: **Jared Diamond** (1987) flatly called farming "the **worst mistake
in the history of the human race**." (Reminder: this is a **scholar's argument/stance**, not
confirmed fact — you may cite it on AP, but mark it as Diamond's argument.)

Key exam sentence (an AP causation ace): "**feeding more people**" and "**making each person
healthier**" are **two different things** — farming achieved the former while sacrificing the
latter for a long time. That's the "same thing, two opposite truths" AP wants.`,
      },
    },

    {
      ...
      defCn: '农业不是从一个地方发明然后传遍世界的，而是在地球好几个角落各自独立被发明出来（multiple origins，多中心起源）。中国境内就有两个独立中心：黄河流域（粟/小米）和长江流域（稻），和西亚时间相近、互不相通、各自成功。',
      defEn: 'Farming was not invented in one place and then spread everywhere — it was invented independently in several corners of the world (multiple origins). China alone had two independent centers: the Yellow River valley (millet) and the Yangtze valley (rice), each succeeding on its own at roughly the same time as western Asia, without any contact between them.',
...
几个互不相通的文明给出同一个答案，说明农业是「特定条件下的必然」还是「巧合」？这是绝佳比较题。`,
...
**"China alone has two independent centers"** (Yellow River millet + Yangtze rice) — make
this stand out. They were **close in time, not in contact, and each succeeded** with western
Asia — **no one copied anyone.**

The **two-way neutrality** teacher stressed:
...
- **The truth is "multiple centers, each independent, close in time" — not a contest over
  who's first.** I copied the story's line: "This does not mean China was earliest or
  greatest, nor that western Asia was — it means people in several corners, facing much the
  same circumstances, each thought up the same idea."
...
make farming "inevitable under certain conditions" or "coincidence"? An excellent compare prompt.`,
...

    {
      ...
      defCn: '一旦一个村子靠农业养起了几百上千人，就再也无法回到狩猎采集——那点野地养不了那么多人，那么多人也散不回小队了。人类被自己的"成功"（更多的人、更多的粮）锁在了农业这条路上，回不了头。',
      defEn: 'Once a village used farming to feed hundreds or thousands of people, there was no going back to hunting and gathering — the wild land couldn\'t feed so many mouths, and so many people could never re-scatter into small bands. Humans were locked onto the farming road by their own "success," with no way to reverse.',
      ...
      xiaoweiNote: {
        cn: `老猎人故事线第 8 节和农家少女故事线第 8 节是同一件事的两面，讲「**回不去了（the trap）**」。
...
也是一旦上了就回不了头的陷阱。这正是 continuity & change 里「**不可逆的 change**」最好的例子。`,
        en: `The hunter's story section 8 and the farm girl's story section 8 are two faces of one
thing: "**you can't go back (the trap)**."

The logic (a circle drawing ever tighter):
**more grain → more people → less able to leave the land → must grow even more grain** — back
to the start, tighter each loop.
...
Teacher said this is the standard answer to "why didn't farmers give up farming and go back
to hunting" — **not that they didn't want to, but that they couldn't** (population lock-in).

Key exam sentence: farming is a "**staircase you can never step down from**" — it's both the
staircase to civilization and a trap you can't reverse once on it. This is the best example
of an "**irreversible change**" in continuity & change.`,
      },
    },
  ],
...
① 「最严重错误」这边（Jared Diamond 1987 年的论点）的证据：骨头显示更矮、牙更坏、传染病、第一次不平等。
② 「伟大进步」这边的证据：剩余粮食 → 分工 → 城市/文字/国王（文明的全部地基都从这里长出来）；养活的人多了千百倍。
高分写法：先承认**对物种是成功、对当时个人常是退步**两边都站得住，再说你为什么更倾向某一边——
这种「同时持有两个相反真相」就是 AP 要的「复杂性（complexity）」。`,
      hintEn: `Hint: no standard answer — AP scoring looks at your ability to **use evidence**, not
which side you pick.
① Evidence for "worst mistake" (Jared Diamond's 1987 argument): bones show shorter height,
  worse teeth, disease, the first inequality.
② Evidence for "great progress": surplus → division of labor → cities/writing/kings (the
  whole foundation of civilization grows from here); hundreds of times more people fed.
High-scoring move: first acknowledge that both stand — **a success for the species, often a
step back for the individual of that time** — then explain why you lean one way. Holding two
opposite truths at once is the "complexity" AP wants.`,
...
leisure to build temples and pursue faith." Yet Göbekli Tepe was built by hunter-gatherers
who **did not yet farm in earnest** — they first moved stones weighing tons for great
ceremonies, and only then were driven to grow more grain nearby to "feed the gathering."

If you were a history teacher writing a question on "which came first, the belly or faith,"
how would you phrase it? Write your question and explain what it's meant to make students see.`,
      hintCn: `提示：好的历史题逼学生**用同一批证据论证两个相反方向**，而不是二选一。
...
（这正是 AP 因果题的高阶训练：因果方向本身可以被质疑。）`,
      hintEn: `Hint: a good history question forces students to **argue two opposite directions from the
same evidence**, not pick one. Key discipline: Göbekli's "faith before farming" is **only a
contested hypothesis, not settled fact** — your question should make students realize "there
are no words on the stones; both directions are arguable; the evidence isn't enough to
decide." Have students compare: old causation (farming → surplus → temple) vs the new
possibility (wanting to gather for ceremony → driven to grow more grain → farming) — then
ask: when evidence is insufficient and both stories hold, how should an honest historian write
the conclusion? (This is higher-order AP causation training: the direction of cause and effect
...
millet by the Yellow River), and Mesoamerica (maize) — no one told anyone, no one copied
anyone; within China alone there were two independent farming centers.
...
真相是**平等的多中心**。能保持这个双向中性，本身就是高分点。`,
      hintEn: `Hint: first lock in the fact of "multiple origins" — it's the topic's core correction.
① For "inevitable": several unconnected places, at roughly the same time, under similar
  conditions (ice age ending, climate warming and stabilizing), each hit on the same idea —
  this looks like "it happens once conditions are met."
...
Advanced discipline (teacher circled it): whichever side you pick, **do not** write "China
was earliest/greatest" or "western Asia was earliest/greatest" — the truth is **equal
multiple centers**. Holding that two-way neutrality is itself a high-scoring move.`,
