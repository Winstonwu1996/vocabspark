...
chain: religious revival, then perfectibility, then a swarm of reform movements.`,
...

    {
      ...
      standaloneText: {
        cn: `这张卡故事里没展开，但它是 APUSH Period 4 的骨架——没有它，改革运动看起来像凭空冒出来的。

**市场革命（Market Revolution）**：1800-1850 年三组驱动力：
1. **交通革命**：伊利运河（1825）、蒸汽船、铁路，货物与信息第一次快速流通全国。
2. **工厂体系**：洛厄尔（Lowell）纺织厂为代表，第一批工资工人（含 Lowell Girls）出现。
3. **货币经济渗透**：家庭从自足转向市场依赖。

**与改革运动的关系**：
- 印刷 + 全国流通 → 《The Liberator》、North Star、《情感宣言》才能变成全国运动。
- **「分离的领域」（Separate Spheres）**：男性主外/女性主内的意识形态，
  把「女性 = 道德/纯洁」对立「市场 = 竞争/腐化」。
  Stanton/Garrison 借「女人天生更道德」为女性参与改革正名——
  这套逻辑既限制女性，又给了她们走出家门的入场券。

考点关键句：市场革命 = 改革运动的物质基础 + 「分离的领域」意识形态的来源。`,
        en: `This card isn't unpacked in the story, but it is the skeleton of APUSH Period 4.
Without it, the reform movements look like they appeared from nowhere.

The **Market Revolution** refers to the fundamental shift of the American economy between
1800 and 1850 from subsistence farming to commercial markets, driven by three sets of change:

1. **Transportation revolution**: canals (the Erie Canal opened 1825, linking the Great Lakes
   to New York City), steamboats, and railroads — for the first time goods, people, and
   information moved quickly across the nation.
2. **Rise of the factory system**: exemplified by the textile mills of Lowell, Massachusetts,
   the first generation of wage workers who "left home to work at a factory" appeared, many
   of them young farm daughters (the Lowell Girls).
3. **Penetration of the money economy**: subsistence farmers began producing for the market
   and buying goods with wages; household economics shifted from self-sufficiency to market
   dependence.

**Its connection to the reform movements** (the AP's favorite causal chain):

- **Urbanization and the press**: newspapers, pamphlets, and declarations (including The
  Liberator, the North Star, and the Declaration of Sentiments) could be printed quickly and
  circulated nationally; reform movements gained a "national audience" only because of this.
- **Separate Spheres**: the Market Revolution pushed men out of the home into factories and
  markets, and kept women inside. This ideology set "home/women = morality/purity" against
  "market/men = competition/corruption." Reformers, including Stanton and Garrison, used
  this very logic — "women are naturally more moral" — to justify women's participation in
  abolition, temperance, and women's rights.
- **Growing economic inequality**: the Market Revolution created a working class and sharpened
  the question of who could benefit — the shared underlying tension behind every movement of
  the reform age.

Key exam sentence: Market Revolution = transportation revolution + factory system + money
economy, three in one; it is the **material foundation** of the reform movements (making
printing, circulation, and assembly possible), and the source of the "Separate Spheres"
ideology — an ideology that both confined women and gave them the entry ticket to step into
public life "in the name of morality."`,
      },
      xiaoweiNote: {
        cn: `老师说市场革命是 AP 最爱「藏在背景里考」的考点——它不是主角，
但你不知道它，就解释不了为什么改革运动在这几十年里突然爆发。
...
男主外、女主内这套话语，既是对女性的限制，也是女性参与改革的借口
（「我们比男人更道德，所以我们该管这些」）。`,
        en: `Teacher said the Market Revolution is the AP's favorite "hidden in the background"
test point. It is not the main character, but without knowing it you cannot explain why the
reform movements suddenly exploded in these decades.
...
- Women stepping out = the material conditions for female participation in temperance,
  abolition, and women's rights

One more concept to memorize: **Separate Spheres** — the doctrine of men outside, women
inside was both a restriction on women and the very excuse women used to enter reform
("we are more moral than men, so we should govern these matters").`,
      },
    },
