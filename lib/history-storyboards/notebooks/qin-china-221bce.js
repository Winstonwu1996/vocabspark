...
最难忘的反讽：他想传万世，结果二世而亡，连十五年都没撑到。`,
          en: `The First Emperor's story line,, both cover this.
...
**考点对照**：法家（靠法与刑）和你学过的儒家（靠道德教化）是两条相反的治国路。`,
          en: `The Li Si story line,, lays it out most clearly — he himself was Legalism's ablest executor.
...
AP 爱考的对照：分封（权力分散给诸侯）vs 郡县（权力收归中央）——各解决了什么，各埋下了什么。`,
          en: `The Li Si story line,, is the heart of this concept (the First Emperor's covers it too).
