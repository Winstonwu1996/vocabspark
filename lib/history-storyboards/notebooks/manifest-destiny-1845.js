  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['polk-n2'],
        xiaoweiNote: {
          cn: `这个我读过！在 Polk Lens 第 2 节，他讲 1845 年一个纽约报人 John O\\'Sullivan
写出两个字：Manifest Destiny（昭昭天命）。意思是——美国向西铺满整个大陆，
是上天注定、不容质疑的命运。

老师反复强调一个最容易错的点：
❌「Manifest Destiny 是一部法律或官方政策」
✅ 它是一个记者造的口号、一种流行的意识形态，不是法律。

考点关键句：这两个字是一句话术。它把「我们想要那片地」这个念头，
变成「老天定我们要那片地」——一个念头从此不用再被质疑，只需要被完成。

我自己的记忆锚：manifest = 明显的、注定的。
把「想拿」包装成「天命」，是这整个 topic 的核心套路。`,
...
❌ "Manifest Destiny was a law or an official policy."
✅ It was a slogan a journalist coined, a popular ideology, not a law.
...
the core move of this whole topic.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['polk-n3'],
        xiaoweiNote: {
          cn: `Polk Lens 第 3 节讲的。德州本是墨西哥的地，1836 年那里的移民闹独立，
...
Polk's "opening"; what he truly wanted was California, west of Texas.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Polk Lens 第 4、5 节是这场仗的核心。Polk 想买加州，墨西哥不卖也不见。
...
struck first" → ✅ the first shot fell in the disputed strip; "Mexico fired first" is itself a
...
Mexico was defeated.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['vallejo-n4'],
        xiaoweiNote: {
          cn: `Vallejo Lens 第 4 节从「被影响的人」这边讲这份条约最戳人。1848 年战争结束，
...
这里埋了全 topic 最关键的张力（DBQ 爱考）：条约「写了」保护，
...
later not kept.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['polk-n6'],
        xiaoweiNote: {
          cn: `Polk Lens 第 6 节是全 topic 我觉得最聪明的一节，因为它把 Polk 整套逻辑照穿了。
1846 年，北边还有一块美英共管的大地：俄勒冈。Polk 竞选时喊过很硬的口号
...
Britain, Oregon. In his campaign Polk had shouted a hard slogan, "54-40 or fight" (take it up to
...
and wrong," the other measures "how hard the other side is" — and it always measured the latter.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['vallejo-n5'],
        xiaoweiNote: {
          cn: `Polk Lens 第 7 节先讲发现金子（条约签字同年，1848 年加州发现金矿，
他大概觉得「连金子都在等我们」）；但 Vallejo Lens 第 5 节从失地者这边讲，才看得见金子的另一面。
...
gold, Polk saw destiny; Vallejo saw the people pouring in to occupy his ranch.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Vallejo Lens 第 6 到 9 节，是这份条约「写了却没保护」的爆发点。
...
⚠️ 注意别跟泪之路搞混：切罗基迁移（1838-39）是另一个主题，本题是 1840s 加州的失地。`,
...
⚠️ Do not mix this up with the Trail of Tears, the Cherokee removal (1838-39) is a different topic;
...
⚠️ 一个老师特别强调的原则（Rule 0）：不能说美国「先进所以对」，
也不能说中国「落后所以活该」。两边都是同一段全球史的不同位置：
有人在浪头上扩张，有人在浪脚下挨打。看清两边，才看得懂 19 世纪到底发生了什么。

🔗 故事连接：Polk Lens 第 6 节里，他对强大的英国谈判、对弱小的墨西哥开战——
...
⚠️ A principle teacher stressed (Rule 0), you cannot say America was "advanced, therefore right,"
...
Destiny" — if negotiate-or-fight follows power, does the coat of "destiny" conveniently cover for power?`,
    ...
    {
      id: 'q3',
      cn: `《Guadalupe Hidalgo 条约》第八、九条白纸黑字写着，墨西哥居民的财产「应受到不可侵犯的尊重」。
