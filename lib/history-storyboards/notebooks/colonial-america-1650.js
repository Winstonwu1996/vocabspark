...
//
// 与 storyboard 的关系：
//   - storyboard 提供情感锚点（大西洋商人 actor / 清教徒牧师 mediator / 被奴役非洲人 receiving-end 三条线）
...
Let me write these down. After I read the three stories — the Atlantic merchant (who got rich
...
the light, and see whose back that light was standing on."`,
    ...
    keyFigures: [
      ...
      },
      {
        ...
        roleEn: 'The leader of the 1739 Stono Rebellion; the record is so thin even his name is uncertain — that "namelessness" is itself a teaching point of the enslaved perspective',
        mustKnow: false,
        audioKey: null,
      },
    ],
  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个我读过！在大西洋商人那一遍第 2 节，他把它讲成"不是一条航线，是一个圈"。
我把这个圈背成三段：
...
（Newport 一地几十家蒸馏坊昼夜不停，被叫"世界朗姆之都"——这个细节最好记。）`,
          en: `I read this! In the Atlantic merchant's Lens Node 2, he calls it "not a route, but a circle."
...
world" — the easiest detail to remember.)`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `三角贸易里最不堪、也最赚钱的一段。被奴役者那一遍第 2 节、商人那一遍第 3 节都讲了。
...
考点关键句：上岸后被拍卖、和牲口农具记在账本同一类——"人变成了财产"。`,
          en: `The most unbearable and most profitable leg of the triangular trade. Covered in the enslaved
Lens Node 2 and the merchant Lens Node 3. It's the weeks of crossing the Atlantic: captured
people chained in the bottom of the hold, packed too tight to straighten their backs, sick and filthy.
...
and tools — "a person became property."`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是整课的"causation 核心"，三个视角都讲到，商人第 6 节、被奴役者第 3 节最清楚。
...
考点关键句：底层那条线，本来是"穷 vs 富"，Bacon 起义后被精英重画成"白 vs 黑"——这是**设计，不是天意**。`,
          en: `This is the whole topic's "causation core," touched by all three lenses; clearest in the merchant
Lens Node 6 and the enslaved Lens Node 3. Teacher said AP most rewards the multi-step causation
"slavery wasn't natural — it was built, law by law."
...
elite redrew it as "white vs black" — this was **design, not fate**.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `商人那一遍第 5 节讲的"转折"。为什么单列一张卡？因为 AP 把它当"种族奴隶制转向"的枢纽事件来考。
...
但它吓出了那一连串把奴隶制写进法律的选择。`,
          en: `The "turn" in the merchant's Lens Node 5. Why its own card? Because AP tests it as the pivot
...
that wrote slavery into law.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `牧师那一遍第 4、6 节是主线，商人第 7 节也碰到了（他也去听、也流泪）。
...
老师说 AP 的 LEQ/SAQ 里，大觉醒被考最多的是它的**长期意义**，要记住"双面"：
**① 它把冷掉的信仰重新点燃，也②把教会劈成两派（见 New/Old Lights 那张卡）；
更重要的③它是头一件"同时席卷所有殖民地"的事——给了各过各的殖民地第一次"共同体验"，
被一些史家看作革命思想的远端铺垫。**

考点关键句：Whitefield 告诉普通人"你不必经过任何既有权威，可以自己直接面对上帝"——
这种"不必经过权威"的想法，后来可能在政治里也长出东西。`,
          en: `The minister's Lens Nodes 4 and 6 are the main line; the merchant's Node 7 touches it too (he
...
something in politics too.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `牧师那一遍第 5 节专门讲这道"裂缝"。大觉醒不只点火，也把牧师一夜劈成两派——
...
记忆锚：New = 新 = 情感 / 个人 / 反权威；Old = 旧 = 秩序 / 教会 / 受训牧师。`,
          en: `The minister's Lens Node 5 is specifically about this "crack." The Awakening didn't only light a
...
Memory anchor: New = emotion / individual / anti-authority; Old = order / church / trained ministers.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `被奴役者那一遍第 6、7 节的高潮，也是这一课跨三个视角都听得见的那阵"鼓声"的落点。
...
"几代奴役逼出的怒火"和"暴力也落在普通人身上"两面，不一刀切。`,
          en: `The climax of the enslaved Lens Nodes 6 and 7, and the landing point of the "drumbeat" heard
across all three lenses in this topic. Teacher said this is the point AP DBQ rewards again and
again: **black agency** — the enslaved were **not** passive goods waiting to be freed, but
...
一度垄断英国贩奴；**1698 年垄断被打破**后，像故事里那个商人一样的独立商人一窝蜂涌进来，
...
broken around 1698**, independent merchants like the one in the story flooded in, England's slave
trading exploded, and within decades it became the world's largest slave-trading nation.
...
independent merchants flood in → England becomes the world's largest slave-trading nation.**`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `牧师那一遍第 1、2、3 节的背景，解释了他为什么那么焦虑——也是大觉醒"为什么会发生"的前提。
...
记忆锚：city upon a hill（理想）→ 三代世俗化 → Halfway Covenant 1662（焦虑的证据）→ 大觉醒（再点火）。`,
          en: `The background of the minister's Lens Nodes 1, 2, and 3, explaining why he was so anxious — and
the precondition for "why the Great Awakening happened."
...
(evidence of anxiety) → Great Awakening (re-lighting).`,
...

    {
      ...
      termCn: '同一片土地的两张脸（Rule 0 中立分析）',
      termEn: 'Two Faces of One Land (Rule 0 Neutral Analysis)',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是把整课收口的一张"评价"卡，三个视角的第 10/11 节都在做同一件事——摆出"两边都站得住"，
...
三个视角各留了一个不替你回答的难题（都没有标准答案，AP 看你怎么用证据）：
...
——这是把 1650-1750 的张力接到今天，AP 的 LEQ 收尾也爱要这种"延续到当下"的视野。`,
          en: `This is the "evaluation" card that closes the whole topic. The 10th/11th nodes of all three
lenses do the same thing — lay out "both sides stand" and **refuse to draw the moral conclusion
...
Each lens leaves a hard question it won't answer for you (no standard answer; AP watches how you use evidence):
...
- **The minister**: a man who clearly saw yet chose silence — is his "struggle" a kind of accomplice?
...
tension to now, and AP LEQ endings love this "continuity to the present" lens.`,
        },
      },
    },
  ],
...
- To defend "legal," you could note that people of the time felt it "followed the rules" — but that's
  exactly what exposes the danger of "normal / legal" (the merchant's Lens Nodes 4 and 10 weigh this).
...
（牧师那一遍第 7 节"脚下踩着 Middle Passage 上死掉的人"就是这个张力的画面）。
...
the reality; both were true at once on the same soil (the minister's Lens Node 7, "standing on the
