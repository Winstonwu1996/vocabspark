...
Stanton、Anthony 一派立刻说：既然公民，就有投票权——
这套逻辑叫 **New Departure（新出路）策略**。
Anthony 1872 年去投票并被捕，用的就是这套论证。

**案件**：密苏里州弗吉尼亚·迈纳（Virginia Minor）1872 年去登记投票被拒，
以丈夫名义起诉（那年代已婚女性不能独立提告）。

**判决**：1875 年最高法院 **9 比 0 全票裁定**——
公民身份与投票权是两回事；选举资格由各州自行规定；
联邦宪法并未赋予女性投票权。

**影响**：New Departure 策略当场死亡。运动只剩一条路：
推一条**专门针对性别的新宪法修正案**。
这正是后来 NAWSA 州一州推进 + NWP 白宫纠察整整 45 年后，
1920 年第 19 修正案才通关的根源。

记忆口诀：**Minor = 堵死旧路，逼出修宪策略**。`,
        en: `The 19th Amendment was not the movement's first strategy — they first tried
arguing "we already have the right," got shut down by the Supreme Court,
and only then were forced into the push-for-a-new-amendment approach.

**Background**: After the Civil War, the 14th Amendment (1868) declared "all persons
born or naturalized in the United States are citizens." Stanton and Anthony's wing
immediately argued: citizenship means voting rights — this logic was called the
**New Departure strategy**. It is the same argument Anthony used when she voted in
1872 and was arrested.

**The case**: Virginia Minor of Missouri was refused voter registration in 1872 and
sued through her husband (married women couldn't sue independently at the time).

**Ruling**: In 1875 the Supreme Court ruled **9 to 0** — citizenship and voting
rights are separate; states control voter qualifications; the federal Constitution
does not grant women the right to vote.

**Impact**: The New Departure strategy died on the spot. The movement had only one
path left: push a **brand-new constitutional amendment specifically on sex.**
This is the root reason NAWSA's state-by-state campaign plus the NWP's White
House picketing took another 45 years before the 19th Amendment passed in 1920.

Mnemonic: **Minor = old road blocked, amendment strategy forced.**`,
      },
      xiaoweiNote: {
        cn: `故事里没讲这个案子，但 AP 很爱考"为什么运动最后要推第 19 修正案而不是
靠已有宪法"——答案就是 Minor v. Happersett（1875）：最高法院说公民身份
不等于投票权，各州管这件事，逼得运动没有别的路。

我的记忆钩子：**Minor（迈纳）= 门关上了，只能造新门**。
时间线：第 14 修正案 1868（公民）→ Anthony 投票被捕 1872 →
Minor 上诉 → 最高法院否决 1875 → 再等 45 年 → 第 19 修正案 1920。`,
        en: `The story doesn't cover this case, but AP loves asking "why did the movement
end up needing the 19th Amendment instead of relying on existing clauses?"
The answer is Minor v. Happersett (1875): the Supreme Court said citizenship
does not equal the vote, states control it — leaving the movement no other road.

My memory hook: **Minor = the door was shut, so they had to build a new one.**
Timeline: 14th Amendment 1868 (citizenship) → Anthony votes and arrested 1872 →
Minor appeals → Supreme Court blocks 1875 → 45 more years → 19th Amendment 1920.`,
      },
    },
