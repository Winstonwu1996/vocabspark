...
她说这句话是这整个 topic 的钥匙：同一个问题"先给谁投票权"，
  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个我读过！在 Lens 1（Stanton）第 1、4、5 节。1848 年 7 月 19-20 日，
...
what meeting did the suffrage movement begin" — the answer is always Seneca Falls 1848.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 1 第 5 节讲到他们怎么搭上的。1850 年前后 Stanton 遇到
...
My mnemonic: **Stanton writes, Anthony runs, and Anthony is the one arrested.**`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这条线**三个 Lens 都碰到了**（Stanton N6/N7、Frances Harper N6、Ida B. Wells N6），
因为它是整个 topic 的"裂缝"。老师说这是**最高频考点**之一。
...
split in between.**`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 2 整条线就是她。**Frances Ellen Watkins Harper**，非裔女诗人 + 活动家，
...
criticizes both sides, and both sides find her not pure enough.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 3（defaultLens）整条线就是她。**Ida B. Wells**，反私刑记者，
...
Both contributed to 1920 — don't remember only one.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个**三个 Lens 的第 9 节都讲到了**（Stanton N9、Frances Harper N9、
...
（提示：你跑过费城制宪那个 Topic，1781 年 Mum Bett 听见主人写的"生而自由"，
