...
这一段的主线，是一场没有硝烟的「大重组」：工厂从一座座小城迁走，
...
The through-line is a quiet "great restructuring": factories left one small town after another,
while money and jobs flowed to the new economy (finance, tech, globalization); the Cold War
was won and the USSR dissolved; then 9/11 and two long wars stretched across twenty years;
and in 2008 a financial crash wiped out half of tens of millions of retirement accounts.
...
I'll come back and check whether I can tell **both sides**, not just one.`,
    ...
    keyFigures: [
      ...
      },
      {
        nameCn: '比尔·克林顿',
        nameEn: 'Bill Clinton',
        roleCn: '美国第 42 任总统（1993-2001），任内 NAFTA 于 1994 年生效；1998 年遭众议院弹劾，参议院未定罪，留任至期满。',
        mustKnow: true,
      },
      {
        nameCn: '乔治·W·布什',
  ...
  mainConcepts: [
    {
      ...
      defCn: '1980 年代美国政治经济的一次大转向：政府减少干预，大幅减税，放松对企业的管制，让市场而不是政府来主导经济。这段转向以里根总统为代表，考试里常叫「里根革命」。',
      defEn: 'A major shift in US politics in the 1980s: the government cut taxes sharply, reduced regulation of businesses, and let markets — not the government — run the economy. Named after President Reagan, it is often called the "Reagan Revolution" on exams.',
      storyAnchor: {
        standaloneText: {
          cn: `这是 Period 9 的开场考点，也是**党派分歧最大的几张卡之一**——所以我背的是「两面」，不是「一边」。

时间：1981-1989，**Ronald Reagan（里根）** 任第 40 任总统。

事实骨架（无争议、必背）：
1. 1981 年 8 月签 Economic Recovery Tax Act，大幅减税。
2. 同时推 deregulation（放松管制）——就是减少政府对企业的规定和限制。
3. 注意一个常见陷阱：个税最高税率**不是一步**从 70% 砍到 28%。是**分两步**：1981 年先降到 50%，1986 年税改后再降到 28%。

然后是吵了四十年还没停的那一层——**这一层我必须两面都写**：
- **支持者说**：减税和放松管制点燃了经济活力，终结了 1970 年代的滞胀。
- **批评者说**：它让经济不平等开始拉大，削弱了对普通工人的保护。

两边用的常常是**同一组数据的不同切面**。

考点关键句：保守主义转向 = 一次税收与监管思路的大转变，它的功过从 1980 年吵到今天。答题时把两边并排摆出来，**不要替历史选边**，这才是 APUSH 要的 complexity（复杂性分析）。`,
          en: `This is the opening exam card of Period 9 — and **one of the most politically divided cards** in this unit — so I memorize "both faces," not one side.

When: 1981-1989, **Ronald Reagan** as the 40th president.

Factual skeleton (uncontested, memorize):
1. In August 1981 he signed the Economic Recovery Tax Act, cutting taxes sharply.
2. He also pushed deregulation — reducing government rules and restrictions on businesses.
3. Watch a common trap: the top income-tax rate was **not** cut from 70% to 28% in one step. It took **two steps**: down to 50% in 1981, then to 28% only after the 1986 tax reform.

Then comes the layer that has been argued for forty years — **I must write both sides here**:
...
Both sides often use **different slices of the same data**.

Key exam sentence: the conservative turn = a major shift in tax-and-regulation thinking whose pros and cons have been argued from 1980 to today. In an answer, lay both sides side by side and **don't pick a side for history** — that's the complexity APUSH wants.`,
        },
        xiaoweiNote: {
          cn: `老师说这张卡的「正确答案」不是某个立场，而是**能不能把两边都摆上桌**。
口诀：先写事实（减税 + 放松管制，分两步降税），再写「支持者说 / 批评者说」两句平行的话。`,
          en: `Teacher said the "right answer" for this card isn't a stance — it's whether you can **put both sides on the table**.
Mnemonic: write the facts first (tax cuts + deregulation, two-step rate drop), then two parallel lines: "supporters say / critics say."`,
        },
      },
    },

    {
      ...
      defCn: '冷战（Cold War）是美国和苏联从 1940 年代末开始长达约四十年的对抗，双方没有直接打仗，但互相施压、军备竞赛。1989 年柏林墙倒塌、1991 年苏联解体，这场对抗正式结束。',
      defEn: 'The Cold War was a roughly forty-year standoff between the United States and the Soviet Union that began in the late 1940s. They did not fight each other directly, but competed through military build-ups, diplomacy, and proxy conflicts. It ended when the Berlin Wall fell in 1989 and the Soviet Union dissolved in 1991.',
      storyAnchor: {
        standaloneText: {
          cn: `两个必背画面、两个必背年份：

- **1989 年 11 月 9 日**：分隔东西柏林 28 年的**柏林墙（Berlin Wall）**被人群涌开。这是冷战走向终结的转折画面。
...
一个常被考的反讽：**一种说法**把冷战终结当成自由市场与民主的胜利。**另一种说法**指出，赢了之后，美国对自己在世界上该扮演什么角色反而陷入了新的迷茫，二十年后还陷入了严重的内部分裂。
...
A frequently tested irony: **one view** treats the Cold War's end as a victory for free markets and democracy. **Another view** notes that after winning, the US grew newly uncertain about its role in the world, and twenty years on fell into serious internal division.
...
Mnemonic: the wall fell from many causes, not "one person pushing it down."`,
...

    {
      ...
      defCn: '全球化（globalization）是指国家之间的贸易、投资和人员流动越来越紧密。去工业化（deindustrialization）是指一个地区的工厂和制造业岗位大量减少。在美国，锈带（五大湖周边的老工业区）从 1980 年代起工厂大量外迁，失业率上升，这就是去工业化最典型的例子。',
      defEn: 'Globalization is the tighter and tighter flow of trade, investment, and people between countries. Deindustrialization is the large-scale loss of factories and manufacturing jobs in a region. In the US, the Rust Belt — the old industrial zone around the Great Lakes — saw factories close or move abroad from the 1980s onward. That is the most-tested example of deindustrialization.',
      storyAnchor: {
        standaloneText: {
          cn: `这是贯穿全课的经济主线，也是承受端家庭故事的核心。

两个必背节点：
- **NAFTA**：1994 年 1 月 1 日正式生效，美、加、墨之间贸易壁垒大幅降低。（老布什 1992 年谈成并签署框架，克林顿签实施法后生效。）
- **中国入世（WTO accession）**：2001 年 12 月 11 日，中国正式成为 WTO 成员，美中经济从此深度交织。

核心概念：**deindustrialization（去工业化）**——锈带（Rust Belt，五大湖周边曾经的工业带）的工厂陆续裁员、外迁、关停。2000 到 2010 年间，美国制造业岗位流失约 570 万个（约三分之一）。

同一件事——「把生产搬到更便宜的地方」——在上行者眼里是**效率与机会**，在承受端家庭眼里是**饭碗的流失**。同一件事，两套词。

制造业岗位为什么消失——多因，单因是 DBQ 大忌：
❌ 「全怪某一个贸易协定或某一位总统」
...
Core concept: **deindustrialization** — factories in the Rust Belt (the old industrial band around the Great Lakes) laid off workers, relocated, and closed one after another. Between 2000 and 2010, the US lost roughly 5.7 million manufacturing jobs (about one-third).
...
口诀：同一件事，上行者叫「效率」，承受端叫「我爸的工作没了」。`,
          en: `The receiving-end story hit hardest: that family watched the factory's lights go dark one shift at a time.
Mnemonic: same event — the upwardly mobile call it "efficiency," the receiving end calls it "my dad's job is gone."`,
...

    {
      ...
      defCn: '从 1990 年代开始，个人电脑和互联网普及，彻底改变了人们工作、购物和通讯的方式。2007 年 iPhone 上市让智能手机成为日常。这场技术浪潮把财富和工作机会推向科技中心城市，同时也让机器代替了更多工厂里的工人。',
      defEn: 'Starting in the 1990s, personal computers and the internet spread widely, changing how people work, shop, and communicate. The iPhone launch in 2007 made smartphones everyday tools. This wave of technology pushed wealth and jobs toward tech-hub cities while also letting machines replace more factory workers.',
      storyAnchor: {
        standaloneText: {
...
它做了什么（接回去工业化的故事）：技术把财富和工作进一步推向**科技走廊**（两岸的金融与科技中心），也进一步**抽离了传统制造业小城**。同一场技术繁荣，是某些地方上行、某些地方凋零的同一个原因之一。

为什么它要和去工业化一起记：制造业岗位消失，**自动化（机器替人）**是和全球化并列的一个原因。所以「工厂为什么走」这道题，技术既是新经济的引擎，也是旧岗位流失的部分原因——写这题要写多因。
...
What it did (connects to the deindustrialization story): technology pushed wealth and jobs further toward the **tech corridors** (the coastal finance and tech hubs), and further **drained traditional manufacturing towns**. The same tech boom is one reason some places rose while others withered.

Why memorize it alongside deindustrialization: in the loss of manufacturing jobs, **automation (machines replacing people)** stands alongside globalization as a cause. So for "why did the factories leave," technology is both the engine of the new economy and part of why old jobs vanished — write multiple causes for that question.
...
Mnemonic: tech is both the engine of the new economy and one cause of lost jobs — so "why the factories left" needs multiple causes.`,
...

    {
      ...
      defCn: '2001 年 9 月 11 日，劫机者撞击纽约世贸双塔和五角大楼，约 2,977 人遇难，是当代美国最深的集体创伤。之后美国发动反恐战争（War on Terror），先出兵阿富汗（2001），再出兵伊拉克（2003），两场战争持续了二十余年。',
      defEn: 'On September 11, 2001, hijackers crashed planes into the World Trade Center towers in New York and the Pentagon, killing about 2,977 people — the deepest collective trauma in contemporary American history. Afterward, the US launched the War on Terror, first invading Afghanistan (2001) and then Iraq (2003). Both wars lasted more than twenty years.',
      storyAnchor: {
        standaloneText: {
          cn: `这是当代美国最深的一道集体创伤，也是退伍军人视角的起点。这张卡里有事实、也有至今仍在争论的评价，我**分两层**写。

事实骨架（无争议、必背）：
1. **2001 年 9 月 11 日**，劫机者撞击纽约世贸双塔与五角大楼，约 **2,977 人**遇难。
2. 同年 **10 月 7 日**出兵**阿富汗**（Afghanistan）。
3. **2003 年 3 月**出兵**伊拉克**（Iraq）。出兵理由（大规模杀伤性武器，WMD）后来**未被证实**，引发巨大争议。「理由后引争议」是**事实陈述**，不是某一方的立场。

然后是评价那一层——**这是全 topic 党派分歧最深的一处，两面必须并排**：
- **支持出兵的人说**：这是反恐、是保护美国安全的延伸。
- **反对的人说**：战争太久、代价太重、理由有争议。

退伍军人那条故事线里有个设计：他既见过这场战争**有意义的一面**（战友、保护身边人的具体责任），也见过它**沉重的代价**（伤亡、漫长、目标一变再变）——他**两边都站过**，所以他是中性的观察点。

考点关键句：9/11（2001）= 集体创伤 + 阿富汗 2001 / 伊拉克 2003 两场战争；战争的**评价**两边都站得住，答题不预设哪边正确。`,
          en: `This is contemporary America's deepest collective trauma and the starting point of the veteran's story. This card holds both facts and contested judgment, so I write it in **two layers**.

Factual skeleton (uncontested, memorize):
1. On **September 11, 2001**, hijackers struck the World Trade Center towers in New York and the Pentagon; about **2,977 people** died.
2. On **October 7** of that year the US invaded **Afghanistan**.
3. In **March 2003** the US invaded **Iraq**. The stated reason (weapons of mass destruction, WMD) was later **not verified**, drawing enormous controversy. "The reason later drew controversy" is a **factual statement**, not one side's position.

Then the judgment layer — **this is the most politically divided point in the whole unit, both sides must run in parallel**:
...
The veteran's story is designed to be a neutral vantage point: he saw both the war's **meaningful side** (comrades, the concrete duty to protect those beside him) and its **heavy cost** (casualties, length, shifting goals) — he **stood on both sides**.
...
口诀：「理由后引争议」是事实；「这仗值不值」是评价——评价那层，两边都要写。`,
          en: `The veteran's story taught me one thing: a person can **at once** see something as meaningful and see its cost as heavy.
Mnemonic: "the reason later drew controversy" is fact; "was the war worth it" is judgment — for the judgment layer, write both sides.`,
...

    {
      ...
      defCn: '2008 年 9 月，美国最大投资银行之一 Lehman Brothers 破产，引发全球金融危机。随后的大衰退（Great Recession，2007 年 12 月–2009 年 6 月）造成约 870 万美国人失职，失业率一度冲到 10%。无数家庭的房子、退休账户、工作同时受到冲击。',
      defEn: 'In September 2008, one of the largest US investment banks, Lehman Brothers, went bankrupt, triggering a global financial crisis. The Great Recession that followed (December 2007–June 2009) cost about 8.7 million Americans their jobs, and unemployment spiked to 10%. Countless families were hit in their homes, retirement accounts, and jobs all at once.',
      storyAnchor: {
        standaloneText: {
          cn: `这是承受端家庭挨的最重一拳，也是一张成因有争议的考点卡——我**事实和成因分开**写。

事实骨架（无争议、必背）：
1. **2008 年 9 月 15 日**，投资银行 **Lehman Brothers** 破产，引爆全球金融海啸（美史最大破产案）。
2. 大衰退（**Great Recession**，2007 年 12 月–2009 年 6 月）里，美国约失去 **870 万**个工作岗位，失业率 2009 年 10 月一度冲到 **10%**。
3. 承受端家庭的房子、退休账户、工作一起挨打。

成因那一层——**两本账至今没合，必须中立并排，不暗示哪个是「真因」**：
- **一种说法**把账算在**华尔街的贪婪和监管缺位**上。
- **另一种说法**算在**过度借贷与政策激励**上。

这对应金融危机调查委员会报告里的多数意见与异议——是真实存在的两种主流归因。

清坑：❌「2008 只是华尔街的错」或「只是借款人的错」→ ✅ 监管、金融创新、激励机制、个体行为都牵涉其中，两边各执一账。

考点关键句：Lehman 2008 + 大衰退（870 万岗位 / 失业率 10%）是事实；**成因是争议的两本账**，答题两边并排、不下定论。`,
          en: `This is the hardest blow the receiving-end family took, and a card with contested causes — so I write **facts and causes separately**.

Factual skeleton (uncontested, memorize):
1. On **September 15, 2008**, investment bank **Lehman Brothers** went bankrupt, igniting a global financial crash (the largest bankruptcy in US history).
2. In the **Great Recession** (December 2007–June 2009), the US lost about **8.7 million** jobs, and unemployment spiked to **10%** in October 2009.
3. The receiving-end family's house, retirement account, and jobs were hit together.
...
Clearing the trap: ❌ "2008 was only Wall Street's fault" or "only the borrowers' fault" → ✅ regulation, financial innovation, incentives, and individual behavior were all involved; each side keeps its own ledger.
...
Mnemonic: 2008's facts are solid; 2008's causes are two ledgers — write them side by side.`,
...

    {
      ...
      defCn: '2008 年 11 月 4 日，Barack Obama（奥巴马）当选美国第 44 任总统，并于 2009 年 1 月 20 日就职，成为美国历史上第一位非裔总统。这是一个无争议的史实里程碑，独立于对他具体政策的任何评价。',
      defEn: 'On November 4, 2008, Barack Obama was elected the 44th President of the United States and was inaugurated on January 20, 2009, becoming the first Black president in US history. This is an uncontested factual milestone, separate from any judgment about his specific policies.',
      storyAnchor: {
        standaloneText: {
          cn: `这是一个世界史里的「第一」，是**史实里程碑**，必背年份和意义。

事实骨架（无争议、必背）：
1. **2008 年 11 月 4 日**，**Barack Obama（奥巴马）** 当选第 44 任总统。
2. **2009 年 1 月 20 日**就职，成为美国历史上**第一位非裔总统**。

为什么它进考点：对很多人，这是一个国家在种族问题上跨出的**历史一步**，记入当代美国的集体记忆。

这张卡聚焦的是「首位非裔总统」这个**史实里程碑**本身。它是一个无争议的事实。对他具体政策的评价是另一回事——那是两边各有说法的讨论，不是这张卡要背的。

放进 Period 9 的位置：就发生在 2008 金融危机最深的那个秋天。两件大事同年——一个国家在经济至暗时刻，也跨出了种族史上的一步。
...
Factual skeleton (uncontested, memorize):
1. On **November 4, 2008**, **Barack Obama** was elected the 44th president.
2. He was inaugurated on **January 20, 2009**, becoming the **first Black president** in US history.
...
This card focuses on the **factual milestone** of "first Black president" itself — an uncontested fact. Judging his specific policies is a separate matter with views on both sides; it's not what this card asks you to memorize.
...
Mnemonic: milestone (fact) and policy judgment (views on both sides) are separate.`,
...

    {
      ...
      defCn: '经济不平等（economic inequality）是指有钱人和穷人之间的差距越来越大。政治极化（political polarization）是指两党、两种美国越来越难对话，立场分歧越来越深。两者从 2010 年代开始同时上升，有大量实证数据支撑。',
      defEn: 'Economic inequality means the gap between wealthy people and everyone else keeps growing. Political polarization means the two parties — and the two Americas — find it harder and harder to talk to each other, with views growing further apart. Both trends have been rising since the 2010s, backed by substantial data.',
      storyAnchor: {
        standaloneText: {
...
学界目前没有定论。诚实的做法不是假装有答案，而是把几种解释并排摆好。
...
The roots of polarization — no consensus, lay the explanations side by side:
- Is it driven by **economic inequality**?
- Is it amplified by **media and technology (social media)**?
- Or by deeper **cultural and identity divides**?

Scholars have no settled answer. The honest move is to set several explanations side by side, not to pick one.
...
Mnemonic: polarization's causes = several explanations side by side; don't pick one as the only answer.`,
...

    {
      ...
      defCn: '阿片危机是指从 1990 年代开始，大量美国人因为处方止痛药成瘾，进而转向海洛因和芬太尼，导致死亡人数急剧攀升的公共卫生危机。它不是单纯的个人选择问题，而是医疗、监管、经济多重因素叠加的结果。1999 到 2020 年间约 56.5 万美国人死于阿片类药物过量。',
      defEn: 'The opioid crisis is a public-health emergency in which large numbers of Americans became addicted to prescription painkillers starting in the 1990s, then shifted to heroin and fentanyl, causing a sharp rise in overdose deaths. It is not simply a matter of personal choice — it resulted from medical, regulatory, and economic factors stacking together. About 565,000 Americans died from opioid overdoses between 1999 and 2020.',
      storyAnchor: {
        standaloneText: {
...
为什么它属于这门课：承受端那条故事线里，人们不只失去工厂和退休账户，还失去了人。主街一家家店熄灯的同时，小城里开始有人因为药物离世。这是重组账单上最重的一行。
...
Clearing the trap — this question guards against "single cause + moral blame":
...
Why it belongs in this unit: in the receiving-end story, people lost not only factories and retirement accounts but people. As Main Street's stores went dark one by one, the town began losing people to drugs. The heaviest line on the restructuring's bill.
...
Mnemonic: the opioid crisis is a public-health crisis (multi-cause), not a personal-morality issue.`,
...

    {
      ...
      defCn: '比尔·克林顿（Bill Clinton）是美国第 42 任总统（1993-2001），民主党。他任内 NAFTA 生效（1994）、互联网经济繁荣、政府实现财政盈余。1998 年他被众议院弹劾，但参议院未定罪，他留任至任期结束。弹劾（impeachment）是宪法规定的调查程序，不等于下台。',
      defEn: 'Bill Clinton was the 42nd US President (1993–2001), a Democrat. During his presidency NAFTA took effect (1994), the internet economy boomed, and the government ran budget surpluses. In 1998 the House of Representatives impeached him, but the Senate did not convict him and he completed his term. Impeachment is a constitutional investigation process — it does not mean removal from office.',
      storyAnchor: {
        standaloneText: {
          cn: `克林顿时代（1993-2001）是 Period 9 常被跳过、但 APUSH 真题反复考的一段。

事实骨架（无争议、必背）：
1. **Bill Clinton** 1993-2001 任第 42 任总统，民主党。
2. 经济：1990 年代中后期互联网经济繁荣，政府实现多年财政盈余。
3. 立法：**NAFTA** 1994 年 1 月 1 日生效（克林顿任内实施）。**1996 年福利改革法案**大幅收紧联邦福利资格——支持者称其激励就业，批评者称其削减了对最脆弱群体的保护。两面并排。
4. 政治：1998 年因 Monica Lewinsky 事件遭众议院**弹劾（impeachment）**，参议院未定罪，克林顿留任。

为什么考它：克林顿时代是「政治中间路线」的典型，是保守主义转向这条大线中的一个内部插点。
...
Factual skeleton (uncontested, memorize):
1. **Bill Clinton** served as the 42nd president, 1993-2001, Democrat.
2. Economically: the mid-to-late 1990s saw an internet-economy boom and the government ran multi-year budget surpluses.
3. Legislation: **NAFTA** took effect January 1, 1994 (Clinton signed the implementing legislation and brought it into force); the **1996 welfare reform law** sharply tightened federal welfare eligibility — supporters say it incentivized work, critics say it cut protections for the most vulnerable. Both sides side by side.
4. Domestic politics: in 1998, over the Monica Lewinsky affair, the House **impeached** Clinton; the Senate did not convict; Clinton remained in office.

Why APUSH tests it: the Clinton era is the classic example of "Third Way" politics — an internal turning point within the broader conservative-to-centrist arc from Reagan onward.
...
Mnemonic: Clinton was impeached (House), not convicted (Senate), stayed in office — three steps, keep them separate.`,
...

    {
      ...
      defCn: '平价医疗法（Affordable Care Act，ACA）是 2010 年奥巴马签署的联邦医疗保险法。它禁止保险公司以「既往病史」为由拒保，并扩大了联邦医保覆盖范围。这是 1960 年代 Medicare/Medicaid 之后美国最大幅度的医保立法扩展，但它是否做对了，两边至今仍在争。',
      defEn: 'The Affordable Care Act (ACA), signed by President Obama in 2010, is a federal health-insurance law. It banned insurance companies from denying coverage because of pre-existing medical conditions and expanded federal health coverage. It is the largest expansion of federal health coverage since Medicare/Medicaid in the 1960s, but whether it was the right approach remains disputed.',
      storyAnchor: {
        standaloneText: {
          cn: `这是 APUSH 里「政府在医疗中的角色」之争最集中的案例，也是一张典型的 Rule-0 卡——事实稳，评价要两边写。

事实骨架（无争议、必背）：
1. 正式名称：**Affordable Care Act（ACA）**，2010 年 3 月 23 日奥巴马签署。
2. 核心机制：①禁止保险公司因既往病史拒保；②设立保险交易市场（marketplaces）；③扩大 Medicaid 资格。签署前美国约有 **4,600 万人**无医保。
3. 最高法院（**NFIB v. Sebelius，2012 年**）裁定 ACA 大部分合宪。
...
考点关键句：ACA 2010 = 扩大医保覆盖的联邦立法；**这是 1960 年代 Medicare / Medicaid 之后美国最大幅度的医保立法扩展**，评价两边都有实证支撑。`,
          en: `This is the most concentrated APUSH case study of "government's role in healthcare" — a classic Rule-0 card where the facts are solid but the judgment needs both sides.

Factual skeleton (uncontested, memorize):
1. Full name: **Affordable Care Act (ACA)**, signed by Obama on March 23, 2010.
2. Core mechanisms: ① insurers prohibited from denying coverage for pre-existing conditions; ② insurance marketplaces established; ③ Medicaid eligibility expanded. Before it passed, roughly **46 million Americans** lacked health insurance.
3. Supreme Court (**NFIB v. Sebelius, 2012**) upheld most of the ACA as constitutional.

This is a **still-live controversy** — both sides side by side:
...
- **Opponents say**: government mandate to carry insurance, rising premiums, restricted personal freedom — excessive intervention in markets.
...
Mnemonic: ACA = signed 2010 + no denial for pre-existing conditions + NFIB v. Sebelius 2012 constitutional; judgment — both sides side by side.`,
...

    {
      ...
      defCn: 'Period 9 里三个主要社会运动：① LGBTQ 平权运动，以 2015 年最高法院裁定同性婚姻全国合法为里程碑；② Black Lives Matter（BLM），2013 年发起，2020 年因 George Floyd 之死引发全美大规模抗议；③ #MeToo，2017 年在社交媒体广泛传播，揭露工作场所性骚扰。三者都是 CED 9.7 的直接考点，作历史对象研究，不站队。',
      defEn: 'Three major social movements of Period 9: ① The LGBTQ rights movement, with the 2015 Supreme Court ruling in Obergefell v. Hodges legalizing same-sex marriage nationwide as its milestone; ② Black Lives Matter (BLM), founded in 2013 and surging in 2020 after the death of George Floyd; ③ #MeToo, which spread widely on social media in 2017 to expose workplace sexual harassment. All three are direct CED 9.7 exam points, studied as historical subjects — no taking sides.',
      storyAnchor: {
        standaloneText: {
...
考点关键句：Obergefell 2015 + BLM 2013/2020 + #MeToo 2017 = CED 9.7 三考点；「公民社会压力 → 制度回应」变革路径。`,
          en: `These are the direct exam matches for CED 9.7 — three case studies of "where social change comes from" in Period 9. All are treated as **historical subjects** — no taking sides.
...
- This is a judicial milestone built up through decades of advocacy since the 1969 Stonewall uprising.

**② Black Lives Matter (BLM)**
- Founded in **2013** by Alicia Garza, Patrisse Cullors, and Opal Tometi, sparked by the Trayvon Martin case.
- In **2020**, the death of George Floyd triggered nationwide — and global — large-scale protests.
- CED explicitly lists BLM as a Period 9 exam point.

**③ #MeToo**
- Spread widely on social media in **2017**, surfacing workplace sexual harassment and assault, prompting policy changes in many institutions.

Shared structure of these movements — the analytical frame AP likes to test:
1. The advocacy path from margin to mainstream.
2. Social media as a mobilizing tool.
3. Historical resonance with and difference from the 1960s civil rights movement.

Key exam sentence: Obergefell 2015 + BLM 2013/2020 + #MeToo 2017 are three CED 9.7 exam points; they illustrate the change path of "civil society pressure → institutional response."`,
        },
        xiaoweiNote: {
...
What did each side give up, and what did each side gain, before you can say you've put both faces of the coin on the table?`,
      hintCn: `提示：这题没有标准答案，也**不是**让你判中美谁强谁弱。AP 看的是你能不能把「两半」并置。
...
高分写法：把两头并排（juxtaposition），承认各有代价与收获，而不是排出谁优谁劣。`,
      hintEn: `Hint: no standard answer, and this is **not** asking you to judge whether the US or China is stronger. AP looks at whether you can juxtapose the "two halves."
...
Support your judgment with specific evidence from this unit (deindustrialization, 2008, the opioid crisis, or the rising corridors' boom).`,
      hintCn: `提示：好的 DBQ 答案**同时持有两件事**，而不是二选一——这正是历史学界在争的。
- 「值得的进步」一边的证据：整体生活水准与技术前沿抬升、上行者搭上新经济、互联网/智能手机经济。
- 「不该抛下自己人」一边的证据：制造业岗位流失约 570 万、2008 冲掉退休账户、阿片危机约 56.5 万逝者。
两边用的常是同一组数据的不同切面。承认两边都有道理，再说明你为什么更倾向某一边——这叫 complexity，别替历史下最终道德结论。`,
      hintEn: `Hint: a strong DBQ answer **holds two things at once** rather than choosing one — exactly what historians argue over.
...
Both sides often use different slices of the same data. Acknowledge both have a point, then explain why you lean one way — that's complexity; don't hand history a final moral verdict.`,
    },
    {
...
Explain your reasoning, and avoid casting the war as either "purely right" or "purely wrong."`,
      hintCn: `提示：这是全 topic 党派分歧最深的一题，所以 Rule-0 最严——**不预设哪一方正确**。
- 先把事实层和评价层分开：「出兵理由（WMD）后来未被证实、引发争议」是**事实**；「这仗值不值」是**评价**。
- 支持出兵的人说：反恐、保护美国安全的延伸。反对的人说：战争太久、代价太重、理由有争议。两边都真实存在。
- 退伍军人两边都站过——他证明一个人可以同时看见意义与代价。
AP 要的是你能不能把两面都摆上桌，再谈你的权衡，而不是替历史选边。`,
      hintEn: `Hint: this is the highest-division question in the unit, so Rule-0 is strictest — **presume no side is right**.
...
- The veteran stood on both sides — he shows a person can see meaning and cost at once.
