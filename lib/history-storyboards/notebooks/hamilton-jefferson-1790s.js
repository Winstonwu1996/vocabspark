  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个我在 Lens 1（Hamilton）第 3、4 节读到了。重点拎出来：
...
split. On a test, be able to argue both sides.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ham-n4'],
        xiaoweiNote: {
          cn: `这个故事在 Lens 1 第 4 节那顿"晚饭"里讲过，但它有一个专门的 AP 名字我必须记牢：**Compromise of 1790**（1790 妥协案），也叫 "dinner table bargain"（晚餐桌交易）。
...
the key compromise" is safer.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ham-n5'],
        xiaoweiNote: {
          cn: `这是全 topic **最高频考点**——老师说 AP US Gov 几乎逐字考它。故事在 Lens 1 第 5 节讲过，我这里把考点框架拎出来（故事不重复）。
...
implied powers in 1791 → McCulloch stamps it in 1819."`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个我从两头都读到了——Lens 3（威士忌酒农 Tom）整条线 + Lens 1（Hamilton）第 6 节。两头拼起来才是完整考点。
...
careful framing：故事 Lens 1 第 6 节里 Hamilton 自己承认，13,000 大军真正的目的不是抓人，是"演给有钱债主看：这个政府收得上税、还得起债"。所以这既是"立国威"，也是"拿穷酒农给富人立威"——DBQ 两边都要写。`,
...
🔗 故事连接：Lens 1（Hamilton）第 7 节他自己点破这一点，并说 **1800 年大选 Jefferson 赢了总统**——这是美国历史上第一次政党轮替（"Revolution of 1800"，权力和平地从一党交到另一党手里）。
...
Federalists pro-British, Dem-Reps pro-French — remember "Republicans → France (both have an r)."`,
...

    {
      ...
      standaloneText: {
        cn: `这张卡故事完全没碰（三个 lens 都是国内财政线），但它是 1790 年代外交的 AP 必考缺口，我必须独立补。
...
section is complete.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 2 整条线就是他。这一卡考的是"建国话语的排除性"——AP DBQ 高频角度。
...
us?" question into America's conscience.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个老师特别强调——AP DBQ 一定考，而且三个 lens 在第 6/8 节都汇到了这一点。
...
三个 lens 其实在问同一个问题：**这个新国家，到底把谁算进"人人"里？**（Lens 1 Hamilton 把权力焊给富人和城市 / Lens 2 黑人被留在平等话语之外 / Lens 3 边疆穷农被甩在后面。）
