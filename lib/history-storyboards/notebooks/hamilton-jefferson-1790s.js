...
They're one causal chain. Don't memorize four things; see them as one thing."`,
    ...
    keyFigures: [
      ...
      },
      {
        ...
        roleCn: '首任总统，签署国家银行，1794 亲自随军出征至 Bedford 后交 Henry Lee 指挥镇压威士忌暴动',
...
the key compromise" is safer.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ham-n5'],
        xiaoweiNote: {
          cn: `这是整门课 **最高频考点**——老师说 AP US Gov 几乎逐字考它。故事在 视角一第 5 节讲过，我这里把考点框架拎出来（故事不重复）。
...
链条（这是这一课的核心因果链）：国家银行要运转 + 承债揽来的债要还利息 → 都要钱 → 1791 年 Hamilton 推 **excise tax（消费税）**，对国内蒸馏的威士忌征税（**新政府第一个对自己国内产品征的税**）→ 边疆酒农反抗 → 1794 **Whiskey Rebellion（威士忌暴动）**。
...
personally accompanying the army to Bedford (**the only time in U.S. history a sitting president
personally accompanied troops into the field**), then handing command to General Henry Lee before
returning to Philadelphia → the 7,000 scattered without a fight → about 20 stood trial, 2 were convicted of
...
**三大核心警告（AP 必背）：**
1. **警告党派之争（factions/parties）**：政党会把国家撕裂成地区对立，腐蚀共和政府。他亲眼看着联邦党 vs 民主共和党把 1790 年代弄成水火——这是他最深的担忧。
2. **警告永久同盟（permanent alliances）**：不要跟任何外国建立长期同盟，尤其是欧洲列强。新国家太弱，卷进别人的战争只有受害。（注：他说的是"不搞永久同盟"，不是"永不跟外国打交道"——商业往来可以。）
3. **警告地区主义（sectionalism）**：别让南北东西的地区利益压过全国利益。

**考点关键句：**
- 党派警告 → 对照 1790s Hamilton vs Jefferson 党争（他亲历）。
- 永久同盟警告 → 对照 Jay's Treaty 刚刚签完（1794-95），法美同盟争议还在烧。
- 这份演说后来被 19 世纪孤立主义者（isolationists）反复引用，成为"美国不干涉欧洲事务"的文本依据。

**careful framing：**
"永久同盟"警告不等于孤立主义——Washington 支持商业往来和短期外交合作，他反对的是把美国永久绑进欧洲的战争机器。写 essay 要区分这两层。`,
        en: `The story doesn't develop this card, but it is one of the **most frequently tested single points** in
APUSH Period 3.

In 1796 Washington decided not to run for a third term. He published his farewell as an open letter
(never read aloud from a podium — printed directly in newspapers): the **Farewell Address**. Hamilton
drafted most of it; Washington revised heavily before it was finalized.

**Three core warnings (AP must-memorize):**
1. **Factions/parties**: political parties will tear the country into regional antagonism and corrupt
   republican government. He had watched the Federalists vs Democratic-Republicans turn the 1790s
   into fire and ice — this was his deepest fear.
2. **Permanent alliances**: do not form long-term alliances with any foreign nation, especially
   European powers. The new nation was too weak; getting dragged into other countries' wars would only
   hurt it. (Note: he said "no permanent alliances," not "no foreign contact" — commerce is fine.)
3. **Sectionalism**: don't let regional interests (north/south/east/west) override the national interest.

**Key exam sentences:**
- Party warning → connect to the Hamilton vs Jefferson party split of the 1790s (he lived through it).
- Permanent-alliance warning → connect to Jay's Treaty just signed (1794-95), with the Franco-American
  alliance controversy still burning.
- This Address was repeatedly cited by 19th-century isolationists as the textual basis for "America
  stays out of Europe's affairs."

**Careful framing:** the "permanent alliance" warning is not the same as isolationism — Washington
supported commercial exchange and short-term diplomatic cooperation; what he opposed was permanently
binding America into Europe's war machinery. Essays must distinguish these two levels.`,
      },
      xiaoweiNote: {
        ...
        en: `Teacher's exact words: "Whenever a multiple-choice question mentions the Washington Farewell
Address, 80% of the time it tests 'warned against permanent alliances' or 'warned against political
parties' — memorize both." My memory anchor: **Farewell Address = three don'ts** — no parties, no
permanent alliances, no sectionalism. Time anchor: 1796, his term ends, Adams takes over.`,
      },
    },
...
**careful framing：** "Millions for defense, not one cent for tribute" 这句话很可能不是特使的原话，是后人整理版——选择题作为口号记，essay 里别当一手史料引。`,
        en: `The story doesn't touch this card (the story focuses on the Washington era; XYZ is already in
the Adams era), but it is a **high-frequency multiple-choice point** in APUSH Period 3.

Background: Jay's Treaty (1794-95) infuriated France — which saw America tilting toward Britain and
betraying the Franco-American alliance. France began seizing American merchant ships. In 1797 the new
president **John Adams (second president, Federalist)** sent three envoys to Paris to negotiate.

**The XYZ Affair (1797-98):**
Three anonymous intermediaries (coded X, Y, Z in the report) for French foreign minister Talleyrand
demanded a bribe from the American envoys: pay $250,000 first, then negotiate. The Americans refused
and reported back to Adams, who released the dispatches to Congress (keeping the agents anonymous),
triggering national outrage. The slogan **"Millions for defense, but not one cent for tribute!"**
went viral.

**What followed:**
The U.S. and France never formally declared war, but fought a two-year naval war in the Atlantic and
Caribbean — this period is called the **Quasi-War (1798-1800)**. It ended with the Convention of 1800
(Mortefontaine Treaty).

**Key exam sentences:**
- XYZ Affair → Adams's firm response → Federalist popularity surged (anti-French sentiment = Federalist
  political capital).
- But that same year Adams signed the **Alien and Sedition Acts (1798)**, which backfired on the
  Federalists — see the next card.
- The Quasi-War was America's first "undeclared war" and the first major occasion for the federal
  government to build up the navy (Naval Act of 1798, creating the U.S. Navy).

**Careful framing:** "Millions for defense, not one cent for tribute" is likely a later-polished version,
not verbatim — fine to cite as a slogan in multiple choice; don't use it as a primary source in an essay.`,
      },
      xiaoweiNote: {
        ...
        en: `My memory anchor for XYZ: **X, Y, Z = three mystery men who demanded a bribe** — and Americans
were so outraged they said "not one cent." Timeline: Jay's Treaty (1794-95) → France seizes ships →
XYZ (1797-98) → Quasi-War (1798-1800) → 1798 Alien and Sedition Acts (next card). This Adams-era
block is tested together.`,
      },
    },
...
- 核心主张：**nullification（无效化）**——各州有权宣布联邦法律违宪、在本州境内无效。理由：宪法是各州之间的契约（compact theory），若联邦违约，各州有权拒绝执行。
- 这是 **nullification 思想的第一次正式登场**，后来 Andrew Jackson vs 南卡罗来纳（1832-33 无效化危机）和内战前南方秩序都援引这个逻辑。

**考点关键句：**
1. Alien & Sedition Acts = 联邦党借战时情绪打压政治异见，**直接引发 1800 年大选 Jefferson 反弹胜出**（"Revolution of 1800"）。
2. Virginia/Kentucky Resolutions = **nullification 思想源头**，日后成为州权 vs 联邦权争论的核武器。
3. 两者合看：联邦权越大→反弹越强→州权主张越尖锐——这是 1790s 到内战的一条持续断层线。

**careful framing：**
- Jefferson/Madison 起草决议时是匿名的（政治风险太高）——历史才知是他们写的。
- 决议本身没有真正推翻这些法律（没有任何法院支持），但作为政治宣言效果强大——逼联邦党在 1800 年大选中落败。`,
        en: `This is the **highest-frequency APUSH exam point** in the 1795-1800 segment, and the sharpest
moment of "federal power vs states' rights" in all of Period 3.

**Background:** The XYZ Affair (1797-98) sent anti-French sentiment surging; the Federalist-controlled
Congress seized the moment to legislate against their opponents.
...
- **Sedition Act**: publishing "false, scandalous, or malicious" criticism of the government or
  president carried up to 2 years' imprisonment plus a fine.

Practical effect: **targeted Democratic-Republican newspapers and editors** — editors were prosecuted
for criticizing Adams. Under cover of "wartime security," the Federalists used law to suppress political
dissent. This was the first federal legislation in U.S. history to directly challenge the First Amendment
(free speech).

**The Democratic-Republican counterattack — Virginia and Kentucky Resolutions (1798-99):**
- **Madison** drafted the Virginia version; **Jefferson** anonymously drafted the Kentucky version
  (both Democratic-Republicans).
- Core claim: **nullification** — states have the right to declare a federal law unconstitutional and
  void within their borders. Rationale: the Constitution is a compact among states (compact theory); if
  the federal government breaks the compact, states may refuse to comply.
- This was **nullification's first formal appearance**. Andrew Jackson vs. South Carolina (the
  Nullification Crisis, 1832-33) and the pre-Civil War South would both cite this logic.

**Key exam sentences:**
1. Alien & Sedition Acts = Federalists using wartime sentiment to crush political dissent, **directly
   fueling Jefferson's landslide win in the election of 1800** (the "Revolution of 1800").
2. Virginia/Kentucky Resolutions = **the origin of nullification doctrine**, later weaponized in
   states' rights vs. federal power battles all the way to the Civil War.
3. Read together: the larger federal power grew → the stronger the backlash → the sharper the
   states'-rights claims — a continuous fault line from the 1790s to the Civil War.

**Careful framing:**
- Jefferson and Madison drafted the resolutions anonymously (the political risk was too high) — only
  later did history establish their authorship.
- The resolutions never actually overturned the laws (no court upheld them), but as political
  manifestos they were enormously powerful — helping drive the Federalists out of office in 1800.`,
      },
      xiaoweiNote: {
        ...
        en: `Teacher called this "the final boss exam point" of Period 3 — Alien & Sedition Acts plus the
Virginia/Kentucky Resolutions appear on almost every exam. My memory chain: **XYZ → anti-French
feeling → Federalists pass Alien & Sedition Acts → Jefferson/Madison counter with resolutions →
nullification is born → Jefferson wins 1800**. That five-step sequence covers the entire end of
Period 3 in one sweep. Don't merge the Sedition Act and Alien Act into one — multiple choice will
