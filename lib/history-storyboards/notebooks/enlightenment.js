...
I wrote that on the first page of my notebook.`,
    ...
    keyFigures: [
      ...
      'Jean-Jacques Rousseau', 'Olympe de Gouges', 'Toussaint Louverture',
    ],
  },
  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个我读过！在 Lens 1 第 6 节，Voltaire 帮一个叫 Jean Calas 的人——
...
Lens 1 第 4 节有提到他在伦敦的笔记本上写"原来政府可以不是上帝任命的"。`,
...
the answer is Rousseau, not Locke. Locke influenced the moderate American faction more.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `她在 Lens 2 整条线讲到了。1791 年《女权宣言》，1793 年被砍头。
