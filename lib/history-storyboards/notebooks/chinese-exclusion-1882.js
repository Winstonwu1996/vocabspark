...
//
// schemaVersion: 1 · notebookVersion: chinese-exclusion-1882-v2
...
Honestly, reading the Taishan worker's story made me think of myself. That I can read this history in both Chinese and English is something those people back then never dared to imagine. I won't cry over it — I'll get it down clearly. That's what I can do for them.`,
    keyTerms: [
    ...
    keyFigures: [
      ...
      },
      {
        ...
        ipa: '/ˈdɛnɪs ˈkɑːrni/',
        roleCn: '加州工人领袖，排华口号「The Chinese must go!」——APUSH 考排外主义时的代表人物',
        roleEn: 'California labor leader known for the exclusion slogan "The Chinese must go!" — a key APUSH figure for nativism',
        mustKnow: true,
        audioKey: null,
      },
      {
        ...
        roleCn: '黑人废奴领袖（跨课人物），同代用同一份独立宣言质问美国对黑人的不平等',
        roleEn: 'Black abolitionist leader (cross-topic figure) who, in the same era, used the same Declaration of Independence to question America\'s inequality toward Black people',
        mustKnow: false,
        audioKey: null,
      },
    ],
  ...
  mainConcepts: [
    {
      ...
      defCn: '横贯大陆铁路是 1869 年建成、把美国东西海岸连起来的铁路。西半段最危险的工程，是上万名来自广东台山的华工用手凿出来的。',
      defEn: 'The transcontinental railroad, completed in 1869, linked America\'s east and west coasts. The western half\'s most dangerous work was dug out by tens of thousands of Chinese workers from Taishan, Guangdong.',
...
要点（考试一定考）：
1. 1862 年林肯政府《太平洋铁路法案》（Pacific Railway Act）授权修横贯大陆铁路，按修建里程给土地和补贴——所以公司只想一个字："快"。
2. 两段竞赛：东段联合太平洋（Union Pacific）从内布拉斯加西修，西段中央太平洋（Central Pacific，Stanford 等"四巨头"）从加州东修。
3. 1865 年中央太平洋先试 50 个华工，成功后大量招——工程最忙时约 90%（十个有九个）是华工，上万人。
4. 西半段穿过内华达山脉（Sierra Nevada）的花岗岩。最难的是峰顶隧道（Summit Tunnel）。华工吊在悬崖篮子里放炸药（nitroglycerin，就是硝化甘油，极不稳定）。1866-67 两冬死得最多，雪崩埋掉整营。
5. 死亡人数从没被官方统计过（估计几百到上千）——账本上没单独列他们。

⚠️ 两个容易写错的地方：
1. Crocker 那句"能修长城的民族还修不了铁路"是后世广为流传的概括/传说，不是逐字一手引文——写 essay 可以说"据说他说过"，别当确证引文。
2. 1869 年 4 月"一天铺 10 英里"的纪录：那天实际抬轨上道的 8 个人是爱尔兰铺轨工，华工是更大基数的主力供料和铺设。准确说法是"以华工为主力、与爱尔兰铺轨工一起"创下纪录，不要写成"华工独自创下"。
...
1. The 1862 Pacific Railway Act (Lincoln's government) authorized the transcontinental railroad, paying land and subsidies by the mile — so the companies wanted only one thing: "speed."
2. Two-section race: from the east, the Union Pacific built west from Nebraska; from the west, the Central Pacific (Stanford's "Big Four") built east from California.
3. In 1865 the Central Pacific tried 50 Chinese workers first, then hired in great numbers — at the busiest point about 90% (nine out of ten) of the workers were Chinese, over ten thousand men.
4. The western half crossed the granite of the Sierra Nevada. The hardest part was the Summit Tunnel. Chinese workers hung in baskets off cliffs to set charges (nitroglycerin — highly unstable). The winters of 1866-67 killed the most; avalanches buried whole camps.
5. The death toll was never officially counted (estimates: hundreds to over a thousand) — they had no separate column in the ledger.

⚠️ Two things people get wrong:
1. Crocker's line "a people who could build the Great Wall could surely build a railroad" is a widely-circulated later paraphrase, not a word-for-word source. In an essay say "he is said to have said," don't cite it as a verified quote.
2. The April 1869 "ten miles in a day" record: the 8 men who laid the rail that day were Irish track-layers; the Chinese were the larger workforce supplying and building. The accurate phrasing is "set by a Chinese-majority crew working with Irish track-layers," not "set by the Chinese alone."
...
**Key exam sentence: The transcontinental railroad joined America's east and west coasts and was a landmark of Gilded Age industrialization. Its western half was carved out by Chinese workers with their lives.**`,
...

    {
      ...
      defCn: '排华法案是 1882 年美国国会通过的联邦法律，也是美国历史上第一部按种族/国籍禁止移民的法律。它做了两件事：禁止华人劳工入境，同时永久禁止已在美华人归化成为公民。',
      defEn: 'The Chinese Exclusion Act, passed by Congress in 1882, was the first U.S. federal law to bar immigration by race or nationality. It did two things: barred Chinese laborers from entering the country, and permanently barred Chinese people already in America from becoming citizens.',
...
2. 明确禁止已经在美国的华人归化（naturalization，就是通过法律程序成为公民）——这一条是把人永远钉在"外国人"身份上。

为什么是第二条最狠？读台山华工那条故事线才真懂：他可以在美国干一辈子活、纳一辈子税、变老、死在这里，但永远不算"美国人"，没有投票权，还不能把妻子孩子接来团聚——一个家被法律拆成两半。

⚠️ 清坑（老师特别强调）：很多人以为"排华法案只是限制移民"——错。它不止限制入境，更**永久禁止归化**。这两层一定要分开写，少写第二层会丢分。
...
**Key exam sentence (memorize it): The Chinese Exclusion Act was the first U.S. federal law to bar immigration by race or nationality.**
...
2. Plainly barred Chinese already in America from naturalization — which means going through the legal process to become a citizen. This clause nailed people forever to "foreigner" status.

Why is the second clause the harshest? Reading the Taishan worker's story made it real: he could work a whole life in America, pay taxes his whole life, grow old, and die here — yet never count as "American," never vote, and never bring his wife and children to reunite. A family torn in two by law.
...
DBQ angle: A country that proclaims "all men are created equal" and "the land of opportunity" shut, in black and white by skin and bloodline, an entire people out the door for the first time — and the people shut out were the very ones who built its east-west artery. That irony is the gold thesis for an essay.`,
...

    {
      ...
      defCn: '排华不是一道法律，是从 1882 到 1943 年、整整 61 年的一串越收越紧的法律。1882 年起禁止华工入境，1888 年撕掉已发的返美证件，1892 年再延长并强制华人随身带身份证件，直到 1943 年才废除。',
      defEn: 'Chinese exclusion was not one law but a string of laws that tightened over 61 years, from 1882 to 1943. It started by banning Chinese laborers from entering, then in 1888 voided lawful re-entry papers, in 1892 extended exclusion and forced Chinese to carry ID cards at all times, and was not repealed until 1943.',
      standardRef: ['APUSH Period 6 (CED 6.7)', 'CA HSS 8.12'],
      examFrequency: 'high',
      storyAnchor: {
        covered: false,
        mentionedIn: [
          ...
          { lens: 'taishan-railroad-worker', nodeId: 'tw-n9', context: '台山华工到死没等到 1943 法案废除' },
        ],
      },
      standaloneText: {
...
- **1892 Geary Act（吉尔里法案）**：把排华再延长 10 年，还加了一条侮辱性规定——华人必须随身携带居留证件（一种内部"身份证"）。随时准备被盘查。白人不用带，只有华人要带。

- **1943 Magnuson Act（马格努森法案）**：废除排华法案。从 1882 到 1943，整整 **61 年**。废除的背景是二战——中国成了美国对抗日本的盟友，继续公开排华很难看，所以才松口（但每年只给华人 105 个移民名额，象征意义大于实际）。

🔗 长尾提醒：排华法案是后来一系列制度性反亚裔措施的开头——1924 年排日、二战日裔被关进拘留营（如 Manzanar）。这一串提醒我们："机会之地"的承诺，对亚裔是一次次被打折的。

🔗 故事连接：王清福那条故事线里，他拼命想阻止这部法律，没成功。台山华工那条故事线里，华工到死顶着"外国人"三个字，没等到 1943。`,
...
- **1892 Geary Act**: extended exclusion another 10 years and added a humiliating rule — the Chinese had to carry residence certificates (a kind of internal ID card) at all times, ready to prove they were "lawful." White people did not have to carry them; only the Chinese did.
...
🔗 Long-tail reminder: the Exclusion Act was the first in a series of institutional anti-Asian measures — Japanese exclusion in 1924, the WWII internment of Japanese Americans (e.g., Manzanar). The chain reminds us the promise of "the land of opportunity" was discounted, again and again, for Asians.

🔗 In Wong Chin Foo's story, he tried desperately to stop this law and failed. In the Taishan worker's story, the worker wore the words "foreigner" until death, never living to see 1943.`,
      },
      xiaoweiNote: {
...
The point that loses the most marks: many think "the Exclusion Act was repealed quickly" — wrong, a full 61 years, tightening the whole way. Also, the 1943 repeal happened because China was a WWII ally, not because America suddenly turned kind — always make the motive clear.`,
...

    {
      ...
      defCn: '排外主义（nativism）是"优待本土出生者、敌视移民"的政治立场，在经济不景气时最凶。黄祸（Yellow Peril）是当时把华人妖魔化为"会吞掉白人世界的瘟疫"的种族主义话语，常见于报纸政治漫画。',
      defEn: 'Nativism is a political stance that favors the native-born and is hostile to immigrants — it peaks in economic downturns. Yellow Peril was the racist idea, common in newspaper cartoons, that Chinese people were a "plague that would swallow the white world."',
      standardRef: ['APUSH Period 6 (CED 6.7)', 'CA HSS 8.12'],
      examFrequency: 'high',
      storyAnchor: {
        covered: true,
        ...
        xiaoweiNote: {
          cn: `这个词组（nativism + Yellow Peril）三条故事线都碰到了。台山华工那条线和王清福那条线讲得最直接。
...
读台山华工那条故事线最有感的一点：同一群人，在几年间从"功臣"变成"罪人"。修最险最累的活时没人愿意干，是华工顶上去的。1870 年代加州经济萧条、白人失业了，反倒说是华工"抢"走了工作。"需要你时是能修长城的好劳力，不需要你时是抢饭碗的黄祸"——这句话是这张卡的灵魂。
...
**考点机制链：经济萧条 → nativism 找替罪羊 → 报纸 Yellow Peril 妖魔化 → 街头暴力 → 政客算选票（华人不能投票）→ 把民粹写成法律（1882）。这条因果链是 essay 的骨架。**`,
          en: `This pair of terms (nativism + Yellow Peril) shows up in all three story lines. The Taishan worker's story and Wong Chin Foo's story are the most direct.

Definitions (be able to write these):
- **nativism**: a political stance favoring the native-born and hostile to immigrants. It's fiercest in economic downturns — because people need somewhere to direct their anger.
...
What hit me most in the Taishan worker's story: the same people went from "heroes" to "criminals" in a few years. When the most dangerous, exhausting work had no takers, the Chinese stepped up. When California's economy slumped in the 1870s and white workers lost jobs, suddenly it was said the Chinese "stole" them. "When you're needed, you're good labor that can build the Great Wall; when you're not, you're the yellow peril stealing the rice bowl" — that line is the soul of this card.
...
**Causal chain to remember: economic slump → nativism seeks a scapegoat → newspapers' Yellow Peril demonization → street violence → politicians do the vote math (the Chinese can't vote) → write the populism into law (1882). That chain is the skeleton of an essay.**`,
...

    {
      ...
      defCn: '推拉因素（push-pull factors）是分析人为什么离开一个地方、去到另一个地方的工具。推力（push factor）是把人"推"出家乡的负面原因，拉力（pull factor）是把人"拉"向目的地的正面吸引。',
      defEn: 'Push-pull factors is a framework for explaining why people move from one place to another. A push factor is a negative reason that drives people away from home; a pull factor is a positive attraction that draws people toward a destination.',
      standardRef: ['APUSH Period 6 (CED 6.5)', 'CA HSS 8.12'],
      examFrequency: 'mid',
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'taishan-railroad-worker', nodeId: 'tw-n2', context: '台山华工讲到自己为什么离乡：山多田少、揭不开锅、"要活命就得往外走"' },
          { lens: 'leland-stanford', nodeId: 'ls-n3', context: 'Stanford 提到加州 1850s 淘金潮把广东华工引来' },
        ],
      },
      standaloneText: {
        cn: `台山华工那条故事线里讲了他"为什么离开家"，但没有用历史课的术语框起来。这里补上 push-pull（推拉因素）这个分析工具——APUSH 考移民时几乎一定会要你用它。
...
⚠️ 清坑：不要把华工写成"被骗来的奴隶（卖猪仔）"。多数台山华工是为养家自愿签契约的契约劳工（虽然契约常不公、负债束缚强）——契约劳工不等于跨大西洋奴隶贸易。两者都残酷，但机制不同，不能混为一谈。这是 essay 容易踩的雷。`,
        en: `The Taishan worker's story explains "why he left home," but doesn't frame it in history-class terms. Here's the push-pull analysis tool — APUSH almost always wants you to use it on immigration questions.

**Push-pull factors**: a framework explaining why people move from one place to another.
- **Push factor**: a negative reason that drives people out of their home.
- **Pull factor**: a positive attraction that draws people toward a destination.

Applied to the Taishan worker:

**Push (China side / Taishan, Guangdong)**:
- Geography: Taishan by the sea, many hills and little field — a family could not divide more than a few acres.
- Economy: a bad year meant hunger; the family could not lift the lid off the rice pot.
- Social tradition: the Guangdong overseas-village tradition of going abroad for a living ran deep — "to live, you must go outward" wasn't new in the 1860s; it was how generations of this southern land lived.

**Pull (America side / California "Gold Mountain")**:
- The 1849 California gold rush; Chinese workers called California "Gold Mountain."
- 1860s Central Pacific recruitment, with wages that were an "astronomical sum" to Taishan eyes.

⚠️ Clear the trap: don't write the workers as "enslaved people tricked into coming." Most Taishan workers were contract laborers who signed willingly to support their families (though the contracts were often unfair and the debt binding strong) — contract labor is not the same as the transatlantic slave trade. Both were cruel, but the mechanisms differ; don't conflate them. This is a common essay mistake.`,
      },
      xiaoweiNote: {
...
Reading this section I thought of something: among those who left Taishan a century ago, there might be a great-grandparent of some Chinese American family's branch. These aren't distant strangers — this is the first chapter of "why we're in America" for many Chinese families.`,
      },
    },

    {
      ...
      defCn: '天使岛移民站（Angel Island Immigration Station）是旧金山湾一个小岛上、1910-1940 年运营的移民检查站，专门用来拦截、关押、审问亚洲移民——尤其是试图绕过排华法案进入美国的华人。',
      defEn: 'Angel Island Immigration Station was an inspection station on a small island in San Francisco Bay, operating 1910-1940. Its main function was to intercept, detain, and interrogate Asian immigrants — especially Chinese people trying to enter despite the Exclusion Act.',
      standardRef: ['APUSH Period 6 (CED 6.7)', 'CA HSS 8.12'],
      examFrequency: 'mid',
      storyAnchor: {
        covered: false,
...
为什么需要它？排华法案禁华工入境，但有几类华人法律上还能进（比如美国出生的华人的子女）。于是想进来的华人要在天使岛被关押、反复盘问，证明自己"够格"——一关常常是几周到几个月，有的甚至一两年。盘问极细（你村里第几间房朝哪开、你家门槛多高），目的就是挑出"假身份"，把人挡回去。

**纸生仔（paper sons）**：1906 年旧金山大地震烧毁了出生记录，一些华人借机声称自己是"美国公民的儿子"（公民的子女可入境），买来假身份文件入境——这就是"paper sons / 纸生仔"。天使岛的残酷盘问，正是针对这种钻法律缝隙的防堵。

**墙上的诗**：被关押的华人在天使岛木屋的墙上，用中文刻下了大量诗——写思乡、写屈辱、写不甘。这些诗今天还在，是排华历史最动人的一手史料（primary source，就是当时人留下的直接证据）之一，也是 DBQ 常用的材料。

🔗 它把抽象的"排华法案"变成了具体的画面——一个人被关在岛上几个月、对着墙刻诗。这就是法律落到一个个真人身上的样子。`,
        en: `The story doesn't cover this at all (it mostly stops at 1882-1898), but it's living evidence of how the Exclusion Act was enforced. California HSS loves to test it, so I'm adding a separate card.
...
Why was it needed? The Exclusion Act barred Chinese laborers, but a few categories of Chinese could still legally enter (such as the children of American-born Chinese). So Chinese trying to enter were detained at Angel Island, interrogated over and over to prove they "qualified" — a stay often ran weeks to months, sometimes a year or two. The questioning was extremely detailed (which way does the third house in your village face, how high is your doorstep) to catch "false identities" and turn people back.
...
**Poems on the walls**: detained Chinese carved many poems in Chinese into the walls of Angel Island's barracks — about homesickness, humiliation, defiance. These poems survive today, one of the most moving primary sources — meaning direct evidence left by people who were there — of exclusion history. They're common DBQ material.

🔗 Angel Island turns the abstract "Exclusion Act" into a concrete image: a person held on an island for months, carving poems into the wall. That is what a law looks like when it lands on real individuals one by one.`,
      },
      xiaoweiNote: {
...
What I remember best are the poems on the walls — those people, held there with nothing else to do, carved into the wall "I was here too, I am a person too." That's the same thing Wong Chin Foo did with a newspaper and the Taishan worker did with his strength, just a third way: with poems.`,
...

    {
      ...
      defCn: '王清福（Wong Chin Foo）是 1847 年生于山东的记者和民权活动家。他 1883 年在纽约创办《华洋新报》（The Chinese American），造出"Chinese American（华裔美国人）"这个词，主张华人可以同时是华人也是美国人。',
      defEn: 'Wong Chin Foo was a journalist and civil rights activist born in Shandong in 1847. In 1883 he founded The Chinese American newspaper in New York and coined the term "Chinese American," arguing that a person could be both Chinese and American at the same time.',
      standardRef: ['APUSH Period 6 (CED 6.7)', 'CA HSS 8.12'],
      examFrequency: 'mid',
      storyAnchor: {
        covered: true,
        ...
        xiaoweiNote: {
          cn: `王清福那整条故事线就是他，我读完特别想把他记住——因为他争的那个名字，今天落在我身上。

要点：
- 王清福，1847 年生于山东，少年被美国传教士带到美国受完整西式教育，英文比很多土生白人还漂亮——这给了他别的华工没有的武器：用美国人自己的语言讲道理。
...
- 他的核心打法：把独立宣言"人人生而平等"原样印在报上，反问——"人人"里包不包括华人？这叫"用对方自己写的话对准对方"。
...
🔗 跨课连接：王清福用独立宣言反问美国，和黑人领袖 Frederick Douglass（同代）用同一份独立宣言质问"黑人算不算'人人'"是同一套打法——少数族裔用美国自己写下、却没兑现的承诺，对准写它的人。

**考点关键句：王清福活着时几乎输掉每一场具体的仗（法案没废、死后被遗忘），但他造的"Chinese American"这个词活到今天，成了几百万人理直气壮的自我称呼。**`,
          en: `Wong Chin Foo's whole story is about him, and after reading it I really wanted to remember him — because the name he fought for has come to rest on me.

Key points:
- Wong Chin Foo, born 1847 in Shandong, was taken to America as a youth by missionaries and fully Western-educated. He spoke English more elegantly than many native-born whites — giving him a weapon other Chinese workers lacked: reasoning with Americans in their own language.
...
- His core move: print the Declaration's "all men are created equal" exactly as it was, then ask back — do the "all" include the Chinese? This is "using the other side's own words against them."
- In 1887 he publicly challenged exclusion leader Denis Kearney to a debate.

⚠️ Clear the trap + fact reminders:
...
🔗 Cross-topic connection: Wong using the Declaration to question America is the same move as Black leader Frederick Douglass (same era) using the same Declaration to ask "do Black people count among the 'all'" — minority groups aiming America's own unkept promise back at those who wrote it.
...
**Key exam sentence: Wong Chin Foo lost nearly every concrete fight while alive (the act wasn't repealed, he was forgotten after death), but the term he coined, "Chinese American," lives today as the self-name millions claim with heads held high.**`,
...

    {
      ...
      defCn: '"先利用、再排斥"是这门课的核心矛盾：美国先用上万华工的命修起横贯大陆铁路，建完之后又立法按种族把他们关在公民权外。同一双手——既建起了国家，又被这个国家排斥。这是 AP DBQ essay 的核心论点骨架。',
      defEn: '"Use-then-exclude" is the core contradiction of this topic: America first used the lives of tens of thousands of Chinese workers to build the transcontinental railroad, then passed a law barring them from citizenship by race. The same hands that built the nation were excluded by it. This is the central thesis framework for AP DBQ essays on this topic.',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是把整门课串起来的那个核心矛盾，三条故事线都指向它——老师说这是 DBQ 的"主论点骨架"。

矛盾是什么：一个标榜"人人生而平等""机会之地"的国家，先用上万华工的命修起东西大动脉，建完之后又立法把他们按种族关在公民权外。同一双手——既建起国家，也排斥建国家的人。

故事里的三个证据点：
- Stanford 那条故事线里：1862 年当加州州长时，他在给立法机关的咨文里公开称华人"劣等种族"。三年后 1865 年他的公司又大量招华工——嘴上说"劣等"，账本上靠华人发家。排华浪潮起，连靠华工发家的他也没替没有选票的他们说话。
- 台山华工那条故事线里："需要你时是能修长城的好劳力，不需要你时是抢饭碗的黄祸。"
- 王清福那条故事线里：他用独立宣言"人人平等"反问——这句话白人写它时没打算算上华人。

⚠️ 事实提醒：Stanford"劣等种族"那句的场合，是他 1862 年当州长时**致立法机关的咨文**，不是"就职演说"——写 essay 别写成就职演说。措辞本身（"劣等种族"）是真史料。
...
4. 结论：这不是"成就 + 污点"两件事，是同一套逻辑的两面——"把人当可用劳力"既修得成铁路，也排得掉人。"机会之地"是一个对某些人没兑现的承诺。`,
          en: `This is the core contradiction that ties the whole topic together — all three story lines point to it, and teacher said it's the "thesis skeleton" of a DBQ.

The contradiction: a country proclaiming "all men are created equal" and "the land of opportunity" first used the lives of ten thousand-plus Chinese workers to build its east-west artery, then passed a law barring them from citizenship by race. The same hands — building the nation, and being excluded by it.

Three evidence points from the stories:
- In Stanford's story: as California governor in 1862, in a message to the legislature, he publicly called the Chinese an "inferior race." Three years later in 1865 his company hired Chinese workers in great numbers — calling them "inferior" with his mouth, building his fortune on them in his ledger. When the exclusion tide rose, even a man who got rich off Chinese labor did not speak for people with no votes.
- In the Taishan worker's story: "when you're needed, you're good labor that can build the Great Wall; when you're not, you're the yellow peril stealing the rice bowl."
- In Wong Chin Foo's story: he used the Declaration's "all men are equal" to ask back — a line white men did not mean to include the Chinese when they wrote it.

⚠️ Fact reminder: the setting of Stanford's "inferior race" line was his 1862 **message to the legislature** as governor, not an "inaugural address" — don't write it as an inaugural address in an essay. The wording itself ("inferior race") is genuine source material.
...
4. Conclusion: this isn't "achievement + a stain," two separate things — it's two faces of one logic. "Treating people as usable labor" can build a railroad and exclude people too. "The land of opportunity" is a promise unkept for some.`,
        },
      },
    },
  ],
...
Do you think "calling them inferior with his mouth while relying on them in his ledger" is a contradiction? If Stanford were sitting in front of you, how might he try to explain himself?`,
      hintCn: `提示：可以从两个角度想——
① Stanford 心里可能根本没把华人当作"完整的人"。他要的只是劳力，"劣等"和"好用"在他脑子里不冲突。
② 或者他知道这是矛盾，但资本逻辑（要快、要赢、要钱）压过了一切。没选票的人在他的政治账本上不值得他冒险。
两种解读都站得住。

进阶思考：今天有没有类似的事——某个群体"被需要的时候很受欢迎，不被需要的时候就被推开"？这种逻辑是某个坏人的问题，还是一套制度的问题？`,
      hintEn: `Hint: think from two angles —
① Stanford may not have regarded the Chinese as "full people" at all. He wanted only labor, and "inferior" and "useful" did not clash in his mind.
② Or he knew it was a contradiction, but capital's logic (speed, winning, money) overrode everything. People with no votes weren't worth a risk in his political ledger.
Both interpretations stand.
...
如果这个华工能开口，他会怎么追问写下"人人平等"的那个国家？被排斥的人捡起美国自己写的承诺、对准写它的人——这是最聪明的武器，还是因为他们根本没有别的武器？`,
      en: `The U.S. Declaration of Independence (1776) wrote "all men are created equal." The Taishan worker built this country's east-west artery with his life, yet was shut out of the "all" by race under the 1882 Chinese Exclusion Act — he worked a whole life, paid taxes his whole life, and never counted as "American" until death.
