...
export var notebook = {
  ...
  preview: {
    cn: `这一课有点特别——我们中文家庭很多人没听过它。我妈说"四大文明古国"里都没有以色列，
...
- **史料分层**（这一课老师反复强调）：焚圣殿在圣经《列王纪下》25 章有记载（primary，
...
all in the same year.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `视角一整条线就是他。我读完发现他不是个只会破坏的莽夫，这点考试会绕——
他其实是个**大建设者**。
...
Judah did it accidentally fail (why it failed: see the "diaspora" card later).`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是这一课的名字本身，必考。三条线都在讲它，少年那条（默认视角）最贴。
...
one-time enslavement of an entire people.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `视角二整条线是他。我得先把"先知"这个词搞清楚——这是个超容易答错的考点。
...
argument saved a nation that had lost its state.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是整门课的核心、老师说"AP 一定考、DBQ 高频"的那张卡。三条线的第 6 节
（少年是第 5+6 节）讲的是同一个"带不带得走的家"——这是跨视角的核心 micro-detail。
...
🔗 跨课：这条离散线一直延续到一千八百多年后——黑死病那段历史里 Strasbourg
...
**为什么这一课是 AP World 的"根"**：古以色列的一神教 + 希伯来圣经，是后来
...
can cite (independent of the Bible) — remember it.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是默认视角（少年）整条线的灵魂——他这个合成人物，**就是照着《诗篇》137 篇
...
- **结尾的复仇诗句**：这首诗结尾几节有极其激烈的诅咒巴比伦的语句，是被掳者真实创伤与愤怒
  的表达；课堂上**通常只读前半段"坐下哭泣"的部分**，这一课也不展开结尾。
