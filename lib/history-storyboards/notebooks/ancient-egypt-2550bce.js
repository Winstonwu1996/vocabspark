...
跨 Topic 提醒：老师说后世一切「统治者宣称自己代表或连接神」的制度，源头都能追到这种把
权力和神圣绑在一起的逻辑。`,
...
工程数字必背：约 230 万块石头，每块两三吨，原高约 146 米。没有起重机、没有铁工具，全靠铜凿、
石锤、木雪橇、绳索、斜坡和庞大的人力组织。它建成时是当时地球上最大的人造物，4500 年后还立着，
是古代七大奇迹里唯一基本保存下来的。
...
Must-memorize engineering numbers: some 2.3 million stones, two or three tonnes each, originally
about 146 meters high. No cranes, no iron tools, all done with copper chisels, stone hammers,
wooden sledges, ropes, ramps, and vast human organization. When finished it was the largest
man-made thing on earth, still standing 4,500 years later, the only one of the seven ancient
wonders to survive largely intact.
...
stripped for other uses thousands of years later).`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是整个 Topic 最重要的一张卡，劳工那一遍第 1、3、5 节全在破这个坑。
...
scoring rewards.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Hemiunu 那一遍第 2、3 节让我从「中间那一层」看清了整个社会的样子。这个 Topic 有个
