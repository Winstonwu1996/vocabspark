  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个在视角一里读到了。Siena 在 1348 年——城里 60-80% 的人死掉了。
...
Why did so many die? The concept card on "transmission" below explains.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `视角一里描写了 Siena 的社会秩序崩塌：医生不知道怎么治，神父不敢去临终祈祷，
家人抛弃病人，邻居彼此不敢接触。
...
trust the Church?). This planted the seeds for the Renaissance and the Reformation.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `视角二就是这个。1349 年 2 月 14 日，Strasbourg（斯特拉斯堡）——
...
an inexplicable disaster, social fear often converts into violence against minorities.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `视角三是 Devorah 的视角——14 岁，Strasbourg 犹太女孩，虚构人物，
...
- Columbus's 1492 arrival in the Americas opened Atlantic trade — but also brought
  Old World diseases (including smallpox from about 1518 onward), contributing to a roughly 90% population decline among Indigenous Americans over about two centuries;
