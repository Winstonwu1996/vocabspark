...
它是这一课的"发令枪"——后面所有事（最高法院的官司、New Echota 条约、Trail of Tears）
都是从这一部法律滚下来的。
...
land, then who did 'civilization' actually protect?"`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是这一课最重要的"思维方式"考点，三条线在结尾都汇到这里。老师说 AP DBQ 一定用。
...
Rule 0 守则：不可说「美国比清朝更野蛮」或「清朝边疆治理更文明」——两套体系各有强制与暴力，也各有其历史语境。
...
The U.S. was managing its indigenous peoples through "treaty + forced removal + reservation." The Qing's integration of frontier ethnic groups in the same period ran on a different institutional logic: the tribute system, "loose rein" (jimmi), and the gaitu guiliu (converting chieftain territories to direct administration). Both systems operated in this same decade, unknown to each other, yet both involved the central state imposing authority over local ethnic groups by force.

Rule 0 note: don't conclude "the U.S. was more barbaric than the Qing" or "Qing frontier governance was more civilized" — each system had its own coercions, violence, and historical context.
