...
🔗 故事连接：Quatie 在 Lens 1 第 3 节亲口拆穿这套话术。Jackson 在 Lens 3 第 4 节
...
"voluntary" or "exchange," first ask: who is standing at whose door?`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个 John Ross 在 Lens 2 整条线讲透了。我把考点压缩成三句：
...
这句名言是**后人编的**（Jackson 死后约 20 年才出现），不是他真说过的。Lens 2 第 7 节
和 Lens 3 第 6 节都拆穿了它。考试别把它当 Jackson 的真实引语写。`,
...
（Lens 3 第 7 节，Jackson 自己用"我把石头推下了山"来认这个责任。）
...
出自一个士兵事后约 52 年（1890 年代）写的信，没有别的证据。Lens 1 第 5 节里 Quatie 自己
...
thousand deaths needs no touching little story to count for more.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Jackson 在 Lens 3 第 3 节亲口讲了这个。考点提炼：
...
Carolina, state against Georgia** — same man, two faces, because the interests differed.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['quatie-n2'],
        xiaoweiNote: {
          cn: `Quatie 在 Lens 1 第 2 节、John Ross 在 Lens 2 第 3 节都讲到了。考点钉死：
