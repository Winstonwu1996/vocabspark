...
//
// schemaVersion: 1 · notebookVersion: decolonization-1960-v2
...
export var notebook = {
  ...
  preview: {
    cn: `这单元学的是去殖民化（Decolonization）——从大约 1947 年到 1975 年，
几百年的欧洲殖民帝国一个接一个散掉，几十个新国家诞生。AP World 把它放在 Unit 8，老师说这是必考单元。
...
但你要会问：这场自由，是谁赢的？又是谁付的账？"`,
    en: `This unit is about Decolonization — from roughly 1947 to 1975, centuries of European
colonial empires broke apart one after another, with dozens of new nations born.
  ...
  mainConcepts: [
    {
      ...
      defCn: '1947 年英国撤出印度时，把印度切成两个国家：印度（印度教为主）和巴基斯坦（伊斯兰教为主）。这次"切割"叫分治（Partition），引发了人类历史上最大规模的人口迁徙之一，也造成了大量死亡。',
      defEn: 'In 1947, Britain split India into two countries as it withdrew: India (mostly Hindu) and Pakistan (mostly Muslim). This split is called Partition. It triggered one of the largest forced migrations in human history and caused massive violence and death.',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个我在难民那条故事线里整条读过——那几节就是在讲这个。重点：

1947 年英国从印度撤走，但走之前把印度切成两国：印度（印度教为主）+ 巴基斯坦（伊斯兰教为主）。
这就叫 Partition（分治）。穆斯林领袖怕在印度教占多数的国家里被边缘化，要求单独建国。

那条国境线交给一个叫 Cyril Radcliffe 的英国律师画。
他接活前从没来过印度，只给了约 5 周时间，对着地图画完。
走向还拖到独立日（印度 8 月 15 日；巴基斯坦 8 月 14 日，分治出的两国独立日差一天）之后才公布——很多人是"独立之后"才发现，自己家被划到了"另一个国家"那边。

后果：
① 约 1500 万人上路逃命，两股人流迎面相遇，互相砍杀。
② 死亡人数学界估计在几十万到一百多万之间（争议很大，所以写区间，别写一个确数）。

**考点关键句**：印巴分治证明——独立的第一个礼物，对很多普通人不是自由，而是逃命、是邻居变仇人。
"自由的胜利"和"普通人的代价"，是同一年发生的两件事。`,
          en: `I read this whole story line — the partition refugee chapters are exactly about this. Key points:

In 1947 Britain withdrew from India, but before leaving split India into two countries:
India (mostly Hindu) + Pakistan (mostly Muslim). This is called Partition. Muslim leaders
feared being sidelined in a Hindu-majority state and demanded a separate nation.

The border was drawn by a British lawyer named Cyril Radcliffe.
He had never been to India before the job. He was given about 5 weeks, drew it off a map,
and the exact line wasn't announced until after independence day (India: August 15; Pakistan: August 14 — the two partitioned nations have independence days a day apart).
Many people learned only "after independence" that their home had been drawn onto "the other country's" side.

The aftermath:
① About 15 million people fled — two streams met head-on, and the violence was brutal.
② Scholars estimate deaths somewhere between several hundred thousand and over a million (heavily disputed — write a range, not a fixed number).

**Key exam sentence**: Partition proves that independence's first gift, for many ordinary people,
was not freedom but flight — and neighbors turned into enemies.
"The victory of freedom" and "the cost to ordinary people" were two things that happened the same year.`,
        },
      },
    },

    {
      ...
      defCn: 'Mohandas Gandhi（莫罕达斯·甘地）是印度独立运动最有名的领袖，他用"非暴力不合作"（satyagraha，意思是"坚持真理"）来对抗英国殖民统治——不用武力，而是靠大规模的"不配合"，让强大的殖民机器转不动。',
      defEn: 'Mohandas Gandhi was the most famous leader of India\'s independence movement. He used "satyagraha" (meaning "holding to truth") — nonviolent mass non-cooperation — to resist British colonial rule without using weapons, jamming the machinery of empire.',
      standardRef: ['AP World Modern Unit 8.5', 'CA HSS 10.9'],
      examFrequency: 'highest',
      storyAnchor: {
        covered: false,
...
意思是：不用暴力，而是用大规模、有纪律的"不配合"来对抗一个比你强得多的统治者。

具体怎么做？三招：
① **不合作**：拒绝在英国的政府、法庭、学校里配合。
② **抵制英货**：几亿印度人不买英国布，自己纺自己织（土布运动）。
③ **公民不服从**：故意违反不公正的法律，然后甘愿被抓。
...
故事连接：在丘吉尔那条故事线里，正是 Gandhi 用绝食、不合作、
抵制英货把大英帝国逼到墙角。丘吉尔恨他，1931 年公开骂他是"半裸的苦行僧"——
...
His core method is called **satyagraha (nonviolent resistance)** — literally "holding to truth."
It means: not using violence, but using mass, disciplined "non-cooperation" to resist a ruler far stronger than you.

How, concretely? Three moves:
① **Non-cooperation**: refusing to work with British government, courts, and schools.
② **Boycott**: hundreds of millions of Indians refusing to buy British cloth, spinning and weaving their own (the homespun movement).
③ **Civil disobedience**: deliberately breaking an unjust law, then willingly being arrested.
  The most famous was the 1930 Salt March — Britain made salt a government monopoly with a salt tax,
  so Gandhi led people on a march of hundreds of kilometers to the sea, made salt from seawater himself, openly breaking the law.

Why did it work? Britain ruled hundreds of millions of Indians with only tens of thousands of officials —
it depended on "Indians cooperating." Once hundreds of millions quietly, without raising a hand, "just refused to cooperate,"
the whole machine of rule jammed.

In Churchill's story line, it is exactly Gandhi who pushed the British Empire into a corner
with hunger strikes, non-cooperation, and boycotts. Churchill hated him and called him in public
(in 1931) a "half-naked fakir" — a thin little old man in homespun cloth who forced an empire off its feet.

Later influence: Martin Luther King explicitly said he learned his nonviolent method from Gandhi
...
Gandhi used "soft" power, but it could jam a "hard" empire.

Note: Gandhi wasn't a flawless saint — he's also been criticized by later generations
on caste and on how he treated his wife. AP doesn't want you to only praise him —
"seeing both the power of the method and the complexity of the person" scores higher.`,
...

    {
      ...
      defCn: '1943 年英国殖民地印度的孟加拉地区爆发大饥荒，学界估计死亡人数从数十万到约 300 万。时任英国首相丘吉尔的政府一再拒绝救援请求，是加重饥荒的关键因素之一。',
      defEn: 'A massive famine struck British-ruled Bengal, India in 1943. Scholars estimate deaths from several hundred thousand up to about 3 million. The British government under Prime Minister Churchill repeatedly blocked relief requests, making him a key figure in worsening the disaster.',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个在丘吉尔那条故事线里读过——而且是那条线里最难受的一节。
...
④ 但丘吉尔政府一次次把救援请求压下、推迟、打折——理由是战时船只优先运兵运粮给前线，
  而且他私下对印度人有很重的轻视。
学界的共识是：他是"加重责任的中心人物，但不是唯一原因"。

**考点关键句**：同一个丘吉尔——1940 年顶住纳粹、被全世界当反法西斯英雄的那双手，
也把约 300 万孟加拉人挡在了救援之外。**一个人可以同时是英雄，和造成伤害的人。**

这正是 AP 反"伟人崇拜"的经典素材：被尊为"英雄""文明使者"的大人物，
翻过来看，同一双手也可能沾着殖民地的血（和 King Leopold、Wilson 是同一个模式）。`,
          en: `I read this in Churchill's story line — and it was the hardest chapter in that whole story.

In 1943 a great famine struck Bengal, India. Scholars estimate deaths from
...
The causes weren't single:
① Japan took Burma and cut off rice imports.
② A cyclone ruined crops.
③ Hoarders drove up prices, and wartime management was a mess.
④ But Churchill's government pushed relief requests down, delayed and cut them, again and again —
  citing wartime priority for ships, and he privately held heavy contempt for Indians.
The scholarly consensus: he was "a central, aggravating figure, but not the only cause."
...
reach of relief. **A person can be a hero and someone who caused great harm at the same time.**

This is classic AP anti-great-man material: figures honored as "heroes" and "bringers of
civilization," turned over, can have the same hands stained with colonial harm
(same pattern as King Leopold and Wilson).`,
        },
      },
    },

    {
      ...
      defCn: '印度独立之后，非洲的殖民地也一个接一个争取独立。加纳（Ghana）在 1957 年通过谈判和平独立；阿尔及利亚（Algeria）则打了一场长达 8 年的独立战争（1954-1962）才拿到独立。这两个案例代表了去殖民化的两条路：谈判式 vs 武装式。',
      defEn: 'After India\'s independence, African colonies also pushed for freedom. Ghana achieved independence peacefully through negotiation in 1957. Algeria had to fight an 8-year war (1954-1962) to win independence. These two cases represent the two paths of decolonization: negotiated vs armed.',
      ...
      standaloneText: {
        cn: `印度只是开头。1945 年之后，非洲的殖民地一个接一个独立。AP 最常考的是两个案例——
...
故事连接：在丘吉尔那条故事线里有一节说"1945 后殖民地一个接一个走"——
加纳、阿尔及利亚就是这股浪潮里的两个。`,
...
In Churchill's story line, one chapter says "after 1945 the colonies left one after
...
+ whether large numbers of settlers refused to leave.**`,
...

    {
      ...
      defCn: '去殖民化不只发生在印度——1945 年之后，亚洲和非洲各地的殖民地纷纷争取独立。AP 考试里最常出现的几个案例是：越南独立战争、1956 年苏伊士运河危机、1960 年"非洲年"（17 个非洲国家同年独立）、以及刚果独立后的危机。',
      defEn: 'Decolonization happened far beyond India — after 1945, colonies across Asia and Africa pushed for independence. The AP exam most often features: Vietnam\'s independence war, the 1956 Suez Crisis, the 1960 "Year of Africa" (17 African nations independent in one year), and the Congo Crisis after independence.',
...
《日内瓦协定》以北纬 17 度线（地图上的一条纬线）把越南一分为二，独立直接接入冷战，演变为越战（1955-1975）。

**苏伊士运河危机（Suez Crisis），1956**
埃及总统**纳赛尔（Nasser）**将运河国有化——意思是把这条关键水道的控制权从外国公司手里收回来，归埃及政府管。
英法以色列出兵，美苏双方都反对，迫使撤军。
...
加丹加省分裂，美苏双方都插手。卢蒙巴 9 月被推翻、后遭处决——"独立不等于稳定"的最典型案例。`,
        en: `Decolonization is not only India and Partition — on AP exams it's a wide map covering Asia, Africa, and beyond.

**Vietnam: one colonizer replaced by another, thirty years of war**
On September 2, 1945, Communist leader **Ho Chi Minh** declared independence in Hanoi,
even quoting the American Declaration of Independence. France refused and sent troops.
By 1954 Vietnam defeated French forces at **Dien Bien Phu**; France withdrew.
The Geneva Accords split Vietnam at the 17th parallel (a line of latitude on the map);
independence fed directly into the Cold War and became the Vietnam War (1955-1975).

**Suez Crisis, 1956**
Egyptian President **Nasser** nationalized the Suez Canal — meaning he took control of this key waterway
back from foreign companies and put it under Egyptian government ownership.
Britain, France, and Israel launched a military action; both the US and USSR opposed it and forced a withdrawal.
British and French prestige collapsed, accelerating African independence —
**the true closing signal of the age of empires**.

**Year of Africa, 1960**
In 1960 alone, **17 African nations became independent** (14 from French Africa + British + Belgian Congo).
...
The Congo is the textbook case for "independence does not equal stability."`,
      },
      xiaoweiNote: {
...
This card's mnemonic:
① Vietnam fought its way out (Dien Bien Phu 1954)
② Suez taken back (Nasser 1956)
③ Year of Africa 17 nations (1960)
④ Congo broke apart (independence 1960, immediate collapse)

The comparison question exams love most: "Why was some decolonization peaceful and some
bloody?" Vietnam vs Ghana is the perfect contrast — one took thirty years of war, one was negotiated.`,
      },
    },

    {
      ...
      defCn: '泛非主义是一种想法，认为全世界的非洲人和非洲后裔——不管被殖民者划到哪个国家——本质上是一个共同体，应该团结起来。这个想法最早在美洲被奴役的非洲后裔中兴起，后来传回非洲大陆，成为非洲独立运动的精神支柱之一。',
      defEn: 'Pan-Africanism is the idea that all Africans and people of African descent worldwide — no matter which country colonizers put them in — are one community and should stand united. The idea started among enslaved Africans in the Americas and later spread back to Africa, becoming a key spirit of the independence movement.',
...
几个关键点：
① 它最早的源头之一在非洲大陆**之外**——美洲被奴役者的后裔（如生于自由州、本人从未被奴役的 W.E.B. Du Bois 杜波依斯）
...
注意：泛非主义的"团结"理想很美，但现实里非洲各国国情、利益差别很大，
真正的"非洲联合"一直很难实现。理想和现实之间，至今有差距。

这张卡和"非洲独立"那张是一对：Nkrumah 既是加纳独立的领袖，也是泛非主义的旗手。`,
        en: `**Pan-Africanism** — the idea that all Africans and people of African descent
...
Key points:
① One of its earliest sources was **outside** the African continent — descendants of
  enslaved people in the Americas (such as W.E.B. Du Bois, who was born free) organized "Pan-African
...
Note: Pan-Africanism's ideal of "unity" is inspiring, but in reality African nations differ
greatly in conditions and interests, and true "African union" has always been hard to achieve.
There is still a gap between the ideal and reality.
...
Exam anchors: Nkrumah + Du Bois + the 1963 OAU (Organization of African Unity).`,
...

    {
      ...
      defCn: '不结盟运动（Non-Aligned Movement，NAM）是一批新独立国家在 1961 年正式成立的政治联盟。它的核心主张是：不加入美国或苏联任何一方的军事集团，走自己的路。这不等于"什么都不做"——而是新国家集体拒绝给大国当小弟的主动选择。',
      defEn: 'The Non-Aligned Movement (NAM) is a political alliance formally founded in 1961 by newly independent nations. Its core stand: not joining either the American or the Soviet military bloc — choosing their own path. This is not passivity — it is the active, collective refusal of new nations to be junior partners of the great powers.',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `丘吉尔那条故事线里有一节读过，难民那条故事线里也提到了。重点：
...
注意（来自难民那条故事线）：不结盟是**大人物在世界舞台上的博弈**。
而路上的难民既没赶上"独立的荣耀"，也没资格上"不结盟"的谈判桌——
新国家还常被卷进冷战代理战争，当了大国的炮灰。`,
          en: `I read this in Churchill's story line, and the partition refugee story line mentions it too. Key points:
...
Note (from the refugee story line): Non-Alignment was **the great figures' game on the world stage.**
The refugees on the road caught neither "the glory of independence" nor a seat at the
"non-aligned" table — and new nations were often dragged into Cold War proxy wars as the great powers' cannon fodder.`,
        },
      },
    },

    {
      ...
      defCn: '去殖民化有两条路：殖民者愿意谈，就通过和平谈判移交权力（谈判式）；殖民者不肯走，被殖民的一方就只能用武装斗争来换独立（武装式）。在两种情形之间，联合国调停员——比如 Ralph Bunche——努力让枪先停下来，争取谈判的空间。',
      defEn: 'Decolonization took two paths: if the colonizer was willing to negotiate, power was handed over peacefully (negotiated); if the colonizer refused to leave, the colonized had no choice but to fight for independence (armed). In between, UN mediators — like Ralph Bunche — worked to silence the guns first and create space for talks.',
...
地中海罗德岛一栋旅馆，靠耐心、公正、绝不偏帮（甚至拉双方打台球缓和气氛），
一寸一寸谈成停火线。1950 年他因此获诺贝尔和平奖——**历史上第一个获此奖的非裔人士**。

**考点关键句（也是注意）：**调停成功的最高境界是"什么都没发生"——
...
the UN / mediation played in between. Ralph Bunche's story line is specifically about mediation.
...
(even getting them to play billiards together to ease the tension), negotiated a ceasefire
line inch by inch. In 1950 he won the Nobel Peace Prize for it —
**the first person of African descent in history to receive it.**

**Key exam sentence (and a note):** The highest art of successful mediation is that
...
man living under racial segregation back in America. In 1949 President Truman asked him to be
**Assistant Secretary of State** (a high post), and he **refused** — because he would not move his
...
fairness abroad while still fighting for his own equality at home.`,
...

    {
      ...
      defCn: '新国家独立之后，往往面临三大长期挑战：① 殖民者随手画下的边界引发持续冲突；② 政治独立了但经济还依附于前殖民母国（这叫新殖民主义，neocolonialism）；③ 殖民者留下的族群/宗教裂痕容易引爆内战。',
      defEn: 'After independence, new nations typically faced three lasting challenges: ① borders drawn carelessly by colonizers kept triggering conflicts; ② political independence came without economic independence — new nations still depended on former colonial powers (called neocolonialism); ③ ethnic and religious divisions deliberately stirred by colonizers could explode into civil wars.',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `在难民那条故事线里读过。这张卡讲的是：独立**之后**的麻烦，往往才是最难的。
...
新殖民主义（neocolonialism）是这么一回事：新国家升起了自己的国旗、有了自己的政府，
但经济上常常还依附于原来的殖民母国或大国——继续被当成原料产地、廉价劳动力来源。
换了国旗，没换"谁赚钱"的格局。

**挑战三：内部裂痕。**
殖民者常用"分而治之"来挑动族群/宗教对立。独立后，这些被埋下的裂痕
（加上人为边界）容易爆成内战、教派冲突。
...
独立是一个"开始"，不是一个"结束"。`,
          en: `I read this in the partition refugee story line. This card is about: the
...
living people, for its own convenience, into "this side" and "that side." Two examples:
...
Neocolonialism works like this: new nations raised their own flags and had their own governments,
but economically often still depended on the former colonial power or great powers —
still treated as a source of raw materials and cheap labor. The flag changed, but "who makes the money" did not.

**Challenge 3: internal fractures.**
Colonizers often used "divide and rule" to set ethnic and religious groups against each other.
After independence, these buried fractures (plus artificial borders) easily exploded into
civil wars and sectarian conflict.

Exam frame (AP's favorite "continuity and change" analysis):
...
Can a person be both an "anti-fascist hero" and "someone whose decisions caused a famine"?
Do you think "merit" and "fault" can be added and subtracted into one total score, or are they two faces of the same belief?`,
      hintCn: `提示：可以从两个角度想——
① 丘吉尔心里那套"大英帝国统治世界天经地义"的信念，
  既让他无比勇敢地对抗纳粹暴政，也让他对印度人的命冷漠——
  因为他反对的"暴政"，可能只算欧洲白人头上的暴政。
② "功过相抵"听起来公平，但对那 300 万死者来说，
  "丘吉尔救了欧洲"并不能抵消"他们饿死了"。

进阶思考：评价一个历史人物，是该给他打一个"总分"，
还是该同时说清他做了什么好事、什么坏事，让读者自己判断？哪种更诚实？`,
      hintEn: `Hint: think from two angles —
① Churchill's inner belief that "the British Empire ruling the world is natural" made him
  both immensely brave against Nazi tyranny and cold toward Indian lives —
  because the "tyranny" he opposed may have counted only as tyranny over white Europeans.
② "Merit cancels fault" sounds fair, but to those 3 million dead,
...
out clearly both the good and the bad they did and let readers judge for themselves? Which is more honest?`,
...
Britain one piece of advice at the time, what would you say?`,
      hintCn: `提示：可以想想——
① 画线的人离得太远、太赶，根本不可能了解线两边住的是谁、是不是几代好邻居。
② 走向拖到独立日之后才公布，让很多人措手不及。
...
一条几十年前画错的线，为什么能让几代人一直流血？"改不动的现状"有没有可能改？`,
      hintEn: `Hint: consider —
① The person drawing was too far away and too rushed to possibly understand who lived on either
  side of the line, or whether they were good neighbors of generations.
② The line was announced only after independence day, catching many off guard.
This is the same "line-drawing logic" as the Berlin Conference carving up Africa decades earlier —
the colonizer's greatest skill was never taking land, it was drawing lines.

Going deeper: many conflicts in today's world trace back to borders colonizers drew carelessly
(India-Pakistan, many parts of Africa). Why can a line drawn wrong decades ago keep generations bleeding?
Is a "status quo that can't be changed" ever changeable?`,
...
如果你是 AP 老师，让你出一道题来分析"是什么决定了去殖民化是和平还是暴力"，
你会怎么提问？`,
...
for" with rivers of blood? If you were an AP teacher writing a question on "what determines
whether decolonization is peaceful or violent," how would you phrase it?`,
      hintCn: `提示：这类题通常会给几个材料（殖民者的声明、独立领袖的演说、有没有大批移民、
殖民母国的实力对比），让你分析这几个变量。可能的提问角度：
① "在多大程度上，去殖民化的暴力程度，取决于殖民者抵抗的顽固程度（而非被殖民者的选择）？"
② "比较加纳和阿尔及利亚：殖民者的态度，如何决定了独立的代价？"

进阶思考：注意一个细节——非暴力（甘地）能成功，部分是因为对手
（衰落中的英国）还在乎国际舆论、撑不住了。如果对手是死不肯走、还有上百万移民赖着的法国，
非暴力够不够用？这说明"用什么方法"不只取决于被压迫者，也取决于压迫者。`,
      hintEn: `Hint: this type of question usually gives several documents (the colonizer's statements,
independence leaders' speeches, whether there were large numbers of settlers, the balance of
power of the colonial home country) and asks you to analyze these variables. Possible question angles:
...
② "Compare Ghana and Algeria: how did the colonizer's attitude determine the cost of independence?"

Going deeper: note one detail — nonviolence (Gandhi) could succeed partly because the opponent
(a declining Britain) still cared about world opinion and couldn't hold on. If the opponent had been
a France that refused to leave and had over a million settlers digging in, would nonviolence have been enough?
This shows that "which method works" depends not only on the oppressed but also on the oppressor.`,
