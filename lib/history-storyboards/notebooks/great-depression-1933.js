...
//
// 与 storyboard 的关系（3 lens：FDR / Frances Perkins / 被挤走的佃农）：
  ...
  mainConcepts: [
    // ── 卡 1：1929 股灾 + 萧条成因（独立，故事只快带过机制）──
    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'fdr', nodeId: 'fdr-n2', context: 'FDR 视角快带过：1929.10 股市崩，滚雪球式蔓延到 1933 约 1300 万失业' },
        ],
      },
      standaloneText: {
        cn: `1929 年 10 月 29 日，星期二，纽约股市崩盘——这一天被叫做 Black Tuesday（黑色星期二）。
无数人的财富一夜变成废纸。这是大萧条（the Great Depression）的开端，
也是美国历史上最严重的一次经济崩溃。

但崩盘只是导火索。Dr. Park 一直强调："考的是成因，不是那一天。"几个主要原因：
1. **股市过度投机 + 用借的钱炒股**（buying on margin）：股价被炒到远超真实价值。
2. **银行体系脆弱**：很多银行把储户的钱也拿去炒股、放高风险贷款，崩盘一来就垮。
3. **生产过剩 + 消费不足**：工厂造的东西，老百姓买不起（贫富差距太大）。
4. **农业早就在萧条**：1920 年代农产品价格一直低，农民先垮了。

然后是**滚雪球**（这是 DBQ 最爱画的因果链）：
股市垮 → 银行垮 → 工厂关 → 工人失业 → 没人买东西 → 更多工厂关。

到 1933 年，全国大约**1300 万人失业**——差不多每四个工作的人里就有一个没活干（约 25%）。
1930-1933 年间，累计有**九千多家银行倒闭**。股市从 1929 年的高点跌掉了近 90%。

🔗 故事连接：罗斯福那一遍第 2 节，他自己把这条滚雪球链条讲了一遍——
"股市垮→银行垮→工厂关→工人失业→没人买东西→更多工厂关"，正是这张图。`,
        en: `On Tuesday, October 29, 1929, the New York stock market crashed — the day called
...
not the day." The main causes:
1. **Stock speculation + buying on margin** (buying stocks with borrowed money):
   prices were driven far above real value.
2. **A fragile banking system**: many banks gambled depositors' money on stocks and
   risky loans, so when the crash hit, they fell.
3. **Overproduction + underconsumption**: factories made goods ordinary people
   couldn't afford (the wealth gap was too wide).
4. **Agriculture was already in a slump**: farm prices stayed low through the 1920s,
...
🔗 Story link: In Roosevelt's pass, Node 2, he walks through this snowball chain himself —
"market falls → banks fall → factories close → workers lose jobs → no one buys →
more factories close" — exactly this diagram.`,
      },
      xiaoweiNote: {
        cn: `老师说选择题最爱挖一个坑："大萧条是 1929 股市崩盘'造成'的吗？"
标准答案是：崩盘是**触发器（trigger）**，不是**根本原因（root cause）**。
真正的根子是上面那 4 条（投机/银行脆弱/生产过剩/农业先垮）。

我的记忆口诀：**"崩盘是火柴，柴堆早就堆好了。"**
数字三件套背熟：1300 万失业 / 约 25% / 9000+ 家银行。`,
        en: `Teacher says multiple choice loves the trap: "Did the 1929 crash *cause* the
Depression?" The correct answer: the crash was the **trigger**, not the **root cause**.
...
Memorize the number trio: 13 million jobless / about 25% / 9,000+ banks.`,
    ...
    // ── 卡 2：Hoover vs FDR（独立，对照框架）──
    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'fdr', nodeId: 'fdr-n2', context: 'FDR 视角带过"前一位总统说政府别插手、市场会自己缓过来，等了三年反而更糟"' },
        ],
      },
      standaloneText: {
...
政府应该尽量别插手经济，市场会自己缓过来；他更看重让企业、慈善、地方政府自愿出手。
要公平地说一句：胡佛**不是什么都没做**（他后期搞过 RFC 复兴金融公司、公共工程），
但他的底线是不让联邦政府大举下场。结果：等了三年，萧条没缓过来，反而更糟。
失业者搭的棚户区被人讽刺地叫 **Hooverville（胡佛村）**——把怒气直接安在他名字上。

**Franklin D. Roosevelt（FDR）**，1932 年靠"新政"承诺压倒性当选，1933 年 3 月就任。
他的思路正相反：**政府主动下场**，直接花钱、直接造工作、直接救人。
他上任头一百天（the Hundred Days）推国会通过一大堆法案，又用 **fireside chats
（炉边谈话，用收音机直接对全国人讲话）**安抚人心、稳住银行挤兑。

考点关键句：Hoover = **laissez-faire / 有限干预**；FDR = **联邦政府主动责任 / 大规模干预**。
这不是"一个坏一个好"，是**两种关于"政府该管多宽"的根本立场**。

🔗 故事连接：罗斯福那一遍第 2 节，他亲口说"前一位总统说政府别插手、市场会自己缓过来，
等了三年反而更糟"——那个"前一位总统"就是 Hoover。`,
        en: `This question tests a **contrast**: in the same crisis, how did two presidents differ.

**Herbert Hoover**, FDR's predecessor, mostly believed in **laissez-faire** — government
should stay out of the economy as much as possible and let the market recover on its own;
he leaned on businesses, charities, and local governments to act voluntarily. To be fair:
Hoover **did not do nothing** (later he created the RFC and some public works), but his
bottom line was keeping the federal government from going all in. The result: three years
passed and the slump didn't recover — it got worse. The shantytowns of the jobless were
mockingly called **Hoovervilles** — pinning the anger right on his name.

**Franklin D. Roosevelt (FDR)** won in 1932 by a landslide on a "New Deal" promise and
took office in March 1933. His approach was the opposite: **the government acts directly** —
spend money, build jobs, save people. In his first **Hundred Days** he pushed a stack of
laws through Congress, and used **fireside chats** (radio talks straight to the nation) to
calm people and stop bank runs.

Key exam sentence: Hoover = **laissez-faire / limited intervention**; FDR = **active
federal responsibility / large-scale intervention**. This isn't "one bad, one good" — it's
**two fundamental positions on how much the government should manage.**

🔗 Story link: In Roosevelt's pass, Node 2, he says "the president before me had one answer:
keep the government out, the market will recover on its own; three years passed, it got
worse." That "president before me" is Hoover.`,
      },
      xiaoweiNote: {
...
he did intervene some, he just wouldn't let the federal government go all in. AP scoring
likes an *accurate* contrast, not a cartoon takedown.

Memory hooks: **Hooverville** = "people pinned their anger on his name"; **fireside chat**
= FDR talking to you directly over the radio.`,
      },
    },
    ...
    // ── 卡 3：三 R + 字母机构（独立，roster）──
    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'fdr', nodeId: 'fdr-n3', context: 'FDR 视角讲百日新政：三 R + CCC 种树修路 + AAA + 公共工程修桥水坝学校 + FDIC/SEC' },
        ],
      },
      standaloneText: {
        cn: `新政（the New Deal）不是一部法，是一**大堆**法案和新机构的总称。
记忆它们的钥匙就是三个字：**relief / recovery / reform（救济 / 复兴 / 改革，三 R）**。
- **Relief（救济）**：先让人活下去——给饿肚子的人发饭、给没工作的人造活干。
...
🔗 故事连接：罗斯福那一遍第 3 节，他亲口讲了百日新政——
CCC（送年轻人种树修路建公园）、AAA（管农业）、公共工程（修桥水坝学校）、
FDIC（存款保险）、SEC（证券监管）。这张表就是把他说的整理成考点。`,
        en: `The New Deal wasn't one law — it's the name for a **whole stack** of laws and new
agencies. The key to remembering them is three words: **relief / recovery / reform.**
...
🔗 Story link: In Roosevelt's pass, Node 3, he describes the Hundred Days himself —
the CCC (young men planting trees, building roads and parks), the AAA (managing farming),
public works (bridges, dams, schools), the FDIC (deposit insurance), the SEC (market
regulation). This table just sorts what he said into exam form.`,
      },
      xiaoweiNote: {
...
name and asking which R it belongs to and what it did. My clumsy method: memorize the order
of the three R's ("survive first → turn it around → don't break again"), then hang each
agency on one R.
...
sharecroppers off their land) — see the next card.`,
    ...
    // ── 卡 4：AAA + 佃农被挤出（故事覆盖，3 lens N6）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个三个故事都讲到了，是这整个 Topic 最绝的"一笔钱三张脸"。

考点机制（先背这个）：农业的死结是——农民越拼命种，粮价跌得越狠，越穷。
AAA（Agricultural Adjustment Act, 1933）的反直觉解法：政府**发补贴奖励农民减产**
（休耕、杀猪、犁掉棉花），供应少了，价格就回升。

可补贴支票是**寄给地主**的（因为地和合同是地主的）。南方很多地是黑人佃农
（sharecropper）租种的。地主拿了钱要减产，就不再需要那么多佃农——于是**拿着政府支票
把佃农赶出土地**。一项估计 AAA 害约 200 万佃农失业。

我在罗斯福那一遍第 6 节、佃农那一遍第 4-6 节，看到了同一笔钱的三张脸：
- 在华盛顿，它叫"救农民"（恩典）；
- 到地主手里，它叫"减产补贴"（利润）；
- 落到佃农头上，它变成"滚蛋"（把人赶上路的那只脚）。

careful framing：法律**纸面上**要求地主分一部分补贴给佃农，可执行这条的正是从中得利的地主，
分配普遍没落实。佃农那一遍说得好——"一条好规矩交到错的人手里执行，变成一把更趁手的刀。"
...
In Roosevelt's pass Node 6 and the sharecropper's Nodes 4-6, I saw one sum of money wear
three faces:
...
happen. The sharecropper's pass nails it — "a good rule, handed to the wrong man to enforce,
...
Deal's differing impact on different groups."`,
    ...
    // ── 卡 5：Social Security + 局限（故事覆盖，fdr+fp+ds N6/N7）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是新政里**最持久、今天还在用**的一块，三个故事都讲到了。

考点正面：1935 年 **Social Security Act（社会保障法）**——老了有养老金、失业了有救济金，
一张"兜住所有人"的安全网。它属于三 R 里的 **reform**。今天美国人退休领的养老金，根子就在这。
设计者是 **Frances Perkins（弗朗西丝·珀金斯）**——美国首位女性内阁部长（劳工部长），
她在 Lens 2 整条线里讲怎么把这件没人做过的大事一寸寸推成法律。

但这张网一开始有**两个洞**：它不覆盖 **农业工人** 和 **家政工人**（在别人家做饭、带孩子、打扫的人）。
这两类活当时主要是**南方黑人**在干——结果上，把多数黑人挡在了养老/失业保障外面
（一项研究说约 65% 黑人被排除，南方部分地区高到 80%）。

careful framing（这点 fact ledger 特别叮嘱）：这两个洞**为什么**留下来？
**结果**是清楚的：多数黑人被挡在外（这是已核实的事实）。
但**动机**学界**有争议**——一派说这是为换南方议员的票、是种族算计；
另一派说当时这两类零散就业"难统计、难收费"，是行政可行性问题。
写 essay 时**别把它一口咬定成纯种族交易**，要说"无论动机是哪种，结果都一样：多数黑人被挡在外"。

我在 Perkins 那一遍第 6-7 节听她自己讲"要么是有洞的网，要么一张都没有，我选了有洞的"；
在佃农那一遍第 7 节听到另一头——"一只手把我推下地（AAA），另一只没接住我（社保漏掉）"。`,
          en: `This is the **most lasting** piece of the New Deal, **still used today** — all three
stories cover it.

The exam positive: the 1935 **Social Security Act** — pensions in old age, relief when
jobless, a safety net to "catch everyone." It belongs to **reform** in the three R's. The
pension Americans draw in retirement today has its roots here. Its designer was **Frances
Perkins** — the first woman in a US cabinet (Secretary of Labor); Lens 2 is her whole line
on pushing this never-before-done thing into law, inch by inch.
...
Careful framing (the fact ledger especially flags this): **why** were the holes left?
The **result** is clear: most Black people were kept out (a verified fact). But the **motive**
is **debated by scholars** — one camp says it was to win Southern congressmen's votes, a
racial calculation; another says these scattered jobs were "hard to count, hard to collect
from," an administrative-feasibility problem. In an essay, **don't flatly call it a pure
racial deal** — say "whatever the motive, the result was the same: most Black people were
kept out."

In Perkins's pass, Nodes 6-7, she says herself "it was either this net with holes or no net
at all, and I chose the one with holes." In the sharecropper's pass, Node 7, you hear the
other end — "one hand pushed me off the land (AAA), the other didn't catch me (Social
Security)."`,
        },
      },
    },
    ...
    // ── 卡 6：Dust Bowl + Okies（独立，且明确区分于 Great Migration）──
    {
      ...
      standaloneText: {
        cn: `这个故事**没讲到**，但 AP 一定考，我单独记。注意：它和故事里黑人佃农的迁移，
是**两条完全不同的路**，千万别混（这是老师反复强调的坑）。

**Dust Bowl（黑色风暴 / 尘暴）**：1930 年代中期，美国大平原（Great Plains，
俄克拉荷马、得州、堪萨斯等地）连年大旱，加上之前过度开垦、把固土的草根全翻掉了，
风一刮就卷起遮天蔽日的黑色沙尘暴。土地种不了了，房子被沙埋了。

结果：大约 **30-40 万** 农民（**多为白人**）被逼离开家园，沿著名的 66 号公路往西，
逃到加州找活干。他们被当地人轻蔑地叫做 **"Okies"**（因为很多来自 Oklahoma 俄克拉荷马）。
到了加州，他们多半只能当流动农工，被歧视、住路边窝棚。作家 John Steinbeck 的小说
《愤怒的葡萄》（The Grapes of Wrath, 1939）写的就是这群人。

⚠️ **最容易考错的对比**（一定背清）：
- **Dust Bowl / Okies**：大平原 → **往西**去加州；约 30-40 万；**多为白人**；起因是**生态灾难**。
- **the Great Migration（大迁徙）**：南方 → **往北**去工业城市（底特律、芝加哥）；约 **600 万**；
  **黑人**；起因是种族压迫 + 经济（含被 AAA 挤出土地）。故事里那个佃农走的是**这一条**。
...
the story — never mix them up (a trap the teacher stresses again and again).

**The Dust Bowl**: in the mid-1930s the Great Plains (Oklahoma, Texas, Kansas, and nearby)
suffered years of severe drought, and earlier over-plowing had torn out the grass roots that
held the soil, so the wind whipped up black dust storms that blotted out the sky. The land
couldn't be farmed; houses were buried in sand.

The result: about **300,000-400,000** farmers (**mostly white**) were forced from their
homes and went **west** along the famous Route 66 to California looking for work. Locals
called them **"Okies"** with contempt (many came from Oklahoma). In California most could
only become migrant farm laborers, facing discrimination and roadside camps. John
Steinbeck's novel *The Grapes of Wrath* (1939) is about these people.
...
side by side and making you choose.`,
      ...
      xiaoweiNote: {
        cn: `Dr. Park 给的口诀我直接抄："**Okies 往西、黑人往北；Okies 多白、迁徙是黑；
Okies 因旱、迁徙因压。**" 三组对比，方向 / 人群 / 起因。
...
**Steinbeck** — AP sometimes uses it as primary-ish material.`,
    ...
    // ── 卡 7：court-packing（故事覆盖，fdr-n5）──
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['fdr-n5'],
        xiaoweiNote: {
          cn: `这个在罗斯福那一遍第 5 节，他自己讲的，特别有意思——是 AP Gov 的经典三权分立案例。

考点经过：1935-36 年，最高法院（Supreme Court）连判好几个新政计划**违宪**
（unconstitutional），说宪法没给联邦政府这么大权力去管农业、管工厂。FDR 气坏了。
1937 年他提出 **court-packing（法院改组案）**：想往最高法院**加塞最多 6 名**自己的法官，
把不听话的老法官稀释掉（理由是给 70 岁以上的法官每人配一个"帮手"）。

结果：连他**自己党内**的人都反对，说他这是想**踩烂三权分立**、让总统骑到法院头上。
方案**失败**了。不过有意思的是，此后法院态度软化，多数新政得以延续
...
罗斯福自己在第 5 节说的那句我特别记住了："那墙正是当年宪法立来防我这种人的。"`,
          en: `This is in Roosevelt's pass, Node 5, told by him — it's a classic AP Gov
separation-of-powers case.

The exam story: in 1935-36 the Supreme Court struck down several New Deal programs as
**unconstitutional**, saying the Constitution gave the federal government no such power to
manage farming and factories. FDR was furious. In 1937 he proposed **court-packing**: to add
**up to 6** of his own justices to the Supreme Court, diluting the old judges who wouldn't go
along (the cover story: an "assistant" for each justice over 70).

The result: even his **own party** opposed it, saying he meant to **trample the separation
of powers** and ride the president over the court. The plan **failed**. Interestingly, the
Court then softened, and most of the New Deal survived (history's joke: "the switch in time
that saved nine").
...
The line of his in Node 5 I really remember: "that wall was exactly the one the Constitution
had raised on purpose, to guard against a man like me."`,
        },
      },
    },
    ...
    // ── 卡 8：Keynes vs Hayek（独立，经济史双视角）──
    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'fdr', nodeId: 'fdr-n8', context: 'FDR 视角带过"一个英国经济学家主张经济垮时政府带头花钱造工作"（凯恩斯）' },
          { lens: 'fdr', nodeId: 'fdr-n11', context: 'synthesis 用"一种说法/另一种说法"中立呈现凯恩斯 vs Hayek' },
        ],
      },
      standaloneText: {
        cn: `这是 AP Macroeconomics 的入门框架，也是这个 Topic 的"经济史双视角"。
故事的 synthesis（罗斯福那一遍第 11 节）用"一种说法 / 另一种说法"中立带过，我这里把它讲清。

核心问题：**经济垮的时候，政府主动花钱救市，到底是救命，还是反而拖长病程？**

**一种说法（Keynes / 凯恩斯，英国经济学家）**：经济垮的时候，老百姓和企业都不敢花钱，
整个经济就停转了。这时要靠**政府带头花钱**——哪怕借钱（赤字开支，deficit spending）也要花，
政府造工作 → 工人有钱 → 去消费 → 工厂重新开 → 经济转起来。这叫 **fiscal policy（财政政策）**
里的"需求管理"。新政的大规模公共工程，用的就是这套思路。
（凯恩斯的代表作《通论》出版于 1936 年。）

**另一种说法（Hayek / 哈耶克，奥地利学派经济学家）**：政府这只手反而帮倒忙。
政府乱插手、扭曲了价格和市场信号，让经济没法自己调整，结果把萧条**拖了整整十年**，
一直到二战军需才真正终结。市场本来会更快自愈，是政府越救越乱。

⚠️ 中立提醒（fact ledger 特别强调）：这**不是**"大政府好 vs 小政府坏"，
是**同一个问题的两种诚实答案**。AP 写 synthesis 时两边都要呈现，**不要预设结论**。
顺带一提，还有第三派（货币主义，如后来的 Friedman）认为是美联储紧缩货币才酿成大萧条——
三派对"萧条为什么这么久"的答案都不同。

🔗 故事连接：罗斯福那一遍第 8 节，他说"一个英国经济学家主张经济垮时政府带头花钱"，
那就是凯恩斯；第 11 节 synthesis 把凯恩斯 vs Hayek 摆成"两种都站得住的说法"让你自己想 30 秒。`,
        en: `This is the intro framework for AP Macroeconomics and the Topic's "two economic
viewpoints." The story's synthesis (Roosevelt's pass, Node 11) presents it neutrally with
"one view / the other view" — here I lay it out.

The core question: **when the economy collapses and the government actively spends to rescue
it, is that saving lives, or dragging out the sickness instead?**

**One view (Keynes, British economist)**: when the economy collapses, ordinary people and
businesses are all afraid to spend, so the whole economy stalls. The fix is the **government
leading the spending** — even by borrowing (**deficit spending**) — government builds jobs →
workers have money → they spend → factories reopen → the economy turns. This is "demand
management" within **fiscal policy**. The New Deal's large public works used this approach.
(Keynes's major work, the *General Theory*, was published in 1936.)

**The other view (Hayek, Austrian-school economist)**: the government's hand made it worse.
By meddling and distorting prices and market signals, it kept the economy from adjusting on
its own, **dragging the depression out a full ten years**, ending only with WWII demand. The
market would have healed faster; the more the government "rescued," the more it muddled.

⚠️ Neutrality reminder (the fact ledger stresses this): this is **not** "big government good
vs small government bad" — it's **two honest answers to the same question**. In an AP
synthesis, present both sides and **don't presuppose a conclusion**. By the way, a third camp
(monetarists, like later Friedman) argues the Federal Reserve's tightening of money caused
the Depression — all three camps answer "why so long" differently.

🔗 Story link: In Roosevelt's pass, Node 8, he says "a British economist argued the
government should lead the spending when the economy collapses" — that's Keynes; Node 11's
synthesis sets Keynes vs Hayek as "two views that both stand," asking you to think 30 seconds.`,
      },
      xiaoweiNote: {
...
DBQ 写到经济双视角时，结尾别站队站太死——AP 喜欢"我承认两边各有道理，然后给我自己的理由"。`,
        en: `Teacher says for AP Macro just lock onto one term: **fiscal policy = the government
using spending and taxing to steer the economy** — Keynes is its founding father. See
"government deficit spending to fight a recession" → think Keynes.

My mnemonic: **"Keynes says hit the gas (government spends); Hayek says stop stomping (the
market heals itself)."** When a DBQ hits the two economic views, don't pick a side too
rigidly at the end — AP likes "I grant both have a point, then here's my own reason."`,
      },
    },
  ],
...
Can one history be **both** "the government saving the people" and "the systematic exclusion
of the weak" at once? If you had to give the New Deal one overall grade, what would it be,
and how would you explain that grade to someone else?`,
      hintCn: `提示：AP 评分讨厌"非黑即白"。试试这个结构——
(1) 先承认它真实救了几千万人（具体举例：CCC/WPA 工作、社保养老金、FDIC 存款保险）；
(2) 再承认它系统地漏掉了同一群最没声音的人（AAA 挤出佃农、社保漏农业/家政工）；
(3) 关键一步：解释这两件事**不是互相抵消**，而是**同时为真**——
...
(1) first grant it truly saved tens of millions (concrete: CCC/WPA jobs, Social Security
pensions, FDIC deposit insurance);
(2) then grant it systematically left out the same group with the least voice (AAA pushing
sharecroppers off the land, Social Security excluding farm/domestic workers);
(3) the key move: explain these two **don't cancel out** but are **both true at once** —
...
如果你是 AP 老师，要出一道 DBQ 题来训练学生**区分"动机"和"结果"**，你会怎么提问？
你会给学生哪几种 primary source 让他们自己判断？`,
...
If you were an AP teacher writing a DBQ to train students to **separate "motive" from
"result,"** how would you phrase the question? Which primary sources would you give them to
judge for themselves?`,
      hintCn: `提示：好的 DBQ 不替学生拍板动机，而是逼他们用证据。
你可以给：① 当年南方议员的发言记录（看有没有种族语言）；② 社保署官方研究里"难统计难收费"的
行政论证；③ NAACP 当年作证说这是按种族排除黑人的材料。让学生比较这几份，自己权衡。

关键教学点：无论动机是种族还是行政，**结果是一样的**——多数黑人被挡在外。
史学上有个站得住的立场叫"区分意图与结果"：哪怕设计者不是故意，结果上的系统性伤害和故意一样真实。
你出的题，怎么让学生既不冤枉历史人物（别一口咬定纯种族交易），又不洗白真实的伤害？`,
      hintEn: `Hint: a good DBQ doesn't decide the motive for students — it forces them to use
evidence. You could give: (1) records of Southern congressmen's statements (is there racial
language?); (2) the Social Security Administration's official study with its "hard to count,
hard to collect" administrative argument; (3) NAACP testimony from the time arguing it
excluded Black people by race. Have students compare and weigh them.

Key teaching point: whatever the motive — racial or administrative — the **result was the
same**: most Black people kept out. There's a defensible historian's stance called
"separating intent from result": even if the designers didn't mean it, the systematic harm
in the result is as real as if they had. How would your question keep students from wronging
the historical figures (don't flatly call it a pure racial deal) *and* from whitewashing the
real harm?`,
...
这正是为什么这种争论能吵几十年。AP 想看的不是你站哪边，是你**承认这题的难处**还能给出理由。`,
      hintEn: `Hint: this has no standard answer; what matters is **how you reason with
evidence**. The Keynesian side would say: in 2008 and 2020 governments used deficit spending
and avoided a deeper collapse, proving it works. The Hayekian side would counter: that
spending may plant inflation and debt, "avoiding short-term pain" isn't the same as "getting
it right," and we can never know "what if they hadn't acted" (a counterfactual — very hard to
prove).
