...
//   3. thinkingQuestions（出口批判性思考）— 开放式 DBQ 入门题，中性不评判
//
// 课纲对齐：
...
我先记下来，等下读三个故事——一个彼得格勒纺织女工（最先被历史压垮、也最先站起来反抗的那种人）、
一个布尔什维克工厂组织者（把革命做出来的那只手）、
还有 Kerensky（夹在所有人中间、两头不讨好的那位）——
读完再回来对照这张单子，看我能不能解释。
...
Let me write these down. After I read the three stories — a Petrograd textile worker
(the kind of person history crushed first, who then stood up first), a Bolshevik factory
organizer (the hand that makes the revolution happen), and Kerensky (the one caught between
everyone, disliked by both sides) — I'll come back and check whether I can explain each one.
...
it lets you hear both sides at once."`,
    ...
    keyFigures: [
      ...
      },
      {
        ...
        ipa: null,
        roleCn: '合成人物，代表最先被压垮、最先站起来的那类普通人。丈夫上了前线、自己每天天不亮去排面包队的平民妇女。1917 年 3 月 8 日（旧 2.23）国际妇女节，她和工友们走出工厂喊「要面包」，点燃了二月革命的第一颗火星。',
        roleEn: "A composite character representing the ordinary people who were crushed first and stood up first. A working-class woman whose husband is at the front and who lines up before dawn each day in the bread queue. On International Women's Day, March 8, 1917 (OS Feb 23), she and her coworkers walked out shouting 'Bread!' — lighting the first spark of the February Revolution.",
        mustKnow: false,
        audioKey: null,
      },
    ],
  ...
  mainConcepts: [
    {
      ...
      defCn: '1905 年，沙皇的士兵朝和平游行的工人开枪（血腥星期日），全国大罢工随后爆发。压力下沙皇成立了民选议会杜马，但始终把持着解散权——这是 12 年后 1917 年乱局的历史根源。',
      defEn: 'In 1905 the Tsar\'s soldiers fired on peacefully marching workers (Bloody Sunday), triggering a nationwide strike. Under pressure the Tsar created an elected legislature called the Duma, but kept the power to dissolve it — planting the seeds of the 1917 crisis twelve years later.',
...
考点三步记：
1. 血腥星期日（1905.1.22）→ 全国罢工爆发；
2. 十月宣言（1905.10）→ 沙皇给杜马一个名分，没给实权；
3. 12 年后，那个名存实亡的杜马变成临时政府骨架，苏维埃成了它的对手——这就是双重权力的来历。`,
...
Three-step exam memory:
1. Bloody Sunday (Jan 22, 1905) → nationwide strikes erupt;
2. October Manifesto (Oct 1905) → the Tsar gave the Duma a name but no real power;
3. Twelve years later that name-only Duma became the Provisional Government's skeleton,
   while the Soviet became its rival — that's where "dual power" came from.`,
        },
        xiaoweiNote: {
          cn: `老师说这张卡是「1917 年的字幕」——不读 1905，1917 年的很多词你不知道从哪来的。
口诀：血腥星期日（1905.1.22）= 沙皇打碎了「小父亲」的形象，民心开始散；
十月宣言（1905.10）= 沙皇给了杜马一个名分，没给实权；
...
popular loyalty began to fracture; October Manifesto (Oct 1905) = the Tsar gave the
...
force — that's where dual power came from.`,
...

    {
      ...
      defCn: '1917 年 3 月（旧历二月，所以叫「二月革命」），彼得格勒纺织女工上街、士兵拒绝开枪、各方自发合力，把沙皇推翻了。没有一个政党在主导，是多方一起干的。',
      defEn: 'In March 1917 (Old Style February, hence "February Revolution"), Petrograd textile workers walked out, soldiers refused to fire on the crowd, and multiple groups together toppled the Tsar. No single party was in charge — it was spontaneous and multi-sided.',
      standardRef: ['AP World — Unit 7 (Topic 7.3-7.4)', 'AP World DBQ rubric'],
...
organized, November). Two revolutions, two natures — never collapse them into one sentence.`,
...

    {
      ...
      defCn: '1917 年 11 月（旧历十月，所以叫「十月革命」），布尔什维克这一个组织严密的政党，在列宁和托洛茨基带领下有计划地夺权，赶走了临时政府，宣布权力归苏维埃。',
      defEn: 'In November 1917 (Old Style October, hence "October Revolution"), the Bolsheviks — one tightly organized party — carried out a planned seizure of power under Lenin and Trotsky, ousting the Provisional Government and declaring power to the Soviets.',
...
"famous storming" of the Winter Palace is fake — the real event had almost no fighting.`,
...

    {
      ...
      defCn: '二月革命后沙皇退位，自由派和贵族组成的「临时政府」填上了权力空缺。它是名义上的政府，但工厂和军队的实际忠诚握在苏维埃手里，最终因坚持打一战、给不出和平/土地/面包而被十月革命推翻。',
      defEn: 'After the February Revolution and the Tsar\'s abdication, a "Provisional Government" of liberals and nobles filled the power vacuum. It was the government in name, but real loyalty from factories and the army stayed with the Soviet; it was ultimately overthrown by the October Revolution because it kept fighting WWI and could not deliver peace, land, or bread.',
...
frontline soldiers and home-front workers most wanted was to **stop the war**.

It couldn't deliver "bread" (the famine continued), "land" (it dared not touch the
landlords), or "peace" (it kept fighting) — it could give none of the three the Bolsheviks
promised.
...
最要命的是它还在打那场没人想打的仗。口诀：给不出「和平、土地、面包」的政府，撑不住。`,
          en: `Kerensky's story showed me why the Provisional Government fell: it could promise
...
can't deliver "Peace, Land, Bread" can't hold on.`,
...

    {
      ...
      termCn: '苏维埃',
      termEn: 'Soviet',
      defCn: '苏维埃（Soviet）的原意是「会议/代表会」，指工人和士兵选出来的代表机构。1917 年最重要的是彼得格勒苏维埃——它没有政府名分，却掌握着工厂和军队的实际忠诚。注意：苏维埃是会议，「苏联」是 1922 年才建立的国家，两件事。',
      defEn: '"Soviet" literally means "council" — a representative body elected by workers and soldiers. The most important one in 1917 was the Petrograd Soviet: no official government title, but it held real loyalty from the factories and the army. Note: a Soviet is a council; the "Soviet Union" (USSR) was a state only founded in 1922 — two different things.',
...
— five years apart.`,
...

    {
      ...
      termCn: '双重权力',
      termEn: 'dual power',
      defCn: '二月革命后到十月革命前，俄国有两个权力中心同时并立：临时政府（有名分但管不动军队）和彼得格勒苏维埃（没名分但工人士兵听它的）。谁也吃不下谁，这个局面叫「双重权力」。',
      defEn: 'Between the February and October Revolutions, Russia had two power centers side by side: the Provisional Government (official name, but couldn\'t command the army) and the Petrograd Soviet (no official title, but workers and soldiers actually listened to it). Neither could swallow the other — this was called "dual power."',
      standardRef: ['AP World — Unit 7', 'AP World DBQ rubric'],
      examFrequency: 'high',
      storyAnchor: {
        standaloneText: {
...
govern, giving the tightly organized Bolsheviks their opening.`,
        ...
        xiaoweiNote: {
          cn: `「双重权力」就像一个国家里同时有两个老板——一个穿西装坐办公室（临时政府），
一个在工厂里真正发号施令（苏维埃），中间一条裂缝。
口诀：一个有名分、一个有枪——裂缝里长出了布尔什维克。`,
          en: `"Dual power" is like one country with two bosses at once — one in a suit at a desk
(Provisional Government), one on the factory floor giving real orders (the Soviet), a crack
between them. Mnemonic: one has the name, the other has the guns — the Bolsheviks grew out
of that crack.`,
        },
      },
    },

    {
      ...
      termCn: '布尔什维克',
      termEn: 'Bolsheviks',
      defCn: '布尔什维克是列宁领导的激进派政党，组织严密、纪律强。他们在 1917 年大多数时候并不是人数最多的一派，但靠着「和平·土地·面包」这个口号和果断的行动，在十月革命时夺得了权力。',
      defEn: 'The Bolsheviks were the radical party led by Lenin — tightly organized and highly disciplined. For most of 1917 they were not the largest faction, but through the slogan "Peace, Land, Bread" and decisive action they seized power in the October Revolution.',
...
史学家至今还在争一个问题：他们到底是「真有群众基础」，还是「少数人在恰当时机的政变」？
这正是 DBQ 让你去拆解的张力。`,
...
Kornilov)."
Historians still debate: did they "truly have a mass base," or was it "a minority's seizure
at just the right moment"? That's exactly the tension a DBQ asks you to unpack.`,
        },
        xiaoweiNote: {
          cn: `布尔什维克工厂组织者的故事让我从内部看懂布尔什维克怎么赢：不是人最多，是**组织最紧、行动最快**。
口诀：少数派 + 紧组织 + 对口号 + 抓时机 = 夺权。`,
          en: `The factory organizer's story showed me from the inside how the Bolsheviks won:
...
+ tight organization + the right slogan + seized timing = power.`,
...

    {
      ...
      defCn: '布尔什维克和孟什维克原本是同一个政党（RSDLP）里的两派，1903 年因党的组织路线争论分家。布尔什维克走小团体精英路线、立即夺权；孟什维克走开放大党路线、先经历民主阶段。1917 年孟什维克随临时政府一起垮掉，布尔什维克夺了权。',
      defEn: 'The Bolsheviks and Mensheviks were originally two factions of one party (RSDLP), splitting in 1903 over how the party should be organized. Bolsheviks: small elite cadre, seize power immediately. Mensheviks: broad open party, go through a democratic phase first. In 1917 the Mensheviks fell with the Provisional Government; the Bolsheviks seized power.',
...
refused to cooperate and ended up seizing power.`,
...

    {
      ...
      defCn: '布尔什维克 1917 年的核心口号，三个词各自对准了一种人最痛的事：士兵要停战（和平）、农民要分地（土地）、城里工人要有饭吃（面包）。临时政府三样都给不出，所以失去了人心。',
      defEn: 'The Bolsheviks\' core 1917 slogan — three words, each aimed at one group\'s sharpest pain: soldiers wanted the war to stop (peace), peasants wanted land redistributed (land), city workers wanted food (bread). The Provisional Government couldn\'t deliver any of the three, and that\'s why it lost popular support.',
      standardRef: ['AP World — Unit 7', 'AP World DBQ rubric'],
      examFrequency: 'highest',
      storyAnchor: {
        standaloneText: {
...
bread; Kerensky kept fighting, so he could deliver none of them.`,
...

    {
      ...
      termCn: '四月提纲',
      termEn: 'April Theses',
      defCn: '1917 年 4 月，列宁流亡多年后乘封闭列车回到彼得格勒，一下车就宣布三条：不支持临时政府、一切权力归苏维埃、立刻退出一战。这三条把布尔什维克的方向彻底拨向夺权。',
      defEn: 'In April 1917, Lenin returned to Petrograd from years of exile on a sealed train and immediately announced three demands: no support for the Provisional Government, all power to the Soviets, and withdraw from WWI at once. These three points turned the Bolsheviks fully toward seizing power.',
      standardRef: ['AP World — Unit 7'],
      examFrequency: 'mid',
      storyAnchor: {
        standaloneText: {
...
Misconception trap: ❌ "Lenin led the revolution in Petrograd from the start" → ✅ when the
February Revolution broke out he was still in Swiss exile and **only returned in April** to
deliver the April Theses — he was not there from the beginning.
...
quit the war."`,
...

    {
      ...
      defCn: '1917 年 3 月 15 日（旧历 3 月 2 日），尼古拉二世在一节火车车厢里签字退位，结束了罗曼诺夫王朝 300 年的统治。他不是被强攻皇宫杀掉的——那是 1918 年内战时的另一件事。',
      defEn: 'On March 15, 1917 (OS March 2), Nicholas II signed his abdication in a railway carriage, ending 300 years of Romanov rule. He was not killed in a palace storming — that execution happened in 1918 during the civil war, a separate event.',
      standardRef: ['AP World — Unit 7', 'AP World DBQ rubric'],
      examFrequency: 'high',
      storyAnchor: {
        standaloneText: {
...
为什么他先把自己逼到这一步：1915 年他做了致命决定——**亲自去前线指挥军队**，
...
Why he had cornered himself first: in 1915 he made a fatal decision — to **take personal
command at the front** — so every defeat afterward was charged directly to him; meanwhile the
capital was left to Empress Alexandra and the "holy man" Rasputin, further hollowing out the
monarchy's prestige.

Misconception trap: ❌ "the Tsar was killed when a palace was stormed" → ✅ he **abdicated,
persuaded by his generals**, on a train in March 1917; he and his family were **executed**
during the civil war in 1918, a **separate matter** — don't merge it with the abdication.
...
(1918, in the civil war) — two events, a year apart.`,
...

    {
      ...
      defCn: '1918 年 3 月 3 日，布尔什维克政权为了兑现「和平」承诺，跟德国签了一份代价巨大的和约：割让约三分之一人口、一多半工业的土地，换来退出一战。但退出外战后，俄国紧接着就掉进了四年内战。',
      defEn: 'On March 3, 1918, the Bolshevik government signed a costly treaty with Germany to deliver on the "peace" promise: ceding territory with about a third of the empire\'s population and over half its industry in exchange for leaving WWI. But leaving the external war led straight into four years of civil war.',
      standardRef: ['AP World — Unit 7', 'APUSH Period 7'],
      examFrequency: 'mid',
      storyAnchor: {
        standaloneText: {
...
Irony: a revolution chanting "peace" only bought its way out of the **external war** by
ceding huge territory — and then fell straight into a four-year **civil war**. The word
"peace" was cashed out both really and bitterly.
...
turned into civil war.`,
...

    {
      ...
      defCn: '1918-1922 年，俄国退出一战后紧接着打了一场内战：布尔什维克的红军 vs 各种反布尔什维克力量组成的白军。红军最终赢了，但几百万人死于战斗、镇压和饥荒。同期俄国唯一一次自由选举出来的议会——制宪会议——只开了一天就被强行解散。',
      defEn: 'From 1918 to 1922, after leaving WWI, Russia immediately fought a civil war: the Bolsheviks\' Red Army vs a loose coalition of anti-Bolshevik forces called the Whites. The Reds won, but millions died in fighting, repression, and famine. During the same period, Russia\'s only freely elected national assembly — the Constituent Assembly — was forcibly dissolved after meeting for a single day.',
...
这段历史有两个面，必须同时看（考试两面都要写）：
- **解放那面**：女工点火、士兵倒戈、沙皇退位——几百万普通人真实的、自发的渴望；
- **专政那面**：就在内战前后，1918 年 1 月，俄国唯一一次自由选出的全国议会——
  **制宪会议**（布尔什维克只占约四分之一）——只开了一天（约 13 小时）就被强行解散。

「为了人民」推翻沙皇是打开自由；「为了人民」解散议会是关掉自由——
同一句话，两个相反方向，都发生在这一两年里。
...
This period has two faces — you need both (the exam expects you to write both sides):
- **The liberation face**: the textile workers lighting it, soldiers defecting, the Tsar
  abdicating — millions of ordinary people's real, spontaneous longing;
- **The dictatorship face**: right around the civil war, in January 1918, Russia's only freely
  elected national assembly — the **Constituent Assembly** (where the Bolsheviks held only
  about a quarter) — was forcibly dissolved after meeting for a single day (about 13 hours).

"For the people" overthrowing the Tsar opened freedom; "for the people" dissolving the
assembly shut freedom down — the same phrase, two opposite directions, both in these one or
two years.
...
高分写法：承认两边都有道理，再说明你为什么更倾向某一边——两面都摆上桌，说清楚你的权衡。`,
...
High-scoring move: acknowledge both have a point, then explain why you lean one way — put both
faces on the table and discuss your weighing of them.`,
...
miss? Argue with specific evidence from both revolutions.`,
      hintCn: `提示：这题考的就是「别把两场混成一场」这个高频考点。
- 二月的性质：没有总指挥，是女工、士兵、自由派、社会主义者一起自发把沙皇掀翻。
- 十月的性质：一个组织严密的政党在特定时机夺权——所以才会有「政变 vs 群众革命」的争论。
- 漏掉二月会漏掉：临时政府、双重权力、克伦斯基这个中间人——也就漏掉了「自由那扇门曾经打开过」。
不下最终道德结论，把两场的差别摆清楚就好。`,
      hintEn: `Hint: this tests the high-frequency point "don't blur the two into one."
...
- October's nature: one tightly organized party seizing power at a chosen moment — hence the
  "coup vs. mass revolution" debate historians still have.
...
Don't issue a final moral verdict; just lay out the difference between the two clearly.`,
...
all? Support your judgment with specific evidence.`,
      hintCn: `提示：好的答案会**同时持有两件事**，而不是二选一（这正是历史学家们一直在争的问题）。
- 「解放」一边：女工点火、士兵倒戈、沙皇退位——几百万普通人真实的、自发的行动。
- 「专政」一边：制宪会议（布尔什维克只占约四分之一）开一天被解散、随后的内战与镇压。
关键张力：同样一句「为了人民」，谁来定义「人民」？布尔什维克说苏维埃才算「真正的人民」，议会不算。
AP 要的是你能不能把两面都摆上桌，再谈你的权衡。`,
      hintEn: `Hint: a strong answer **holds two things at once** rather than choosing one
(this is exactly what historians argue over).
...
AP wants you to put both faces on the table and then discuss your weighing of them.`,
...
specific choices.`,
      hintCn: `提示：先把 Kerensky 的处境摆全——他不是单纯软弱，他是被结构夹死的。
...
进阶：你身边有没有「想让所有人都满意」反而两头不讨好的处境？那是软弱还是勇气？不下最终道德结论。`,
      hintEn: `Hint: first lay out Kerensky's full situation — he wasn't simply weak,
...
both sides? Is that weakness or courage? Don't issue a final moral verdict.`,
...
your own history comes from"?`,
      hintCn: `提示：这是整门课最重要的中国桥之一，但有一个关键边界要先讲清。
...
- **重要边界**：说「十月革命塑造了现代中国」是在**描述一条可确证的历史影响链**，
  这**不等于**在为这场革命的最终结果（无论你怎么评价）背书。**描述影响 ≠ 认可结果**。
对一个中美双语家庭的孩子，这是「外国历史」突然变成「自己历史源头」的时刻——但你评价它时，仍然两面都要看。`,
      hintEn: `Hint: this is one of the most important China connections in the whole course, but
there's a key boundary to state first.
...
- **Important boundary:** saying "the October Revolution shaped modern China" is
