  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ceo-n3'],
        xiaoweiNote: {
          cn: `这个我读过！在 CEO 那一遍第 3 节，他讲光有集装箱还不够，还需要一个让货物自由跨国流动的世界。

我把这条制度时间线背成一串：
1. **1944 年 Bretton Woods（布雷顿森林）会议**：二战刚打完，各国立下战后经济规矩，
   建了 **IMF（国际货币基金组织）** 和 **World Bank（世界银行）**（降关税的 **GATT** 协议则在几年后的 **1947 年**另签）。
...
1. **The 1944 Bretton Woods conference**: right after the war, nations laid down postwar
   economic rules, built the **IMF (International Monetary Fund)** and the **World Bank** (the
   tariff-cutting **GATT** agreement was signed separately a few years later, in **1947**).
...
accelerated globalization" — technology, institutions, geopolitics, all three at once.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ceo-n2'],
        xiaoweiNote: {
          cn: `CEO 那一遍第 2 节专门讲这个——而且它是全球化最容易被忽略、其实最关键的"物理地基"。
...
answer: the container.)`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['rb-n3'],
        xiaoweiNote: {
          cn: `锈带工人那一遍第 3 节讲到了——他后来才弄明白，为什么公司能这么干。
...
globalization" AP loves to test — one agreement, who gains and who loses.)`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `CEO 那一遍第 4 节是"你就是我"的高潮——你坐在会议室，墙上挂着世界地图，
...
one product, who benefits, who pays.)`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ceo-n8'],
        xiaoweiNote: {
          cn: `CEO 那一遍第 8 节专门讲那个改变了整盘棋的国家：中国。这一段中国是主角，老师说真实的中文术语可以直接用。
...
joining global supply chains). Both are true, don't write it one-sided.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['gw-n5', 'gw-n9'],
        xiaoweiNote: {
          cn: `制衣女工那一遍第 5 节和第 9 节最完整地讲了这一刀的两面——这是整门课最高频、也最适合 DBQ 的考点。

**红利那面（第 5 节）**：女工寄回老家的钱，落地长出了真东西——妹妹上了学、爹的病治了、土坯房换了不漏雨的屋顶。
故事接上真实数字：**从 1990 到 2010 年代，全世界活在极端贫困里的人，比例从大约 36% 降到了大约 10%。**
几亿个像她这样的人，一针一线把自己和家里"缝出了赤贫"。这是真实的红利，不是美化。

**代价那面（第 9 节 + 锈带那一遍）**：同一套体系也跑在不平等上。在富国，像俄亥俄那样被掏空的工业城市叫**锈带（Rust Belt）**；
...
is exactly the complexity AP scoring rewards.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['gw-n7'],
        xiaoweiNote: {
          cn: `制衣女工那一遍第 7 节讲了一件她每次想起都喘不上气的事——这是整门课里"便宜的代价"最具体、最沉的一张卡。
...
**环境后果**：全球供应链把工厂搬到劳动和环保标准最低的地方，结果是：全球碳排放随工业化国家增多而上升；跨国运输（远洋集装箱船、航空货运）本身消耗大量化石燃料；发展中国家承受更多工业污染——"污染天堂假说"（pollution haven hypothesis）。

**疾病与全球卫生**：人和货物的跨境流动也带着病原体跨境流动。1980s HIV/AIDS 沿着贸易和旅行网络快速蔓延成全球疫情（pandemic）；SARS（2003）、H1N1（2009）、Covid-19 都是全球互联让区域疫情变成全球危机的案例。国际机构（WHO）是全球化催生的卫生治理回应。

考点关键句：全球化加速了财富流动，也加速了污染与疾病的流动——同一张互联网络，跑的东西有好有坏。`,
        en: `AP World Unit 9.5-9.6 explicitly lists two "costs of globalization":

**Environmental consequences**: global supply chains moved factories to places with the lowest labor and environmental standards, resulting in rising global carbon emissions as more countries industrialize; transoceanic container ships and air freight consume large amounts of fossil fuels; developing nations absorb more industrial pollution — the "pollution haven hypothesis."

**Disease and global health**: the cross-border flow of people and goods carries pathogens across borders too. HIV/AIDS spread rapidly in the 1980s along trade and travel networks to become a global pandemic; SARS (2003), H1N1 (2009), and Covid-19 are all cases where global connectivity turned a regional outbreak into a global crisis. International institutions (WHO) are the global governance response that globalization itself produced.
...
Key exam sentence: globalization accelerated the flow of wealth and also the flow of pollution and disease — the same interconnected network carries both good and bad.`,
      ...
      xiaoweiNote: {
        cn: `老师说 AP 9.5-9.6 这两条在 SAQ 和 DBQ 经常配对出现——"全球化的代价"题几乎必考环境 + 卫生这两块。
口诀：**全球化让东西跑得更快——好东西（货物、资本、信息）跑得快，坏东西（碳排放、病毒、污染）也跑得快。**`,
        en: `Teacher said AP 9.5-9.6 often appear together in SAQs and DBQs — "costs of globalization" questions almost always include environment + health as a pair.
Mnemonic: **globalization makes everything move faster — the good (goods, capital, information) moves faster, and so does the bad (carbon emissions, viruses, pollution).**`,
      },
    },
...
- **经济移民**：从低工资国家移向高工资国家（如从拉丁美洲到美国、从南亚到海湾国家），汇款（remittances）成为很多发展中国家的重要收入来源。
- **难民与被迫流离**：战争、气候灾难、经济崩溃也推动大量非自愿移民。

**结构调整方案（SAP, Structural Adjustment Programs）**：1980-1990s IMF 和世界银行向债务危机国家（多为非洲、拉美）提供贷款，条件是"结构调整"——削减政府开支、私有化国有企业、开放市场、取消补贴。
批评者说：SAP 让穷国为还债削减教育和医疗，加剧了不平等；支持者说：它推动了市场开放和财政纪律。这是 AP 考"对全球化的反应"的标准对立素材。
...
- **Economic migrants**: moving from low-wage to high-wage countries (e.g., Latin America to the US, South Asia to Gulf states); remittances became a major income source for many developing nations.
- **Refugees and forced displacement**: war, climate disasters, and economic collapse also drive large involuntary movements.

**Structural Adjustment Programs (SAPs)**: in the 1980s-1990s, the IMF and World Bank loaned money to countries in debt crisis (mostly Africa, Latin America) on condition of "structural adjustment" — cut government spending, privatize state enterprises, open markets, remove subsidies.
Critics: SAPs forced poor nations to slash education and healthcare to repay debt, deepening inequality. Supporters: they promoted market openness and fiscal discipline. This is the standard AP "responses to globalization" debate material.
...
记忆钩：**移民 = 人跟着工作跑**（资本去找劳动力，劳动力也去找资本）；**SAP = 救钱的同时削人**（财政稳了，教育和医疗先割）。`,
        en: `Migration and SAP are the two most often missed from AP 9.6-9.7 — because the story's three lenses focus on the production side and don't directly cover these.
...
🔗 故事连接：CEO 那一遍第 6 节那件 T 恤、那部手机，本身就是文化全球化的物质载体——
一件商品跨越国界，也带着它的品牌、款式、生活方式一起跨过去；
制衣女工那一遍第 1 节，她缝的衣服漂洋过海，挂进她永远不会去的国家的商场，正是这种跨国流动的另一端。
...
and ways of life"** — two threads driven by the same technology and free flow.`,
  ...
  thinkingQuestions: [
    {
      id: 'q1',
      cn: `全球极端贫困率从大约 36%（1990）降到大约 10%（2010 年代），几亿人脱了贫；
...
which side you pick.
- Evidence for "poverty-reduction machine": extreme poverty ~36%→~10%, China's roughly 800 million
