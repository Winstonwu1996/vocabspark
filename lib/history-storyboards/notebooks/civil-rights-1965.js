...
这个 Topic 在 AP 里特别重——APUSH Period 8 一定考，AP 政府课里
...
🔗 跨 Topic 长线（这是 DBQ 的金线）：平等保护这条，早在 **1868 年**
内战刚打完那阵就写进了宪法（你跑过 reconstruction 那个 Topic 就懂这条根）。
...
door in 1963.`,
      ...
      xiaoweiNote: {
        cn: `老师说这张卡是整个 Topic 的「最高频考点」——Brown 是 AP 政府课
...
变成一套真能打仗的策略（你在 Lens 2 第 3 节读到过）。
...
（你在 Lens 3 第 3 节读到「更年轻、更激进的学生组织」就是它）。
...
「隔离」长什么样，舆论一下子倒向游行者。
（你在 Lens 1 第 5 节，从挡门的华莱士那边读到过这段。）
...
（你在 Lens 2/Lens 3 读到，挨打不还手要反复训练才做得到）。
...
it's not a simple right-or-wrong.`,
    ...
    // ── 7. Civil Rights Act 1964 + Selma/Voting Rights Act 1965（故事覆盖型：selma-teen）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Selma 这条线（Lens 3）讲到了 Selma 和投票权法案。重点提炼，
...
你在 Lens 3 第 9 节读到「一生画了一个没合上的圆」就是这个意思。
...
1. **非暴力技术的引进者**：1940 年代他去印度研究甘地的非暴力，
   ...
   后来手把手教 MLK（你在 Lens 2 第 2、3 节读到）。
