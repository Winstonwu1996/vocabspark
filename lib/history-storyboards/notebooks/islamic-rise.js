...
人名清单：
穆罕默德（Muhammad），马蒙（al-Ma'mun），花剌子米（al-Khwarizmi），法蒂玛·菲赫里（Fatima al-Fihri）
...
Name list:
Muhammad, al-Ma'mun, al-Khwarizmi, Fatima al-Fihri

Place names:
Mecca, Medina

Term list:
Five Pillars of Islam, Caliph, Abbasid dynasty, House of Wisdom (Bayt al-Hikma), Hijra (622 CE migration)
...
Teacher reminded me: so many names in this unit are hard to pronounce — mark the pronunciation first, because multiple choice tests will use the actual names. I'll use this list to preview, then come back after the three story perspectives and see how many I can explain.`,
    ...
    keyFigures: [
      ...
      },
      {
        ...
        nameEn: "al-Ma'mun",
        ipa: '/æl mæˈmuːn/',
        roleCn: '阿巴斯王朝第七任哈里发，智慧宫的扩建者与翻译运动主推手',
        roleEn: 'Seventh Abbasid Caliph, who expanded the House of Wisdom and drove the Translation Movement',
        mustKnow: true,
        audioKey: 'al-mamun',
      },
      {
  ...
  mainConcepts: [
    // ── 卡 1：穆罕默德生平（standaloneText，故事未覆盖）────────
    {
      ...
      defCn: '穆罕默德是伊斯兰教的创始人，约 570 年生于麦加。他 40 岁时收到神启，开始传播一神信仰，622 年迁往麦地那建立了第一个伊斯兰社区，632 年去世。',
      defEn: 'Muhammad is the founder of Islam, born around 570 CE in Mecca. He received his first divine revelation at age 40, began preaching monotheism, migrated to Medina in 622 CE to build the first Islamic community, and died in 632 CE.',
...
My mnemonic: **570-610-622-632** — the gaps keep shrinking: first add 40, then 12, then 10. That makes it harder to mix up.`,
    ...
    // ── 卡 2：伊斯兰五功（standaloneText，故事未覆盖）──────────
    {
      ...
      defCn: '伊斯兰五功是每位穆斯林必须做到的五件事：① 念清真言（承认只有安拉是神），② 每天五次礼拜，③ 天课（把收入的一部分捐给穷人），④ 斋月期间白天禁食，⑤ 一生至少一次前往麦加朝圣。这五件事加在一起构成了伊斯兰信仰的骨架。',
      defEn: 'The Five Pillars of Islam are the five things every Muslim must practice: ① Shahada (declaring there is only one God, Allah), ② Salat (praying five times daily), ③ Zakat (giving a portion of income to the poor), ④ Sawm (fasting during Ramadan), and ⑤ Hajj (pilgrimage to Mecca at least once in a lifetime). Together, these five duties form the core structure of Islamic faith.',
...
Multiple choice trap: if the question asks "which pillar best represents Islamic egalitarianism," answer **Zakat** — not Hajj. Hajj is about unified faith; Zakat is directly about giving money to the poor.`,
    ...
    // ── 卡 3：622 年 Hijra（standaloneText，故事未覆盖）─────────
    {
      ...
      defCn: '希吉拉（Hijra）是 622 年穆罕默德带着早期信众从麦加迁往麦地那的那次迁徙。这不只是一次逃亡——它是伊斯兰历法的元年起点，也是伊斯兰从一个宗教运动变成有政治权力的国家的转折点。',
      defEn: 'The Hijra is the migration Muhammad led in 622 CE, moving from Mecca to Medina with his early followers. It was more than an escape — it marks Year One of the Islamic calendar and the turning point when Islam transformed from a religious movement into a community with political power.',
...
Exam note: if you see "AH" (Anno Hegirae), it means "Year X after the Hijra" — that's how Islamic calendar years are labeled.`,
      ...
      xiaoweiNote: {
        cn: `Hijra 是这个单元里 AP 考得最多的单独事件——它同时是 ① 伊斯兰历元年、② 政教合一的起点、③ 伊斯兰从宗教变成国家的转折点。三个功能一次记完。

记忆技巧：**622 = 六·二·二 = "六弦吉他两根弦"**，反正就是记住 622 年，考题不管问哪个角度，答案都和这个年份有关。`,
        en: `Hijra is the single event AP tests most in this unit — it's simultaneously ① Year One of the Islamic calendar, ② the starting point of political-religious fusion, and ③ the turning point from religion to statehood. Three functions, one memory slot.
...
Memory trick: just lock in **622 CE**. Whatever angle the test question comes from, the answer connects to this year.`,
    ...
    // ── 卡 4：早期扩张与哈里发制度（standaloneText，故事未覆盖）──
    {
      ...
      defCn: '哈里发（Caliph）是穆罕默德去世后的继承者，同时是宗教领袖和政治军事领袖。穆斯林帝国先后经历三个王朝：正统哈里发（632-661）→ 倭马亚王朝（661-750）→ 阿巴斯王朝（750-1258），版图从阿拉伯半岛扩展到今天的西班牙、伊朗和中亚。',
      defEn: 'The Caliph was the successor to Muhammad who held both religious authority and political-military power. The Muslim empire passed through three dynasties: Rashidun (632-661) → Umayyad (661-750) → Abbasid (750-1258), expanding from the Arabian Peninsula to what is now Spain, Iran, and Central Asia.',
      standardRef: ['AP World KC-1.2', 'CA HSS 7.2.4'],
      examFrequency: 'high',
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'al-mamun', nodeId: 'al-mamun-N1', context: '马蒙是阿巴斯王朝第七任哈里发，故事开场交代王朝背景' },
        ],
      },
      standaloneText: {
...
**阿巴斯王朝（Abbasid Caliphate，750-1258 年）**——推翻倭马亚，首都迁到巴格达。这是伊斯兰黄金时代的主要舞台，故事里的马蒙（第七任阿巴斯哈里发）就在这个阶段大力扩建了智慧宫（前身是 Harun al-Rashid 时期的图书馆）。
...
**Abbasid Caliphate (750-1258 CE)** — Overthrew the Umayyads; capital moved to Baghdad. This is the main stage of the Islamic Golden Age. The story's protagonist al-Ma'mun (seventh Abbasid Caliph) greatly expanded the House of Wisdom during this period (its predecessor was a library from the time of Harun al-Rashid).
...
My mnemonic: **R-U-A, capitals moved from Medina→Damascus→Baghdad, kept moving east.** Baghdad is farthest east — that's where the Golden Age happened.`,
    ...
    // ── 卡 5：马蒙与智慧宫（storyAnchor，Lens 1 已覆盖）──────────
    {
      ...
      defCn: '伊斯兰黄金时代（约 750-1258 年）是阿巴斯王朝统治期间科学、数学、医学、文学高速发展的时期。其中心是马蒙在巴格达大力扩建的智慧宫（Bayt al-Hikma，前身是 Harun al-Rashid 时期初建的翻译机构与图书馆）——这里把希腊、印度、波斯的典籍翻译成阿拉伯语，保存并传播了大量古代知识。',
      defEn: 'The Islamic Golden Age (roughly 750-1258 CE) was a period of rapid advances in science, math, medicine, and literature under the Abbasid Caliphate. Its center was the House of Wisdom (Bayt al-Hikma) in Baghdad, greatly expanded by Caliph al-Ma\'mun (its predecessor was a translation institution and library begun under Harun al-Rashid), where scholars translated Greek, Indian, and Persian texts into Arabic, preserving and spreading ancient knowledge.',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个在第一个视角里讲得很完整。马蒙（阿巴斯王朝第七任哈里发）在巴格达把智慧宫（Bayt al-Hikma）扩建成了 9 世纪最厉害的学术机构（前身是 Harun al-Rashid 时期的图书馆），把希腊文、梵文、波斯文的典籍全部翻译成阿拉伯语。
...
还有一个常被引用的传说："马蒙按译稿等重的黄金酬谢翻译者"——一本书译完，按书的重量给等重的黄金。但要小心：这其实是 19 世纪欧洲东方学（Orientalist）浪漫化的传闻，现代学界（Gutas 1998）已基本否定。真实情况是制度化的高薪职业——像 Hunayn ibn Ishaq 这样的译者每月领固定高薪、配抄写员，不是奇观式的"等重黄金"。这反而更说明翻译是阿巴斯王朝的国家级工程。`,
          en: `This was covered thoroughly in the first perspective. al-Ma'mun (seventh Abbasid Caliph) expanded the House of Wisdom (Bayt al-Hikma) in Baghdad into the most powerful academic institution of the 9th century (its predecessor was a library from the time of Harun al-Rashid), translating Greek, Sanskrit, and Persian texts into Arabic.
...
One often-quoted legend: that al-Ma'mun paid translators "gold equal in weight to the manuscript" — a book's weight in gold once it was translated. But be careful: this is a 19th-century European Orientalist romanticization, largely discredited by modern scholarship (Gutas 1998). The reality was institutionalized high-salary employment — translators like Hunayn ibn Ishaq drew a fixed monthly salary with assigned scribes, not spectacle "weight-in-gold" pay. That actually shows even better that translation was a state-level project of the Abbasid Caliphate.`,
        },
      },
    },
    ...
    // ── 卡 6：花剌子米与代数学（storyAnchor，Lens 2 已覆盖）──────
    {
      ...
      defCn: '花剌子米是 9 世纪在巴格达智慧宫工作的数学家。他写的书名里有"al-jabr"这个词，这就是英文"algebra（代数）"的来源。他还把印度数字系统（0-9）介绍到阿拉伯学术界，他名字的拉丁语拼法"Algoritmi"后来变成了"algorithm（算法）"这个词。',
      defEn: 'al-Khwarizmi was a 9th-century mathematician who worked at the House of Wisdom in Baghdad. The title of his book contained the word "al-jabr," which is the origin of the English word "algebra." He also introduced the Indian numeral system (0-9) to Arabic scholarship, and the Latin form of his name, "Algoritmi," became the word "algorithm."',
      standardRef: ['AP World KC-1.2', 'CA HSS 7.2.6'],
      examFrequency: 'mid',
      storyAnchor: {
        covered: true,
...
Exam point: al-Khwarizmi represents the Islamic Golden Age's **synthesis of knowledge** — he combined the Indian number system (0-9 positional notation), Greek geometry, and local mathematical traditions to create a universal computational language. AP loves testing "how Islamic scholars synthesized knowledge from different civilizations."`,
    ...
    // ── 卡 7：法蒂玛与 al-Qarawiyyin（storyAnchor，Lens 3 已覆盖）─
    {
      ...
      defCn: '法蒂玛·菲赫里是 9 世纪的女性学者。她在 859 年用父亲的遗产，在摩洛哥的非斯城创办了 al-Qarawiyyin 大学。联合国教科文组织认定这是世界上至今仍在运营的最古老大学，比欧洲第一所大学博洛尼亚早约 200 年。',
      defEn: 'Fatima al-Fihri was a 9th-century female scholar who used her father\'s inheritance to found al-Qarawiyyin University in Fes, Morocco, in 859 CE. UNESCO recognizes it as the oldest continuously operating university in the world — about 200 years older than Bologna, Europe\'s first university.',
      standardRef: ['AP World KC-1.2', 'CA HSS 7.2.6'],
      examFrequency: 'mid',
      storyAnchor: {
        covered: true,
        lens: 'fatima-al-fihri',
...
One big context to remember from this card: Islamic civilization's attitude toward **women's participation in religious scholarship** in the 9th century was significantly more open than contemporaneous Christian Europe — Europe's first university didn't appear until the 12th century, and opened to women even later. Fatima's story is the defining example of this contrast.`,
    ...
    // ── 卡 NEW-A：逊尼-什叶分裂（standaloneText，故事未覆盖）────────
    {
      id: 'sunni-shia-split',
      termCn: '逊尼-什叶分裂',
      termEn: 'Sunni-Shia Split',
      defCn: '逊尼派和什叶派是伊斯兰教的两大分支，起因是 632 年穆罕默德去世后的继承权之争。逊尼派认为领袖应由社区推选最有能力的人，什叶派则坚持领袖必须是穆罕默德的血亲后代。今天全球约 85-90% 的穆斯林是逊尼派，10-15% 是什叶派。',
      defEn: 'Sunni and Shia are the two main branches of Islam, originating from a dispute over who should succeed Muhammad after his death in 632 CE. Sunnis believed the leader should be elected by the community; Shia believed leadership must stay within Muhammad\'s bloodline. Today about 85-90% of the world\'s Muslims are Sunni and 10-15% are Shia.',
      standardRef: ['AP World KC-1.2', 'CA HSS 7.2.4'],
      examFrequency: 'high',
      storyAnchor: {
        covered: false,
      ...
      standaloneText: {
        cn: `伊斯兰最大历史分裂，起点是继承权之争。

**632 年**穆罕默德去世，没有指定继承人，社区出现两派：

**逊尼派（Sunni）**：领袖应由社区推选最有能力的人。支持岳父阿布·伯克尔出任第一任哈里发。"Sunni"源自"Sunna"（先知传统），强调共识和法学权威。

**什叶派（Shia）**："Shiat Ali（阿里追随者）"缩写。坚持领袖必须出自穆罕默德血亲——堂弟兼女婿阿里（Ali ibn Abi Talib）。

**决定性事件 — 680 年卡尔巴拉之战（Battle of Karbala）**：阿里之子侯赛因（Husayn）拒绝效忠倭马亚哈里发，被围杀于伊拉克卡尔巴拉。侯赛因殉难成为什叶派最核心的历史记忆；阿舒拉节（Ashura）每年悼念此事。

**神学差异**：逊尼派哈里发是行政领袖，不需神圣血统；什叶派伊玛目（Imam）必须有穆罕默德血统，具神圣解经权威。

**现状**：全球穆斯林约 85-90% 逊尼，10-15% 什叶；什叶主要分布在伊朗、伊拉克、黎巴嫩。`,
        en: `Islam's largest historical schism began as a succession dispute.

**In 632 CE**, Muhammad (founder of Islam) died without designating a successor. The community immediately divided into two positions:

**One faction** held that leadership should be determined by community election — choosing the most capable person. They backed Abu Bakr (Muhammad's father-in-law, the first Rashidun Caliph). This group eventually became the **Sunni** branch. "Sunni" derives from the Arabic "Sunna," meaning the Prophet's practice/tradition; Sunnis emphasize following prophetic practice and community consensus.

**The other faction** held that leadership must belong to Muhammad's bloodline — specifically his cousin and son-in-law Ali ibn Abi Talib. This group eventually became the **Shia** branch. "Shia" is short for "Shiat Ali" (partisans of Ali).

**Decisive events**:
- **656-661 CE**: Ali served as the fourth Caliph but faced civil war and was ultimately assassinated.
- **680 CE — Battle of Karbala**: Ali's son Husayn ibn Ali refused to pledge loyalty to the Umayyad Caliph and was besieged and killed with a small band of followers in Karbala (modern Iraq). Husayn's martyrdom became the central historical memory of Shia Islam — Ashura, the annual day of mourning for Husayn, is one of Shia Islam's most important religious observances.

**Theological differences (key for AP exams)**:
- Sunni: the Caliph is an administrative leader and need not have divine lineage; authority derives from consensus and legal tradition (Sharia).
- Shia: the Imam must carry Muhammad's bloodline and holds divinely sanctioned authority to interpret religion; Husayn's martyrdom is a theological symbol of suffering and redemption.

**Today's distribution**: approximately 85-90% of the world's Muslims are Sunni, 10-15% Shia; Shia populations are concentrated in Iran, Iraq, Lebanon, and Bahrain.`,
      },
      xiaoweiNote: {
        cn: `AP 考试一定出——选择题常问"逊尼和什叶的分裂根本原因是什么？"
标准答案：**继承权之争**（谁有资格当穆罕默德的继承人），不是神学分歧。神学差异是后来发展出来的，起点是政治问题。

记忆对比：
- 逊尼（Sunni）= "社区推选、共识优先" = 多数派（~85-90%）
- 什叶（Shia）= "血统继承、阿里家族" = 少数派（~10-15%）

卡尔巴拉（Karbala）+ 680 年 + 侯赛因殉难——这三个记住，AP 题经常拿卡尔巴拉事件考什叶派神学的情感根源。`,
        en: `Guaranteed on the AP exam — multiple choice often asks: "What was the fundamental cause of the Sunni-Shia split?"
Standard answer: **a succession dispute** (who was entitled to succeed Muhammad), not a theological disagreement. Theological differences developed later; the starting point was a political question.

Quick contrast:
- Sunni = "community election, consensus first" = majority (~85-90%)
- Shia = "bloodline succession, Ali's family" = minority (~10-15%)

Karbala + 680 CE + Husayn's martyrdom — memorize these three. AP frequently uses the Karbala event to test the emotional foundation of Shia theology.`,
      },
    },
    ...
    // ── 卡 8：伊斯兰知识传播与跨文化交流（storyAnchor，三个视角均覆盖）
    {
      ...
      defCn: '伊斯兰黄金时代的学者把希腊、印度、波斯的知识翻译整理成阿拉伯文，再通过贸易网络传遍世界。这些知识后来传回欧洲，成为文艺复兴的重要来源之一。伊斯兰帝国地跨三大洲的地理位置、统治者的资金支持、以及阿拉伯语作为统一学术语言，是这场知识传播的三大原因。',
      defEn: 'During the Islamic Golden Age, scholars translated and organized Greek, Indian, and Persian knowledge into Arabic, then spread it across the world through trade networks. This knowledge later reached Europe and became one of the key sources of the Renaissance. The three main reasons for this spread were: geography (the Islamic empire spanned three continents), political will (rulers funded scholars and libraries), and linguistic unity (Arabic served as a common academic language).',
      standardRef: ['AP World KC-1.2', 'CA HSS 7.2.6'],
      examFrequency: 'high',
      storyAnchor: {
        covered: true,
...
Classic AP DBQ angle: Was Islamic civilization a "cultural preserver" (translation preserved the Greek legacy) or a "cultural innovator" (original contributions in algebra, astronomy, medicine)? — The answer is **both**, which is exactly the nuanced perspective AP wants to see.`,
  ...
  thinkingQuestions: [
    {
      id: 'tq1',
      cn: `马蒙（阿巴斯王朝第七任哈里发）花了巨资大力扩建智慧宫（前身是上一代初建的翻译机构），翻译希腊、印度、波斯的典籍。有历史学家说他这样做是为了"追求真理"，也有历史学家说他是想用知识巩固政治权威。

你觉得这两种解释可以同时成立吗？一个统治者可以既真诚地热爱知识，又把知识当政治工具吗？请用至少一个具体例子支持你的回答。`,
      en: `al-Ma'mun (seventh Abbasid Caliph) spent enormous resources greatly expanding the House of Wisdom (which an earlier caliph had first founded) and translating Greek, Indian, and Persian texts. Some historians say he did this "in pursuit of truth"; others say he used knowledge to consolidate political authority.
...
Many great movements in history began with persecution and flight. Can you think of another similar example? Why does "being forced to leave" sometimes help a movement grow stronger? What does this pattern reveal?`,
      hintCn: `提示：想几个方向——① 早期基督教：耶稣被钉十字架后，他的追随者被罗马帝国迫害，最终基督教从一个小教派变成罗马国教；② 中国历史：长征（1934-1935）毛泽东带着红军从江西突围，这次"逃亡"重塑了党的领导层，也成为中共建党神话的核心；③ 犹太民族：多次流散（Diaspora）反而强化了犹太身份认同。问自己：危机什么时候会消灭一个运动，什么时候会强化它？有什么决定性因素？`,
      hintEn: `Hint: think in a few directions — ① Early Christianity: after the crucifixion, Jesus's followers were persecuted by the Roman Empire, and Christianity eventually transformed from a small sect to the Roman state religion; ② Chinese history: the Long March (1934-1935), Mao Zedong breaking out from Jiangxi — this "flight" reshaped party leadership and became the central myth of the CCP's founding; ③ Jewish people: multiple Diasporas actually reinforced Jewish identity. Ask yourself: when does crisis destroy a movement, and when does it strengthen it? What factors make the difference?`,
