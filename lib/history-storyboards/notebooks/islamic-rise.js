...
My mnemonic: **R-U-A, capitals moved from Medina→Damascus→Baghdad, kept moving east.** Baghdad is farthest east — that's where the Golden Age happened.`,
    ...
    // ── 卡 5：马蒙与智慧宫（storyAnchor，Lens 1 已覆盖）──────────
    {
      ...
      defCn: '伊斯兰黄金时代（约 750-1258 年）是阿巴斯王朝统治期间科学、数学、医学、文学高速发展的时期。其中心是马蒙在巴格达建立的智慧宫（Bayt al-Hikma）——这里把希腊、印度、波斯的典籍翻译成阿拉伯语，保存并传播了大量古代知识。',
      defEn: 'The Islamic Golden Age (roughly 750-1258 CE) was a period of rapid advances in science, math, medicine, and literature under the Abbasid Caliphate. Its center was the House of Wisdom (Bayt al-Hikma) in Baghdad, founded by Caliph al-Ma\'mun, where scholars translated Greek, Indian, and Persian texts into Arabic, preserving and spreading ancient knowledge.',
