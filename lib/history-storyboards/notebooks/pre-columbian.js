...
20 世纪末的学者更倾向后者：她约 8 岁时首次被卖为奴隶，
1519 年转给科尔特斯时约 19 岁，从未有过选择说"不"的权力。
...
she was first sold into slavery at around age 8, and was approximately 19 years old
when given to Cortés in 1519 — she never had the power to say no.
...
Maya = intellectual city-states.** Nine words, three civilizations, core feature each.`,
    ...
    // ── 卡 8 ── 哥伦布大交换（Columbian Exchange）框架（故事未覆盖 → standalone）
    {
      ...
      storyAnchor: {
        covered: false,
        mentionedIn: [
          { lens: 'malintzin-lonely-mediator', nodeId: 'malintzin-N8', context: '马林钦视角末段看见西班牙人带来的牲畜和疾病，暗示接触后的双向交换' },
          { lens: 'ix-mutal-ahau-receiving-end', nodeId: 'maya-N9', context: '玛雅视角尾声中隐含的人口崩溃' },
        ],
      },
      standaloneText: {
        cn: `"哥伦布大交换"（Columbian Exchange）是 AP World KC-4.1/4.2 的核心框架术语，
指 1492 年哥伦布"接触"美洲之后，旧世界（欧亚非）与新世界（美洲）之间
大规模双向交换动植物、疾病和人口的历史过程。这个词由历史学家 Alfred Crosby
在 1972 年的同名著作中提出，是 AP 考试最高频的框架概念之一。
...
- 谷物和蔬菜：小麦、大麦、甘蔗、香蕉
- 最毁灭性的一项：天花（smallpox）、麻疹（measles）、流感等欧洲疾病。
  美洲原住民对这些疾病没有任何免疫力，某些地区在 100 年内人口减少了 50%-90%。
  这是人类史上最严重的疾病导致的人口崩溃。

新世界 → 旧世界（欧亚非）：
- 主粮作物：玉米（maize）、马铃薯（potato）、番薯、木薯（cassava）
  这些高产作物传入欧洲和亚洲后，支撑了旧世界的人口爆炸。
  18-19 世纪欧洲人口增长的物质基础，很大程度上来自美洲作物。
- 其他：番茄、辣椒、可可（巧克力原料）、橡胶、烟草
- 梅毒（syphilis）：从美洲传入欧洲，16 世纪横扫欧洲。

**为什么这是 AP 必考框架**

1. Causation（因果）：欧洲为什么能征服美洲？军事力量是一部分，
   但疾病才是决定性的——天花到达时，阿兹特克和印加的人口已经崩溃，
   社会结构瓦解，西班牙人面对的是已被疾病击倒的对手。
2. Continuity and Change：接触前美洲 vs 接触后美洲——人口、土地使用、
   物种分布全部剧变；但原住民的文化、语言、记忆并未消失，
   这是 AP 要求的"continuity in the face of change"。
3. Comparison：旧世界因美洲作物而人口增长，新世界因欧洲疾病而人口崩溃——
   同一个"交换"对两端的影响完全相反，这是最典型的 DBQ 多视角素材。
...
考点关键句：哥伦布大交换是 1492 年之后最深刻的全球生态和人口变革，
它的后果在两端截然不同——对旧世界是人口红利，对新世界是人口灾难。`,
        en: `"Columbian Exchange" is the core framework term for AP World KC-4.1/4.2.
It refers to the massive, bidirectional exchange of plants, animals, diseases, and people
between the Old World (Eurasia and Africa) and the New World (the Americas) that followed
Columbus's 1492 "contact." The term was coined by historian Alfred Crosby in his 1972 book
of the same name, and is one of the highest-frequency framework concepts on AP exams.

**Why "exchange" — it was bidirectional**

Old World to New World (Americas):
- Livestock: horses, pigs, cattle, sheep, chickens. Before contact the Americas had only small
  domesticated animals such as the Andean llama and alpaca — no large draft animals or mounts like
  horses and cattle; the arrival of horses transformed Plains cultures entirely.
- Grains and produce: wheat, barley, sugarcane, bananas.
- Most destructive: smallpox, measles, influenza, and other European diseases.
  Indigenous Americans had no immunity to these; in some regions, populations fell
  50-90% within a hundred years. This was the most severe disease-driven population
  collapse in recorded human history.

New World to Old World (Eurasia and Africa):
- Staple crops: maize, potato, sweet potato, cassava. These high-yield crops entering
  Europe and Asia supported Old World population explosions. Much of Europe's 18th-19th
  century population growth rested materially on American crops.
...
1. Causation: why could Europe conquer the Americas? Military force was part of it, but
   disease was decisive — when smallpox arrived, Aztec and Inca populations had already
   collapsed and social structures had broken down. The Spanish faced opponents already
   brought down by disease.
2. Continuity and Change: pre-contact Americas vs post-contact Americas — population,
   land use, and species distribution all changed radically; but indigenous cultures,
   languages, and memory did not disappear. That is the "continuity within change" AP requires.
3. Comparison: the Old World gained population from American crops; the New World lost
   population to European disease. The same "exchange" had opposite effects on each end —
   the quintessential DBQ multi-perspective material.

**Key figures (AP multiple choice)**

- Pre-contact Indigenous American population: estimated 50 million to 100 million
  (debated; AP does not require a precise number)
- By around 1600, disease and conquest had reduced indigenous populations by 50-90%
  in some regions
- After maize and potato entered the Old World, both European and Chinese populations
  grew significantly within two centuries

Key exam sentence: the Columbian Exchange was the deepest ecological and demographic
transformation of the world after 1492, with entirely opposite outcomes on each end —
a population dividend for the Old World, a population catastrophe for the New World.`,
      },
      xiaoweiNote: {
        cn: `老师说"哥伦布大交换"这个词是考试里的框架术语，不是普通词汇——
选择题如果出现"Columbian Exchange"，题目的核心一定在"双向 + 不对称"上：
旧世界和新世界交换了东西，但后果完全不同。

记忆口诀：**"旧世界送疾病，新世界送粮食——两边都没料到这些东西会到来。"**

还有一个常考陷阱：天花不是西班牙人"故意"带来的（不像后来有些殖民者故意传播），
但它造成的死亡比所有战争加在一起还多。AP 不让你评判意图，让你分析后果。

马铃薯（potato）原产安第斯，玉米（maize）原产中美洲，
两者经哥伦布大交换传入旧世界——这是本课地理农业卡的知识和这张卡的知识要连在一起用。`,
        en: `Teacher said "Columbian Exchange" is a framework term in exams, not ordinary vocabulary —
when it appears in multiple choice, the question always turns on "bidirectional + asymmetric":
Old World and New World exchanged things, but the consequences were completely different.

Mnemonic: "Old World sent disease; New World sent food — neither side expected what was coming."

A common exam trap: smallpox was not deliberately introduced by the Spanish (unlike some later
colonial actors), but it killed more people than all the wars combined. AP doesn't ask you to judge
intent — it asks you to analyze consequences.

Potato (native to the Andes) and maize (native to Mesoamerica) both reached the Old World through
the Columbian Exchange — this card's knowledge connects directly to the geography-and-agriculture
card in this same notebook.`,
      },
    },
