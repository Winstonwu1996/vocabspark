  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['rb-n1', 'rb-n5'],
        xiaoweiNote: {
          cn: `这个我读过！铁路巨头 Lens 第 1 节就是接轨那一刻，第 5 节讲它有多了不起。
...
that had been others' home for generations.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['wh-n3', 'wh-n4'],
        xiaoweiNote: {
          cn: `华工·拓荒户 Lens 第 3 节讲拓荒户怎么被它吸引来，第 4 节是"你就是 TA"的拷问。
...
defined "a home where people lived" as "empty land no one wanted."`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['wh-n2', 'wh-n8'],
        xiaoweiNote: {
          cn: `华工·拓荒户 Lens 第 2 节专讲修铁路的华工，第 8 节讲他们后来怎么被对待。
...
and doesn't unpack it.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['pn-n4', 'pn-n7'],
        xiaoweiNote: {
          cn: `Lakota Lens 第 4 节讲野牛被打光的过程，第 7 节讲为什么这不全是意外，最戳人。
...
"said" any one line.)`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['pn-n3', 'pn-n8'],
        xiaoweiNote: {
          cn: `Lakota Lens 第 3 节讲条约怎么来的，第 8 节讲被赶进保留地以后的日子。
...
manifest-destiny-1845 — a treaty is not real protection.)`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['pn-n5', 'pn-n9'],
        xiaoweiNote: {
          cn: `Lakota Lens 第 5 节是 Little Bighorn 大胜，第 9 节是 Wounded Knee 的结局。
...
🔗 故事连接：Lakota Lens 第 8 节，他亲口讲这一刀砍的是"我们活法的命根"；
铁路巨头 Lens 第 8 节，赢家自己点破套路："先用枪和饥饿把人逼进保留地，
