...
⚠️ 别搞混：这里华工是**铁路语境的背景**；1882 年那部把华工挡在国门外的排华法，是另一段历史
（chinese-exclusion-1882），白人工人对华工的怨气是那部法律的社会土壤之一，但这一课只埋种子、不展开。`,
...
dispossession wrapped in "for your own good"** — a fine name hiding a real cost.`,
...

    {
      ...
      standaloneText: {
        cn: `**Sand Creek Massacre（沙溪大屠杀）** 是 APUSH CED 课程文件点名列出的必考事件，故事里只埋了背景，需单独掌握。

**时间与经过（1864 年 11 月 29 日）**：
科罗拉多领地的 **Colonel John Chivington（奇文顿上校）** 率领约 700 名民兵，
在清晨突袭了位于 Sand Creek（沙溪）河边、已接受政府安置的 **Cheyenne（夏延族）和 Arapaho（阿拉帕霍族）**营地。
营地升起美国国旗和白旗——都没用。约 **150-200 人**被杀（多数是妇女、老人和孩子）。
遗体被肢解，士兵把头皮和遗骸当战利品带回。

**为什么 AP 重点考它？**
1. **反驳"开战有因"的叙事**：那支营地部队已按政府要求集中定居，升起了表示投降的旗帜——这不是"战争"，是**屠杀**。
2. **催化连锁反应**：Sand Creek 激怒了平原民族，是此后 1860-70s 一系列剧烈冲突（包括 1876 年 Little Bighorn）的燃点之一。
3. **国会调查结论**：事后国会调查明确谴责奇文顿的行动是"无法辩护的残行"——这在当时极为罕见，留下了官方白纸黑字的定性。

**考点关键句**：Sand Creek 是平原民族战争中最典型的**政府暴力针对已接受安置的平民**案例，
AP 用它考「暴力对象是谁、动机是什么」的分析，而非简单的"双方打仗"叙事。

⚠️ 别把 Sand Creek (1864) 和 Wounded Knee (1890) 搞混：
Sand Creek = 科罗拉多、Cheyenne/Arapaho、Chivington、1864；
Wounded Knee = 南达科他、Lakota、鬼舞镇压、1890。两件事都是 CED 必考，分开背。`,
        en: `**The Sand Creek Massacre** is explicitly named in the APUSH CED; the storyboard only buries it in background, so master it separately.
...
1. **Refutes a "justified combat" narrative**: the camp had done what the government asked, gathered in place, and raised the surrender flag — this was not "a battle"; it was a **massacre**.
2. **Catalyzed a chain reaction**: Sand Creek enraged the Plains nations and was one of the ignition points for the more intense conflicts of the 1860s-70s, including the 1876 Little Bighorn.
3. **Congressional finding**: a later congressional investigation explicitly condemned Chivington's action as "a foul and dastardly massacre" — rare in the era and leaving an official documented verdict.
...
Wounded Knee = South Dakota, Lakota, Ghost Dance crackdown, 1890. Both are CED-required; memorize them separately.`,
      },
      xiaoweiNote: {
        cn: `这张卡故事里没展开，但 CED 点名，所以单独背。
我用**两道时间轴锚点**把它和 Wounded Knee 分开：
1864 Sand Creek = 奇文顿 + 夏延/阿拉帕霍 + 升了白旗还被杀；
1890 Wounded Knee = 鬼舞 + Lakota + 大雪地。
考点句：**政府暴力打的是已接受安置的平民，不是战场上的武装力量。**`,
        en: `This card isn't in the story, but the CED names it, so memorize it separately.
I use **two timeline anchors** to keep it apart from Wounded Knee:
1864 Sand Creek = Chivington + Cheyenne/Arapaho + flew a white flag and were still killed;
1890 Wounded Knee = Ghost Dance + Lakota + deep snow. Exam sentence: **government violence was aimed at civilians who had already accepted relocation, not an armed force on a battlefield.**`,
      },
    },

    {
      id: 'sitting-bull-named-figure',
      termCn: 'Sitting Bull（坐牛）——具名考点',
      termEn: 'Sitting Bull — A Named AP Exam Figure',
      ...
      storyAnchor: {
        ...
        nodeIds: ['pn-n5', 'pn-n9'],
        xiaoweiNote: {
          cn: `Sitting Bull 在 Little Bighorn 那张卡（plains-indian-wars-little-bighorn-wounded-knee）里提到了，
但他是 APUSH CED 点名的**具名人物考点**，必须单独能写，不能只靠一句捎带。

**坐牛（Hunkpapa Lakota，约 1831-1890）**是平原民族抵抗运动的精神核心，不是单纯的战士：
- **圣人（holy man）+ 领袖双重身份**：在 Lakota 文化里，大圣人往往比战争领袖更有精神权威；
  1876 年 Little Bighorn 前，他举行太阳舞（Sun Dance），预见了打败卡斯特的异象——鼓舞了全营士气。
- **拒绝黑山出售**：1868 年《拉勒米堡条约》写明黑山（Black Hills）属于 Lakota；
  1874 年发现金子、白人涌入后，政府要强买，他拒绝：「我的土地不卖，它是我血液的一部分。」
- **流亡加拿大（1877-1881）**：Little Bighorn 大胜之后联邦军大规模围剿，他率部出走加拿大避难四年，
  最终带族人南返投降——不是因为打败了，而是因为族人在饥饿中支撑不下去了。
- **在保留地被杀（1890 年 12 月 15 日）**：Wounded Knee 屠杀两周前，
  政府担心他支持鬼舞运动引发暴动，派部落警察逮捕，冲突中被射杀。

**考点关键句**：Sitting Bull 代表的不是一个人，是 Lakota 抵抗"宁饥饿不投降、宁死不卖黑山"的原则立场。

**AP 题出现形式**：他常被 SAQ/LEQ 拿来考「个人如何体现一个时代的更大冲突」（1 个具体人物支撑 1 条大论点）。
记住他的两条行动轨迹：拒绝（黑山）→ 胜利（Little Bighorn 1876）→ 流亡（加拿大 1877-81）→ 返回投降（被迫）→ 被杀（1890）。`,
          en: `Sitting Bull appears in the Little Bighorn card, but he is an **explicitly named AP CED figure** — you must be able to write about him alone, not just catch him in passing.

**Sitting Bull (Hunkpapa Lakota, c. 1831-1890)** was the spiritual core of Plains resistance, not just a warrior:
- **Holy man + leader, both roles**: in Lakota culture a great holy man often carried more spiritual authority than a war chief. Before the 1876 Little Bighorn he held a Sun Dance, during which he received a vision of defeating Custer — it galvanized the whole camp.
...
- **Exile in Canada (1877-1881)**: after the great victory, the U.S. Army launched a massive campaign and he led his people out to Canada for four years; he finally returned with his people to surrender — not because they were defeated militarily, but because the people could not endure starvation.
- **Killed on the reservation (December 15, 1890)**: two weeks before Wounded Knee, the government feared he was supporting the Ghost Dance movement and might spark an uprising; tribal police were sent to arrest him and he was shot in the ensuing struggle.

**Key exam sentence**: Sitting Bull represents not one man but the Lakota principle that "starvation before surrender, death before selling the Black Hills."

**How AP tests him**: he is used in SAQ/LEQ to ask how an individual embodies a larger conflict of the era. Keep his arc: refusal (Black Hills) → victory (Little Bighorn 1876) → exile (Canada 1877-81) → forced return → killed (1890).`,
        },
      },
    },

    {
      ...
      standaloneText: {
        cn: `**印第安寄宿学校政策（Indian boarding school policy）**是 Dawes Act 同时代的文化同化工程，
AP 把它和强制分地合起来考"联邦如何系统性消灭原住民文化认同"。

**核心机制**：
1879 年，前陆军上尉 **Richard Henry Pratt** 在宾夕法尼亚 Carlisle 创办了 **Carlisle Indian Industrial School**，
他的宗旨一句话概括：**"Kill the Indian, save the man."**（杀死印第安人，拯救那个人。）
他的意思：不是杀人，是要把一个人身上的"印第安性"彻底抹掉，把他改造成白人文明里的顺民。

**学校里发生什么**：
- 儿童（有时是强制带走、有时是以食物和安全为诱饵送来）被送到远离保留地的学校。
- **剪掉长发**（在许多原住民文化里，长发只在哀悼时才剪）——这是第一刀剥夺身份。
- **禁止使用母语**：被抓到说原住民语言就受罚。
- 被强制穿欧式服装、改用英语名字、信基督教、学农活和家务（男做农工，女做洗衣/烹饪）。
- 死亡率极高——疾病、恶劣条件、逃跑被抓后的惩罚。近年大量研究（包括 2022 年联邦调查报告）
  记录了数以千计在校死亡的儿童，许多葬在校园无名墓地。

**AP 考点逻辑**：寄宿学校政策和 Dawes Act 是同一套"同化"逻辑的两条腿——
Dawes 在外（夺地、拆部落共有）、寄宿学校在内（夺语言、夺身份）。
两者加起来是"不用屠杀，用制度消灭"。

**考点关键句**：**联邦政府通过寄宿学校系统性地剥夺原住民儿童的语言、文化与部落认同**，
是 APUSH Period 6 大主题"联邦政策对原住民的多重影响"的核心证据之一。`,
        en: `**The Indian boarding school policy** is a cultural assimilation program running alongside the Dawes Act. AP tests it together with forced allotment as evidence of how the federal government systematically destroyed Native identity.

**The core mechanism**:
In 1879, former army captain **Richard Henry Pratt** founded the **Carlisle Indian Industrial School** in Pennsylvania. His goal in one sentence: **"Kill the Indian, save the man."** He meant not killing bodies but erasing the "Indian-ness" from a person entirely and remaking them as a docile member of white civilization.

**What happened in these schools**:
- Children (sometimes forcibly removed, sometimes brought with food and safety as inducements) were sent to schools far from the reservations.
- **Hair cut off** (in many Native cultures hair is only cut in mourning) — the first stroke of identity stripping.
...
- Death rates were very high — disease, harsh conditions, punishment for attempted escape. Recent research (including a 2022 federal investigation) has documented thousands of children who died in these schools, many buried in unmarked graves on school grounds.

**AP exam logic**: boarding schools and the Dawes Act are two legs of the same "assimilation" logic — the Dawes Act works from outside (taking land, breaking tribal communal holding); the boarding school works from inside (taking language, taking identity). Together they mean "erase without outright massacre, erase through institutions."

**Key exam sentence**: **the federal government used the boarding school system to strip Native children of their language, culture, and tribal identity** — one of the central pieces of evidence for the APUSH Period 6 theme of "multiple federal policy impacts on Native peoples."`,
      },
      xiaoweiNote: {
        cn: `这张卡故事里没单独讲，但 AP DBQ 爱拿它和 Dawes Act 配对考。
我把它压成一句话：**"Kill the Indian, save the man" = 1879 Carlisle 寄宿学校 = 剪发、禁母语、改名、强制基督教。**
记忆锚：和 Dawes Act 是同一套逻辑的两面——一个夺地（外），一个夺身份（内）。
别只记 Dawes，要把寄宿学校和它绑在一起背，AP 有时问"哪些政策共同打击了原住民的文化认同"。`,
        en: `The story doesn't cover this card alone, but AP DBQs often pair it with the Dawes Act.
I compress it: **"Kill the Indian, save the man" = 1879 Carlisle boarding school = cut hair, ban the mother tongue, rename, force Christianity.**
Memory anchor: two faces of the same logic as the Dawes Act — one takes land (external), one takes identity (internal). Don't only memorize Dawes; pair the boarding schools with it, because AP sometimes asks "which policies together targeted Native cultural identity."`,
      },
    },
