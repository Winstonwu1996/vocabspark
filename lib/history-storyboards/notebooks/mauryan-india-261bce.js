...
power.' To read him, you must see both lines at once."`,
    ...
    keyFigures: [
      ...
      },
      {
        ...
        ipa: null,
        roleCn: '本课受影响方视角的承载者（虚构个体承载真实群体经验），家人在那约 10 万死者、15 万流放者之中',
  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ash-n2'],
        xiaoweiNote: {
          cn: `这个阿育王在他那一遍第 2 节亲口讲了。在他之前，是他家的人先打下了这个帝国。
...
generations, exactly the "continuity and change" AP loves to compare.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `阿育王整条那一遍都是他。我把他这个人压成一条时间线，专门防公元前年代搞反：
...
turned around.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `三个视角都绕着这场仗，阿育王那一遍第 4、5、6 节讲得最透，Kalinga 幸存者那一遍最戳人。
...
heard by the receiving end as the question: and what about my family?`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `达摩官那一遍第 2 节专门拆这个误区，我觉得这是这一课最容易考错的一条。
...
One is private faith, the other a public code.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `阿育王那一遍第 5、6、7 节都在讲这个。这是这一课最重要的「文件」，DBQ 高频。
...
🔗 故事连接：阿育王那一遍第 7 节里他亲口说自己偏向佛教、修 stupa；
达摩官那一遍第 2 节专门点出「国王自己偏佛教，但他交给我推的 dhamma 不是某一个教」。`,
...
dhamma is the inward, empire-wide public code (cross-sectarian).** Keep the two separate, don't merge them.`,
...

    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ash-n9'],
        xiaoweiNote: {
          cn: `阿育王那一遍第 9 节讲到了，连阿育王自己都说这是他做梦也想不到的事。
...
(stone plus lions) survived to today.`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这条横跨两个视角：达摩官那一遍第 3、8 节讲帝国怎么「管」，阿育王那一遍第 9 节讲它怎么「散」。
