...
//
// schemaVersion: 1 · notebookVersion: haitian-revolution-1791-v2
...
这条链子长这样：美国 1776 → 法国 1789 → 海地 1791 → 拉美 1810s。
但海地这一格特别：它是历史上**唯一一场**被奴役者自己打赢、并自己建国的革命。
...
我先记下来，等下读三个故事——一个法国种植园主的视角、
Toussaint 夹在所有人中间的视角、还有甘蔗田里一个点火的少年的视角——
...
The chain goes like this: America 1776 → France 1789 → Haiti 1791 → Latin America 1810s.
But the Haiti box is special: it's the **only** revolution in history that the enslaved won themselves, and then founded their own nation.
...
Let me write these down. After I read the three stories — a French planter's
point of view, Toussaint caught between everyone, and a boy in the cane fields
who lights the first torch — I'll come back and check whether I can explain each word.
    ...
    keyFigures: [
      {
        ...
        roleCn: '被奴役者出身的自由人，识字会驯马，1770 年代已获自由。十几年里在法、西、英三个帝国间纵横。1801 年颁布废奴自治宪法。最后被拿破仑诱捕、死在法国阿尔卑斯山牢中。',
        roleEn: 'Born enslaved, literate and a horseman, freed in the 1770s. For over a decade he maneuvered among the French, Spanish, and British empires. Issued an abolitionist self-rule constitution in 1801. Died in a French Alpine prison after Napoleon lured and seized him.',
        mustKnow: true,
  ...
  mainConcepts: [
    {
      ...
      termCn: '黑人能动性',
      termEn: 'Black Agency',
      defCn: '被奴役者不是坐着等别人来救他们，而是自己策划、自己动手、自己建国的历史推动者。这叫「黑人能动性」（black agency）。',
      defEn: 'The idea that enslaved people were not passive victims waiting to be rescued, but the ones who planned, fought, and founded their own nation. That is called "black agency."',
      standardRef: ['AP World — Unit 5 (Revolutions)', 'AP World DBQ rubric'],
      examFrequency: 'highest',
      storyAnchor: {
        standaloneText: {
          cn: `这是这道题最高频的 DBQ 角度。老师说阅卷老师反复奖励这个论点，必须背熟。

**「黑人能动性（black agency）」** = 被奴役者**不是**被动等别人来解放的对象，而是亲手点火、亲手打、亲手建国的历史**主动推动者**。

我把支撑这个论点的四块证据攒成一串，DBQ 写作可以直接用：
①  Bois Caïman 仪式——被奴役者自己立的起义之盟，不是外人安排的。
②  北部平原起义——几万人自己拿起 machete（砍刀）和火把烧种植园。
③  Toussaint 1801 年自己写了一部废奴宪法——「曾经的财产」亲手写根本大法。
④  黄热病战中，原本帮法国打仗的黑人和有色人军官识破恢复奴役的真相后，倒戈转向被奴役者一方。

常见误解：❌「海地是被法国或外人解放的」。
正确答案：✅ 它是被奴役者**自己**点火、自己打、自己建国的——这正是它在世界史里独一无二的地方。`,
          en: `This is the single highest-frequency DBQ angle. Teacher said graders keep
rewarding this argument, so memorize it.
...
①  The Bois Caïman ceremony — the enslaved swore their own oath to revolt; no outsider arranged it.
②  The northern-plain uprising — tens of thousands took up machetes and torches to burn the plantations.
③  Toussaint's own 1801 abolitionist constitution — the "former property" wrote the fundamental law.
④  In the yellow-fever war, Black and mixed-race officers who had been fighting for France defected once they saw slavery was being restored.

Common mistake: ❌ "Haiti was freed by France or outsiders."
Correct answer: ✅ The enslaved lit it, fought it, and founded it **themselves** — exactly what makes it unique in world history.`,
        },
        xiaoweiNote: {
          cn: `甘蔗田少年那个故事最戳我——他拿起火把那一刻，账本上的「财产」做了一件财产不该做的事：他做了一个**选择**。那就是 black agency 最具体的样子。
我的口诀：agency = 主语，不是宾语。被奴役者是这句历史的「主语」。`,
          en: `The cane-field boy's story hit me hardest — the moment he picks up the torch, the "property" on the ledger does the one thing property isn't supposed to do: he makes a **choice**. That's the most concrete face of black agency.
My mnemonic: agency = the subject, not the object. The enslaved are the "subject" of this sentence of history.`,
        },
      },
    },

    {
      ...
      defCn: '圣多曼格（Saint-Domingue）是今天海地的旧名，1697 年起是法国的糖殖民地。1804 年独立后才改回原住民 Taíno 语的旧名 Haiti / Ayiti。',
      defEn: 'Saint-Domingue was the colonial name for what is now Haiti — a French sugar colony since 1697. After independence in 1804 it was renamed Haiti / Ayiti, reviving the original Indigenous Taíno name.',
...
**Saint-Domingue（圣多曼格）** = 加勒比海 Hispaniola（伊斯帕尼奥拉岛）西部三分之一，1697 年起归法国。就是今天的海地。独立后（1804）才被改回原住民 Taíno 语的旧名 **Haiti / Ayiti**（意为「多山之地」），纪念哥伦布到来之前的原住民。

为什么必背：它当时是**全世界最赚钱的殖民地**，一个岛贡献了法国对外贸易的一大块。靠的是北部平原（Plaine du Nord）的糖和咖啡，港口城市叫 Le Cap-Français（简称 Le Cap）。
...
我的记忆锚：同一片土地，两个名字，两种命运——殖民地 vs 自由国家。`,
          en: `My mom hadn't heard the name because it changed from "Saint-Domingue" to "Haiti."
My memory anchor: one piece of land, two names, two destinies — colony vs. free nation.`,
        },
      },
    },

    {
      ...
      termCn: '黑法典',
      termEn: 'Code Noir',
      defCn: '黑法典（Code Noir）是法国 1685 年颁布的法律，把被奴役者定义为主人可以买卖的「财产」，是整套奴役制度的法律框架。',
      defEn: 'Code Noir is the law France issued in 1685 that defined enslaved people as property their owners could buy and sell. It was the legal backbone of the whole slavery system.',
...
它的逻辑分两面（DBQ 爱用）：
①  一面把被奴役者定义为主人的「动产」（biens meubles），就是可以买卖的财产。
②  另一面名义上要求主人提供衣食、不许随意杀害——但现实中常被无视。

它最阴的地方不是赤裸的残忍，而是用「法律」「秩序」「甚至一点点保护」，
把「把人当消耗品」包装成**正常生意**。理解了 Code Noir，才理解被奴役者反抗的到底是什么：不只是某个坏主人，是一整套把人变成账本数字的制度。
...
Its logic has two faces (DBQs love this):
①  On one hand it defines enslaved people as the owner's "movable goods" (biens meubles) — property that can be bought and sold.
②  On the other it nominally requires owners to provide food and clothing and not to kill at will — often ignored in reality.

The most sinister part isn't bare cruelty. It's that "law," "order," and "even a little protection" were used to package "using humans as consumables" as **normal business**. Once you understand Code Noir, you understand what the enslaved were actually rebelling against: not just one bad owner, but a whole system that turned people into numbers on a ledger.
...
the 1804 founding overturn Code Noir's logic at the root.`,
        ...
        xiaoweiNote: {
          cn: `种植园主那个故事让我懂了 Code Noir 怎么运作：他「不是个人特别坏」，是制度让「把人当财产消耗」成了正常生意。这比单纯一个恶人可怕多了。`,
          en: `The planter's story taught me how Code Noir worked: he "wasn't an unusually
...
far scarier than just one villain.`,
...

    {
      ...
      defCn: '自由有色人（gens de couleur libres）是有非洲和欧洲混合血统、法律上已经自由的第三方阶层。他们不是白人，也不是被奴役者，夹在中间，两边都不完全接受他们。',
      defEn: 'Gens de couleur libres were a third group — people of mixed African and European ancestry who were legally free. They were neither white nor enslaved, stuck in the middle, and accepted by neither side.',
      standardRef: ['AP World — Unit 5', 'AP World DBQ rubric'],
      examFrequency: 'high',
      storyAnchor: {
        standaloneText: {
...
**gens de couleur libres（自由有色人）** = 有非洲和欧洲混合血统、**法律上自由**的第三方阶层。1789 年前后约 2.8-3 万人。关键复杂点：他们有的自己也拥有种植园和奴隶，卡在白人和被奴役者中间，两边都不把他们当自己人。

常见误解：
❌「自由有色人天然站在被奴役者一边」
✅ 他们是独立的**第三方**，诉求是「平等公民权」，**不是**「废奴」。立场随局势反复变化，有人自己也蓄奴。

记住他们的代表：Vincent Ogé（奥热）——1790 年为争平等公民权起事，被处死，这件事把全岛矛盾全面激化，是 1791 起义的前奏之一。

考点关键句：这场革命有**四个**互相敌对的人群（不是黑白两方）：
grand blanc / petit blanc / gens de couleur libres / 被奴役的大多数。
DBQ 写利益相关方分析时，一定要把这四方都摆出来。`,
...
When you write a stakeholder analysis in a DBQ, all four must be on the table.`,
        },
        xiaoweiNote: {
...
two demands are very different.`,
...

    {
      ...
      defCn: '大白人（grand blanc）是法国大种植园主，靠奴役制度赚钱。小白人（petit blanc）是白人监工和小店主，比种植园主穷，但同样死守「我是白人」的优越感。',
      defEn: 'Grand blanc were the big French planters who got rich from the slavery system. Petit blanc were white overseers and small shopkeepers — poorer than the planters, but clinging tightly to the privilege of being white.',
...
**grand blanc（大白人）** = 法国大种植园主，靠北部平原全世界最赚钱的糖和咖啡发财，也靠最残酷的奴役制度维持它。1789 年他们想要的是**自治**（少受巴黎管），但绝不包括解放奴隶——那等于烧掉自己的财产。

**petit blanc（小白人）** = 白人监工、小店主、水手——比种植园主穷，却死死攥着「我是白人」这一条优越感。

考点关键句：「人生而自由平等」这句话一传到岛上，**每一群人**都用它要不同的东西——grand blanc 要自治、gens de couleur 要平等公民权、被奴役者要自由本身。同一句话，四个方向。这正是 DBQ 要你拆的「同一文本，不同解读」。`,
...
asks you to unpack.`,
        ...
        xiaoweiNote: {
          cn: `种植园主那个故事就是一个 grand blanc 视角。他到死可能都不理解，为什么「财产」会站起来——因为在他的世界里，被奴役者从来不算「人」。`,
          en: `The planter's story is a grand blanc point of view. To his death he probably never understood
why "property" stood up — because in his world, the enslaved were never counted as "people."`,
...

    {
      ...
      defCn: '凯门森林（Bois Caïman）仪式是 1791 年 8 月在北部一片森林里举行的 Vodou 仪式，被奴役者在这里立下起义之盟，是海地革命的精神起点。',
      defEn: 'The Bois Caïman ceremony was a Vodou ritual held in a forest in August 1791 where the enslaved swore their oath to revolt. It is considered the spiritual starting point of the Haitian Revolution.',
      standardRef: ['AP World — Unit 5'],
      examFrequency: 'mid',
      storyAnchor: {
        standaloneText: {
          cn: `**Bois Caïman（凯门森林）** 是 1791 年 8 月北部一片森林的名字，革命的**精神起点**就在这里。

1791 年 8 月 14 日夜，祭司 **Dutty Boukman** 和女祭司 **Cécile Fatiman** 在这里主持了一场 **Vodou（伏都）** 仪式——有鼓声、有血、有誓言，立下起义之盟。几天后（8 月 21-22 日夜），约定的信号来了：有人吹响 **lambi（海螺号）**，号声一座种植园接一座种植园传过黑夜的北部平原，几万人拿起 machete 和火把。

为什么它重要：起义之盟是被奴役者**自己**立的，用的是他们从非洲带来、在岛上融合成 Vodou 的信仰——这是 black agency 最有力的证据之一。注意：仪式确切日期有争议，部分史家定在 8 月 22 日。写答案时可以说「1791 年 8 月」，不用纠结具体哪天。
...
Why it matters: the oath to revolt was sworn by the enslaved **themselves**, drawing on the faith they brought from Africa and blended into Vodou on the island — one of the strongest pieces of evidence for black agency. Note: the exact date is disputed; some historians place it on August 22, so in an answer just write "August 1791" rather than pinning a specific night.

Key exam sentence: Bois Caïman = the spiritual start of the revolution; the lambi call =
the signal for the uprising.`,
        },
        xiaoweiNote: {
          cn: `三个故事里所有人都听见了同一声 lambi：少年是吹响它的人，Toussaint 听成「信号」，种植园主听成黑暗里说不清来源的怪声。同一声号，三种意思。`,
          en: `In all three stories everyone hears the same lambi: the boy is the one who sounds it,
...
he can't place. One call, three meanings.`,
...

    {
      ...
      defCn: '大西洋革命（Atlantic Revolutions）是 1750-1900 年间一连串以「人权」为旗帜掀翻大西洋世界的革命，顺序是：美国 1776 → 法国 1789 → 海地 1791 → 拉美 1810s。',
      defEn: 'The Atlantic Revolutions were a wave of revolutions from 1750 to 1900 that swept the Atlantic world under the banner of "human rights": America 1776 → France 1789 → Haiti 1791 → Latin America 1810s.',
      standardRef: ['AP World — Unit 5 (Topic 5.2-5.3)', 'CA HSS World History'],
      examFrequency: 'highest',
      storyAnchor: {
        standaloneText: {
          cn: `这是把海地放进「大局」的框架考点，AP World 几乎一定会考这条连续体。

**Atlantic Revolutions（大西洋革命）** = 1750-1900 年间，「人权」话语一个接一个掀翻大西洋世界的一串革命：
**美国 1776 → 法国 1789 → 海地 1791 → 拉美 1810s。**

海地在这条链子里的独特位置（必背）：它是**唯一一场由被奴役者自己发动、并最终建国**的革命。美国和法国革命的「自由」，主要是有产白人男性的自由。海地革命把这句「自由」撑成了「**所有人**的自由」——它把人权话语逼到了底。

跨题比较钩子：同一句「人生而自由平等」，法国本土说出来时根本没打算给殖民地的被奴役者。是被奴役者自己捡起来逼它兑现。这是「思想跨大西洋传播」+「被原作者排除的人逼它兑现」的双重故事。
...
stretched that "liberty" to the liberty of **everyone** — it pushed the human-rights
language all the way to the bottom.

Cross-topic comparison hook: the same line, "all men are born free and equal," was
...
one fought "from the very bottom up."`,
...

    {
      ...
      defCn: '黄热病（yellow fever）是一种热带传染病。本地人和非洲来的人对它有一定抵抗力，刚到的欧洲士兵没有。1802 年这种病大批击倒法军，是法国远征军失败的关键原因之一。',
      defEn: 'Yellow fever is a tropical disease. Local people and people from Africa had some resistance to it, but newly arrived European soldiers did not. In 1802 it wiped out large numbers of French troops and was one of the key reasons the French expedition failed.',
      standardRef: ['AP World — Unit 5', 'AP World DBQ rubric'],
      examFrequency: 'high',
      storyAnchor: {
        standaloneText: {
          cn: `这是 AP 最爱用来考「结构或物质因素」的一条——别只写英雄叙事。

**yellow fever（黄热病）** 是一个生物学事实：本地人和非洲来的人有一定抵抗力，**新来的欧洲军队没有**。1802 年拿破仑派 Leclerc 率两万多大军来恢复奴隶制，黄热病成片击倒缺乏抵抗力的法军——连主帅 Leclerc 自己也在 1802 年 11 月病死。

常见误解：
❌「法军是被海地军队正面打垮的」
✅ 军事抵抗是真的，但**黄热病**击倒欧洲新兵，是法军崩溃的**关键生物学因素之一**（注意「之一」，别写成唯一原因）。

怎么和 black agency 配合写（高分）：黄热病削弱了法军，**同时**黑人和有色人军官识破恢复奴役的真相后倒戈、由 Dessalines 统一指挥——是「疾病 + 人的选择」一起赢的，两者都要写，不能用疾病抹掉被奴役者的能动性。`,
          en: `This is AP's favorite way to test "structural or material factors" — don't write
...
don't let disease erase the agency of the enslaved.`,
        ...
        xiaoweiNote: {
          cn: `口诀：黄热病是「之一」，不是「唯一」——疾病帮忙，但人才是打赢的主语。`,
          en: `Mnemonic: yellow fever is "one of," not "the only" — disease helped, but people
were the subject who won.`,
...

    {
      ...
      defCn: '1804 年 1 月 1 日，Dessalines 宣布独立，建立了拉美第一个独立国家，也是历史上第一个由被奴役者自己建立、从第一天起就彻底废奴的国家。',
      defEn: 'On January 1, 1804, Dessalines declared independence, creating the first independent nation in Latin America and the first country in history founded by the enslaved — with slavery abolished completely from day one.',
...
**1804 年 1 月 1 日**，**Dessalines（德萨林）** 宣布独立，把殖民地名 Saint-Domingue 改回原住民 Taíno 语的旧名 **Haiti / Ayiti**。这是：
①  拉美**第一个**独立国家；
②  美洲**第二个**独立共和国（美国之后）；
③  历史上**第一个由被奴役者建立的国家**——从立国第一天起就彻底废奴。

但要直面血腥的一面：独立后 1804 年 2-4 月，Dessalines 下令屠杀岛上剩余的法国白人，约 3000 至 7000 人被杀。自由的伟大与过程的暴力，**同体**，不美化也不单极否定。

长期代价（别漏）：法国 1825 年逼海地用巨额「赔款」债务换承认，这笔债压了海地一个多世纪，是它长期贫困的**结构性根源之一**。常见误解：❌「海地独立后就好了」→ ✅ 独立只是开始，外债与动荡随之而来。

考点关键句：1804 = 第一个由被奴役者建立、从第一天彻底废奴的国家；代价是 1804 屠杀 + 1825 外债——光明与代价同体。`,
...
But you must face the bloody side too: between February and April 1804, Dessalines ordered the massacre of the remaining French whites on the island, with roughly 3,000 to 7,000 killed. The greatness of the freedom and the violence of the process are **one and the same** — neither whitewashed nor flatly condemned.

Long-term cost (don't skip): in 1825 France forced Haiti to buy recognition with a huge
"indemnity" debt, which weighed on Haiti for more than a century and is **one of the
structural roots** of its long poverty. Common mistake: ❌ "Things were fine for Haiti after independence" → ✅ independence was only the beginning; foreign debt and instability followed.
...
one and the same.`,
        ...
        xiaoweiNote: {
          cn: `改名 Saint-Domingue → Haiti 那一刻我起了鸡皮疙瘩：被奴役者建国的第一件事，是把殖民者起的名字扔掉，捡回原住民的名字。但我也提醒自己——同一年还有 1804 的屠杀，这一面也得写，不能只挑亮的讲。`,
...
高分写法：承认两边都有道理，再说明你为什么更倾向某一边——这叫在 AP 答案里展示复杂性。`,
...
- Evidence for "in the writer's hands": the French who wrote it never counted the Caribbean
  enslaved among "men."
High-scoring move: acknowledge both have a point, then explain why you lean one way — that's showing complexity in an AP answer.`,
...
"purely bright" or "purely bloody."`,
      hintCn: `提示：好的 DBQ 答案会**同时持有两件事**，而不是二选一（这正是历史学家争的）。
- 「解放的伟大」一边：第一个由被奴役者建立、从第一天彻底废奴的国家。
- 「过程的暴力」一边：1804 年 2-4 月对剩余法国人的屠杀（约 3000-7000 人）。
不要替历史下最终道德结论；AP 要的是你能不能把两面都摆在桌上，再谈你的权衡。`,
...
Don't hand history a final moral verdict; AP wants you to put both faces on the
...
(the 1801 constitution, maneuvering among three empires).`,
      hintCn: `提示：先把 Toussaint 的复杂性摆全——他不是「一直在田里的奴隶英雄」，他 1770 年代就被解放、识字、甚至一度自己拥有过少数被奴役者。
「调停者」一边：他在法、西、英三方间纵横，想用制度（1801 宪法）锁住所有人都能活的未来。
「悲剧」一边：他对谁都不完全是自己人，最信的帝国背叛了他。
进阶：你身边有没有「想让所有人都满意」反而两头不讨好的处境？那是软弱还是勇气？`,
      hintEn: `Hint: first lay out Toussaint's full complexity — he was not a "lifelong
...
这正好呼应 black agency——能动性决定了同一句话往哪个方向兑现。不要下最终道德排名。`,
      hintEn: `Hint: this is a great cross-topic comparison.
...
same line gets cashed out. Don't issue a final moral ranking.`,
