...
labor problem didn't vanish; it just moved to the other end of the global supply chain.`,
...

    {
      ...
      standaloneText: {
        cn: `工业革命的 80 年长弧（1760-1840），正对应中国清朝中后期（乾隆中期到道光年间）。1840 年——工业革命基本完成的同一年——正是鸦片战争爆发之年。

结构对照（Rule 0，并列不褒贬）：
- 英国把煤与蒸汽转化为机械动力，进入机器量产与工厂制度。
- 同期中国仍以农业和手工业为主体：纺织业高度发达，但分散在家庭与作坊，没有走向机械化的工厂动力跃迁。

这引出一个开放的历史大问题——「大分流（Great Divergence）」：为何工业革命发生在西北欧，而非同样富庶、技术积累深厚的中国？史学界至今争论，没有定论。制度派、地理/资源派（彭慕兰：煤矿位置 + 新大陆「鬼田」）、文化派各有解释。

避免两种错误：不可写「中国落后所以没发生工业革命」（18 世纪中国是全球最大经济体之一）；也不可写「西方靠掠夺、东方道德高尚」（分流是多因结构性问题，不是道德题）。`,
        en: `The 80-year arc of the Industrial Revolution (1760-1840) maps to the mid-to-late Qing dynasty (mid-Qianlong through Daoguang). 1840 — the year the Revolution was essentially complete — was also the year the First Opium War broke out.

Structural comparison (Rule 0, no ranking):
- Britain converted coal and steam into mechanical power, entering machine-scale production and the factory system.
- China in the same period remained grounded in agriculture and handicraft industry: textile production was highly developed, but dispersed in households and workshops, without the leap to mechanized factory power.

This opens a great historical question — the "Great Divergence": why did the Industrial Revolution happen in northwestern Europe rather than China, which was equally prosperous and had deep accumulated technology? Historians debate it still, with no settled answer. The institutional school, the resource/geography school (Pomeranz: coal location + New World "ghost acres"), and the cultural school all offer explanations.

Two errors to avoid: don't write "China was backward, so the Industrial Revolution didn't happen there" (18th-century China was one of the world's largest economies); also don't write "the West succeeded through plunder while the East was morally superior" (the divergence is a multi-causal structural question, not a moral one).`,
      },
      xiaoweiNote: {
        cn: `老师说这是历史学家争了几十年的大问题，我们不用给答案——但要知道它叫「大分流」、知道它没有定论、知道「中国落后」不是答案。AP World 考到比较工业化的题，把这个问题摆出来是加分点。`,
        en: `Teacher says this is a question historians have argued about for decades — we don't have to provide the answer, but we should know it's called the "Great Divergence," know that there's no settled answer, and know that "China was backward" is not the answer. If AP World asks a comparative industrialization question, raising this problem earns you points.`,
      },
    },
  ],
