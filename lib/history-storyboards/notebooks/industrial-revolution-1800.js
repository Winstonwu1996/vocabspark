...
the same body" angle.`,
...

    {
      ...
      standaloneText: null,
      xiaoweiNote: {
        cn: `Arkwright N9 把这两个词串成了一条因果链，我觉得这是全 Topic 最该背的一条逻辑。
...
🔗 跨 Topic 连接（Arkwright N7 亲口说的）：蒸汽机不是凭空冒出来的——它站在科学革命
...
三个 lens 各自在 N10-N11 把镜头拉到今天，说的其实是同一件事的不同面：
...
🔗 transfer（三个 lens 都点了）：今天你随手买的便宜东西，背后那根线另一头，可能还连着某个看不见的
...
labor problem didn't vanish; it just moved to the other end of the global supply chain.`,
  ...
  thinkingQuestions: [
    {
      id: 'q1',
      questionCn: `Arkwright 真心相信自己在创造进步，也真心觉得"我给了童工饭吃、有宿舍、有工钱寄回家，
比在乡下挨饿强"。这些话每一句都是真的。

可同样真的是：他每天用上百个九岁孩子，让他们在机器边站十几个小时。一个相信自己在做好事的人，
能不能同时在做巨大的恶？`,
      questionEn: `Arkwright sincerely believed he was creating progress, and sincerely felt "I gave the
...
too" to look away from a much larger cost? Is this a personal failing, or a structural feature of the era?`,
    ...
    {
      id: 'q2',
      questionCn: `Owen 在 New Lanark 救得了自己一家厂的两千人，却救不了墙外曼彻斯特的几十万童工。
别的厂主冷静拒绝学他："你赚'够多'就满足，我们要赚'最多'。"于是 Owen 醒悟：靠个人良心救不了系统，
必须立法。

让童工状况真正变好的，到底是"好人多一点"，还是"改规则"？如果你只能押一边，你押哪边？为什么？`,
      questionEn: `Owen could save the two thousand in his own New Lanark mill, but not the hundreds of
...
two work together?`,
    ...
    {
      id: 'q3',
      questionCn: `课本常说"工业革命让生活变好了"。可 Ellen 说："同一根线，一头是我没了的手指，
...
你会给学生哪几份不同的材料，逼他们两面都看？`,
      questionEn: `Textbooks often say "the Industrial Revolution made life better." But Ellen says: "The
