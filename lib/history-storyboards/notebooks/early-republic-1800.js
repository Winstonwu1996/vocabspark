...
//
// 与 storyboard 的关系：
//   - storyboard 提供情感锚点（Jefferson 掌权者 / Tecumseh 孤独调停者 / 被推走的母亲+被卖的少年 受影响方三条线）
  ...
  mainConcepts: [
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个三个视角都讲到了，Jefferson 那一遍第 4、5 节最完整。
...
考点关键句：主张"严格解释宪法"（strict construction）的 Jefferson，
做了宪法压根没写的最大一件事——买下半个大陆。他后来说这是
"在国家利益面前，把对宪法的顾虑咽了下去"。这是 AP 最爱考的"原则 vs 现实"张力。

别忘了另一面（被推走的母亲那一遍第 4 节）：那片地不是空的，
上面住着几十个原住民民族；巴黎签字的屋里，没有一个原住民在场。
"史上最划算的买卖"是从别人的家上压过去的。`,
          en: `All three lenses touch this; Jefferson's Lens Nodes 4 and 5 are the fullest.
...
Key exam sentence: Jefferson, the champion of "strict construction," did the single
biggest thing the Constitution never authorized — buying half a continent. He later said
he "swallowed his constitutional doubts for the good of the country." This is AP's favorite
"principle vs reality" tension.

Don't forget the other side (the mother's Lens Node 4): the land was not empty; dozens of
Native nations lived on it, and not one was in the Paris room. The "best bargain in history"
was pressed down on someone else's home.`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Jefferson 那一遍第 6 节。买完地，Jefferson 派 Meriwether Lewis 和 William Clark
...
记忆锚：**地图往西画一寸 = 替白人小农往西钉一根木桩**（故事里 Jefferson 的原话）。
探险不只是"知识"，它给白人移民铺了往西的路——也踩在别人的家上。`,
          en: `Jefferson's Lens Node 6. After buying the land, Jefferson sent Meriwether Lewis
and William Clark with the "Corps of Discovery" to see what he had bought: out from near
St. Louis in **May 1804**, up the Missouri, over the Rockies, to the Pacific, returning in
**September 1806**, drawing the first map of the West.
...
Memory anchor: **every inch of map drawn west = one stake driven west for white small
farmers** (Jefferson's line in the story). The expedition wasn't just "knowledge" — it
paved the westward road for white settlers, standing on top of someone's home.`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Jefferson 那一遍第 7 节。起因：英国在海上拦截美国船、**强征水手**（impressment）、
又被疑在背后撑原住民抵抗。**1812 年 6 月**美国对英宣战（那时 Jefferson 已卸任，继任 Madison），
后人叫它"第二次独立战争"。**1814 年 8 月**英军一把火烧了华盛顿，连白宫都烧了。
...
考点关键句：一场严格说"不必要"的胜仗，喂大了全国自豪感，也喂出了一位未来总统（Jackson）。`,
          en: `Jefferson's Lens Node 7. Causes: Britain seized American ships at sea, forced
American sailors to fight (**impressment**), and was suspected of propping up Native
resistance. In **June 1812** the U.S. declared war on Britain (Jefferson had already left
office, succeeded by Madison) — later called the "second war of independence." In **August
1814** British troops burned Washington, even the White House. In **December 1814** the two
sides signed peace at Ghent (Belgium), essentially "restoring the prewar status quo" —
neither gained much.
...
president (Jackson).`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Jefferson 那一遍第 9 节 + 被卖少年那一遍第 8 节。**market revolution（市场革命）**
是 APUSH Period 4 的主框架，三根线同时拉起：
**交通**（运河、蒸汽船）+ **工厂**（New England 河边纺织厂，首次大规模雇 **mill girls** 工厂女孩）
+ **市场扩张**（西部种粮、南方种棉、东北做工连成全国市场）。

必背数字：**1825 年 Erie Canal（伊利运河，363 英里）通航，一吨货运费从约 100 美元暴跌到约 6 美元**——
一个数字就解释了为什么这是"革命"。

老师反复纠正的**误解陷阱**：
误："市场革命让奴隶制慢慢消失了。"
正：恰恰相反。运河让棉花卖得更远更贵 → 棉花更赚钱 → 开更多棉田 → 卖更多像那个少年一样的人去种。
市场革命和奴隶制是**互相喂养**的（被卖少年那一遍说的"同一枚硬币的两面"）。

记忆锚：连成一张网 = 一处崩、处处疼 →直接引出 **Panic of 1819**（见下一张卡）。`,
          en: `Jefferson's Lens Node 9 + the sold boy's Lens Node 8. The **market revolution**
is the main framework of APUSH Period 4, with three threads pulled tight at once:
**transportation** (canals, steamboats) + **factories** (New England riverside textile mills,
first to hire **mill girls** at scale) + **market expansion** (West grows grain, South grows
cotton, Northeast makes goods, linked into one national market).
...
money → more cotton fields → more people like that boy sold to work them. The market
revolution and slavery **fed each other** (the boy's "two faces of one coin").
...
**Panic of 1819** (see the next card).`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Jefferson 那一遍第 8 节。**1820 年** Missouri（密苏里）申请以蓄奴州身份入盟，
打破自由州 vs 蓄奴州的平衡，国会吵翻。**Henry Clay** 牵头拼出 **Missouri Compromise**：

必背三件套：
1. **Missouri 蓄奴州 + Maine（缅因）自由州**一起入盟（保住平衡，一边加一个）。
2. 画一条线——路易斯安那购地内 **北纬 36°30′ 以北今后禁止蓄奴**。
3. 这条线把 Jefferson 买的那片地，一刀劈成"自由"和"蓄奴"两半。
...
老师强调：误"密苏里妥协解决了奴隶制问题" → 正：它只是把矛盾沿 36°30′ 线**冻起来**、
换来四十年和平，却把"奴隶制能往哪扩"变成全国政治的中心。妥协 = 把引信加长，不是拆掉。`,
          en: `Jefferson's Lens Node 8. In **1820** Missouri applied to join as a slave state,
breaking the free-vs-slave balance, and Congress erupted. **Henry Clay** brokered the
**Missouri Compromise**:

Must-memorize trio:
1. **Missouri enters slave + Maine enters free** together (keeps the balance, one for each side).
2. A line is drawn — within the Louisiana Purchase, **slavery banned north of latitude 36°30′** from now on.
3. That line cut the very land Jefferson bought into "free" and "slave" halves.
...
Teacher stressed: Misconception "the Missouri Compromise solved slavery" → Correction: it
only **froze** the conflict along the 36°30′ line, bought forty years of peace, and turned
"where can slavery expand" into the center of national politics. Compromise = lengthening the
fuse, not pulling it.`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Tecumseh 那一整遍线就是这个。他看清了一件事：白人一个民族一个民族地买地、骗地、抢地，
**只要原住民各打各的，就一定一个个被吃掉**。所以他走遍五大湖到南方，去说服几十个有世仇的民族联合，
守一条底线：**土地是所有原住民共有的，任何单个民族都无权卖给白人**。

必记三个节点（背时间）：
1. **联盟中心** Prophetstown（先知镇），他弟弟 **Tenskwatawa（"先知"）** 一文一武（精神号召）。
2. **1811.11.7 Battle of Tippecanoe（蒂珀卡努之战）**：Tecumseh 外出招募盟友时，
   Harrison 率军逼近，联盟受重创、Prophetstown 被烧。（注意对手是 Harrison vs 弟弟，Tecumseh 不在场。）
3. **1813.10.5 Battle of the Thames（泰晤士河之战，今加拿大安大略）**：1812 战争里 Tecumseh
   与英国结盟、继续抵抗，**战死于此**，联盟随之瓦解。

考点关键句（AP 反 Whig 史观爱考）：被推走的一方**不是被动等死**的——
他们里面有最清醒的战略家。Tecumseh 失败，不一定是想法错，可能是时间不够、大势太猛。
这正是"原住民能动性"(Native agency) 的核心论点。`,
          en: `Tecumseh's whole Lens is this. He saw one thing: white people bought, tricked,
...
1. **Confederacy center** Prophetstown, with his brother **Tenskwatawa ("the Prophet")** —
   one in word, one in war (the spiritual call).
2. **Nov 7, 1811 Battle of Tippecanoe**: while Tecumseh was away recruiting allies, Harrison
   marched in; the confederacy was badly hurt and Prophetstown burned. (Note: the opponent
   was Harrison vs the brother — Tecumseh was not there.)
3. **Oct 5, 1813 Battle of the Thames (in today's Ontario, Canada)**: in the War of 1812
   Tecumseh allied with Britain and kept resisting, was **killed here**, and the confederacy
   fell apart with him.

Key exam sentence (AP's anti-Whig reading loves this): the side pushed off was **not
passively waiting to die** — it held the clearest strategist of its age. Tecumseh's failure
may not mean the idea was wrong, but that there wasn't enough time and the tide was too
strong. This is the core of "Native agency."`,
        },
      },
    },

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `被卖少年那一遍第 3、7 节。这是 AP 越来越爱考的"市场革命的暗面"。

背景：他小时候南方很多人以为奴隶制会**慢慢自己消失**（烟草把地种穷，养奴隶快不划算）。
...
harsher labor + **permanent separation from family**. This is the "domestic slave trade."

Key exam sentence: **"westward expansion" was a fate-changing direction for white farmers,
but for the enslaved it was the direction of being sold deeper, farther from home**. The
same "west," two opposite worlds — exactly the DBQ "same evidence, two readings."
...
him were sold. Prosperity and being sold were one and the same force.`,
...

    {
      ...
      standaloneText: {
        cn: `**Panic of 1819（1819 大恐慌）** 是**美国第一次全国性经济危机**，故事里只点了它的爆发，
没单独展开，但它是市场革命"网越大、越脆弱"的活教材，要单独掌握。

**起因（一连串叠加）：**
- 1812 战争后的**繁荣 + 投机**：欧洲恢复后对美国棉花、粮食的需求回落。
- **土地投机**：西部地价被炒高，借钱买地的人一大片。
- **第二合众国银行（1816 成立）先放水、后猛收贷**：信贷一收紧，泡沫就破了。

**后果：** 地价崩、银行倒、城市大批人失业——这是美国人第一次集体发现：
**连在一张全国市场网上，意味着一处崩、处处疼**。一个地方的危机会顺着网传遍全国。

**和奴隶制的连锁（被卖少年那一遍点过）：** 危机一来，最先被当成"省钱的东西"卖掉抵债的，
还是账本上的被奴役者。繁荣时被卖得越远，崩塌时也照样第一个被推出去。

考点关键句：Panic of 1819 = 美国第一次全国性经济萧条，是市场革命"系统性脆弱"的第一次显形；
它也激化了关于第二合众国银行、联邦经济角色的争论，为后来的政党重组埋下情绪。`,
        en: `The **Panic of 1819** was **America's first nationwide economic crisis**. The
story only marks its outbreak without unpacking it, but it's a live lesson in the market
revolution's "the bigger the net, the more fragile," so master it separately.

**Causes (a stack of factors):**
- Post-War-of-1812 **boom + speculation**: European demand for American cotton and grain fell as Europe recovered.
- **Land speculation**: western land prices were bid up; many borrowed to buy.
...
**Effects:** land values collapsed, banks failed, cities filled with the jobless — the
first time Americans collectively discovered that **being linked into one national market
net means one crash hurts everywhere**. A local crisis spreads nationwide along the net.

**The chain with slavery (the sold boy's Lens touches it):** when the crisis hit, the first
"thing to be sold off to pay debts" was still the enslaved on the ledger. Sold ever farther
in good times, pushed out first in the crash.
...
the Second Bank and the federal role in the economy, seeding the mood for later party
realignment.`,
      },
      xiaoweiNote: {
...
最容易得分的连锁：繁荣（市场革命）→ 投机 + 银行放水 → 1819 银行收贷 → 全国崩。
配上"危机里被奴役者最先被卖掉抵债"这一句，就能在 DBQ 里同时拿住"繁荣"和"代价"两面。`,
        en: `Teacher said AP doesn't test this every year, but it's the key evidence that
flips the "market revolution" from "good news" to "double-edged sword." Memory anchor:
**bigger net → one crash hurts everywhere.** That's the cost of "connection."

The easiest-scoring chain: boom (market revolution) → speculation + easy bank credit → 1819
credit tightening → nationwide crash. Add the line "in the crisis the enslaved were sold off
first to pay debts," and you can hold both "prosperity" and "cost" at once in a DBQ.`,
      },
    },
...
故事里在 Jefferson 第 9 节一句带过，要单独掌握。

**是什么：** **1823 年 12 月**，Monroe 总统在国情咨文里宣布——
**美洲不再是欧洲列强的殖民对象，美洲的事美洲自己管，美欧互不干涉**。
原文关键句："美洲大陆……从今往后，不能再被任何欧洲国家当作殖民的对象。"

**为什么这时提：** 拉美各国刚刚纷纷独立，眼看欧洲列强可能想趁机插手美洲。

**两个最常考的"反直觉"点：**
1. **真正的设计者不是 Monroe，是国务卿 John Quincy Adams（小亚当斯）**——他后来当了总统。
   课本以 Monroe 命名，但主笔是 Adams。
2. **1823 年的美国其实没实力执行它**——美国海军很弱。真正让它有效的，
   是当时**英国皇家海军**也不希望别国插手美洲（英美利益碰巧一致）。
   所以它更像一份"长期意向声明"，而非当下就能落地的硬实力。

考点关键句：门罗主义定下了美国此后一个多世纪"把整个西半球视为自己后院"的外交基调。`,
        en: `The **Monroe Doctrine** is a required **foreign-policy principle** in APUSH Period
4. The story mentions it in one line in Jefferson's Node 9, so master it separately.

**What it is:** in **December 1823**, President Monroe announced in his annual message —
...
**Why now:** the nations of Latin America had just been winning independence, and European
powers looked likely to try to step into the Americas.

**Two most-tested "counterintuitive" points:**
1. **The real architect was not Monroe but Secretary of State John Quincy Adams** — who
   later became president. The textbook names it for Monroe, but Adams drafted it.
2. **The U.S. in 1823 actually lacked the power to enforce it** — its navy was weak. What
...
记忆口诀：**门罗主义 = 美洲是美国后院 + 真正作者是国务卿 Adams + 当时是空头支票（靠英国海军兜底）**。`,
...
Mnemonic: **Monroe Doctrine = Americas are America's backyard + real author is Secretary of
State Adams + at the time a blank check (backed by the British navy).**`,
      },
    },

    {
      ...
      standaloneText: {
        cn: `这张卡把"好感时代"到 1828 政党改组**一条政治线**连起来，故事没展开（它聚焦土地、战争、市场），
但 APUSH 把它当 Period 4 收尾的关键转折，要单独掌握。

**1. Era of Good Feelings（好感时代，约 1817-1825）：**
...
**2. corrupt bargain（肮脏交易，1824-1825）：**
1824 大选四人混战，**Andrew Jackson 拿到最多普选票和选举人票却没过半数**。
按宪法**第 12 修正案**，由众议院从前三名里选。众议院议长 **Henry Clay 把票投给 John Quincy Adams**，
Adams 当选后又任命 Clay 当国务卿。Jackson 阵营大骂这是 **"corrupt bargain"（肮脏交易）**，
撕碎了"好感时代"的假和气。

**3. 1828 政党改组：** 憋着一口气的 Jackson 在 **1828 年**卷土重来、当选总统。
**第一次政党体系彻底改组**，围绕 Jackson 的新民主党登场——这一代"站稳、长大"的故事，
交棒给下一代"杰克逊时代"。
...
**1. Era of Good Feelings (c. 1817-1825):**
...
**3. The 1828 realignment:** Nursing his grievance, Jackson came roaring back and won the
presidency in **1828**. The **first party system was thoroughly realigned**, and a new
Jacksonian Democratic Party took the stage — this generation's "standing up, growing up"
story handing off to the next, the "Jacksonian era."
...
really a transition in which the old system collapsed and a new one was born.`,
      ...
      xiaoweiNote: {
        cn: `老师说这条 AP 喜欢考"好感时代到底好不好感"——答案：表面和气，底下密苏里之争已经劈开国家，
是假象。还有"肮脏交易"是高频名词：Jackson 最多票却没过半 → 众议院选 Adams → Clay 当国务卿 → Jackson 骂。

记忆锚：**Era of Good Feelings = 假和气；corrupt bargain = Clay 投 Adams、换来国务卿；1828 = Jackson 复仇当选、政党重组**。
这条线把整个 Period 4 收口。`,
...
Memory anchor: **Era of Good Feelings = false harmony; corrupt bargain = Clay backs Adams,
gets Secretary of State; 1828 = Jackson's revenge win, party realignment.** This thread
closes out all of Period 4.`,
      },
    },
  ],
  ...
  thinkingQuestions: [
    {
      id: 'q1',
      cn: `一向主张"宪法没写的，政府就不能做"（strict construction）的 Jefferson，
...
say" (strict construction), did the single biggest thing the Constitution never authorized —
...
the country to find a respectable step down from breaking his own principle"? Support your
judgment with at least two specific pieces of evidence.`,
      hintCn: `提示：这题没有标准答案，AP 评分看你**用证据**的能力，不看你站哪边。
- "成熟担当"这边的证据：机会百年难逢、错过就没；1500 万买半个大陆、每英亩才几美分；
  原则死板到让国家错失生路才是失职。
- "破例借口"这边的证据：他自己承认"咽下了对宪法的顾虑"；今天能为大义破一次，明天就能再破；
...
- Evidence for "mature responsibility": the chance came once in a century and would be gone;
  $15 million for half a continent, a few cents per acre; a principle so rigid it makes the
  nation miss its way out is the real dereliction of duty.
- Evidence for "an excuse for an exception": he admitted he "swallowed his constitutional
  doubts"; break the rule once today and you can break it again tomorrow; what he bought was
  not only an "empire of liberty" but land where slavery could spread west and the home dozens
...
你可以让学生比较"同一片地"的两种讲法：一种以"成长"为主语（购地让面积翻倍、运河让千万人更富），
一种以"失去的人"为主语（被划走的玉米地、那条 36°30′ 线、"被卖下河"）。
关键不是问"该不该承认进步"，而是问"把多数受害者写成一行脚注的历史，缺了哪半真相"。
你的题目可以要求学生**各用一条具体证据**支撑两面——这正是 AP 要的"看见沉默的大多数"。`,
      hintEn: `Hint: a good DBQ forces students to **see two things at once**, not pick one.
Have students compare two tellings of "the same land": one with "growth" as the subject (the
purchase doubled territory, canals made millions richer), one with "the people who lost" as
the subject (the cornfield marked away, the 36°30′ line, "sold down the river"). The point
isn't "should we admit progress," but "what half of the truth is missing from a history that
writes most of its victims as one footnote." Your question can require students to support
**both sides with one specific piece of evidence each** — exactly the AP "see the silent
majority."`,
...
Support your view with at least one specific piece of evidence.`,
      hintCn: `提示：先把这题和"他是不是英雄"分开——AP 不是让你给他打分，是让你分析"失败说明了什么"。
- "想法太理想"这边的证据：要几十个有世仇的民族放下几代旧怨、交出"我自己说了算"的权力，违背人性；
  他一离开 Prophetstown，弟弟就没忍住开战（Tippecanoe）——联盟连一次外出都扛不住。
- "看得对、只是太早"这边的证据：他说"不联合就被一个个吃掉"，后来几十年东南原住民真的被一个个推走、
  被迫西迁，一一应验；Thames 一战他死、联盟散，正说明它太依赖一个人、还没长成。
高分写法：两面都拿住，再说明你为什么更倾向某一边。`,
      hintEn: `Hint: first separate this from "was he a hero" — AP isn't asking you to grade him,
but to analyze "what the failure shows."
- Evidence for "too ideal": asking dozens of feuding nations to set down generations of
  grudges and hand over "I decide for myself" runs against human nature; the moment he left
  Prophetstown, his brother couldn't hold back from fighting (Tippecanoe) — the confederacy
  couldn't survive a single absence.
- Evidence for "right but too early": he said "do not unite and you are eaten one by one," and
  in the decades that followed Southeastern Native nations really were pushed off one by one
  and forced west, borne out; that his death at the Thames scattered the confederacy shows it
  leaned too much on one man and hadn't matured.
