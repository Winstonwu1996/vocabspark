...
🔗 故事连接：威尔逊在 Lens 1 第 2 节把两大阵营 + 军备竞赛叫"两堆堆到顶的干柴"；
普林西普在 Lens 2 第 6 节说得最透——"我点的只是火星，可炸药，是他们自己堆好的"。
M.A.I.N. 就是那堆炸药的四个名字。`,
...
Underlying cause ≠ trigger — keep these two apart; AP loves to set the trap right here.`,
    ...
    // ── 卡 2：斐迪南遇刺 / 导火索（故事覆盖 — Princip lens）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个我读过！Lens 2 第 1 节就是普林西普开枪那一刻。重点记牢：
...
piled up.`,
    ...
    // ── 卡 3：联盟连锁 / 七月危机（故事覆盖 — Wilson + Princip）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 2 第 5 节讲清了导火索之后那一个月发生了什么——就是著名的
...
威尔逊在 Lens 1 第 2 节把它形容得很妙："战争像一台没人能关掉的机器：
...
🔗 故事连接：威尔逊在 Lens 1 第 4 节坐在白宫，想象他签字送去的士兵面对的就是这些；
塞内加尔狙击兵 Demba 在 Lens 3 第 4 节，**亲身**站在 1916 年凡尔登附近的战壕里——
...
这条直接连到 womens-suffrage Topic，是跨 Topic 的高分连线。`,
...
womens-suffrage topic — a high-scoring cross-topic connection.`,
    ...
    // ── 卡 6：殖民地士兵 / 塞内加尔狙击兵（故事覆盖 — tirailleur default lens）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 3 整条线就是这个——这也是这个 Topic 的**默认视角**，老师特别说要认真读。
...
non-European people.)`,
    ...
    // ── 卡 7：威尔逊十四点 + 自决 + 国联（故事覆盖 — Wilson lens）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Lens 1 整条线就是威尔逊。这是 **APUSH 必考人物**，老师说几乎年年出。重点：

**美国怎么参战（Lens 1 第 3 节）**：1917 年两件事把美国逼进战争——
...
**十四点（Fourteen Points，Lens 1 第 5 节）**：1918.1.8 提出的和平蓝图，必背四条——
...
同一双手 1913 年起在白宫重推联邦机构种族隔离（连到 reconstruction Topic 的倒退）。
...
🔗 故事连接：威尔逊在 Lens 1 第 9 节亲口承认苛刻和约埋下了二战的引线；
塞内加尔狙击兵 Demba 在 Lens 3 第 8 节把"种子"带回非洲——
