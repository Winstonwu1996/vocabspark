...
🔗 故事连接：汉谟拉比那一遍第 2 节，他自己讲怎么打了三十多年仗、为什么统一之后
非立一套统一规矩不可。`,
...
region). Babylon is just one city inside the land between the rivers.`,
    ...
    // ── 卡 2：成文法典的意义（故事覆盖：hammurabi）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这个我读过！汉谟拉比那一遍第 1 节：他在巴比伦城里立起一根两米多高的
...
US Constitution.`,
    ...
    // ── 卡 3：lex talionis 以眼还眼（故事覆盖：hammurabi N5/N6）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `汉谟拉比那一遍第 5、6 节专门讲这个，是整个 Topic 最容易考、也最容易理解错的一条。
...
you pay with your body or your life.`,
    ...
    // ── 卡 4：三等差等正义 awilum/mushkenum/wardum（故事覆盖：all lens N4/N6）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是整个 Topic 的脊梁，三个视角的 N4（"你就是 TA"）和 N6（掰到最清楚一刻）
...
我在三个视角里读到的同一件事，各看一面：
- 汉谟拉比那一遍：三等差等是**设计**，不是 bug——在王眼里"这就是世界本来的样子"。
- 书吏那一遍：他比谁都更早读懂这不公，却**忠实地一字不改**把它刻进永恒。
- 平民女性那一遍：受害这边——"在那块石头上，我从来不是'一个人'，我是'三分之一'。"
...
the hardest evidence for "written ≠ equal."`,
    ...
    // ── 卡 5：君权神授 Shamash（故事覆盖：hammurabi N3）──
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['ham-n3'],
        xiaoweiNote: {
          cn: `汉谟拉比那一遍第 3 节专门讲这个，AP 经常和"统治合法性"(legitimacy) 一起考。
...
This motif returns again and again later (e.g. the medieval European "divine right of kings").`,
    ...
    // ── 卡 6：楔形文字与书吏（故事覆盖：scribe lens）──
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `书吏那一遍整条线就是这个考点。先说清楚：那个书吏是 composite（虚构典型人物，
...
书吏那一遍第 6 节那个画面我忘不了：他亲手把"人不平等"这件本来只是国王嘴里
...
often becomes, to those who come after, "what really happened."`,
    ...
    // ── 卡 7：性别与财产条款（故事覆盖：commoner-woman N3）──
    {
      ...
      storyAnchor: {
        ...
        nodeIds: ['cw-n3'],
        xiaoweiNote: {
          cn: `平民女性那一遍第 3 节专门讲这个，考点是"别走极端"——法典对女性
...
🔗 故事连接：汉谟拉比那一遍第 7 节自己把石柱前挂到 Magna Carta；
平民女性那一遍第 7 节把"三分之一"对照到美国宪法"五分之三"。
