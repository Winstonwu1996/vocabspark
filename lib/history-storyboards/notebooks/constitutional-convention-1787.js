  ...
  mainConcepts: [
    {
      ...
      conceptCn: '邦联条例的缺陷',
      conceptEn: 'Weaknesses of the Articles of Confederation',
      ...
      storyAnchor: {
        ...
        nodeIds: ['mad-n2'],
        xiaoweiNote: {
          cn: `这个我读过！在 Madison Lens 第 2 节，他讲为什么大家这么慌：
...
head were all new).`,
    ...
    {
      id: 'great-compromise',
      conceptCn: '大妥协 / 康涅狄格妥协',
      conceptEn: 'Great Compromise (Connecticut Compromise)',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Sherman Lens 整条线就是这个。大州（弗吉尼亚、宾州）要按人口分席位，
...
still works this way — a direct descendant of that 1787 compromise.`,
...

    {
      ...
      conceptCn: '3/5 妥协',
      conceptEn: 'Three-Fifths Compromise',
      standardRef: ['AP US Gov — Constitution', 'APUSH KC-3.2.II', 'CA HSS 8.2'],
      examFrequency: 'highest',
      storyAnchor: {
        covered: true,
        ...
        xiaoweiNote: {
          cn: `三个 lens 都讲到它，但 Mum Bett Lens 第 7 节最戳人。
...
down to three-fifths. Same word "person," two opposite directions.`,
...

    {
      ...
      conceptCn: '三权分立与制衡',
      conceptEn: 'Separation of Powers & Checks and Balances',
...
🔗 故事连接：Madison Lens 第 3 节讲他读 Montesquieu 把这套思想搬进 Virginia Plan；
...
Federalist 51 (ambition checks ambition)."`,
    ...
    {
      id: 'federalist-10',
      conceptCn: 'Federalist No. 10（派系与大共和国）',
      conceptEn: 'Federalist No. 10 (Factions & the Large Republic)',
...
🔗 故事连接：Madison Lens 第 8 节讲他和 Hamilton、Jay 合写 The Federalist Papers
...
"representatives."`,
...

    {
      ...
      conceptCn: '批准之争与权利法案',
      conceptEn: 'Ratification Debate & the Bill of Rights',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Madison Lens 第 8、9 节讲到了。签完字（1787.9.17，55 人里只有 39 人签）不算完，
...
admits it: "Those ten clauses weren't our goodwill — our opponents forced them out of us.")`,
...

    {
      ...
      conceptCn: '宪法里的奴隶制条款与"回避的词"',
      conceptEn: 'Slavery Clauses & the Word the Constitution Avoided',
      ...
      storyAnchor: {
        ...
        nodeIds: ['mad-n7'],
        xiaoweiNote: {
          cn: `Madison Lens 第 7 节专门讲奴隶制的妥协，不止 3/5 这一笔，一共**三处条款**：
...
AP scoring rewards.`,
...

    {
      ...
      conceptCn: 'Madison 的双面角色',
      conceptEn: 'Madison\'s Two-Faced Role',
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Madison Lens 整条线就是他，第 10 节的 synthesis 把他的"双面"说得最清楚。
...
AP DBQ wants.`,
  ...
  thinkingQuestions: [
    {
      id: 'q1',
      questionCn: `1787 年那部宪法开篇喊"We the People（我们人民）"，又写"所有人……"，
可它同一口气，用三处条款保护奴隶制，还把约六分之一的人（被奴役者）算成 3/5。

你觉得这部宪法应该被看成"一个谎"，还是"一张还没兑现的支票"？
用至少两条具体证据支持你的判断。`,
      questionEn: `The 1787 Constitution opens crying "We the People" and writes "all..." —
...
that's complexity.`,
    ...
    {
      id: 'q2',
      questionCn: `1787 年 7 月 16 日，大妥协以 5 比 4 通过——只差一票。它让会议没散，
保住了国家；可同一套妥协逻辑，也帮着把不在谈判桌上的被奴役者写成了 3/5。

如果你是 AP 老师，要出一道题考"妥协是建国的智慧，还是对弱者的牺牲"，
你会怎么提问？请写出你的题目，并说明这道题想逼学生看见什么。`,
      questionEn: `On July 16, 1787, the Great Compromise passed 5 to 4 — by one vote. It kept
...
former praised as "founding wisdom" while the latter is a stain? Where's the difference?`,
    ...
    {
      id: 'q3',
      questionCn: `Madison 在 Federalist 51 写"必须让野心去对抗野心"，设计了三权分立和制衡，
说他不指望当权者是好人，只指望他们互相牵制。

你同意"与其指望好人当权，不如设计制度让坏人也作不了恶"这个思路吗？
这是聪明的现实主义，还是对人性的悲观？用宪法里的一个具体制衡机制来支持你的看法。`,
      questionEn: `In Federalist 51 Madison wrote "ambition must be made to counteract
