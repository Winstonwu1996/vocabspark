...
I drew myself a little map: the four slaveholding border states (KY/MD/MO/DE) = the states Lincoln had to keep "coaxed."`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `这是整门课的核心，三遍故事都在第 6 节用**同一张纸**做了对位（N6 跨视角锚），我超喜欢这个设计。
...
**同工不同酬**：白人兵每月 13 美元（衣物免费），黑人兵 10 美元还要扣 3 美元衣物费 = 到手 **7 美元**。一样上战场、一样会死，工资差一截。**第 54 麻省团整团罢领军饷顶了一年多**抗议，直到 **1864 年国会才把军饷拉平**。小 U画重点：他们要的不只是"自由"，是"平等"。
...
注意时间：这篇演说是 **1865 年 3 月**讲的，比 4 月 9 日 Lee 投降**早一个多月**。别记成"投降后才讲"。
...
**但"废奴 ≠ 平等"**（黑人士兵第 10 节）：第 13 修正案废了奴隶制，可战后南方很快用法律和暴力夺回黑人刚得到的权利，让"自由"对每个黑人真正算数又花了一百年（到 1960s 民权运动）。这条直通**重建（Reconstruction）那段历史**。

考点关键句：**第 13 修正案（1865 底）把废奴从战时命令升级为对所有州永久生效的宪法，但战后平等远未实现，权利被夺回、百年后才补（接重建那段历史）。**`,
...
Key exam sentence: **The 13th Amendment (late 1865) upgraded abolition from a wartime order into a constitutional clause binding on all states permanently — but equality was far from achieved, rights were taken back, and the gap took a century to close (leads to the Reconstruction topic).**`,
...

    {
      ...
      standaloneText: {
        cn: `故事里 Lincoln 说南北"吵了几十年"、"每次妥协都撑不住上一次"——密苏里妥协（1820）就是这条断裂链的第一环，AP 考试高频出现。

**背景**：1819 年密苏里申请以蓄奴州身份加入联邦，南北在国会僵住——批准，就打破蓄奴/自由州数量平衡。

**妥协内容（三件事记住）**：
1. 密苏里以**蓄奴州**加入联邦。
2. 同时把缅因从马萨诸塞分出，以**自由州**加入，保持两边票数对等。
3. 划定**北纬 36°30' 线**：此后从路易斯安那购地内划出的新州，在线以北禁奴，以南可蓄奴。

**效果与局限**：妥协撑了三十四年。1854 年堪萨斯-内布拉斯加法将这条线废除，矛盾再度爆发。1857 年 Dred Scott 案中最高法院更裁定该妥协违宪，彻底埋葬它。

考点关键句：**密苏里妥协（1820）靠"一蓄一自由"和 36°30' 纬线暂时平息奴隶制西扩之争；它是内战前最重要的立法妥协，也证明奴隶制扩张问题靠妥协只能拖延、无法解决。**`,
...
Key exam sentence: **The Missouri Compromise (1820) temporarily quieted the fight over slavery's westward spread through a "one slave, one free" pairing and the 36-30 line; it was the most important legislative compromise before the Civil War, and it proved that the question of slavery's expansion could only be delayed, never solved, by compromise.**`,
      ...
      xiaoweiNote: {
        cn: `我的记忆钩子：**Missouri = Mo、Maine = Me、36-30 = 那条线**。三件事打包：Mo 进（蓄奴）/ Me 进（自由）/ 36°30' 划线。

AP 常考的坑：别把密苏里妥协和 1850 年妥协搞混。密苏里妥协（1820）是最早这条；1850 年妥协是南北各让一步（加州自由 + 逃奴法强化）；1854 年堪萨斯-内布拉斯加把 1820 的线废掉，局势彻底失控。三个时间点要分清。`,
...
AP trap: don't mix up the Missouri Compromise with the Compromise of 1850. Missouri Compromise (1820) is first; the 1850 Compromise had both sides give ground (California free + stronger Fugitive Slave Act); the Kansas-Nebraska Act of 1854 erased the 1820 line and things spun out of control. Keep the three dates straight.`,
...

    {
      ...
      standaloneText: {
        cn: `密苏里妥协划的那条 36°30' 线撑了三十四年。1854 年，参议员 Stephen Douglas 提出堪萨斯-内布拉斯加法，把它废掉了，内战前因果链从这里急速升温。

**法案内容**：把路易斯安那购地北部（原 36°30' 线以北，按妥协应禁奴）划为堪萨斯和内布拉斯加两个准州，但不直接规定蓄奴或禁奴——让**当地居民自己投票决定**（popular sovereignty，人民主权原则）。

**后果（三条必背）**：
1. **"流血的堪萨斯"（Bleeding Kansas）**：南北双方抢着往堪萨斯移民、争夺投票多数，冲突升级为武装流血，美国提前进入微型内战状态。
2. **共和党成立（1854）**：北方反对派愤怒集结，创立新政党，纲领核心：**阻止奴隶制向西扩张**。Lincoln 就是这个党后来推出的总统候选人。
3. **南北裂痕不可弥合**：这一法案证明"妥协"已失效，双方再无共同政治地基，内战倒计时从这里开始。

考点关键句：**堪萨斯-内布拉斯加法（1854）废除密苏里妥协的 36°30' 禁奴线，以"人民主权"取代，引发"流血的堪萨斯"、催生共和党，是奴隶制西扩之争从议会辩论升级为武装冲突的转折点。**`,
...
Key exam sentence: **The Kansas-Nebraska Act (1854) repealed the Missouri Compromise's 36-30 ban on slavery, substituted popular sovereignty, triggered "Bleeding Kansas," and gave birth to the Republican Party — the turning point when the fight over slavery's westward spread moved from congressional debate to armed conflict.**`,
      ...
      xiaoweiNote: {
        cn: `老师说的"内战因果链"顺序：
**1820 密苏里妥协**（划线）→ **1850 妥协**（各退一步）→ **1854 堪萨斯-内布拉斯加法**（废线、人民主权）→ **Bleeding Kansas**（小型内战）→ **共和党成立**→ **1860 Lincoln 当选**→**南方脱离**。

这条链掌握了，APUSH 关于内战起源的因果题基本稳了。DBQ 常问：堪萨斯-内布拉斯加法为什么比之前任何妥协都更"不可逆"？答案：它不是双方都给一点，而是把"谁赢就是谁的"变成了武装竞争，把问题扔还给基层冲突解决——结果冲突解决不了，只有打。`,
