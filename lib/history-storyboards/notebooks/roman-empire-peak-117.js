...
//   - 意大利被奴役者约 100 万-150 万，约占人口 1/4-1/3（narrative §5 D）
...
考点关键句：罗马版图的顶点 = 公元 117 年 = Trajan。这是本 topic 的招牌时间点，一定要钉死。
...
quarter to a third of Italy's population. (Node 5)
...
这个理念，远端连到 Magna Carta（大宪章 1215）和美国宪法。你跑过那两个 topic 会认得这条线。
...
还有一句跨 topic 的对应记下来："罗马法 = 西方 rule of law 的远祖，远端连到 Magna Carta 和美国宪法。"`,
...
- 社会底座：罗马高度依赖奴隶制（战俘为主，约占意大利人口 1/4-1/3）；
...
- The social base: Rome relied heavily on slavery (war captives mainly, about a quarter to a third
  of Italy's population); Han rested on registered free farmers plus dependents of great estates
...
可这份"伟大"，是靠不断征服别人、把约占意大利四分之一到三分之一的人变成奴隶，喂出来的。
...
quarter to a third of Italy's people into slaves.
...
- "机器"这边的证据：意大利约 1/4-1/3 人口被奴役、罗马法把奴隶划成"物"、
...
side you pick.
- Evidence for "machine": about a quarter to a third of Italy enslaved, Roman law drawing slaves
