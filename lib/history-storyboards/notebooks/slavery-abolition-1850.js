...
simple "good whites freed passive Blacks" story (the self-emancipation view).`,
...

    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `Tubman 整条线就是她（也是这个 Topic 的 default lens）。
...
careful framing（第 8、9 节小薇最喜欢的一点）：这一步步，没有一步是"疯子"干的。
...
Careful framing (Xiaowei's favorite point from Nodes 8-9): not a single one of these steps
