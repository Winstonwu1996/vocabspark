...
have to be able to draw that chain."`,
    keyTerms: [
      { cn: '法印战争（七年战争北美战场）', en: 'French & Indian War (Seven Years\'s War in N. America)' },
    ...
    keyFigures: [
      {
        ...
        roleCn: '1763 年起的英国首相兼财政大臣，推糖税与印花税。手里拿着一本合理的账单，却完全误读了殖民者的情绪。',
        roleEn: 'British Prime Minister and chief finance minister from 1763; pushed the Sugar and Stamp Acts. He had a reasonable bill in hand but completely misread what the colonists felt.',
        mustKnow: true,
      ...
      },
      {
        ...
        nameEn: 'John Adams',
        ipa: '/dʒɒn ˈædəms/',
        roleCn: '波士顿律师，反对英国苛政，却替开枪英军辩护。他夹在"自由"与"法治"之间，是最孤独的那种勇气。',
        roleEn: 'Boston lawyer who opposed British tyranny yet defended the soldiers who fired. Caught between "liberty" and "the rule of law," he showed a lonely kind of courage.',
        mustKnow: true,
        audioKey: 'john-adams',
      },
      {
        ...
        nameEn: 'Pontiac',
        ipa: '/ˈpɒntiæk/',
        roleCn: 'Ottawa 领袖，1763 年联合俄亥俄河谷-五大湖多民族反英起义的核心人物。',
      ...
      },
      {
        ...
        nameEn: 'Paul Revere',
        ipa: '/pɔːl rɪˈvɪər/',
        roleCn: '银匠，刻了"波士顿惨案"宣传版画——史上最早、最有力的政治宣传画之一，不是中立的现场记录。AP 考出处分析（sourcing）必考。',
        roleEn: 'Silversmith who engraved the "Boston Massacre" propaganda print — one of the earliest, most powerful political prints in history, not a neutral record. A must-know for AP sourcing questions.',
        mustKnow: true,
        audioKey: null,
      },
      {
        ...
        ipa: '/ˈkrɪspəs ˈætəks/',
        roleCn: '非裔/原住民混血码头工人，波士顿惨案 5 名死者之一。AP 考"被排除群体"时常被引用。',
        roleEn: 'Dockworker of African and Native descent, one of the five killed in the Boston Massacre. Frequently cited in AP questions on excluded groups.',
        mustKnow: true,
        audioKey: null,
      },
      {
  ...
  mainConcepts: [
    {
      ...
      defCn: '1754-1763 年，英国和法国为争夺北美打了一场大仗，叫做法印战争（French & Indian War）。英国赢了，却背上了一座巨额债山——这是后来所有征税的起点。',
      defEn: 'From 1754 to 1763, Britain and France fought a major war over North America called the French & Indian War. Britain won but was left with an enormous debt — this is the starting point of every later tax.',
      standardRef: ['APUSH Topic 3.2 (Seven Years\'s War)', 'CA HSS 8.1'],
      ...
      xiaoweiNote: {
        cn: `这张卡是整条因果链的起点。Grenville 那条故事线里讲得最清楚。

1754-1763 年，英国和法国为争夺北美（尤其是西部那片地）打了一场大仗。
殖民者叫它 **French & Indian War（法印战争）**，因为对手是法国人 + 站法国一边的原住民。
它是全球性 **Seven Years' War（七年战争）** 的北美战场。
**1763 年 2 月 10 日，Treaty of Paris（巴黎和约）** 签订：英国赢，法国基本退出北美大陆。

战后那本账，我把它记成两个数字：
**国债约从 7500 万 → 约 1.33 亿英镑，几乎翻倍。**
**新得的西部要养约一万驻军，一年还要花约 20 万英镑。**

考点关键句：胜利反而留下"一座还不完的债山 + 一笔停不下来的军费"。这是后面所有征税的**起点**。AP 爱考"战争如何制造了战后的财政危机"。`,
        en: `This card is the starting point of the whole chain. Grenville's story line explains it most clearly.
...
**Debt rose from about 75 million → about 133 million pounds — nearly doubled.**
**The new western lands needed about 10,000 troops, costing about 200,000 pounds a year.**
...
"how did the war create the postwar fiscal crisis."`,
...

    {
      ...
      defCn: '战前几十年，伦敦管殖民地管得很松，让他们自己收税、自己管事，这叫"有益的忽视"（salutary neglect）。战后，伦敦为了还债，第一次认真伸手来收殖民者的钱——打破了这种默契。',
      defEn: 'For decades before the war, London loosely governed the colonies, letting them tax themselves and run their own affairs — this is called "salutary neglect." After the war, London reached into colonial pockets for the first time to pay debts, breaking that long-standing understanding.',
      ...
      xiaoweiNote: {
        cn: `Grenville 那条故事线里专门点了一句"记住，后面要用"的伏笔——就是这个。

1763 年之前，伦敦对北美管得很松。几十年来基本是 **salutary neglect（有益的忽视）**：
殖民地自己收自己的税、管自己的事，习惯了**高度自治**。

我自己的理解锚：英国不是"突然变坏"，是**突然不再放手**了。
战后要还债，伦敦第一次认真地"伸手"进殖民地的口袋，打破了几十年的默契。
殖民者那种"被冒犯"的感觉，一大半来自这个反差：
**以前你不管我，现在凭什么突然来管我、来收我的钱？**

考点关键句（AP Continuity & Change 高频）：
变了的是"伦敦从放手到伸手"。
没变的是社会内部对女性、原住民、被奴役者的排除。
答 Continuity & Change（延续与变化）题时，这两条要同时点到。`,
        en: `In Grenville's story line there's a deliberate "remember this — it matters later" hook.
This is it.

Before 1763, London ruled North America loosely. For decades it was, in effect, **salutary
neglect**: the colonies set and collected their own taxes, ran their own affairs, and grew used
to **wide self-rule**.

My own anchor: Britain didn't "suddenly turn bad" — it suddenly **stopped letting go**. To pay
off the war debt, London for the first time seriously "reached in" to colonial pockets, breaking
a decades-old understanding. Much of the colonists' sense of being insulted comes from that
contrast: **you ignored me for decades — now by what right do you suddenly rule me and take
my money?**

Key exam sentence (high-frequency for AP Continuity & Change):
What changed: "London from letting go to reaching in."
What stayed the same: the exclusion of women, Native peoples, and the enslaved inside colonial
society. On a Continuity & Change question, name both.`,
      },
    },

    {
      ...
      defCn: '1763 年春，以 Ottawa 领袖庞蒂亚克（Pontiac）为代表，俄亥俄河谷到五大湖一带多个原住民民族第一次大规模联合，攻打英军西部要塞，这就是庞蒂亚克起义（Pontiac\'s War）。它直接逼出了 1763 宣言线。',
      defEn: "In spring 1763, Ottawa leader Pontiac led a large-scale united uprising of many Native nations from the Ohio Country to the Great Lakes, attacking British forts in the west — this is Pontiac's War. It directly forced Britain to issue the Proclamation Line of 1763.",
      ...
      xiaoweiNote: {
        cn: `这是俄亥俄河谷原住民青年那条故事线里的核心，也是标准叙事最容易漏掉的一块——但 AP 现在很爱考。
...
他们不是被动的旁观者，而是**有能动性（agency）的第三方**。
庞蒂亚克起义直接逼出了 1763 宣言线（下一张卡）。
AP 的 DBQ 现在常考"原住民能动性（Native agency）"，这条是必备证据。`,
        en: `This is the core of the Ohio Country youth's story line, the piece the standard story most
easily drops — but AP now loves testing it.
...
people. A Delaware prophet, **Neolin**, preached unity and a return to ancestral ways.

In the **spring of 1763**, led by the Ottawa leader **Pontiac**, many nations from the Ohio Country
...
now often test "Native agency" — this is essential evidence.`,
...

    {
      ...
      defCn: '1763 年 10 月 7 日，英王沿阿巴拉契亚山脉（Appalachian Mountains）划了一条线，禁止殖民者越线西迁，说山以西的土地"保留给原住民各部"。这条线两头都不讨好，是西部矛盾被点燃的第一步。',
      defEn: 'On October 7, 1763, the King drew a line along the Appalachian Mountains forbidding colonists from moving west. The land west of the line was said to be "reserved for the Native nations." This line pleased neither side and was the first step in igniting the western conflict.',
      ...
      xiaoweiNote: {
        cn: `三条故事线都触到它，但俄亥俄河谷原住民青年那条故事线里讲得最戳人。

**1763 年 10 月 7 日**，英王颁布 **Proclamation Line of 1763（1763 宣言线）**：
沿 **Appalachian Mountains（阿巴拉契亚山脉）** 划一条线（地图上的一条南北走向的天然山界），
...
考点关键句：宣言线是"一张纸，三种读法"的经典例子，也是西部矛盾被点燃的第一步。`,
        en: `All three story lines touch it, but the Ohio Country youth's story line hits hardest.

On **October 7, 1763**, the King issued the **Proclamation Line of 1763**: a line drawn along
the **Appalachian Mountains** (a north-south mountain ridge on the map), forbidding colonists
from crossing westward. The land west of the line was "reserved for the Native nations."
...
case, and the first step in igniting the western conflict.`,
...

    {
      ...
      defCn: '"无代表不纳税"（no taxation without representation）是殖民者的核心口号，意思是：没有我们自己选出的代表点头，政府就不能向我们收税。这不是钱多钱少的问题，是"谁有权动我口袋"的原则之争。',
      defEn: '"No taxation without representation" was the colonists\' core slogan: no one may tax us without the consent of representatives we elected ourselves. This was never about the amount of money — it was a fight over the principle of who has the right to touch our money.',
      ...
      xiaoweiNote: {
        cn: `Grenville 那条故事线和 John Adams 那条故事线正好从两边讲同一条原则——这是整条链的"宪政内核"。
...
这也解释了为什么后来茶税那一点点钱也能引爆倾茶——抗的始终是那个"权"字。`,
        en: `Grenville's story line and John Adams's story line tell the same principle from two sides —
...
resisted was always the question of "the right."`,
...

    {
      ...
      defCn: '1764-1765 年，英国连出三道法令：糖税（Sugar Act）、印花税（Stamp Act）、驻军法（Quartering Act）。印花税打在几乎每张印刷品上，偏偏得罪了最会写、最会串联的律师和报人。自由之子（Sons of Liberty）由此成立，开始组织街头抗议。',
      defEn: 'Between 1764 and 1765, Britain passed three laws: the Sugar Act, the Stamp Act, and the Quartering Act. The Stamp Act hit nearly every printed item and angered exactly the lawyers and printers who were best at writing and organizing. The Sons of Liberty formed and began street protests.',
      ...
      xiaoweiNote: {
        cn: `Grenville 那条故事线里连着把头几道税和第一次抵抗讲完了。我把它排成一条小链：

① **1764 Sugar Act（糖税）**：加严对进口糖蜜的征税和缉私。
   英国第一次明确"为了向殖民地要钱"而立的税。
② **1765 Stamp Act（印花税）**：打在报纸、文件、契约、扑克牌等几乎每张印刷品上。
   它的致命之处：**偏偏得罪了律师、商人、报人、印刷工**。
   在一个识字率和报纸普及率极高的社会里，等于拍醒了最会把怒火印成传单、传遍十三殖民地的人。
③ **1765 Quartering Act（驻军法）**：要殖民地出钱出房养英军。
④ 反抗：**Sons of Liberty（自由之子）** 成立，**1765 年 8 月 14 日** 在波士顿吊起税吏草人示众。

考点关键句：印花税为什么比糖税炸得厉害？因为它**得罪的人**会写、会串联、会印。
一个政策最危险的地方，常常是它"得罪了谁"。`,
        en: `Grenville's story line runs through the first taxes and the first resistance. I line them
up as a mini-chain:

① **1764 Sugar Act**: tightened duties and anti-smuggling on imported molasses — the first
   time Britain plainly wrote a tax "to raise money from the colonies."
② **1765 Stamp Act**: fell on newspapers, documents, contracts, playing cards — nearly every
...
③ **1765 Quartering Act**: made the colonies pay and house British troops.
④ Resistance: the **Sons of Liberty** formed and, on **August 14, 1765**, hung an effigy of a
...
"whom it offended."`,
...

    {
      ...
      defCn: '1765 年，九个殖民地代表第一次聚在一起开会，这叫印花税大会（Stamp Act Congress）。英国之后撤销了印花税，但同时通过宣告法（Declaratory Act），宣告议会"在一切情况下"对殖民地都有立法权——钱让步了，权一步不退。',
      defEn: 'In 1765, delegates from nine colonies met together for the first time at the Stamp Act Congress. Britain then repealed the Stamp Act but simultaneously passed the Declaratory Act, stating Parliament had authority over the colonies "in all cases whatsoever" — they gave ground on money but not on power.',
      standardRef: ['APUSH Topic 3.3', 'CA HSS 8.1'],
      examFrequency: 'high',
      storyAnchor: {
        covered: true,
      ...
      xiaoweiNote: {
        cn: `Grenville 那条故事线里讲了第一次跨殖民地联合，还有一个最容易被忽略、却最关键的转折。

**1765 年 10 月**：九个殖民地的代表第一次聚到纽约，开 **Stamp Act Congress（印花税大会）**。
这是头一回放下彼此的成见、跨殖民地联合抗议，喊出"无代表，不纳税"。
...
考点关键句：撤印花税（让步）+ 宣告法（不认输）= 同一天的两手，是矛盾被推迟、而非解决的证据。`,
        en: `Grenville's story line covers the first cross-colonial union plus a turning point that's
...
two-handed move of one day, evidence the conflict was postponed, not resolved.`,
...

    {
      ...
      defCn: '1767 年汤森法（Townshend Acts）再次向殖民地征税，英军随之进驻波士顿。1770 年 3 月 5 日，士兵在混乱中开枪，五名殖民者死亡，这就是波士顿惨案（Boston Massacre）。Paul Revere 的版画把这夜画成英军冷血屠杀，但那是宣传品，不是真实记录——这是 AP 考出处分析的核心案例。',
      defEn: 'The 1767 Townshend Acts taxed the colonies again, bringing British troops into Boston. On March 5, 1770, soldiers fired in chaos and five colonists died — the Boston Massacre. Paul Revere\'s engraving depicted it as a cold-blooded slaughter, but it was propaganda, not an accurate record — a core AP sourcing case.',
      ...
      xiaoweiNote: {
        cn: `John Adams 那条故事线里讲完了这一段，还教了一个超出本课的读史技能。
...
**Paul Revere（保罗·里维尔）的"波士顿惨案"版画**把那夜画成"英军成排冷血屠杀手无寸铁的平民"。
但它是**宣传品，不是中立的现场记录**。真实更乱：人群先攻击、士兵恐惧开枪。
要分清"**发生了什么**"和"**谁在怎样讲它**"——连"惨案"这个名字本身，就是一场宣传胜利。`,
        en: `John Adams's story line finishes this stretch and teaches a reading skill beyond the lesson.
...
"**who is telling it, and how**" — even the name "massacre" was itself a propaganda victory.`,
...

    {
      ...
      defCn: '1773 年 12 月 16 日夜，一群人化装成原住民登上茶船，把 342 箱茶倒进波士顿港，这就是波士顿倾茶（Boston Tea Party）。英国震怒，通过一连串报复性法令，殖民者叫它不可容忍法（Intolerable Acts）。这些法令本想孤立马萨诸塞，结果把各殖民地逼成了一体。',
      defEn: 'On the night of December 16, 1773, a group disguised as Native people boarded tea ships and dumped 342 chests of tea into Boston Harbor — the Boston Tea Party. Britain, furious, passed a string of punitive laws the colonists called the Intolerable Acts. Instead of isolating Massachusetts, these laws united the colonies.',
      standardRef: ['APUSH Topic 3.3', 'CA HSS 8.1'],
      examFrequency: 'highest',
      storyAnchor: {
        covered: true,
      ...
      xiaoweiNote: {
        cn: `Grenville 那条故事线の机器视角把链条收到尾声，三个事件一气呵成。

① **1770** 撤汤森法大部，**偏偏留一项茶税**——不为钱，为宣示"议会有权征税"这个**原则**。
② **1773 年 12 月 16 日** 夜：一群人化装成 **Mohawk** 的模样，登上三条茶船，
   把 **342 箱茶**倒进波士顿港——这就是 **Boston Tea Party（波士顿倾茶）**。
   （倒的不是茶，是英国死守的那个"原则"。）
③ **1774**：英国震怒，通过一连串报复性法令，殖民者叫它 **Intolerable Acts（不可容忍法）**：
...
考点关键句：不可容忍法本想杀鸡儆猴、孤立马萨诸塞，**结果适得其反**（见下一张卡）。`,
        en: `Grenville's story line zooms out to the "machine" view and brings the chain to its close,
three events in one breath.

① **1770**: most Townshend taxes repealed, but **one tea tax kept** — not for money, but to
   assert the **principle** that "Parliament has the right to tax."
② Night of **December 16, 1773**: a group disguised as **Mohawks** boarded three tea ships and
...
③ **1774**: Britain, furious, passed a string of punitive laws the colonists called the
...
but **backfired** (see the next card).`,
...

    {
      ...
      defCn: '1774 年 9 月，12 个殖民地的代表齐聚费城，开第一次大陆会议（First Continental Congress），统一抵制英货。十年的怒火第一次有了一个共同的声音。把革命推出来的，不是任何一道单独的税，而是"征税→抗议→镇压→再征税"这台停不下来的升级机器。',
      defEn: 'In September 1774, delegates from twelve colonies gathered in Philadelphia for the First Continental Congress to jointly boycott British goods. A decade of anger finally had one shared voice. What pushed out the revolution was not any single tax but the unstoppable escalation machine of "tax → protest → crackdown → tax again."',
      ...
      xiaoweiNote: {
        cn: `这是整门课最该会"画"的一张卡——Grenville 那条故事线里把整条因果链一口气串起来了。
...
story line strings the entire chain together in one breath.
...
unpacked.`,
...

    {
      ...
      defCn: '殖民者喊"无代表不纳税"，背后有一条思想根：英国思想家约翰·洛克（John Locke）的两个概念——社会契约（social contract，政府的权力来自被统治者的同意）和天赋权利（natural rights，每个人生来拥有生命、自由、财产）。这套思想后来直接进了 1776 独立宣言。',
      defEn: 'Behind the slogan "no taxation without representation" was a deep intellectual root: two ideas from English thinker John Locke — the social contract (government\'s power comes from the consent of the governed) and natural rights (every person is born with life, liberty, and property). These ideas fed directly into the 1776 Declaration of Independence.',
...
John Adams 那条故事线点了一下，但没系统展开，这里单独掌握——写 LEQ 可以直接引用。

殖民者喊"无代表不纳税"，不是凭空发明的口号，它有一条很深的**思想根**。

这条根来自 **Enlightenment（启蒙运动）** 里英国思想家 **John Locke（约翰·洛克）** 的两个核心概念：

① **social contract（社会契约）**：政府不是天上掉下来的，是人们为了保护自己的权利"约定"出来的。
   政府的正当权力，来自 **consent of the governed（被统治者的同意）**。
② **natural rights（天赋权利）**：每个人生来就有 **life, liberty, property（生命、自由、财产）**，
   任何政府都不能随便拿走。
...
（读过启蒙运动那段历史，会认得 Locke 这个名字。后面 1776 独立宣言里的
...
LEQ 写"革命的思想起源"时，这是必引的一条。`,
        en: `**Philosophical Foundations** is a dedicated APUSH Topic 3.4 point. John Adams's story line
...
That root comes from two core ideas of the English **Enlightenment** thinker **John Locke**:

① **Social contract**: government isn't handed down from the sky — people "agree" to it to
   protect their own rights. A government's rightful power comes from the **consent of the governed.**
② **Natural rights**: everyone is born with **life, liberty, and property**, which no government
...
(If you've gone through the Enlightenment topic, you'll recognize Locke's name. Later, in the
1776 Declaration, "unalienable rights" and "consent of the governed" are almost a direct echo
of Locke.)
...
Constitutional Convention lesson).`,
...

    {
      ...
      defCn: '殖民者高喊"自由""权利"，但这个圈子主要包括有产白人男性。原住民的土地被当筹码；约五分之一人口的被奴役者连人身自由都没有；无产白人和女性也被排除在完整政治权利之外。分析任何"自由"话语，先问"谁被算进去、谁被排除"。',
      defEn: 'Colonists shouted "liberty" and "rights," but that circle mainly included propertied white men. Native land was used as a bargaining chip; the enslaved — about one fifth of the population — had no personal freedom at all; propertyless white men and women were also excluded from full political rights. When analyzing any "liberty" language, first ask "who is counted in and who is excluded."',
      ...
      standaloneText: {
        cn: `这是一张"读史的眼睛"卡。俄亥俄河谷原住民青年那条故事线和 John Adams 那条故事线都点到了，但没单独总结。AP 的 DBQ 现在**几乎必考**"谁被算进、谁被排除在'自由'之外"，要会单独答。

标准叙事是"英国 vs 殖民者"两方之争。但一个**完整**的论述，必须能指出这套"自由"话语的**盲区**：

- **原住民**：这场仗争的那片 Ohio Country 是他们的家园。殖民者喊"没人同意就不能动我的钱"，
  回头却越过宣言线、占他们的土地——**从没征求过原住民一个字的同意**。
  "他们的自由，垫在原住民的不自由上。"
...
这是 DBQ 拿 complexity 分的固定动作。`,
        en: `This is a "reading eyes" card. Both the Ohio Country youth's story line and John Adams's
story line touch it, but neither sums it up alone. AP DBQs now **almost always** test "who is
counted in and who is excluded from 'liberty'," so be able to answer it on its own.
...
- **Native peoples**: the Ohio Country fought over was their homeland. Colonists cried "no one
  may touch my money without consent," yet turned around, crossed the Proclamation Line, and took
  their land — **without ever asking the Natives a single word of consent.**
  "Their liberty was propped on Native unfreedom."
- **The enslaved**: about a fifth of the population of the 13 colonies (roughly 500,000 people).
  Many who cried "no taxation without representation" themselves held people with no personal
  freedom at all.
...
Don't pick a side ("the Revolution was great" or "the Revolution was hypocritical") — **hold both
at once**: this movement in the name of "liberty" both planted the seed of "consent of the
governed" that later benefited countless people **and**, from the first day, had people it could
not count in. **The light and the cost are one body.**

Key exam sentence: to analyze any "liberty/rights" language, first ask "**who is counted into
this 'all,' and who is excluded?**" — that's the fixed move for earning DBQ complexity points.`,
      },
      xiaoweiNote: {
        cn: `老师说俄亥俄河谷原住民青年那条故事线一直在逼我看见这件事，也是 AP 的 DBQ 最近几年最爱考的角度。
...
两件事缠在一起、分不开——这句话本身就是 AP 想要的"复杂性"。`,
        en: `Teacher said the Ohio Country youth's story line keeps forcing me to see this, and it's the
angle AP DBQs have loved most in recent years.

Mnemonic: when you read "liberty," first count the **four excluded groups** —
**① Native peoples (land taken), ② the enslaved (about a fifth of the population),
③ propertyless white men, ④ women.**

Going deeper (for complexity points): don't say "the Revolution was fake" — say "**the Revolution
was at once real progress and had real blind spots**," the two tangled and inseparable. That
sentence itself is the "complexity" AP wants.`,
      },
    },
  ],
