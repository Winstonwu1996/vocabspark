...
Key exam sentence: **The Yasa was the legal foundation of the Mongol Empire; its religious tolerance clause is a major reason the empire could govern diverse populations.**`,
    ...
    // ── 卡 2：Yam 驿站系统 & Pax Mongolica（storyAnchor·covered）
    {
      ...
      storyAnchor: {
        ...
        xiaoweiNote: {
          cn: `成吉思汗故事线讲到他"遗产"那部分会带到这——但要记准：**Yam 驿站系统**真正成体系，是他儿子**窝阔台（Ögedei）**约 1235 年在首都哈拉和林（Karakorum）建起来的。成吉思汗的《Yasa》法只打了底（保护商人和使者），系统化的驿站网络是窝阔台的功劳。
...
考点记住这句话：**Pax Mongolica 是蒙古帝国对全球贸易网络最重要的贡献，也是欧亚大陆文化交流和疾病传播（包括黑死病）的关键时期。**`,
          en: `The "legacy" section of the Genghis Khan story thread leads into this — but get the credit right: **the Yam relay system** was built as a systematic network by his son **Ögedei** around 1235, at the capital Karakorum. Genghis's *Yasa* code only laid the groundwork (protection for merchants and envoys); the organized relay network was Ögedei's achievement.
