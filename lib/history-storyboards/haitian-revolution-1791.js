...
export var fieldWorkerLens = {
  ...
  storyboard: [
    ...
    {
      id: 'hai-field-n9',
      // 刚读到「我们赢了、换回原来的名字」，紧接着看 1804 独立宣言
      sourceRef: 'haiti-independence-1804',
      type: 'narrative',
      phase: 'story',
      content: {
