...
export var jeffersonLens = {
  ...
  icon: '📜',
  description: {
    cn: '他是一个 33 岁的弗吉尼亚人，刚被推到费城一间二楼小屋里，写一句要传遍全世界的话。这一遍让你坐到他书桌前，看一只手怎么写下「人人生而平等」，而这只手回到家，名下还有约 200 个不自由的人。',
    en: 'He is a thirty-three-year-old Virginian pushed into an upstairs room in Philadelphia to write a line that will travel the world. This pass sits you at his desk as one hand writes "all men are created equal" while, back home, that same hand holds about two hundred people not free.',
  },
  storyboard: [
    {
      id: 'jef-n1',
...
export var loyalistLens = {
  ...
  icon: '⚖️',
  description: {
    cn: '他是一个家在这片土地住了三代、自认英国人的普通殖民地居民（一个合成人物，让那「输掉的三分之一」有一张能看见的脸）。这一遍让你跟他一起站在邻居们都举枪要独立的街上，看一个真心相信「谈比打好」的人，怎么被同乡叫成叛徒，被英国当弃子，最后两边都不要。',
    en: 'He is an ordinary colonist whose family has lived here three generations, who takes himself for an Englishman (a composite, giving the "losing third" a face). This pass stands you with him on a street where neighbors are taking up arms for independence, watching a man who sincerely believes "talk beats war" be called a traitor at home, dropped by Britain, and wanted by neither.',
  },
  storyboard: [
    {
      id: 'loy-n1',
...
export var enslavedPersonLens = {
  ...
  icon: '⛓️',
  description: {
    cn: '他是一个端着盘子站在主人桌边、把「自由」两个字字字听进去的被奴役者（一个合成人物，让无数听着别人喊自由却不被算在内的人有一个我）。这一遍让你跟他一起在 1775 年冬天那张奴隶屋子里的纸条前面站住，看「自由」这两个字，对一个连身体都不属于自己的人，到底意味着什么。',
    en: 'He is an enslaved man at the master\'s table, taking the word "liberty" in syllable by syllable (a composite, lending an "I" to the countless who heard others cry liberty without being counted in). This pass stands him over a slip of paper passed into the slave quarters in the winter of 1775, weighing what "liberty" means to a person who does not own his own body.',
  },
  storyboard: [
    {
      id: 'ens-n1',
