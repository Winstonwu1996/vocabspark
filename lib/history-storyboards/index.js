...
import * as haitianRevolutionModule from './haitian-revolution-1791.js';
import * as meijiRestorationModule from './meiji-restoration-1868.js';
import * as russianRevolutionModule from './russian-revolution-1917.js';
import * as contemporaryUsModule from './contemporary-us-1980.js';
...
import * as thirteenColoniesModule from './thirteen-colonies-1700.js';
import * as hanChinaModule from './han-china-130bce.js';
import * as americanRevolutionModule from './american-revolution-1776.js';
import * as westwardExpansionModule from './westward-expansion-1869.js';

// ── 全覆盖 (2026-05-25) — Globalization (AP World U9), dark, 未进 TOPIC_REGISTRY, 待 Gate 3 ──
import * as globalizationModule from './globalization-1995.js';

// ── 北美原住民 (2026-05-25) — CA HSS-5.1 / APUSH P1, North America (distinct from pre-columbian = Mesoamerica/Andes) ──
import * as nativeAmericansPre1500Module from './native-americans-pre1500.js';
// ── 2026-06 World 缺口新课 (AP World U2/U6 + CA G6 古代文明) ──
import * as tradeNetworksModule from './trade-networks-1200.js';
import * as asianImperialismModule from './asian-imperialism-1839.js';
import * as mesopotamiaModule from './mesopotamia-3500bce.js';
import * as indusValleyModule from './indus-valley-2600bce.js';
import * as earlyHumansModule from './early-humans-10000bce.js';
import * as ancientIsraelModule from './ancient-israel-1000bce.js';
// —— 2026-06 World [med] 缺口课 ——
import * as guptaIndiaModule from './gupta-india-320.js';
import * as persianEmpireModule from './persian-empire-550bce.js';
import * as latinAmericanIndependenceModule from './latin-american-independence-1810.js';
import * as interwarTotalitarianismModule from './interwar-totalitarianism-1919.js';
// —— 2026-06 美国史缺口课 (APUSH P2-P8) ——
import * as vietnamWarModule from './vietnam-war-1965.js';
import * as coldWarHomeFrontModule from './cold-war-home-front-1950.js';
import * as spanishAmericanWarModule from './spanish-american-war-1898.js';
import * as roadToRevolutionModule from './road-to-revolution-1763.js';
import * as colonialAmericaModule from './colonial-america-1650.js';
import * as earlyRepublicModule from './early-republic-1800.js';
...
export var STORYBOARDS = {
  ...
  'haitian-revolution-1791': haitianRevolutionModule,
  'meiji-restoration-1868': meijiRestorationModule,
  'russian-revolution-1917': russianRevolutionModule,
  'contemporary-us-1980': contemporaryUsModule,
  ...
  'thirteen-colonies-1700': thirteenColoniesModule,
  'han-china-130bce': hanChinaModule,
  'american-revolution-1776': americanRevolutionModule,
  'westward-expansion-1869': westwardExpansionModule,
  // ── Globalization (AP World U9, dark, 未进 TOPIC_REGISTRY) ──
  'globalization-1995': globalizationModule,
  // ── 北美原住民 (CA HSS-5.1 / APUSH P1, North America) ──
  'native-americans-pre1500': nativeAmericansPre1500Module,
  'trade-networks-1200': tradeNetworksModule,
  'asian-imperialism-1839': asianImperialismModule,
  'mesopotamia-3500bce': mesopotamiaModule,
  'indus-valley-2600bce': indusValleyModule,
  'early-humans-10000bce': earlyHumansModule,
  'ancient-israel-1000bce': ancientIsraelModule,
  'gupta-india-320': guptaIndiaModule,
  'persian-empire-550bce': persianEmpireModule,
  'latin-american-independence-1810': latinAmericanIndependenceModule,
  'interwar-totalitarianism-1919': interwarTotalitarianismModule,
  'vietnam-war-1965': vietnamWarModule,
  'cold-war-home-front-1950': coldWarHomeFrontModule,
  'spanish-american-war-1898': spanishAmericanWarModule,
  'road-to-revolution-1763': roadToRevolutionModule,
  'colonial-america-1650': colonialAmericaModule,
  'early-republic-1800': earlyRepublicModule,
};
