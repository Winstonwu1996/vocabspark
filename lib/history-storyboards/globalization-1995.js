...
//
// ⚠️ Rule 0 双刃 (本 Topic 最敏感维度): 全球化真把数亿人脱贫 (全球极端贫困 ~36% 1990 → ~10% 2010s; 中国 ~8 亿)
...
export var ceoLens = {
  ...
  storyboard: [
    ...
    },
    {
      ...
      deliverGoal: 'N5 story — 搬工厂让俄亥俄失业但地球另一边有了工厂工作 + 对乡下看天吃饭的人稳定现金工资是几代头一回 + 真实数据 (极端贫困 ~36% 1990 → ~10% 2010s/几亿人脱贫) + 同一决定干了方向相反的多件事 + 桥到南方女工 lens',
...
export var rustBeltLens = {
  ...
  icon: '⚙️',
  description: {
    cn: '美国中西部一座小城的工厂工人,在同一家工厂拧了二十年螺丝,养大两个孩子。1990 年代某一天,工厂贴出告示:生产要搬到地球另一边,这里关门。他丢了工作,整座城慢慢空掉。可矛盾的是他自己也去超市买那些更便宜的、别人在远方做的东西。作为工人,全球化抢走他的饭碗;作为消费者,全球化让他的钱更经花。这一遍让你站在被夹在中间的人这里,体会全球化不是「好」或「坏」,是同一件事在同一个人身上又抢又给。',
    en: 'A factory worker in a small Midwestern American city, who turned the same bolts in the same plant for twenty years and raised two children. One day in the 1990s a notice went up: production was moving to the other side of the world, and this plant would close. He lost his job, and the whole city slowly emptied out. The contradiction is that he too goes to the supermarket and buys cheaper things made far away by others. As a worker, globalization took his livelihood; as a consumer, it made his money stretch further. This pass puts you with a person caught in the middle, to feel that globalization is not "good" or "bad" but the same thing, on the same person, both taking and giving.',
  },
  storyboard: [
    {
      id: 'rb-n1',
    ...
    },
    {
      ...
      deliverGoal: 'N8 story — 逼自己看公平 + 那个一小时 1 美元的人不是敌人 + 对我是丢掉的好日子对他可能是翻身第一步 (原来乡下看天吃饭进厂第一次稳定现金工资) + 真实数据 (极端贫困 ~36% 1990 → ~10% 2010s/亚洲进厂农民接住搬走的工作) + 同一份工作转移一人往下一人往上 + 我不甘心但没法说他错',
...
export var garmentWorkerLens = {
  ...
  storyboard: [
    ...
    },
    {
      ...
      deliverGoal: 'N5 story — 寄回去的钱落地长出什么 (妹妹上学家里天大的事/将来也许不用坐缝纫机/爹病治了娘攒钱换结实屋顶下雨不漏) + 都是一针一线缝出来 + 全球化对我不只是被便宜使唤是一条路 (从世代种地看天吃饭通向妹妹上学家不挨饿/又窄又苦但真实是娘奶奶没有过的) + 真实数据 (极端贫困 ~36%→~10%/几亿人一针一线缝出赤贫)',
...
export var meta = {
  ...
  notes: [
    ...
    'Rule 0 双刃: 极端贫困 ~36% (1990) → ~10% (2010s) 全球脱贫 (中国 ~8 亿) AND Rana Plaza 2013 ~1,134 死 + 锈带失业 + 不平等拉大; 不向任何一边说教',
    'anti-fab: 无伪造引文/数据; 真实数字标约数 (~36%/~10%/~8 亿/~1,134); 集装箱 1956 McLean / Bretton Woods 1944 / WTO 1995 / NAFTA 1994 / 中国入世 2001 均真实',
