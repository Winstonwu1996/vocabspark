...
export var bayardRustinLens = {
  ...
  icon: '🎼',
  description: {
    cn: '宾夕法尼亚人,1912 年生,贵格会祖母带大,和平主义从小刻进骨子。他高瘦,弹一手好曼陀林,唱黑人灵歌。1940 年代他去印度研究甘地非暴力,是美国少数吃透这套方法的人,MLK 的非暴力策略正是他手把手教的;1963 年震动世界的华盛顿大游行幕后总指挥也是他。可他是公开同性恋者,运动里有人怕他的身份成把柄,反复把他推到看不见的后台。这一遍让你从一个贡献最大、名字却最少被提起的人这边,看这场运动。',
    en: 'A Pennsylvania man, born 1912, raised by a Quaker grandmother, pacifism set into him from childhood. Tall and thin, he played the mandolin beautifully and sang Black spirituals. In the 1940s he went to India to study Gandhi\'s nonviolent resistance, one of the few Americans who truly mastered the method, and the nonviolent strategy MLK later used, Rustin taught him hand over hand; the 1963 March on Washington that shook the world, he was its chief organizer behind the scenes. But he was an openly gay man, and some in the movement feared his identity would become a weapon against it, and pushed him again and again to the unseen back. This pass lets you see the movement from the side of the man who gave the most and whose name was spoken the least.',
  },
  storyboard: [
    {
      id: 'br-n1',
...
export var selmaTeenMarcherLens = {
  ...
  icon: '🌉',
  description: {
    cn: '合成人物,代表 1965 年 Selma 游行里没留下名字的黑人青少年。约 1948 年生在阿拉巴马 Selma 黑人家,从小看爸妈想投票却过不了登记官。1965 年初他 17 岁,听组织者讲非暴力就上街。3 月 7 日他和约 600 人走向 Edmund Pettus 桥,桥那头是举警棍、催泪瓦斯的州警。他按训练不还手,被打倒。这一遍,你从一个被历史重量压上身的 17 岁孩子这边,看这场运动。',
    en: 'A composite character, standing for the Black teenagers who truly existed but mostly left no names in the 1965 Selma voting-rights march. Born around 1948 in Selma, Alabama, into a Black family, he grew up watching his parents want to vote and fail to get past the registrar. In early 1965, about seventeen, he heard the organizers speak about nonviolence and decided to walk into the street. On 7 March he and about 600 others walked toward the Edmund Pettus Bridge, where state troopers waited with batons and tear gas; he took the blows by his training, did not strike back, and was knocked down. This pass lets you see the movement from the side of a seventeen-year-old, the weight of history pressed directly onto him.',
  },
  storyboard: [
    {
      id: 'st-n1',
