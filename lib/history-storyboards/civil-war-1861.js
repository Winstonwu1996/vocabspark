...
export var usctSoldierLens = {
  ...
  icon: '🔵',
  description: {
    cn: '一个加入北军的获释黑人士兵,18 万黑人军人之一,原型是真实的第 54 麻省团(名字和家世是叙事补充,经历、军饷、被俘风险都按真实黑人部队史)。生在马里兰一个种植园,年轻时逃到北方,1863 年解放宣言一开放黑人参军他就报了名。他领的军饷比白人少一截,明知被南军俘虏可能当场被杀,还是穿上了那身蓝军装。这一遍,你站在那些被宪法算成 3/5、又被这场战争第一次拿起枪的人这边,看南北战争到底为谁而打。',
    en: 'A freed black man who joined the Union army, one of 180,000 black soldiers, modeled on the real 54th Massachusetts Regiment (name and family a narrative addition; the soldier\'s experience, pay, and risk of capture all follow the real history of the black units). Born on a Maryland plantation, he fled north as a young man, and the moment the 1863 Proclamation opened enlistment to black men, he signed up. He drew pay short of a white soldier\'s, knew that capture by the Southern army might mean death on the spot, and put on the blue uniform all the same. This pass puts you with the people the Constitution counted as three-fifths, who picked up a gun for the first time in this war, to see whom the Civil War was really fought for.',
  },
  storyboard: [
    {
      id: 'usct-n1',
