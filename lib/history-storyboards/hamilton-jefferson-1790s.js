...
export var hamiltonLens = {
  ...
  description: {
    cn: '他是加勒比海一个小岛上的私生子，11 岁父亲走了再没回来，13 岁母亲在他身边的床上发烧死了。14 岁的他一个人在 St. Croix 的货栈里管账，管的是糖、朗姆酒，还有奴隶的进出。这一遍让你跟他坐进那间账房，看一个每天把人当一行数字记的少年，后来怎么决定要不要替蓄奴的妻家继续管同一种账本。',
    en: 'He is a bastard born on a small Caribbean island, abandoned by his father at eleven, watching his mother die of fever in the bed beside him at thirteen. At fourteen he runs a St. Croix trading house\'s books alone, the entries running sugar, rum, and enslaved people, each a line of numbers. This pass sits with him at that ledger and walks to the years he must decide whether to keep the same books for his slaveholding in-laws.',
  },
  storyboard: [
    {
      id: 'ham-n1',
...
export var bannekerLens = {
  ...
  description: {
    cn: '他是马里兰一个自由黑人农民，自学天文和数学，亲手做过一座全木齿轮的钟，走了几十年。1791 年他参与了新首都的边界测绘，又算了一整年的日月星辰位置出了一本年历。这一遍让你跟他坐进那间夜里点灯算星的屋子，看一个不求恩赐的人，怎么决定要不要把这本年历手抄一份寄给那个写下「人人生而平等」却蓄着六百个奴隶的人。',
    en: 'He is a free Black farmer in Maryland, self-taught in astronomy and mathematics, who built a clock of all-wooden gears that ran for decades. In 1791 he surveyed the boundary of the new capital and calculated a full year of sun, moon, and stars into an almanac. This pass sits with him in the lamplit room and watches a man who asks for no favor decide whether to mail a hand-copied copy to the man who wrote "all men are created equal" while holding six hundred enslaved.',
  },
  storyboard: [
    {
      id: 'ban-n1',
...
export var whiskeyFarmerLens = {
  ...
  description: {
    cn: '他是阿勒格尼山以西种谷子的边疆酒农（一个合成人物，代表 1794 年宾州西部几千个被卷进 Whiskey Rebellion 的真实农户）。谷子翻不出山，他只好蒸成威士忌，那就是他的钱、他的工钱、他的命脉。新政府收了他的威士忌税，他抗，然后联邦的一万三千大军开过来。这一遍让你站在政策链条最末端的人这里看 1790 年代，不是从写报告的人那边看，是从被报告砸到的人这边看。',
    en: 'He is a frontier distiller west of the Allegheny Mountains (a composite for the thousands of western Pennsylvania farmers swept into the Whiskey Rebellion of 1794; every event he lives is drawn from the record). Grain cannot cross the mountains, so he distills it into whiskey: his money, his wages, his lifeline. The new government taxes the whiskey, he resists, and 13,000 federal troops come over the ridge. This pass stands you at the very end of the chain, looking at the 1790s from the side the report landed on.',
  },
  storyboard: [
    {
      id: 'whf-n1',
