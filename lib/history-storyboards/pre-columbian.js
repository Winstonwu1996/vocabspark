...
export var pachacutiLens = {
  ...
  description: 'He is the second son in a small Andean city-state ringed by mountains, the boy his father does not choose, the one who watches Cusco bow to his older brother and learns power not by command but by standing to the side and reading it. This pass walks with him from those quiet years to the spring an enemy army comes over the western ridge and his father turns to flee, leaving him alone in a town that is about to become an empire.',
...
export var malintzinLens = {
  ...
  description: 'She is a small girl on the southeastern edge of the Aztec empire, falling asleep to Nahuatl by day and Maya from across the river at night, the daughter of a noble cacique who walks to Tenochtitlan with jade and cacao. This pass starts in that two-language childhood and walks with her into the years after her father dies, when those two languages stop being a private game and become the only thing keeping her alive.',
...
那个时候，Hispaniola 岛上的 Anacaona——那位 Taíno 女王——已经被西班牙人处死整整 11 年了（1508 年）。她试图用谈判和解来保全她的族人，最后被执行绞刑。西班牙人在加勒比海已经征服了一圈，现在轮到大陆了（参见「大航海时代」那段历史：加勒比 → 大陆的征服路线）。
...
export var ixMutalLens = {
  ...
  description: 'She is a girl born around 1480 in a no-name Yucatan village, a few days\' walk from grass-covered ruins of a city that fell thirty years before her birth, in a Maya world that outsiders call "decline" but that her father\'s milpa and her mother\'s loom know is not (a composite character standing in for around a million Postclassic Maya commoner women whose names history did not record). This pass starts at the sound of her mother hanging cotton thread on the backstrap loom and walks with her through six decades into the years when men with metal and horses appear at the edges of the kuchkabal.',
...
同一批病——1347 年从中亚传到欧洲的黑死病 (Black Death，参见 VocabSpark「黑死病」那段历史)——1518 年从 Hispaniola 传到 Maya 海岸。规律完全一样：新病原，加上一个从未接触过、完全没有免疫的人群，加上高密度接触——死亡率高得让人说不出话。Black Death 杀了欧洲 25 到 50%；天花在美洲的死亡率是 80 到 95%。差别是：欧洲人有时间建立部分免疫；我们同时遭遇几十种新病原，没有任何缓冲。
...
学界把这种模式叫做「institutional survival, personal erasure」——机构活了，个人的故事消失了（参见 VocabSpark「科学革命」那段历史的 Maria Kirch：天文机构传下来了，她的名字没传下来）。
