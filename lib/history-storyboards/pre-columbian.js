...
export var ixMutalLens = {
  ...
  description: {
    cn: '她是大约 1480 年生在 Yucatán 北部一个叫不出大名字的村子里，从家走几天路就能看见 30 年前崩塌的玛雅潘城墙，被草盖住的石头（一个合成人物，代表 16 世纪一百万左右没有名字进史书的 Postclassic Maya 平民女子）。这一遍让你坐进那间小屋，从母亲早晨把棉线挂上 backstrap 织机的那个声音开始，跟她走过六十年，一直走到带铁、带马、说一种没人听过的话的人出现在 kuchkabal 边缘的那一年。',
    en: 'She is a girl born around 1480 in a no-name Yucatán village (a composite character standing in for some one million Postclassic Maya commoner women whose names history did not record), a few days\' walk from the grass-covered ruins of a city that fell thirty years before her birth. This pass starts at the sound of her mother hanging cotton thread on the backstrap loom and walks with her through six decades into the years when men with metal and horses appear at the edges of the kuchkabal.',
  },
