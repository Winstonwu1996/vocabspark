...
export var douglassLens = {
  ...
  icon: '🖋️',
  description: {
    cn: '马里兰人，约 1818 年生，生来就是被奴役者，连自己的生日都不知道。小时候偷偷学认字，他后来说这是他走向自由的第一步。20 岁那年逃到北方，靠一张嘴成了全国最有名的废奴演说家，又办报、写自传，把一个逃奴的生命变成了对奴隶制最有力的证词。这一遍让你从一个既要对抗敌人、又要挣脱盟友的人内部，看「替自己说话」有多难。',
    en: 'A Marylander, born around 1818 into slavery, who did not even know his own birthday. As a boy he secretly taught himself to read, which he later called his first step toward freedom. At twenty he escaped north and, on the strength of his voice, became the most famous abolitionist speaker in the country, then founded a newspaper and wrote his autobiography, turning one fugitive\'s life into the most powerful testimony against slavery. This pass lets you watch, from inside a man who had to fight his enemies and pull free of his allies at once, how hard it is to speak for yourself.',
  },
  storyboard: [
    {
      id: 'doug-n1',
...
export var tubmanLens = {
  ...
  icon: '🌙',
  description: {
    cn: '约 1822 年生在马里兰州一个被奴役的家庭，原名 Araminta。小时候被一块铁器砸中头部，落下一辈子的头痛和突然昏睡的毛病。1849 年她一个人逃到北方，本可以从此安稳，可她做了一件几乎没人敢做的事，一次次回到她逃出来的那片土地，把别人也带出去，据说救了约 70 个人，一个都没丢。这一遍你跟着她走那条夜里的逃亡路，看自由不是写在纸上的词，是用脚一步步走出来的。',
    en: 'Born around 1822 in Maryland into an enslaved family, named Araminta at birth. As a child she was struck in the head by an iron weight, leaving her with lifelong headaches and sudden sleeping spells. In 1849 she escaped north alone, and could have lived in safety. Instead she did something almost no one dared: she returned again and again to the land she had fled to bring others out, said to have rescued about 70 people without losing one. This pass walks the night-time escape road with her, to see that freedom is not a word written on paper but something walked out, one step at a time.',
  },
  storyboard: [
    {
      id: 'tub-n1',
