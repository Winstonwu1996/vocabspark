...
export var tokimuneLens = {
  ...
  description: 'He is the spare son in the Hojo regent house, not the chosen heir, growing up inside the machinery that actually runs Japan from a city the Emperor does not live in. This pass walks you with him from those quiet rooms where his father weighs land disputes into the years when the largest empire the world has ever seen sends ships across the sea to swallow his islands.',
  descriptionCn: '他是北条执权家里那个不被选中的备用儿子,在天皇都不住的镰仓城里,从小看着父亲在背后调解一桩桩土地纠纷。这一遍让你跟他从那些安静的房间出发,一直走到世界上最大的帝国派船渡海要吞掉这片岛的那几年。',
  storyboard: [
  {
    nodeId: 'tokimune-N1',
    year: 1251,
...
1271 年、1273 年，又来了使者。每一次，我的回应都一样：不予答复，遣返。使者走了那么远的路，被原样送回去——这本身已经是一种侮辱，但还没有人流血。
...
我知道这意味着什么。第一次入侵已经发生，斩使不是为了阻止战争——战争已经来过了。斩使是一个宣告：没有议和，没有回头，下一次他们再来，我们也只有打。1275 年斩使，1281 年弘安之役——是同一条决心的两端。

为什么这么做？一种解读：我要彻底堵死朝廷「也许可以议和」的可能性。使者死了，外交渠道物理上切断，镰仓就是唯一的决策者。另一种解读：我二十四岁，刚挺过第一次入侵，需要一个不可撤回的姿态，告诉所有人——对内对外——我不会动摇。

两种解读也许都是真的。

从大都出发，经高丽，到太宰府，再到镰仓——使者走了这么远，最后被处决在龙之口。对大都的忽必烈来说，这是他从未遇到过的答案。对我来说，这是一个我没有办法收回的决定。

「不可撤回的决定」是历史上最重要的决定类型。它不一定是最聪明的，但它是彻底划定边界的那一种。1275 年之后，中间地带不存在了。`,
...
Why do it? One reading: I wanted to permanently close off the court's option of "perhaps we can negotiate." With the envoys dead and the diplomatic channel physically severed, Kamakura was the only decision-maker. Another reading: I was twenty-four years old, having just survived the first invasion. I needed an irreversible gesture to tell everyone — inside and out — that I would not be moved.

Perhaps both are true.

From Dadu, through Goryeo, to Dazaifu, then to Kamakura — the envoys traveled all that way, and were executed at Tatsunokuchi. For Kublai Khan in Dadu, this was an answer he had never received before. For me, it was a decision I had no way to take back.

"Irrevocable decisions" are among the most important category in history. They are not always the wisest. But they are the kind that draws a line so completely there is no middle ground left. After 1275, the middle ground was gone.`,
...
跨课：1438 年，太平洋另一端，一个叫帕查库特克的人也刚刚击败了入侵者，开始建设一个新的帝国。他用了三十四年，建起了南美洲最大的政体；时宗用了十六年，守住了日本海岸。他们互不知晓，但他们都在做同一件事：将外部威胁转化为内部系统的强化，然后面对同一种命运——系统越精密，越不能承受它没设计过的事情。
...
export var sesshuLens = {
  ...
  description: 'He is a Bitchu Province boy who entered a Zen temple before he can quite remember it, learning to sit in meditation and copy sutras while a courtyard stone is the clearest thing in his memory. This pass walks you with him from that stone courtyard into middle age, when he finally crosses the sea to Ming China and has to decide whether the painting he came to learn is the painting he will bring home.',
  descriptionCn: '他是备中国一个连出生村子都说不清的孩子,从小进了宝福寺学坐禅抄经,记忆里最清楚的是院子里的一块石头和老师的背影。这一遍让你跟他从那块石头出发,一直走到中年终于渡海到明朝,看一个禅僧画家亲眼站到大陆山水跟前,要决定他来学的画到底是不是他要带回去的画。',
  storyboard: [
  {
    id: 'sesshu-N1',
    nodeId: 'sesshu-N1',
...
export var masakoLens = {
  ...
  description: 'She is a girl born in the back-country of Izu in the same year that a palace coup tears Kyoto apart, in a household so far off the national map that no one tells her family the news for months. This pass walks you with her through twenty-four years of watching land disputes and unpaid debts settle without poetry or ritual, until a fugitive prince arrives at her father\'s estate and the language of power she has been quietly learning suddenly has a use.',
  descriptionCn: '她是伊豆乡下一个 1156 年出生的女孩,京都那年正在闹宫廷政变,她家在全国权力地图上几乎是一块白地,大事过去几个月才传到这里。这一遍让你跟她在父亲庄园里看二十四年的土地纠纷和债务清算,直到一个流亡王子出现在门口,她从小学的那种没有装饰的权力语言终于要派上用场。',
  isDefaultLens: true,
  storyboard: [
...
我把我的话交给景盛，让他带到御家人面前——据《吾妻鏡》，我的话不是我当众亲口说的，而是由安达景盛代我向集会的御家人宣读。在那一刻之前，会场里有人还没有决定。后鸟羽上皇是上皇——传统上最高的文化权威，天皇制度的象征核心。对抗他，对很多武士来说，心理上有障碍。

景盛替我宣读的话，《吾妻鏡》载其大意是：「赖朝公从无到有建立这个政权，你们的土地、你们的地位，都来自那段历史。上皇此举是奸臣蒙蔽，不是上皇本意。如果还有人想投靠上皇，现在就说，我不阻拦；但如果你们想报答赖朝公的恩情，就现在举兵。」
...
我不知道我说的话是否如记录中那样完整。但我知道我让景盛把我的话带到御家人面前的那一刻，我不知道结果会怎样。我只知道如果我不说，就没有人说。

这是政子 1221 年演讲，跟 Byzantine 拜占庭那段历史的狄奥多拉（Theodora）532 年 Nika 暴动时的「紫袍是好寿衣」并列。两个女性在政权最危险的时刻开口。两人都不是体制里的正式权力持有者，都用语言重新定义了危机的性质。最重要的话，往往是在最不确定的时刻说出来的。`,
...
跨课对比：Theodora 548 年死，我 1225 年死——相隔 677 年。两个女性之后的制度，都没有继续产生同等级的女性政治声音。Theodora 死后的拜占庭，政治里的女性声音逐渐式微；我死后的日本，执权体制在北条氏手里继续运转，但这个体制不再给女性任何制度性的位置。两个案例的规律是相同的：女性政治声音的出现，在那个时代不是趋势，是偶然，是条件性的，是不可复制的。
