...
export var tokimuneLens = {
  ...
  description: {
    cn: '他是北条执权家里那个不被选中的备用儿子，在天皇都不住的镰仓城里，从小看着父亲在背后调解一桩桩土地纠纷。这一遍让你跟他从那些安静的房间出发，走到世界上最大的帝国派船渡海要吞掉这片岛的那几年。',
    en: 'He is the spare son in the Hojo regent house, not the chosen heir, growing up inside the machinery that actually runs Japan from a city the Emperor does not live in. This pass walks with him from those quiet rooms where his father weighs land disputes into the years when the largest empire the world has ever seen sends ships across the sea to swallow his islands.',
  },
  storyboard: [
  {
    nodeId: 'tokimune-N1',
...
信的结尾意思再清楚不过：「若至此仍不遣使往来，则不得不使用兵力」。写信的是忽必烈，成吉思汗的孙子，那年五十三岁，已经是一个帝国老人。我十七岁，刚继位，幕府内部还有异见，我需要确立自己是决策者。

镰仓又把信转报京都朝廷，于是两套权力机构都要表态。朝廷一方有声音主张议和——公家文化有通过文书处理危机的悠久传统。

我的选择：完全拒绝。不回信，不派使者。

但这里要停一下：我拒绝，不只是因为蒙古的要求不合理。还有一层——如果朝廷的议和路线成功，处理外交的就是京都，而不是镰仓。「谁来代表日本应对蒙古」，这个问题的答案直接决定了幕府的权力合法性。我拒绝蒙古，同时也在拒绝让朝廷主导危机处理。

1221 年，北条政子在承久之乱里赢得的那场战争，让这封蒙古信只能送到我手里，而不必转交给天皇决定。她那一年确立的权力边界，就是我现在站着的地基。
...
Kamakura in turn relayed the letter to the Kyoto court, so both centers of power had to respond. The court had voices arguing for negotiations — the aristocratic culture had a long tradition of resolving crises through correspondence and diplomacy.

My choice: complete refusal. No reply. No envoys.

But a pause is needed here. I refused not simply because Kublai's demands were unreasonable. There was another layer: if the court's negotiating path had succeeded, the diplomacy would have been handled by Kyoto, not Kamakura. The answer to "who represents Japan in facing the Mongols" determined the shogunate's political legitimacy. I refused the Mongols, and simultaneously refused to let the court lead the crisis response.
...
A seventeen-year-old's refusal — two directions of power announced at once: outward, rejecting the Mongol threat; inward, telling the court that Kamakura handles this.`,
...

  {
    ...
    bodyCn: `1268 年第一封信，我不回。1271、1273 年又来了使者，每次我都不予答复、遣返。使者走了那么远，被原样送回去——这本身已经是侮辱，但还没有人流血。

1274 年文永之役，蒙古真的来了，又退了。然后 1275 年 9 月，忽必烈再派一批使者——杜世忠等五人——这一次，使者被杀，斩于镰仓的龙之口。

斩杀外国使者是国际外交史上极其罕见的举动。蒙古帝国的驿站系统（yam）建立在一条原则上：使者神圣不可侵犯。1219 年，花剌子模王杀了蒙古商队使节——那之后成吉思汗向西远征，花剌子模在地图上消失了。蒙古人对此有固定的反应。

我知道这意味着什么。第一次入侵已经发生，斩使不是为了阻止战争——战争已经来过了。斩使是一个宣告：没有议和，没有回头，下一次再来我们也只有打。1275 年斩使，1281 年弘安之役，是同一条决心的两端。

为什么这么做？一是要堵死朝廷「也许可以议和」的可能性，使者死了，镰仓就是唯一决策者；二是我二十四岁，刚挺过第一次入侵，需要一个不可撤回的姿态。两者也许都对。

使者从大都经高丽、太宰府、镰仓，最后被处决在龙之口。对忽必烈来说，这是他从未遇到过的答案；对我，这是收不回的决定。

「不可撤回的决定」是历史上最重要的一类——不一定最聪明，但彻底划定边界。1275 年之后，中间地带不存在了。`,
    bodyEn: `In 1268, the first letter: I did not reply.

In 1271 and 1273, more envoys came. Each time, my response was the same: no answer, sent back. The envoys traveled all that way and were returned untouched — an insult in itself, but no one had bled yet.

In 1274, the Bun'ei campaign: the Mongols actually came, and withdrew. Then, in September 1275, Kublai Khan sent another set of envoys — Du Shizhong and four others. This time, the envoys were killed, beheaded at Tatsunokuchi in Kamakura.

Killing foreign envoys is among the rarest acts in the history of international diplomacy. The Mongol empire's relay network, the yam, rested on one principle: envoys are inviolable. In 1219, the shah of Khwarezm killed Mongol trade envoys; after that, Chinggis Khan marched west, and Khwarezm was erased from the map. The Mongols had a fixed response to the killing of envoys.

I knew what this meant. The first invasion had already happened; killing the envoys was not meant to prevent a war — the war had already come. It was a declaration: no negotiation, no turning back, and the next time they came, we would only fight. The 1275 killing and the 1281 Kōan invasion were two ends of the same resolve.

Why do it? First, to permanently close off the court's option of "perhaps we can negotiate" — with the envoys dead and the channel severed, Kamakura was the only decision-maker. Second, I was twenty-four, having just survived the first invasion, and needed an irreversible gesture to tell everyone I would not be moved. Perhaps both are true.

From Dadu, through Goryeo, to Dazaifu, to Kamakura — the envoys traveled all that way and were executed at Tatsunokuchi. For Kublai Khan, this was an answer he had never received before. For me, it was a decision I had no way to take back.

"Irrevocable decisions" are among the most important category in history. They are not always the wisest, but they draw a line so completely that no middle ground is left. After 1275, the middle ground was gone.`,
    themeCn: '不可撤回的决定彻底划定边界，但也切断了所有其他的可能',
    themeEn: 'An irrevocable decision draws the sharpest line — and closes every other door',
    crossTopicHook: '花剌子模 1219 年杀使 → 蒙古西征；日本 1275 年斩使（第一次入侵之后）→ 1281 年弘安之役。同一个模式，同一个后果',
    expectsRealAnswer: false,
    sourcingNote: 'Conlan 2001；Narrative §7 斩使动机分析；著名斩使（杜世忠等五人，斩于龙之口）为 1275 年 9 月，发生在 1274 文永之役失败之后、1281 弘安之役之前，是报复与决心宣示，非 1274 入侵的前因；1268-1273 使团仅被拒遣返、未杀；Mongol Topic cross-ref Yam 驿站系统',
  },

  {
    ...
    bodyCn: `1274 年文永之役：10 月，蒙古-高丽联军从合浦出发，经对马岛、壹岐岛，在博多湾登陆。

人数史料有分歧：《元史》记 15,000-25,000，《高丽史》记合计约 33,000。较稳健的估计是约 25,000-30,000 人，近 900 艘船。

日本武士战争有一套规矩：双方武将先互报名号，一对一单挑。这套传统在日本内战里有真实的军事逻辑，但在蒙古军面前变成了灾难。蒙古战法是集团战术：数百人同步移动，弓手轮替，长矛兵掩护。武士冲过去单挑，迎接他的是一排箭雨。

然后是铁炮（tetsuhau）。它不是后来明朝的火绳枪，而是一种铁壳炸弹，填入火药和铁片，点燃后抛掷，爆炸时产生声响、火光、碎片。

武士们听到爆炸声的第一刻，没有人知道那叫什么。这场战争被《蒙古袭来绘词》画了下来——但绘卷的主人竹崎季长是个武士，画它是为了告诉幕府「我打了仗，请赏赐我土地」。所以这首先是一份请功申请书，不是客观记录。铁炮确实存在（考古有实物），但决定性作用可能比绘词画的小。

我在镰仓，不在博多湾。消息传到我手里时，战斗已经打了一整天。我知道的只是：日本守军节节后退，退守大宰府防线。

那天晚上，台风打入博多湾，锚泊在湾内的蒙古舰队相互碰撞，部分沉没，联军撤退返回合浦。
...
The numbers are disputed: the Yuan Shi records 15,000 to 25,000; the Goryeo Sa records a combined total of about 33,000. A defensible estimate is roughly 25,000 to 30,000 men, with close to 900 ships.
...
The warriors who heard the explosion for the first time had no word for what it was. The battle was painted in the Mōko Shūrai Ekotoba, which includes images of tetsuhau detonating — but the scroll belongs to a warrior named Takezaki Suenaga, who commissioned it to tell the shogunate "I fought; give me land." So it is first a proof of service, not an objective record. The iron bombs are archaeologically confirmed, but their decisive impact may have been smaller than the scroll depicts.
...
"A storm came, and we survived" — that is what actually happened in 1274. The first thought of the victor is the next war.`,
...

  {
    ...
    bodyCn: `1275 年开始，博多湾沿岸的御家人家族被征调建设石墙。工程历时约五年，到 1280 年基本完工。

博多湾防壁（Genkō Bōeki）：全长约 20 公里，高约 2-3 米，石块砌成，顶部可供弓手站立。这是日本有史以来最大规模的工程动员之一，数千御家人家族参与。

九州有一个御家人当家——我从镰仓下令，从不知道具体的名字——1276 年初春，看着自己的耕地被划入施工区。他没有选择。幕府的命令是命令，御家人效忠幕府，这是体制规则。他的田地这一季不种了，人手去凿石头。

这就是「系统硬化」的意思：我把防御从「个人武士英勇」转成了「集体工程」。1274 年，日本武士一对一冲进蒙古阵型，遭遇铁炮，惨烈。石墙的逻辑完全不同——不靠个人英勇，而是用建筑本身挡住敌人，让他们在水里面对弓手，没有展开空间。

但集体工程的代价，永远由别人承担。

耕地变施工区的那个九州御家人，他的损失进了哪本账本？幕府账本里有的是「博多湾防壁竣工，全长约 20 公里」。他家的粮食短缺，他家的冬天，不在那本账本里。

就在这五年里，幕府与御家人之间的关系开始出现裂缝。不是因为御家人不服从——他们服从了。而是服从的代价，让他们开始计算「这个交换还值不值」。

我建的石墙有效，1281 年真的挡住了蒙古的东路军。但有效的代价，不是我付的。`,
    bodyEn: `Beginning in 1275, warrior households along the Hakata Bay coast were mobilized to build the stone wall. Construction ran for about five years and was largely complete by 1280.

The Genkō Bōeki — the defensive barrier against Yuan incursion — ran roughly 20 km along the coastline, about 2 to 3 meters high, fitted stone, with a walkway on top for archers. This was one of the largest construction mobilizations in Japanese history to that point, involving thousands of warrior households.

There was a gokenin household head in Kyushu — I do not know his name, I gave orders from Kamakura and never knew the specific names — who in early spring of 1276 watched his farmland designated as a construction zone. He had no choice. The shogunate's order was the order. Gokenin are loyal to the shogunate; that is the system's rule. His fields, not planted this season. His people, cutting stone.

This is what "system hardening" means: I transformed defense from "individual warrior valor" into "collective engineering." In 1274, Japanese warriors charged individually into Mongol formations and met iron bombs. The wall's logic was entirely different — not personal courage, but using the structure itself to block the enemy, forcing them to face archers while still in the water, with no space to form up.
...
It was during these five years that the relationship between the shogunate and the gokenin began to crack. Not because the warriors refused to comply — they complied. But because the cost of compliance made them start calculating whether the exchange was still worth it.
...
两支舰队同时出发：东路军约 40,000 人，从高丽合浦出发，配约 900 艘战船；江南军约 100,000 人，主要由刚被征服的南宋士兵组成，从今浙江、福建出发，配约 3,500 艘战船。合计约 140,000 人，约 4,400 艘船。这些数字来自《元史》，可能有夸大，实际参战或接近 100,000-120,000——但即便如此，这仍是 13 世纪最大规模的海上军事行动之一。

6 月，东路军先抵博多湾。他们遇到了 1274 年没有的东西：那道沿海岸线延伸约 20 公里的石墙。从船上下来，就面对石墙后的弓手，没有展开空间。东路军尝试在多处强行登陆，均被击退。

日本武士还有夜袭：用小型快船趁夜摸到蒙古大船边，爬上甲板近战，或者放火。大船不灵活，小船快，夜间视线差，蒙古军难以有效反击。

东路军与日本守军在博多湾僵持了近两个月，等待江南军。

在这两个月里，我在镰仓命人测量了圆觉寺的地基。无学祖元（Mugaku Sogen，1226-1286）已经同意担任住持。寺庙为弘安之役的战死者而建——这是我能许诺的事：如果有人死了，我为他们建一座寺。

台风来临前夜，圆觉寺的地基已经测量完。我三十岁，不知道台风明天就到。`,
    bodyEn: `In 1281, Kublai Khan mobilized the largest seaborne campaign in his empire's history.

Two fleets departed simultaneously: the Eastern Route Army, roughly 40,000 men from Goryeo's Happo, with about 900 warships; the Kōnan Army, roughly 100,000 men drawn largely from recently conquered Southern Song soldiers, departing from today's Zhejiang and Fujian with about 3,500 ships. Combined: about 140,000 men, about 4,400 ships. These figures come from the Yuan Shi and may be inflated — actual combatants were perhaps closer to 100,000 to 120,000 — but even so, this was one of the largest seaborne military operations of the thirteenth century.

In June, the Eastern Route Army arrived at Hakata Bay first. They met something not there in 1274: the stone wall running about 20 km along the coastline. Coming off the ships, the invaders faced archers behind the wall with no room to deploy. The Eastern Route Army attempted forced landings at several points and was repelled each time.

Japanese warriors also conducted night raids — small fast boats approaching Mongol vessels in darkness, climbing aboard for close combat or setting fires. Large ships are slow to maneuver; small boats are fast; nighttime visibility is poor. The Mongols could not organize effective counterattacks.
...
During those two months, I had the foundations of Engakuji measured in Kamakura. Mugaku Sogen (1226-1286) had already agreed to serve as founding abbot. The temple would be built for those who died in the Kōan campaign — this was what I could promise: if people died, I would build a place for them.
...
镰仓幕府建立在御家人体制上：御家人效忠幕府，战时出兵，战后获封赏——通常是土地。这是幕府合法性的基础：打仗有回报。

但 1281 年这场战争，打赢了，没有占领任何土地。蒙古人溺死了，日本没有从敌方夺到任何新领土可以分封。

参战御家人怎么办？他们花了自己的钱、失去了自己的人手、消耗了战马和粮草，期待幕府补偿。我能给的只有已有的日本土地，但这需要从别人那里重新分配，或从寺庙神社的地产里挤压。两条路都会制造新的怨恨。

1281 年之后，御家人对封赏制度的信任开始系统性松动。不是一次爆炸，是一条慢慢裂开的缝。

同时，石墙建造、博多湾长期守备、军事动员的粮草物流——全部要钱。幕府从御家人征调，御家人从庄园里挤，压力传到农民身上。而消耗没有停止：忽必烈直到 1294 年死前始终在准备第三次远征，时宗只能继续维持博多湾的警戒。

「系统硬化」的悖论在这里出现：我成功维护了系统，裂缝因此被封在了内部。台风帮了我，石墙起作用了，御家人服从了——我「赢了」。但赢的代价，我没有土地可以支付。

胜利者的账单，往往比失败者的更难付清。失败者的账单是确定的；胜利者的账单，是一种说不清原因的慢慢腐蚀。`,
    bodyEn: `In the autumn of 1281, I was thirty years old. The shogunate had "won."

Then the ledger opened.

Kamakura was built on the gokenin system: warrior households pledged loyalty, sent men to war, and received rewards afterward — typically land. This was the foundation of the shogunate's legitimacy: military service produces a return.

But the 1281 war was won without capturing any land. The Mongols drowned. Japan seized no new territory to distribute.

What about the warriors who fought? They had spent their own money, lost their own people, depleted their warhorses and grain, and they expected compensation. What I had to give was existing Japanese land — which meant redistributing from someone else, or squeezing the estates of temples and shrines. Either path creates new grievances.

After 1281, gokenin confidence in the reward system began to erode systematically. Not a single explosion — a crack that widened slowly.

At the same time, the wall's construction, the sustained garrison at Hakata Bay, the logistics of mobilization — all of it required resources. The shogunate requisitioned from the gokenin, the gokenin squeezed their shōen estates, the pressure passed down to the farmers. And the consumption did not stop: Kublai Khan kept planning a third campaign until his death in 1294, so I had to keep the Hakata Bay watch active.

Here is where the paradox of "system hardening" appears: I successfully maintained the system, so its cracks were sealed inside it. The typhoon helped me, the wall worked, the warriors complied — I "won." But the cost of winning, I had no land to pay.

The victor's bill is often harder to pay than the loser's. The loser's bill is clear and finite. The victor's bill is a slow corrosion no one can quite name the reason for.`,
...
寺庙为弘安之役战死者而建。这是我能给的东西：我没有土地给他们的后代，所以给他们一座寺庙，让僧侣为他们的灵魂做法事。

这不是彻底的解决方案。每个人都知道这不是土地。但我没有其他方法了。

后世流传一段时宗与无学祖元的著名禅对话——时宗问「如何克服恐惧」，祖元答「洞然无依，万物皆空」。这段对话要小心看待：它以完整问答形式出现在时宗死后很久才编纂的传记和寺院记录里，不能当成当时确实发生的史实。但它折射出的东西是真实的：从 17 岁到 33 岁，1268-1284 年间，我几乎没有停止过危机应对，确实在用禅宗管理一种极度的疲惫。

圆觉寺不只是精神补偿，它也是治理工具：我用宗教回应自己无法用土地回应的问题——跟镰仓武士用禅宗管理心理压力是同一种逻辑的放大。你无法消除那个困境，所以你给它一个仪式上的容器。

北条政子 1221 年赢得的御家人忠诚契约，建立在「我们共同的土地，赖朝公给的」这个基础上。到 1282 年，这条契约链已经开始松动——那些 1281 年后没得到封赏的御家人，拿到的不是土地，是一座寺庙的超度法事。

权力者用石头建筑偿还他还不起的债。你认为这是补偿，还是回避？`,
    bodyEn: `In 1282, Engakuji was completed. I invited the Chinese Zen monk Mugaku Sogen (1226-1286) to come from Song-dynasty China and serve as founding abbot.
...
A famous Zen exchange between me and Mugaku Sogen has come down through later sources — I ask "how does one overcome fear," he answers "洞然無依" (utterly unsupported, empty of all attachment). Treat it carefully: it appears as a polished exchange only in biographies and temple records compiled well after my death, and cannot be cited as a confirmed historical fact. But what it reflects is real: from age seventeen to thirty-three, across 1268 to 1284, I was in nearly continuous crisis management, genuinely using Zen practice to manage a profound exhaustion.

Engakuji was not only spiritual compensation. It was a governance tool: I used religion to respond to what I could not address with land — the same logic as warriors using Zen to manage psychological pressure, scaled up. You cannot eliminate the difficulty, so you give it a ritual container.

The gokenin loyalty contract that Hōjō Masako secured in 1221 rested on the premise of "the lands we share, which Yoritomo gave us." By 1282, that chain was loosening — those gokenin who received no adequate reward after 1281 got not land, but memorial rites in a temple.
...
A person in power repays unpayable debts in stone architecture. Do you think this counts as compensation — or as avoidance?`,
    ...
    engagementHook: '御家人本来该拿到的是土地，我没有土地，于是建了圆觉寺、用超度法事顶上。先不急着评判我这一生，只看「把一笔土地债换成一笔精神债」这一个动作，有两种读法。一种说：这是诚实地承认欠下了、并在能力范围内尽量还，债还在，只是换了形式。另一种说：法事让没还清的账看起来像还清了，是把一笔算得清的债，悄悄藏进一笔算不清的债里。你更同意哪一种？想 30 秒，写下来。',
...
儿子贞时十三岁接任第九代执权——又一个少年执权，又一次权力真空。

时宗死后四十九年，1333 年，镰仓幕府被后醍醐天皇和足利尊氏的联军摧毁。倒幕的军事力量，正来自那些在 1281 年后封赏不足、忠诚松动的御家人家族——那条裂缝，到 1333 年裂开了。

这是历史学的经典悖论：一个人用全部力量防住外部威胁，却在这个过程里把内部结构压得脆弱，最终让体制在他死后数十年崩塌。时宗的胜利是真实的；幕府崩溃的根源也埋在这场胜利里——两者同时为真。

要纠正一个流行说法：时宗不是「神风（kamikaze；中国教材称「台风」）英雄」——神风叙事是他死后由神社神职人员和后来的统治者建构的，20 世纪的「神风特攻队」才借用了这个词。真实的时宗，是一个从 17 到 33 岁在持续高压下做出一连串不可撤回决定的人：拒绝蒙古、斩使、建石墙、挺过两次入侵。

跨课：1438 年，太平洋另一端，帕查库特克也刚击败入侵者，开始建起南美洲最大的政体；时宗守住了日本海岸。两人互不知晓，却面对同一种命运：系统越精密，越承受不住没设计过的事。

system-hardener 永远不知道自己什么时候变成了 system-destroyer。`,
    bodyEn: `On April 20, 1284, Tokimune died in Kamakura, thirty-three years old. The sources do not specify the cause of death; "illness" is the general account.

His son Sadatoki, thirteen years old, became the ninth regent — another young regent, another power vacuum.

Forty-nine years after his death, in 1333, the Kamakura shogunate was destroyed by the combined forces of Emperor Go-Daigo and Ashikaga Takauji. The military force behind the overthrow came from the gokenin households whose loyalty had been eroding since 1281, the ones who received inadequate reward. The crack opened by the 1281 crisis had by 1333 split wide open.

This is one of history's classic paradoxes: a person uses every resource to block an external threat and, in the process, compresses the internal structure until it is brittle, so that the institution collapses in the decades after their death. Tokimune's victory was real. The root cause of the shogunate's collapse was buried inside that victory. Both were true at once.

To correct a popular account: Tokimune was not a "divine wind hero" — the kamikaze narrative was constructed after his death by shrine priests and later rulers, and twentieth-century kamikaze pilots borrowed the term directly. The real Tokimune was a person who, from age seventeen to thirty-three, under sustained pressure, made a series of irrevocable decisions: refusing the Mongols, killing the envoys, building the wall, surviving two invasions.

Cross-Topic: in 1438, on the other side of the Pacific, a man named Pachacuti had just defeated invaders and begun building the largest polity in South America; Tokimune defended Japan's coast. They never knew each other existed, but they faced the same fate: the more precisely engineered the system, the less it can withstand what it was not designed for.

A system-hardener never knows when they have become a system-destroyer.`,
    ...
    engagementHook: '走完我这一生——挡住了蒙古，却用石头建筑偿还还不起的债，最后亲手维护的系统把自己的裂缝封进内部，死后五十年崩塌。你会怎么评价这样一个 system-hardener：圆觉寺是补偿还是回避？他变成 system-destroyer，是失败，还是所有「用力维护系统的人」都会面对的结局？再想一步：你身边有没有这种「拼命维护一个系统、却把代价压给别人」的人，你会怎么对待 TA？',
    expectsRealAnswer: true,
...
export var sesshuLens = {
  ...
  description: {
    cn: '他是备中国一个连出生村子都说不清的孩子，从小进了宝福寺学坐禅抄经，记忆里最清楚的是院子里的石头和老师的背影。这一遍让你跟他从那块石头出发，走到中年终于渡海到明朝，亲眼站到大陆山水跟前，要决定他来学的画到底是不是他要带回去的画。',
    en: 'He is a Bitchu Province boy who entered a Zen temple before he can quite remember it, learning to sit in meditation and copy sutras while a courtyard stone is the clearest thing in his memory. This pass walks with him from that stone courtyard into middle age, when he finally crosses the sea to Ming China and has to decide whether the painting he came to learn is the painting he will bring home.',
  },
  storyboard: [
  {
    id: 'sesshu-N1',
...
具体是哪个村子，我说不清楚。后人说是「备中赤浜」，但那是他们在我死后一百多年才编出来的说法（此地名是 17 世纪以后的传说，非史实）。我只知道我出生在今日冈山县西部一带，然后进了宝福寺（Hōfukuji）修禅。

进宝福寺时，我还是个孩子。幼年的事很多记不清了，记得的是院子里的石头，和老师的背影。

关于幼年有一个流传很广的传说：老师罚我绑在柱子上，我用眼泪在地上画了一只老鼠，惟妙惟肖，老师以为是真鼠，大吃一惊，于是放了我。有人觉得这故事很美。我不否认它美——禅宗的顿悟故事本来就是为了美而写的。但它最早出现在我死后逾百年的 17 世纪文献里，是一个禅宗文学建构，不是我记忆中发生过的事。

我只是一个进了宝福寺的孩子，学坐禅，学抄经，学用笔墨写字。画，是后来的事。

1420 年这一年，北京的紫禁城刚刚建成（永乐帝在位）。日本这边，室町幕府的第 4 代将军足利义持在位，距离勘合贸易（kango bōeki）建立才 19 年。整个东亚的格局，那时候还是可以描述的——明朝在北，日本在东，海峡中间有船往来。

我不知道这些。我是一个备中国的孩子，住在宝福寺，还没想过「中国」是什么。`,
      en: `1420. Bitchū no Kuni. That is where I was born.

Which village exactly — I cannot say clearly. Later people said "Bitchū Akahama," but that was a story they invented more than a hundred years after I died; the place name appears only in seventeenth-century sources, not in records from my lifetime. I know only that I was born somewhere in what is now the western part of Okayama Prefecture, and that I entered Hōfukuji temple to train in Zen while I was still a child.
...
In 1420, the year I was born, the Forbidden City in Beijing had just been completed under the Yongle Emperor. In Japan, the fourth shogun of the Muromachi Bakufu, Ashikaga Yoshimochi, held power. The kango tribute-trade system between Japan and Ming China had existed for only nineteen years. The shape of East Asia, at that moment, could still be described in clear terms — Ming to the north, Japan to the east, ships crossing the strait between.
...
1420 年这一年，北京的紫禁城刚刚建成（永乐帝在位）。日本这边，室町幕府的第 4 代将军足利义持在位，距离勘合贸易建立才 19 年。整个东亚的格局，那时候还是可以描述的。
...
船是足利义政（第 8 代将军）名义下批准的勘合船。资助方一说为大内氏（Ōuchi clan，西日本强藩，长期参与勘合贸易），但史料有限，不宜过于确定。我以「禅僧随员」（zenji-gaiin，僧侣外交随行）身份搭船，47 岁，已经是相国寺系的成熟画家。

出发的时间，与应仁之乱的爆发几乎同步。应仁之乱 1467 年正月正式开始，具体船期与乱事的先后史料不详——但无论我哪天出港，京都在我航行期间已经起火，或即将起火。我选择出发，而不是留守。

我不是逃跑。「逃」意味着你放弃了本来应该守护的东西。但相国寺那时已经不是我需要守护的地方了——它给了我它能给的一切，然后我需要走了。这是不同的事。
...
The ship sailed under the authorization of shogun Ashikaga Yoshimasa. The sponsoring party was possibly the Ōuchi clan — the powerful western Japan domain long involved in the kango trade — but the historical sources are limited and I will not overstate it. I traveled in the capacity of zenji-gaiin, a clerical diplomatic attendant. Forty-seven years old. An established painter in the Shōkokuji tradition.

The timing of my departure overlapped almost exactly with the Ōnin War, which formally began in the first month of 1467. The precise sequence — whether I left before or after the first fighting — is not recoverable from surviving sources. What is clear: whether I sailed before or after the first fires, Kyoto was burning or about to burn while I was at sea. I chose to depart, not to stay.
...
I watched Hakata harbor disappear behind the horizon. Forty-seven years old. Leaving Japan for the first time.`,
...

  {
    ...
    content: {
      cn: `1467 年我从日本出发，1468 年，宁波（Ningbo）入港。47 岁，第一次踏上中国土地。
...
「原本」不存在于某个固定的地方。它在时间里移动，等你到达的时候，它已经走了。`,
      en: `I set out from Japan in 1467. In 1468, Ningbo harbor. Forty-seven years old. My feet on Chinese soil for the first time.
...
The original does not exist in a fixed place. It moves through time. By the time you arrive, it has already moved on.`,
    ...
    bodyCn: `1467 年我从日本出发，1468 年宁波入港。47 岁，第一次踏上中国土地。
...
「原本」不存在于某个固定的地方。它在时间里移动，等你到达的时候，它已经走了。`,
    bodyEn: `I set out from Japan in 1467. In 1468, Ningbo harbor. Forty-seven years old. My feet on Chinese soil for the first time.
...
The original does not exist in a fixed place. It moves through time. By the time you arrive, it has already moved on.`,
    ...
    expectsRealAnswer: false,
    sourcingNote: '1467 年从日本出发、1468 年抵宁波入港（出发与登陆分属两年）；来自 narrative §14；戴进浙派 + 郭熙系传承来自 narrative §14；Watanabe 1975',
    nodeType: 'lonely-mediator',
  },
...
这一段要小心说：我在北京的行程，史料所存极为有限。「进入北京」可以确认，但具体做了什么、待了多久、见了谁，都没有详细记录。我接触的是宫廷待诏画家的圈子，而不是某个正式学院——明朝宫廷画家以「待诏」身份供职。

我看到的是当时「活的」中国山水画——浙派戴进（Dai Jin，1388-1462）的风格主导着宫廷画家圈，北宋大山大水的构图传统也通过明朝宫廷系统传了下来。这跟我在相国寺学的不同，也跟我想象的不同。

我在明朝更像一个研究者，不是学生：我带去自己成熟的 Zen 水墨语言，与明朝院体做对比，而不是简单复制。

我记得有一个明朝待诏画家看了我带去的日本水墨画，说：「这是中国画法，但不是中国的。」我想了很久。他的意思是：你从我们这里拿走了技法，但你用它画的不是我们的山，是你们的山。

在北京，我第一次真正理解「相国寺水墨」是什么——是中国技法在日本地形上长出来的变体，不是复制。我带着这个理解离开中国。

1467 年，就在我研究明朝山水画的同时，6,000 公里外的佛罗伦萨，洛伦佐·美第奇（Lorenzo de\' Medici，1449-1492）18 岁，开始主持美第奇家族。他在赞助艺术家，我在研究艺术——两种「艺术家与权力」的关系，在同一个 1467 年同时发生。`,
      en: `After Ningbo, our vessels moved north. I entered Beijing.

This part has to be said carefully: the historical record of my time in Beijing is extremely thin. That I entered Beijing can be confirmed, but the specific activities, duration, and contacts are not documented in detail. What I dealt with was the circle of court daizhao painters — supply-artists on call — not a formal academy.
...
In Ming China I was more a researcher than a student: I brought my own mature Zen ink language, held it against Ming academy style to compare and calibrate, rather than simply copy.

I remember a Ming daizhao painter looking at the Japanese ink painting I had brought along and saying: "This is Chinese technique, but it is not Chinese." I turned that over for a long time. What he meant: you took the method from us, but what you painted with it is not our mountains. It is yours.
...
In 1467, while I studied Ming landscape painting in Beijing, six thousand kilometers away in Florence, Lorenzo de\' Medici was eighteen years old, beginning to lead the Medici family. He was sponsoring artists; I was studying art. Two versions of the relationship between artists and power, both in the same year.`,
    },
    bodyCn: `宁波之后，船队北上，我进入了北京。

这一段要小心说：我在北京的行程史料所存极为有限。「进入北京」可以确认，但具体做了什么、待了多久、见了谁，都没有详细记录。我接触的是宫廷待诏画家的圈子，而不是某个正式学院——明朝宫廷画家以「待诏」身份供职。

我看到的是当时「活的」中国山水画——浙派戴进（Dai Jin，1388-1462）的风格主导宫廷画家圈，北宋大山大水构图传统也通过明朝宫廷系统传了下来。这跟相国寺学的不同，也跟我想象的不同。

我在明朝更像一个研究者，不是学生：我带去自己成熟的 Zen 水墨语言，与明朝院体做对比，而不是简单复制。

我记得一个明朝待诏画家看了我带去的日本水墨画，说：「这是中国画法，但不是中国的。」我想了很久。他的意思是：你从我们这里拿走了技法，但你用它画的不是我们的山，是你们的山。

在北京，我第一次真正理解「相国寺水墨」是什么——是中国技法在日本地形上长出来的变体，不是复制。我带着这个理解离开中国。

1467 年，就在我研究明朝山水画的同时，洛伦佐·美第奇（1449-1492）18 岁，在佛罗伦萨开始主持美第奇家族，赞助艺术。两种「艺术家与权力」的关系，在同一个 1467 年同时发生。`,
...
这听起来很简单：回到日本，画日本的山。但实际发生的，比这复杂。

我用的是明朝山水的「体量感」（把山和石头作为有重量的三维实体来画）和日本禅宗水墨的「留白意识」（用墨和空白的关系表达精神状态）。这两件事我不是分开用，而是把它们融合在一起，产生了一种既不属于明朝院体、也不属于相国寺旧风的新语言。

我记得大约 1470 年代某个早晨，我在山口附近的山里，看着一片花岗岩露头。花岗岩的节理是垂直切割的——中国北方画里常见的是横向分层的砂岩；但花岗岩不一样，它的纹理是块状的、球形风化的，是另一种逻辑。

我拿起毛笔，用明朝「斧劈皴」（axe-cut brushstroke）的侧锋，去画眼前那片花岗岩。

然后我停下来。那个山石的体积感「对」了——不是中国的对法，是日本花岗岩自己的对法。斧劈皴本是为画北方砂岩用的，但它的侧锋干笔用在花岗岩的切割面上，是另一种东西。

这是「用别人的眼睛，重新看自己的家」的第一次——用明朝带回来的笔墨方式，发现日本地形自身的结构。不是把中国画法套到日本风景上，是用中国笔墨的逻辑，找到日本地形自己的美感。

这件事，需要你先去别处看别的山，然后回来，才能看见自己的山。`,
      en: `Yamaguchi period. After 1469. I began in earnest to paint Japanese mountains.

That sounds simple: come back to Japan, paint Japanese mountains. But what actually happened was more complicated.

What I worked with was the volumetric weight of Ming landscape — treating mountains and rocks as three-dimensional objects with mass — combined with the Japanese Zen ink tradition's negative space — using the relationship between ink and empty paper to express a mental state. I did not use these separately; I fused them, producing a language that belonged to neither Ming academy style nor the old Shōkokuji manner.
...
I picked up my brush and used the side-stroke of the Ming axe-cut brushstroke on that granite outcrop in front of me.

Then I stopped. The volume of the rock felt right — not right in the Chinese way, but right in the way of Japanese granite itself. The axe-cut stroke was developed for northern Chinese sandstone, but the dry-brush side-stroke against the cut face of granite produced something different.

This was the first moment of using another's eyes to look at your own home again — using Ming brush logic to discover the structural beauty already present in Japanese terrain. Not forcing Chinese methods onto Japanese scenery. Using Chinese brush logic to find Japanese form.
...
这是一幅横卷，全长约 1560 厘米，由四段组成，今藏京都国立博物馆。要说明一点：有学者认为传世版本经后代重装，原始尺寸与记载有出入，「约 1560 厘米」是当前传世版本的数字，不保证是我完成时的状态。

春夏秋冬，四时连贯。

为什么要画四季？因为山水不是一个时刻的山水——是时间里的山水。春天的山、夏天的山、秋天的山、冬天的山，各自不同。画成一卷，展开时随卷轴移动，就是随时间移动。

技法上，这幅画融合了「斧劈皴」（axe-cut brushstroke，郭熙系，把山体切割成块面）和日本禅宗水墨的留白意识。山体体积感强烈，不同于周文系的轻淡风格——这是明朝带回来的。

但画的是什么山？是日本的山——我在山口附近和九州山地里走过、看过的山，用明朝的笔墨语言重新组织出来的。不是明朝的山，也不是相国寺系那个约定俗成的「山水符号」。
...
天桥立是日本「三景」之一，位于今日京都府宫津市，丹后半岛南侧。一条砂洲横跨宫津湾，长约 3.6 公里，两侧是海，中间是茂密的松林。从高处看，它像一条飞越海湾的桥——「天橋立」，天上的桥，立在水里。

我为什么要去现场？

在我之前的日本山水画，很多是「约定俗成的山水」——画一座「山水里的山」，不是亲眼看见的某座山，是一个代表「山水意境」的文化符号。这在相国寺系里也有。

但中国有一个传统叫「真景山水」——画家亲赴某处，画他亲眼所见的真实地形，而不是想象或学来的符号。我在明朝接触到这个传统，把它带回了日本。

于是 80 岁出头，我拖着老迈的身体去了天桥立。不是因为记忆里有它，不是因为想象中的它——是因为我需要去看它，用我自己的眼睛，画下它真实的地形。

这个动作，跟 47 岁去明朝是同一个：去看原本。47 岁是离开日本，去看中国原本；80 岁是离开山口，去看日本土地上的原本。同一种冲动，不同的距离。
...
Ama-no-hashidate is one of Japan's "Three Views," in what is now Miyazu City in Kyoto Prefecture, on the southern side of the Tango Peninsula. A sandbar stretches across Miyazu Bay, about 3.6 kilometers long, water on both sides, a thick pine forest in the middle. Seen from above, it looks like a bridge flying across the bay — the Bridge of Heaven, standing in water.

Why did I go in person?

Much Japanese landscape painting before me was "conventional landscape" — the painter painted "a mountain in a landscape setting," not any particular mountain he had actually seen, but a cultural symbol representing "landscape atmosphere." The Shōkokuji system had this too.

But there is a Chinese tradition called "portrait of real landscape" — the painter goes to a specific place and paints the actual terrain as he personally sees it, not an imagined or learned symbol. I encountered this tradition in Ming China and brought it back to Japan.
...
This action is the same as going to Ming China at forty-seven: to go and see the original. At forty-seven, the journey was leaving Japan to see the Chinese original; at eighty, leaving Yamaguchi to see an original on Japanese soil. The same impulse, a different distance.

A painter's life is not about establishing a style somewhere and then stopping. It is a series of trips to go and see, each one a first encounter with a specific place.`,
    },
...
我之前的日本山水画，很多是「约定俗成的山水」——画一座「山水里的山」，不是某座真实的山，是一个代表「山水意境」的文化符号。这在相国寺系里也有。但中国有一个传统叫「真景山水」——画家亲赴某处，画他亲眼所见的真实地形。我在明朝接触到这个传统，把它带回了日本。
...
Does the idea of "going to see the original" mean anything to you? Is there something you thought you understood, but had only understood someone else's description of it?`,
    ...
    engagementHook: '我 80 岁拖着身体去天桥立，画我亲眼看见的真实地形，不画约定俗成的山水符号。那么我画出来的，到底算不算更接近「真实」？有两种读法。一种说：亲赴现场写生，比闭门画一个文化符号更接近真实，眼睛胜过想象。另一种说：再忠实的写生也是一个人的眼睛、一支笔筛选过的版本，它跟那个符号一样，仍然不是地形本身。你更同意哪一种？想 30 秒，写下来。',
    expectsRealAnswer: true,
...
「1506 年」是文献推算的约值，实际死亡时间地点日本史书无明确记载。常见说法是「约 86 岁」卒于山口或益田附近，但这是后世传记的推算。我不知道自己哪年哪月、在哪里死的，当时没人记清楚。

这值得停下来想：一个 86 岁的画家，留下几十件真迹，死亡时间地点却找不到——说明他活着时，没人认为他的死值得仔细记录。

我活着的时候，没有「画圣」这个称号。「日本画圣」（日本水墨画之祖）这个头衔，是明治以后民族主义美术史建构出来的——把一个跨文化的禅宗僧侣，简化成「日本性」的旗帜。我从没自称画圣，也没有建立正式流派。

但我之后每一个重要的水墨流派，都从我身上借力。长谷川等伯（Hasegawa Tōhaku，1539-1610）宣称继承我的传统；狩野派（Kanō school）引入我的水墨元素，走向装饰；20 世纪的现代水墨把我追溯为祖先。

这就是 lonely mediator 的命运：活着时不属于任何一边，死后被所有人认领。

Lorenzo de\' Medici 死于 1492 年；我到 1506 年仍在工作，多活 14 年。

要说清楚：我不是以「成为日本画圣」为目标工作的。我是一个 Zen 僧侣，在明日文化边界上探索山水与禅，被大名庇护，在战乱中坚持创作。画圣是后人贴的标签。`,
      en: `In 1506, I died. Approximately.

"1506" is a figure derived from document inference — the actual date and place of my death are not recorded clearly in any Japanese source. The common saying is "approximately eighty-six years old," dying somewhere near Yamaguchi or Masuda, but this is a composite inference made by later biographers, not a document from the time. I can only tell you honestly: I do not know the year or month I died, or where, and no one at the time recorded it carefully enough.

This is worth pausing on. An eighty-six-year-old painter who left behind dozens of verifiable works — and his death cannot be located in the historical record. That tells you something: while he was alive, no one considered his death important enough to document precisely.

I held no title of "Master of Painting" while I was alive. The designation "patriarch of Japanese ink painting" was constructed by nationalist art history writing after the Meiji period — taking a complex, cross-cultural Zen monk and simplifying him into a flag for "Japanese-ness." I never called myself a master, never established a formal school, organized no disciples, set no rules.
...
Do you think being labeled by later generations is an honor, or a misunderstanding? Or both at once?`,
    ...
    engagementHook: '走完我这一生——一次接一次跋涉去看真实的原本，活着时却连「画圣」的头衔都没有，死后 300 年才被所有人认领。你会怎么评价这样一个「去看原本」的人？再想一步：你身边有没有什么东西，你以为你了解，其实只了解了别人的描述，你愿意亲自去看一次吗？',
    expectsRealAnswer: true,
...
export var masakoLens = {
  ...
  description: {
    cn: '她是 1156 年生在伊豆乡下的女孩，京都那年正在闹宫廷政变，她家在全国权力地图上几乎是一块白地，大事过去几个月才传到这里。这一遍让你跟她在父亲庄园里看二十四年的土地纠纷和债务清算，直到一个流亡王子出现在门口，她从小学的那种不带装饰的权力语言终于要派上用场。',
    en: 'She is a girl born in the back-country of Izu in the same year that a palace coup tears Kyoto apart, in a household so far off the national map that no one tells her family the news for months. This pass walks with her through twenty-four years of watching land disputes and unpaid debts settle without poetry or ritual, until a fugitive prince arrives at her father\'s estate and the language of power she has been quietly learning suddenly has a use.',
  },
  isDefaultLens: true,
  storyboard: [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn: `1156 年，我出生在伊豆国（Izu Province）。那一年，京都正在发生保元之乱（Hōgen no Ran，皇室与贵族的内战）——天皇家分裂，藤原氏分裂，武将源氏和平氏被拉进首都的权力游戏。

我不知道这件事。

伊豆在京都西南方向，隔着山，隔着海，隔着那种「远到发生了大事也很久才听说」的距离。我父亲北条时政（Hōjō Tokimasa）是伊豆当地的御家人（gokenin）——字面意思是「将军家里的人」，但那时还没有将军，这称呼只是说他效忠地方豪族网络，有自己的庄园、武装和土地，在伊豆半岛是个说得上话的人。在全国权力地图上，他几乎是白地。

我出生进来的世界是伊豆的世界——不是《源氏物语》里薰香琴瑟的宫廷，不是藤原氏操弄天皇的幕后大厅，是庄园里的土地纠纷、债务清算、武装冲突和季节轮回。

人们后来常把我描述成「贤妻良母」，或者「悲伤出家的遗孀」。这两种说法都把我缩小了。我想在第一节就说清楚：那不是我。

从边缘看权力，往往比在中心看得更清楚——因为没有装饰，只有骨头。我在伊豆度过的这 24 年，学到的是权力真正的样子。后来在镰仓，我认出了它。

那是后来的事。现在是 1156 年，我刚出生，京都出了大事，而我们不知道。

出生地点，决定了你最先学会哪一种权力的语言。我学会的第一种，是伊豆武士的语言。`,
...
京都贵族学的是：怎么把权力用诗歌和礼仪包起来，让它看起来不像权力。我父亲那一代伊豆御家人学的是：土地的边界在哪里，债务到期怎么索还，联盟怎么维护，武力什么时候用、什么时候威胁就够了。

两种教育都是关于权力的。但我学到的那种，没有包装纸。

父亲的庄园平时是农业单位，秋收之后就变成账本——谁欠了多少，谁按时交了贡赋，谁试图讨价还价，谁跟邻近豪族暗中联系。我从小跟着父亲的账房走，听庄园管事报告。我学会了在一个房间里，通过一个人说话的速度、看父亲的眼神、手有没有放松，判断他在说谎还是说真话。

这是书上读不到的东西，是伊豆教给我的。

1160 年代，平清盛（Taira no Kiyomori）控制了京都，走的是藤原氏的老路：把女儿嫁给天皇。消息传到伊豆已是几个月后。父亲听完，沉默了一下，说：「武将终究走了外戚的路。这条路很短。」

我那时大约 4 岁，还听不懂这句话。但 20 年后赖朝来了，我记起了它。

这 24 年我观察到一件事：权力不是头衔给的，头衔只是记录权力已经在谁手里。真正的权力是关系，是信用，是你说了话别人相信你会做到。父亲的庄园不大，但他说话，伊豆人听。
...
I stored this observation like a tool I knew I would someday use.`,
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn: `1160 年，源赖朝（Minamoto no Yoritomo）被平清盛流放到伊豆，当时 13 岁。平清盛本想杀他，有人劝说留了一命。赖朝在伊豆待了整整 20 年——不是坐牢，是半监视居住，不能随意进入政治活动，但可以走动。

他在伊豆认识了我父亲和伊豆的御家人网络。我从童年就认识他。

1180 年，赖朝 33 岁，我 24 岁。这一年，以仁王（Mochihito-Ō）发出令旨，号召各地源氏举兵反平氏。这是一个极度危险的赌局——失败则全族灭亡，成功则翻身豪门。父亲决定支持赖朝举兵。

《吾妻鏡》（Azuma Kagami）记载，父亲原本已为我安排婚事，对象是山木兼隆（Yamaki Kanetaka），但我不顾安排，夜间逃到赖朝住处，父亲追赶没追上。这段记载要谨慎看：《吾妻鏡》是幕府官修史书，有塑造英雄配偶形象的动机，不能字字当真。但学界共识是：我确实嫁给了赖朝，这桩婚姻使父亲从「支持者」变成「岳父」。这是把地方御家人推进全国政治的一步。

一个婚姻决定，可以同时是个人选择和家族赌注，这两件事不矛盾。

我 24 岁，知道这个男人有可能失败，知道失败的代价。父亲也知道。赌注已经押下去，押的是这个家族，押注的方式，是把我嫁过去。

这不只是一个爱情故事。爱情是真的，但它发生在一个政治赌局里——两件事同时为真。`,
...
This is not only a love story. The love was real. But it happened inside a political gamble, and both things were true at the same time.`,
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn: `1185 年，壇ノ浦之战（Battle of Dan-no-ura）结束了源平合战。平氏残部在今山口县的海峡里沉没，年幼的安德天皇被抱入水中。赖朝成为镰仓政权的核心，1192 年朝廷正式封他为征夷大将军（Seii Taishōgun）。

我 29 岁，是将军的妻子。

我有四个孩子，两个幼年早死——在那个时代的医疗条件下不算意外。活下来的是长子赖家（Yoriie，1182-1204）和次子实朝（Sanetomo，1192-1219）。

那 14 年我不是决策者。权力是赖朝的，是父亲和义时的，不是我的。我是见证者——一个既懂伊豆武士语言、又懂镰仓幕府制度语言的人。但见证者通常没有发言权。

那 14 年，我看着御家人（gokenin）体制怎么建立起来：地方武士和将军之间，建立了一套「忠诚换土地保障」的关系——你跟着将军，将军承认你的庄园，土地权利由幕府背书。这让镰仓幕府有了真正的地方基础——不只军事，更是经济捆绑。

我当时不知道：我孙子一辈的北条时宗（Hōjō Tokimune，1251-1284）会在我死后 26 年用这套体制抵御蒙古。1268 年他能让御家人全力备战，正因为这套关系在 1185 年就建立了——它搭起来的每一块砖，我都亲眼看着。

见证者最清楚真相，却最没发言权——直到发言的时刻来临。`,
...
A witness is often the person who sees the truth most clearly, and the person with the least standing to speak. Until the moment to speak arrives.`,
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn: `1199 年 1 月，赖朝死了，52 岁。《吾妻鏡》说他是落马，但细节含糊，后世推测各异，没有定论。

我那年 43 岁。

按照那个时代武士妇女的礼制：丈夫死后，遗孀应该出家——剃发为尼，退出世俗生活，让儿子主持丧事，让家族权力在儿子辈里重新分配。逻辑是：遗孀必须服从儿子，将军之母必须退到将军之后。

如果我照礼制走，就成了赖家（17 岁）的「母亲」——而「母亲」在礼制里，是一个必须服从「儿子」的位置。

我削了发，取法号「二位尼（Nii-no-Ama）」。这是礼制允许我做的动作，但我用它达到的结果，跟礼制预设的完全相反。出家之后，我不是将军的母亲，不是任何人的妻子，而是宗教人士。礼制对宗教人士和对世俗妇女，是两套不同的规则。我找到了那个缝隙。

「尼将军（Ama Shōgun）」这个称呼，最早出现在《吾妻鏡》1221 年前后的记录里，是史书对我角色的总结，不是我的自称，也不是正式官职。后世文学和教科书反复强化它，给我加上了比当时现实更整齐的「女性权力」形象。

那一天，赖家 17 岁，准备接任将军。我剃了头，变成一个礼制上没有「母亲」身份的人——于是可以继续作为政治行动者存在，而不是作为遗孀存在。
...
人们后来有两种说法：一种说我是权谋的受害者，被父亲和弟弟操控、无力阻止，是一个忍受父权压迫的悲哀母亲。另一种说法不同——我是主动参与者，不是受害者。从这个角度看，我做了一个政治判断：赖家稳不住幕府。

赖家性格刚愎，21 岁还没学会御家人体制需要的那种政治耐心，在位期间已和多位宿老冲突。他若继续当将军，北条氏和御家人网络之间的裂缝会越来越大，幕府的内部稳定会被侵蚀。我需要实朝——11 岁，好塑造，可以在北条氏的辅政下成长。

这是政治判断，不是母亲的判断。做了政治判断，就意味着我没有做母亲的判断。两者不能同时，我只能选一个。

把政子读成「贤惠母亲忍受父权压迫」，是后世人把自己的叙事框架，套到 12-13 世纪的政治现实上。那个框架在这里用不上。
...
A mother whose children have all died is still working for the system those children died inside of. That was my situation in 1219. I do not have good language for it.`,
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    setting: {
      time: '1221 年，65 岁',
      place: '镰仓，御家人集会',
      cn: '后鸟羽上皇讨幕令；御家人犹豫；政子的话由安达景盛代为向御家人宣读（《吾妻鏡》）；McCullough 1985 + Bialock 2007 史料复杂性',
      en: 'Retired Emperor Go-Toba\'s anti-shogunate edict; wavering gokenin; Masako\'s words read aloud to the gokenin by Adachi Kagemori (Azuma Kagami); McCullough 1985 + Bialock 2007 on source complexity',
    },
    content: {
      cn: `1221 年，退位的后鸟羽上皇（Retired Emperor Go-Toba，1180-1239）颁布讨幕令，以「讨义时」为名，号召西国武士背叛镰仓，重新归附京都朝廷。这是镰仓幕府建立以来最严重的危机。

御家人集会。

据《吾妻鏡》，我的话不是当众亲口说的，而是由安达景盛代我向御家人宣读。在那一刻之前，会场里有人还没决定：后鸟羽是上皇——传统上最高的文化权威，对抗他，很多武士心理上有障碍。

景盛替我宣读的话，大意是：「赖朝公从无到有建立这个政权，你们的土地和地位都来自那段历史。上皇此举是奸臣蒙蔽，不是他的本意。还想投靠上皇的，现在就说，我不阻拦；想报答赖朝公的，就现在举兵。」

这里要诚实说明：《吾妻鏡》成书于演讲 50 多年后，是幕府官修史书，有美化建国合法性的动机；这段演讲措辞整齐、节奏有力，明显被后世润色过。但有充分旁证：内容可能是重构的，政子却确实在场、发表了影响御家人决策的讲话。

我不知道我的话是否如记录那样完整。但我知道：让景盛把话带到御家人面前的那一刻，我不知道结果会怎样——只知道我不说，就没有人说。

这场 1221 年的演讲，跟拜占庭的狄奥多拉（Theodora）532 年 Nika 暴动时「紫袍是好寿衣」并列：两个女性都在政权最危险的时刻开口。最重要的话，往往在最不确定时说出。`,
...
I gave my words to Kagemori, to carry before the gokenin — according to the Azuma Kagami, I did not speak them aloud myself; Adachi Kagemori read them on my behalf to the assembled warriors. Until that moment, some in the hall had not yet decided. Go-Toba was an ex-emperor — the symbolic center of the imperial system, traditionally the highest cultural authority. Many warriors felt a psychological barrier to opposing him.

The Azuma Kagami records the substance of what Kagemori read in my name: "Yoritomo built this government from nothing. Your land, your position — all of it comes from that history. What Go-Toba has done is the work of treacherous advisors; it is not Go-Toba's own true intention. If there is anyone here who wishes to go over to Go-Toba's side, say it now — I will not stop you. But if you wish to repay what Yoritomo gave you, take up arms now."
...
I do not know whether what I said was as complete as the record states. I only know that the moment I sent my words to the gokenin through Kagemori, I did not know the outcome. I only knew that if I did not speak, no one would.
...
Masako's 1221 speech sits alongside Theodora's "the purple is a good burial shroud" during the Nika Riots of 532 in the Byzantine Topic. Two women speaking at the most dangerous moment for their respective regimes. Neither held formal power within their systems. Both used language to redefine what the crisis was. The most important words are often spoken in the most uncertain moment.`,
    ...
    deliverGoal: 'N9 — 1221 承久之乱 + 御家人犹豫 + 政子的话由安达景盛代读（《吾妻鏡》，非政子当众亲口）+ careful framing：《吾妻鏡》写定化 (Bialock 2007 / Varley 1994) + McCullough 1985：演讲影响有实质依据 + 跨 Topic：Theodora 532 年 Nika 暴动对照',
...
30 天，后鸟羽上皇的军队被击溃。他被流放隠岐（Oki，今岛根县离岛），在那里度过余生，1239 年死在流放地。
...
战后处置——300 余名西国武士没收土地，后鸟羽一家流放——都是义时的决定，不是我的。幕府在全国的权威确立之后，权力重心完全在义时手里。

我还在，但我不再是关键决策者。

这不是因为我衰老了，不是因为我软弱了，也不是因为义时排挤我。是因为体制完成了它需要我做的事，就不再需要我了。

1199 年，体制需要我成为幕府和北条氏之间的接口，我做了；1203 年，需要我对废赖家默许，我做了；1213 年，需要我在和田合战上表态，我做了；1221 年，需要我在御家人面前开口——我开了。

每一次，体制需要我，我就在那里。

1221 年之后，体制不需要那个声音了，因为问题已经解决。权力的逻辑是功能性的，不是感情性的——你有用，你在场；你不再有那个特定的用处，你就退到边缘。

我没有屈辱，也没有愤恨。这是我从伊豆就懂的事：权力的位置不是永久的，是条件性的。条件还在，你就在那里；条件变了，位置就变了。

1221 到 1225 年，我在镰仓、在幕府的运转里，但不在中心了。我再次成为见证者——这一次，是见证我自己构建和维护的体制，在我还活着时，就完成了对我的交班。
...
A system uses people, then sets them down.`,
    ...
    engagementHook: '体制需要她时她就在场，用完了就把她放回边缘。一种说法是：这是体制辜负了她，把她当工具用完就丢。另一种说法是：这不是针对她，任何人在任何体制里，用处一旦消失就都会被放下。你更认同哪一种？想 30 秒，写下来。',
    expectsRealAnswer: true,
    nodeType: 'receiving-end',
...
我的演讲留在《吾妻鏡》里。但《吾妻鏡》是幕府官修史书，我的声音经过幕府过滤——留下来的，是幕府需要的那个版本，其他的不在记录里。

1225 年之后，日本历史里再没有一个女性能以自身名义执掌政权，或发出能被史书记录的政治声音。我是「女性政治声音在制度里消失」的节点，不是开端：我是孤例，不是先例。

我能出现，靠的是一组罕见的条件——伊豆武士家庭出身（懂权力的真实面目）、赖朝的妻子（合法性来源）、父亲和弟弟的政治支持网，加上 1199 年出家找到的礼制缝隙。1225 年之后，这些条件没有在任何女性身上重新组合。这是制度的原因，不是个人能力。

跨课对比：Theodora 548 年死，我 1225 年死，相隔 677 年。两人之后的制度都没有再产生同等级的女性政治声音。那个时代女性的政治声音不是趋势，是偶然，不可复制。

我不是「女性权力的先驱」，不是「贤妻良母」，也不是「封建压迫的受害者」。我是在极端约束下做政治判断的人——活着时制度允许，死后没有再产生类似条件。

历史记住北条政子，不是因为她开创了什么，而是因为她之后再没有人能这样做。那个「再也没有人」，是历史对她最诚实的评价，也是那个制度最诚实的证词。`,
...
A cross-topic comparison: Theodora died in 548; I died in 1225 — 677 years apart. Neither of the institutional systems that followed either of us continued to produce female political voices at the same level. The appearance of female political voice in that era was not a trend; it was contingent, non-reproducible.

I was not "a pioneer of female power," not a "virtuous wife and good mother," and not "a victim of feudal oppression." I was a person making political judgments under extreme constraint — while I was alive, the institution allowed it; after I died, it did not produce the conditions again.
...
What do you think: is a person remembered by history because she was exceptional, or because those who came after her were less exceptional? What is the difference between those two explanations?`,
    ...
    engagementHook: '走完政子这一生——她死后再没有第二个女性能这样发声。历史记住她，到底是因为她特别，还是因为她之后的人更不特别？这两种理由，分量完全不同。再想一步：在你自己的班级、家庭或社区里，有没有谁是「唯一一个能做某件事的人」，等 TA 走了就再没人接得上？你会怎么对待这样的人？想 30 秒，写下来。',
    expectsRealAnswer: true,
    nodeType: 'receiving-end',
