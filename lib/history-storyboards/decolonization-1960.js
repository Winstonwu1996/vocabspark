...
export var churchillLens = {
  ...
  icon: '🎩',
  description: {
    cn: '他是 1942 年伦敦炸弹还在头上落时全世界都在听他广播的那位首相，他说英国绝不投降，要在海滩上、在街道上跟纳粹打到底,,那几年他是反法西斯的英雄，这没人能否认。可同一张嘴，那几年还说过另一句话：「我当首相，不是为了去主持大英帝国的散伙。」这一遍让你跟他一起坐进唐宁街那间办公室：他从小被教大英帝国是世界本来的样子，印度是「王冠上的明珠」，没有它英国只是个普通国家,,他要决定，让印度独立这件事，对他到底是「一个殖民地走了」，还是抠下王冠上最大那颗宝石。',
    en: 'He is the prime minister whose broadcasts the whole world listens to in London in 1942 while bombs still fall overhead, saying Britain will never surrender, that they will fight the Nazis on the beaches and in the streets to the very end. In those years he is a hero against fascism, none can deny it. Yet the same mouth, in those same years, said another thing: "I did not become prime minister to preside over the breakup of the British Empire." This pass puts you with him in that Downing Street office: he was taught from boyhood that the Empire was simply the way the world was, that India is "the jewel in the crown," and without India Britain is only an ordinary country, and he must decide, is letting India go free just "one colony leaving" or the prying out of the largest gem in his crown?',
  },
  storyboard: [
    {
      id: 'churchill-n1',
...
export var ralphBuncheLens = {
  ...
  icon: '🕊️',
  description: {
    cn: '他是 1949 年在地中海一座小岛的旅馆里，把刚打完一场惨烈战争、连同一张桌子都不愿坐的两边人关在屋里的联合国调停员。没有军队听他的，没有任何一方怕他，他手里唯一的东西是耐心和一张地图。这一年他 45 岁,,一个美国黑人，在自己的国家很多餐馆不让他进，很多人觉得像他这样的人天生就该待在底层。这一遍让你跟他一起坐进那间会议室：全世界都在等他这个「不该坐到台面上」的人去为两国谈和平,,他要替你回答，一个在自己家都不被当平等的人，怎么去为别人主持公正。',
    en: 'He is the UN mediator in 1949, shutting inside a hotel room on a small Mediterranean island the two sides of enemies just out of a brutal war, who will not even sit at the same table. No army obeys him, no side fears him, and the only thing in his hands is patience and a map. This year he is 45, a Black American whose own country bars him from many restaurants and whose people are told they belong at the bottom by birth. This pass puts you with him in that room: the whole world waits for him, a man "not supposed to have a seat at the table," to negotiate peace for two nations, and he must answer for you, how does a man not treated as an equal in his own home go and broker fairness for others?',
  },
  storyboard: [
    {
      id: 'bunche-n1',
...
export var partitionRefugeeLens = {
  ...
  icon: '🚂',
  description: {
    cn: '他不告诉你他的名字，因为他不是一个人，他是几百万人（历史学家从无数真实幸存者的口述里拼出的一个代表，他身上每一件事都真的发生在 1947 年某个真人身上）。他大概 27 岁，住在旁遮普一个村子里,,那是印度西北部一片肥沃的平原，他家世世代代住在那儿，邻居里有印度教徒、有穆斯林、有锡克教徒，做了几代人的邻居，孩子们一起在田埂上跑。这一遍让你跟他一起站在自家门口：一条一个从没来过印度的英国律师用五个星期画出的线，要切开他的家乡，他几代人的好邻居即将拿起刀,,他要决定，是连夜逃，还是赌邻居还是邻居。',
    en: 'He will not tell you his name, because he is not one person, he is millions (a representative pieced together by historians from the spoken testimonies of countless real survivors; every single thing about him truly happened to some real person in 1947). He is about 27, in a village in Punjab, a fertile plain in the northwest of India where his family has lived for generations, among neighbors of several faiths, Hindu, Muslim, Sikh, for as long as anyone remembers, the children running together on the field paths. This pass puts you with him at his own door: a line drawn in five weeks by a British lawyer who had never been to India is about to cut his homeland in two, and the good neighbors of generations are about to take up the knife, and he must decide, flee in the night, or bet that a neighbor is still a neighbor.',
  },
  storyboard: [
    {
      id: 'refugee-n1',
