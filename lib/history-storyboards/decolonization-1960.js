...
export var churchillLens = {
  ...
  icon: '🎩',
  description: {
    cn: '英国人，1874 年生在一座贵族庄园里。二战时他是首相，带领英国顶住纳粹德国的轰炸，是世界公认的反法西斯英雄。同一个他，一辈子坚信大英帝国统治世界是天经地义，公开说自己「不是为了拆掉帝国才当首相的」。1943 年印度孟加拉闹大饥荒，估计数十万到约 300 万人饿死（取决于是否计入间接死亡），他拒绝调粮救援。这一遍让你从一个真英雄、也真帝国主义者的内部，看「自由的胜利」这个故事的另一面。',
