...
export var churchillLens = {
  ...
  icon: '🎩',
  description: {
    cn: '他是 1942 年伦敦炸弹还在头上落时全世界都在听他广播的那位首相,他说英国绝不投降,要在海滩、街道上跟纳粹打到底,那几年他是反法西斯的英雄。可同一张嘴还说过:「我当首相,不是为了主持大英帝国的散伙。」这一遍让你跟他坐进唐宁街办公室:他从小被教大英帝国是世界本来的样子,印度是「王冠上的明珠」,没了印度英国只是普通国家,他要决定:让印度独立,对他是「一个殖民地走了」,还是抠下王冠上最大那颗宝石。',
    en: 'He is the prime minister whose broadcasts the whole world listens to in London in 1942 while bombs still fall overhead, saying Britain will never surrender, will fight the Nazis on the beaches and in the streets to the very end; in those years he is a hero against fascism. Yet the same mouth, in those same years, said: "I did not become prime minister to preside over the breakup of the British Empire." This pass puts you with him in the Downing Street office: he was taught from boyhood that the Empire was simply how the world was, that India is "the jewel in the crown," and without India Britain is only an ordinary country, and he must decide, is letting India go free just "one colony leaving," or prying out the largest gem in his crown?',
  },
  storyboard: [
    {
      id: 'churchill-n1',
...
export var ralphBuncheLens = {
  ...
  icon: '🕊️',
  description: {
    cn: '他是 1949 年在地中海一座小岛旅馆里,把刚打完一场惨战、连同一张桌子都不愿坐的两边人关在屋里的联合国调停员。没军队听他、没人怕他,手里只有耐心和一张地图。这一年他 44 岁,一个美国黑人,自己的国家很多餐馆不让他进,人们觉得像他这样的人天生该待在底层。这一遍让你跟他坐进那间会议室:全世界等他这个「不该坐上台面」的人为两国谈和平,他要替你回答:一个在自己家都不被当平等的人,怎么为别人主持公正。',
    en: 'He is the UN mediator in 1949, shutting inside a hotel room on a small Mediterranean island two sides just out of a brutal war who will not even sit at the same table. No army obeys him, no side fears him, in his hands only patience and a map. This year he is 44, a Black American whose own country bars him from many restaurants and where people like him are told they belong at the bottom by birth. This pass puts you with him in that room: the whole world waits for this man "not supposed to have a seat at the table" to negotiate peace for two nations, and he must answer, how does a man not treated as an equal in his own home broker fairness for others?',
  },
  storyboard: [
    {
      id: 'bunche-n1',
...
export var partitionRefugeeLens = {
  ...
  icon: '🚂',
  description: {
    cn: '他不告诉你名字,因为他不是一个人,他是几百万人(历史学家从真实幸存者口述拼出的代表,身上每件事都发生在 1947 年某个真人身上)。他大概 27 岁,住在旁遮普一个村子,印度西北的肥沃平原,世代住在那儿,邻居有印度教徒、穆斯林、锡克教徒,孩子在田埂上一起跑。这一遍让你跟他站在自家门口:一条没来过印度的英国律师五周画出的线要切开他的家乡,几代好邻居即将拿起刀,他要决定:连夜逃,还是赌邻居仍是邻居。',
    en: 'He will not tell you his name, because he is not one person, he is millions (a representative pieced together by historians from countless real survivors\' testimonies; every single thing about him truly happened to some real person in 1947). He is about 27, in a village in Punjab, a fertile plain in the northwest of India where his family has lived for generations, among neighbors of several faiths, Hindu, Muslim, Sikh, the children running together on the field paths. This pass puts you with him at his own door: a line drawn in five weeks by a British lawyer who had never been to India is about to cut his homeland in two, and the good neighbors of generations are about to take up the knife, and he must decide, flee in the night, or bet that a neighbor is still a neighbor.',
  },
  storyboard: [
    {
      id: 'refugee-n1',
...
export var meta = {
  ...
  notes: [
    ...
    '日期/数学校验: Churchill 1874-1965 / Ralph Bunche 1904-1971 1950 诺奖 / 印巴分治 1947 / 孟加拉饥荒 1943 ~300 万 / 大迁徙 ~1500 万 / Bunche 1949 停火 44 岁 (生于 1904-08-07；最后一份停火协议 1949-07-20 签订，距 8 月生日前故为 44 岁)',
