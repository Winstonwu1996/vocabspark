...
export var hanWudiLens = {
  ...
  icon: '👑',
  description: {
    cn: '他是 16 岁登基的大汉皇帝刘彻,接手时国库的钱串子绳都烂了、粮仓陈粮多到吃不完,是祖辈几十年不打大仗一点一点攒下的。这一遍让你坐进他在长安宫里望北、看着这满库的家底却咽不下祖辈靠送公主送丝绸换匈奴一时安宁的位置,看他要不要用这笔几代人攒下的钱粮去搏一件之前没人做成的事:把匈奴打服、把帝国的思想拧成一股、把路通到他从没见过的西边。',
    en: 'He is Liu Che, emperor of the great Han enthroned at sixteen, who inherited a treasury so full the cords stringing the coins had rotted through and granaries of grain old enough to spoil, all saved up by his forebears over decades of fighting no great war. This pass puts you in his seat as he stands in the palace at Chang\'an looking north, the full storehouses before him but the breath of his house unable to swallow the decades of buying off the Xiongnu with princesses and silk, watching whether he will spend the savings of generations to wager on what no emperor before has done: break the Xiongnu, twist the empire\'s thought into one strand, run a road to a west he has never seen.',
  },
  storyboard: [
    {
      id: 'hw-n1',
    ...
    },
    {
      ...
      deliverGoal: 'N11 close — 评价时代 (盛世被庆祝两千年 vs 打空国库榨干百姓无数送死/同一面墙雄伟而墙下埋人同一天平) + 跨视角指针 (你只听了下令的我/张骞+戍卒各有说法/换视角再走一遍看判断站不站得住) + transfer「从小听的盛世强汉多半从最高处角度讲/问皇帝和问买不起盐儿子被征走的农民答案一样吗」+ 以后再听某某盛世黄金时代多问一句: 谁的盛世/荣光谁在底下扛',
      engagementHook: '一个盛世被庆祝两千年，可它是用打空的国库、榨干的百姓、无数被征去送死的人换来的。你会怎么评价这样一个时代？再想一步：以后你再听到「某某盛世」「黄金时代」，会不会多问一句——这盛世，是谁的盛世？它的荣光，又是谁在底下替它扛着？',
      expectsRealAnswer: true,
    },
  ],
};
...
export var zhangQianLens = {
  ...
  icon: '🐫',
  description: {
    cn: '他是一个手里握着皇帝交的节杖、带着一百多人往汉人从没去过的西边走的郎官,刚出河西走廊就被匈奴整队截住,单于没杀他、还给他娶了草原上的妻子,把他软禁了十几年。这一遍让你坐进他在草原上有了家、有了儿子,可那根代表大汉使命的竹杖一直留在身边没丢的位置,看他靠什么记住「我还是张骞,我还在路上」,又怎么在一桩没办成的差事里,凿开一条改写东西方的路。',
    en: 'He is an attendant officer with the emperor\'s staff of mission in hand, leading more than a hundred men into a west no Han had ever crossed, only to be intercepted whole by the Xiongnu past the Hexi corridor; the chanyu does not kill him but gives him a wife of the steppe and holds him under guard for more than ten years. This pass puts you in his place after he has built a home and a son on the steppe, the bamboo staff that stands for the Han mission still kept at his side, watching what he holds on to in order to remember "I am still Zhang Qian, I am still on the road," and how, inside an unfinished errand, he bores open a road that will rewrite the East and the West.',
  },
  storyboard: [
    {
      id: 'zq-n1',
...
export var conscriptPeasantLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是一个史书里连名字都没留下的汉国种田人,赶上过文景之治尾巴几年好日子,可妻子最近称盐回来一次次念叨「这盐怎么又贵了」,直到亭长在村口名册里念到他的名字(一个合成人物,代表汉武盛世底下千千万万没名字的人,账册上只是「发卒若干」之一)。这一遍让你跟他一起夜里在塞外烽火台底下站岗、裹紧单薄的衣服望北边黑沉沉的草原,看他心里那个不敢说出口的念头冒出来:几千里外朝堂那场「赫赫武功」的庆贺里,算不算我们这些人的一份?',
    en: 'He is a Han farmer not even a name was left behind for, who caught the tail of the good years under Wen and Jing, but his wife now mutters again each time she weighs out salt, "how has it gone dearer again," until the village head reads out his name from the roll at the gate (a composite figure, standing for the countless nameless people beneath Emperor Wu\'s golden age, only one of the "so many conscripts levied" in the ledger). This pass puts you with him at night on watch beneath a beacon tower past the passes, pulling his thin clothes tight as he looks at the black steppe to the north, watching the thought he dares not speak rise: in those congratulations of "glorious feats of arms" sounding a thousand li away at court, does any share count for people like us?',
  },
  storyboard: [
    {
      id: 'cp-n1',
    ...
    },
    {
      ...
      deliverGoal: 'N8 story — 他没能回家 (怎么没的不重要/成了埋塞外的一个/没再见妻子没看儿子长大没回到该插秧的地) + anti-fab 透明化: 「我」是后人替千千万万真实存在却一字没留的人拼出的一个声音 + 真实的他们连这点都没有 (没名没故事没遗言) + 「皇帝赫赫武功写满史书/张骞凿空代代传诵/那千万死边塞累死徭役破产流亡的人史书最多给几个字: 海内虚耗户口减半」+ 「户口减半: 少的那一半是谁没名怎么没的没数」+ 「为什么要有这一遍: 替户口减半底下一个个具体的人说出没说出口的话」',
