...
export var conscriptPeasantLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是史书里连名字都没留下的汉国种田人,赶上过文景之治尾巴几年好日子,可妻子最近称盐回来念叨「这盐怎么又贵了」,直到亭长在村口名册念到他名字(合成人物,代表汉武盛世底下千千万万没名字的人,账册上只是「发卒若干」之一)。这一遍让你跟他夜里在塞外烽火台下站岗、裹紧单薄衣服望北边黑沉沉的草原,看他心里那个不敢说出口的念头冒出来:几千里外朝堂那场「赫赫武功」的庆贺里,算不算我们这些人的一份?',
    en: 'He is a Han farmer for whom not even a name was left behind, who caught the tail of the good years under Wen and Jing, but his wife now mutters each time she weighs out salt, "how has it gone dearer again," until the village head reads his name from the roll at the gate (a composite figure, standing for the countless nameless people beneath Emperor Wu\'s golden age, only one of the "so many conscripts levied" in the ledger). This pass puts you with him at night on watch beneath a beacon tower past the passes, pulling his thin clothes tight as he looks at the black steppe to the north, watching the thought he dares not speak rise: in those congratulations of "glorious feats of arms" a thousand li away at court, does any share count for people like us?',
  },
  storyboard: [
    {
      id: 'cp-n1',
