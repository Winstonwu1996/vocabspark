...
export var nebuchadnezzarLens = {
  ...
  icon: '🏛️',
  description: {
    cn: '新巴比伦帝国的王，公元前 605 年到 562 年在位，统治了 43 年，是当时世界上最有权力的人。他不是只会破坏的莽夫，而是巴比伦城的大建设者，修了传说中的城墙、神庙塔和巨大的运河。他懂一件别的征服者不太懂的事：要彻底征服一个民族，光占地收税不够，得断它的根。公元前 586 年，他烧掉了犹太人最神圣的第一圣殿，把他们的精英一批批掳到巴比伦。这一遍让你从征服者内部，看一场「断根」的战略，怎么意外地把对手锤打得更结实。',
    en: 'King of the Neo-Babylonian Empire, reigning from 605 to 562 BCE, for 43 years, the most powerful man in the world of his day. He was no mere destroyer but a great builder of the city of Babylon, raising its legendary walls, temple-towers, and vast canals. He understood something other conquerors did not: to truly conquer a people, taking their land and taxing them is not enough, you must cut their root. In 586 BCE he burned the First Temple, the holiest building of the Jews, and carried their elite away to Babylon in waves. This pass lets you watch, from inside the conqueror, how a strategy of cutting the root accidentally hammered an enemy into something harder.',
  },
  storyboard: [
    {
      id: 'neb-n1',
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '把镜头拉远，看我那套「断根」战略最后的结局。\n\n我公元前 562 年死了。又过了二十几年，公元前 538 年，波斯王居鲁士打垮了我的巴比伦，下令准许那些犹大人回耶路撒冷、重建圣殿。\n\n一部分人回去了，重新立起第二座圣殿。可奇怪的是：很多人没回去。他们在巴比伦已经扎了根，留了下来。从此这个民族就「散」开了——一部分在故土，一部分在巴比伦，后来又散到地中海各地。他们管这叫「离散」。\n\n而正因为他们早在流亡里学会了「靠一本书，不靠一座殿」，散到天涯海角也散不掉。\n\n这条离散的线，拉得比你想象的长。一千八百多年后，在欧洲莱茵河边一座叫 Strasbourg 的城里，还有一个这个民族的女孩，守着同一本书过日子。（你跑过 Black Death 那个 Topic，会认得她。）\n\n我想用一场火让一个民族消失。结果，那场火帮它学会了永远不消失。',
        en: 'Pull the lens back and look at the end of my "cut the root" strategy.\n\nI died in 562 BCE. Some twenty-odd years later, in 538 BCE, the Persian king Cyrus crushed my Babylon and ordered that those people of Judah be allowed to return to Jerusalem and rebuild the Temple.\n\nSome went back and raised a Second Temple. But strangely, many did not return. They had already put down roots in Babylon and stayed. From then on this people was "scattered", some in the homeland, some in Babylon, later spread across the lands of the sea. They call it the diaspora.\n\nAnd precisely because they had learned in exile to rely on a book, not on a building, scattered to the ends of the earth, they could not be scattered away.\n\nThis line of dispersion runs longer than you would think. More than eighteen hundred years later, in a city on the Rhine in Europe called Strasbourg, there was still a girl of this people, living her days by the same book. (Run the Black Death topic and you will recognize her.)\n\nI meant to make a people vanish with one fire. Instead, that fire taught them never to vanish.',
      },
      deliverGoal: 'N7 zoom-out + topic connection — 562 BCE Nebuchadnezzar 死 + 538 BCE 居鲁士灭巴比伦准归回重建圣殿 (一部分回立第二圣殿/很多人留巴比伦扎根) + 离散 diaspora 格局定型 + 因早学会靠书不靠殿散不掉 + 跨 Topic 锚: 1800 多年后 Strasbourg 莱茵河边女孩同一本书 (black-death Devorah) +「我想用火让民族消失结果火教它永不消失」',
...
export var jeremiahLens = {
  ...
  icon: '📜',
  description: {
    cn: '希伯来圣经里的先知，大约公元前 650 年生，活到约公元前 570 年，亲历了犹大王国从动摇到灭国的全过程。先知不是算命的，是站出来替神说真话、对国王和百姓讲他们最不爱听的话的人。在所有人都喊「巴比伦打不进来」的时候，他一个人公开说「灭国要来了，圣殿保不住」。他不主张抵抗到底，而主张认清现实、在流亡中保住信仰。为这些话，他被骂叛徒、被关、被下进枯井。这一遍让你从一个不被同胞接受的人那里，看「说没人想听的真话」要付多大代价，又能救下什么。',
    en: 'A prophet in the Hebrew Bible, born around 650 BCE and living to about 570 BCE, who lived through Judah\'s whole slide from wavering to destruction. A prophet is not a fortune-teller but one who stands up to speak truth for God, telling kings and people what they least want to hear. When everyone was crying "Babylon cannot break in," he alone said openly, "Destruction is coming, the Temple cannot be saved." He did not call for resistance to the last but for facing reality and preserving the faith through exile. For these words he was called a traitor, imprisoned, lowered into a dry well. This pass lets you stand with a man his own people rejected, and see what it costs to speak truth no one wants to hear, and what it can save.',
  },
  storyboard: [
    {
      id: 'jer-n1',
    ...
    },
    {
      ...
      engagementHook: '我活着时是被扔进井里的失败者,可我劝的事救了一个民族。一千多年后又有个 Luther,同样挑战正统、被骂叛徒。说真话的人为什么常常活着时是输家?',
      expectsRealAnswer: false,
    },
    {
      id: 'jer-n8',
...
export var exiledJudeanYouthLens = {
  ...
  icon: '🌊',
  description: {
    cn: '一个被掳到巴比伦河边的犹太少年，是个合成人物，不是真有名有姓的人。他基于希伯来圣经《诗篇》137 篇「我们在巴比伦河边坐下哭泣」那一代被掳者的真实处境而设定，让你能贴着一个具体的人去经历这段历史。设定他公元前 600 年左右生在耶路撒冷，圣殿被烧那年大约 14 岁，跟家人一起被押往一千多公里外的巴比伦。他从小被教「圣殿在，神就在」，可现在圣殿烧了。这一遍让你从那部最强帝国的战略本来没打算让其活下来的人这边，看一个 14 岁的孩子，怎么在异乡的河边重新找到「我们还是我们」。',
    en: 'A Judean youth carried off to the rivers of Babylon, a composite figure, not a named real person. He is built on the real situation of the generation in Psalm 137, "by the rivers of Babylon we sat down and wept," so you can live this history close to one specific person. He is set as born around 600 BCE in Jerusalem, about fourteen the year the Temple burned, marched with his family more than a thousand kilometers to Babylon. He was raised to believe "where the Temple is, God is," and now the Temple is burned. This pass lets you see, from the side of the people the strongest empire\'s strategy never meant to let survive, how a fourteen-year-old, by a river in a foreign land, finds his way back to "we are still us."',
  },
  storyboard: [
    {
      id: 'youth-n1',
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '把镜头往后拉，看我们这代人最后怎么样了。\n\n我们在巴比伦活了下来。不只活下来——我们在油灯下，把信仰写成了书。又过了快五十年，差不多两代人，波斯王居鲁士打败了巴比伦，下令准我们回耶路撒冷、重建圣殿。\n\n一些人回去了，重新立起第二座圣殿。可你猜怎么着？很多人没回去。包括我们这样在巴比伦扎了根、生了孩子的人家。因为我们已经明白了:家是那本书,书在哪儿,家就在哪儿。\n\n从那以后,我们这个民族就「散」在了世界各地——大家管这叫「离散」。可正因为我们早在巴比伦学会了「靠书,不靠一座殿」,散到天涯海角,也散不掉。\n\n这条线拉得很长很长。一千八百多年后,在欧洲莱茵河边一座叫 Strasbourg 的城里,有一个跟我一样大的犹太女孩,叫 Devorah,守着同一本书过日子。(你跑过 Black Death 那个 Topic,会认得她——她和我,是同一条河上,隔了两千年的两个孩子。)',
        en: 'Pull the lens forward and see how our generation ended up.\n\nWe survived in Babylon. More than survived, by the oil lamp we wrote our faith into a book. Nearly fifty years later, about two generations, the Persian king Cyrus defeated Babylon and ordered that we be allowed to return to Jerusalem and rebuild the Temple.\n\nSome went back and raised a Second Temple. But guess what? Many did not return, including families like ours who had put down roots in Babylon and had children. Because we had already understood: home is that book, and where the book is, home is.\n\nFrom then on our people was "scattered" across the lands of the world, what they call the diaspora. Yet precisely because we had learned in Babylon to "rely on a book, not on one building," scattered to the ends of the earth, we could not be scattered away.\n\nThis line runs very, very long. More than eighteen hundred years later, in a city on the Rhine in Europe called Strasbourg, there was a Jewish girl my own age, named Devorah, living her days by the same book. (Run the Black Death topic and you will recognize her, she and I are two children on the same river, two thousand years apart.)',
      },
      deliverGoal: 'N7 zoom-out + topic connection — 我们这代活下来 (不只活/油灯下把信仰写成书) + 快 50 年约两代人后居鲁士败巴比伦准归回重建圣殿 + 一些人回立第二圣殿但很多人没回 (包括扎根生孩子的人家/因明白家是书书在哪家在哪) + 离散 diaspora 格局 + 因早学会靠书不靠殿散不掉 + 跨 Topic 锚: 1800 多年后 Strasbourg 莱茵河边同龄犹太女孩 Devorah 守同一本书 (black-death Topic/她和我同一条河隔两千年两个孩子)',
