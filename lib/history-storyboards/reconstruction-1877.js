...
export var hiramRevelsLens = {
  ...
  icon: '⛪',
  description: {
    cn: '北卡罗来纳人，1827 年生，是个生来就自由的黑人，不曾被奴役。他当过牧师、办过学校、内战时帮着招募黑人士兵。1870 年，密西西比州选他进了联邦参议院，他成了美国历史上第一位非裔参议员——而且他坐的，恰好是当年带头脱离联邦的那个人留下的位子。他走的是温和路线，不喊报复，只想用规则一点点为同胞争权利。这一遍让你从一个孤身闯进白人权力核心的人那里，看一段短暂的高峰，怎么很快被反扑的潮水淹没。',
    en: 'A North Carolina man, born 1827, a Black man born free who was never enslaved. He served as a minister, founded schools, and helped recruit Black soldiers during the war. In 1870 the state of Mississippi sent him into the United States Senate, and he became the first African American senator in American history, taking, as it happened, the very seat once held by a man who had led the move to leave the Union. He walked a moderate road, calling for no revenge, seeking only to win rights for his people, rule by rule. This pass lets you watch, from one man alone inside the core of white power, how a brief peak was soon swallowed by a surging tide of backlash.',
  },
  storyboard: [
    {
      id: 'hr-n1',
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '我不是一个人在战斗，也不是第一个尝到这种苦的人。\n\n比我更早、更有名的，是 Frederick Douglass（弗雷德里克·道格拉斯）。他从奴隶逃出来，靠自己学会读写，成了那个时代最有力量的黑人声音。他比我激烈，也比我坚持得久。可你去看他这一生：一次次满怀希望，一次次被现实泼冷水。废奴成功了，他以为天亮了；重建推进了，他以为路通了；然后 1877 年军队一撤，一切又被打回原形。（你跑过 Douglass 那个 Topic，会认得这条反复受挫的母题。）\n\n这就是那个时代黑人政治领袖共同的命运：他们一次次爬到高处，又一次次被反扑的潮水拍回谷底。\n\n我是参议员，Douglass 是演说家，我们走的路不一样——一个温和，一个激烈。可结局有相似的地方：我们都没能在自己活着的时候，看见那些写在纸上的权利，真正在每一个黑人身上兑现。\n\n我们这一代人做的，更像是替后人，把火种小心地护在手里，没让它彻底熄灭。',
