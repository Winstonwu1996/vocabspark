...
export var andrewJohnsonLens = {
  ...
  icon: '🏛️',
  description: {
    cn: '他是一个赶鸭子上架的总统，林肯昨晚被人开枪打死，他今天上午就在旅馆房间里宣誓接班。他出身南方最底层，恨种植园主一辈子，可现在四百万刚获自由的黑人，命运握在他这个南方白人手里。这一遍让你从他这里看：1865 年底，南方旧势力卷土重来，他手里有总统的否决权和派军队的权力，他是会替黑人踩刹车，还是替自己心里那笔账松开闸门。',
    en: 'He is a president shoved into the seat overnight, Lincoln shot dead the night before, sworn in that very morning in a hotel room. He comes from the deepest bottom of the South and has hated the planters all his life, yet now four million just-freed Black people have their fate in the hands of this southern white man. This pass lets you watch him in late 1865, as the old southern power surges back: he holds the veto and the power to send troops, and you see whether he steps on the brake for Black people, or opens the gate for the ledger in his own heart.',
  },
  storyboard: [
    {
      id: 'aj-n1',
...
export var hiramRevelsLens = {
  ...
  icon: '⛪',
  description: {
    cn: '他是 1870 年 2 月那天站在参议院门口的黑人，里面坐着的全是白人，几个南方议员正在吵「凭什么让一个黑人进来」。他口袋里揣着密西西比的合法选票，他接的恰好是当年带头脱离联邦、保卫奴隶制的那个人留下没干完的参议员任期。这一遍让你从他这里看：屋里所有目光都盯着他，全美国都在用他这一个人判断「黑人到底配不配坐这里」，他要为同胞吼，还是要忍住、用规则一寸一寸去争。',
    en: 'He is the Black man standing at the Senate door that February day in 1870, with a roomful of white men inside and several Southern senators arguing whether he should be let in at all. In his pocket is Mississippi\'s lawful vote, and the term he is filling, by chance, is the unfinished one left by a man who had led the move to leave the Union and defend slavery. This pass lets you watch him as every eye in that chamber fixes on him and all of America judges, through this one man, whether Black people are fit to sit there at all: will he roar for his people, or hold his anger and fight, rule by rule, for one inch at a time.',
  },
  storyboard: [
    {
      id: 'hr-n1',
...
export var freedmanSharecropperLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是 1865 年春天那片棉花地里的人，有人骑着马进来，念了一段他听不太懂的话,,他只听懂了一句：你们自由了（他是一个合成人物，把几百万真实存在、却连名字都没留下的南方黑人，集中到一个人身上）。他活了二十多年，生下来就是账本上跟骡子记在一起的财产，从没想过「自由」两个字会落到自己头上。这一遍让你从他这里看：他脚下还是主人的地，他不识字、没有钱、没有工具，「自由」之后他要往哪儿走，又会被同一双手怎么一点点拽回去。',
    en: 'He is the man in the cotton field in the spring of 1865, when someone rode in and read out words he could not quite follow, except one: you are free (he is a composite person, gathering into one body the millions of real Southern Black people who left no name behind). He has lived more than twenty years, born as a line in the ledger beside the mules, never imagining the word "free" would fall on him. This pass lets you watch him: under his feet is still his old master\'s land, he cannot read, has no money, no tools, and you see where "free" can take him, and how the same hands will pull him back, inch by inch.',
  },
  storyboard: [
    {
      id: 'fs-n1',
