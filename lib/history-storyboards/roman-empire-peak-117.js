...
//   Pax Romana 是真的有道路/法律/公民权扩展, 同时它建在征服 + 约 15%-25%（1/6 到 1/4）意大利人口被奴役之上 —— 两者同体, 不下结论。
//
...
export var enslavedDacianLens = {
  ...
  icon: '⛓️',
  description: {
    cn: '她是一个公元 106 年家乡被烧、母亲再也没见过、自己被锁着押了上千公里卖到罗马一户人家当奴隶的达契亚少女（合成人物，代表那「俘虏数以万计」四个字里一个一个有家有名字的人）。这一遍让你站在她每天从主人家窗口能望见城中心那根新立的大理石功柱的位置，那柱子上从下到上盘的浮雕，刻的正是把她变成奴隶的那场战争。',
    en: 'She is a Dacian girl whose homeland was burned in 106 CE, who never saw her mother again, marched a thousand kilometers in chains and sold to a household in Rome (a composite figure, standing for the people, each with a home and a name, inside the four words "captives by the tens of thousands"). This pass puts you with her at the window of her master\'s house, where she sees the new marble column at the city center; everyone calls it grand, the emperor\'s glory, yet the relief spiraling base to top carves the very war that made her a slave, and her throat tightens every time around the line: that "peace" never included me.',
  },
  storyboard: [
    {
      id: 'ed-n1',
