...
export var trajanLens = {
  ...
  icon: '👑',
  description: {
    cn: '他是一个生在西班牙行省、第一个非意大利本土的罗马皇帝,坐在 117 年罗马版图历史最大的那一年的位置,从不列颠的雾到埃及的沙到两河流域的城,这一大圈土地都在他一个名字下面。这一遍让你坐进他刚下令出征 Dacia 的位置,因为前几任皇帝每年要给那个北方蛮王送钱买和平,他视为奇耻,看他下一秒要不要修起那座横跨多瑙河的大石桥告诉对岸:罗马来了,而且不打算走。',
    en: 'He is the first Roman emperor not born in Italy, raised in a Spanish province, seated in 117 CE in the year the Roman map reached the largest extent in its history, from the fogs of Britain to the sands of Egypt to the cities of Mesopotamia, all that ring of land under his one name. This pass puts you in his seat as he orders the campaign against Dacia, the earlier emperors having paid that northern barbarian king every year to keep quiet, a thing he holds a deep disgrace, and you watch whether he is about to raise the great stone bridge across the Danube that says to the other shore: Rome has come, and does not mean to leave.',
  },
  storyboard: [
    {
      id: 'tr-n1',
...
export var provincialEliteLens = {
  ...
  icon: '⚖️',
  description: {
    cn: '他是一个说拉丁文、穿罗马袍、拜罗马神的西班牙南部小城精英,祖父还是城里讲本地话的地方望族,到他这一代全家拿到了罗马公民权(一个合成人物,代表那一类被罗马一代代收编的行省头面人物)。这一遍让你站在他自己掏腰包在家乡修起一座罗马式剧场、刻着他名字的石碑立在门口的位置,看他用自己的钱亲手把家乡一砖一瓦变得更像罗马,没人逼他、是他自己愿意的,逼你想:当同化是你「自愿」的,它还算被征服吗?',
    en: 'He is a man from a small town in southern Spain who speaks Latin, wears the Roman robe, worships the Roman gods, while his grandfather was still a local notable speaking the local tongue; by his generation the whole family holds Roman citizenship (a composite figure, standing for the class of provincial men of standing Rome co-opted generation by generation). This pass puts you with him as he pays out of his own purse to raise a Roman-style theater in his town, a stone inscribed with his name at the door, with his own money and his own hand turning his hometown brick by brick into something more like Rome; no one held a sword to him, he did it willingly, pressing you to ask: when the assimilation is your own choice, is it still conquest?',
  },
  storyboard: [
    {
      id: 'pe-n1',
...
export var enslavedDacianLens = {
  ...
  icon: '⛓️',
  description: {
    cn: '她是一个公元 106 年家乡被烧、母亲再也没见过、自己被锁着押了上千公里卖到罗马一户人家当奴隶的达契亚少女(一个合成人物,代表那「俘虏数以万计」四个字里一个一个有家有名字的人)。这一遍让你站在她每天从主人家窗口能望见城中心那根新立的大理石功柱的位置,人人都说那柱子气派、是皇帝的荣耀,可那柱子上从下到上盘的浮雕,刻的正是把她变成奴隶的那场战争,看她每次看见喉咙发紧的那句话:那份「和平」,从来不包括我。',
    en: 'She is a Dacian girl whose homeland was burned in 106 CE, who never saw her mother again, who was marched a thousand kilometers in chains and sold to a household in Rome as a slave (a composite figure, standing for one of the people, each with a home and a name, inside the four words "captives by the tens of thousands"). This pass puts you with her at the window of her master\'s house where she can see the new marble column at the city center; everyone calls the column grand, the emperor\'s glory, yet the relief spiraling from base to top carves the very war that made her a slave, and you watch the line her throat tightens around every time she sees it: that "peace" never included me.',
  },
  storyboard: [
    {
      id: 'ed-n1',
