...
export var lenses = {
  'roger-toulouse': {
    ...
    description: '虚构的南法 21 岁二儿子骑士。1095 年 11 月在 Clermont 听 Urban II 喊"Deus vult"，撕红布上肩。25 岁站在耶路撒冷城墙下。这个视角让你从 perpetrator-actor 内部经历"真心相信为上帝流血"的 4 年、实施屠杀的 3 天，和 60 年余生每周做梦。',
  ...
  'aisha-jerusalem': {
    ...
    description: '虚构的 12 岁穆斯林女孩。父亲 Yusuf 是耶路撒冷 Souq al-Qattanin 的棉布商。1099 年 6 月围城前夜，她还在无花果树下问父亲"Frangi 是什么"。这个视角让你从受害方内部经历那 3 天屠城，以及 Roger 这一遍里那条"红头巾"的另一面。',
  ...
  'alexios': {
    ...
    description: '拜占庭皇帝。1056 年生君士坦丁堡老牌军事家族，24 岁政变上位时帝国已经瘸了。1094 年写信向教皇 Urban II 求 3000 专业兵——结果来了 10 万乱军。这个视角让你经历他的 24 年走钢丝：逼 Bohemond 装恭顺、用一封信赢 Nicaea、1099 屠杀消息后两天沉默、62 岁临终对 Anna 说"我开了一扇关不上的门"，以及 86 年后这扇门反过来吃他的城。',
