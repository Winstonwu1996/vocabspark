  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我从来没见过这种规模的城。城墙厚得我一辈子也没见过——三层，外加一条护城河。城里据说住 40 万人——是 Toulouse 的 30 倍。我们的 Raymond 伯爵进城去见拜占庭皇帝 Alexios I（亚历克西奥斯一世，40 岁，从政变上来的将军——他是 1095 年那封给教皇求援信的发信人）。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '那天晚上 Bertrand 在帐篷外吐——他蹲在地上，肩膀抖。我问他："你还相信我们是基督徒吗？"他半天说："我相信我们曾经是。"\n\n' +
...
var aishaJerusalemStoryboard = [
  ...
  },
  {
    ...
    content: {
      cn:
        '现在跳到 88 年后。\n\n' +
        '1187 年 10 月 2 日——一个库尔德人苏丹 Saladin（萨拉丁，50 岁）从十字军手里**重新夺回**耶路撒冷——\n\n' +
      ...
      en:
        ...
        'On October 2, 1187, a Kurdish sultan named Saladin (Salah ad-Din, age 50) **retook** Jerusalem from the Crusaders.\n\n' +
