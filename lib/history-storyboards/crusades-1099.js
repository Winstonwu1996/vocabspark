...
export var lenses = {
  ...
  'alexios': {
    ...
    description: {
      cn: '拜占庭皇帝。1056 年生君士坦丁堡老牌军事家族，24 岁政变上位时帝国已经瘸了。1094 年写信向教皇 Urban II 求 3000 专业兵——结果来了 10 万乱军。从 lonely mediator 内部走他的 24 年钢丝：逼 Bohemond 装恭顺、用一封信赢 Nicaea、1099 屠杀消息后两天沉默、62 岁临终对 Anna 说"我开了一扇关不上的门"，以及 86 年后这扇门反过来吃他的城。',
      en: 'Byzantine emperor. Born 1056 into an old Constantinople military family, he seized the throne by coup at 24 when the empire was already crippled. In 1094 he wrote to Pope Urban II asking for 3,000 professional troops, and got 100,000 unruly Latins instead. The lonely mediator lens on his 24-year tightrope: forcing Bohemond into a feigned homage, winning Nicaea by a single letter, falling silent for two days after the news of the Jerusalem massacre, and telling Anna on his deathbed at 62 that he had opened a door he could not close.',
    },
    // 旧字段 fallback
