  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我妈说，我们这条巷三个家——穆斯林、亚美尼亚教派基督徒、犹太人——三家在这里住了 80 年——我爷爷的爷爷就跟 Sarkis 的爷爷的爷爷一起喝过茶。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我后来才知道是 1.5 万。\n\n' +
        '城里有 Fatimid 王朝（埃及的什叶派穆斯林——1098 年从塞尔柱手里抢回耶路撒冷的）的 1000 守军。城里居民大概 4 万——多数穆斯林，几千犹太人，几千东方基督徒。我们家是穆斯林——Sarkis 家是亚美尼亚教派基督徒——我们这一巷三家住了 80 年了。\n\n' +
  ...
  },
  {
    ...
    content: {
      ...
      en:
        ...
        'That afternoon something occurred to me. The first line of *Surah Al-Fatiha* — the opening chapter of the Quran, seven verses — also says *al-hamdu lillahi rabbil alameen*, "praise be to the Lord of all the worlds." Their prayer also praised the Lord.\n\n' +
        'The same Lord?\n\n' +
        'A different Lord?\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '左边铁匠铺——Sarkis 一家四口——Sarkis、他老婆、Hovsep 11 岁、Hovsep 妹妹 8 岁——都倒在自家炉子边——Hovsep 嘴半张——他临死那刻可能想喊"我们是基督徒——亚美尼亚教派"——但 Frangi 兵没听过这个区分——他们只看你的衣服——亚美尼亚教派的袍子跟穆斯林的袍子在他们眼里一样——他们没分。\n\n' +
  ...
  // ═════ Synthesis（真 Socratic）═════
  {
    ...
    content: {
      cn:
        ...
        '历史学家在这里有两种真实并立的看法——\n\n' +
        '**读法 A——这是"她个人的灾难"**：从 Aisha 的内部看——她爸死了、姨妈死了、邻居 Hovsep 死了——一个家被毁——一个 12 岁的童年被切断——她从此每周做梦——她的人生从这 3 天开始变成"幸存者的人生"。这是属于她的悲剧——具体到一卷红布、一条头巾、一棵无花果树——历史学家用 *micro-history*（微观史学）的方法记录这种个人创伤。\n\n' +
        '**读法 B——这是"文明的撕裂"**：从外面看——1099 年 7 月那 3 天——拉丁基督教第一次撕开了东方基督教 + 穆斯林之间脆弱的共存——80 年来在 Souq al-Qattanin 这条巷里同住的三家——穆斯林（Aisha）+ 亚美尼亚教派基督徒（Hovsep）+ 犹太人（Yakov）——一夜之间成了"不同阵营"——而拉丁兵分不清——他们一律杀。这一波撕裂是**后面 200 年地中海东岸暴力的种子**——历史学家用 *longue durée*（长时段）方法看这种结构性后果。\n\n' +
        '两种读法都有真证据——\n\n' +
        '——Aisha 自己的视角只能感受到 (A)——她不知道 (B) 是什么意思——\n' +
        '——但历史学家从 900 年后看，能看到 (B) 的轮廓——\n' +
        '——可历史学家自己没经历过 (A)——\n\n' +
        '哪一个更"真"？或者两边都真——但你自己读到 Aisha 这一遍，更靠近哪一种感受？想 30 秒答。',
      en:
        ...
        'Which is more "true"? Or are they both true — and which one feels closer to you, after walking through Aisha\'s lens? Take thirty seconds. Your reasoning matters more than the answer.',
    },
    deliverGoal:
      '你刚扮演了 Aisha——12 岁——经历了她家被毁、父亲死、姨妈死、Hovsep 死——' +
      '历史学家对这 3 天有**两种真实并立**的解读：' +
      '**读法 A（micro-history 个人灾难）**：一个家被毁——一个 12 岁童年被切断——这是 Aisha 自己感受到的。' +
      '**读法 B（longue durée 文明撕裂）**：拉丁基督教第一次撕开东方基督教 + 穆斯林共存——后面 200 年暴力的种子。' +
      'Aisha 自己只感受得到 A——历史学家从外面看到 B——哪一个更"真"？',
    engagementHook:
      '**你怎么看**——1099 那 3 天，是 Aisha 的**个人灾难**（一个家被毁），还是**文明撕裂**（80 年共存被一夜撕开 → 后面 200 年的种子）？或者两边都真——你更靠近哪一边？想 30 秒答',
    expectedLength: '200-240 字 + 真问题',
    expectsRealAnswer: true,
  },
  {
    ...
    content: {
      cn:
        ...
        '**(C) 历史回不去**：1187 不是 1099 之前——88 年里 Souq al-Qattanin 那条巷子早换了 5 茬居民——Sarkis 一家、Yakov 一家都死了不会回来——原来的"三家共住"那个世界本身——已经死了——Saladin 重夺只能让"地"回到穆斯林手里——但回不到那个"巷"里。\n\n' +
        '哪一种"回不去"是最深的？想 30 秒答。',
      en:
        ...
        '**(C) They cannot return historically.** 1187 is not the year before 1099. In those 88 years, the Souq al-Qattanin alley had changed inhabitants five times. Sarkis\'s family, Yakov\'s family — they were dead, they would not be coming back. The world of "three houses living together" — that world itself was dead. Saladin\'s retaking could put the *land* back in Muslim hands. But it could not put the *alley* back the way it was.\n\n' +
    ...
    deliverGoal:
      ...
      '——哪一种"回不去"最深？',
    engagementHook:
      '**你怎么看**——Aisha 一家 88 年后没回耶路撒冷——是物理（家毁了）、心理（创伤）、还是历史（那个世界本身死了）回不去最深？想 30 秒答',
    expectedLength: '200-240 字 + 真问题',
    expectsRealAnswer: true,
  },
  // ═════ Meta（反思 + 桥）═════
...
var alexiosStoryboard = [
  {
    ...
    content: {
      cn:
        ...
        '我开头三行是这样的：来自上帝任命的罗马人皇帝（*Imperator Romanorum*——这是我们对自己的称呼，因为我们是真正东罗马的延续）——给罗马教皇——基督在东方的兄弟们正在受苦。\n\n' +
        ...
        '我是 Alexios I Komnenos，*basileus*（巴塞勒斯——希腊语"皇帝"）。接下来 12 节，你跟我走 24 年——从这盏油灯下的夜里，到我 1118 年闭眼的那一刻——再到我闭眼之后 86 年发生的事。',
      en:
        ...
        'My first three lines: From the Emperor of the Romans appointed by God (*Imperator Romanorum* — this is what we called ourselves, because we are the true continuation of the Eastern Roman Empire) — to the Bishop of Rome — the brothers of Christ in the East are suffering.\n\n' +
        ...
        'I am Alexios I Komnenos, *basileus* (the Greek word for emperor). Over the next twelve sections you will walk with me for twenty-four years — from this lamplit desk to the day I closed my eyes in 1118 — and then to what happened eighty-six years after I closed them.',
    },
    deliverGoal: '[fallback]',
  ...
  },
  {
    ...
    content: {
      ...
      en:
        ...
        'That afternoon a letter arrived from the Seljuks, sharply polite: "Your Christian friends are lying on the plain at Civetot. Would you like to send men to collect the bodies?"\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '但是有一个人我从一开始就特别**怕看见**——\n\n' +
        '**Bohemond of Taranto**——意大利南部诺曼公爵的儿子——42 岁——他爸 Robert Guiscard **15 年前**（1081 年）在巴尔干 Dyrrachium 战役**亲手打败过我**——俘虏了我几十员大将——我一辈子记得 Bohemond 那张脸——他爸那年没杀他要他在前面带骑兵——他亲手刺过我两个亲信。\n\n' +
        ...
        '我让他宣誓——他举右手——念完所有句子——签字——按我的指环印——红蜡封印（我们叫 *bulla*——金属或蜡封印模——我的印章是双头鹰加十字）。\n\n' +
      ...
      en:
        ...
        '**Bohemond of Taranto.** Son of a Norman duke from southern Italy. Forty-two years old. His father Robert Guiscard, fifteen years earlier in 1081, had personally defeated me at the Battle of Dyrrachium in the Balkans, captured several of my senior officers, and made me run. I have never forgotten Bohemond\'s face. His father had put him in the front cavalry that day. He had personally killed two of my friends.\n\n' +
        ...
        'I had him swear. He raised his right hand, recited the words, signed, and pressed my ring into red wax (we called it a *bulla* — metal or wax seal, mine was a double-headed eagle with a cross).\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我做了一件十字军不知道的事。\n\n' +
        '5 月底我派了一个特使——**Manuel Boutoumites**——他是 *megas doux*（海军大将）——他乘小船从湖面进 Nicaea 城——直接见塞尔柱守城官 Kilij Arslan 的母亲（这位苏丹本人正在小亚细亚东部跟另一个突厥派打仗，没在城里）——\n\n' +
        '我让 Manuel 传一句话：\n\n' +
        ...
        '我做的是按拜占庭传统——**没屠城**——城里塞尔柱守军和家属被礼仪送出（5000 人换了身衣服，给一笔安顿金，送往内陆）——城内基督徒（拜占庭旧居民）解放——清真寺重新做回教堂——这套流程拜占庭做了 700 年，我们叫它 *eutaxia*——"良序接管"。\n\n' +
      ...
      en:
        ...
        'In late May I sent a special envoy — **Manuel Boutoumites**, my *megas doux* (grand admiral). He took a small boat across the lake into Nicaea and went directly to the mother of the Seljuk sultan (Sultan Kilij Arslan himself was off in eastern Anatolia fighting another Turkish faction, not in the city).\n\n' +
        ...
        'What I did followed Byzantine tradition — **no massacre**. The Seljuk garrison and their families were marched out under formal escort (five thousand of them, given new clothes and a small settlement payment, sent inland). Byzantine Christians who had lived under Seljuk rule were freed. The mosque was reconverted into a church. This procedure Byzantium had run for seven centuries — we called it *eutaxia*, "orderly transfer."\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        'Stephen 见我——脸色发白——满身泥——他说："*basileus*——Antioch 完了——所有人都死了——昨晚十字军主营地里说塞尔柱苏丹 Kerbogha 带 7 万援军围他们——他们撑不到一周。"\n\n' +
      ...
      en:
        ...
        'Stephen came before me, pale, covered in mud. He said: "*Basileus* — Antioch is finished. They are all dead. Last night the camp was saying the Seljuk sultan Kerbogha is bringing seventy thousand reinforcements. The crusaders cannot last a week."\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '**他们错杀了**。\n\n' +
        '拉丁兵分不清亚美尼亚教派和穆斯林——他们看不懂希腊语——他们看一眼黑头发深皮肤的人就劈下去——耶路撒冷的东方基督徒——是**我管辖下**的牧民——他们一直在拜占庭东方教会传统下生活——他们死在所谓"拯救基督教兄弟"的拉丁人剑下——\n\n' +
        '我把报告放在桌上。\n\n' +
        '我没有说话——这一点我必须告诉你——我**沉默了两天**。\n\n' +
        '第二天我宫廷里的人开始问："*basileus*——你要发布声明吗？要谴责吗？要召大主教 Nicholas 来共商吗？"\n\n' +
        '我没回答。\n\n' +
        ...
        '我那天没有答案——我今天也没有。\n\n' +
        '8 月底我私下对我女儿 Anna（那年 16 岁，她长大后会用 30 年时间写下《Alexiad》15 卷——今天我们读到的拜占庭最详尽的史料）说了一句话。我不知道她那天有没有真的记下来。但我那一刻对她说的，是这一句——\n\n' +
      ...
      en:
        ...
        'On the second day my court began to ask: "*Basileus* — do you wish to issue a statement? A condemnation? Should we summon Patriarch Nicholas?"\n\n' +
        'I did not answer.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我女儿 Anna 35 岁——她从早上起一直坐在我床边——她手里拿着记录本（她从 16 岁那年开始记我说的话——她是我所有孩子里读书最多的——她知道父亲做的事——比我知道她还多）。\n\n' +
        ...
        '十字军在君士坦丁堡 3 天——抢、烧、屠（虽然规模比 1099 耶路撒冷小，但同样是基督徒打基督徒）——他们抢光了 Hagia Sophia 大教堂里的金器——他们在 Anna Komnene 写完《Alexiad》的同一座 Kecharitomene 修道院里强奸了 17 个修女——他们把君士坦丁堡的青铜马（来自古希腊）拆下来运回威尼斯（今天还在威尼斯圣马可大教堂的屋顶上）——\n\n' +
      ...
      en:
        ...
        'My daughter Anna was thirty-five. She had been sitting beside the bed since morning. She held her notebook (she had begun, at sixteen, to write down what I said. She had read more than any of my children. She knew what her father had done — better than I knew her).\n\n' +
        ...
        'The crusaders held the city for three days. They looted, burned, and killed (smaller in scale than 1099 Jerusalem, but again Christians killing Christians). They stripped the gold vessels of *Hagia Sophia*. In the very same Kecharitomene monastery where Anna Komnene would later write the *Alexiad*, they raped seventeen nuns. They removed the bronze horses of Constantinople (originally Greek antiquities) and shipped them back to Venice — where they still stand today on the roof of St. Mark\'s Basilica.\n\n' +
  ...
  // ═════ Synthesis（真 Socratic）═════
  {
    ...
    content: {
      cn:
        ...
        '**读法 A — 拜占庭学派 / Anna Komnene 传统（《Alexiad》12 世纪 + 现代 Byzantine studies 多数派）**：Alexios 那一刻面对的现实：塞尔柱占了 80% 小亚细亚——拜占庭兵不够——求外援是合理的——结果他**实际拿回了 Nicaea + 部分 Anatolia + 维持了帝国 100 年**——他**做对了**。1204 年是后人（包括他孙子 Manuel I 跟威尼斯吵架的那些事）累积的错——不能赖在他 1094 那封信头上。这是政治家**正确的近期决策被遥远的不可控未来污染**——但他**1094 年那一刻**做的是**对的**。\n\n' +
        '**读法 B — 当代去神话化派（Christopher Tyerman / John Norwich《A Short History of Byzantium》）**：Alexios 是个一流的近期政治家——但他**忽略了制度的不对称性**——他求的是"拜占庭传统 = 几千雇佣兵"——他没意识到"拉丁世界传统 = 教皇可以越过国王召集 10 万人"——他不懂西方那个体系——他用拜占庭逻辑去拉一根西方的绳，绳子是他不熟悉的——这种**对外部体系结构的误判** = 政治家的判断失误。1204 不是巧合——是 1094 的种子按拉丁教权-王权那套机制长出来的果。Alexios 那封信不是"高招"——是"误以为自己懂西方"的写照。\n\n' +
        '两种读法都站得住——读法 A 走"近期可控范围内决策正确"看，读法 B 走"对外部体系结构判断"看。\n\n' +
        '你怎么看？Alexios 1094 那封信——更靠近读法 A（高超政治智慧）还是读法 B（历史最大判断失误）？想 30 秒答——你的论证比结论重要。',
      en:
        ...
        '**Reading B — the contemporary demystifying school (Christopher Tyerman, John Norwich *A Short History of Byzantium*):** Alexios was a first-class short-range politician. But he **failed to read the asymmetry of institutions**. He requested help on Byzantine terms — "a few thousand mercenaries." He did not realize the Latin tradition, where the pope could go around kings and mobilize 100,000 men, was a different machine entirely. He did not understand the Western system. He pulled on a Western rope using Byzantine logic, not knowing what was tied to the other end. **This kind of misjudgment of an external system\'s structure is exactly a political failure.** 1204 was not a coincidence. It was the seed of 1094 growing through the mechanics of Latin church-state politics. Alexios\'s letter was not a brilliant move — it was the portrait of a man who thought he understood the West, and did not.\n\n' +
        ...
        'What do you think? Was the 1094 letter closer to Reading A (high political intelligence) or Reading B (largest misjudgment in history)? Take thirty seconds. Your reasoning matters more than your conclusion.',
    },
    deliverGoal:
      '你扮演了 Alexios 8 节——一个写信求兵 + 闭眼时已经感觉到自己引来力量会毁城的皇帝。' +
      '历史学界对那封 1094 年信**两极分化**：' +
      '**读法 A（Byzantinist 传统）**：近期决策正确——他实际拿回 Nicaea + 维持帝国 100 年——1204 不能赖在他头上。' +
      '**读法 B（Tyerman 去神话化派）**：他不懂西方教权-王权那套——拉了一根他不熟悉的绳——这是政治家结构性误判。' +
      '——你怎么看，Alexios 那封信是高智慧还是大失误？',
    engagementHook:
      '**你怎么看**——Alexios 1094 那封信，是高超政治智慧还是历史最大判断失误？没有标准答案——给你的理由说服我。想 30 秒答',
    expectedLength: '200-240 字 + 真问题',
    expectsRealAnswer: true,
  },
  {
    ...
    content: {
      cn:
        ...
        '1099 年 7 月底——耶路撒冷屠杀消息传到 Alexios——他**沉默了两天**——然后**没公开谴责**。他知道这些"基督徒兄弟"屠了穆斯林、犹太人——还**错杀了拜占庭管辖下的东方基督徒**——但他**没说话**。他在私人日记上写："我把他们引进东方——他们干了我永远不会干的事——但我没有公开谴责。"\n\n' +
        ...
        '**读法 A — 政治现实主义（Byzantine Realpolitik 学派 / Henry Kissinger 风格的国际关系阅读）**：政治家不是道德家——他的责任是国家生存——Alexios 沉默换来的是：① 拜占庭和拉丁国家不公开决裂 ② 塞尔柱被牵制在南线 ③ 他可以集中精力收复北线小亚细亚——**这三件 + 一句"我反对"——你选哪个？**——选了"我反对"——你 8 个月后丢君士坦丁堡——你子孙后代连写《Alexiad》的机会都没有。沉默是**对帝国负责**。\n\n' +
        '**读法 B — 道德底线派（现代人权传统 / Hannah Arendt "the banality of evil" 框架反向阅读）**：政治家**永远不能用"国家利益"洗白沉默**。沉默 = 默许 = 同谋。Alexios 自己日记写"他们干了我永远不会干的事"——他自己知道这是错的——但他选了不说——这不是"政治智慧"——是**用自己的沉默向暴行换政治资本**。如果他公开谴责——可能损失 10% 政治杠杆——但他保留了一件政治家最难保留的东西——**自己的人格**。50 年后写他历史的人——会写"沉默的皇帝"——这个名字比"Antioch 的得失"重得多。\n\n' +
        '两种读法都站得住——读法 A 是**国家责任**优先，读法 B 是**人性底线**优先。\n\n' +
        '你怎么看？Alexios 那两天的沉默——更靠近读法 A（政治家的隐忍）还是读法 B（道德上的同谋）？想 30 秒答。\n\n' +
      ...
      en:
        ...
        'Late July 1099. The news of the Jerusalem massacre reaches Alexios. He is silent for two days. He does not condemn. He knows these "Christian brothers" massacred Muslims, Jews — and **also killed Eastern Christians under his own jurisdiction by mistake**. But he says nothing publicly. He writes in his private journal: "I brought them into the East. They did what I would never do. And I did not condemn it."\n\n' +
    ...
    deliverGoal:
      ...
      '**读法 A（政治现实主义）**：他责任是国家生存——沉默换来 3 件实质好处 vs 一句"我反对"——选哪个？' +
      '**读法 B（道德底线派）**：他自己日记承认是错——选了不说 = 同谋——他用沉默换政治资本——50 年后历史会记住"沉默的皇帝"。' +
      '——这个问题超出 11 世纪——任何时代任何政治家在"盟友暴行"前都要回答',
    engagementHook:
      '**你怎么看**——Alexios 那两天沉默，是政治家的隐忍还是道德上的同谋？想 30 秒答',
  ...
  // ═════ Meta（反思 + 桥）═════
  {
    ...
    content: {
      cn:
        ...
        '是 1099 年 7 月底耶路撒冷屠杀消息到——他**沉默两天**——他自己日记写"他们干了我永远不会干的事"但他没公开谴责？\n\n' +
      ...
      en:
        ...
        'Was it the late July of 1099, the silence of two days, the journal line "they did what I would never do" — but he did not say it publicly?\n\n' +
