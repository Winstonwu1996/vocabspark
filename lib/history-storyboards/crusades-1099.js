...
var rogerToulouseStoryboard = [
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '接下来从 Maarat 到耶路撒冷还有 6 个月。1099 年春天我们慢慢南下，沿黎巴嫩海岸经过 Tripoli（的黎波里）、海法、Caesarea、Jaffa。各地阿拉伯城镇看见我们这群人——衣衫破烂，眼神空洞，带着 Maarat 那个谣言——他们直接付钱让我们绕路走。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '6 月 7 日我们到城外。城里 1000 守军（Fatimid 王朝是埃及的什叶派，1098 年刚从塞尔柱手里抢回耶路撒冷）。城里居民大概 4 万——大多数穆斯林，加几千犹太人，几千东方基督徒（亚美尼亚正教、希腊正教派、叙利亚教派，这些教派跟拉丁教派不一样，但都是基督徒）。\n\n' +
        ...
        '7 月 8 日早上，6 点，我们 1.5 万人——剩下还活着的那些——赤脚开始走。我那天脚底烫到起泡，但我没想停。我边走边念 *Pater Noster*（"我们的父"，拉丁文主祷文）。Bertrand 走在我旁边，他在哭。我没问他为什么。可能他想到 Pierre，可能想到 Maarat，可能他自己也不知道。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '7 月 15 日中午，我跟 Bertrand 翻进南门。我手里那柄诺曼长剑——我爸 1080 年代用过的那柄——已经磨过 3 次。我那天用它做的事，我用 4 年时间想过该不该写出来——但这一遍我必须直接告诉你，否则我就在骗你。\n\n' +
        ...
        'Bertrand 那 3 天没怎么动手。他跟在我后面。第二天晚上他坐在 Solomon 圣殿台阶上——我们的修士 Raymond of Aguilers 后来借《启示录》里的话形容那天：血没到马勒（这是《启示录》14:20 里"血流到马勒"的末世意象，是一句宗教净化的修辞，不是真去量血有多深）——Bertrand 跟我说："Roger，我以为我们到这里之后会感觉到什么。"\n\n' +
        '我说："我也以为。"\n\n' +
        '7 月 17 日傍晚，城里大概不会再有活的穆斯林了。我们去 Synagogue（犹太会堂）——里面藏着的犹太人不愿出来——我们放火烧了——里面的人全部烧死。亚美尼亚基督徒邻居死了，因为我们的拉丁兵分不清亚美尼亚正教和穆斯林。\n\n' +
        '现代历史学家估算，那 3 天死了 3000 到 10000 人。当时我们的修士写的是"血没到马勒"——那是借《启示录》的末世修辞，不是字面的测量。Ibn al-Athir（一位 13 世纪的阿拉伯历史学家）后来记 7 万——现代学界认为偏高。但你要是问我那 3 天的耶路撒冷有多少血——3000 还是 10000 还是 70000，对一个曾经在那里的人不重要。',
      en:
        ...
        'Bertrand did not strike many that day. He followed me. The second evening he sat on the steps of the Temple of Solomon — our chronicler Raymond of Aguilers later reached for the words of Revelation to describe that day: blood up to the horses\' bridles (this is the apocalyptic image from Revelation 14:20, a phrase of religious purification, not a literal measure of how deep the blood ran) — and Bertrand said: "Roger, I thought we would feel something when we reached this place."\n\n' +
        'I said: "So did I."\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '这是这种多视角学法的核心：Roger 1099 年觉得自己在做对的事。900 年后我们读他的故事知道他做的不是对的事。但这两件事都是真的——他真心相信，他做了，我们今天读懂了，我们没法假装他没做。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '楼上传来我爸的脚步声。他在搬什么，可能他想堵住门，可能他在收钱，可能他只是想让自己有事做。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '杀 Khadija 的那个人，可能就是 7 月 14 日翻进我家铺子杀我爸那批人里的某一个。他可能从这棵树下走过的时候，只看到了一条红头巾。他没看到我的姨妈，他没看到 Fatima 表妹，他没看到这条头巾是我去年织的——\n\n' +
        '——但我看到了。',
      en:
        'In the Souq —\n\n' +
...
var alexiosStoryboard = [
  {
    ...
    content: {
      cn:
'（先说清楚：史实是 1095 年 3 月，我派了一个使团到意大利 Piacenza 的教廷会议，当面口头求援——不是一封亲笔信。下面这一段，是这一遍让你走进我求援那一刻的处境，把那次求援演成第一人称的场景。）\n\n' +
        '1094-95 年那个冬天，君士坦丁堡 Blachernae 宫。我 38 岁。\n\n' +
        '窗外是博斯普鲁斯海峡的黑水。我心里反复推敲那条要送往 1500 公里外罗马的口信——给教皇 Urban II。\n\n' +
        '开头的意思是这样的：来自上帝任命的罗马人皇帝（这是我们对自己的称呼——我们是真正东罗马的延续）——给罗马教皇——基督在东方的兄弟们正在受苦。\n\n' +
        '然后是我真正想要的：**几千个专业兵**。我付钱。一年期。任务是帮我从塞尔柱手里收复小亚细亚——那是我的农田、我的兵源地、我从小长大的地方。\n\n' +
        '我反复叮嘱使团强调一句：**只要专业军人**——*milites*——不要平民，不要修士，不要朝圣的农民。\n\n' +
        '我那一刻以为自己在做一件聪明事。我用别人的力量解决我自己的问题——这是高级政治家的算盘。\n\n' +
        '我那一刻不知道——几个月后这条求援被 Urban II 放大、念给 Clermont 城外两千人听的时候，"几千专业军"会变成"全欧洲的基督徒都来"。\n\n' +
        '我是 Alexios I Komnenos，拜占庭皇帝。接下来 12 节，你跟我走 24 年——从这盏油灯下的夜里，到我 1118 年闭眼的那一刻——再到我闭眼之后 86 年发生的事。',
      en:
'(First, to be clear: the historical fact is that in March 1095 I sent an embassy to the Church council at Piacenza in Italy, asking for help out loud, in person — not a private letter in my own hand. What follows is this lens letting you step into the moment of that appeal, staging it as a first-person scene.)\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '我那次求援 1095 年 3 月送到 Piacenza 的教廷会议。8 个月后 Urban II 在 Clermont 演说。这些事我都不知道——拜占庭和拉丁世界中间隔着两个月的传递。\n\n' +
      ...
      en:
        'My appeal reached the Church council at Piacenza in March 1095. Eight months later Urban II preached at Clermont. None of that did I see in real time — between Byzantium and the Latin world there was always a two-month delay.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        'Hugh of Vermandois——法王 Philip 的亲弟弟，11 月先到，1000 人，容易：他海上遇风暴丢了大部分人和钱，到我面前已经是落汤鸡，给他换了袍子住了几天，宣誓签字。\n\n' +
        'Godfrey of Bouillon——4 万人，12 月到，驻在城墙外金角湾对岸。他不肯宣誓，说"我对的只是上帝"，我下令封锁他的食物供应。4 月他撑不住，宣誓签字。\n\n' +
      ...
      en:
        ...
        'I wore the purple robe. I sat on the gold *throne* (we called it the Throne of Solomon, modeled on the biblical king). Bronze lions on either side mechanically roared, eleventh-century engineering only Constantinople could build. My Varangian Guard — my personal troops, fair-haired Northmen, who could not understand a word of Greek or Latin but whose eyes made you speak carefully — twelve on each side.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我那两天心里反复转的话——我没写下来，也没说出口——但这个视角让你听见一个皇帝沉默时脑子里在转什么——\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我看着 Anna——我说了几句话——\n\n' +
        '我具体说了什么，《Alexiad》没有完整记下来（Anna 第 15 卷开头写的是我跟 Bohemond 后期的政治角力总结，不是我临终的话）。这一段是这一遍让你听见——一个皇帝最后那几分钟脑子里到底在转什么——\n\n' +
        ...
        '十字军在君士坦丁堡 3 天，抢、烧、屠（虽然规模比 1099 耶路撒冷小，但同样是基督徒打基督徒）。他们抢光了 Hagia Sophia 大教堂里的金器；拉丁兵冲进 Kecharitomene 修道院（也就是 Anna Komnene 后来写完《Alexiad》那一座）强奸修女；他们把君士坦丁堡的青铜马（来自古希腊）拆下来运回威尼斯（今天还在威尼斯圣马可大教堂的屋顶上）。\n\n' +
      ...
      en:
        ...
        'The crusaders held the city for three days. They looted, burned, and killed (smaller in scale than 1099 Jerusalem, but again Christians killing Christians). They stripped the gold vessels of *Hagia Sophia*. Latin soldiers broke into the Kecharitomene monastery (the very monastery where Anna Komnene would later write the *Alexiad*) and raped nuns there. They removed the bronze horses of Constantinople (originally Greek antiquities) and shipped them back to Venice — where they still stand today on the roof of St. Mark\'s Basilica.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '1099 年 7 月底，耶路撒冷屠杀消息传到 Alexios。他**沉默了两天**，然后**没公开谴责**。他知道这些"基督徒兄弟"屠了穆斯林、犹太人，还**错杀了拜占庭管辖下的东方基督徒**——但他**没说话**。这一段是这一遍让你听见——一个皇帝沉默时反复转的话。他没写下来，也没说出口，但他自己知道："我把他们引进东方，他们干了我永远不会干的事，但我没有公开谴责。"\n\n' +
  ...
  // ═════ Meta（反思 + 桥）═════
  {
    ...
    content: {
      cn:
        ...
        '说一句话告诉我。\n\n' +
        '然后——你可以选：(1) 进 mastery 通关；或者 (2) 换视角重玩。同一个 1099，不同视角，可能是 Roger（你已经走过的拉丁骑士），可能是 Aisha（耶路撒冷穆斯林女孩）。同一事件不同角度，会发现新东西。',
      en:
...
export var lenses = {
  'roger-toulouse': {
    ...
    description: {
      cn: '虚构的南法 21 岁二儿子骑士。1095 年 11 月在 Clermont 听 Urban II 喊"Deus vult"，撕红布上肩。25 岁站在耶路撒冷城墙下。从 perpetrator-actor 内部经历"真心相信为上帝流血"的 4 年、实施屠杀的 3 天，和 60 年余生每周做梦。',
      en: 'A fictional 21-year-old second son knight from southern France, raised on a small fief outside Toulouse. In November 1095 he heard Pope Urban II shout "Deus vult" at Clermont and tore a red cross of cloth onto his shoulder. At 25 he stood under the walls of Jerusalem. The perpetrator-actor lens on 4 years of believing he bled for God, the 3-day massacre he carried out, and 60 years of weekly nightmares afterward.',
    },
    // 旧字段 fallback
    nameCn: '罗杰（虚构十字军骑士）',
  ...
  'aisha-jerusalem': {
    ...
    description: {
      cn: '虚构的 12 岁穆斯林女孩。父亲 Yusuf 是耶路撒冷 Souq al-Qattanin 的棉布商。1099 年 6 月围城前夜，她还在无花果树下问父亲"Frangi 是什么"。从受害方内部经历那 3 天屠城，以及 Roger 这一遍里那条"红头巾"的另一面。',
      en: 'A fictional 12-year-old Muslim girl in Jerusalem. Her father Yusuf sells cotton at the Souq al-Qattanin. On the eve of the siege in June 1099 she was still asking him under the fig tree what a Frangi was. The receiving-end lens on the 3-day sack of the city, and the other side of the red headscarf that appears in Roger\'s lens.',
    },
    // 旧字段 fallback
  ...
  'alexios': {
    ...
    description: {
      cn: '拜占庭皇帝。1056 年生君士坦丁堡老牌军事家族，24 岁政变上位时帝国已经瘸了。1095 年派使团向教皇 Urban II 求几千专业兵，结果来了 10 万乱军。从 lonely mediator 内部走他的 24 年钢丝：逼 Bohemond 装恭顺、用一封信赢 Nicaea、1099 屠杀消息后两天沉默、62 岁临终对 Anna 说"我开了一扇关不上的门"，以及 86 年后这扇门反过来吃他的城。',
      en: 'Byzantine emperor. Born 1056 into an old Constantinople military family, he seized the throne by coup at 24 when the empire was already crippled. In 1095 he sent an embassy to Pope Urban II asking for a few thousand professional troops, and got 100,000 unruly Latins instead. The lonely mediator lens on his 24-year tightrope: forcing Bohemond into a feigned homage, winning Nicaea by a single letter, falling silent for two days after the news of the Jerusalem massacre, and telling Anna on his deathbed at 62 that he had opened a door he could not close.',
    },
    // 旧字段 fallback
