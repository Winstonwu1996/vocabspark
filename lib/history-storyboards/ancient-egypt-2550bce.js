...
export var khufuLens = {
  ...
  icon: '👑',
  description: {
    cn: '埃及第四王朝的法老，希腊人后来叫他 Cheops。约公元前 2550 年，他做了一件人类历史上没人做过的事：动用一整个国家，给自己造一座 146 米高、约 230 万块石头的山。在他自己眼里，他不是凡人国王，是活着的神，这座山是他死后变成永生之神的升天机器。讽刺的是，建了世界最大坟墓的他，后世只留下一尊 7.5 厘米高的小象牙像，比一根手指还小。这一遍让你从神王内部，看一个人怎么用整个国家去换永生。',
    en: 'A pharaoh of Egypt\'s Fourth Dynasty, later called Cheops by the Greeks. Around 2550 BCE he did something no one in human history had done: he turned an entire country to building himself a mountain, 146 meters high, of some 2.3 million stones. In his own eyes he was not a mortal king but a living god, and this mountain was the machine that would lift him into an eternal god after death. The irony: the man who built the largest tomb on earth left behind only one confirmed likeness, an ivory figure 7.5 centimeters tall, smaller than a finger. This pass lets you watch, from inside a god-king, how a man spends a whole country to buy eternity.',
  },
  storyboard: [
    {
      id: 'khufu-n1',
...
export var hemiunuLens = {
  ...
  icon: '📐',
  description: {
    cn: '法老 Khufu 的侄子，维西尔（vizier），头衔里最关键的一个是「王室一切工程总监」。直白说，大金字塔这个史上最大工程，组织和执行的总负责人就是他。他夹在中间：上面是要变成神、要在有生之年建完整座山的神王，下面是几万个会饿、会累、会被石头砸伤、会死的真人。法老下命令只要一句话，把这句话变成几万人几十年的吃饭、运石、治伤、安葬，是他的活。他在自己的大墓里留下一尊胖子坐像。这一遍让你从组织者的位置，看一个人怎么把神的意志，扛在自己肩上变成现实。',
    en: 'A nephew of Pharaoh Khufu, a vizier, whose most important title was "Overseer of All the King\'s Works." Plainly: the man in overall charge of organizing and carrying out the largest building project in history was him. He stood in the middle: above, a god-king who meant to become a god and finish the whole mountain within his lifetime; below, tens of thousands of real people who hungered, tired, were crushed by stone, and died. The pharaoh\'s order took one word; turning that word into the food, stone-hauling, wound-tending, and burials of tens of thousands over decades was his job. He left a seated statue of himself, a heavy man, in his own great tomb. This pass puts you in the organizer\'s seat, watching one man carry a god\'s will on his shoulders and make it real.',
  },
  storyboard: [
    {
      id: 'hem-n1',
...
export var pyramidLaborerLens = {
  ...
  icon: '⛏️',
  description: {
    cn: '这一遍的「我」，是用真实考古证据拼出来的一个代表性劳工，不是某一个有名有姓的真人。古王国一个普通农民，平时在尼罗河边种地，每年泛滥季田被淹、种不了地，就被国家征召去搬石头。他不是好莱坞电影里被鞭子抽的外族奴隶，那是个被现代考古推翻的误解。真相是：他是本地埃及人，被编进有名字的工班，吃国家发的面包、啤酒、牛肉和鱼，受了伤有人治，死了葬在金字塔脚下。但这活儿照样苦、照样危险、照样不是他自己能选的。这一遍，你从这座山最底下、几乎没留下名字的人这边，看它是怎么被一块块垒起来的。',
    en: 'The "I" in this pass is a representative laborer pieced together from real archaeological evidence, not one named, specific person. An ordinary farmer of the Old Kingdom, who tilled the land by the Nile, and each flood season, when his fields drowned and could not be worked, was summoned by the state to haul stone. He is not the whip-driven foreign slave of Hollywood films; that is a misconception modern archaeology has overturned. The truth: he was a native Egyptian, formed into a named work gang, fed bread, beer, beef, and fish issued by the state, his wounds tended, and, in death, buried at the foot of the pyramid. Yet the work was still grueling, still dangerous, still not his to choose. This pass lets you see, from the side of the people at the very bottom of this mountain who left almost no name, how it was stacked up stone by stone.',
  },
  storyboard: [
    {
      id: 'lab-n1',
