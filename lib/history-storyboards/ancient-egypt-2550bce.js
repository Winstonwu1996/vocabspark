...
export var khufuLens = {
  ...
  description: {
    ...
    en: 'A pharaoh of Egypt\'s Fourth Dynasty, later called Cheops by the Greeks. Around 2550 BCE he did something no one in human history had done: he turned an entire country to building himself a mountain, 146 meters high, of some 2.3 million stones. In his own eyes he was not a mortal king but a living god, and this mountain was the machine that would lift him into an eternal god after death. The irony: the man who built the largest tomb on earth left behind only one largely-intact likeness that can be confirmed as him, an ivory figure 7.5 centimeters tall, smaller than a finger. This pass lets you watch, from inside a god-king, how a man spends a whole country to buy eternity.',
  },
  storyboard: [
    {
      id: 'khufu-n1',
