...
export var mumBettLens = {
  ...
  icon: '🔥',
  description: {
    cn: '真实历史人物,约 1744 年生在纽约州一个荷兰人家,没有姓,大人叫她 Bett,后来被卖到马萨诸塞 Sheffield 的 Ashley 家。在那家的账本上她不是人,是一笔财产,跟牲口记在一起。手臂上一道从手肘到手腕的烫疤,她从不拿袖子盖。1780 年她听见「所有人生而自由平等」,1781 年去打官司,把自己从财产变回一个完整的人。这一遍,你从宪法没打算算进去的人这边,看 1787 年的费城。',
    en: 'A real historical person, born around 1744 to a Dutch household in New York, with no surname, called Bett, later sold to the Ashley family in Sheffield, Massachusetts. In that family\'s ledger she was not a person but a piece of property, recorded alongside the livestock. A burn scar ran from elbow to wrist, and she never covered it with her sleeve. In 1780 she heard the words "all men are born free and equal," and in 1781 she went to court and turned herself from property back into a whole person. This pass lets you see Philadelphia in 1787 from the side of the people that Constitution never planned to count in.',
  },
  storyboard: [
    {
      id: 'mb-n1',
