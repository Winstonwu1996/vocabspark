...
//
// defaultLens = 'qin-shi-huang' (例外: 中国 topic 学生自带「暴君」先验, 默认进权力方视角先听成就再被代价复杂化,
//   才能挑战先验; 「受影响者优先」通则不适用于 prior-loaded 中国 topic — 创始人 2026-05-24 拍板。
//   qsh-n11 已补 default-lens-stands-alone 跨视角指针; 戍卒(受苦)与李斯仍是加深 lens)
//
...
export var qinShiHuangLens = {
  ...
  icon: '👑',
  description: {
    cn: '他是一个刚刚 39 岁就把打了五百多年的天下打完的秦王,站在咸阳高台上,觉得「王」这个称号太贱、要给自己造一个从没人用过的「皇帝」,还打算把帝国传到万世。这一遍让你坐进他低头一看就发现六国各写各的字、用各的钱、各的尺的位置,看他下一步要怎么用一道道命令把这片乱地捏成一个,又是怎么慢慢从「书同文」滑到「焚书」的同一道意志的两张脸。',
    en: 'He is the King of Qin who, at just thirty-nine, has finished a war that ran more than five hundred years, standing on a high terrace at Xianyang, finding the word "King" too cheap and minting himself an unheard-of title "Emperor," meaning his line to last ten thousand generations. This pass puts you in his seat as he looks down on six states each with their own script, coin, ruler, watching how he is about to press it all into one with order after order, and how the same single will slides from "one script" to "burn the books," the two faces of one stroke.',
  },
  storyboard: [
    {
      id: 'qsh-n1',
...
export var liSiLens = {
  ...
  icon: '📜',
  description: {
    cn: '他是从楚国一个看老鼠悟出「人有没有出息全看待在什么地方」的小吏,一路爬到秦帝国丞相、一人之下万人之上的位置,皇帝身边没他不行的那个人。这一遍让你坐进他在朝堂上单挑整个老臣集团、要劝皇帝废分封行郡县的位置,他赌的是「皇帝想要江山永固而我这套是把权力锁进他一只手的唯一办法」,看一个绝顶聪明的技术官僚要不要、敢不敢去亲手喂养一台日后会反过来碾碎他自己的机器。',
    en: 'He is the man who, from a minor clerk in Chu watching rats and learning that "where a man places himself decides his life," climbed all the way to chancellor of the Qin empire, second to one and above ten thousand, the man the emperor cannot do without. This pass puts you in his place at court as he stands alone against the whole bloc of old ministers, about to urge the emperor to scrap enfeoffment for commanderies; his wager is "the emperor wants a dynasty fixed forever, and my plan is the only way to lock all power into his single hand," and you watch whether a brilliant technocrat will, and dare, feed with his own hands a machine that will one day grind him to pieces.',
  },
  storyboard: [
    {
      id: 'ls-n1',
...
export var conscriptLaborerLens = {
  ...
  icon: '⛏️',
  description: {
    cn: '他是一个史书里连名字都没留下的秦国农民,妻子昨晚一句话没说只默默给他缝鞋烙干粮,因为天没亮他就要跟村里另几个被征的人上路去帝国最北边修长城(一个合成人物,代表秦治下千千万万没名字的人,账册上只是「戍卒若干」里的若干之一)。这一遍让你跟他一起直起腰望那道半修在荒寒山岭上、一眼望不到头的夯土墙,看他心里冒出那个不敢说出口的问题:这道将来会被人叫做伟大的奇迹的墙,里面到底算不算我们这些人的一份?',
    en: 'He is a Qin farmer not even a name was left behind for, his wife last night silently mending his shoes and baking dry rations because before dawn he must set out with the others from the village levied to build the wall at the empire\'s far north (a composite figure, standing for the countless nameless people under Qin, only one of the "so many garrison conscripts" in the ledger). This pass puts you with him as he straightens his back and looks at that half-built rammed-earth wall on the cold and barren ridges stretching beyond sight, watching the question he dares not speak aloud rise in him: this wall that ages to come will call a great wonder, does it count any share for people like us?',
  },
  storyboard: [
    {
      id: 'cl-n1',
...
// defaultLens 例外 (创始人 2026-05-24): 中国 topic 自带「暴君」先验, 默认进权力方(始皇帝)视角才能挑战先验
// (受影响者优先通则不适用 prior-loaded 中国 topic); qsh-n10 已含 千古一帝 vs 暴君 双面 + qsh-n11 已补跨视角指针
export var defaultLens = 'qin-shi-huang';
...
export var meta = {
  ...
  notes: [
    ...
    'defaultLens: qin-shi-huang (例外, 创始人 2026-05-24) — prior-loaded 中国 topic 默认进权力方挑战「暴君」先验; qsh-n10 千古一帝 vs 暴君双面 + qsh-n11 含 default-lens 跨视角指针; 戍卒/李斯为加深 lens',
