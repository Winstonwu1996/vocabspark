...
export default [
...

  {
    ...
    deliverGoal:
      ...
      'King John 跟 25 个 baron 对峙——他被逼往一张拉丁文写的纸上**盖蜡封印**' +
      '（**wax seal — 不是中国玉玺——是**金属戒指压在融化的红蜡上**留下王室纹章**）——' +
      '强烈感官细节：草地泥泞 / 王冠 / 红蜡封印（不是玉玺） / baron 全副武装 / 雨打湿羊皮纸——' +
...

  {
    ...
    expectedLength: '180-220 字（短一点 OK——下一节 King John 第一人称会展开当王后的事）',
    expectsRealAnswer: false,
  },

  {
    ...
    phase: 'story',
    cosplay: 'King John',
    narrativeRef: '§3 King John 1199-1213 在位（出身已在 Node 2 讲过——这里**只讲他当王后做的事**）',
    deliverGoal:
      '⚠️ **不要重复 Node 2 已经讲过的出身**（1166 出生 / Eleanor / 4 个哥哥 / Lackland 绰号 / Richard 1199 死接班——这些 Node 2 都讲过）——' +
      '这一节 King John 第一人称——专注他**1199 加冕之后**的事：' +
      '(1) 1204 年 Philip Augustus 进攻 Normandy——John 没去前线——一个夏天 Normandy 全丢 + Anjou + Maine + Touraine——138 年祖产一夜没——' +
      '(2) 残忍：他抢侄子 Arthur of Brittany 王位 + 1203 把 Arthur 秘密杀（很可能亲手）——' +
      '(3) 残忍：亲信 William de Briouze 反叛 → John 把 Briouze 妻子 + 11 岁儿子关 Windsor 城堡饿死——' +
      '(4) 高税：他需要钱重夺 Normandy——加倍收税 + 抢 baron 私产——' +
      '(5) 这种残忍 + 高税让 baron 慢慢联合——但 John 还有一个对手没出现：教皇',
    engagementHook:
      '我加倍收税 + 抢 baron 私产——baron 还能忍——但接下来 1208 年——一件事让所有人都不能忍——你猜是什么',
    expectedLength: '200-240 字（写出 1-2 个最具体的场景画面就够——不要全部 5 件事都展开）',
    expectsRealAnswer: false,
  },
...

  {
    ...
    expectedLength: '240-280 字（Runnymede 现场是关键场景——值得多一点画面）',
    expectsRealAnswer: false,
  },
...

  {
    ...
    expectedLength: '280-320 字（4 条文献内容多——值得多一点但不要超过 320）',
    expectsRealAnswer: false,
  },
