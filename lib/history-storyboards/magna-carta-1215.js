...
var kingJohnStoryboard = [
  ...
  // ═════ Synthesis（真 Socratic）═════
  {
    ...
    content: {
      cn:
        '你刚扮演了 King John——一个失败者，一个被逼签字的人。他签完字当天就在谋划怎么废掉它。\n\n' +
        '但这张纸 800 年后出现在美国宪法第 5 修正案里。这是历史里最常见的一种反讽：当事人想要 A，结果 800 年后变成了 B。\n\n' +
        '问题是：这张纸到底是*加速*了现代民主，还是*延缓*了它？历史学界有两种读法，各有真实依据。\n\n' +
        '**读法 A（Whig 进步派，19 世纪英美主流）**：Magna Carta 是自由对抗暴政的第一声，预设了议会制、法治、个人权利，是一条清晰的"进步线"——从 1215 到 1689 权利法案到 1776 美国独立。没有 Magna Carta，后面这些都得晚。\n\n' +
        '**读法 B（修正派，J.C. Holt 等 20 世纪史学家）**：Magna Carta 的"free man"在 1215 年只覆盖大约 10–20% 的人——除贵族外还包括少量自由农和市民，但 80% 以上的农奴和女性被排除。它给"自由"装了一个封建贵族版的定义，反而让这个定义在法律里固化了几百年——而且排除得合法。这样说来，Magna Carta 不是民主的起点，是精英用法律锁住特权、让真正的民主推迟 600 年的工具。\n\n' +
        '两种读法都有文件支撑，没有一种是"情绪偏见"。\n\n' +
        '你认为 Magna Carta 是加速了民主，还是延缓了民主？给我一个你觉得最有力的理由，想 30 秒答。',
      en:
        'You have just played King John — a man who lost everything and was coerced into sealing a document he intended to destroy. He was already plotting its cancellation the moment the wax dried.\n\n' +
        'And yet that document shows up in the Fifth Amendment to the United States Constitution, eight centuries later. This is one of history\'s most common ironies: the people at the center of an event want A, and eight hundred years later it has become B.\n\n' +
        'Here is the real question. Did Magna Carta *accelerate* modern democracy — or did it *delay* it? Historians hold two genuinely opposed positions, each with real evidence behind it.\n\n' +
        '**Reading A (Whig interpretation, dominant in 19th-century Britain and America):** Magna Carta was the first blow struck for liberty against tyranny, a document that pre-set the conditions for parliamentary government, rule of law, and individual rights. Trace the line: 1215 → 1628 *Petition of Right* → 1689 *Bill of Rights* → 1776 American independence. Without Magna Carta as the first link, each of these arrives later, if at all.\n\n' +
        '**Reading B (revisionist interpretation, J.C. Holt and others, 20th century):** The "free man" of Magna Carta covered roughly 10–20 percent of the population in 1215 — beyond the barons it included some freeholders and townsmen, but more than 80 percent of the population (villeins and women) were excluded. It took the concept of "liberty" and sealed it inside a feudal definition — liberty as the preserved privilege of a landed elite. Those excluded were excluded *legally*, with the document\'s own language. By this reading, Magna Carta did not launch democracy. It gave aristocrats a legal mechanism to protect their own status and arguably pushed genuine democratic expansion back by six hundred years.\n\n' +
        'Both readings are grounded in primary sources. Neither is simply an emotional bias.\n\n' +
        'What do you think — did Magna Carta accelerate democracy, or delay it? Give me one reason you find most convincing. Take thirty seconds.',
    },
    deliverGoal:
  ...
  },
  {
    ...
    content: {
      cn:
        '跳出英国看一眼。Magna Carta 1215 年——63 条，只保护贵族，只在英国一个海岛上。\n\n' +
        '比这早 564 年，651 年唐高宗颁布《永徽律》——基础律典；653 年长孙无忌主持加详细注疏，定本为《唐律疏议》：12 卷，502 条，覆盖刑事、民事、行政，管皇族也管平民，是当时亚洲最系统的成文法典之一。后来朝鲜、日本、越南的法律都从它派生。\n\n' +
        '同样是"成文法"，为什么《唐律疏议》没有成为现代宪政的源头，而 Magna Carta 成了？\n\n' +
        '这里有三种解释，每种都有道理，你不必选一个就放弃其他两个。\n\n' +
        '**解释一：文化路径决定**。中国法律传统是皇权向下授权，"法"是工具，不是约束皇帝的武器；英国封建合同是双向义务，贵族有权利反向要求国王。两种法律观从根上不同。这个解释强调文化的长期塑造力。\n\n' +
        '**解释二：历史偶然性**。17 世纪 Edward Coke 在一场政治斗争里"重新挖出"Magna Carta，给它注入了 1215 年没有的宪政意义。没有 Coke 那次重新解读，Magna Carta 可能和《唐律疏议》一样被后人当历史文物。这个解释不信"命中注定"，认为一次关键选择改变了命运。\n\n' +
        '**解释三：重新解读机制不同**。英国有普通法（common law）传统——法官可以引用旧判例和旧文件，每一代人都在给 Magna Carta 加新意义。唐律之后中国法律走向"祖制不可改"，新朝修法主要是继承，不是激活旧条款对新问题发声。\n\n' +
        '你觉得哪个解释最有说服力？或者三个都有一点对？想 30 秒答。',
      en:
        'Step back from England for a moment. Magna Carta, 1215: 63 clauses, protecting only the nobility, confined to one island.\n\n' +
        'Five hundred and sixty-four years earlier, in 651 CE, the Tang dynasty promulgated the *Yonghui Code* — the underlying legal text. Two years later, in 653 CE, the chancellor Zhangsun Wuji completed an authoritative annotated version, the *Tang Code with Commentary* (*Tanglü Shuyi*): twelve volumes, 502 articles, with detailed commentary, covering criminal, civil, and administrative law, applying to everyone from royalty to commoners. It was one of the most systematically developed legal codes in Asia at the time. The legal systems of Korea, Japan, and Vietnam all derived from it.\n\n' +
        'Both were written law codes. Why did the Tang Code not become the source of modern constitutionalism, while Magna Carta did?\n\n' +
        'Three explanations exist, and each has genuine support. You do not have to pick one and abandon the others.\n\n' +
        '**Explanation 1: Cultural path dependency.** The Chinese legal tradition treated law as a tool of imperial governance flowing downward — law shaped subjects, but did not constrain the emperor. The English feudal contract was bidirectional — lords had standing to make claims against the king. These are fundamentally different legal philosophies, shaped over centuries.\n\n' +
        '**Explanation 2: Historical contingency.** In the early 17th century, the jurist (legal scholar) Edward Coke reached back into history and *reactivated* Magna Carta during a political conflict with King Charles I. He injected constitutional meanings the 1215 document did not originally carry. Without that specific act of reinterpretation, Magna Carta might be a historical artifact today, as little-cited as the Tang Code. This view holds that one person\'s choice, at one moment, redirected history.\n\n' +
        '**Explanation 3: Reinterpretation mechanism.** English common law (*judge-made law based on accumulated precedent*) gave each generation a mechanism for invoking old documents against new problems. Tang law, and subsequent Chinese dynasties\' legal traditions, treated earlier codes as ancestors to be inherited, not weapons to be reloaded for present battles.\n\n' +
        'Which explanation do you find most convincing? Or do you think all three are partially right? Take thirty seconds.',
    },
    deliverGoal:
  ...
  // ═════ Meta（反思 + 桥）═════
  {
    ...
    content: {
      cn:
        '你刚从 King John 的内部走了一遍——他的失去、他的屈辱、他的算计、他死前的清单。\n\n' +
        '在你进入记忆考核之前，一个问题：\n\n' +
        '这一遍里，最让你 surprise 的是什么？是他签字时手在发抖但心里已经在策划反悔？是他一生做什么都做不成，连"毁掉自己的耻辱"都没做成？还是他死前绝对不会想到，他最不情愿签下的那张纸，会在 800 年后出现在地球另一端的宪法里？\n\n' +
        '说一句话告诉我。\n\n' +
        '然后——准备好了吗？接下来是记忆考核：拼写、定义、应用题。这是你把今天学的变成真正会用的最后一步。',
      en:
        'You have just walked through King John from the inside — his losses, his humiliations, his calculations, his deathbed inventory.\n\n' +
        'Before you move into the mastery check, one question:\n\n' +
        'What surprised you most in this lens? Was it the fact that his hand was shaking when he set the seal, but his mind was already plotting how to cancel it? Was it that a man who failed at everything — including destroying his own most embarrassing document — could not even manage that? Or was it that the king who least wanted this charter to survive is the one whose name it carries, eight hundred years later, in constitutions he never imagined?\n\n' +
        'Tell me in one sentence.\n\n' +
        'Then — are you ready? The mastery check comes next: spelling, definitions, application questions. That is the step that turns what you experienced today into something you actually own.',
    },
    deliverGoal:
...
var stephenLangtonStoryboard = [
  ...
  // ═════ Synthesis ═════
  {
    ...
    content: {
      cn:
        '你刚扮演了 Stephen Langton——一个在流亡 7 年里读遍英国宪法史的学者，最后用 5 天把贵族的愤怒写成了可以穿越时间的法律语言。\n\n' +
        '他在 Clause 39 里选了"free man"而不是"baron"或"knight"。他后来自己说：写法律不应该只为今天写。\n\n' +
        '问题来了：他 1215 年真的预见到 800 年后吗？还是我们在他死后，把我们的解读投射给了他？\n\n' +
        '**论点 A：他确实有预见性。** Stephen 读过 Henry I 在 1100 年的 Charter of Liberties——他知道法律语言需要能"穿越国王的寿命"。他故意选"free man"而不是"贵族"——这不是随机用词，是一个训练过的法学家的主动选择。他知道 free man 的边界是活的。这是有意为之的"可扩展性"。\n\n' +
        '**论点 B：后人的重新解读才是关键。** 1215 年的"free man"在法律意义上只覆盖约 10% 的人口。Edward Coke 1628 年在政治斗争里重新拿出这条，才给它注入了宪政意义。杰斐逊 1776 年借用，才让它跨越大西洋。Stephen 写的字是他写的——但这些字变成什么，是后人决定的。历史学家 J.C. Holt 的说法是：Magna Carta 的"伟大"是它后来变成的，不是它原本就是的。\n\n' +
        '两种论点都有文件支撑。你站哪边，还是两边都有一点对？想 30 秒答。',
      en:
        'You have just played Stephen Langton — a scholar who spent seven years in exile reading English constitutional history, then compressed a baronial revolt into law in five days.\n\n' +
        'He chose "free man" in Clause 39 instead of "baron" or "knight." He later said himself: a law should never be written for today alone.\n\n' +
        'Here is the real question: did he actually foresee eight hundred years? Or have we, looking back from the future, projected our interpretation onto him?\n\n' +
        '**Argument A: He genuinely had foresight.** Stephen had studied Henry I\'s Charter of Liberties from 1100. He knew legal language had to outlive specific kings. He *deliberately* chose "free man" over "baron" — that is not random word choice from a trained canon lawyer. He understood that who counts as a free man is a question each generation answers for itself. The expandability was intentional.\n\n' +
        '**Argument B: Later reinterpretation did the real work.** In 1215, "free man" (*liber homo*) covered roughly 10 percent of the population in legal terms. It was Edward Coke in 1628 — pulling Magna Carta into a political fight against King Charles I — who loaded it with constitutional meaning it did not originally carry. It was Jefferson in 1776 who carried it across the Atlantic. The words were Stephen\'s. What those words became was decided by others. Historian J.C. Holt put it directly: Magna Carta\'s greatness is what it became, not what it originally was.\n\n' +
        'Both arguments are grounded in evidence. Which side do you lean toward — or do both have something right? Take thirty seconds.',
    },
    deliverGoal:
  ...
  },
  {
    ...
    content: {
      cn:
        '现在换一个比较视角。\n\n' +
        'Stephen Langton 不是历史上第一个"把权力约束写进成文法典"的人。比他早 564 年，651 年唐朝颁布《永徽律》——基础律典；653 年长孙无忌主持加详细注疏，定本为《唐律疏议》——12 卷 502 条，管皇族也管平民，是当时亚洲法律技术水平最高的文本之一。它后来影响了整个东亚。\n\n' +
        '一个问题：是 Stephen Langton 比长孙无忌有更强的"预见性"？还是两人都是称职的法律起草人，但后续社会走出了完全不同的轨迹？\n\n' +
        '**论点 A：预见性在人，Stephen 更强。** "free man"这个词是有意留开口的，长孙无忌的《唐律疏议》没有这种设计——它是皇权体系内部的精细管理工具，目标是皇权有效运行，不是约束皇权本身。起草者的出发点就不同，所以可扩展的方向也不同。\n\n' +
        '**论点 B：后续解读机制决定命运，不是起草人。** 《唐律疏议》颁布后，宋、元、明、清都有法典，但法律传统趋向"继承祖制"，不是用旧条款对新问题发声。英国普通法（common law）传统——法官可以引用几百年前的判例——给 Magna Carta 提供了一个被反复激活的机制。两人的起草水平可能旗鼓相当，但土壤不同。\n\n' +
        '你觉得差异在人，还是在土壤？想 30 秒答。',
      en:
        'Now shift to a comparative frame.\n\n' +
        'Stephen Langton was not the first person in history to write constraints on power into a formal legal code. Five hundred and sixty-four years before him, in 651 CE, the Tang dynasty promulgated the *Yonghui Code* — the underlying legal text. Two years later, in 653 CE, the chancellor Zhangsun Wuji led the compilation of an authoritative annotated version, the *Tang Code with Commentary* (*Tanglü Shuyi*) — twelve volumes, 502 articles with commentary on every clause, applying to nobility and commoners alike, technically the most sophisticated legal text in Asia at the time. It shaped law across East Asia for centuries.\n\n' +
        'One question: was Stephen Langton simply more *farsighted* than Zhangsun Wuji? Or were both capable legal drafters, and it was the societies that followed that took entirely different paths?\n\n' +
        '**Argument A: The foresight was personal, and Stephen\'s was stronger.** The choice of "free man" over "baron" was an intentional opening. The Tang Code was an administrative instrument designed to make imperial governance run smoothly — it was not built to constrain the emperor, only to regularize everything beneath him. The drafters had different goals from the start, so the expandability pointed in different directions.\n\n' +
        '**Argument B: The reinterpretation mechanism decided the outcome, not the drafters.** After the Tang Code, Song, Yuan, Ming, and Qing dynasties each had legal codes — but the legal tradition tended toward *inheriting the ancestors\' rules*, not using old clauses as weapons against new problems. English common law gave judges a mechanism to cite centuries-old precedent (*prior judicial decisions*) against present-day issues. Magna Carta was *reloaded* by each generation because the legal culture made that possible. The two drafters may have been equally skilled — but the soil was different.\n\n' +
        'Do you think the difference was in the people, or in the systems around them? Take thirty seconds.',
    },
    deliverGoal:
      '同代有另一个起草人——唐《永徽律》651 年颁布——653 年长孙无忌主编加注疏成《唐律疏议》——' +
  ...
  // ═════ Meta ═════
  {
    ...
    content: {
      cn:
        '你刚从 Stephen Langton 的视角走了一遍——一个巴黎学者被卷进英国宪政史，流亡 7 年，用 5 天起草了一份他自己也不知道会活多久的文件。\n\n' +
        '进记忆考核之前，一个问题：\n\n' +
        '这一遍里，最让你 surprise 的是什么？是他 7 年流亡期间在修道院里默默研究 Henry I 的旧文件，把历史合法性准备好等贵族需要的时候拿出来？是他签字当天就知道 John 会反悔，但还是念完了 63 条？还是他死前亲眼看着文件在内战后站稳了脚——他以为这是结局，但真正的故事 400 年后才开始？\n\n' +
        '说一句话告诉我。\n\n' +
        '然后——记忆考核准备好了吗？拼写、定义、应用题——把今天扮演过的变成你真正记住的。',
      en:
        'You have just walked through Stephen Langton\'s perspective — a Paris scholar pulled into English constitutional history, six years in exile, five days of drafting, a document whose lifespan he could not predict.\n\n' +
        'Before the mastery check, one question:\n\n' +
        'What surprised you most in this lens? Was it the seven years he spent in a monastery quietly studying Henry I\'s old charter, preparing the historical legitimacy the barons would need before they even knew they needed it? Was it that on the day of the ceremony he already knew John would renege — and read through all sixty-three clauses anyway? Or was it that he died having watched the document survive a civil war, thinking that was the ending — when the real story was only four hundred years from starting?\n\n' +
        'Tell me in one sentence.\n\n' +
        'Then — ready for the mastery check? Spelling, definitions, application questions — the step that turns what you played into what you actually remember.',
    },
    deliverGoal:
...
var tomVilleinStoryboard = [
  ...
  // ═════ Synthesis ═════
  {
    ...
    content: {
      cn:
        '你刚跟着 Tom 走了一遍——13 岁在树后看着贵族和国王谈判，什么也不懂，什么也没得到。那张羊皮纸上写的"free man"，1215 年不是他，不是他爸，也不是他儿子。\n\n' +
        '但 200 年后，黑死病来了，农奴大量死亡，劳动力变得值钱，农奴开始用脚投票往城里跑。Article 39 的"free man"保护——在他子孙那里，才慢慢轮到。\n\n' +
        '问题：1215 年的 Tom，应该感谢 Magna Carta，还是应该愤怒？\n\n' +
        '**感谢的理由**：Magna Carta 留下了一个法律开口。它没有规定"永远只保护贵族"。Tom 的子孙后来成为自由人的时候，Article 39 是在那里等着他们的。没有那个法律框架，解放有可能更晚、更混乱、更没有保障。就算种子要 200 年才发芽，但种子在。\n\n' +
        '**愤怒的理由**：Tom 本人活不到 200 年后。他的儿子也活不到。一个说"你的后代 200 年后可能会被保护"的法律，对今天正在挨饿、正在被打、正在被地主任意处置的人来说，算什么保护？而且那个"扩展"不是 Magna Carta 主动给的——是黑死病死了一半人口、是农奴自己用脚投票争出来的。贵族起草 Magna Carta 的时候，根本没想过 Tom。\n\n' +
        '你会感谢还是愤怒？或者两种都有，比例各占多少？想 30 秒答。',
      en:
        'You have just followed Tom through his experience — a thirteen-year-old hiding behind an oak tree while barons and a king negotiated something he could not read, and received nothing from. The words "free man" on that parchment did not mean him, his father, or his son in 1215.\n\n' +
        'Two hundred years later, the Black Death arrived. Nearly half the population died. Labor became scarce and valuable. Villeins began voting with their feet, walking to the towns. The "free man" protection of Article 39 — only then did it slowly reach his descendants.\n\n' +
        'The question: should Tom, in 1215, have been grateful to Magna Carta — or furious at it?\n\n' +
        '**The case for gratitude:** Magna Carta left a legal opening. It did not say "protect nobles forever and only nobles." When Tom\'s descendants became free men, Article 39 was waiting there for them. Without that legal framework, liberation might have come later, more chaotically, with less legal ground to stand on. A seed that takes two hundred years to grow is still a seed.\n\n' +
        '**The case for fury:** Tom himself will not live two hundred years. Neither will his son. A law that says "your descendants *may* be protected two centuries from now" is not protection for the person being starved, beaten, or disposed of by a lord today. And the "expansion" was not something Magna Carta delivered voluntarily — it was the Black Death killing half the population, villeins walking away, that forced the change. The barons who drafted Magna Carta were not thinking about Tom at all.\n\n' +
        'Would you be grateful, or furious? Or both — and in what proportion? Take thirty seconds.',
    },
    deliverGoal:
  ...
  },
  {
    ...
    content: {
      cn:
        '1215 年，英格兰大约 90% 的人是农奴或农村劳动者。Tom 是其中之一。\n\n' +
        '同一年，南宋的农民处境是另一个样子。南宋没有西欧式农奴制——佃农有人身自由，理论上自由民出身的儿子可以读书参加科举，考过了就能做官。但实际上有不少身份限制：宋代多数时段对"贱籍"（奴婢、乐户、世仆）和某些客户有应试限制，且一线考中需逐级筛选——真正从普通农家一步登顶的极少。即便如此，确有极少数农家出身的人通过几代积累做到了宰相级别。伦理上国家认这条路。\n\n' +
        '英国的路是：法律慢慢扩展，200 年后子孙可能被 Article 39 保护。中国的路是：个人通过考试向上流动，但没有约束皇权的成文宪章。\n\n' +
        '两条路都有真实代价，没有哪条是"显然更好"的。\n\n' +
        '**英国路的代价**：Tom 本人和他的儿子在 1215 年没有任何保护。地主今天想打他，Magna Carta 管不到。那条法律是为未来写的，不是为今天的农奴写的。而且 200 年后的扩展是因为黑死病，不是因为贵族愿意主动给。\n\n' +
        '**中国路的代价**：科举给的是个人机会，不是集体保护。整个农民阶层作为一个群体，没有法律机制约束皇权对他们集体的处置。而且科举实际门槛极高——真正从农家一步考上进士的比例极低，多数是有钱有时间读书的家庭才真正有机会。\n\n' +
        '如果你是 Tom，你宁愿活在 1215 年的英国，还是同代的中国？或者这两个选项都不够好，你想要什么？想 30 秒答。',
      en:
        'In 1215, roughly ninety percent of England\'s people were villeins or rural laborers. Tom was one of them.\n\n' +
        'The same year, farmers in Southern Song China lived differently. There was no Western-style serfdom (a system binding people to the land without freedom to leave) — tenant farmers had personal freedom. In theory, the son of a free commoner could study, pass the imperial examinations (*keju*, a competitive civil service exam), and become an official. But significant status restrictions applied: certain "debased" categories (*jianji*: enslaved households, hereditary servants, entertainers) and some bonded tenants were barred from sitting the exam, and reaching the top required passing several elimination rounds — true ascent in a single generation from an ordinary farming household was extremely rare. Still, a very small number of men from farming families did genuinely rise to senior government positions over multiple generations. The state recognized this path.\n\n' +
        'England\'s path: law expands slowly, perhaps Tom\'s descendants receive Article 39\'s protection two hundred years later. China\'s path: individual mobility through examinations, but no written charter constraining imperial power.\n\n' +
        'Both paths carried real costs. Neither is obviously better.\n\n' +
        '**The cost of the English path:** Tom himself and his son have no protection in 1215. If the lord strikes him today, Magna Carta cannot reach that. The law was written for the future, not for today\'s villein. And the two-hundred-year expansion came because the Black Death killed half the population — not because the barons chose to give it.\n\n' +
        '**The cost of the Chinese path:** The examinations offered individual opportunity, not collective protection. The whole farming population, as a group, had no legal mechanism to constrain what the emperor\'s system could do to them collectively. And the real barriers to examination success were high — the families who genuinely had a chance were mostly those who could afford the time and books for years of study. True ascent from a poor farming household was rare.\n\n' +
        'If you were Tom, would you rather live in England in 1215, or in China in the same era? Or are both options inadequate — and what would you actually want? Take thirty seconds.',
    },
    deliverGoal:
      '同代中国——同样是农民 90%——但中国农民**没有 Magna Carta 这种法律保护**——' +
      '中国走另一条路——**科举制度**——自由民儿子**理论上**可以做官（但有身份门槛和层层筛选）——' +
      '一个走"法律保护所有 free man（慢慢扩展）"——' +
      '一个走"个人通过考试上升"——' +
      '——两条路给农民的命运不同',
    engagementHook:
      '**你怎么看**——如果你是 Tom——你愿意活在 1215 英国（被 charter 排除但 200 年后子孙慢慢被保护）还是同代中国（自由民有科举一线机会但 charter 永远没有）？想 30 秒答',
    expectedLength: '170-210 字 + 真问题',
    expectsRealAnswer: true,
  },
  // ═════ Meta ═════
  {
    ...
    content: {
      cn:
        ...
        '进记忆考核之前，一个问题：\n\n' +
        '这一遍里，最让你 surprise 的是什么？是那个 13 岁的孩子隔着树看着影响 800 年的事件，却只记得"铠甲很亮"？是他 30 年后在磨坊里听到"Article 39"三个字，才突然明白自己曾经目击过什么？还是 Magna Carta 真正轮到 Tom 这样的人，是因为黑死病死了一半人口，不是因为贵族想给？\n\n' +
        '说一句话告诉我。\n\n' +
        '然后——记忆考核来了。拼写、定义、应用题——今天的历史，变成你真正会用的东西。准备好了吗？',
      en:
        ...
        'Before the mastery check, one question:\n\n' +
        'What surprised you most in this lens? Was it that a thirteen-year-old boy was watching an event that would shape eight hundred years of history from behind a tree — and all he remembered was that the armor was bright? Was it the moment thirty years later in a mill, when he heard the words "Article 39" and suddenly understood what he had witnessed? Or was it the fact that Magna Carta only reached people like Tom because the Black Death killed half the population — not because the barons chose to give it?\n\n' +
        'Tell me in one sentence.\n\n' +
        'Then — the mastery check. Spelling, definitions, application questions — turning today\'s history into something you actually own. Ready?',
    },
    deliverGoal:
