  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '1215 年的 free man 不到全英国人口的一半，约 40-50% 是 villein 农奴，以及女性和其他被排除者。但"free man"这个词，边界是活的。是谁，由未来决定。如果有一天农奴被解放，他们就成了 free man。如果有一天商人取得公民权，他们也是 free man。\n\n' +
  ...
  // ═════ Synthesis ═════
  {
    ...
    content: {
      cn:
        ...
        '**另一种说法：后人的解读才是关键**。1215 年这个"free man"，在当时的法律意义上不到一半英国人——约 40-50% 是 villein 农奴，被排除在外。1628 年 Edward Coke 跟查理一世吵架，把 Magna Carta 翻出来当武器——给这个词塞进了 1215 年根本没有的宪政意义。1776 年杰斐逊借去美国，才让它跨过大西洋。Stephen 写的字是他写的——但这些字最后变成什么，是后人决定的。J.C. Holt 一句话说透：Magna Carta 的"伟大"是它后来变成的，不是它原本就是的。\n\n' +
      ...
      en:
        ...
        '**The other view: later reinterpretation did the real work.** In 1215, "free man" (liber homo) covered fewer than half the population — roughly 40–50 percent were villeins (bonded farmers) who were excluded. In 1628, Edward Coke had a fight with King Charles I, pulled Magna Carta into the conflict, and loaded the word with constitutional meaning the 1215 document never originally carried. In 1776, Jefferson carried it across the Atlantic. The words were Stephen\'s. What those words became was decided by others. Historian J.C. Holt put it bluntly: Magna Carta\'s greatness is what it became, not what it originally was.\n\n' +
...
var tomVilleinStoryboard = [
  ...
  },
  {
    ...
    content: {
      cn:
        '1215 年，英格兰约 40-50% 的人是 villein 农奴，加上女性等被排除者，不到一半的人口是"free man"（自由人）。Tom 是被排除在外的人之一。\n\n' +
