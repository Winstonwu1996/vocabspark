...
var kingJohnStoryboard = [
  {
    ...
    deliverGoal:
      '第一人称 King John——1215 年 6 月 15 日清晨——我骑马到 Runnymede 草地——' +
      '下小雨——25 个 baron 全副武装站在我对面——' +
      '我手在抖——但不是因为冷——是因为愤怒——' +
      '我必须往一张羊皮纸上盖印（红蜡封 wax seal——金属戒指压融化的红蜡）——' +
      '签完我心里一句话："等你们走——我就让教皇废了它"——' +
      '我是 King John——你接下来 13 节会跟我经历 16 年——看我怎么走到这一刻',
    engagementHook: '我为什么走到这一刻？我们倒回 1199 年——我刚做王那天',
  ...
  },
  {
    ...
    deliverGoal:
      '我（John）出生 1166 年圣诞节前夜——牛津——Henry II 第 4 子——' +
      '我妈 Eleanor of Aquitaine 看到我叹气："又一个没地分的"——' +
      '我爸给我外号 "Lackland"——无地约翰——' +
      '我从小看 3 个哥哥分封地——我什么都没有——' +
      '1199 年 4 月——3 哥 Richard（狮心王）攻城战中箭死——遗言："我的继承人是 John"——' +
      '32 岁——我突然成英格兰国王——但我没准备过',
  ...
  },
  {
    ...
    deliverGoal:
      '1204 年夏天——法王 Philip Augustus 进攻 Normandy——' +
      '我没去前线——我在英国南部宫殿打猎——' +
      '一个夏天——Normandy + Anjou + Maine + Touraine 全丢——' +
      '138 年祖产一夜没————' +
      '回英国我加倍收税——为夺回——但我也做了一件后悔事：' +
      '我侄子 Arthur of Brittany（16 岁）——我亲手在 Rouen 城堡杀了他——' +
      '没人知道具体——我只宣布"逃跑时死了"——但欧洲都猜到',
    engagementHook: '杀侄子 + 高税——baron 还忍——但 1208 年——一件事让所有人不能忍——你猜',
  ...
  },
  {
    ...
    deliverGoal:
      ...
      '教皇下 Interdict——全英国教堂关——婴儿不能洗礼 + 死人不能葬——' +
      '我扛 5 年——直到 1213——我跪了——我把英国"献给"教皇——每年付 1000 银马克贡——' +
      'baron 看到他们的王跪在罗马面前——他们想：这种王值得效忠吗——' +
      '——这是我人生最深的耻辱',
  ...
  },
  {
    ...
    deliverGoal:
      '1214 年 7 月 27 日——Bouvines 战役——我攒 4 年的反法联军——' +
      '我自己又没去前线——我在英国南部 Poitou——' +
      '我派 William Marshal + 神圣罗马帝国皇帝 Otto IV——一起打 Philip Augustus——' +
      '一个下午——我们大败——Otto IV 跑——William 回英国——' +
      'William 跟我说："Sire——baron 不会再忍了"——' +
      '我没钱了——我没地了——我没盟友了——' +
      'baron 1215 春集合在 Stamford——他们要我签法律',
    engagementHook: '5 月 17 日——London 城门主动为 baron 打开——我没了首都——必须谈判',
    expectedLength: '200-240 字',
    expectsRealAnswer: false,
  },
  {
    ...
    deliverGoal:
      ...
      '我派 Stephen Langton 大主教做中间人——他是教皇的人——但他懂法律——' +
      '他起草一份"Articles of the Barons"——49 条 baron 诉求——' +
      '我看了第 39 条："任何 free man 不能被随便抓走或没收财产——必须经过同辈陪审或国法"——' +
      '我心想——这是要把我（王）放在法律之下——' +
      '——但我没选择——我必须签——否则失去王位',
    engagementHook: '6 月 15 日 Runnymede——我去签——但我已经在想怎么 renege',
    expectedLength: '180-220 字',
    expectsRealAnswer: false,
  },
  {
    ...
    deliverGoal:
      '6 月 15 日——Runnymede 草地——我带 wax seal——25 baron 全副武装站对面——' +
      'Stephen Langton 念拉丁文 63 条——' +
      '我盖印——我心里想：' +
      '"我父亲 Henry II 收复整个西法国——我一夜失去——" +' +
      '"我哥哥 Richard 死时所有人哭——我活着所有人恨——"+' +
      '"今天我在草地上——pen 是别人写的——印是我的——但**我心里没认**"——' +
      '签完——我立刻派密使去 Rome——求教皇废了它',
  ...
  },
  {
    ...
    deliverGoal:
      '1216 年 10 月 18 日——我在 Newark——痢疾——49 岁——' +
      '我躺在床上——我想我留下了什么：' +
      '"我失去 Normandy——失去教皇——失去 baron——失去 charter——" +' +
      '"我儿子 Henry 才 9 岁——William Marshal 70 岁会摄政——他比我可靠"——' +
      '我闭眼——我以为 charter 跟我一起死——' +
      '——我不知道——William Marshal 11 月会重新颁 Magna Carta——以新王名义——' +
      '我以为我失败的那张纸——会活 800 年',
  ...
  },
  {
    ...
    deliverGoal:
      '现在我们离开 King John 视角——zoom out 看 charter 怎么活：' +
      '1216 11 月 William Marshal 以新王 Henry III 名义重新颁——加一句"这是 King 的礼物"——' +
      '1217 / 1225 / 1297 反复 reissue——' +
      '1297 Edward I 把 Magna Carta 列入 statute book——成正式法律——' +
      '1628 Petition of Right 引用 Article 39——' +
      '1689 Bill of Rights 引用——' +
      '1789 美国宪法第 5 修正案 + 第 14 修正案——直接继承 Article 39——' +
      '——King John 1215 年签时不知道：他失败的那张纸成了西方法治根基',
    engagementHook: '——现在你（用了 7 节扮演 King John）——回头看你自己——',
    expectedLength: '200-240 字',
    expectsRealAnswer: false,
  },
  // ═════ Synthesis（真 Socratic）═════
  {
    ...
    deliverGoal:
      ...
      '问题来了——',
    engagementHook:
      '**你怎么看**——King John 是"输给了历史长河趋势"——还是"他自己的失败**就是**那个趋势的一部分"？想 30 秒答',
  ...
  },
  {
    ...
    deliverGoal:
      '比 Magna Carta 早 564 年——唐律疏议 651 年——' +
      '12 卷 502 条——管所有人——更系统——但**没成现代法律源头**——' +
      'Magna Carta 1215 年只 63 条——只保护 25 baron——只在英国——' +
      '却变成全球宪政基础——' +
      '同样的"成文法"——为什么走出**完全不同的命运**？',
    engagementHook:
