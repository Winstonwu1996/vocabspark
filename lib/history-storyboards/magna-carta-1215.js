...
var kingJohnStoryboard = [
  ...
  },
  {
    ...
    engagementHook:
      '同样是"成文法"，唐律变成博物馆文物、Magna Carta 变成现代宪法祖宗——是文化决定、纯属偶然，还是机制不同？先在心里想想你怎么看，下一节我会正式问你。',
  ...
  // ═════ Meta（反思 + 桥）═════
  {
    ...
    deliverGoal:
      ...
      '——同一事件不同角度——会发现新东西',
    engagementHook:
      '走完约翰王这一生——一个签字当天就在想怎么废掉它、却什么都做不成的失败者，偏偏签出了一份活 800 年的文件。你会怎么评价这样一个人？再想一步：唐律和 Magna Carta 都是"成文法"，一个变文物、一个变现代宪法祖宗——你觉得是文化、偶然、还是机制不同造成的？',
...
export var lenses = {
  'king-john': {
    ...
    description: {
      cn: '英格兰国王，在位 17 年丢掉了诺曼底、和教皇打了 6 年、被自己贵族打输一场内战。1215 年 6 月 15 日被逼盖印 Magna Carta，但当晚就在写信请求教皇废掉它。从 perpetrator-loser 内部看这张纸是怎么诞生的。',
      en: 'King of England who reigned 17 years. He lost Normandy in 1204, fought the Pope for 6 years, and lost a civil war to his own barons. On June 15 1215 he was forced to seal Magna Carta at Runnymede, then wrote that same evening asking Pope Innocent III to annul it.',
    },
    // 旧字段 fallback
    nameCn: '约翰王',
  ...
  'stephen-langton': {
    ...
    description: {
      cn: 'Canterbury 大主教 + 巴黎大学法学博士。1207 年被教皇任命，国王不让他登陆英国，他在法国流亡 7 年。1213 年回英国，2 年后亲手起草 Magna Carta 第 39 条——这一句 800 年后还在美国宪法第 5 修正案里。',
      en: 'Archbishop of Canterbury and a Paris-trained doctor of canon law. Appointed by Pope Innocent III in 1207, then exiled in France for 7 years because King John refused to let him land. In 1215 he drafted clause 39, the due-process line that still echoes in the U.S. Fifth Amendment 800 years later.',
    },
    // 旧字段 fallback
    nameCn: '斯蒂芬·朗顿',
  ...
  'tom-villein': {
    ...
    description: {
      cn: '13 岁农奴男孩，住在 Runnymede 旁边的 Mowbray 庄园。1215 年 6 月 15 日他在河边放羊，看到一队队骑兵从北边路过去那片草地。他不识字，不懂草地上发生了什么。从被 charter 排除的 90% 的人内部看那一天，以及 200 年后他子孙才被覆盖的扩展机制。',
      en: 'A 13-year-old villein boy on the Mowbray manor next to Runnymede. On June 15 1215 he was tending sheep by the Thames when troops of armoured riders passed him heading for the meadow. He could not read and had no idea what was being sealed. The lens of the 90% the charter excluded, and the slow 200-year arc by which his descendants were finally covered.',
    },
    // 旧字段 fallback
