...
var kingJohnStoryboard = [
  ...
  },
  {
    ...
    content: {
      cn:
        '1214 年 7 月 27 日，Bouvines 战役。我酝酿 4 年的反法联盟全压上去：神圣罗马帝国皇帝 Otto IV、Flanders 伯爵、还有我同父异母弟弟 William Longespée（绰号"长剑"）。目标是从两面夹击法王 Philip Augustus。\n\n' +
        '我自己在 Poitou（法国西部）围 La Roche-aux-Moines，把 Bouvines 北线交给 Otto IV 和 Longespée。一个下午，北线联军彻底崩溃：Otto IV 弃马逃走，Longespée 被俘。我的南线也撑不住，被迫回英国。\n\n' +
        '消息传回，70 岁的老骑士 William Marshal 来见我。他一辈子服侍过 5 个国王，是英格兰最忠诚的人。他话很少："Sire（陛下），贵族们再也忍不下去了。"\n\n' +
        '没有钱了。没有领地了。没有盟友了。\n\n' +
        '1215 年 4 月，贵族集合在 Stamford。5 月 5 日，他们正式撤回对我的效忠誓（fealty，臣对封建领主的效忠）——中世纪最严重的政治宣告，法律上等于"我们不再认你做王"。5 月 17 日，London 城门主动为他们打开——伦敦商人也恨我的高税。\n\n' +
        '我没了首都。必须谈判。',
      en:
        'July 27, 1214. The Battle of Bouvines. The anti-French coalition I had spent four years building threw everything onto the field: Holy Roman Emperor Otto IV, the Count of Flanders, and my own half-brother William Longespée, nicknamed "Longsword." The plan was to crush King Philip Augustus from two sides at once.\n\n' +
        'I was besieging La Roche-aux-Moines myself, in Poitou (western France), and left the northern front at Bouvines to Otto IV and Longespée. In a single afternoon the northern coalition collapsed: Otto IV abandoned his horse and fled, Longespée was captured. My own front in the south buckled too, and I had to retreat to England.\n\n' +
        'When the news reached me, William Marshal came to see me. Seventy years old, he had served five kings in his lifetime, and was the most loyal man in the country. He said very little: "Sire, the barons cannot bear it any longer."\n\n' +
        'No more money. No more lands. No more allies.\n\n' +
        'In April 1215, the barons gathered at Stamford. On May 5, they formally renounced their oath of fealty (loyalty oath to a feudal lord) to me — the gravest political act in medieval law, legally meaning: "We no longer accept you as our king." On May 17, the gates of London opened for them, voluntarily. London\'s merchants hated my taxes too.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '1791 年，美国宪法第 5 修正案（权利法案）——直接继承 Article 39 的 due process（正当法律程序）原则；1868 年第 14 修正案将保护扩展到所有人。\n\n' +
      ...
      en:
        ...
        '1791: The Fifth Amendment (Bill of Rights) to the United States Constitution drew directly from Article 39 — adopting the doctrine of due process of law. In 1868, the Fourteenth Amendment extended that protection to all persons.\n\n' +
  ...
  // ═════ Synthesis（真 Socratic）═════
  {
    ...
    content: {
      cn:
        ...
        '**另一种说法**（20 世纪修正派，J.C. Holt 等史学家）：纸上写的"free man"在 1215 年不到一半英国人——约 40-50% 是 villein 农奴，外加女性和其他被排除者。更狠的是，"自由 = 上层人的特权"这个定义被钉进了法律——后人想扩大保护范围，要先回头跟这张原始文件较劲。从这个角度看，它不是起点，是路障。\n\n' +
        '两边证据都过硬。没有谁是凭情绪。\n\n' +
      ...
      en:
        ...
        '**The other view** (20th-century historians who challenge that older account, J.C. Holt and others): the "free man" mentioned in 1215 covered fewer than half the population — roughly 40–50 percent were villeins (bonded farmers), and women and others were also excluded in writing. Worse: by locking "liberty = the privilege of those at the top" into the law, it froze the definition. Later generations who wanted to expand it had to fight against the original document. By this view, Magna Carta wasn\'t the starting line. It was a roadblock.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '比它早 564 年，唐朝就有了《永徽律》（651 年颁布；653 年长孙无忌加注疏后定本为《唐律疏议》）。12 卷，502 条，管皇族也管平民——朝鲜、日本、越南后来都从它派生，是当时亚洲最系统的法典。\n\n' +
        '同样是"成文法"，为什么《唐律疏议》后来成了博物馆文物，而 Magna Carta 成了现代宪法的祖宗？\n\n' +
        '三种想法，每种都有道理：\n\n' +
        '**一种想法：文化不同。**中国法律是皇帝从上往下的工具——管你不管自己。英国封建是双向合同——贵族也能反过来要求国王。根上就不一样，几百年走出两条路。\n\n' +
        '**另一种想法：纯属偶然。**17 世纪英国法学家 Edward Coke 跟国王查理一世吵架，翻出 Magna Carta 当武器——塞进了 1215 年根本没有的宪政意义。没有那次重新解读，它大概也是文物。\n\n' +
        '**还有一种：机制不同。**英国普通法允许法官引用几百年前的旧文件，每一代人都在给 Magna Carta 加新意义。唐律之后中国走"祖制不可改"，新朝修法主要是继承。机制活的，文件就活；机制僵的，再好的文件也用不起来。\n\n' +
      ...
      en:
        ...
        '564 years earlier, the Tang dynasty already had the Yonghui Code (promulgated in 651 CE; in 653 CE the chancellor Zhangsun Wuji finalized an annotated version, the Tang Code with Commentary, or Tanglü Shuyi). Twelve volumes, 502 articles, applying to royalty and commoners. Korea, Japan, and Vietnam all later derived their codes from it. It was the most systematic legal code in Asia.\n\n' +
        'Both were written law codes. Why did the Tang Code end up a museum piece, while Magna Carta became the ancestor of modern constitutional law?\n\n' +
        'Three ways of thinking about it — each has real support:\n\n' +
        '**One way: culture was different.** Chinese law was a tool the emperor used downward — to govern others, not himself. English feudalism was a two-way contract — lords could push back against the king. Different roots, two different paths over the centuries.\n\n' +
        '**Another way: pure accident.** In the 1620s, an English legal scholar named Edward Coke had a fight with King Charles I, pulled out Magna Carta as a weapon, and loaded it with constitutional meaning the 1215 document never carried. Without that reinterpretation, it would probably be a museum piece too.\n\n' +
        '**A third way: the mechanism was different.** English common law (judge-made law built from old cases) lets judges cite documents from centuries ago, so each generation reloads Magna Carta with new meaning. After the Tang Code, Chinese law moved toward "the ancestors\' rules cannot be changed" — new dynasties mostly inherited old codes. When the mechanism is alive, the document stays alive. When it is frozen, even the best document collects dust.\n\n' +
    ...
    engagementHook:
      '历史上很多文明都写下过"成文法"——大多变成博物馆里的文物，只有 Magna Carta 变成了现代宪法祖宗。是文化决定、纯属偶然，还是机制不同？先在心里想想你怎么看，下一节我会正式问你。',
  ...
  // ═════ Meta（反思 + 桥）═════
  {
    ...
    deliverGoal:
      ...
      '现在你可以选：' +
      '(1) 进 mastery 通关 / ' +
      '(2) 换视角重玩——比如 Stephen Langton（起草人视角）或 Tom（农奴小孩视角）——' +
      '——同一事件不同角度——会发现新东西',
    engagementHook:
      '走完约翰王这一生——一个签字当天就在想怎么废掉它、却什么都做不成的失败者，偏偏签出了一份活 800 年的文件。你会怎么评价这样一个人？再想一步：历史上很多文明都写下过「成文法」——大多变成博物馆里的文物，只有 Magna Carta 变成了现代宪法的祖宗。你觉得是文化、偶然、还是机制不同造成的？',
...
var stephenLangtonStoryboard = [
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '十九岁那年我去巴黎大学——十二世纪欧洲的学术中心，神学家、法学家、医生挤在同一条街上争论。我在那里待了近三十年，真做学问：今天你打开任何一本《圣经》，那套**章**（chapter）的划分，就是我在 1190 年代前后定的。（节 verses 的划分要等 1551 年巴黎印刷商 Robert Estienne 才完成。）\n\n' +
        '我还教 canon law（教会法）。后来的教皇 Innocent III 那段时期也在巴黎学术圈。我们是否真"同窗"史家仍在争，但他登上教皇位后，记得我。\n\n' +
        '1207 年，他写信给我：Canterbury 大主教空缺，你来当——这是英国教会一把手，地位仅次于国王。\n\n' +
        '我不想去。巴黎是我的家。但教皇不是在问我的意见。\n\n' +
        '同年，King John 得知任命后，直接拒绝让我入境——他要自己的人当大主教。于是我被困在法国 Pontigny 修道院，隔着海峡看英国，看不到头。\n\n' +
        '这一等就是六年。英国为我一个人，陷进一场宗教危机。',
      en:
        ...
        'At nineteen I went to the University of Paris — the intellectual center of twelfth-century Europe, where theologians, canon lawyers, and physicians all argued in the same streets. I stayed nearly thirty years, doing real scholarship: the chapter divisions in every Bible you open today are the ones I set, around the 1190s. (Verse divisions came much later — a Paris printer named Robert Estienne added those in 1551.)\n\n' +
        'I also taught canon law (Church law). The man who would become Pope Innocent III was in the Paris academic world during those years. Whether we were truly classmates, historians still debate — but once he was Pope, he remembered me.\n\n' +
        'In 1207, he wrote to me: the Archbishop of Canterbury seat was empty, and he wanted me to fill it — head of the English Church, second in rank only to the King himself.\n\n' +
        'I did not want to go. Paris was my home. But the Pope was not asking.\n\n' +
        'When King John learned of the appointment, he refused to let me land in England — he wanted his own man in that seat. So I was stranded at Pontigny Abbey in France, watching England across the Channel with no way in.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '1214 年 7 月 27 日，Bouvines 战役。John 筹备了四年的反法联盟一战崩了：神圣罗马帝国皇帝 Otto IV 溃逃，John 的同父异母弟弟 William Longespée 被俘。John 退回英国，再没有夺回法国领地的筹码。\n\n' +
        '消息传到英国，贵族们等的时机到了。1215 年复活节后，四十多位北方贵族在 Stamford 集结。5 月 5 日，他们在 Brackley 正式向 John 发出 defiance（宣战书）——撤回 fealty（效忠誓 / 对封建领主的效忠）。5 月 17 日，伦敦城门由市民从里面打开，迎接贵族军队——伦敦商人也恨 John 的苛税。\n\n' +
        'John 退到 Windsor 城堡，派人来找我。信里客气，意思只有一个：Stephen，你来做中间人。\n\n' +
        '我接了。不是帮 John，是因为内战对任何人都是灾难。\n\n' +
        '贵族给了我一份 Articles of the Barons（贵族诉求条款）——四十九条，写得乱，多数是封建技术细节：遗孀改嫁权、继承金额上限、森林狩猎权。我读完，知道不够。它只能保护 1215 年的贵族，不能保护任何人的未来。\n\n' +
        '我告诉他们：这四十九条，我来改写，改成法律语言。',
      en:
        'July 27, 1214. The Battle of Bouvines. The anti-French coalition John had spent four years building collapsed: Holy Roman Emperor Otto IV fled, and John\'s half-brother William Longespée was captured. John retreated to England, with no leverage left to win back the French lands.\n\n' +
        'When the news reached England, the barons saw their moment. After Easter 1215, more than forty northern barons gathered at Stamford. On May 5, at Brackley, they sent John a formal defiance (a written declaration of war) — withdrawing their fealty (loyalty oath to a feudal lord). On May 17, the gates of London were opened from the inside by the city\'s own merchants — London\'s traders hated John\'s taxes too.\n\n' +
        'John retreated to Windsor Castle and sent word to me. The message was polite; the meaning was plain: Stephen, be our intermediary.\n\n' +
        'I agreed. Not to help John — because civil war would be a disaster for everyone.\n\n' +
        'The barons gave me their draft: Articles of the Barons — forty-nine clauses, written roughly, mostly feudal technical demands: rights of widows to remarry, caps on inheritance fees, hunting rights in royal forests. I read it through and knew it was not enough. It could protect the barons of 1215. It could not protect anyone in the future.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '贵族那四十九条原文里，没有第三十九条。最后五天定稿时，我和书记员把它加了进去。\n\n' +
        '我不会说这一条只属于我——起草室里有几个人。但我是少数受过 canon law（教会法）训练的人，也是写最终拉丁文版本的人之一。\n\n' +
        '贵族要的是具体保护：不要乱收钱，不要随便没收庄园。合理，但他们没往更远想。我在巴黎读过 Henry I 的 Charter of Liberties（1100 年，国王承诺不滥用权力的旧文件）。我知道，保护今天二十五个贵族的条款，下一代国王能用别的借口绕开。\n\n' +
        '必须写一条能穿越时间的。\n\n' +
        '于是这一条写下来：\n\n' +
        'Nullus liber homo capiatur...\n\n' +
        '意思是：任何 free man（自由人）不能被随便逮捕、监禁或剥夺财产，除非经过同辈的合法审判，或者按国法。\n\n' +
        '关键词是"free man"——不是"baron"，不是"knight"。\n\n' +
        '1215 年的 free man 不到全英国人口的一半，约 40-50% 是 villein 农奴，还有女性和其他被排除者。但"free man"这个词边界是活的，是谁由未来决定：农奴若被解放，就是 free man；商人若取得公民权，也是 free man。\n\n' +
        '我不敢说我们在 1215 年就预见了八百年后。我只知道，写法律不该只为今天写。',
      en:
        'Clause 39 was not in the barons\' original forty-nine articles. It was added during the final five days of revisions, by me and the scribes.\n\n' +
        'I will not claim it was mine alone — there were several of us in that room. But I was among the few trained in canon law (Church law), and one of the people who drafted the final Latin.\n\n' +
        'The barons wanted specific protections: no more arbitrary fines, no more seizure of estates. Reasonable — but they were not thinking further ahead. In Paris I had studied Henry I\'s Charter of Liberties — a document from 1100 in which the King promised not to abuse his power. I knew a clause protecting twenty-five barons today could be circumvented by the next king with a different excuse.\n\n' +
        'We needed a clause that could survive across time.\n\n' +
        'So these words went down on parchment:\n\n' +
        'Nullus liber homo capiatur...\n\n' +
        ...
        'In 1215, free men were fewer than half of England\'s population: roughly 40–50 percent were villeins (bonded farmers), and women and others were also excluded. But "free man" is an open category — who counts is something each generation decides. If serfs were ever freed, they would become free men. If merchants ever gained rights, they would be free men too.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '仪式结束后我没有庆祝。\n\n' +
        '我在 Runnymede 草地上站了很久，看贵族骑马散去，看 John 的队伍回 Windsor。\n\n' +
        '我知道 John 不会认。在胁迫下盖印的人，心里从没同意过。我在他眼里看到的不是接受，是算账。\n\n' +
        '果然——六月底，他派密使去罗马给教皇 Innocent III 送信。逻辑精明：这份文件限制了他这个 vassal（封臣），也就等于限制了他封建上位者教皇的权威。\n\n' +
        '教皇接了。1215 年 8 月 24 日，Innocent III 签发 papal bull（教皇敕令——正式的教会决定）：Magna Carta 永远无效。我这个起草人也被暂停 archbishopric（大主教职位），理由是"支持反叛"。我第二次流亡，去罗马上诉。\n\n' +
        '1216 年 10 月，John 死了。regent（摄政——替年幼国王代理国政的人）是七十岁的老骑士 William Marshal。他做了一件我没想到的事——1216 年 11 月，他以九岁新王 Henry III 的名义重新颁布 Magna Carta，加了一句：此乃国王恩赐。\n\n' +
        '这句话给文件穿上合法外衣——不再是贵族逼出来的，是国王主动给的。\n\n' +
        '我在罗马听到这消息时沉默了很久。那张我改了五天的羊皮纸，活过了盖印它的国王，活过了废掉它的教皇。它还在。',
      en:
        'I did not celebrate when the ceremony ended.\n\n' +
        'I stood on the Runnymede meadow for a long time, watching the barons ride off and John\'s entourage head back toward Windsor.\n\n' +
        ...
        'As I expected — by late June, he dispatched a secret messenger to Rome with a letter for Pope Innocent III. The argument was sharp: this document restrained him as a vassal (a feudal subordinate), which meant it also restrained the authority of his feudal superior, the Pope.\n\n' +
        'The Pope agreed. On August 24, 1215, Innocent III issued a papal bull (a formal Church decree): Magna Carta was null and void forever. And I, the man who had drafted it, had my archbishopric (position as Archbishop) suspended for "supporting rebellion." I went into exile a second time, to Rome to appeal.\n\n' +
        'In October 1216, John died. The regent (a temporary ruler for a child king) was the seventy-year-old knight William Marshal. He did something I had not anticipated: in November 1216, in the name of the nine-year-old new King Henry III, he reissued Magna Carta and added a single line — this is granted as a gift from the King.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '1791 年，美国宪法第五修正案（权利法案），其中 due process of law（正当法律程序）原则直接来自 Clause 39 的语言。"free man"这个词，到了 1868 年第十四修正案，变成了"no person"——任何人，不论出身。\n\n' +
      ...
      en:
        ...
        '1689: The Bill of Rights cited it again.\n\n' +
        '1791: The Fifth Amendment to the United States Constitution — its guarantee of due process of law — drew its language from Clause 39. The "free man" Stephen wrote became "no person" in the Fourteenth Amendment of 1868. Any person. Regardless of origin.\n\n' +
  ...
  // ═════ Synthesis ═════
  {
    ...
    content: {
      cn:
        '你刚演完 Stephen Langton——流亡 7 年里读遍英国旧文件的学者，最后用 5 天把贵族的怒火写成能穿越时间的法律语言。\n\n' +
        '他在 Clause 39 里选了"free man"，没选"baron"也没选"knight"。他说过：写法律不应该只为今天写。\n\n' +
        '问题来了：他 1215 年真预见到 800 年后吗？还是我们站在今天回头看，把今天的解读硬塞给他？\n\n' +
        '**一种说法：他确实有远见。**Stephen 在巴黎学过法律，读过 Henry I 1100 年的 Charter of Liberties——他知道法律语言要"活得比国王久"。选"free man"是法学家的故意选择：他知道这个词边界是活的，每代人都能往里填新的人。这是**有意留白**。\n\n' +
        '**另一种说法：后人的解读才是关键。**1215 年这个"free man"，约 40-50% 的英国人（villein 农奴）被排除在外。1628 年 Edward Coke 跟查理一世吵架，把 Magna Carta 翻出来当武器，塞进了 1215 年根本没有的宪政意义。1776 年杰斐逊借去美国，才让它跨过大西洋。字是 Stephen 写的，但这些字最后变成什么，是后人决定的。\n\n' +
      ...
      en:
        ...
        'So here is the question. Did he genuinely foresee eight hundred years? Or are we — looking back from today — projecting our reading onto him?\n\n' +
        '**One view: he really did have foresight.** Stephen had studied law in Paris and read Henry I\'s Charter of Liberties from 1100 — he knew legal language had to outlive specific kings. Choosing "free man" was the deliberate choice of a trained legal scholar: he understood the boundary of the word was open, and each generation could refill it with new people. **He left the door ajar on purpose.**\n\n' +
        '**The other view: later reinterpretation did the real work.** In 1215, "free man" excluded roughly 40–50 percent of England — the villeins (bonded farmers). In 1628, Edward Coke had a fight with King Charles I, pulled Magna Carta into the conflict, and loaded the word with constitutional meaning the 1215 document never carried. In 1776, Jefferson carried it across the Atlantic. The words were Stephen\'s — but what those words became was decided by others.\n\n' +
  ...
  },
  {
    ...
    deliverGoal:
      ...
      '你会怎么给他写——',
    engagementHook:
      '如果你能给 1228 年临终的 Stephen 寄一封信，告诉他这张纸 800 年后的下场——他会更欣慰（赌赢了），还是更困惑（这还是我写的吗）？先在心里想想你会怎么写，下一节我会正式问你。',
  ...
  // ═════ Meta ═════
  {
    ...
    deliverGoal:
      ...
      '同一事件不同角度——会发现新东西',
    engagementHook:
      '走完 Stephen 这一段——一个流亡 7 年、用 5 天把怒火写成法律的人，他选"free man"这个词时，到底是真有远见，还是后人替他造的远见？你会怎么评价这样一个起草人？再想一步：如果你能给 1228 年临终的他寄一封信，告诉他这张纸 800 年后的下场，他会更欣慰还是更困惑？你会怎么写？',
    expectedLength: '120-160 字',
    expectsRealAnswer: true,
  },
];
...
var tomVilleinStoryboard = [
  {
    ...
    content: {
      cn:
        ...
        '我是 Tom。这是我的故事，也是 1215 年英格兰大多数被排除在外的人的故事。',
      en:
        ...
        'I am Tom. This is my story — and the story of the majority who were left outside in 1215.',
    },
    deliverGoal: '[fallback]',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '1215 年，英格兰约四到五成人是 villein 农奴，不到一半是 free man（自由人）。那张大家都在说的 charter（大宪章），里面写"free man"，那不是在说我们。\n\n' +
        '我们属于那些被排除在外的人。那张纸跟我们无关。',
      en:
        ...
        'In 1215, roughly 40 to 50 percent of people in England were villeins — bonded to the land. Fewer than half were free men. That charter everyone is talking about — the one that says "no free man shall be seized" — it is not talking about us.\n\n' +
        'We are among those who were left out. That piece of skin on the table at Runnymede had nothing to do with us.',
    },
    deliverGoal: '[fallback]',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我十五岁那年逃到离庄园三十里外的一个集镇。中世纪有条规矩："住在自治市里满一年又一天的人，自动成为自由人"。我在镇上磨坊学徒，熬过那一年又一天。后来攒了钱，回村边买了块小地，自己开磨坊。我儿子今年六岁，正在外面追鸡。\n\n' +
        '有一天，一个路过的律师在我这里歇脚。聊到磨面价钱、近期收成，最后他随口提了一句：你知道 1215 年 Runnymede 那张纸吗？里面有第三十九条——任何 free man（自由人）不能被随便抓走、夺走财产，必须经过合法审判。\n\n' +
        '我说，我知道那张纸。我那年十三岁，躲在树后面看他们签。但那条不保护我，那年我家还是农奴。\n\n' +
        '律师没多想，喝完水付了铜板，骑马走了。\n\n' +
        '我一个人坐在磨坊里，心里一沉，半天说不出话。\n\n' +
        ...
        '我不知道这算好事还是坏事。那一句"任何 free man 不能被随便抓走"，我翻来覆去想了一整个下午。',
      en:
        'Twenty-something years later. I was thirty-five, and I was no longer a villein.\n\n' +
        'When I was fifteen, I ran away to a market town about thirty miles from the manor. There was a medieval rule: "if a man lives in a chartered town for a year and a day, he becomes a free man." I got through that year and a day as a mill apprentice. Years later, with savings, I came back, bought a small plot near the village, and set up my own mill. My son is six years old now, chasing chickens out in the yard.\n\n' +
        'One day a traveling lawyer stopped at my mill to rest. We talked about flour prices and the harvest. At the end, he mentioned in passing: do you know about that piece of skin from Runnymede in 1215? Inside it there is Article 39 — no free man shall be seized or stripped of his property without lawful judgment.\n\n' +
        'I said, I know that document. I was thirteen that day, hiding behind a tree, watching them stamp it. But that clause did not protect us — my family were still villeins then.\n\n' +
        'The lawyer was not making a point. He drank his water, dropped a copper coin on the counter, and rode off.\n\n' +
        'I sat alone in the mill. Something tightened in my chest, and for a long while I could not say anything.\n\n' +
        'I thought of that thirteen-year-old behind the oak. Back then, I was certain that piece of skin had nothing to do with me. Today I suddenly understood — I am a free man now, and my son will be too. If the authorities ever try to seize him, that piece of skin I watched them stamp twenty-two years ago — he can point to it.\n\n' +
        ...
        'I do not know whether to call this good or bad. I thought about that one line — "no free man shall be seized" — again and again, for the rest of the afternoon.',
    },
    deliverGoal: '[fallback]',
  ...
  },
  {
    ...
    content: {
      cn:
        'Tom 活到什么时候，没人知道——他不识字，没人给他写传记。但他的子孙后来怎么样，历史告诉了我们。\n\n' +
        '1348 年，黑死病（Black Death）席卷英格兰，每四个人里死掉将近两个。农奴大量死亡，地里没人干活，地主突然发现自己需要农奴，比农奴需要他们还迫切。劳动力一下子值钱了：留下来的农奴敢要工钱、敢谈条件、敢往城里跑。\n\n' +
        '地主想用旧规矩挡住这股浪，没挡住。到十五世纪，英格兰的农奴制（serfdom）基本自然消失——不是靠一纸法令，是黑死病搅动了所有人的活路。\n\n' +
        '1381 年，瓦特·泰勒（Wat Tyler）带农民在肯特郡起义，几万人进了 London，要求废除农奴制。带头的人讲的不是 Magna Carta，而是约翰·鲍尔（John Ball）那句名言："亚当耕田、夏娃织布的时候，谁是绅士？"——本来人人平等，凭什么有贵族、有农奴？起义被镇压，Wat Tyler 死了。\n\n' +
        '要说清楚：第三十九条**并不是这场起义直接引用的武器**。Article 39 真正进入普通人话语，要等 400 年后 17 世纪英国法学家 Edward Coke 重新解读它的时候。\n\n' +
        '历史的扩展是慢的。Tom 的后代慢慢成了自由人，靠的是黑死病、是城市、是约翰·鲍尔的话。Article 39 等了他们好几百年，才轮到他们用。',
      en:
        'Nobody knows when Tom died — he could not read or write, and no one wrote his story down. But history tells us what happened to his descendants.\n\n' +
        'In 1348, the Black Death swept through England. Nearly half the population died. The villeins died in enormous numbers, the fields went unworked, and suddenly the lords needed workers far more than the workers needed them. Labor became valuable: the villeins who survived began to bargain — asking for wages, setting conditions, fleeing to the towns.\n\n' +
        'The lords tried to hold back the tide with the old rules. It did not work. By the fifteenth century, serfdom (the villein system) had mostly disappeared from England — not through any single law, but because the Black Death had upended the way everyone made a living.\n\n' +
        'In 1381, Wat Tyler led a peasant revolt in Kent. Tens of thousands marched into London demanding an end to serfdom. The leading voice was not Magna Carta. It was the priest John Ball, with his famous question: "When Adam delved and Eve span, who was then the gentleman?" People were originally equal — why should there be lords and serfs? The revolt was crushed, and Wat Tyler was killed.\n\n' +
        'A note for accuracy: Article 39 was **not** a weapon the 1381 rebels directly used. It only entered the ordinary person\'s vocabulary much later — in the 17th century, when the English jurist Edward Coke reread it and gave it a constitutional meaning. That was four hundred years after Runnymede.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '1215 年，英格兰约 40-50% 的人是 villein 农奴，加上女性等被排除者，不到一半人口是"free man"（自由人）。Tom 是被排除的人之一。\n\n' +
        '同一年的南宋是另一种活法——没有西欧式农奴制。佃农有人身自由，自由民的儿子理论上可以读书考科举（但有门槛："贱籍"被禁应试，多数底层人也读不起书）。\n\n' +
        '还有第三条路：宋代县乡有**乡约**（1076 年起的蓝田吕氏乡约）和**义庄**（1049 年起的范仲淹义田）——靠宗族和乡里互助给农村底层提供**集体保护**：饥荒救助、教育资助、纠纷调解。不是法律，是民间安全网。\n\n' +
        '英国走"法律慢慢扩展"，中国走"个人考试 + 民间互助"——两条路都有真实代价。\n\n' +
        '**英国路的代价**：Tom 和儿子 1215 年没有任何保护。地主今天打他，Magna Carta 管不到——那纸为未来写，不为今天的农奴写。200 年后的扩展也是黑死病逼出来的，不是贵族主动给的。\n\n' +
        '**中国路的代价**：科举只给个人机会，不给集体保护。整个农民群体没有法律机制约束皇权。乡约义庄能管小范围互助，却管不了"整个国家怎么对待农民"——全是民间自治，没强制力，遇强势地主或贪官就挡不住。\n\n' +
        '如果你是 Tom——你宁愿活在 1215 英国，还是同代南宋？还是两个都不够？想 30 秒。',
      en:
        'In 1215, roughly 40–50 percent of England\'s people were villeins (bonded farmers) — plus women and others excluded in writing — making fewer than half of England truly "free men." Tom was one of the excluded.\n\n' +
        'The same year, in Southern Song China, farmers lived differently. There was no Western-style serfdom (a system binding people to the land without freedom to leave). Tenant farmers had personal freedom, and in theory a free commoner\'s son could study and sit the imperial examinations (keju, a competitive civil service exam) — though barriers applied: "debased" categories (jianji) were barred, and most poor families could not afford the books and years of study.\n\n' +
        'There was also a third path. Song-era counties and villages had ***xiangyue*** (community covenants — the Lü family covenant of 1076) and ***yizhuang*** (charitable estates — Fan Zhongyan\'s charitable land of 1049). Through clan and community mutual aid, these gave the rural poor **collective protection**: famine relief, education funds, dispute mediation. Not law — a folk safety net.\n\n' +
        ...
        '**The cost of the Chinese path:** The exams offered only individual opportunity, not collective protection. The farming population, as a group, had no legal mechanism to constrain imperial power. Xiangyue and yizhuang helped at small scale, but could not constrain how the state itself treated farmers — and with no enforcement power, a strong landlord or corrupt official could simply ignore them.\n\n' +
        'If you were Tom — would you rather live in 1215 England, or in Southern Song China? Or are both insufficient? Take thirty seconds.',
    },
    deliverGoal:
      '同代南宋是另一种活法——没有西欧式农奴制——' +
      '南宋走"个人科举 + 民间互助"（乡约、义庄）——' +
      ...
      '两条路都有真实代价——你愿意活在哪条？',
    engagementHook:
      '如果你是 Tom——1215 英国（法律慢慢扩展）vs 同代南宋（个人科举 + 民间互助），你宁愿活在哪条路？还是两条都不够？先在心里想想你怎么选，下一节我会正式问你。',
  ...
  // ═════ Meta ═════
  {
    ...
    engagementHook:
      '走完 Tom 这一遍——一个被那张纸排除的 13 岁农奴，要等 200 年后子孙才慢慢被覆盖。你会怎么评价这种"慢慢扩展"的法律？再想一步：如果你是 Tom，1215 英国（法律慢慢扩展）和同代南宋（个人科举 + 民间互助）这两条路，你宁愿活在哪一条？',
    expectedLength: '120-160 字',
    expectsRealAnswer: true,
  },
];
...
export var lenses = {
  'king-john': {
    id: 'king-john',
    icon: '👑',
    name: { cn: '约翰王', en: 'King John' },
    role: {
      cn: '英格兰国王 / 1199-1216 perpetrator-loser 视角',
      en: 'King of England / 1199-1216 perpetrator-loser lens',
    },
    description: {
      cn: '他是一个输红了眼的国王，刚被自己的贵族打败，首都没了，军费没了。这一遍让你从他眼里看那张被逼盖印的纸，他签的时候，心里已经在算怎么撕掉它。',
      en: 'He is a king who has lost everything but his crown, beaten by his own barons, capital gone, treasury empty. This pass puts you behind his eyes as they force him to seal the parchment, while he is already plotting how to tear it up.',
    },
    // 旧字段 fallback
    nameCn: '约翰王',
  ...
  'stephen-langton': {
    id: 'stephen-langton',
    icon: '✍️',
    name: { cn: '斯蒂芬·朗顿', en: 'Stephen Langton' },
    role: {
      cn: 'Canterbury 大主教 / 1213-1228 lonely mediator 视角',
      en: 'Archbishop of Canterbury / 1213-1228 lonely mediator lens',
    },
    description: {
      cn: '他是一个在国外流亡了六年的学者，刚被允许踏上英国的土地，国王和贵族已经磨刀霍霍。这一遍让你跟他坐下来起草那六十三条，看一个手无寸铁的人怎么用一支笔，把一场内战改写成一部法律。',
      en: 'He is a scholar just back from six years of exile, finding his king and his nobles already sharpening their swords. This pass sits you beside him as he drafts those 63 clauses, watching an unarmed man rewrite a civil war into a law.',
    },
    // 旧字段 fallback
    nameCn: '斯蒂芬·朗顿',
  ...
  'tom-villein': {
    id: 'tom-villein',
    icon: '🐑',
    name: { cn: 'Tom 农奴男孩', en: 'Tom the villein boy' },
    role: {
      cn: '13 岁农奴 / invisible commoner 视角',
      en: '13yo villein boy / invisible commoner lens',
    },
    description: {
      cn: '他是一个十三岁的农奴男孩，在 Runnymede 河边放羊，看见一队队铁甲骑兵从北边的路过去。这一遍让你蹲在那棵橡树后头，跟他一起看一件他完全不懂、却要等三十年才慢慢回过味来的事。',
      en: 'He is a thirteen-year-old serf tending sheep at Runnymede, watching column after column of armored riders pass up the road. This pass crouches behind the oak with him, taking in a scene he cannot read and will not grasp for thirty years.',
    },
    // 旧字段 fallback
