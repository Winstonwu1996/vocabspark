  ...
  // ═════ Synthesis（真 Socratic）═════
  {
    ...
    content: {
      cn:
        ...
        '**读法 B（修正派，J.C. Holt 等 20 世纪史学家）**：Magna Carta 只保护约 10% 的上层男性。它给"自由"装了一个封建贵族版的定义，反而让这个定义在法律里固化了几百年。90% 的人被系统性排除——而且排除得合法。这样说来，Magna Carta 不是民主的起点，是精英用法律锁住特权、让真正的民主推迟 600 年的工具。\n\n' +
      ...
      en:
        ...
        '**Reading B (revisionist interpretation, J.C. Holt and others, 20th century):** Magna Carta protected roughly the top 10 percent of the male population. It took the concept of "liberty" and sealed it inside a feudal definition — liberty as the preserved privilege of a landed elite. The 90 percent who were excluded were excluded *legally*, with the document\'s own language. By this reading, Magna Carta did not launch democracy. It gave aristocrats a legal mechanism to protect their own status and arguably pushed genuine democratic expansion back by six hundred years.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '比这早 564 年，651 年唐高宗颁布《唐律疏议》：12 卷，502 条，有详细注疏，覆盖刑事、民事、行政，管皇族也管平民，是当时亚洲最系统的成文法典之一。后来朝鲜、日本、越南的法律都从它派生。\n\n' +
      ...
      en:
        ...
        'Six hundred and sixty-four years earlier, in 651 CE, the Tang emperor Gaozong promulgated the *Tang Code* (*Tanglü Shuyi*): twelve volumes, 502 articles, with detailed commentary, covering criminal, civil, and administrative law, applying to everyone from royalty to commoners. It was one of the most systematically developed legal codes in Asia at the time. The legal systems of Korea, Japan, and Vietnam all derived from it.\n\n' +
...
var stephenLangtonStoryboard = [
  ...
  },
  {
    ...
    content: {
      cn:
        '现在换一个比较视角。\n\n' +
        'Stephen Langton 不是历史上第一个"把权力约束写进成文法典"的人。比他早 564 年，651 年长孙无忌主编颁布《唐律疏议》——12 卷 502 条，有逐条注解，管皇族也管平民，是当时亚洲法律技术水平最高的文本之一。它后来影响了整个东亚。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '同一年，南宋的农民处境是另一个样子。南宋没有农奴制——佃农有人身自由，理论上他的儿子可以读书参加科举，考过了就能做官，甚至有极少数农家出身的人真的做到了宰相级别。伦理上国家认这条路。\n\n' +
      ...
      en:
        ...
        'The same year, farmers in Southern Song China lived differently. There was no serfdom (a system binding people to the land without freedom to leave) there — tenant farmers had personal freedom. In theory, a farmer\'s son could study, pass the imperial examinations (*keju*, a competitive civil service exam open to all males), and become an official. A very small number of men from farming families genuinely rose to senior government positions. The state recognized this path.\n\n' +
