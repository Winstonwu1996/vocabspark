...
var stephenLangtonStoryboard = [
  ...
  },
  {
    ...
    content: {
      cn:
        '我出生在 1150 年前后，Lincolnshire，英国中部一个普通家庭。没有贵族血统，没有土地，没有城堡。\n\n' +
        '十九岁那年我去巴黎大学——十二世纪欧洲的学术中心，神学家、法学家、医生挤在同一条街上争论。我在那里整整待了将近三十年。不是混日子，是真做学问：把整本《圣经》从头到尾分了章、分了节——今天你打开任何版本的《圣经》，看到的那套章节编号就是我在 1180 年代定的。\n\n' +
        '我还教 canon law（教会法，Church law）。教皇 Innocent III 年轻时在巴黎读书，我们是同窗。\n\n' +
        ...
        '这一等就是六年。六年里，整个英国因为我一个人，陷进了一场长达六年的宗教危机。',
      en:
        'I was born around 1150, in Lincolnshire — central England, a plain family, no noble title, no land, no castle.\n\n' +
        'At nineteen I went to the University of Paris — the intellectual center of twelfth-century Europe. Theologians, canon lawyers, physicians all argued in the same streets. I stayed nearly thirty years. Not passing time — doing real scholarship. I divided the entire Bible, from Genesis to Revelation, into chapters and verses. The numbering system in every Bible you open today is the one I set in the 1180s.\n\n' +
        'I also taught canon law (教会法 / Church law). Pope Innocent III studied in Paris when he was young. We knew each other from those years.\n\n' +
        ...
        'When King John learned of the appointment, he refused to let me land in England. He wanted his own man in that seat. So I was stranded at Pontigny Abbey in France — sitting on the French side of the Channel, watching England from a distance, with no way in.\n\n' +
        'That wait lasted six years. Six years in which the whole of England fell into a religious crisis, and the sole reason was a dispute over one man: me.',
    },
    deliverGoal: '[fallback]',
  ...
  },
  {
    ...
    content: {
      cn:
        '1208 年，教皇发出 Interdict（停教令）：全英国的教堂关门，婚礼停办，死人不能按教会仪式下葬，婴儿不能受洗。这道命令的导火索就是 John 拒绝让我回国。整个英国因为我一个人的任命，陷进了六年的宗教恐慌。\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '1214 年 7 月 27 日，Bouvines 战役。John 精心筹备了四年的反法联盟彻底崩溃——神圣罗马帝国皇帝 Otto IV 弃马逃走，John 的同父异母弟弟 William Longespée 被俘。John 退回英国，手里已经没有任何重新夺回法国领地的筹码。\n\n' +
        '消息传到英国，贵族们等的时机到了。1215 年 4 月，四十多位北方贵族在 Stamford 集结，正式向 John 发出 defiance（宣战书）——中世纪封建术语，意思是撤销效忠誓 fealty（loyalty oath to feudal lord）。5 月 5 日他们正式断绝效忠。5 月 17 日，伦敦城门由市民从里面打开迎接贵族军队。伦敦商人也恨 John 的苛税。\n\n' +
      ...
      en:
        'July 27, 1214. The Battle of Bouvines. The anti-French coalition John had spent four years building collapsed entirely. Holy Roman Emperor Otto IV abandoned his horse and fled. John\'s half-brother William Longespée was captured. John retreated to England with nothing left — no allies, no money, no path back to the French lands he had lost a decade earlier.\n\n' +
        'When the news reached England, the barons saw their moment. In April 1215, more than forty northern barons gathered at Stamford and sent John a formal defiance — in medieval feudal terms, this meant withdrawing their fealty (效忠誓 / loyalty oath to a feudal lord). On May 5 they formally renounced their allegiance. On May 17, the gates of London were opened from the inside by the city\'s own merchants. London\'s traders hated John\'s taxes too.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '四十九条原文里，没有第三十九条。这一条是我自己加进去的。\n\n' +
        '贵族们要的是具体保护：不要乱收钱，不要随便没收庄园。合理。但他们没有往更远想。我在巴黎读过 Henry I 的 Charter of Liberties（1100 年，一百一十五年前的旧文件，里面国王承诺不滥用权力）。我知道，保护今天二十五个贵族的条款，下一代国王可以用另一种借口绕开。\n\n' +
        '必须写一条能穿越时间的。\n\n' +
        '我写下六个拉丁词：\n\n' +
        '*Nullus liber homo capiatur...*\n\n' +
        '意思是：任何 free man（自由人）不能被随便逮捕、监禁或剥夺财产，除非经过他同辈的合法审判，或者按照国法。\n\n' +
        '我用了"free man"——不是"baron"，不是"knight"，是"free man"。\n\n' +
        '1215 年的 free man 大概只有全英国人口的十分之一，主要是贵族和自由农民。但"free man"这个词是开放的——是谁，由未来决定。如果有一天农奴被解放，他们就成了 free man。如果有一天商人取得公民权，他们也是 free man。这个词没有把边界钉死。\n\n' +
        '我不敢说我当时预见了八百年后。我只知道，写法律不应该只为今天写。',
      en:
        'Clause 39 was not in the original forty-nine. I added it myself.\n\n' +
        ...
        'I needed to write a clause that could survive across time.\n\n' +
        'I wrote six Latin words:\n\n' +
        '*Nullus liber homo capiatur...*\n\n' +
        ...
        'I used the words "free man" — not "baron," not "knight." Free man.\n\n' +
        'In 1215, free men were perhaps one tenth of England\'s population: mainly nobles and free farmers. But "free man" is an open category. Who counts as a free man is something each generation decides for itself. If serfs were ever freed, they would become free men. If merchants ever gained rights, they would be free men too. The boundary of the word was not nailed shut.\n\n' +
        'I will not claim I foresaw eight hundred years of history. I only knew that a law should never be written for today alone.',
    },
    deliverGoal: '[fallback]',
  ...
  },
  {
    ...
    content: {
      cn:
        '仪式结束后我没有庆祝。\n\n' +
        '我在 Runnymede 草地上站了很久，看着贵族们骑马散去，看着 John 的队伍回 Windsor。我手里还拿着那卷羊皮纸的副本，羊皮纸上的蜡封还是暖的。\n\n' +
        '我知道 John 不会认。一个人在胁迫下盖印，他在心里从来没有同意。我在他的眼睛里看到的，不是接受，是计算。\n\n' +
        '果然——六月底，他派密使出发去罗马，带着一封信给教皇 Innocent III。信里的逻辑精明：这份文件限制了他这个 vassal（封臣），也就等于限制了他的封建上位者教皇的权威。教皇会接吗？\n\n' +
        '教皇接了。1215 年 8 月 24 日，Innocent III 签发敕令：Magna Carta 无效，永远无效。签这份文件的起草人我，也被暂停大主教职务，理由是"支持反叛"。\n\n' +
        '我第二次流亡。这次去罗马上诉。\n\n' +
        '1216 年 10 月，John 死了。摄政是 William Marshal，七十岁的老骑士。他做了一件我没想到的事——1216 年 11 月，他以九岁新王 Henry III 的名义，重新颁布 Magna Carta。他加了一句话：此乃国王恩赐。\n\n' +
        '这句话给文件穿上了合法外衣——不再是贵族逼出来的，是国王主动给的。\n\n' +
        '我在罗马听到这个消息时，沉默了很久。那张被我改写了五天的羊皮纸，活过了发出它的国王，活过了废掉它的教皇。它还在。',
      en:
        'I did not celebrate when the ceremony ended.\n\n' +
        'I stood on the Runnymede meadow for a long time, watching the barons ride off, watching John\'s retinue head back toward Windsor Castle. I still held a copy of the parchment. The wax seal was still warm.\n\n' +
        ...
        'As I expected — by late June, he dispatched a secret messenger to Rome, carrying a letter for Pope Innocent III. The argument was sharp: this document restrained him as a vassal (封臣 / feudal subordinate), which meant it also restrained the authority of his feudal superior, the Pope. Would the Pope allow that?\n\n' +
        'The Pope would not. On August 24, 1215, Innocent III issued a papal bull: Magna Carta was null and void — null and void forever. As for me, the man who had drafted it, my archbishopric was suspended. The stated reason: supporting rebellion.\n\n' +
        'I went into exile a second time, this time to Rome to appeal.\n\n' +
        'In October 1216, John died. The regent was William Marshal — a knight of seventy years. He did something I had not anticipated. In November 1216, in the name of the nine-year-old new King Henry III, Marshal reissued Magna Carta. He added a single line: this is granted as a gift from the King.\n\n' +
...
var tomVilleinStoryboard = [
  {
    ...
    content: {
      ...
      en:
        ...
        'My name is Tom. I am thirteen years old. My family lives on Mowbray manor, near a stretch of meadow along the Thames called Runnymede. I have never left this place. My father is a villein (a serf — a farmworker bound to the land who cannot leave), and I am one too, and I will always be one.\n\n' +
        'That morning, an army came. First came the sound of hooves — far away, like thunder. Then the horsemen: men in iron armor, riding in long columns, one after another, moving north along the road past our manor. I had never seen so many armed men in my life. The dogs in the yard were all barking. My mother pulled my little brother inside.\n\n' +
        'I did not go inside. I ran along the riverbank and hid behind a big oak tree, looking out across the meadow.\n\n' +
        'On the grass, some tables had been set up. A heavy man in fine clothes sat on one side — about twenty iron-armored men stood around him, hands on their sword hilts. A man in a wide archbishop\'s robe stood between the two groups. On the table there was a flat piece of skin, some wax, and a stamp. I did not understand what they were doing.\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '每年收成，三分之一交给地主，十分之一交给教会，剩下的才是我们自己的。遇到坏年景，剩下的就不够吃。\n\n' +
        '我们不能识字。村里只有教堂的神父会读书写字。我爸跟我说，识字是绅士的事，不是我们的事。\n\n' +
        '我们也不能去告状。要是地主的管事打了人，我们去哪里说？法庭那些东西，跟我们没关系。\n\n' +
      ...
      en:
        ...
        'Serfdom (the villein system — being bound to the land and lord) means you belong to the manor. You cannot leave. My father once said he wanted to travel to a market in the south. The lord\'s steward said no. No reason given. Just no.\n\n' +
        'Every harvest, one third goes to the lord. One tenth goes to the church. Whatever is left is ours. In a bad year, what is left is not enough to eat.\n\n' +
        ...
        'In 1215, roughly nine out of ten people in England were villeins. Only one out of ten was a free man. That charter everyone was talking about — the one that said "no free man shall be seized" — it was not talking about us.\n\n' +
        'We were the nine out of ten. That piece of skin on the table at Runnymede had nothing to do with us.',
    },
    deliverGoal: '[fallback]',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '我爸有一天跟我说："王跟那些穿铁衣的人要打起来了。贵族（baron）嫌税太重，说要起兵。但你记住，不管谁赢，最后吃亏的是我们。大老爷打仗，粮食从哪来？从地里来，从我们手里来。"\n\n' +
  ...
  },
  {
    ...
    content: {
      cn:
        '三十年后，我二十八岁，已经不是农奴了。\n\n' +
        '我爸在我二十岁那年攒够了钱，买了一份自由身的文书，我们家就算脱了农奴（villein）的身份，成了自由人。我在庄园边做磨坊主，磨面粉，日子比以前好一点。\n\n' +
        '有一天，一个路过的律师在我这里歇脚，我们聊起来。他说，你知道 1215 年 Runnymede 那张纸吗？里面有第三十九条，Article 39，写着：任何 free man（自由人）不能被随便抓走，不能被随便夺走财产，必须经过合法的审判。\n\n' +
        '我说，我知道那张纸。我那年十三岁，躲在树后面看他们签。但那条不保护我，那年我家还是农奴，农奴不是 free man。\n\n' +
        '律师停了一下，说：对，1215 年保护不了你家。但你现在是自由人了。你儿子呢？你儿子要是遇上官府随便抓人，这条他可以拿出来说话。\n\n' +
        '我心里咯噔了一下，说不出话来。\n\n' +
        '我想到 1215 年草地上的那个画面。那时候我不知道那张纸写了什么，也知道跟我没关系。但现在律师说，我儿子，可能有关系了。\n\n' +
        '那条 Article 39 没有在 1215 年保护我家。但它在那里放着，放了三十年，等着我儿子变成可以用它的人。\n\n' +
        '我不知道该说这是好事还是坏事。我只是坐在磨坊里，把那句话翻来覆去想了很久。',
      en:
        'Thirty years later, I was twenty-eight years old, and I was no longer a villein.\n\n' +
        'When I was twenty, my father had saved enough money to buy a document of freedom. Our family was released from villeinage — serfdom, being bound to the land. I became a millward, running a grain mill at the edge of the manor. Life was a little better than before.\n\n' +
        'One day, a traveling lawyer stopped to rest at my mill. We got to talking. He said: do you know about the piece of skin from Runnymede in 1215? Inside it there is Article 39 — it says: no free man shall be seized or imprisoned, or stripped of his property, without lawful judgment.\n\n' +
        'I said, I know that document. I was thirteen years old that day. I hid behind a tree and watched them stamp it. But that clause did not protect us — my family were still villeins then, and villeins are not free men.\n\n' +
        'The lawyer paused. He said: you are right, it could not protect your family in 1215. But you are a free man now. What about your son? If the authorities someday try to seize him without a lawful reason, he can point to that clause and speak.\n\n' +
        'Something dropped inside my chest. I could not find words.\n\n' +
        'I thought about that meadow in 1215. I had not known what was written on that piece of skin, and I had known it had nothing to do with us. But now the lawyer was telling me — my son, maybe it had something to do with him after all.\n\n' +
        'Article 39 did not protect my family in 1215. But it sat there for thirty years, waiting for my son to become the kind of person it could protect.\n\n' +
        'I do not know whether to call this a good thing or a bad thing. I only sat in the mill and turned that sentence over in my mind for a long time.',
    },
    deliverGoal: '[fallback]',
  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '地主们想用旧规矩挡住这股浪，没有挡住。十四世纪末，越来越多的农奴要么买了自由身，要么直接逃进城里。到十五世纪，英格兰的农奴制（serfdom）基本自然消失了，不是靠一纸法令，是靠黑死病重新洗牌了整个劳动市场。\n\n' +
        '1381 年，有人把这股浪推到了最高点。瓦特·泰勒（Wat Tyler）带着农民在肯特郡起义，几万人进了 London。他们打出的口号里有一条，直接引用 Magna Carta 第三十九条（Article 39）：任何 free man 不能被随便抓走。他们说：我们也是人，那条里写的 free man，也该算我们。\n\n' +
        '起义被镇压了。Wat Tyler 死了。但那个声音没有死：那条写了一百六十六年的 Article 39，第一次被底层的人拿来替自己说话。\n\n' +
        'Tom 的后代真的成了自由人。只是他没能亲眼看到。',
      en:
        ...
        'The lords tried to hold back the tide with the old rules. It did not work. By the late fourteenth century, more and more villeins had either bought their freedom or simply walked away. By the fifteenth century, serfdom (the villein system) had mostly disappeared from England — not through any single law, but because the Black Death had reshuffled the whole labor market.\n\n' +
        'In 1381, someone pushed this wave to its highest point. Wat Tyler led a peasant revolt in Kent. Tens of thousands of people marched into London. One of the things they demanded — they quoted Article 39 of Magna Carta directly: no free man shall be seized without lawful judgment. They said: we are people too. The free men in that clause should include us.\n\n' +
        'The revolt was crushed. Wat Tyler was killed. But the voice did not die. Article 39, written 166 years earlier, was used for the first time by ordinary people at the bottom to speak on their own behalf.\n\n' +
        "Tom's descendants did become free people. He just did not live to see it.",
    },
    deliverGoal: '[fallback]',
