...
var kingJohnStoryboard = [
  {
    ...
    deliverGoal:
      '第一人称约翰王（King John）。1215 年 6 月 15 日清晨，我骑马到 Runnymede 草地。下着小雨。' +
      '25 个贵族（baron）全副武装站在我对面。我手在抖——不是冷，是愤怒。' +
      '我必须在一张羊皮纸上盖下**Great Seal（王室印玺）**：双面青铜印模，约 1.5 公斤重，' +
      '一面是我骑马像，一面是我坐王座像，刻着拉丁文 SIGILLUM JOHANNES REX（约翰王玺）。' +
      '熔化的红蜡滴在羊皮纸上，我把印模压下去，纹章留下。' +
      '盖完我心里只有一句话："等你们走，我就让教皇废了它。"' +
      '我是约翰王。接下来 11 节你会跟我经历 16 年，看我怎么走到这一刻。',
    engagementHook: '我为什么走到这一刻？倒回 1199 年我刚做王那天。',
    expectedLength: '200-240 字（用句号 + 逗号正常断句——1-2 个戏剧 em-dash 即可，不要轰炸）',
  ...
  },
  {
    ...
    deliverGoal:
      '1208 年教皇英诺森三世（Innocent III）跟我闹翻——他要任命 Stephen Langton 为 Canterbury 大主教，我不接受。' +
      '3 月 23 日，教皇下 **Interdict（停教令——全英国教堂关门，婴儿不洗礼，死人不下葬）**。' +
      '这还不够。1209 年 11 月，教皇又对我个人 **excommunicate（绝罚——开除教籍）**。' +
      '按教法，被绝罚的国王，他的臣民可以**不必效忠**——这是终极武器，' +
      '贵族现在有了背弃我的法律理由。' +
      '我扛了 5 年。直到 1213 年 5 月 15 日，我在 Dover 跪下——把英格兰"献给"教皇做封地，' +
      '每年付 1000 银马克贡。众贵族眼睁睁看着自家君王跪在罗马脚下，心中只剩一句：这样的王，还值得效忠？' +
      '——这是我此生最深的耻辱。',
  ...
  },
  {
    ...
    deliverGoal:
      ...
      '1789 年美国宪法第 5 修正案 + 第 14 修正案，直接继承 Article 39 的 *due process*（正当法律程序）语言。' +
