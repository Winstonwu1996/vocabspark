...
export var lenses = {
  'king-john': {
    ...
    name: 'King John',
    nameCn: '约翰王',
    role: '英格兰国王 / 1199-1216 perpetrator-loser 视角',
    description: '英格兰国王，在位 17 年丢掉了诺曼底、和教皇打了 6 年、被自己贵族打输一场内战。1215 年 6 月 15 日被逼盖印 Magna Carta，但当晚就在写信请求教皇废掉它。这个视角 让你从 perpetrator-loser 内部看这张纸是怎么诞生的。',
  ...
  'stephen-langton': {
    ...
    nameCn: '斯蒂芬·朗顿',
    role: 'Canterbury 大主教 / 1213-1228 lonely mediator 视角',
    description: 'Canterbury 大主教 + 巴黎大学法学博士。1207 年被教皇任命，国王不让他登陆英国，他在法国流亡 7 年。1213 年回英国，2 年后亲手起草 Magna Carta 第 39 条——这一句 800 年后还在美国宪法第 5 修正案里。这个视角 让你看一个 mediator 怎么把贵族的怒火写成能跨越时代的法律语言。',
  ...
  'tom-villein': {
    ...
    role: '13 岁农奴 / invisible commoner 视角',
    description: '13 岁农奴男孩，住在 Runnymede 旁边的 Mowbray 庄园。1215 年 6 月 15 日他在河边放羊，看到一队队骑兵从北边路过去那片草地。他不识字，不懂草地上发生了什么。这个视角 让你从被 charter 排除的 90% 的人内部看那一天，以及 200 年后他子孙才被覆盖的扩展机制。',
