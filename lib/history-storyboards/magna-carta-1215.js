  ...
  },
  {
    ...
    content: {
      cn:
        ...
        '教皇真的在 8 月废了 Magna Carta——但贵族不认。他们去法国请来法王的儿子 Louis 当英格兰王。内战重新开打。1216 年 9 月我在 The Wash 海湾（英格兰东部潮汐湾）过河时丢失了大量辎重——加冕器物和银箱沉入沼泽（学界对这一传说仍在争论：可能是 Roger of Wendover 13 世纪修士的渲染）。10 月，我病倒了。\n\n' +
        '弥留之际，我数我留下了什么——\n\n' +
        '"我失去了 Normandy。"\n\n' +
        '"我跪过教皇。"\n\n' +
        '"我让贵族集体造反。"\n\n' +
