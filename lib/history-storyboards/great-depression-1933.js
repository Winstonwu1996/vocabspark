...
export var francesPerkinsLens = {
  ...
  icon: '🧷',
  description: {
    cn: '她是 1911 年 3 月 25 日在纽约街对面喝下午茶、忽然听见尖叫的那个女人,,抬头看见女工一个个从八楼着火的窗口跳下来，因为车间的门被老板从外面锁死了。那一天定了她这辈子要做的事。1933 年罗斯福请她当劳工部长（美国头一个女性内阁部长），她没立刻答应，先递给他一张条件清单：养老金、失业救济、最低工资、限制童工、一张兜住普通人的安全网。这一遍让你跟她坐进会议室里：她常常是屋里唯一的女人，被男人们绕过、轻视，她要决定哪些角必须保住、哪些角不得不剪掉。',
    en: 'She is the woman across the street having tea in New York on 25 March 1911 when she heard the screaming, looked up and saw women workers leaping one after another from the eighth-floor windows, because the workroom doors had been locked from the outside by the bosses. That day decided what she would do with her life. In 1933 Roosevelt asked her to be Secretary of Labor, the first woman in an American cabinet, and she did not say yes at once but handed him a list of conditions first: old-age pensions, unemployment relief, a minimum wage, limits on child labor, a safety net to catch ordinary people. This pass puts you with her in the meeting rooms, often the only woman there, talked past and dismissed by the men, as she decides which corners of that net must be kept and which corners she will be forced to cut.',
  },
  storyboard: [
    {
      id: 'fp-n1',
...
export var displacedSharecropperLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是 1933 年冬天密西西比那个被地主敲门赶走的人（合成人物，他经历的每件事，是那几年南方千千万万人真实经历过的）。地主手里捏着一封政府寄来的信，对他说：政府给我寄了钱，今年地要少种，你们一家不用留了。他的爷爷生下来是奴隶、内战后自由却一辈子还不完的债；他爹这么过了一辈子；他三代人弯腰在这片地上，可这地从来不是他们的。这一遍让你跟他一起站在自家门口听这句话：报纸说政府来「救农民」,,他也是农民，可政府寄来的钱，怎么成了把他赶走的那一脚。',
    en: 'He is the man whose door the landlord knocks on in Mississippi in the winter of 1933 (a composite person; everything he lives through was lived by millions in the South in those years). In the landlord\'s hand is a letter from the government, and he says: the government sent me money, this year we plant less, your family does not need to stay. His grandfather was born a slave, freed after the Civil War yet never out of debt; his father lived the same way; three generations have bent over this soil, yet it was never theirs. This pass puts you with him at his own door hearing that line: the newspapers say the government has come to "save the farmers," and he is a farmer too, yet the money the government mailed has become the boot that kicks him out.',
  },
  storyboard: [
    {
      id: 'ds-n1',
