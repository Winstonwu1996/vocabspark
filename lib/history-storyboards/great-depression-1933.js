...
export var fdrLens = {
  ...
  icon: '🦽',
  description: {
    cn: '他是 1933 年 3 月那天宣誓就任的总统，面前是一个像停了的国家：四个人里有一个没工作，银行一家接一家倒，农民的粮烂在地里因为城里人买不起。他自己也是个下半身瘫了的人，腿上绑着钢支架硬撑着站。这一遍让你跟他一起站在台上：他要做一件前面几任总统都没敢做的事,,让政府主动下场、直接花钱、直接造工作、直接救人。可他签下的这只救人的手，会不会同时漏掉一整群指望它的人？',
    en: 'He is the president sworn in that day in March 1933, facing a country that seems to have stopped: one in four people out of work, banks failing one after another, farmers\' crops rotting in the fields because city people cannot afford them. He himself is a man paralyzed below the waist, holding himself up on steel leg-irons under his trousers. This pass puts you with him on the platform as he prepares to do what earlier presidents have not dared, send the government onto the field, spend money directly, build jobs directly, save people directly. Yet will the saving hand he signs into being also leave out a whole group of people who count on it?',
  },
  storyboard: [
    {
      id: 'fdr-n1',
...
export var francesPerkinsLens = {
  ...
  icon: '🧷',
  description: {
    cn: '她是 1911 年 3 月 25 日在纽约街对面喝下午茶时听见尖叫的女人,抬头看女工一个个从八楼着火的窗口跳下,车间门被从外面锁死。那天定了她一辈子要做的事。1933 年罗斯福请她当劳工部长(美国首位女性内阁部长),她没立刻答应,先递一张清单:养老金、失业救济、最低工资、限制童工、兜住普通人的安全网。这一遍让你跟她坐进会议室:她常是屋里唯一的女人,被男人绕过、轻视,要决定哪些角保住、哪些剪掉。',
    en: 'She is the woman having tea across the street in New York on 25 March 1911 when she heard the screaming, looked up and saw women workers leaping one after another from the eighth-floor windows, the workroom doors locked from outside. That day decided what she would do with her life. In 1933 Roosevelt asked her to be Secretary of Labor (the first woman in an American cabinet), and she did not say yes at once but handed him a list first: old-age pensions, unemployment relief, a minimum wage, limits on child labor, a safety net to catch ordinary people. This pass puts you with her in the meeting rooms, often the only woman there, talked past and dismissed by the men, as she decides which corners to keep and which she will be forced to cut.',
  },
  storyboard: [
    {
      id: 'fp-n1',
...
export var displacedSharecropperLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是 1933 年冬天密西西比被地主敲门赶走的人(合成人物,经历的每件事是那几年南方千千万万人真经历过的)。地主手里捏着政府寄来的信对他说:政府给我寄了钱,今年地少种,你们不用留了。他爷爷生下来是奴隶,内战后自由却一辈子还不完债,他爹这样过了一辈子,三代人弯腰在这片地,可地从来不是他们的。这一遍让你跟他站在自家门口听这话:报纸说政府来「救农民」,他也是农民,可政府寄的钱怎么成了把他赶走的那一脚。',
    en: 'He is the man whose door the landlord knocks on in Mississippi in the winter of 1933 (a composite person; everything he lives through was lived by millions in the South in those years). In the landlord\'s hand is a letter from the government, and he says: the government sent me money, this year we plant less, your family is not needed. His grandfather was born a slave, freed after the Civil War yet never out of debt; his father lived the same way; three generations bent over this soil, yet it was never theirs. This pass puts you with him at his own door hearing that line: the newspapers say the government has come to "save the farmers," and he is a farmer too, yet the money the government mailed has become the boot that kicks him out.',
  },
  storyboard: [
    {
      id: 'ds-n1',
