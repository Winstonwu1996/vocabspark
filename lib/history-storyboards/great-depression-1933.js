...
export var fdrLens = {
  ...
  storyboard: [
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '把镜头从我个人拉远，看这场新政在更长的时间里留下了什么。\n\n往前看，我做的事，是一场百年老争论的一个顶点。美国从立国起就吵一件事：联邦政府该强，还是各州该强？早年 Hamilton（汉密尔顿）那一派要强联邦，对手要守住州权。这条张力吵了一百多年。我这一任，把天平狠狠推向了「强联邦」那一边——而且再没推回去过。（你跑过 hamilton 那个 Topic，会认得这条线的起点。）\n\n往深看，新政也是对前几十年的一个回应。镀金时代（Gilded Age）那几十年，财富疯狂集中、贫富撕裂、政府放任不管——新政某种意义上，是这个国家被那种「放任」逼到崩溃后，第一次系统地说「不能再这样了」。（你跑过 gilded-age 那个 Topic，会认得这种不平等的来路。）\n\n我把联邦政府的角色，从「守夜人」改成了「兜底人」。这个改变，到今天还在塑造每个美国人的生活——也还在被人争论。',
