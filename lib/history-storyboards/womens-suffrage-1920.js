...
export var idaBWellsLens = {
  ...
  icon: '🗞️',
  description: {
    cn: '真实历史人物，1862 年生在密西西比州，出生时还是奴隶，几个月后内战结束才获自由。16 岁父母双亡，她谎报年龄当老师，独自拉扯大几个弟妹。后来她成了全美最敢写的记者，专门调查南方的私刑，也就是白人暴民未经审判就把黑人吊死、烧死的暴行。她写的报道让她在南方收到死亡威胁、报馆被烧，被警告再回孟菲斯就没命。1913 年，她去华盛顿参加一场全国妇女游行，组织者要求黑人妇女走在队伍最后面。这一遍让你站在一个被自己人推到队尾的人这边，看一场「进步运动」里，谁有资格走在前排。',
    en: 'A real historical person, born in 1862 in Mississippi, born into slavery and freed only months later when the Civil War ended. Orphaned at 16, she lied about her age to become a teacher and raised several younger siblings alone. She became one of the boldest journalists in America, investigating the lynchings of the South, the atrocities in which white mobs hanged and burned Black people without trial. Her reporting brought death threats in the South and her press burned, with warnings that if she returned to Memphis she would not live. In 1913 she went to Washington for a national women\'s parade, where the organizers asked Black women to march at the very back. This pass puts you on the side of a person pushed to the back of the line by her own movement, watching who, in a "movement for progress," is allowed to march at the front.',
  },
  storyboard: [
    {
      id: 'ibw-n1',
