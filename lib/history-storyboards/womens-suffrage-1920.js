...
export var cadyStantonLens = {
  ...
  icon: '✒️',
  description: {
    cn: '美国妇女选举权运动的奠基者，1815 年生在纽约州一个法官家庭。1848 年她在 Seneca Falls 一张小桌子上，仿照《独立宣言》写出一份《情感宣言》，第一次公开要求妇女投票权。她口才犀利、笔锋极硬，几乎是凭一支笔点燃了整场运动。同一个她，1869 年为了争取白人女性的选票，公开反对先给黑人男性投票，说出过带种族歧视的话。这一遍让你从一个运动奠基者的内部，看一个真正的先驱怎么在「为我这样的人争权」和「把别人推到后面」之间，走出一条又勇敢又有污点的路。',
    en: 'The founder of the American movement for women\'s suffrage, born in 1815 to a judge\'s family in New York. In 1848, at a small table in Seneca Falls, she modeled a Declaration of Sentiments on the Declaration of Independence and demanded, in public for the first time, the right of women to vote. Sharp-tongued and hard-penned, she lit the whole movement almost with a single pen. The same woman, in 1869, publicly opposed giving Black men the vote first in order to win the vote for white women, and said words that carried racial contempt. This pass lets you watch, from inside a movement\'s founder, how a true pioneer walked a path both brave and stained, between "fighting for rights for people like me" and "pushing others to the back."',
  },
  storyboard: [
    {
      id: 'ecs-n1',
...
export var francesHarperLens = {
  ...
  icon: '📖',
  description: {
    cn: '非裔美国诗人和活动家，1825 年生在马里兰州 Baltimore 一个自由黑人家庭，三岁成了孤儿。她当过老师，靠写诗和演讲谋生，是当时全国最受欢迎的黑人作家之一。她一辈子站在一个最难站的位置：她既是女人，又是黑人——在一个把「为女人争权」和「为黑人争权」当成两条要二选一的战线的年代，她拒绝二选一。1866 年她在一场大会上说出一句话：「我们都被绑在一起。」这一遍让你从一个两边都不完全属于、却两边都不肯放弃的调停者身上，看一场进步运动内部的裂缝。',
    en: 'An African American poet and activist, born in 1825 to a free Black family in Baltimore, Maryland, and orphaned at three. She worked as a teacher and earned her living by poetry and lecturing, one of the most popular Black writers in the country at the time. Her whole life she stood in the hardest place to stand: she was a woman and she was Black, and in an era that treated "rights for women" and "rights for Black people" as two fronts you had to choose between, she refused to choose. In 1866, at a great convention, she said one line: "We are all bound up together." This pass lets you see the crack inside a movement for progress through a mediator who belonged fully to neither side and refused to give up either.',
  },
  storyboard: [
    {
      id: 'feh-n1',
...
export var idaBWellsLens = {
  ...
  icon: '🗞️',
  description: {
    cn: '真实历史人物，1862 年生在密西西比州，出生时还是奴隶，几个月后内战结束才获自由。16 岁父母双亡，她谎报年龄当老师，独自拉扯大几个弟妹。后来她成了全美最敢写的记者，专门调查南方的私刑——白人暴民未经审判就把黑人吊死、烧死的暴行。她写的报道让她在南方被悬赏追杀，报馆被烧。1913 年，她去华盛顿参加一场全国妇女游行，组织者要求黑人妇女走在队伍最后面。这一遍让你站在一个被自己人推到队尾的人这边，看一场「进步运动」里，谁有资格走在前排。',
    en: 'A real historical person, born in 1862 in Mississippi, born into slavery and freed only months later when the Civil War ended. Orphaned at 16, she lied about her age to become a teacher and raised several younger siblings alone. She became one of the boldest journalists in America, investigating the lynchings of the South, the atrocities in which white mobs hanged and burned Black people without trial. Her reporting got a bounty placed on her in the South and her press burned. In 1913 she went to Washington for a national women\'s parade, where the organizers asked Black women to march at the very back. This pass puts you on the side of a person pushed to the back of the line by her own movement, watching who, in a "movement for progress," is allowed to march at the front.',
  },
  storyboard: [
    {
      id: 'ibw-n1',
