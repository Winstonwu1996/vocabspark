...
export var cadyStantonLens = {
  ...
  icon: '✒️',
  description: {
    cn: '她是 1848 年 7 月围坐在 Seneca Falls 一张客厅茶桌旁的几个女人之一，仿照《独立宣言》，往那句最有名的话里加了「和女人」两个字。在那个年代，已婚女人法律上几乎不算一个独立的人：钱归丈夫，孩子归丈夫，她不能签合同、不能上大学、不能投票。这一遍让你跟她一起坐在那张茶桌旁，看她这一支笔是怎么开了一场要打 72 年的仗的第一枪。',
    en: 'She is one of the few women sitting around a parlor tea table in Seneca Falls in July 1848, modeling a declaration on the Declaration of Independence and slipping two words into its most famous line, so it read "all men and women are created equal." In that era a married woman was barely a separate person in law: her money was her husband\'s, her children were her husband\'s, she could not sign a contract, attend college, or vote. This pass puts you at the tea table with her, watching this one pen of hers fire the first shot of a fight that will last seventy-two years.',
  },
  storyboard: [
    {
      id: 'ecs-n1',
...
export var idaBWellsLens = {
  ...
  icon: '🗞️',
  description: {
    cn: '她是 1913 年 3 月 3 日从芝加哥赶到华盛顿的人，明天就是新总统就职，今天她要和几千名妇女一起在宾州大道上为投票权游行。出发前组织者把她叫到一边说：为了不得罪南方来的白人妇女，请你和所有黑人妇女走在队尾。她这辈子调查过几百起私刑案，报馆被烧、收过死亡威胁，都没让她闭嘴。这一遍让你站在她这里，看她会咽下去单独走一组，还是按她从小信的那句「没人会替你站，你得自己站」，硬挤进队伍前排。',
    en: 'She came from Chicago to Washington on 3 March 1913 to march for the vote down Pennsylvania Avenue with thousands of women. Before they set off, the organizers took her aside: so as not to offend the white women from the South, please, you and all Black women, walk at the back. She had investigated hundreds of lynchings, had her press burned, received death threats, and none of it had shut her up. This pass puts you with her, to watch her choose: swallow it and walk alone at the rear, or, by the line she has held since girlhood, "no one will stand up for you, you must stand yourself," push to the front.',
  },
  storyboard: [
    {
      id: 'ibw-n1',
