...
//   - Lens 1 (Mansa Musa) N4/N6: 设计者 — 1324 朝圣队伍组织 + Cairo 约 12% 黄金价格下降
...
//   - anti-fab: 黄金约 12% 下降 al-'Umari 个人记录 (mithqal 25→22 dirham, 不是"通胀第一次") /
...
export var mansaMusaLens = {
  ...
  perspectiveTag: 'imperial-system-projector',
  description: {
    en: 'He is a forty-four-year-old African emperor in 1324, standing at the head of a sixty-thousand-person caravan with eighty camels each loaded with three hundred pounds of gold and twelve thousand enslaved people each forced to carry four more pounds. This pass walks you out of his palace at Niani and across eight thousand kilometers to Mecca, watching one calculated journey rewrite Europe\'s mental map of West Africa for the next two hundred years.',
    cn: '他是一个四十四岁的非洲皇帝,1324 年那个夏天站在一支六万人队伍的最前头,八十头骆驼每头驮三百磅黄金,身后还跟着一万两千个被迫各自捧着四磅黄金的奴隶。这一遍让你跟他从 Niani 的王宫出发,走完八千公里到 Mecca,看一次精心计算过的旅程怎么把欧洲对西非整整两百年的认知地图重新画一遍。',
  },
  storyboard: [
    {
      id: 'mm-n1',
    ...
    },
    {
      ...
      type: 'narrative',
      content: {
        cn: '我 3 个月在 Cairo——结果 Cairo 黄金价格下降了约 12%（金币 mithqal 由不低于 25 dirham 跌到约 22 dirham 或更低）。\n\n（学术 caveat：这数字来自 al-\'Umari 1300-1349 同代埃及学者,是他个人定性观察。不是经济数据。al-\'Umari 自己写「持续到我写本书时约 12 年还在影响」——但 al-\'Umari 是文学性记述。现代经济史 Goldberg 2012 / Borsch 2005 估计实际影响 5-10 年,而且认为约 12% 这种波动本身落在 Mamluk 货币正常波动范围内——程度学界争议,部分研究认为 Black Death 1347-1349 才是 Mamluk 经济真正崩溃。）\n\n这不是「人类第一次通货膨胀」,\n罗马 3 世纪 Diocletian 银币贬值 + 中国汉武帝五铢钱通胀 + 13-14 世纪元朝交钞 hyperinflation,都比我 1324 早。\n\n这是有记录中单笔外来财富冲击他国经济最著名的早期案例之一,14 世纪没人做过这种规模的单笔财富动员,欧洲对 Mali Empire 的认知，从这一刻起永远改变了。',
        en: 'My 3 months in Cairo — gold price in Cairo fell ~12% (the mithqal coin fell from no less than 25 dirham to about 22 dirham or lower).\n\n(Scholarly caveat: this figure comes from al-\'Umari, contemporary Cairo scholar 1300-1349 — it is his personal qualitative observation, not economic data. al-\'Umari himself wrote "still affecting Cairo about 12 years later as I write" — but al-\'Umari is literary, not statistical. Modern economic history, Goldberg 2012, Borsch 2005, estimate real impact 5-10 years, and consider a swing of around 12% to fall within the normal range of Mamluk currency fluctuation, extent contested, some scholars argue the Black Death 1347-1349 was the actual collapse of the Mamluk economy.)\n\nThis was NOT "humanity\'s first inflation."\nRome\'s 3rd-century Diocletian denarius debasement + Han China\'s wuzhu coin inflation + 13-14th-century Yuan jiaochao hyperinflation, all predate my 1324.\n\nThis was one of the most famous early recorded cases of a single injection of foreign wealth shaking a foreign economy. No one in the 14th century had done single-event wealth mobilization at this scale. From that moment, Europe\'s mental map of the Mali Empire was permanently rewritten.',
      },
      deliverGoal: 'N6 cross-lens micro-detail #2 — Cairo 约 12% 黄金价格下降 (al-\'Umari 个人定性观察, mithqal 25→22 dirham) + 反 Whig 修正 (不是"通胀第一次") + Black Death 干扰因素',
    ...
    },
    {
      ...
      type: 'synthesis',
      content: {
        cn: '关于我，我留下两件传世物：\n\n1. Catalan Atlas 1375——西班牙 Majorca 犹太人 Cresques Abraham 绘的地图,把我画在西非,手里举一块大金子,头戴金冠。这是欧洲第一张「正式承认」非洲帝国的地图。我 1324 朝圣 51 年后,欧洲终于把 Mali 画进世界地图。\n\n2. 21 世纪 myth,「Mansa Musa 比 Bezos 富 4000 亿美金」。这是 2012 年 Time Magazine 文章 + Black History Month 热度产物。但学界 Levtzion 1973 / Conrad 2005 都说：14 世纪没有可比 GDP / wealth metric,18 世纪以前「人类史上最富的人」根本没法算。这是 21 世纪流行 myth,不是 14 世纪的事实。\n\n我希望你记住的是事实：1324 黄金朝圣 / 12,000 enslaved / Cairo 金价约 12% 下降 / al-Sahili 建筑 / Sankoré 14 世纪基础——都是真的。\n\n我 1337 死的时候,al-Sahili 1327 建的 Djinguereber 大清真寺还在;700 年后还在。那是我留下的,不是 myth。',
        en: 'Two things outlived me:\n\n1. The Catalan Atlas 1375 — drawn by Cresques Abraham, a Jewish cartographer in Majorca — depicts me in West Africa, holding a large lump of gold, crowned in gold. It was the first European map to formally include an African empire. 51 years after my 1324 hajj, Europe finally drew Mali onto the world map.\n\n2. The 21st-century myth — "Mansa Musa was richer than Bezos by $400 billion." This came from a 2012 Time Magazine article and Black History Month buzz. But scholars, Levtzion 1973, Conrad 2005, both say: there is no comparable GDP/wealth metric across these centuries, "richest person in history before the 18th century" cannot even be calculated. It is 21st-century popular myth, not a 14th-century fact.\n\nWhat I hope you remember are the facts: the 1324 hajj, the 12,000 enslaved, the ~12% Cairo gold drop, al-Sahili\'s architecture, the 14th-century Sankoré foundation — all real.\n\nWhen I died in 1337, the Djinguereber Mosque al-Sahili built in 1327 was still standing. 700 years later it is still standing. That is what I left behind, not the myth.',
      },
...
export var ibnBattutaLens = {
  ...
  perspectiveTag: 'cross-civilization-witness',
  description: {
    en: 'He is a forty-eight-year-old Moroccan jurist who left home at twenty-one for a one-year pilgrimage and never went back, returning at forty-five to a Tangier emptied by the Black Death, his mother dead in the years he was gone. This pass sets out with him on one last crossing, ninety days of Sahara without a single tree, into a Mali whose stories he has been hearing in Cairo cafes for twenty-eight years, watching a strict Maliki jurist try to write down what he actually sees.',
    cn: '他是一个四十八岁的摩洛哥法学者,二十一岁出门去 Mecca 朝圣本来打算一年回来,二十四年后回到家,母亲已经在黑死病里死了。这一遍让你跟他启程做最后一次远行,九十天沙漠路上看不到一棵树,走进一个他在 Cairo 茶馆里已经听了二十八年传闻的 Mali,看一个严格的 Maliki 法学者怎么诚实写下他真正看见的东西。',
  },
  storyboard: [
    {
      id: 'ib-n1',
    ...
    },
    {
      ...
      type: 'synthesis',
      content: {
        cn: '我 1325-1354 30 年——同代还有这些 cross-civilization 旅行家：\n\n- **Marco Polo（1271-1295 / 24 年 / 15,000-25,000 km）**,欧洲最有名,但游记很多细节不可信,商人圈的 second-hand 混进 first-hand。\n\n- **汪大渊（1311-1350 / 1330-1349 印度洋 + 东南亚 / 写《岛夷志略》1349）**,元朝民间航海家,比 Zheng He 1405 早 56 年,但学界冷门。\n\n- **Odoric of Pordenone（1286-1331 / 方济各会修士 / 1318-1330 访华 12 年）**,比我早访中国,《Itinerary》是欧洲传教士第一手中国记录。\n\n- **Mahmud Kati（作者归属有争议 / 常被认为是《Tarikh al-Fattash》记录者）**,西非内部第一手,但研究指出这手稿 17 世纪经大量修订（Hunwick / Levtzion）。\n\n14-15 世纪是「长途旅行黄金时代」。不是只 Marco Polo + 我,是 Islamic + 中国 + 欧洲 + 非洲都在 cross-cultural mobility。',
        en: 'My 30 years (1325-1354) — contemporary cross-civilization travelers included:\n\n- **Marco Polo (1271-1295 / 24 years / 15,000-25,000 km)**, Europe\'s most famous 14th-century traveler, but many details are unreliable, merchant networks mixed second-hand into first-hand.\n\n- **Wang Dayuan (1311-1350 / 1330-1349 Indian Ocean and SE Asia / "Daoyi Zhilüe" 1349)**, 14th-century Yuan-Dynasty civilian navigator, 56 years before Zheng He 1405, but obscure in scholarship.\n\n- **Odoric of Pordenone (1286-1331 / Franciscan friar / in China 1318-1330)**, later than Marco Polo, earlier than my China visit, his "Itinerary" is a first-hand Christian missionary record of China.\n\n- **Mahmud Kati (attribution contested / often called the chronicler of "Tarikh al-Fattash")**, West Africa internal first-hand, but research suggests heavy 17th-century revision (Hunwick / Levtzion).\n\nThe 14th-15th centuries were "the golden age of long-distance travel", not just Marco Polo and me, Islamic + Chinese + European + African all in cross-cultural mobility.',
      },
    ...
    },
    {
      ...
      type: 'synthesis',
      content: {
        cn: '我 Rihla 留下来——你 21 世纪 7 年级,这是你能用的：\n\n1. **Mali 是 14 世纪世界最安全的国家**。我亲自走 8,000 km 进去 8 个月写下来的——欧洲中心 narrative 的「非洲野蛮」从这一句话碎掉。\n\n2. **女性 + 教育 + 法治**,三个 Mali 比 14 世纪欧洲更先进的——课本若只讲「中世纪 Europe vs 黑暗 Africa」,是错的。\n\n3. **谁的故事被记得 / 谁的故事被忘,是政治**。我 700 年「不存在」是欧洲中心 narrative 的选择,21 世纪 cross-cultural turn 慢慢 reset,你 7 年级现在站在中间。\n\n4. **源头透明 > 假装中立**。我 14 世纪带 Maliki 法学者偏见,但我写在 Rihla 里,21 世纪你能读到。\n\n你读 Mali narrative + 我的 lens + Mansa Musa lens + Aisha 1413 lens,三视角看一座 700 年前的帝国,这就是 AP DBQ source-criticism 顶级训练。',
        en: 'Rihla survives — and at 21st-century 7th grade, here is what you can use:\n\n1. **Mali was the safest country in the 14th-century world** — I walked 8,000 km in over 8 months and wrote it down — Europe\'s "African barbarism" myth shatters on that one sentence.\n\n2. **Women + education + rule of law**, three things 14th-century Mali had over Europe, if your textbook teaches "medieval Europe vs dark Africa", it is wrong.\n\n3. **Whose story is remembered, whose is forgotten, is political.** For 700 years I "did not exist" because of Euro-centric choices, the 21st-century cross-cultural turn is slowly resetting this, and you 7th-graders stand in the middle.\n\n4. **Honest about your bias beats pretend neutrality.** I had Maliki jurist biases, but I wrote them into Rihla, 21st-century readers can see them.\n\nYou read the Mali narrative + my lens + Mansa Musa\'s lens + Aisha 1413\'s lens, three perspectives on the same 700-year-old empire, that is AP DBQ source-criticism training at its best.',
      },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '「89 年前 Mansa Musa 走出 Niani 那天,后面跟 80 头骆驼每头驮 300 磅黄金,还跟 12,000 个奴隶,每人捧 4 磅黄金。\n\n' +
        '他们走 8000 km。很多没活到 Mecca。活到的,很多留在 Cairo,卖给 Mamluk 苏丹的人。\n\n' +
        '60 年后,摩洛哥旅行家 Ibn Battuta 1353 在 Mali 待 8 个月,写了本书。他写:在 Cairo 见过这 12,000 一些人的孙子,还在给苏丹做事。」\n\n' +
        '我站着听——那 12,000 个跟我一样是 Mande 人,但没人记得名字。\n\n' +
        '我们家 50 岁厨娘 Awa——她妈妈就是 1324 那批没去 Mecca、被卖回 Niani 的人。所以这 12,000 不是抽象,是 Awa 妈妈。\n\n' +
        'Mansa Musa 撒金动了一座城市经济,是「Mande 怎么伟大」的故事。12,000 人捧 4 磅金子走 8000 km,是另一个故事。两个是同一件事的两面。\n\n' +
        '多数 jeli 只唱 Sundiata。这个 jeli 唱了。',
      en:
        ...
        'The old jeli is not singing Sundiata. He sings:\n\n' +
        '"Eighty-nine years ago, the day Mansa Musa left Niani, eighty camels followed him, each carrying three hundred pounds of gold, and twelve thousand people followed, each holding four pounds of gold. These twelve thousand were enslaved.\n\n' +
        ...
        'Sixty years later, a Moroccan traveler named Ibn Battuta stayed in Mali eight months in 1353 and went home to write a book. He wrote that in Cairo he had seen grandchildren of some of those twelve thousand, still working for the sultan."\n\n' +
        'I stand under the palm tree, listening — those twelve thousand were Mande people, like me — but no one remembers their names.\n\n' +
        'In our house there is a fifty-year-old cook, Awa. Her mother was one of that batch who never reached Mecca and was sold back to Niani. So the twelve thousand are not abstract — they are Awa\'s mother.\n\n' +
        'Mansa Musa scattering gold in 1324, moving the economy of a city, is the story of "how great we Mande are." Twelve thousand people carrying four pounds of gold across eight thousand kilometers is another story. Two sides of the same thing.\n\n' +
        'Most jelis sing Sundiata, not this. This jeli sang it.',
    },
    deliverGoal: {
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '虚构合成人物,但她代表真人:14-16 世纪 Timbuktu 很多 qadi 家庭女孩能背 Quran、教其他女孩,但没书、没名字。5 代人塑造非洲女性识字传统的根。\n\n' +
        '236 年后,1655,一个叫 al-Sa\'di 的 Sankoré 学者写完《Tarikh es-Sudan》(苏丹编年史)。1591 摩洛哥火枪兵打 Songhai、抢 Sankoré 图书馆、70 多个 marabout 被押到 Marrakech,al-Sa\'di 亲眼见。这本手稿后来由 Timbuktu 的 Haidara 家族世代保存。\n\n' +
        '2012 年 Timbuktu 被武装组织占领,他们要烧手稿。Haidara 家族 + 当地 librarian 冒命把 30 万件手稿藏的藏、运的运,保住了。从 1655 al-Sa\'di 提笔到 2012 抢救——357 年的知识保存。\n\n' +
        '4 段历史:Renaissance 印刷机 / Reformation 95 Theses 4 周印遍德国 / AoE Columbus 1493 信 9 版 / Mali al-Sa\'di 沙漠藏书,同一件事的不同面:14-17 世纪人怎么把知识传给 400 年后的你。\n\n' +
        '准备记忆考核?',
      en:
        'You walked with Aisha through 1413-1419 — six years.\n\n' +
        'A composite — not a real person. But what she stands for is real: in fourteenth- to sixteenth-century Timbuktu, many girls born into qadi families could recite the Quran and teach other girls — but had no books, no names. Five generations of them shaped the root of female literacy in West Africa.\n\n' +
        '236 years later — 1655 — a Sankoré scholar named al-Sa\'di finished a book called "Tarikh es-Sudan" (the Sudan Chronicle). In 1591 Moroccan musketeers had defeated Songhai, sacked the Sankoré library, and marched seventy marabouts to Marrakech. Al-Sa\'di saw it. The manuscript was then kept across generations by the Haidara family of Timbuktu.\n\n' +
        'In 2012, Timbuktu was occupied by an armed group who wanted to burn the manuscripts. The Haidara family and local librarians, risking their lives, hid and moved three hundred thousand manuscripts. They were saved. From al-Sa\'di setting down his pen in 1655 to the rescue in 2012 — three hundred and fifty-seven years of knowledge preservation.\n\n' +
        'Four Topics: Renaissance printing press, Reformation 95 Theses spreading across Germany in four weeks, Age of Exploration Columbus\'s 1493 letter in nine printings, Mali al-Sa\'di\'s manuscripts in the desert — different sides of the same thing: how people in the fourteenth through seventeenth centuries carried knowledge to you, four hundred years later.\n\n' +
    ...
    engagementHook: {
      cn: '4 段历史共同 thread: Renaissance 印刷机 / Reformation 95 Theses 4 周 / AoE 1493 信 9 版 / Mali al-Sa\'di 1655 沙漠——14-17 世纪人怎么把知识传给 400 年后的你。准备记忆考核?',
...
export var aishaLens = {
  ...
  description: {
    cn: '她是 Timbuktu 一条小巷里十四岁的 Mande 女孩,会织几何腰带、背十五章 Quran、唱爷爷教的 Sundiata 史诗开头(合成人物,代表 Mansa Musa 后百年里几千个 qadi 与 marabout 家出身、没留名的女孩)。这一遍让你跟她坐进泥砖房,走完接下来六年,看识字的母亲被边境劫掠者带走后,女孩怎么把 Quran 和 Sundiata 接住,再传给下一茬十二个。',
    en: 'She is a fourteen-year-old Mande girl in a Timbuktu lane who can weave geometric belts, recite fifteen chapters of the Quran, and sing the opening of the Sundiata epic her grandfather taught her (a composite character standing in for thousands of girls born into qadi and marabout families in the century after Mansa Musa, never recorded by name). This pass sits you in her mud-brick house and walks the next six years with her, watching a literate mother taken by border raiders, the young girl catching both the Quran and the Sundiata songs in mid-air and passing them on to twelve more.',
  },
