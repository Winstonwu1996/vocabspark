...
export var aishaLens = {
  ...
  description: {
    cn: '她是 Timbuktu 一条小巷里十四岁的 Mande 女孩,会织 Mande 几何腰带,会背十五章 Quran,会唱爷爷教的 Sundiata 史诗开头 (一个合成人物,代表 Mansa Musa 之后那一百年里 Timbuktu 几千个 qadi 和 marabout 家庭出身、却没有留下名字的女孩)。这一遍让你跟她坐进她家泥砖房,走完接下来六年,看一个识字的母亲被边境劫掠者带走之后,这个女孩怎么把 Quran 和 Sundiata 一起接住,再传给下一茬十二个女孩。',
    en: 'She is a fourteen-year-old Mande girl in a small lane in Timbuktu who can weave Mande geometric belts, recite fifteen chapters of the Quran, and sing the opening of the Sundiata epic her grandfather taught her (a composite character standing in for thousands of girls born into qadi and marabout families in the century after Mansa Musa who were never recorded by name). This pass sits you in her mud-brick house and walks the next six years with her, watching a literate mother taken by border raiders and a young girl catch both the Quran and the Sundiata songs in mid-air and pass them on to twelve more girls.',
  },
