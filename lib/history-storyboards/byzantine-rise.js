...
export var emperorJustinianLens = {
  ...
  perspectiveTag: 'overreach-system-builder',
  description: {
    cn: '你是 Justinian (482-565) — 东罗马 (拜占庭) 第 11 位皇帝, 出身巴尔干一户农民家庭 (今北马其顿境内的 Tauresium 村), 叔父 Justin I 当兵起家做到皇帝, 把你带去君士坦丁堡培养。你 36 岁前学拉丁、希腊、神学、罗马法; 527 年 4 月 1 日叔父死, 你 45 岁即位。在位 38 年, 你做了三件传 1500 年的大事: 528-534 编《查士丁尼法典》 (Corpus Juris Civilis) — 21 世纪意大利、法国、德国、日本民法都溯到它; 533-554 派 Belisarius 重夺北非、意大利、西班牙南部, 把地中海一度变回「罗马湖」; 537 年 12 月 27 日 Hagia Sophia 圣索菲亚圆顶完工 — 直径 31 米、顶高 56 米, 1000 年世界最大穹顶, 到 1436 Brunelleschi 在 Florence 建 Duomo 才被超过。但你也是 542 年查士丁尼鼠疫的当事皇帝 — 自己染病活下来, 但帝国被打到税基崩坏, 重夺的地盘后来全丢了。这一遍让你看见「极致 ambitious system-builder + 系统性 overreach」怎么同体 — 不是二元化, 是真实的人性悖论。',
    en: 'You are Justinian (482-565), the eleventh emperor of the Eastern Roman (Byzantine) realm. You were born to a peasant family in Tauresium, a village in modern North Macedonia. Your uncle Justin I rose through the army to become emperor and brought you to Constantinople for the best education available — Latin, Greek, theology, Roman law. On 1 April 527 your uncle died; you took the throne at forty-five. In thirty-eight years on the throne you launched three works that have lasted fifteen hundred years. From 528 to 534 you commissioned the Corpus Juris Civilis, the legal compilation that twenty-first-century Italian, French, German, and Japanese civil codes still trace their bones to. From 533 to 554 you sent Belisarius to retake North Africa, Italy, and southern Spain, briefly turning the Mediterranean back into a Roman lake. On 27 December 537 the Hagia Sophia dome was finished — thirty-one meters across, fifty-six above the floor, the largest dome in the world for a thousand years, until Brunelleschi finished the Florence Duomo in 1436. But you are also the emperor who lived through the Plague of Justinian in 542 — you caught it yourself and survived, while the empire bled out tax base, soldiers, and farmers, and the reconquered territories slipped away within a generation of your death. This lens shows how an extreme system-builder and a systemic over-reacher live in the same body — not a binary, but the real paradox of a powerful man.',
  },
  storyboard: [
    // ═══════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      engagementHook: '你身边谁是「极致才华 + 把组织 over-extend 到崩溃」的 leader? 你怎么看 ta?',
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      engagementHook: '你 21 世纪每天碰我留下的东西却不知道是我 — 你怎么记我?',
      expectsRealAnswer: true,
    },
  ],
};
...
//     537.12.27 Hagia Sophia / 542 鼠疫 / 548 死乳腺癌
...
export var theodoraLens = {
  ...
  perspectiveTag: 'from-stage-to-purple',
  description: {
    en: 'You are Theodora (c. 500-548), Empress of the Eastern Roman Empire — born to a bear-keeper of the Hippodrome Greens faction, raised on the Constantinople stage where 6th-century actresses ranked beside sex workers, married to Justinian in 525 after a Roman law was rewritten so a senator could marry a former actress, crowned beside him on 1 April 527. In January 532 you stood up in the imperial council during the Nika Riot — when Justinian was preparing to flee by ship — and said purple is a noble shroud. He stayed. After the riot you pushed Justinian to legislate protections for prostitutes (Novellae 535) and quietly sheltered Monophysite (anti-Chalcedonian) bishops in the palace — keeping a religious-dissent channel open inside an officially Chalcedonian empire. You died of cancer at 48 in 548. You are not the manipulative "harlot empress" of Procopius\'s posthumous Secret History, and not the saintly icon of later Orthodox memory — you are a stage-born mediator who kept Justinian on the throne and kept religious dissenters inside the empire.',
    cn: '你是狄奥多拉（约 500-548）——东罗马帝国皇后。父亲 Acacius 是君士坦丁堡赛马场（Hippodrome）绿党的熊管理员；5 岁父亲死，母亲带 3 个女儿到赛马场求职位被拒。你童年到 Hippodrome 当哑剧演员——6 世纪演员社会地位极低，跟妓女同等级，罗马法律禁元老议员娶演员。522 年回君士坦丁堡做羊毛工人 + 改信反 Chalcedonian 的 Monophysite（一性论）派；525 年遇 Justinian——525 年法律专门改了允许元老议员娶前演员——你跟他结婚。527 年 4 月 1 日跟他同日加冕。532 年 1 月 Nika 暴动第 5 天，Justinian 想坐船逃，你在皇宫议会站起来说：「紫袍是高贵的寿衣（purple is a noble shroud）。」他留下。之后你推动《新法》（Novellae）535 保护妓女 + 庇护一性论主教让宗教异见在帝国内部维持。548 年你 48 岁死乳腺癌。你不是 19 世纪 Procopius《秘史》里的「淫妇皇后」，也不是后世东正教圣徒化叙事——你是从舞台走到紫袍的孤独调停者。',
  },
  storyboard: [
    {
      id: 'theo-n1',
    ...
    },
    {
      ...
      engagementHook: '「演员的女儿不应该到那个位置」vs「她就是到了」——两件事同时成立——你 21 世纪能 hold 这种矛盾真相 30 秒吗？',
      expectsRealAnswer: true,
    },
    {
      id: 'theo-n12',
      ...
      engagementHook: '你 21 世纪身边——「自己经历过 + 后来用位置改变制度」——这种人是谁？',
      expectsRealAnswer: true,
    },
  ],
};
...
export var annaTheIconographerLens = {
  ...
  perspectiveTag: 'female-monastic-image-maker',
  description: {
    en: 'You are Anna (composite, c. 710 - c. 820), a Byzantine nun and icon-painter. Born in Constantinople around 710 to a small artisan family. Your father died defending the city walls during the Arab siege of 717-718 (Leo III\'s great defensive war). Your mother, unable to feed three children, sent you at age four (around 714) to a women\'s monastery in the city, where you grew up learning to paint icons in the older Constantinopolitan style. At sixteen (726), you watched Emperor Leo III order the public removal of the Christ icon from the Chalke Gate of the imperial palace — the opening act of Byzantine Iconoclasm. You lived through the 730 edict, the secret survival of icons inside monasteries, the 754 Hieria Council that declared icon-veneration heresy, the 762 closures and the day Emperor Constantine V paraded monks and nuns through the Hippodrome, the 787 Second Council of Nicaea\'s short restoration of icons, the 815 second wave of Iconoclasm under Leo V, and you died around 820. You did not see the final 11 March 843 Triumph of Orthodoxy — your students did. You are not an evil-iconoclast-emperor versus saintly-icon-defender simplification. 21st-century scholarship (Brubaker & Haldon 2011, Byzantium in the Iconoclast Era c. 680-850) gives a careful frame: the real drivers of Iconoclasm were Arab military pressure, Slavic migration, post-plague economic collapse, the themata military reform, and a real theological argument over images — not simply "wicked emperors hating art."',
    cn: '你是修女安娜（虚构合成，约 710 - 约 820 年），拜占庭圣像派修女画家。约 710 年生于君士坦丁堡的一个小手艺人家庭。你父亲死于 717-718 年阿拉伯人围城（Leo III 那场决定帝国存亡的防御战）。母亲带不动三个孩子，约 714 年你 4 岁时被送进城里的一家女修院，在那里长大、学画圣像（icon）——用 6 世纪以来君士坦丁堡传下来的老风格。16 岁（726）你看着 Leo III 皇帝下令把皇宫 Chalke 门上的基督圣像公开拆下——拜占庭 Iconoclasm（毁圣像运动）的开场。你经历了 730 年法令、修道院里圣像被秘密藏起、754 年 Hieria 大公会议宣布圣像崇拜为异端、762 年皇帝 Constantine V 关闭修道院 + Hippodrome 游街僧尼那一天、787 年第二次 Nicaea 大公会议圣像派短暂回归、815 年 Leo V 第二轮 Iconoclasm，约 820 年你死。你没有看到 843 年 3 月 11 日的 Triumph of Orthodoxy——你的学生看到了。你不是「邪恶毁圣像皇帝 vs 圣洁圣像派修女」二元化叙事。21 世纪学界（Brubaker & Haldon 2011《Byzantium in the Iconoclast Era c. 680-850》）给的 careful framing 是：Iconoclasm 真实推手是阿拉伯军事压力、Slavic 移民、6 世纪鼠疫之后人口经济崩溃、themata 军区制改革、加上一场关于圣像的真实神学辩论——不是单纯「邪恶皇帝讨厌艺术」。',
  },
  fictionalDisclaimer: {
  ...
  storyboard: [
    ...
    },
    {
      ...
      deliverGoal: 'N11 synthesis 双 view (邪恶 Iconoclast 皇帝 vs 圣洁圣像派 19c 主流 / Brubaker & Haldon 2011 4 重结构压力) — anti-binary 真相在中间 / 「结构性原因」跟「个人代价」不是非此即彼 / 「身份 vs 创作」哪个先定义 / 117 年内战 / hold 矛盾真相 30 秒',
      engagementHook: '「身份」跟「创作」——你 21 世纪——哪个先定义你？哪个最后留下来？',
      expectsRealAnswer: true,
    },
    {
      id: 'anna-n12',
      ...
      engagementHook: '「你打算在你的一个秋天里画什么？」——你 21 世纪的「秋天」可能 30-50 年——你想做的那件事是什么？',
      expectsRealAnswer: true,
    },
  ],
};
