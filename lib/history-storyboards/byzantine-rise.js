...
export var emperorJustinianLens = {
  ...
  storyboard: [
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      engagementHook: '极致才华 + 把组织 over-extend 到崩溃，常是同一种性格的两面——先在心里想想你怎么看，下一节我会正式问你。',
      expectsRealAnswer: false,
    },
...
export var theodoraLens = {
  ...
  storyboard: [
    ...
    },
    {
      ...
      engagementHook: '「演员的女儿不应该到那个位置」vs「她就是到了」——两件事同时成立——先在心里想想你怎么看，下一节我会正式问你。',
      expectsRealAnswer: false,
    },
    {
      id: 'theo-n12',
...
export var annaTheIconographerLens = {
  ...
  storyboard: [
    ...
    },
    {
      ...
      engagementHook: '「身份」（你属于哪个群体）跟「创作」（你手里的手艺）——哪个先定义你、哪个最后留下来——先在心里想想你怎么看，下一节我会正式问你。',
      expectsRealAnswer: false,
    },
    {
      id: 'anna-n12',
