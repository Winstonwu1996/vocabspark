...
export var theodoraLens = {
  ...
  description: {
    ...
    cn: '你是狄奥多拉（约 500-548）——东罗马帝国皇后。父亲 Acacius 是君士坦丁堡赛马场（Hippodrome）绿党的熊管理员；5 岁父亲死，母亲带 3 个女儿到赛马场求职位被拒。你童年到 Hippodrome 当哑剧演员——6 世纪演员社会地位极低，跟妓女同等级，罗马法律禁元老议员娶演员。522 年回君士坦丁堡做羊毛工人 + 改信反 Chalcedonian 的 Monophysite（一性论）派；525 年遇 Justinian——525 年法律专门改了允许元老议员娶前演员——你跟他结婚。527 年 4 月 1 日跟他同日加冕。532 年 1 月 Nika 暴动第 5 天，Justinian 想坐船逃，你在皇宫议会站起来说：「紫袍是高贵的寿衣（purple is a noble shroud）。」他留下。之后你推动《新法》（Novellae）535 保护妓女 + 庇护一性论主教让宗教异见在帝国内部维持。548 年你 48 岁死于癌症 (具体病种史料不详)。你不是 19 世纪 Procopius《秘史》里的「淫妇皇后」，也不是后世东正教圣徒化叙事——你是从舞台走到紫袍的孤独调停者。',
  },
  storyboard: [
    {
      id: 'theo-n1',
