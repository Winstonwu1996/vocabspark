...
export var ashokaLens = {
  ...
  icon: '🦁',
  description: {
    cn: '他是一个刚刚打赢的 Maurya 国王,正站在 Kalinga 战后的土地上,看见的不是地图上多出来的一块颜色,而是约 10 万具尸体、被绳子串成一长队往北押走的 15 万人、烧空的村子和还没散的烟。这一遍让你坐进他心里那个出发时理直气壮、此刻第一次问「我赢了可我赢的到底是什么」的位置,看他下一步要不要做一件古代国王几乎都不做的事:把自己造成的死亡,亲手刻进石头。',
    en: 'He is a Maurya king fresh from victory, standing on the ground after the war on Kalinga, seeing not one more patch of color on the map but about a hundred thousand corpses, a hundred and fifty thousand roped into a long line driven north, villages burned hollow and smoke not yet cleared. This pass puts you inside the king who set out fully justified and now, for the first time, asks "I won, but what is it I won," watching whether he is about to do a thing almost no ancient ruler did: carve the death he caused into stone with his own hand.',
  },
  storyboard: [
    {
      id: 'ash-n1',
...
export var dhammaOfficialLens = {
  ...
  icon: '☸️',
  description: {
    cn: '他是阿育王新设的一种官 dhamma-mahamatta(达摩官),手里没有刀,只有国王的名义和一双能走几千公里的脚(这一官职法敕里真实有记载,这位达摩官的姓名家世是合成,代表那一类执行者)。这一遍让你跟他一起走进刚被国王血洗过的 Kalinga 村子,面前是一个全家都在那 10 万死、15 万流放数字里的男人,眼睛比恨和怕都冷,看他怎么开口说出国王让他带来的那句「我后悔了,从今讲非暴力」。',
    en: 'He is a new kind of officer Ashoka created, the dhamma-mahamatta, with no blade in hand, only the king\'s name and a pair of feet that can walk thousands of miles (the office is really recorded in the edicts; this officer\'s name and family are composite, standing for that class of enforcer). This pass walks you with him into a village in Kalinga, freshly bloodied by the king, before a man whose whole family is in the figures of a hundred thousand dead and a hundred and fifty thousand deported, his eyes colder than hatred or fear, and you watch how he gets out of his mouth the line the king has sent: "I am sorry, from now on it is non-violence."',
  },
  storyboard: [
    {
      id: 'do-n1',
...
export var kalingaSurvivorLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是 Kalinga 海边一个仗打完后什么都没了的人,父亲、母亲、兄弟、整个村子都在那 10 万死、15 万被串走的数字里(一个合成人物,承载真实群体经验,史料确证的是法敕里这两个数字和 Kalinga 被吞并)。这一遍让你站在他面前那块村口大石头边,有人在念北边那个国王新刻的法敕,念到「深深懊悔」四个字,看他脑子里翻江倒海:一边想他终于知道错了,一边一个更冷的声音问,他后悔,我父亲就能活过来吗?',
    en: 'He is a man of Kalinga by the sea who had nothing left after the war ended, his father, mother, brother, the whole village among the figures of a hundred thousand dead and a hundred and fifty thousand roped away (a composite figure carrying real collective experience; what the record confirms is those two numbers in the edict and the annexation of Kalinga). This pass puts you with him at the great stone at the village mouth, where someone is reading the newly carved edict from the king to the north, reaching the four words "deeply regrets," and his heart churns: one side thinks he has finally seen his wrong, the other, colder voice asks, he is sorry, will my father live again?',
  },
  storyboard: [
    {
      id: 'ks-n1',
    ...
    },
    {
      ...
      engagementHook: '国王的「我后悔了」刻在帝国各地几十处，两千年后还看得见；那 10 万死者、15 万被掳走的人，连一个名字都没留下。历史的天平，替有权的人记下了悔过，把没权的人连同他们的死一起抹掉了。你听见的这场战争，大多是国王那一边的——那另一边呢？',
      expectsRealAnswer: false,
    },
    {
      id: 'ks-n9',
