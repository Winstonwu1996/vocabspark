...
export var lelandStanfordLens = {
  ...
  icon: '🚂',
  description: {
    cn: '他是加州最有钱有势的人之一，刚把上万华工召上了内华达山。这一遍让你坐进他山下温暖的办公室，看他翻开一本只有数字、没有名字的账本，决定要不要为「那些华工」放慢脚步。',
    en: 'One of the richest men in California, who has just sent ten thousand Chinese workers up into the Sierra Nevada. This pass seats you in his warm office below the mountain, opening a ledger of numbers without names, deciding whether to slow down for them.',
  },
  storyboard: [
    {
      id: 'ls-n1',
...
export var wongChinFooLens = {
  ...
  icon: '📰',
  description: {
    cn: '他是一个站在两个世界中间、两边都不完全接纳他的华人，英文比许多白人还漂亮。这一遍让你跟他一起，只拿着一支笔、一张嘴，替一群被当成怪物、连一句英文都不会喊的同胞，争一个做人的名分。',
    en: 'A Chinese man caught between two worlds, accepted by neither, his English finer than many a white man\'s. This pass walks with him, armed with only a pen and a tongue, winning a human name for a people treated as monsters and unable to cry out.',
  },
  storyboard: [
    {
      id: 'wcf-n1',
...
export var taishanWorkerLens = {
  ...
  icon: '⛏️',
  description: {
    cn: '他是一个十几岁就签下契约、漂洋过海的台山男孩（合成人物，代表无数无名华工），正吊在内华达山悬崖边的柳条篮子里，手里攥着一根点着的引线。这一遍让你跟他一起算那一秒：晚一秒，人没了；早一秒，家里还有口饭。',
    en: 'A Taishan boy who crossed half the globe on a labor contract (a composite figure standing for countless nameless Chinese workers), hanging off a Sierra Nevada cliff in a wicker basket, a lit fuse in his hand. This pass counts that second with him: a second late, he dies; a second early, his family eats.',
  },
  storyboard: [
    {
      id: 'tw-n1',
...
export var meta = {
  ...
  notes: [
    ...
    '4-agent review pending (7thgrader 小 U / AP teacher Dr. Park / ESL Maria / Chinese teacher 赵老师) — 特别留意台山华工 lens 的尊严处理 + 中国身份锚不刻意煽情',
  ],
};
