...
export var haudenosauneeLeaderLens = {
  ...
  icon: '🪶',
  description: {
    cn: '他是今天纽约州北部林子里一座长屋里的 sachem,坐进会议厅,中间一堆火,两边坐着几代人之前还在互相仇杀的五个民族的代表(一个合成人物,把许多代真实邦联酋长合到一起)。这一遍让你坐进他的位置,看一群人怎么把世仇放下、走进一个不能拍板只能慢慢商量到所有人点头的会议,把一场本可以再杀几百年的事,一句话一句话谈出来。',
    en: 'He is a sachem in a longhouse in the woods of what is now upstate New York, walking into a council where a fire sits between two rows of delegates from five peoples who, only a few generations earlier, were killing one another (a composite character drawn from generations of real confederacy chiefs). This pass takes his seat with you, watching a roomful of people set down blood feuds and step into a council where no one can simply rule, only reason and wait, talking one line at a time through what could otherwise have been centuries more of killing.',
  },
  storyboard: [
    {
      id: 'hl-n1',
...
export var clanMotherLens = {
  ...
  icon: '🌽',
  description: {
    cn: '她是 Haudenosaunee 一个氏族里最年长的女人,手里捏着一串氏族世代传下来的 wampum 贝壳串,身后是属于女人的长屋、田地和粮仓(一个合成人物,代表许多代真实的氏族母亲)。这一遍让你站到她这里,看一个不坐会议桌却决定谁能坐上去的位置,怎么在她亲手扶起的酋长开始变质的那一天,把那串贝壳从他头上取下来。',
    en: 'She is the eldest woman of a Haudenosaunee clan, holding a string of wampum shells passed down for generations, with the longhouse, the fields, and the granary behind her all belonging to the women (a composite character standing in for many generations of real clan mothers). This pass puts you where she stands, in a seat that does not sit at the council yet decides who may, on the day a sachem she raised with her own hands begins to go wrong and she has to take the string back from his head.',
  },
  storyboard: [
    {
      id: 'cm-n1',
...
export var contactSurvivorLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是一个北美原住民,小时候记得村里长屋一座挨一座、田里满是孩子,后来在一年之内,身边每十个人里走了将近九个(一个合成人物,把欧洲人初到那几代人里许许多多真实经历合到一人身上)。这一遍让你跟他站到瘟疫过去后那个空了大半的村子中间,看一个活下来的人怎么面对那群晚到的、把这片刚刚被掏空的土地说成「本来就空」的人。',
    en: 'He is a Native North American who remembers a village of longhouses pressed one against the next and fields full of children, and then, within a single year, watched nearly nine of every ten people he knew vanish (a composite character gathering many real experiences from the first generations of the European arrival into one figure). This pass walks you to the half-empty village square with him after the sickness has passed, watching a survivor face the latecomers who will call this just-emptied continent "empty from the start."',
  },
  storyboard: [
    {
      id: 'cs-n1',
