...
philosophes 的「英国」和「荷兰」是示范模型，不是田野调查报告。我们用这些国家作为攻击欧洲大陆政治的镜子——不是在如实报道那里的现实。
...
这是一个结构性模式：女性的知识劳动，无论是翻译、教导、计算，都被降格为「帮助」，被记在男性名下，或者干脆不被记录。Émilie du Châtelet 是这个模式里一个典型的例子。
...
This is a structural pattern: women's intellectual labor — translation, teaching, calculation — was consistently demoted to "assistance," credited to men or simply not credited at all. Émilie du Châtelet was a typical case in this pattern.
...
财务记录显示：我在 1720 年代到 1750 年代持有 Compagnie des Indes 的股份，这是我投资组合的重要组成部分。我死时的遗产折合约 200 万法郎，在 18 世纪作家里是异常巨额的数字。
...
我的财富来自我投资的公司，这些公司的利润来自殖民地贸易——我不是奴隶船的日常经营者，但我是殖民地经济的受益者。（一处补充：更新的研究 Giovannetti-Singh 2022 指出，我曾在 1752 年直接出资一次贩奴航程——所以「从不直接沾手」这种绝对说法不能成立。）

知情（哪怕是不完整的知情）和受益可以同时成立。

我没有追踪每一笔红利的来源。这件事让我的良知可以保持安静。但钱在那里运转，不管我的良知安不安静。`,
...
Financial records show that I held Compagnie des Indes shares across the 1720s–1750s, a significant part of my investment portfolio. I died worth roughly 2 million *livres tournois* — an extraordinary figure for an 18th-century writer.
...
这里有一个时间线，Cronk 2009（p.20）明确注明：我的 Compagnie des Indes 持股高峰在 1720 年代到 1750 年代，而《Candide》的苏里南段落写于 1759 年——我的持股高峰期当时已经过去。我在持股期间没有任何公开文字直接批评奴贸；对奴隶制最直接的描写，出现在我大规模持股的高峰之后。（careful framing：更新的研究 Giovannetti-Singh 2022 认为我其实终身持股，所以「写《Candide》时已经清盘」这种说法不能下死结论——持股与批奴文字的时间关系，史学界有不同解读。）
...
There is a timeline that Cronk 2009 (p.20) specifically notes: my Compagnie des Indes shareholding was concentrated in the 1720s–1750s, while *Candide*'s Surinam passage was written in 1759 — after my peak shareholding years had passed. During my peak shareholding years, I wrote no public words directly criticizing the slave trade. My most direct depiction of slavery appeared after the height of my major shareholding. (Careful framing: more recent research, Giovannetti-Singh 2022, argues I in fact held shares for life, so the claim that the holding "had been liquidated by the time I wrote *Candide*" cannot be stated as settled — the timing relationship between shareholding and anti-slavery writing is read differently by different historians.)
...
这是我人生里最好的一面。这是欧洲近代史上最早的「媒体舆论翻案」之一——不是律师翻案，而是知识界通过出版物制造压力迫使王权重审。我手里的笔，打赢了图卢兹的车轮。
...
我写的内容混合了宗教批判和文化 stereotype：对犹太教起源的嘲讽，对犹太人商业行为的贬称，对犹太文化的傲慢评价。我的框架是「理性批判一切宗教」——我攻击基督教，也攻击犹太教。

但这个条目，是世俗/族裔反犹主义（secular/ethnic antisemitism）的早期模板。

传统的宗教反犹说：「犹太人杀了基督。」这是神学立场，可以在神学层面被反驳。

启蒙式的「理性」反犹说：「犹太人的文化和思维方式是落后的。」这个说法戴着「理性分析」的面具，更难被反驳，因为它看起来不像偏见，看起来像结论。

这个分析让我不舒服，因为它是对的。我那天写「Juifs」条目的时候，我相信自己在做理性批判。我没有意识到我在建造一栋后来会被用来伤害人的大楼。我不知道那栋大楼一百多年后会是什么样子。
...
But that entry was an early template for secular/ethnic antisemitism.
...
export var gougesLens = {
  ...
  description: 'French playwright who declared women rights and died for it, 1748-1793',
  descriptionCn: '法国剧作家，为女性权利而声，为此而死，1748-1793',
  storyboard: [
  {
    id: 'N1',
    nodeId: 'gouges-N1',
...
法语里，『homme』（阿曼，这个词）有两种意思：泛指的『人』（不分性别的人类）和特指的『男人』（男性）。起草这份文件的人——Sieyès、Lafayette、Mirabeau——心里想的「享有这些权利的人」是：有财产的法国男性公民。女性不在这个圈子里。殖民地的奴隶不在这个圈子里。
...
还有一个跨主题的对比值得想一想：拜占庭那段历史里的 Theodora，她用她的声音保住了现存秩序，让 Justinian 没有逃跑，让帝国的权力得以延续。Gouges 用她的声音挑战新建立的秩序，挑战了声称自己代表「人民和理性」的权力。同一种工具——公开的语言——两种方向，两种命运。
...
这本书叫《Histoire des deux Indes》（两印度史），作者是 Abbé Raynal（雷纳尔神父）。1770 年出版后多次增修；1780 年的第三版加入了来自 Diderot 的大量反殖民内容——那个把受压迫者比作 Spartacus 的段落，出自 Diderot 而非 Raynal 本人（Robertson 2005）。正是这个 1780 年版本在 1781 年被法国查禁，Raynal 被迫流亡。Toussaint 若读到它，读的很可能是 1780 年的那个版本。
...
The book was the *Histoire des deux Indes* (History of the Two Indies), written by Abbé Raynal. Published in 1770, it was revised multiple times; the third edition of 1780 added substantial new content from Diderot — including the passage comparing the oppressed to Spartacus, which was Diderot's addition, not Raynal's own writing (Robertson 2005). It was this 1780 edition that was banned in France in 1781, forcing Raynal into exile. The version Toussaint may have encountered was most likely the 1780 edition.
...
但在 Saint-Domingue 的四层社会体制里，我的位置是这样的：白人分为两层——grands blancs（种植园主和大商人）在最顶层，petits blancs（工匠、小商人等普通白人）在其下；再往下是自由有色人种（gens de couleur）；最底层是约 50 万被奴役的人。这是四层，不是三层——每一层的利益都不同，互相之间的矛盾不亚于他们对奴隶制本身的依赖。我从底层进入了第三层——但在第三层里，自由黑人的地位通常还低于混血自由人（mulâtres）。
...
But in Saint-Domingue's four-tiered social structure, my position looked like this: grands blancs (plantation owners and major merchants) at the very top, petits blancs (artisans, small traders, ordinary white colonists) below them, free people of color (gens de couleur) in the third tier, and approximately 500,000 enslaved people at the bottom. Four tiers, not three — each with distinct interests, and the tensions between them no less sharp than their shared dependence on the slave system. I had moved from the bottom into the third tier — but within that tier, free Black men typically ranked below mixed-race freedmen (mulâtres).
...
最早书面记录这个仪式的，是一个叫 Moreau de Saint-Méry 的殖民地白人作者，他在仪式发生约六年后才写下这件事（1797 年）——他对「巫术仪式」的描写背后，有他自己的政治动机。这是批判这段史料的起点。
...
The earliest written account of this ceremony comes from Moreau de Saint-Méry, a colonial white author who wrote his description approximately six years after the event (1797) — his portrayal of the ceremony as a "voodoo ritual" carries his own political motivations. This is the starting point for understanding why the historical record here requires such careful handling.
...
1793 年 8 月 29 日，Sonthonax 总督在 Saint-Domingue 北部宣布了当地废奴——这是一个地方性的宣言，不是全国立法，但它是真实的信号。

就在 1793 年，我签了第一份以新名字命名的声明——

次年——1794 年 2 月 4 日——法国国民公会正式通过立法，废除所有殖民地的奴隶制。这是人类历史上第一次国家级别的废奴令。我在西班牙阵营里听到这个消息。那几周，我仔细评估：这个废奴令是真实的政策，还是虚词？我确认它是真的之后，1794 年 5 月，我带着部队离开西班牙，转投法国。
...
On August 29, 1793, Governor Sonthonax declared local abolition in the northern province of Saint-Domingue — a regional proclamation, not national legislation, but a real signal nonetheless.

And it was in 1793 that I signed the first declaration under my new name —

One year later, on February 4, 1794, the French National Convention passed a national law: slavery was abolished in all French colonies. This was the first state-level abolition decree in human history. When the news reached me, I was still in the Spanish camp. Over the following weeks I evaluated carefully: was this abolition decree a real policy, or empty words? Once I confirmed it was real, in May 1794, I brought my troops across and joined the French.
...
加勒比的热带气候对英国士兵是致命的。黄热病（yellow fever / fièvre jaune）在英军中造成了极高死亡率。Dubois 2004 引用的估算：英国在 1793 到 1798 年间损失了超过 40,000 名士兵——其中绝大多数死于黄热病，不是战斗。
...
我用启蒙的语言打败了启蒙的施害者，又因为对启蒙最后一丝信任走进了那间营帐。那么「用压迫者的语言去反抗压迫」这件事本身，你会怎么称呼它：一种胜利，一个陷阱，还是两者皆是？挑一个，说出你的理由。想 30 秒，写下来。`,
...
读完 Toussaint 的 12 个节点，你刚才已经给「用压迫者的语言反抗压迫」下过一个判断。现在再往前看一步：这个判断对你自己有什么用。

不过先记住：你这一遍，听的只是用压迫者的话反抗的 Toussaint。靠这套殖民体系得利的 Voltaire、被同一个法国送上断头台的 Gouges，各有各的说法——换个视角再走一遍，你会听见他们怎么讲这同一段历史，也会看看你刚才的判断站不站得住。

你身边有没有人，正在「用对方的规则跟对方较量」——也许就是你自己？带着你对 Toussaint 的判断，你会提醒 TA 什么，又会怎么帮 TA？想 30 秒，写下来。`,
...
Having read all twelve nodes of Toussaint\'s story, you have already passed your own judgment on using the oppressor\'s language to resist oppression. Now take it one step further: what that judgment is good for in your own life.

But first, remember: this pass, you heard only Toussaint, who fought with the oppressor\'s own words. Voltaire, who profited from this same colonial system, and Gouges, sent to the guillotine by the same France, each have their own case. Run it again through another lens and you will hear how they tell this same history, and see whether the judgment you just made still holds.

Is there someone around you right now who is fighting an opponent by that opponent\'s own rules — maybe even you? Carrying your judgment of Toussaint, what would you warn them about, and how would you help them? Take thirty seconds, and write it down.`,
    },
