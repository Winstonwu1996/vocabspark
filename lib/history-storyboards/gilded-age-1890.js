...
export var carnegieLens = {
  ...
  icon: '🏭',
  description: {
    cn: '他是全美最大的钢铁帝国的主人，一辈子捐建了 2500 多座图书馆，把自己写成穷孩子靠书翻身的活样板。1892 年夏天，他人在大洋彼岸的苏格兰，自己工厂的工人罢工。这一遍让你从他这里看：他把对付工人的全权交给了硬手厂长，只说一句「合同到期后必须变成没有工人组织的厂，怎么做你看着办」,,隔着一个大西洋，他要不要为接下来在厂门口流的血负责，他自己说不知情，你信吗。',
    en: 'He is the master of the largest steel empire in America, who funded more than 2,500 libraries in his life and wrote himself as the living proof that a poor boy can rise on books. In the summer of 1892 he is across the ocean in Scotland, and his own workers go on strike. This pass lets you watch him as he hands full authority over the mill to a hard-line manager, with only one instruction, "when the contract expires this mill must become one with no workers\' organization, how you do it is up to you", and asks, from an ocean away, whether he answers for the blood that will soon spill at the mill gate. He says he did not know. Do you believe him?',
  },
  storyboard: [
    {
      id: 'carn-n1',
...
export var gompersLens = {
  ...
  icon: '🚬',
  description: {
    cn: '他是手指被烟叶染得发黄的人,10 岁起在卷烟工坊干活,听身边人念书念报学怎么思考。后来他建起全美最大的工人联合组织,当了快 40 年的头。这一遍让你跟他算一笔残酷的账:他能集起几十万熟练工跟老板叫板,可没技术、刚下船的移民、大批女工几乎没有讨价还价的本钱,为「所有工人」张怀抱可能谁都救不了,只为「争得动的那部分」死守能救一部分,但要亲手把另一部分人关在门外。他选哪条路?',
    en: 'He is the man with fingers stained yellow by tobacco, rolling cigars from age ten, learning to think while others read aloud beside him on the shop floor. Later he built the largest federation of workers\' organizations in America and led it for nearly forty years. This pass lets you do a cruel piece of arithmetic with him: he can muster hundreds of thousands of skilled workers to face down capital, yet the unskilled, the immigrants fresh off the boat, and the mass of women workers have almost no bargaining chips; opening his arms for "all workers" may save no one, while holding firm only for "the part you can win for" saves some but shuts the rest outside the door with his own hands. Which road does he take?',
  },
  storyboard: [
    {
      id: 'gomp-n1',
...
export var homesteadStrikerLens = {
  ...
  icon: '⚙️',
  description: {
    cn: '他是 1892 年 7 月 6 日天没亮守在 Homestead 钢厂河边的人(合成人物,那天的对峙和死伤是史料确证的,名字和家事是叙事补充)。他手里没枪,只有 1500 度高炉边烤了十几年的力气和一肚子怕。河面雾里飘来两条黑大船,船上是厂里花钱请来、握步枪的私兵。这一遍让你跟他站在岸上:手里只有石头、棍子,对面是训练有素的枪,他是后退保命、看别人进厂顶掉他养家的活,还是用这身肉去挡那一船的枪。',
    en: 'He is the man standing by the river at the Homestead steel mill before dawn on 6 July 1892 (a composite person; the standoff and the dead and wounded that day are confirmed by the record, his name and family a narrative addition). He has no gun, only this body roasted for ten-plus years beside furnaces at 1,500 degrees, and a belly full of fear. Through the mist on the water, two dark hulking boats come up, carrying private men the mill has paid, gripping rifles. This pass puts you on the bank with him: in his hands are stones and clubs, across the water are trained guns, and he must choose, fall back and keep his life as others go in to take the work that feeds his family, or use this body of flesh to block that boatload of rifles.',
  },
  storyboard: [
    {
      id: 'hs-n1',
