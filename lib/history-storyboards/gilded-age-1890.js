...
export var gompersLens = {
  ...
  icon: '🚬',
  description: {
    cn: '他是手指被烟叶染得发黄的人,,10 岁起就在卷烟工坊里干活，听着身边人念书念报学怎么思考。后来他建起全美最大的工人联合组织，当了快 40 年的头。这一遍让你跟他一起算一笔残酷的账：他手里能集结起几十万熟练工跟老板叫板，可那些没技术、刚下船的移民、还有大批女工，几乎没有讨价还价的本钱,,为「所有工人」张开怀抱可能谁都救不了，只为「争得动的那部分」死守能救一部分，但要亲手把另一部分人关在门外。他选哪条路？',
    en: 'He is the man with fingers stained yellow by tobacco, rolling cigars from the age of ten and learning to think while others read aloud beside him on the shop floor. Later he built the largest federation of workers\' organizations in America and led it for nearly forty years. This pass lets you do a cruel piece of arithmetic with him: he can muster hundreds of thousands of skilled workers to face down capital, yet the unskilled, the immigrants fresh off the boat, and a great mass of women workers have almost no bargaining chips, and to open his arms for "all workers" may save no one, while to hold firm only for "the part you can win for" saves some but shuts the rest outside the door with his own hands. Which road does he take?',
  },
  storyboard: [
    {
      id: 'gomp-n1',
...
export var homesteadStrikerLens = {
  ...
  icon: '⚙️',
  description: {
    cn: '他是 1892 年 7 月 6 日天还没亮就守在 Homestead 钢厂河边的人（合成人物，那天的对峙和死伤是史料确证的，他的名字和家事是叙事补充）。他手里没枪，只有这身在 1500 度高炉边烤了十几年的力气，和一肚子怕。河面雾里飘来两条黑大船，船上是厂里花钱请来对付他们的私兵，握着步枪。这一遍让你跟他一起站在岸上：手里只有石头、棍子，对面是训练有素的枪。他是后退保命、眼睁睁看别人进厂顶掉他养家的活，还是用这身肉去挡那一船的枪。',
    en: 'He is the man standing by the river at the Homestead steel mill before dawn on 6 July 1892 (a composite person; the standoff and the dead and wounded that day are confirmed by the record, his name and family a narrative addition). He has no gun in his hand, only this body roasted for more than ten years beside furnaces at 1,500 degrees, and a belly full of fear. Out on the water, through the mist, two dark hulking boats come up, carrying private men the mill has paid to deal with them, gripping rifles. This pass puts you on the bank with him: in his hands are stones, clubs, and across the water are trained guns, and he must choose, fall back and keep his life as others go in to take the work that feeds his family, or use this body of flesh to block that boatload of rifles.',
  },
  storyboard: [
    {
      id: 'hs-n1',
