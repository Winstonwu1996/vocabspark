...
export var janissaryLens = {
  ...
  icon: '⚔️',
  description: {
    cn: '奥斯曼苏丹最精锐的步兵之一。他生在巴尔干一个基督徒农家,小时候被征募官按 devshirme(童子征募制)从家里带走,皈依伊斯兰,训练成苏丹的奴隶兵。他不许结婚、没家庭、法律上是苏丹的财产,可也是帝国最有战斗力、最有前途的人,不少首席行政官就这样出身。他记得母亲的话、村里教堂的钟声,也真心效忠那个夺走他又抬起他的帝国。这一遍让你坐进一个夹缝里的人:他既是受害者又是统治机器一部分,两样同时是真的。',
    en: 'One of the Ottoman Sultan\'s most elite infantry. He was born to a Christian farming family in the Balkans and taken from home as a boy under the devshirme (the child levy), converted to Islam, and trained into the Sultan\'s slave soldier. He may not marry, has no family, is in law the Sultan\'s property, yet is also among the most formidable and most promising men in the empire, for not a few of its chief administrators came up the same way. He remembers his mother\'s tongue and the church bells of his village, and is also truly loyal to the empire that took him and raised him. This pass puts you inside a man in a vise: at once a victim and a part of the ruling machine, both true at the same time.',
  },
  storyboard: [
    {
      id: 'jan-n1',
...
export var nonMuslimSubjectLens = {
  ...
  icon: '🌾',
  description: {
    cn: '莫卧儿治下的印度教农民,三个穆斯林帝国治下人数最多却最没声音的人之一。他不打仗、不进宫廷、不立法,只种地交税,看帝国政策在头上变来变去。Akbar 之前他作为非穆斯林要交人头税 jizya;1564 年 Akbar 废了它,他头一回觉得自己像帝国一份子。可他清楚这是君主「赏」的,换个君主随时能收回,Aurangzeb 果然又加了回来。这一遍,你从帝国「黄金时代」没打算细看的人这边,看火药帝国史。',
    en: 'A Hindu farmer under Mughal rule, one of the most numerous and most voiceless of the ordinary people these three Muslim empires ruled. He does not fight, does not enter the court, does not make laws; he tills the soil, pays the taxes, watches the empire\'s policies shift over his head from far away. Before Akbar, as a non-Muslim he paid the head tax called jizya; in 1564 Akbar abolished it, and for the first time he felt like a member of the empire. Yet he knows: this was the emperor\'s to "grant," and another emperor could take it back, and Aurangzeb indeed brought it back later. This pass lets you see the whole gunpowder-empires history from the side of the people their "golden ages" never meant to look at closely.',
  },
  storyboard: [
    {
      id: 'nms-n1',
