...
export var wilsonLens = {
  ...
  icon: '🕊️',
  description: {
    cn: '他是 1917 年 4 月 2 日站在国会两院面前的总统，要请他们做一件他竞选时承诺绝不做的事：参战。三年了，欧洲在打一场谁也停不下来的大战，他一直让美国置身事外，可今天他要把几百万美国年轻人送过大西洋，送进别人的战壕。这一遍让你跟他一起站在那个讲台上：他得给这件事一个大到配得上这么多人去死的理由，他张口说出后来全世界都记住的那一句,,他相信自己说的，可你听着，会发现这同一句话既是他的理想，也是他给自己心里那道坎递的一个台阶。',
    en: 'He is the president standing before both houses of Congress on 2 April 1917, asking them to do the one thing he had promised in his campaign never to do: enter the war. For three years Europe has been fighting a great war no one can stop, and he has kept America out, yet today he is to send millions of young Americans across the Atlantic into other men\'s trenches. This pass puts you with him at that podium: he must give this thing a reason large enough to be worth so many deaths, and the line he speaks the whole world will remember. He believes what he says. But as you listen, you find this same line is both his ideal and the step he offers his own conscience to get over.',
  },
  storyboard: [
    {
      id: 'wil-n1',
...
export var principLens = {
  ...
  icon: '🔫',
  description: {
    cn: '他是 1914 年 6 月 28 日上午站在萨拉热窝街角失魂落魄的 19 岁青年，刚才他们这帮人扔的炸弹没炸死车里的人，他以为今天完了。就在这时那辆敞篷车又开了过来,,司机走错路正要倒车，停在他面前几步远，车上正是奥匈帝国的王储夫妇。他几乎不敢相信，掏出枪走上前，开了两枪。这一遍让你跟他一起站在那个街角：他以为自己打死的是压在家乡头上那个帝国的象征，是点了一把解放的火,,他不知道这把枪背后，连着整个欧洲一张张密约绑成的两串炸药。然后你和他一起，眼睁睁看那两枪一步步变成一场谁也控制不了的世界大战。',
    en: 'He is the dazed 19-year-old standing on a Sarajevo street corner on the morning of 28 June 1914, after the bomb his group had thrown failed to kill the people in the car and he thought the day was lost. Just then that open car comes by again, the driver having taken a wrong turn and stopped a few steps in front of him, with the heir of Austria-Hungary and his wife inside. He can hardly believe it, draws his pistol, steps forward, and fires two shots. This pass puts you with him at that corner: he thinks he has killed the symbol of the empire pressing down on his homeland, that he has lit a fire of liberation, and he does not know that wired behind this pistol are the two strings of explosives the great powers had bound themselves into with treaty after treaty. Then with him you watch those two shots become, step by step, a world war no one can control.',
  },
  storyboard: [
    {
      id: 'pri-n1',
...
export var tirailleurLens = {
  ...
  icon: '🎖️',
  description: {
    cn: '他叫 Demba（合成人物，根据真实的塞内加尔狙击兵史实拼出，他的名字和村子是叙事补充，史料确证的是这支部队的存在和他们的遭遇）。他大约 1895 年生在西非靠海的村子里，他不识法文，不知道德国在哪，更不懂什么叫「同盟国」「协约国」,,他从小听得见海，可从没想过有一天会渡过它。这一遍让你跟他一起站在法国北部一条灌满泥水的战壕里：那是他这辈子见过的最冷的地方，他要为一个统治着他家乡的国家，打一场跟他完全没关系的战争，没有人问过他愿不愿意,,「这到底是谁的战争，凭什么要我去死」，他要替你想这个问题。',
    en: 'His name is Demba (a composite character, pieced together from the real history of the Senegalese tirailleurs; his name and home village are narrative additions, what the record confirms is the existence of this corps and what befell them). He was born around 1895 in a village by the sea in West Africa, cannot read French, does not know where Germany is, still less what "the Central Powers" or "the Allies" mean. He grew up hearing the sea, yet never thought he would cross it. This pass puts you with him in a trench in northern France flooded with mud and water, the coldest place he ever saw, having to fight for a country that rules his homeland, in a war that has nothing to do with him, with no one asking whether he was willing. He must turn over for you the question, whose war is this, by what right must I die in it?',
  },
  storyboard: [
    {
      id: 'tir-n1',
    ...
    },
    {
      ...
      phase: 'setup',
      content: {
        cn: '先说我被拽走之前的日子，你才懂后来那条战壕对我意味着什么。\n\n我家在一个靠海的村子。我们种花生、放牲口、捕鱼。日子穷，但那是我的土地、我的家人、我听得懂的语言。\n\n可这片土地，不归我们做主。几十年前，法国和别的欧洲国家，在一张非洲地图上用尺子画线，把整个非洲切成一块块，分给自己。我们这一块，归了法国。(他们怎么用一把尺子在地图上划走整个非洲，你跑过 scramble-for-africa 那段历史就懂。)\n\n从那以后，法国官员管着我们：收税、定规矩、需要劳力的时候征人。\n\n你要知道一件让人难受的事：在更早的时候，西非这片土地上曾经有过自己强大的帝国，有自己的城市、商路、学者。(那段我们自己当家的历史，在 mali-empire 那段历史里。) 可到了我这一代，我们成了别人地图上的一块颜色。\n\n所以当法国说「我们需要兵」的时候，我没有说不的权利。',
