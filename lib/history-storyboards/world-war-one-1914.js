...
export var wilsonLens = {
  ...
  description: {
    ...
    en: 'On 2 April 1917 he stands before both houses of Congress to ask them to do the one thing he had promised in his campaign never to do: enter the war. For three years Europe has been fighting a great war no one can stop, and he has kept America out; yet today he is about to send millions of young Americans across the Atlantic. This pass puts you with him at that podium, to hear the line the whole world will remember, a line that is both his ideal and the step he offers his own conscience to get over.',
  },
  storyboard: [
    {
      id: 'wil-n1',
...
export var principLens = {
  ...
  description: {
    ...
    en: 'He is the dazed 19-year-old on a Sarajevo street corner on the morning of 28 June 1914, after the bomb his group threw failed and he thought the day was lost. Just then that open car comes by again, the driver having taken a wrong turn, and stops a few steps from him with the heir of Austria-Hungary and his wife inside. This pass puts you with him at that corner: he thinks he has killed the symbol of the empire pressing down on his homeland, not knowing that wired behind this pistol are two strings of explosives the great powers had bound themselves into with treaty after treaty.',
  },
  storyboard: [
    {
      id: 'pri-n1',
...
export var tirailleurLens = {
  ...
  description: {
    ...
    en: 'His name is Demba (a composite character, pieced together from the real history of the Senegalese tirailleurs). Born around 1895 in a village by the sea in West Africa, he cannot read French and does not know where Germany is. He grew up hearing the sea, never thinking he would cross it. This pass puts you with him in a mud-and-water trench in northern France, the coldest place he has ever seen, fighting for the country that rules his homeland in a war that has nothing to do with him, no one having asked. He must turn over the question: whose war is this, and by what right must I die in it?',
  },
  storyboard: [
    {
      id: 'tir-n1',
