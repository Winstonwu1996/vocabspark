...
export var polkLens = {
  ...
  icon: '👔',
  description: {
    cn: '田纳西人，1795 年生，安静、刻板、工作到把自己累垮的总统。1845 年上任那天，他给自己列了四个目标，四年里几乎全做到，其中两个是拿下俄勒冈和加州。他真心相信向西扩张是美国注定的命运，并为此对墨西哥打了一场仗，把版图推到太平洋。同一个他，一辈子靠田纳西种植园的被奴役者维生，他扩出的每一块新地，立刻成了「算蓄奴州还是自由州」的火药桶。这一遍让你从一个「目标全兑现」的总统内部，看一个国家的成就和它的代价怎么同时长出来。',
    en: 'A Tennessean, born 1795, a quiet, rigid president who worked himself into the grave. On the day he took office in 1845 he set himself four goals and met nearly all of them in four years, two of which were taking Oregon and California. He truly believed westward expansion was America\'s destined fate, and to that end he fought a war with Mexico and pushed the map to the Pacific. The same man lived his whole life off the enslaved people of a Tennessee plantation, and every new tract he expanded into became at once a powder keg over "slave state or free state." This pass lets you watch, from inside a president who met all his goals, how a nation\'s achievement and its cost grow at the same time.',
  },
  storyboard: [
    {
      id: 'polk-n1',
...
export var thoreauLens = {
  ...
  icon: '⚖️',
  description: {
    cn: '马萨诸塞 Concord 人，1817 年生，作家兼博物学者，曾在 Walden Pond（瓦尔登湖）边一间自己盖的小木屋里独居。他不是政客，不是带兵的人，手里一点权力都没有。1846 年，他拒绝缴一笔会流向这场他认为不义的战争、并保护奴隶制的政府的人头税，为此在牢里关了一夜。这一夜后来生出一篇影响世界的文章《Civil Disobedience（公民不服从）》。这一遍让你从一个夹在中间的人这边，看一个普通公民面对自己反对、却无力阻止的事，到底还能做什么。',
    en: 'A man of Concord, Massachusetts, born 1817, a writer and naturalist who once lived alone in a small cabin he built himself by Walden Pond. He was no politician, no general, and held not a shred of power. In 1846 he refused to pay a poll tax that would flow to a government waging a war he believed unjust and protecting slavery, and for this he spent a night in jail. That one night gave rise to an essay that shaped the world, Civil Disobedience. This pass puts you in the place of a man caught in the middle, watching what an ordinary citizen can still do in the face of something he opposes but is powerless to stop.',
  },
  storyboard: [
    {
      id: 'thoreau-n1',
...
export var vallejoLens = {
  ...
  icon: '🌵',
  description: {
    cn: '真实历史人物，1807 年生在西班牙治下的加州（当时叫 Alta California），是 Californio——加州世代相传的西班牙裔/墨西哥裔家族。他一度是北加州最有权势的人，在 Sonoma 一带掌管约 17.5 万英亩的大牧场，牛马成群。耐人寻味的是，他并不反美——他相信加州归入美国会更稳定繁荣。可 1848 年加州割让给美国后，条约白纸黑字保证他的财产，他却在淘金客的强占和美国法庭十几年的诉讼里，把那 17.5 万英亩一块块地丢掉，最后只剩几百英亩。这一遍，你从一个「欢迎了新主人、却被新主人的规则掏空」的人这边，看 1840 年代的西进扩张。',
    en: 'A real historical person, born 1807 in Spanish-ruled California (then called Alta California), a Californio, of the Spanish and Mexican families rooted in California for generations. He was once the most powerful man in northern California, holding about 175,000 acres of ranch land around Sonoma, herds of cattle and horses. Tellingly, he was no foe of America, he believed California joining the United States would bring greater stability and prosperity. Yet after California was ceded to America in 1848, with a treaty that guaranteed his property in black and white, he lost those 175,000 acres tract by tract, to squatting gold-seekers and more than a decade of American court cases, until only a few hundred acres remained. This pass lets you see the westward expansion of the 1840s from the side of a man who welcomed the new master, and was hollowed out by the new master\'s rules.',
  },
  storyboard: [
    {
      id: 'vallejo-n1',
