...
//   - 7thgrader (小薇): 3 P0 (Luther N4 名字超载 / Erasmus N4 概念词 / Erasmus dependency hint)
...
var lutherStoryboard = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '后来这一句「Here I stand. I can do no other」变成 Reformation 最有名的口号。我不是 4 月 17 日下午说的,是 4 月 18 日傍晚说的——隔了一夜祷告之后。中间那一夜没人看见,但那一夜才是这句话真正的成本。',
      en:
        ...
        'Later this line, "Here I stand," became the most famous slogan of the Reformation. I did not say it on the afternoon of April 17. I said it on the evening of April 18 — after the night between. No one saw that night. But that night is what the line actually cost.',
    },
    deliverGoal: {
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '——\n\n' +
        '我也支持过烧女巫。我多次讲道说女巫是真实的、必须烧。我对 Wittenberg 法庭说过:「上帝命令我们必须杀这种人。」整个 1450-1750 年这 300 年,欧洲烧死大约 4-6 万「女巫」,75-85% 是女性——主要是寡妇、老年妇女、助产士、边缘女人。新教国家(德国部分地区、苏格兰、瑞士部分地区)烧得比天主教国家更多——这是历史学家反复确认的反直觉事实。\n\n' +
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '一边——他给世界「个人良心 vs 集体权威」这一句话。1521 年 4 月 18 日他面对皇帝 + 教皇代表 + 7 个选帝侯说「Here I stand」。这一句话从他嘴里走到 Mahatma Gandhi、Martin Luther King、Edward Snowden。Reformation 没有 Luther 不会发生:民族语言 Bible、新教家庭、政教分离的种子,都从他那一夜长出来。\n\n' +
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    engagementHook: {
      cn: '哪一种路径更说服你?想 30 秒。',
      en: 'Which path is more persuasive to you? Take thirty seconds.',
    },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '——\n\n' +
        '换一个角度看,你已经学过 Renaissance Topic——你看见的是另一个故事的另一边。\n\n' +
...
var erasmusStoryboard = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    deliverGoal:
      ...
      '两边都站得住。想 30 秒。',
    engagementHook:
      '**你愿意要哪种代价**？欧洲式碎片化(Reformation 革命 + 130 年血)还是中国式大一统(王阳明心学 + 没催生 First Amendment)？想 30 秒。',
    expectedLength: '380-440 字 CN + 真问题',
    expectsRealAnswer: true,
  },
...
var agnesStoryboard = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '**另一种说法**——Reformation 也撕裂了传统女性 institutional roles。修女院是中世纪极少数让女性独立(不结婚 + 受教育 + 有 community)的 institution。Henry VIII 1536-1540 关上 800+ 修道院 = 关上一种女性可能性。Calvin 1539 禁 Marie Dentière 写女人神学。新教学校只雇男老师。1450-1750 年欧洲烧死 4-6 万"女巫",75-85% 是女性,主要是寡妇 + 老年妇女 + 边缘女性,新教国家烧得比天主教国家更多。Henry VIII 解散修道院之后,英国到 19 世纪才有 women\'s colleges——Cambridge Girton 1869。\n\n' +
        '两边都站得住。\n\n' +
      ...
      en:
        ...
        '**The other view —** the Reformation also tore apart the traditional female institutional roles. The convent was one of the very few medieval European institutions that let a woman live independently (unmarried, educated, in a community of other women). Between 1536 and 1540 Henry VIII closed more than eight hundred religious houses, closing one possibility for women. In 1539 Calvin in Geneva silenced Marie Dentière for daring to write theology. The new Protestant schools hired only men. Between 1450 and 1750, somewhere between forty and sixty thousand "witches" were executed in Europe (seventy-five to eighty-five percent of them women, mostly widows, the old, the marginal), and Protestant lands burned more of them than Catholic lands. After Henry closed the convents, England did not have a women\'s college again until Cambridge\'s Girton in 1869.\n\n' +
        'Both sides stand.\n\n' +
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    deliverGoal:
      ...
      '——两边都站得住。',
    engagementHook: '**你怎么看**——1539 生在 Lincolnshire 还是苏州,两边都站得住吗?想 30 秒。',
    expectedLength: '320-380 字 + 真问题',
    expectsRealAnswer: true,
  },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '在 atlas-lab/reformation 里没有。Atlas 大多数 Topic 写的是 perpetrator-actor 视角(Luther / Calvin / Henry VIII / Loyola / Trent)——这些是史书有名字的人。\n\n' +
        'Sister Agnes 这种没名字的修女——只有这种"视角学法"才能让你完整经历她的一天。\n\n' +
        '这个 Topic 还有另外两个视角:Luther(95 条钉门人)和 Erasmus(没人要的桥)。\n\n' +
    ...
    engagementHook:
      '**Sister Agnes 这一遍最让你停一下的是什么**?是签解散文件那一刻?是地下室铁盒里那本 1525 偷藏的小册子?是 39 岁拿 reference 信走出商人家?60 岁死时房东把 日记 当废纸烧?说一句话',
...
export var lenses = {
  'martin-luther': {
    ...
    description: {
      cn: '你是 Martin Luther (1483-1546),德国 Wittenberg 神学教授。1517 年 10 月 31 日你拿锤子钉 95 条到城堡教堂门——本意只是学术讨论,你不知道这一锤会触发欧洲分裂。接下来 30 年你写、辩、藏、翻译、结婚、死。1525 年农民战争屠杀 10 万人——其中一部分因为你写了《反农民帮派》。你不是英雄也不是 villain——你是 agonistic-prophet (痛苦先知)。',
      en: 'You are Martin Luther (1483-1546), a Wittenberg theology professor. On October 31, 1517, you nailed 95 theses to the church door — meant as academic debate; you did not know that hammer would crack open Europe. Over the next 30 years you write, argue, hide, translate, marry, and die. In 1525 you watch the Peasants War butcher 100,000 people — some of them because you wrote Against the Murderous, Thieving Peasant Hordes. You are neither hero nor villain — you are the agonistic-prophet.',
    },
  ...
  'erasmus': {
    ...
    description: {
      cn: '你是 Desiderius Erasmus of Rotterdam (1466-1536),北方人文主义最大学者。私生子出身,1516 编校 Greek New Testament 给 Reformation 准备了文本依据。但你不站 Luther 那边——你留在天主教内,主张内部改革。新教骂你懦夫,天主教 23 年后把你的书烧了。你是「没人要的桥」。建议先做 Luther lens 再做这个,会更容易共鸣。',
      en: 'You are Desiderius Erasmus of Rotterdam (1466-1536), the greatest scholar of northern humanism. Born illegitimate; in 1516 you produced the Greek New Testament that became the textual ground for the Reformation. But you refuse to stand with Luther — you stay inside the Catholic Church, arguing for reform from within. Protestants call you a coward; twenty-three years after your death, the Pope burns every book you ever wrote. You are the bridge nobody wanted. Recommended: do Luther lens first to resonate with this one.',
    },
  ...
  'sister-agnes': {
    ...
    description: {
      cn: '你是 Sister Agnes,虚构合成人物代表 1536-1540 Henry VIII 解散修道院时被赶出来的约 8000 个英国修女。32 岁,Cistercian 修女,18 年只见过修道院围墙内的世界。1539 年 5 月你被强制签解散文件,拿 5 镑年金,放弃 vows。你活下来——但世界对你没准备。你是 Reformation 的 forgotten-half (被遗忘的一半)。',
      en: 'You are Sister Agnes, a fictional composite representing the roughly 8,000 English nuns expelled when Henry VIII dissolved the monasteries (1536-1540). Thirty-two years old, Cistercian, you have known nothing outside the cloister walls for 18 years. In May 1539 you are made to sign the deed of surrender, accept a 5-pound-a-year pension, and abandon your vows. You survive — but the world has no place ready for you. You are the Reformation\'s forgotten-half.',
    },
