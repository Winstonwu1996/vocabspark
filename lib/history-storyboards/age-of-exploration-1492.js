  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '现在掂量两种读法。一种说:我是一个合成的女孩,不是真人——用一个虚构名字 + 一首 areíto 去承载 30 万到 100 万真实的死,会让这段灭族被你真正记住,数字记不住,一个有名字的人能记住。另一种说:正因为我不是真人,给我编名字、编家人、编死法,可能让你把「故事的感动」错当成「历史的真相」,反而模糊了那 30 万到 100 万真实的人。\n\n' +
      ...
      en:
        ...
        'Now weigh two readings. One says: I am a composite girl, not a real person — and using one invented name plus one areíto to carry the real deaths of three hundred thousand to one million people is exactly what makes this destruction something you actually remember. Numbers do not hold; a person with a name holds. The other says: precisely because I am not real, inventing my name, my family, my way of dying may trick you into mistaking "the feeling of a story" for "the truth of history," and so blur the very three hundred thousand to one million real people.\n\n' +
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '——但我有名字。\n\n' +
        '——\n\n' +
        '这一课还有另外两个视角:Columbus(1492 出航的人)和 las Casas(1502 下船的、1514 conversion 的、1542 写下我阿姨名字的修士)。做完那两个,你会发现一个 micro-detail——关于一封 1493 年的信。我不告诉你是什么。让你自己 connect。\n\n' +
...
export var anacaonaJrLens = {
  ...
  description: {
    cn: '她是 12 岁的小 Anacaona，住在 Hispaniola 西部 Xaragua 酋邦的一个 Taíno 女孩（合成人物，代表 1492-1542 年加勒比海几十万被殖民 5 年内死光全家、史书没写过名字的女孩）。她的姑姑 Anacaona 王后是真人，Xaragua 的女王，也是岛上最有名的 areíto 诗人。这一遍让你跟她坐进 bohío 草顶屋，从 1495 年那个春天她第一次看见铁甲、剑和马的那一刻开始，听她用九年一个一个唱出后来死掉的家人的名字。',
    en: 'She is twelve-year-old Little Anacaona of Xaragua on western Hispaniola (a composite standing for the hundreds of thousands of Caribbean girls between 1492 and 1542 who lost whole families within five years and whose names history did not record). Her aunt Queen Anacaona was real, ruler of Xaragua and the island\'s most famous areíto poet. This pass sits with her in a thatched bohío from the spring of 1495, when she first sees armor and horse, through nine years of singing the names of the dead.',
  },
