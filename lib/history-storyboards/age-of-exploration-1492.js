    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      content: {
        ...
        en:
          ...
          '- From 1492 onward, my men and I brought smallpox, measles, and influenza. Hispaniola began with 300,000 to 1,000,000 Taíno (the figure is debated). By 1542, only about 200 remained (Bartolomé de las Casas\'s number). Across the Americas over the next two hundred years, roughly one hundred million Indigenous people died — mainly from disease (no immunity), with enslavement, massacre, and forced labor accelerating the collapse.\n\n' +
...
var anacaonaJrStoryboard = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '一个月后,妈妈开始发烧。皮肤上长红色小点,后来变成水泡。她吐。她躺在 bohío 地上,一直叫我去远一点。这是天花,一种从西班牙人身上来、Taíno 之前没有过的病。我们没有抗体——一个村子第一次有这种病时常 80% 的人死。\n\n' +
        '3 个月后,1497 年春末,妈妈死。\n\n' +
        '是天花的病杀她,还是那个月夜杀她?——我不知道。我那时候 14 岁。她最后看了我一眼,但她没说话。\n\n' +
      ...
      en:
        ...
        'A month later she began to run a fever. Small red spots appeared, then blisters. She vomited. She lay on the floor and kept telling me to go further away. This was smallpox — a disease the Spaniards brought, no Taíno had ever had before. We had no immunity — when smallpox first reached a village, it was common for eighty in a hundred to die.\n\n' +
        'Three months later, late spring 1497, my mother was dead.\n\n' +
        'Was it the smallpox that killed her, or that moonlit night? I do not know. I was fourteen. Her eyes looked at me at the end — she did not speak.\n\n' +
    ...
    deliverGoal: {
      cn: '1497 一个月夜士兵闯入。一个月后她发烧 + 长红疹 + 水泡——天花,Taíno 之前没接触过的病——3 个月后死。她最后看了我一眼,没说话。妈妈死那天我把她织一半的 8 代腰带藏在 yuca 树下。',
      en: 'In 1497 a moonlit night — soldiers forced their way in. A month later she began to fever — red spots, then blisters — smallpox, a disease the Taíno had never met — three months later she was dead. Her eyes looked at me at the end. She did not speak. The day she died I rolled up her half-woven eight-generation belt and hid it under a yuca tree.',
    },
    engagementHook: {
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        '1499 年。我 16 岁。\n\n' +
        '只剩下我跟哥哥,哥哥 19 岁。1497 那一波天花传遍 Hispaniola,1498-1499 又来第二波。1499 年春,哥哥发烧、红疹、水泡。\n\n' +
        ...
        '3 天后哥哥死了。\n\n' +
        '我 16 岁。爸爸 1496 河里、妈妈 1497 天花、叔叔 1498 砍手、哥哥 1499 天花——4 年 4 人 4 种死法。\n\n' +
        '我把哥哥埋在 yuca 树旁,妈妈织一半的腰带也埋在那里。我开始按哥哥说的把 4 个名字编进 areíto,边唱边织布。我那时候不知道——再过 5 年,会变成 6 个人。',
      en:
        '1499. I am sixteen.\n\n' +
        'Only my brother and I are left. He is nineteen. The smallpox wave that killed my mother in 1497 had spread across Hispaniola; a second wave came in 1498-1499. Spring 1499 — my brother began to fever. Red spots. Blisters.\n\n' +
        ...
        'I was sixteen. My family — father, 1496, the river. Mother, 1497, smallpox. Uncle, 1498, the cut hands. Brother, 1499, smallpox. Four years. Four people. Four different deaths.\n\n' +
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        '1502 年。我 19 岁。\n\n' +
        'Tureyra 1 岁多,开始会走路。夏天她发烧、红疹、水泡——天花,第三波。我做我妈妈做过的、我哥哥做过的同样的事。但她那么小——5 天后她死。\n\n' +
      ...
      en:
        '1502. I am nineteen.\n\n' +
        'Tureyra is just over a year old, beginning to walk. Summer — fever, red spots, blisters. Smallpox, the third wave. I did everything my mother had done for me, everything I had done for my brother. But she was so small — five days later she was dead.\n\n' +
    ...
    deliverGoal: {
      cn: '1502 夏 Tureyra 1 岁多得天花 5 天死,埋在 yuca 树下家里 4 人旁边。同年 9 月,岛北岸 La Isabela 港 18 岁 Bartolomé de las Casas 下船(他爸爸 Pedro 是 Columbus 朋友 + 1493 来过岛),他来当殖民者 + 自己有 encomienda。我跟他没见过面,岛 200 公里,但 1502 同一个月同一座岛同一片天空。12 年后 1514 他会 conversion,1542 写下 Anacaona 王后的名字——但写不下我。',
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    content: {
      cn:
        ...
        '新总督 Nicolás de Ovando(1502 到任)比 Hojeda 更冷。他给我阿姨 Anacaona 王后送信:他要来 Xaragua,跟全岛西部 80 个 cacique 开「和平会议」。阿姨 50 岁,是岛上最大酋邦的 cacique + 最有名的 areíto 诗人,她相信会议可以谈。\n\n' +
        '我那一天没去。前一晚我做梦,梦到爸爸、妈妈、叔叔、哥哥跟 Tureyra 站在 yuca 树下,5 个一起对我摇头。我醒来跟阿姨说「我不去」,她摸我的头说「Anacaona,你不一定要去」。她去了。我拿着妈妈织一半的腰带往山上走。\n\n' +
        '——\n\n' +
        '下午,80 个 cacique + Anacaona 王后聚集在 Xaragua 一个大 bohío 里。Ovando 把门围起来,给一个手势,士兵烧大 bohío。80 个没有一个出来。后来有人说,我阿姨在烧的时候唱 areíto——她自己 30 年前写的一首歌,讲 Xaragua 大地怎么从大海里升起来。\n\n' +
        '20 岁的我站在山上的树后面。我看到 bohío 那边的黑烟柱直直升到天上,白色的云被切开。\n\n' +
        '那一晚我在山上唱 areíto,把家里 4 个 + Tureyra + 阿姨 = 6 个名字编进去。哥哥 1499 年说我应该把家里所有人的名字都唱进去——他那时候不知道,「家里所有人」会变成 6 个人。',
      en:
        'November 9, 1503. I am twenty.\n\n' +
        'The new Spanish governor, Nicolás de Ovando (appointed 1502), was colder than Hojeda. He sent word to my aunt, Queen Anacaona: he was coming to Xaragua to hold a "peace meeting" with the eighty caciques of the western part of the island. My aunt — fifty, the cacique of the largest chiefdom and the most famous areíto poet on Hispaniola — believed a peace meeting could be talked through.\n\n' +
        ...
        '—\n\n' +
        'On the afternoon of November 9, eighty caciques and Queen Anacaona gathered inside one great bohío. Ovando ringed the doorway, gave a hand signal, and his soldiers set the bohío on fire. Not one of the eighty came out. Those who later spoke of it said my aunt sang an areíto as it burned — a song she had composed thirty years before, about how the land of Xaragua had risen from the sea.\n\n' +
        'I, twenty, stood behind a tree on the mountain. I saw the smoke — a black column rising straight up, cutting the white clouds open.\n\n' +
