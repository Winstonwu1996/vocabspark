...
var anacaonaJrStoryboard = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    engagementHook: {
      cn: '**这一遍哪一刻让你停下?** 1495 铁甲? 14 岁藏腰带? 1498 砍手? 1499 哥哥说唱名字? 1500 17 岁有女儿? 1502 las Casas 同岛? 1503 阿姨烧? 1504 山洞 6 个名字? 一句话告诉我。然后选: mastery 或换 Columbus / las Casas 视角——会 connect 一个 1493 年信的 micro-detail。',
      en: '**Which moment made you stop?** 1495 armor? Fourteen-year-old hiding the belt? 1498 cut hands? 1499 brother saying sing the names? 1500 seventeen-year-old with a daughter? 1502 las Casas same island? 1503 aunt burned? 1504 cave six names? One sentence. Then choose: mastery, or one of the other two lenses (Columbus or las Casas) — to connect a 1493 letter micro-detail.',
    },
