...
export var themistoclesLens = {
  ...
  icon: '⚓',
  description: {
    cn: '他是一个站在 Salamis 窄海峡边、看着对面山头上波斯大王的雅典将领，自己的城几天前刚被烧成灰，全城的老人女人孩子都躲在他身后的岛上。这一遍让你坐进他的位置，所有人都喊「打不过该逃」，他偏要赌这条窄缝里大船反而是死，看他下一秒打算用什么手段逼住那群只想撤回老家的盟友。',
    en: 'He is an Athenian general standing at the narrow strait of Salamis, the Persian king watching from the hill across, his own city burned to ash days before, every old person, woman, and child of Athens huddled on the island at his back. This pass puts you in his seat: everyone shouts "we cannot win, flee," and he is wagering instead that in this crack a big fleet becomes a death sentence, and you watch what he is about to do to force the allies, who only want to fall back to their own coasts, to stay.',
  },
  storyboard: [
    {
      id: 'them-n1',
...
export var meticResidentLens = {
  ...
  icon: '⚖️',
  description: {
    cn: '他是一个在雅典开店做买卖、说雅典话、为雅典上船划桨流血的外邦人，雅典人叫他 metic，意思是「住在身边的人」（一个合成人物，把许多真实居留外邦人的处境拼到一起）。这一遍让你站在公民大会的门外，看他每月交着居留税、赞助着战船，可投票那天还是被挡在门口，逼你想雅典那条「公民」的线到底是怎么画的。',
    en: 'He is a free foreigner who keeps a shop in Athens, speaks the Athenian tongue, and rows in its fleet and bleeds, and the Athenians call him metic, "one who dwells alongside" (a composite figure, piecing together the lives of many real resident foreigners). This pass puts you outside the door of the Assembly with him: each month he pays the foreigners\' residence tax, funds a warship for the city, and on voting day is still kept at the door, pressing you to think about exactly where Athens drew the line of "citizen."',
  },
  storyboard: [
    {
      id: 'mt-n1',
...
export var laurionSlaveLens = {
  ...
  icon: '🏺',
  description: {
    cn: '他是 Laurion 银矿地底下一个连名字都没留下的被奴役矿工，账本上记的不是名字是价钱（一个合成人物，把上万真实存在过的矿工的命合到一起）。这一遍让你蹲在矿道口跟他在一起，外面传来雅典烧了、人逃到海上的消息，他第一次想到那个只有他这位置才问得出的问题：这场全希腊为「自由」拼命的大仗，有没有一秒钟是为了我的自由？',
    en: 'He is an enslaved miner in the Laurion silver pits whose name was never kept, the ledger writing not his name but his price (a composite figure, joining the lives of tens of thousands of real miners who once existed). This pass puts you crouched at the tunnel mouth with him, word reaching down that Athens is burned and her people have fled to the sea, and he asks for the first time the question only someone in his place can ask: in this great war all Greece strains for "freedom," was there ever, for one second, anything that was for my freedom?',
  },
  storyboard: [
    {
      id: 'ls-n1',
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '我大概会死在这条矿道里，没有名字，没有坟，没有人记得。这是我们这种人最常见的结局。\n\n可这件事并没有跟着雅典一起结束：「自由」踩在不自由的人身上，往后两千多年，一遍遍重演。\n\n两千多年后，大西洋对岸出过几乎一模一样的事：公元 1776 年，一群人写了一份《独立宣言》，开头喊「人人生而平等」，喊「自由」。十一年后的 1787 年，他们又写了一部宪法，开头喊「我们人民」。可正是这部 1787 年的宪法，把跟我一样、被当成财产的人，算成 3/5 个人（那份 1776 年的宣言喊的是平等，写下 3/5 的是这部宪法）。种棉花的奴隶，养活了那个喊「自由」的国家——跟我用银养活喊「自由」的雅典，一模一样。\n\n喊「自由」的人，骑在没有自由的人身上。这不是雅典一座城的毛病，是「自由」这件事两千多年都没洗干净的一笔旧账。\n\n我没等到这笔账被还。我死在了矿里。\n\n但我想让你记住的是：每一次，当有人骄傲地喊「我们自由了」「我们赢了」，你都可以替我，往那句话的底下看一眼，那里有没有一个没被算进去、正替这份「自由」扛着的人？',
        en: 'I will most likely die in this tunnel, with no name, no grave, no one to remember. This is the commonest end for people like us.\n\nBut this thing, "freedom" standing on the unfree, did not end together with Athens.\n\nFor more than two thousand years after, this contradiction played out again and again. More than two thousand years later, across the ocean, almost exactly the same thing happened: in 1776 CE a group of men wrote a Declaration of Independence that opened crying "all men are created equal," crying "freedom." Eleven years later in 1787 they wrote a Constitution opening with "We the People." Yet it was that 1787 Constitution that counted people like me, held as property, as three-fifths of a person (the 1776 Declaration cried equality; the three-fifths clause was the Constitution). The slaves who grew the cotton fed the nation that cried "freedom," exactly as I, with silver, fed the Athens that cried "freedom." (If you have run the topic on the Philadelphia convention, you will recognize this debt at once.)\n\nThe people who cry "freedom," riding on the people who have none, this is not the fault of one city, Athens. It is an old debt that the thing called "freedom" has not washed clean in two thousand years.\n\nI did not live to see that debt paid. I died in the mine.\n\nBut what I want you to remember is this: every time someone proudly cries "we are free," "we won," you may, for me, look once beneath that sentence, and ask: is there, down there, someone never counted in, bearing this "freedom" on his back?',
      },
      deliverGoal: 'N9 zoom-out + topic connection — 我大概死矿道里没名没坟没人记 (我们这种人最常见结局) + 但「自由踩在不自由人身上」没跟雅典结束 + 跨 Topic 锚: 1776《独立宣言》喊「人人生而平等」/ 1787 宪法喊「We the People」却把被当财产的人算 3/5 (两份文件分清) + 种棉花奴隶养活喊自由的国家跟我用银养活喊自由的雅典一模一样 + 喊自由的人骑在没自由的人身上不是雅典一城毛病是两千年没洗干净的旧账 + 我没等到账被还死在矿里 + 想让你记住: 每次有人喊我们自由了我们赢了替我往底下看一眼有没有没被算进去正扛着这份自由的人',
