...
export var arkwrightLens = {
  ...
  icon: '⚙️',
  description: {
    cn: '英格兰人，1732 年生，家里十三个孩子排最小，穷得没钱上学，年轻时是个走街串巷的理发师兼假发匠。他没受过什么教育，却有一双看见机会的眼睛。1771 年他在 Cromford 建起世界上第一批靠水力运转的纺纱厂，把工人、机器和一口钟关进同一栋楼里，按钟点上下班。他赚到了爵位和巨额财富，也亲手发明了一套东西：工厂制度，连同每天十几个小时的童工班。这一遍让你从这套制度的发明者内部，看进步和代价怎么在同一栋厂房里一起诞生。',
    en: 'An Englishman, born 1732, the youngest of thirteen children, too poor to go to school, a traveling barber and wig-maker in his youth. He had little education but a sharp eye for opportunity. In 1771 he built at Cromford some of the first mills in the world run by water power, shutting workers, machines, and a single clock into one building, on and off by the hour. He won a knighthood and an enormous fortune, and with his own hands he invented something: the factory system, and the children\'s shifts of twelve hours and more that came with it. This pass lets you watch, from inside the inventor of that system, how progress and its cost are born together in the same mill.',
  },
  storyboard: [
    {
      id: 'ark-n1',
...
export var robertOwenLens = {
  ...
  icon: '🏘️',
  description: {
    cn: '威尔士人，1771 年生，十岁就出门当学徒，二十几岁已经管着一整家大棉纺厂。他本可以像别的厂主一样，靠压榨工人发财。可他偏偏相信一件当时没人信的事：人是被环境塑造的，把工厂和工人的生活弄好，工厂照样能赚钱。1800 年他接手苏格兰 New Lanark 的工厂，砍工时、办学校、不雇幼童，把它变成全欧洲来参观的模范实验。他一辈子在两个世界中间走钢丝：一边是只认利润的厂主，一边是被工厂碾过的工人。这一遍让你站在一个想两边都顾的改革者位置，看「善意」在一个残酷的系统里能走多远。',
    en: 'A Welshman, born 1771, who left home at ten to be an apprentice and by his twenties was managing a whole great cotton mill. He could have grown rich like other owners, by squeezing his workers. Instead he believed a thing no one then believed: that people are shaped by their surroundings, and that making the factory and the workers\' lives better could still turn a profit. In 1800 he took over the mill at New Lanark in Scotland, cut the hours, opened a school, refused to hire the youngest children, and made it a model experiment that all of Europe came to see. All his life he walked a tightrope between two worlds: on one side the owners who knew only profit, on the other the workers the factory ground down. This pass puts you in the seat of a reformer trying to hold both, watching how far "good intentions" can travel inside a cruel system.',
  },
  storyboard: [
    {
      id: 'ro-n1',
...
export var manchesterChildWorkerLens = {
  ...
  icon: '🧵',
  description: {
    cn: '一个九岁的女孩，叫 Ellen，在曼彻斯特一家棉纺厂干活。她不是一个真实存在过的具体某人，而是用很多真实证词拼出来的一个孩子（基于 1832 年英国议会 Sadler 报告里上百名工厂童工的真实证言）。她每天天不亮就被叫醒，走进机器轰鸣的车间，一站就是十几个小时，钻进机器底下接断线，困了就被监工的皮带抽醒。她的一根手指被机器咬掉过，她的脊柱因为常年弯腰长歪了。这一遍，你站在那些把工业革命扛在自己小小身体上的人这边，看这段历史。',
    en: 'A nine-year-old girl named Ellen, working in a cotton mill in Manchester. She is not one real, specific person, but a child pieced together from many true accounts (based on the testimony of more than a hundred real factory children in the 1832 Sadler Report to the British Parliament). Every day she is woken before dawn, walks into a workroom roaring with machines, stands for twelve hours and more, reaches under the machine to join broken threads, and when she nods off is struck awake by the overlooker\'s strap. A machine bit off one of her fingers; her spine grew crooked from years of bending. This pass puts you on the side of those who carried the Industrial Revolution on their own small bodies, and lets you see this history from there.',
  },
  storyboard: [
    {
      id: 'mc-n1',
