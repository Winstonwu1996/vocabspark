...
export var colonialEliteLens = {
  ...
  icon: '🎩',
  description: {
    cn: '弗吉尼亚的烟草种植园主,约 1700 年当家。祖父辈坐契约奴的船来到这片土地,干满几年分到一块地,三代下来攒成了沿河几千英亩的烟草庄园。每天清晨他骑马巡田,鞋底沾着红黏土,闻得出烟叶晾到几分熟。他既是「老板」,又坐在弗吉尼亚议会里投票当「立法者」。他要的就是两样:更多的地,更多的劳力。这一遍让你从一个赢家内部,看一片「机会之地」的繁荣,是怎么被建在别人的土地和劳动上的。',
    en: 'A Virginia tobacco planter, master of his estate around 1700. His grandfather had crossed the ocean as an indentured servant, served his years, and was given a plot of land; three generations on, the family held thousands of acres of tobacco along the river. Each dawn he rode out to inspect the fields, red clay on his boots, able to smell how far the tobacco leaves had cured. He was both the boss and a lawmaker who voted in the Virginia assembly. He wanted two things: more land, and more labor. This pass lets you watch, from inside a winner, how the prosperity of a "land of opportunity" was built on other people\'s land and labor.',
  },
  storyboard: [
    {
      id: 'ce-n1',
...
export var indenturedServantLens = {
  ...
  icon: '⚖️',
  description: {
    cn: '从英格兰来的契约奴,约 1690 年代上岸。在英国是个没地、没活路的穷姑娘,有人给了一张合同:签几年白干,管饭管住,到期发一身衣服、几样工具、有时一小块地,换来一张横渡大西洋的船票。她卡在中间:不是自由人,也不是终身奴隶;法律上还是「人」,可这几年里,主人能买卖她、打她、延她的年限。她的位置正卡在历史的拐弯上。「契约奴」这条会翻身的路,正被一道道法律改写成「看你是什么肤色」。这一遍让你从两个世界中间那个人的位置,看一片殖民地的底层是怎么被一道线劈开的。',
    en: 'An indentured servant from England, landed in the 1690s. In England she was a poor girl with no land and no living, and someone gave her a contract: sign for years of unpaid labor, food and lodging provided, and at term\'s end a set of clothes, some tools, sometimes a small plot of land, in exchange for passage across the Atlantic. She was caught in the middle, not a free person, not a slave for life; in law still a "person," yet for those years a master could sell her, beat her, extend her term. Her place was caught on the bend of history, as the rising road of "indenture" was being rewritten, law by law, into "it depends on your color." This pass puts you in the seat of the one between two worlds, watching how the bottom of a colony was split apart by a single line.',
  },
  storyboard: [
    {
      id: 'is-n1',
...
export var enslavedAfricanLens = {
  ...
  icon: '⛓️',
  description: {
    cn: '一名被掳到南卡稻米种植园的西非人。他原本在西非的村子里有名字、有家、有种稻的手艺。一天他被掳走、卖给沿海的奴隶贩子、锁进船舱底层,横渡大西洋。这段航程叫 Middle Passage(中段航程):挤在不能直腰的舱里几个星期,锁着、病着,有人死在身边被扔进海里。上岸后他被拍卖,在账本上被记成一笔财产,跟牲口列在一起。讽刺的是,南卡种稻发的财,靠的正是他从西非带来的种稻和治水手艺。他的知识让别人致富,他自己一无所有。这一遍,你从整片殖民地繁荣的最底层,看那句「机会之地」到底是谁的机会。',
    en: 'A West African dragged to a rice plantation in South Carolina. In his village in West Africa he had a name, a family, the skill of growing rice. One day he was seized, sold to slavers on the coast, locked into the hold of a ship, and carried across the Atlantic, a voyage called the Middle Passage: weeks in a hold where he could not straighten his back, chained, sick, some dying beside him and thrown into the sea. Ashore, he was sold at auction, recorded in a ledger as a piece of property, listed alongside the livestock. The irony is that the fortune South Carolina made on rice rested on the rice-growing and water-managing skill he brought from West Africa, his knowledge made others rich while he had nothing. This pass lets you see, from the very bottom of a whole colony\'s prosperity, whose opportunity the "land of opportunity" really was.',
  },
  storyboard: [
    {
      id: 'ea-n1',
