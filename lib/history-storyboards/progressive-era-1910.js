...
export var theodoreRooseveltLens = {
  ...
  icon: '🐻',
  description: {
    cn: '他是一个谁都没选过的总统：1901 年 9 月他正在山间小路上登山，传令员追上来说总统中枪了，几小时后他 42 岁接班，成了美国到那时最年轻的总统。华盛顿那些老政客们都头疼,,这个浑身是劲、谁都敢顶的年轻人，要怎么管。这一遍让你从他这里看：他面前是一个被几个没人选过的钢铁大王、石油大王攥住的国家，他打算挥起大棒去拆，可同一双手也举着白人种族更优越的旗子去抢殖民地,,「进步」这两个字的光和影，在他身上同时长着。',
    en: 'He is a president no one elected: in September 1901 he was up a mountain trail when a messenger came panting after him to say the president had been shot, and hours later, at 42, he took over as the youngest president America had ever had. The old politicians in Washington were worried, this restless young man who would face down anyone, how do we control him. This pass lets you watch him as he faces a country gripped by a handful of unelected steel and oil kings, ready to swing his big stick and break them, while the same hands hold up the banner of white racial superiority and grab for colonies abroad. The light and the shadow of the word "progress" grow on him at the same time.',
  },
  storyboard: [
    {
      id: 'tr-n1',
...
export var janeAddamsLens = {
  ...
  icon: '🏠',
  description: {
    cn: '她是 1889 年那个搬进芝加哥最穷移民区的富家女儿,,别人是去「行善」，她是直接搬进去，跟意大利人、波兰人、犹太人、希腊人做邻居，住同一条街，闻同样的味道，听同样夜里的哭声。她从小读了一肚子书，可那年代一个受过教育的女人，竟然找不到一件「正经事」可做。这一遍让你跟她一起站在 Hull House 门口看：华盛顿在谈反垄断、谈选举这些大事，可这些大事怎么变成她邻居孩子嘴里的一口饭、肺里的一口干净空气,,中间隔着十万八千里，没人去搭那座桥，她决定她来搭。',
    en: 'She is the wealthy merchant\'s daughter who in 1889 moved into the poorest immigrant district of Chicago, not to "do good" but to live there, neighbor to Italians, Poles, Jews and Greeks on the same street, breathing the same smells, hearing the same crying at night. She had read widely from childhood, yet in that era an educated woman could find no "proper work" she was allowed to do. This pass puts you with her at the door of Hull House: in Washington they argue antitrust and elections and great matters, but how do those great matters become a mouthful of food in her neighbor\'s child, a breath of clean air in their lungs, a vast distance lies between, and no one is building the bridge, and she decides she will build it.',
  },
  storyboard: [
    {
      id: 'ja-n1',
...
export var triangleFireWorkerLens = {
  ...
  icon: '🔥',
  description: {
    cn: '她是 1911 年 3 月 25 日下午快五点那场火里的人（合成的角色，名字和年龄是叙事补充，确证的是这场火和 146 个死者）。她十几岁，几年前跟家人从欧洲坐船来到纽约，每天在 Triangle 制衣厂踩缝纫机踩到天黑。那天下午她正准备收工回家，八楼起火，她和几百个工友冲向楼梯口,,门，锁着，从外面锁的，老板怕她们偷布料、偷一分钟懒。这一遍让你跟她一起站在那扇锁着的门后面往外看：进步时代漂亮的口号，到底有没有能伸到这扇门里来的那一只手。',
    en: 'She is one of the people in the fire just before five on the afternoon of 25 March 1911 (a composite character, the name and age a narrative addition, what is confirmed is the fire and its 146 dead). She is in her teens, came by ship from Europe to New York with her family a few years before, and treads a sewing machine in the Triangle garment factory until dark each day. That afternoon she was getting ready to go home when the eighth floor caught fire, and she and hundreds of workmates rushed to the stairwell, where the door was locked, locked from the outside, by bosses afraid they would steal cloth, steal a minute of idleness. This pass puts you behind that locked door with her, looking out, to see whether the fine slogans of the Progressive Era have any hand that can reach in through this door.',
  },
  storyboard: [
    {
      id: 'tw-n1',
