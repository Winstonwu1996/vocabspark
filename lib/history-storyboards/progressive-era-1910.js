...
export var triangleFireWorkerLens = {
  ...
  icon: '🔥',
  description: {
    cn: '她是 1911 年 3 月 25 日下午快五点那场火里的人（合成的角色，名字和年龄是叙事补充，确证的是这场火和 146 个死者）。她十几岁，几年前跟家人从欧洲坐船来到纽约，每天在 Triangle 制衣厂踩缝纫机踩到天黑。那天下午她正准备收工回家，八楼起火，她和几百个工友冲向楼梯口，门锁着，从外面锁的。这一遍让你跟她一起站在那扇锁着的门后面往外看，进步时代漂亮的口号到底有没有能伸到这扇门里来的那只手。',
