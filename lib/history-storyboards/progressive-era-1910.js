...
export var theodoreRooseveltLens = {
  ...
  icon: '🐻',
  description: {
    cn: '纽约人，1858 年生，体弱多病的近视眼小孩，靠拼命锻炼把自己练成牛仔、猎人、军人。1901 年总统遇刺，他 42 岁接任，是美国到那时最年轻的总统。他举着大棒拆开垄断巨头，把一亿英亩荒野划成国家保护地，民众喊他「打 trust 的英雄」。同一个他，公开相信白人种族更优越，支持优生学，把美国变成一个抢殖民地的帝国。这一遍让你从一个改革者内部，看「进步」这两个字的光和影怎么长在同一个人身上。',
    en: 'A New Yorker, born 1858, a sickly, nearsighted boy who drove himself through exercise into a cowboy, a hunter, a soldier. When the president was shot in 1901 he took over at 42, the youngest president America had had to that point. He swung a big stick to break apart the giant monopolies and set aside a hundred million acres of wilderness as protected land, and the public called him the hero who fought the trusts. The same man openly believed the white race was superior, backed eugenics, and turned America into an empire grabbing for colonies. This pass lets you watch, from inside a reformer, how the light and the shadow of the word "progress" grow on the same person.',
  },
  storyboard: [
    {
      id: 'tr-n1',
...
export var janeAddamsLens = {
  ...
  icon: '🏠',
  description: {
    cn: '伊利诺伊人，1860 年生，富商的女儿，从小读书，却找不到一个女人能做的「正经事」。29 岁那年，她在芝加哥最穷的移民区租下一栋旧楼，搬进去和移民做邻居，办起一个叫 Hull House 的地方。她不发救济、不传教，只做一件事：站在工厂主和移民、美国人和外国人、改革者和穷人中间，把谁也不肯听谁的两边，拉到同一张桌子上。1931 年她拿了诺贝尔和平奖。这一遍让你从一个调停者的位置，看进步时代那些漂亮的改革，落到一个移民家庭头上时是什么样子。',
    en: 'An Illinois woman, born 1860, a wealthy merchant\'s daughter, well read from childhood, who could find no "proper work" a woman was allowed to do. At 29 she rented an old building in the poorest immigrant district of Chicago, moved in to live as a neighbor among the immigrants, and opened a place called Hull House. She did not hand out charity or preach. She did one thing: she stood between the factory owners and the immigrants, the Americans and the foreigners, the reformers and the poor, and pulled the sides who would not listen to one another to the same table. In 1931 she won the Nobel Peace Prize. This pass puts you in a mediator\'s seat, watching what the Progressive Era\'s fine reforms looked like when they landed on one immigrant family.',
  },
  storyboard: [
    {
      id: 'ja-n1',
...
export var triangleFireWorkerLens = {
  ...
  icon: '🔥',
  description: {
    cn: '一个合成的角色，代表 1911 年 Triangle 制衣厂大火中死去的 146 个人 (姓名/年龄是叙事性补充，确证的是这场火和 146 个死者)。她十几岁，几年前跟家人从欧洲坐船来到纽约，住在挤满移民的下东区，每天在制衣厂踩缝纫机踩到天黑。她和工友为更安全的工厂罢过工，可老板照样把通往楼梯的门从外面锁死。这一遍，你站在进步时代那些漂亮改革够不着的人这边——站在那扇锁着的门后面，往外看。',
    en: 'A composite character standing for the 146 people who died in the Triangle garment factory fire of 1911 (the name and age are a narrative addition; what is confirmed is the fire and its 146 dead). She is in her teens, came by ship from Europe to New York with her family a few years before, lives in the immigrant-packed Lower East Side, and treads a sewing machine in a garment factory until dark each day. She and her workmates went on strike for a safer factory, yet the owners still locked the door to the stairwell from the outside. This pass puts you on the side of the people the Progressive Era\'s fine reforms could not reach, behind that locked door, looking out.',
  },
  storyboard: [
    {
      id: 'tw-n1',
