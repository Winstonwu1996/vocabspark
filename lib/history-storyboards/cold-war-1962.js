...
export var arkhipovLens = {
  ...
  icon: '⚓',
  description: {
    cn: '他是苏联潜艇里一个三十六岁的副长，空调坏了，氧气快没了，头顶上正传来美军的爆炸声。这一遍让你跟他挤在那个又黑又热的铁罐子里，看一个人怎么对着艇长和所有战友，说出一个字：不。',
    en: 'He is a 36-year-old second-in-command aboard a Soviet submarine, the air conditioning dead, oxygen thinning, American charges booming overhead. This pass squeezes you in beside him in that hot iron can, watching one man say a single word to his captain: no.',
  },
  storyboard: [
    {
      id: 'ark-n1',
