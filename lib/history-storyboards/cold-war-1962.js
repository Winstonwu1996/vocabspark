...
//   - vasili-arkhipov               (lonely-mediator)   — Vasili Arkhipov 1926-1998 苏联潜艇分队参谋长（brigade chief of staff）随舰乘 B-59，1962 拒绝发射核鱼雷
...
export var jfkLens = {
  ...
  icon: '🎖️',
  description: {
    cn: '他是当时最年轻的美国总统，才四十五岁，前一年刚批了一场惨败的入侵。这一遍让你坐进他白宫地下那把椅子，在「示弱」和「毁灭世界」之间，找一条窄得不能再窄的路。',
    en: 'He is the youngest American president of his time, only forty-five, who a year earlier signed off on a botched invasion. This pass puts you in his chair beneath the White House, finding a path between looking weak and destroying the world.',
  },
  storyboard: [
    {
      id: 'jfk-n1',
...
export var arkhipovLens = {
  ...
  icon: '⚓',
  description: {
    cn: '他是苏联潜艇分队参谋长，三十六岁，随舰乘坐 B-59，空调坏了，氧气快没了，头顶上正传来美军的爆炸声。这一遍让你跟他挤在那个又黑又热的铁罐子里，看一个人怎么对着艇长和所有战友，说出一个字：不。',
    en: 'He is the 36-year-old chief of staff of a Soviet submarine brigade, riding aboard B-59, the air conditioning dead, oxygen thinning, American charges booming overhead. This pass squeezes you in beside him in that hot iron can, watching one man say a single word to his captain: no.',
  },
  storyboard: [
    {
      id: 'ark-n1',
...
export var proxyWarPeasantLens = {
  ...
  icon: '🌾',
  description: {
    cn: '他是一个不识字的农民，只想要一小块自己的地，让一家人不挨饿（一个合成人物，把许多真实农民的遭遇合到一起）。这一遍让你跟他站在烧黑的玉米地上，看两个遥远大国的争斗，怎么一夜之间毁掉一个根本听不懂它的人。',
    en: 'He is an illiterate peasant who only wanted a small patch of land, enough to keep his family from hunger (a composite figure pieced together from many real peasants\' stories). This pass stands you in his blackened maize field, watching two distant powers\' struggle ruin, in one night, a man who cannot even name it.',
  },
  storyboard: [
    {
      id: 'pwp-n1',
...
export var meta = {
  ...
  notes: [
    ...
    '日期/数学校验: JFK 1917-1963 (1962 年 45 岁✓ / 遇刺 46 岁✓); Arkhipov 1926-1998 (1962 年 36 岁✓ / 死 72 岁✓); 头衔: 分队参谋长 brigade chief of staff (非副艇长); 古巴危机 1962.10.16-28; 冷战 1947-1991; 广岛长崎 1945',
