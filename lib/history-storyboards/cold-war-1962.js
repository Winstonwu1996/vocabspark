...
export var proxyWarPeasantLens = {
  ...
  icon: '🌾',
  description: {
    cn: '这是一个合成的人物，把许多真实第三世界农民的经历合到一起——危地马拉高地的玉米地，越南红河边的稻田，都有过一样的故事。他不识字，没听过「冷战」「相互确保毁灭」这些词，一辈子没出过自己的省。他只知道地里的庄稼、天上的雨、家里几张要吃饭的嘴。可有一天，飞机来了，士兵来了，村子烧了，亲人没了——为了一场他根本不认识的、两个遥远大国的争斗。这一遍让你站在两极格局最底下、被碾过去的那个人身边，看「冷战」在他眼里，到底是什么样子。',
  ...
  storyboard: [
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '我想让你知道，我不是头一个，也不是最后一个，被远方大国的算计碾过去的普通人。\n\n往前看几十年。第一次世界大战的时候，法国从它的非洲殖民地，征召了成千上万的西非人，送到欧洲的战壕里，替宗主国去死——那些人,大多也不懂这仗为了什么。（你跑过一战那个 Topic，会见到一个塞内加尔士兵。）\n\n再往前，比利时国王把整个刚果当成自己的私产，逼着当地人采橡胶，完不成配额就砍手——又是为了远方人的财富和野心。（你跑过瓜分非洲那个 Topic，会见到刚果的村民。）\n\n你看出那条线了吗？从殖民时代,到两次大战,到我所在的冷战——换了名字、换了旗号、换了「主义」，可有一件事一直没变:总有一些遥远的、强大的人,在地图上画线、做决定;而总有一些像我这样的人,在地上,用血替他们的决定买单。\n\n旗号年年在变。站在最底下挨打的，永远是同一种人。',
