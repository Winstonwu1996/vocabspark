  ...
  storyboard: [
    {
      ...
      phase: 'hook',
      content: {
        cn: '人们叫我「不可腐蚀者」。\n\n我不喝酒，不收一分贿赂，不要情人。在一个人人都能被钱、被女人、被权位收买的年代，连我的敌人都承认：在我身上找不到一个污点。\n\n我是 Robespierre（罗伯斯庇尔），一个外省来的律师。1789 年革命刚起来时，我站在议会里，主张废除死刑——我说，国家用杀人来证明杀人有罪，是矛盾的。\n\n请你记住我此刻说的这句话。\n\n因为四年后，1793 年，是我，把成千上万的人，一批一批送上了断头台。\n\n这一遍，你坐进我这个位置。你会看见一个真心相信「自由」「美德」的人，怎么一步步说服自己：为了那个最纯洁的共和国，杀人，是必须的。',
        en: 'People called me "the Incorruptible."\n\nI did not drink, took not a single bribe, kept no mistress. In an age when everyone could be bought with money, with women, with office, even my enemies admitted there was not one stain to be found on me.\n\nI am Robespierre, a lawyer from the provinces. When the Revolution rose in 1789, I stood in the assembly and argued to abolish the death penalty. I said: for the state to use killing to prove that killing is a crime is a contradiction.\n\nPlease remember the words I am saying now.\n\nBecause four years later, in 1793, it was I who sent thousands of people, batch by batch, to the guillotine.\n\nThis pass puts you in my seat. You will watch a man who sincerely believed in "liberty" and "virtue" talk himself, step by step, into this: that for the sake of the purest republic, killing was necessary.',
      },
      deliverGoal: 'N1 hook — 不可腐蚀者 (不喝酒/不收贿/不要情人/敌人也承认无污点) + Robespierre 自我介绍 (外省律师) + 1789 主张废死刑 + 反差伏笔 (4 年后送成千上万人上断头台) + 这一遍视角 (理想主义者怎么说服自己杀人是必须)',
      engagementHook: '一个 1789 年主张废除死刑的人，四年后把成千上万人送上断头台。同一个人怎么会变成这样？你信「好人也会做出可怕的事」吗？',
