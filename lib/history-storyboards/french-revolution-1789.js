...
export var robespierreLens = {
  ...
  icon: '⚖️',
  description: {
    cn: '他是一个外省来的瘦削律师，三年前还在议会里主张废除死刑，没人能在他身上找到一个污点。这一遍让你钻进他心里，看「为了一个最纯洁的共和国，杀人是必须的」这句话，怎么一步步变成他能签下名字的命令。',
    en: 'He is a thin provincial lawyer who three years ago argued to abolish the death penalty, a man not even his enemies could stain. This pass climbs inside him as "for the purest republic, killing is necessary" turns, step by step, into an order he signs his name to.',
  },
  storyboard: [
    {
      id: 'rob-n1',
...
export var lafayetteLens = {
  ...
  icon: '🗽',
  description: {
    cn: '他是一个十九岁就自费横渡大洋的法国贵族，在美国打完仗回来，又成了法国革命的明星，手里握着一支自卫军。这一遍让你跟他一起站在两派之间，看一个想「两全」的人，怎么被一场不要中间路线的革命，两边同时抛弃。',
    en: 'He is a French nobleman who at nineteen crossed the ocean to fight the American war, then came home a star of the French Revolution. This pass stands you with him between two factions, watching a man who wanted "both" cast off by both sides at once.',
  },
  storyboard: [
    {
      id: 'laf-n1',
...
export var parisWasherwomanLens = {
  ...
  icon: '🍞',
  description: {
    cn: '她是一个手在冷水里泡到开裂的洗衣女工，靠几个铜板把全家撑起来（一个合成人物，把巴黎几万没留下名字的女工合成一个人，让你能透过她看一整代）。这一遍让你站在她身边，看她清早天没亮就去排面包队，看一场被写成「自由平等」的革命，对她意味着什么。',
    en: 'She is a washerwoman whose hands crack from cold river water, holding a family up on a few copper coins (a composite, standing in for the tens of thousands of unnamed Paris working women, so that through her you see one whole generation). This pass stands you beside her in the bread line before dawn, watching what a revolution written down as "liberty and equality" actually means to her.',
  },
  storyboard: [
    {
      id: 'pw-n1',
