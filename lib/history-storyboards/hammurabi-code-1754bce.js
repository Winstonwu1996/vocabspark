...
//   「同样的伤害，不同的人,赔的钱天差地别」— 同一部法典里,打掉一个 awilum (贵族) 的牙,赔一个 mina 银子;
//   打掉一个 mushkenum (平民) 的牙,只赔三分之一 mina。同一颗牙,值多少,看你是谁。
//   - Hammurabi lens N6: 三等差等是设计,不是疏漏 — 「同罪不同罚」就是这部法典的核心
//   - scribe lens N6: 书吏的笔 — 把「人不平等」一字一字刻进湿泥,刻进永恒
//   - commoner woman lens N6: 受害者这边 — 我的牙和贵族的牙,在法典里值不一样的钱
//
// cross-Topic 锚:
...
//
// defaultLens = 'babylonian-commoner-woman-receiving-end' (受影响者优先 pattern: 平民女性 + 法律差等对待一方 + N6 跨 lens「同一颗牙不同价」对位)
//
...
export var hammurabiLens = {
  ...
  icon: '👑',
  description: {
    cn: '巴比伦的国王，公元前 1792 年到前 1750 年在位。他用了几十年，把两河流域许多小城邦打成一个统一的王国。公元前 1754 年前后，他下令把 282 条法律刻在一根两米多高的黑色石柱上，立在城里给所有人看。石柱顶上刻着他站在太阳神面前接过权杖的样子，意思是：这些法律，是神授权给我立的。同一部法典里，打掉一个贵族的牙和打掉一个平民的牙，赔的钱差好几倍。这一遍让你从立法者内部，看一部最早的成文法，怎么把「人不平等」一条一条写成了规矩。',
  ...
  storyboard: [
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '现在你就是我。\n\n你要给整个王国定一套规矩。可你面对的不是一群一样的人。你的子民，被分成三等。\n\n最上一等叫 awilum（阿维鲁），是有地位的自由人，贵族。中间一等叫 mushkenum（穆什凯努），是地位低一截的平民。最下一等叫 wardum（瓦尔杜），是奴隶，在法律眼里更接近财产。\n\n现在你提笔写第一条伤害赔偿：有人打掉别人一颗牙，该怎么赔？\n\n你可以写「打掉一颗牙，赔多少，不分对方是谁」。这样最简单，也最平等。\n\n但你没有。你写的是：打掉一个 awilum 的牙，赔一 mina 银子；打掉一个 mushkenum 的牙，只赔三分之一 mina。同一颗牙，看长在谁嘴里，值不一样的钱。\n\n你为什么这么写？因为在你眼里，这不是不公平，这就是世界本来的样子。贵族和平民，本来就不该一个价。\n\n你写下的，不是「人人平等」。你写下的，是「不平等」本身，而且把它变成了法律。',
        en: 'Now you are me.\n\nYou must set one body of rules for the whole kingdom. But the people before you are not all alike. Your subjects are split into three ranks.\n\nThe top rank is the awilum, free people of standing, the nobles. The middle rank is the mushkenum, commoners attached to the palace or temple, a notch lower. The bottom rank is the wardum, the enslaved, who in the eyes of the law are closer to property than to whole people.\n\nNow you take up the reed to write the first law on injury: someone knocks out another person\'s tooth; how shall it be paid for?\n\nYou could write "knock out a tooth, pay this much, no matter who the other person is." That is the simplest, and the most equal.\n\nBut you did not. You wrote: knock out an awilum\'s tooth, pay one mina of silver; knock out a mushkenum\'s tooth, pay only one-third of a mina. The same tooth is worth a different amount depending on whose mouth it sits in.\n\nWhy write it that way? Because in your eyes this is not unfairness, it is simply the way the world is. Nobles and commoners were never meant to be priced the same.\n\nWhat you wrote down is not "all people are equal." What you wrote down is inequality itself, and you turned it into law.',
      },
      deliverGoal: 'N4 personal「你就是 TA」peak — 三等人 (awilum 贵族/mushkenum 平民/wardum 奴隶近财产) + 提笔写打牙赔偿 + 可写平等但写成差等 (awilum 牙赔 1 mina / mushkenum 三分之一 mina) + 在王眼里差等是世界本来样子 + 你写下的是不平等本身变成法律',
      engagementHook: '同一颗牙,长在贵族嘴里值一 mina,长在平民嘴里只值三分之一。我觉得这天经地义。如果你是立法的王,你会把「不平等」也写成法律,还是写一条人人一样的规矩?',
      expectsRealAnswer: false,
    },
    {
      id: 'ham-n5',
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '让我把这件事掰到最清楚的一刻给你看。\n\n想象同一天，我的城里，两个人各被打掉一颗牙。\n\n第一个是 awilum，一个有地位的自由人。按我的法典，打他的人要赔一 mina 银子。一 mina 不是小数目——够买不少粮食，够一户人家撑很久。\n\n第二个是 mushkenum，一个普通平民。一样是一颗牙，一样的疼，一样的血。可打他的人，只要赔三分之一 mina。\n\n同一颗牙。同样的伤害。差三倍的价。\n\n这不是哪个糊涂书吏抄错了。这是我亲自定的。在我的法典里，一个人值多少，先看他是哪一等人。\n\n我要你记住的，正是这个：成文法不等于平等的法。我把规矩写下来、刻进永远不烂的石头里，我让它公开、可查、对所有人一致——可这套「对所有人一致」的规矩，内容本身，就是把人分成三六九等。\n\n白纸黑字，反而把不平等钉死了：从此它不再是某个官吏一时的偏心，而是神授的、永恒的、写进石头的「正义」。',
        en: 'Let me show you the moment that makes this clearest.\n\nImagine that on the same day, in my city, two men each have a tooth knocked out.\n\nThe first is an awilum, a free man of standing. By my code, the one who struck him must pay one mina of silver. One mina is no small sum, enough to buy plenty of grain, enough to keep a household going a long while.\n\nThe second is a mushkenum, an ordinary commoner. The same one tooth, the same pain, the same blood. Yet the one who struck him need pay only one-third of a mina.\n\nThe same tooth. The same injury. A threefold difference in price.\n\nThis was not some careless scribe copying it wrong. I set it myself. In my code, what a person is worth depends first on which rank he belongs to.\n\nWhat I want you to remember is exactly this: written law is not the same as equal law. I wrote the rules down, carved them into stone that would never rot, made them public, checkable, the same for all to read, and yet the content of these "same for all" rules was itself the sorting of people into ranks.\n\nIn black and white, inequality was nailed down all the harder: no longer one official\'s passing favoritism, but a god-given, eternal "justice" written into stone.',
      },
      deliverGoal: 'N6 ANCHOR cross-lens — 同一天两人各打掉一颗牙: awilum 赔 1 mina vs mushkenum 三分之一 mina (同牙/同伤/差三倍价) + 不是抄错是 Hammurabi 亲定 + 核心命题: 成文法 ≠ 平等的法 (公开可查一致但内容把人分三等) + 白纸黑字反把不平等钉死成神授永恒的正义',
      engagementHook: '同一颗牙,贵族的值一 mina,平民的只值三分之一——这不是抄错,是我亲定的。一旦把「不平等」刻进永不烂的石头、说成神授,它是不是比口头偏心更难翻案?',
      expectsRealAnswer: false,
    },
    {
      id: 'ham-n7',
...
export var babylonianScribeLens = {
  ...
  storyboard: [
    ...
    },
    {
      ...
      phase: 'setup',
      content: {
        cn: '现在，国王交给我们书吏一桩大活：把他那 282 条法律，刻成全城都看得见的样子。\n\n这不是随便记个账。这是要立在城里、传给后世的东西。先在泥板上拟稿、核对、改；定稿了，再由最好的工匠把字凿到那根两米多高的黑石柱上。石头不像泥，刻错一笔，改不了。\n\n刻的时候，我一条一条往下走。前面几条还好。刻到伤害赔偿那几条，我手上慢了下来。\n\n法律写得清清楚楚：打掉一个 awilum（贵族）的牙，赔一 mina 银子；打掉一个 mushkenum（平民）的牙，赔三分之一 mina。\n\n我读得懂这些字。我比城里几乎所有人都更早、更清楚地知道：这部法律，把同一颗牙，标了不同的价。\n\n而我的活，就是把这个「不同的价」，一笔一笔，刻进永远擦不掉的石头。',
        en: 'Now the king hands us scribes a great task: to carve his 282 laws into a form the whole city can see.\n\nThis was not just keeping some account. This was something to stand in the city and be passed to later ages. First we drafted on clay tablets, checked, corrected; once the text was final, the best craftsmen would chisel the signs onto that black pillar more than two meters tall. Stone is not like clay, a wrong stroke cannot be undone.\n\nAs I carved, I went down them one by one. The first few were fine. Coming to the laws on injury, my hand slowed.\n\nThe law is written plainly: knock out an awilum\'s tooth, pay one mina of silver; knock out a mushkenum\'s tooth, pay one-third of a mina.\n\nI can read these signs. Earlier and more clearly than almost anyone in the city, I know this: this law has marked the same tooth at different prices.\n\nAnd my work is to carve that "different price," stroke by stroke, into stone that can never be wiped away.',
      },
      deliverGoal: 'N3 setup — 国王交活把 282 条刻成全城可见 (泥板拟稿核对改/工匠凿黑石柱/石头刻错改不了) + 刻到伤害赔偿手慢下来 (awilum 牙 1 mina / mushkenum 三分之一) + 书吏比谁都更早读懂同牙不同价 + 他的活是把不平等刻进擦不掉的石头',
      engagementHook: '我读得懂这些字,比城里几乎所有人都更早知道:这部法律把同一颗牙标了不同的价。读懂了,可活还得照刻——你会是什么心情?',
      expectsRealAnswer: false,
    },
    {
      id: 'sc-n4',
...
export var babylonianCommonerWomanLens = {
  ...
  storyboard: [
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '现在你就是我。\n\n这一天，在巷子里，你跟一个人起了争执。对方动了手，一拳打掉了你一颗牙。\n\n血在嘴里。疼得钻心。\n\n你去讨说法。城里有法律，你想：好，有法律，我能讨回公道。\n\n可你接下来听到的话，会让你这辈子忘不掉。\n\n断案的人翻出法典上的条款：打掉一个 mushkenum（平民）的牙，赔三分之一 mina 银子。\n\n你愣住了。三分之一 mina？\n\n旁边有人小声告诉你：同样这一拳，要是打掉的是一个 awilum（贵族）的牙，得赔整整一 mina——是你的三倍。\n\n同一颗牙。同样的疼，同样的血。可因为你是平民，你的牙，只值人家的三分之一。\n\n你站在那儿，嘴里还在淌血。你心里那个问题，憋了很久，这一刻冒出来：凭什么？凭什么我的疼，比贵族的疼，便宜三分之二？',
        en: 'Now you are me.\n\nOne day, in an alley, you fall into a quarrel with someone. The other strikes you, and one blow knocks out a tooth.\n\nBlood in your mouth. Pain to the bone.\n\nYou go to claim justice. There is law in the city, you think: good, there is law, I can win what is fair.\n\nBut what you hear next, you will never forget your whole life.\n\nThe one who judges turns up the clause in the code: knock out a mushkenum\'s tooth, pay one-third of a mina of silver.\n\nYou freeze. One-third of a mina?\n\nSomeone beside you says quietly: the same blow, if it had knocked out an awilum\'s tooth, would cost a full mina, three times yours.\n\nThe same tooth. The same pain, the same blood. But because you are a commoner, your tooth is worth only one-third of theirs.\n\nYou stand there, blood still running in your mouth. The question held back so long rises up in this moment: by what right? By what right is my pain two-thirds cheaper than a noble\'s pain?',
      },
      deliverGoal: 'N4 personal「你就是 TA」peak — 巷子里争执被打掉一颗牙 (血/疼) + 去讨说法以为有法律能讨公道 + 断案翻条款 mushkenum 牙赔三分之一 mina + 旁人告诉她 awilum 牙赔一 mina (三倍) + 同牙同疼同血但平民只值三分之一 + 憋很久的问题冒出来「凭什么我的疼比贵族便宜三分之二」',
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '让我把这件事，掰到最清楚的一刻给你看。\n\n那天，城里还有另一个人，也被打掉了一颗牙。他是 awilum，一个贵族。\n\n我们俩，同一座城，同一种伤，同一颗牙。我嘴里淌的血，和他嘴里淌的血，是一样红的；我的疼，和他的疼，是一样钻心的。\n\n可法典翻开，白纸黑字：他的牙，赔一整个 mina；我的牙，赔三分之一 mina。\n\n同一颗牙，差三倍的价。差的那两份，不是因为他更疼、不是因为他流的血更多。差的那两份，只因为——他是贵族，我是平民。\n\n你现在懂我为什么说那部石柱上的「正义」让我心寒了吧？\n\n它不是没给我「正义」。它给了——只不过，它先把我和那个贵族，标上了不一样的价签，再按价签给我们各自的「正义」。\n\n在那块石头上，我从来不是「一个人」。我是「三分之一」。',
        en: 'Let me show you the moment that makes this clearest.\n\nThat day, another person in the city also had a tooth knocked out. He was an awilum, a noble.\n\nThe two of us, the same city, the same injury, the same one tooth. The blood running in my mouth and the blood running in his were the same red; my pain and his pain were the same, cutting to the bone.\n\nBut open the code, in black and white: his tooth, pay a whole mina; my tooth, pay one-third of a mina.\n\nThe same tooth, a threefold difference in price. The missing two shares were not because he hurt more, not because he bled more. The missing two shares were only because he was a noble and I was a commoner.\n\nNow you understand why I said the "justice" on that pillar chilled my heart?\n\nIt was not that it gave me no "justice." It gave it, only it first marked the noble and me with different price tags, then handed each of us our own "justice" according to the tag.\n\nOn that stone, I was never "a person." I was "one-third."',
      },
      deliverGoal: 'N6 ANCHOR cross-lens — 同一天另一人 awilum 也被打掉一颗牙 + 同城同伤同牙/血一样红疼一样钻心 + 法典白纸黑字: 他牙一 mina/我牙三分之一 + 差两份不因他更疼流更多血只因他贵族我平民 + 石柱「正义」让她心寒 (不是没给正义,是先标不同价签再按价签给各自正义) + 「在那块石头上我从来不是一个人,我是三分之一」',
      engagementHook: '同一天,我和一个贵族都被打掉一颗牙——血一样红,疼一样钻心。可法典里,他的牙赔一整个 mina,我的只赔三分之一。在那块石头上,我从来不是「一个人」,我是「三分之一」。一部把你标成「三分之一」的法律,还配叫「正义」吗?',
      expectsRealAnswer: false,
    },
    {
      id: 'cw-n7',
...
// 平民女性 + 法律差等对待一方 + N6「同一颗牙不同价」跨 lens 对位 + N8/N9 进步 vs 钉死不平等 closing
...
export var meta = {
  ...
  notes: [
    '3 lens / 9 nodes each / cross-lens micro-detail N6: 同一颗牙不同价 (awilum 牙 1 mina vs mushkenum 牙 1/3 mina) — Hammurabi 三等差等是设计 / scribe 把不平等刻进永恒 / commoner woman 我从不是一个人是三分之一',
    ...
    'defaultLens: babylonian-commoner-woman-receiving-end — 受影响者优先 (平民女性 + 法律差等对待一方 + N6 同牙不同价 + N8/N9 进步 vs 钉死不平等)',
