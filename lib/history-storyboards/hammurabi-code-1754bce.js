...
export var hammurabiLens = {
  ...
  icon: '👑',
  description: {
    cn: '他是一个刚把两河许多互打的小城邦捏成一个王国的王,正在巴比伦城里立起一根两米多高的黑石柱,顶上刻着他从太阳神 Shamash 手里接过权杖。这一遍让你坐进他提笔写第一条赔偿律的位置,他面前的子民分成贵族、平民、奴隶三等,他可以写一条「打掉一颗牙怎么处置不分对方是谁」,看他是写得平等还是写下不平等本身。',
    en: 'He is the king who has just forged the bickering small city-states of Mesopotamia into one kingdom, raising in Babylon a black stone pillar more than two meters tall, the top of it carved with him receiving the rod of authority from the sun god Shamash. This pass puts you in his seat as he takes up the reed to write the first injury law: his subjects are split into noble, commoner, and enslaved, and he could write "knock out a tooth, handle it this way, no matter who," and you watch whether he writes equality or writes inequality itself.',
  },
  storyboard: [
    {
      id: 'ham-n1',
...
export var babylonianScribeLens = {
  ...
  icon: '🪶',
  description: {
    cn: '他是一个万人里只有几个识字的城里的书吏,指尖磨出薄薄一层握尖头压泥板压出来的茧(一个合成人物,把那个时代真有却没留下名字的一群识字人拼到一起)。这一遍让你站在他手里举着尖头、面前是国王那 282 条法律要刻进黑石柱的位置,他刻到「同一颗牙贵族要拿牙抵平民只赔三分之一 mina」那条手慢下来,看一个比谁都更早读懂这条不平等的人,要不要继续把这一笔刻进永远擦不掉的石头。',
    en: 'He is a scribe in a city where only a handful out of ten thousand can read, a thin callus on his fingertips from gripping the reed pressed into clay (a composite figure, joining together a class of literate people who really existed in that age but left no names). This pass puts you with him as he holds the reed before the king\'s 282 laws on their way into the black pillar; his hand slows when he reaches the clause where the same tooth costs a noble his own tooth and a commoner only one-third of a mina, and you watch a man who has read this inequality earlier than anyone else decide whether to carve the next stroke into stone that can never be wiped away.',
  },
  storyboard: [
    {
      id: 'sc-n1',
...
export var babylonianCommonerWomanLens = {
  ...
  icon: '🏺',
  description: {
    cn: '她是每天从城中心那根写满「正义」的黑石柱旁走过、一个字都看不懂的巴比伦平民女人,既是 mushkenum 这一中间等级,又比男人矮一头(合成人物,按法典里平民和女人的条款拼出,真有这类人但没留下名字)。这一遍让你站在她巷子里被人一拳打掉一颗牙、嘴里淌着血去讨说法的位置,听断案人翻出「平民牙赔三分之一 mina」一条,看她憋了很久的问题终于冒出来:凭什么我的疼比贵族的疼便宜三分之二?',
    en: 'She is a commoner woman of Babylon who walks every day past the black pillar covered in "justice" she cannot read a single sign of, both a mushkenum of the middle rank and a head shorter than a man (a composite figure, pieced together from the code\'s clauses on commoners and women; people like her really are in the code, no particular name left). This pass puts you with her in an alley where a single blow has knocked out a tooth, blood in her mouth as she goes to claim what is fair, hearing the judge turn up the clause "for a commoner\'s tooth, one-third of a mina," watching a question she has held back so long finally rise: by what right is my pain worth two-thirds less than a noble\'s?',
  },
  storyboard: [
    {
      id: 'cw-n1',
