...
export var babylonianCommonerWomanLens = {
  ...
  icon: '🏺',
  description: {
    cn: '她是一个每天从城中心那根写满「正义」的黑石柱旁走过、一个字都看不懂的巴比伦平民女人,既是 mushkenum 这一中间等级,又比男人矮一头(一个合成人物,按汉谟拉比法典里关于平民和女人的条款拼出来,真有这一类人但没留下具体名字)。这一遍让你站在她在巷子里被人一拳打掉一颗牙、嘴里淌着血去讨说法的位置,听断案人翻出那条「平民牙赔三分之一 mina」,看她憋了很久的那个问题终于冒出来:凭什么我的疼比贵族的疼便宜三分之二?',
    en: 'She is a commoner woman of Babylon who walks every day past the black pillar in the city center covered in "justice" she cannot read a single sign of, both a mushkenum of the middle rank and a head shorter than a man (a composite figure, pieced together from the code\'s clauses on commoners and women; people like her really are in the code, but no particular name was left). This pass puts you with her in an alley where a single blow has knocked out a tooth, blood in her mouth as she goes to claim what is fair, hearing the judge turn up the clause "for a commoner\'s tooth, one-third of a mina," watching a question she has held back so long finally rise: by what right is my pain worth two-thirds less than a noble\'s?',
  },
  storyboard: [
    {
      id: 'cw-n1',
