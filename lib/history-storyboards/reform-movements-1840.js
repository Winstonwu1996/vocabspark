...
export var stantonLens = {
  ...
  icon: '✊',
  description: {
    cn: '纽约人，1815 年生在一个法官家里，从小在父亲律所翻法律书，发现这套法律对女人多不公平。1840 年她去伦敦参加废奴大会却被拦在场外，因为她是女人。8 年后她在 Seneca Falls 把美国《独立宣言》改写了一句话，掀起美国女权运动第一炮。但她心里那个「人人平等」的「人人」，主要装的是像她一样的白人有产女性。这一遍让你从一个改革发动机内部，看一场运动怎么既推开一扇门，又关上另一扇。',
    en: 'A New Yorker, born 1815 into a judge’s household, who grew up paging through law books in her father’s office and discovered how unjust those laws were to women. In 1840 she traveled to London for an anti-slavery convention and was shut out of the floor, because she was a woman. Eight years later in Seneca Falls she rewrote one line of the Declaration of Independence and fired the opening shot of the American women’s rights movement. But her “all are equal” mostly meant white propertied women like herself. This pass lets you watch, from inside a reform engine, how a movement can push open one door while closing another.',
  },
  storyboard: [
    {
      id: 'st-n1',
...
export var douglassLens = {
  ...
  icon: '📰',
  description: {
    cn: '约 1818 年生在马里兰一个奴隶种植园，他连自己生日都不知道。20 岁逃到北方，靠一张嘴成了全美最有名的废奴演说家，又办起自己的报纸 North Star。1848 年那场只关乎女人的 Seneca Falls 大会上，他是唯一站出来替女性投票权公开背书的黑人男性。这一遍让你从一个「架桥的人」内部，看一个既被排除、又懂得替别人撑腰的人，怎么在几股力量中间走钢丝。',
    en: 'Born around 1818 on a Maryland slave plantation, he did not even know his own birthday. He escaped north at twenty and, on the strength of his voice, became America’s most famous anti-slavery orator, then founded his own newspaper, the North Star. At the 1848 Seneca Falls convention, supposedly only about women, he was the one Black man who rose to publicly back women’s suffrage. This pass lets you watch, from inside a bridge-builder, how a man both excluded and willing to stand up for others walks a tightrope among several forces.',
  },
  storyboard: [
    {
      id: 'dg-n1',
...
export var enslavedWomanLens = {
  ...
  icon: '🌾',
  description: {
    cn: '这一遍没有一个留在历史里的名字。她是 1840 年代美国南方千千万万被奴役的黑人女性中的一个（合成的声音，代表那些被两场运动反复谈论却没人请上桌的人）。她在棉田、在主人厨房里劳作，既是被买卖的财产，又被主人随意处置身体。北方那场「改革年代」，一场运动「关于」她（废奴），一场「关于」女人（女权），两张桌子都没给她留位子。这一遍你站在她这边，看这个「完善人类」年代：改革到底是为谁的改革？',
    en: 'This pass carries no name left in the record. She is one of the countless enslaved Black women of the 1840s American South (a composite voice, standing for those whom every reform discussed and no one invited to the table), laboring in the cotton fields and the master’s kitchen, both bought-and-sold property and a body the master used as he pleased. The Northern “reform age” had one movement supposedly “about” her (abolition) and another “about” women (women’s rights), yet neither table kept a seat for her. This pass puts you with her, looking anew at the age praised for “perfecting humanity”: reform, for whom, exactly?',
  },
  storyboard: [
    {
      id: 'ew-n1',
