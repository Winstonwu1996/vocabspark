...
export var douglassLens = {
  ...
  icon: '📰',
  description: {
    cn: '约 1818 年生在马里兰一个奴隶种植园，他连自己生日都不知道。20 岁那年逃到北方，靠一张嘴成了全美最有名的废奴演说家，又办起自己的报纸 North Star。1848 年那场只关乎女人的 Seneca Falls 大会上，他是唯一站出来替女性投票权公开背书的黑人男性。他一辈子站在好几道夹缝里，黑人和白人之间，废奴和女权之间。这一遍让你从一个「架桥的人」内部，看一个既被排除、又懂得替别人撑腰的人，怎么在几股力量中间走钢丝。',
...
export var enslavedWomanLens = {
  ...
  icon: '🌾',
  description: {
    cn: '这一遍没有一个留在历史里的名字。她是 1840 年代美国南方千千万万被奴役的黑人女性中的一个（合成的声音，代表那些被两场运动反复谈论却没人请上桌的人）。她在棉田里、在主人厨房里劳作，既是被买卖的财产，又被主人随意处置身体。北方那场轰轰烈烈的「改革年代」，一场运动专门「关于」她（废奴），一场专门「关于」女人（女权），可两张桌子都没给她留位子。这一遍你站在她这边，重新看这个被称颂的「完善人类」年代：改革到底是为谁的改革？',
