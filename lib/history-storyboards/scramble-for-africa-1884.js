...
export var williamsLens = {
  ...
  description: {
    ...
    en: 'He is the man who crossed the Atlantic to the Congo in 1890. Before he set out he had believed Leopold\'s tale of a "civilized Congo," because he was Black, author of A History of the Negro Race in America, and knew that a people for whom no one writes a history gets treated as if it had never been civilized. But he went, saw with his own eyes, and his faith broke. This pass puts you with him on the Congo river: no army, no fortune, only his eyes and his pen, and he must decide whether one man, with a single pen, can and dares to aim it at a king.',
  },
  storyboard: [
    {
      id: 'gw-n1',
...
export var villagerLens = {
  ...
  description: {
    ...
    en: 'He is a man of a village by the Congo river (a composite figure, condensing tens of thousands of real people into one voice you can hear). Born here around 1870, with its forest, its river, everyone he has known since childhood. Then one day men from far away say this land belongs to a king he has never seen, and on the ledger he is no longer a person with a name, he is a rubber quota. This pass walks with him into the forest: the nearby vines are tapped thinner and thinner, he must go deeper, the cassava fields run to weed, no one fishes any more, all his strength drained away by that quota.',
  },
  storyboard: [
    {
      id: 'vil-n1',
