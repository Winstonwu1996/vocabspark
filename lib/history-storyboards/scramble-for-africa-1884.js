...
export var williamsLens = {
  ...
  icon: '✒️',
  description: {
    cn: '他是 1890 年那个横渡大西洋去刚果的人。出发之前他本来是相信利奥波德那套「文明刚果」说法的,,他是黑人，写过《美国黑人种族史》，太清楚一个种族没人替它写下历史就会被当成「从来没文明过」，所以他对祖先大陆的事，心里有一种特别的牵挂。可他亲自去了，亲眼看了，信仰碎了。这一遍让你跟他一起站在刚果河上：他没有军队，没有财富，手里只有他的眼睛和他的笔,,他要决定，撞见这桩没人敢说、连他自己原本都不信会发生的暴行后，一个人能不能、敢不敢，用一支笔对准一个国王。',
...
export var villagerLens = {
  ...
  icon: '🌿',
  description: {
    cn: '他是刚果河边一个村子的人（这一遍的他是合成人物，把成千上万真实存在的人浓缩成一个能听见的声音，他经历的每件事都有真实的照片和调查记录在那儿）。他大概 1870 年生在这里，村里有森林、有河、有从小认识的每一个人。然后有一天，远方来的人说，这片土地现在归一个他从没见过、从没听过名字的国王,,在那套制度的账本上，他不是一个有名字的人，是一份橡胶配额。这一遍让你跟他一起走进森林：近处的藤蔓越割越少，他得往更深的地方走，木薯地荒了，鱼也没人捕了，所有力气被那条配额吸走，而完不成的代价，他自己也快要明白。',
