...
export var leopoldLens = {
  ...
  icon: '👑',
  description: {
    cn: '他是一个一步都没踏上过非洲的国王，可有二十多年，中部非洲一片比他自己国家大 76 倍的土地，是他一个人的私人财产。他做到这一点没靠一支大军,,他靠开会、写信、签条约，对每个人说他去那里是反对奴隶贩子、是给非洲带去文明。这一遍让你跟他一起坐进 1876 年布鲁塞尔那场地理大会，看他怎么把四百年前对付美洲那套「文明使命」的话术，原样搬来，套上一个像慈善机构的好听名字,,而全世界，鼓掌。',
    en: 'He is a king who never set foot in Africa, yet for more than twenty years a stretch of central Africa seventy-six times larger than his own country was his private property. He managed it without an army: he held conferences, wrote letters, signed treaties, and told everyone he had come to fight the slave traders and to bring civilization to Africa. This pass puts you with him at the geographical conference in Brussels in 1876, watching how he lifts the four-hundred-year-old "civilizing mission" script first used on the Americas and applies it, unchanged, under the fine name of a charity, while the whole world applauds.',
  },
  storyboard: [
    {
      id: 'leo-n1',
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '我的账本上是橡胶数字。村子里发生的事，是另一回事。\n\n配额完不成，殖民军队怎么逼？他们抓走村里的女人和孩子当人质，关起来，逼男人进森林采胶来赎。还有一种更狠的：完不成配额，就砍掉村民的手。\n\n为什么是手？因为殖民军给了士兵子弹，要他们交回证据，证明子弹没被浪费——他们就砍下被打死者的手交差。慢慢地，手本身变成了一种货币：砍一只手，抵一份没完成的配额。被砍手的，有的当场被打死，有的活了下来，里面有大人也有孩子。\n\n（这些不是传说。1904 年，一个英国传教士拍下了照片——一个父亲，盯着面前地上他被杀害的小女儿被砍下的一只小手和一只小脚。照片传遍了世界。）\n\n这就是「文明使命」的真相：我对世界讲的，是反奴隶、办文明；我的土地上真正运转的，是配额、人质，和砍下来的手。\n\n同一套「文明」的话——我在布鲁塞尔用它筹款、博取掌声；村里收到的，是少了一只手的代价。一套修辞，两个方向。',
        en: 'On my ledger were rubber numbers. What happened in the villages was another thing.\n\nWhen a quota was not met, how did the colonial soldiers force it? They seized the women and children of the village as hostages, locked them up, and made the men go into the forest to gather rubber to ransom them. And there was a crueler thing: fail the quota, and a villager\'s hand was cut off.\n\nWhy the hand? Because the soldiers were issued bullets and ordered to bring back proof that none had been wasted. So they cut off the hands of those they shot, to account for the bullets. Slowly the hand itself became a kind of currency: one severed hand for one unmet quota. Among those whose hands were taken, some were shot dead on the spot and some lived on, grown people and children alike.\n\n(These are not legends. In 1904 a British missionary photographed a father staring at the small severed hand and small severed foot of his murdered little daughter on the ground before him. The photographs traveled the world.)\n\nThis is the truth of the "civilizing mission": what I told the world was fighting slavery and bringing civilization; what actually ran on my land was quotas, hostages, and severed hands.\n\nThe same words about "civilization." In Brussels I used them to raise money and win applause; in the village what arrived was the price of one missing hand. One set of rhetoric, two directions.',
      },
      deliverGoal: 'N6 ANCHOR cross-lens — 配额逼迫机制 (抓女人孩子当人质/砍手) + 砍手原因 (子弹证据→手变货币/被砍手者有当场被打死有活下来/大人孩子都有) + anti-fab 括号短句 (1904 Alice Seeley Harris 照片/父亲盯着被杀害女儿被砍下的手和脚) + 文明使命真相 (说反奴隶办文明/真运转配额人质砍手) + 跨 lens 对位 (布鲁塞尔筹款掌声 vs 村里少一只手/一套修辞两方向)',
    ...
    },
    {
      ...
      engagementHook: '同一片非洲，几百年前有过自己强大的帝国、有过当时世界级的知识中心。那片土地从来不是「等着被文明拯救的空白」——是我们来了，才把繁荣变成砍下来的手。「带来文明」这四个字，到底是谁带给了谁什么？',
      expectsRealAnswer: false,
    },
    {
      id: 'leo-n10',
...
export var williamsLens = {
  ...
  icon: '✒️',
  description: {
    cn: '他是 1890 年那个横渡大西洋去刚果的人。出发前他相信利奥波德那套「文明刚果」说法，因为他是黑人，写过《美国黑人种族史》，太清楚一个种族没人替它写下历史就会被当成「从来没文明过」。可他亲自去了，亲眼看了，信仰碎了。这一遍让你跟他一起站在刚果河上，他没有军队，没有财富，手里只有他的眼睛和他的笔，他要决定，撞见这桩没人敢说的暴行后，一个人能不能、敢不敢，用一支笔对准一个国王。',
    en: 'He is the man who crossed the Atlantic to the Congo in 1890. Before he set out he was one of those who believed Leopold\'s story of a "civilized Congo"; he was Black, had written A History of the Negro Race in America, and knew too well that a people for whom no one writes a history is treated as if it had never been civilized at all, so he felt a particular pull toward the continent of his ancestors. But he went himself, saw with his own eyes, and his faith broke. This pass puts you with him on the Congo river: he has no army, no fortune, only his eyes and his pen, and he must decide, after stumbling on an atrocity no one dares to name and that he himself had not believed could happen, whether one man, with a single pen, can and dares to aim it at a king.',
  },
  storyboard: [
    {
      id: 'gw-n1',
...
export var villagerLens = {
  ...
  icon: '🌿',
  description: {
    cn: '他是刚果河边一个村子的人（合成人物，把成千上万真实存在的人浓缩成一个能听见的声音）。他大概 1870 年生在这里，村里有森林、有河、有从小认识的每一个人。然后有一天，远方来的人说，这片土地现在归一个他从没见过的国王，在那套制度的账本上，他不再是有名字的人，是一份橡胶配额。这一遍让你跟他一起走进森林，近处的藤蔓越割越少，他得往更深的地方走，木薯地荒了，鱼也没人捕了，所有力气被那条配额吸走。',
    en: 'He is a man of a village by the Congo river (this person of his is a composite, drawing tens of thousands of real people down into one voice you can hear, and every single thing he lives through has real photographs and investigation records behind it). He was born here around 1870, and the village has its forest, its river, every person he had known since childhood. Then one day, men from far away say that this land now belongs to a king he has never seen and whose name he has never heard, and on the ledger of that system he is not a person with a name, he is a rubber quota. This pass walks with him into the forest: the vines nearby are tapped thinner and thinner, he must go deeper and deeper in, the cassava fields run to weeds and no one fishes any more, all his strength drained away by that quota, and the price of failing to meet it, he himself is about to understand.',
  },
  storyboard: [
    {
      id: 'vil-n1',
    ...
    },
    {
      ...
      phase: 'story',
      content: {
        cn: '那一次，军队还是来了。\n\n他们点数橡胶，不够。然后他们做了那件事——我一辈子都忘不掉。\n\n我不细讲那个场面。被砍掉手的人里，有大人，也有孩子。有的人当场就被打死了；有的人没有当场死，带着只剩一只手的身体活了下来，那道伤口跟着他们一辈子。\n\n（我说的不是传言。1904 年，有个外来的人，拍下了一张照片：一个父亲，坐在自家屋前，盯着地上他被杀害的孩子被砍下来的一只小手和一只小脚。那张照片，后来被很多很多人看见。）\n\n为什么是手？我后来才听说原因，荒唐又冷血：那些士兵领了子弹，长官要他们交回证据，证明子弹没浪费——他们就砍下被打死者的手交差。慢慢地，一只手，成了一笔账：抵一份没交上的橡胶。\n\n你听明白了吗?在那套制度里，一个人的手，跟一公斤橡胶，是可以放在同一本账上算的。',
        en: 'That time, the soldiers came after all.\n\nThey counted the rubber, and it was not enough. Then they did the thing I will never forget my whole life.\n\nI will not tell that scene in detail. Among those whose hands were cut off were grown people, and children too. Some were shot dead on the spot; others did not die on the spot, but lived on with a body that had only one hand left, and that wound stayed with them their whole lives.\n\n(What I tell is not rumor. In 1904 an outsider took a photograph: a father, sitting before his own house, staring at the small severed hand and small severed foot of his murdered child on the ground. That photograph was later seen by very, very many people.)\n\nWhy the hand? Only later did I hear the reason, absurd and cold-blooded: those soldiers drew bullets, and their officers ordered them to bring back proof that no bullet was wasted, so they cut off the hands of the dead to account for them. Slowly, a hand became an entry in a ledger: one for a missing batch of rubber.\n\nDo you understand it now? In that system, a person\'s hand and a kilogram of rubber could be set down on the same ledger and reckoned together.',
      },
      deliverGoal: 'N5 story (documented restraint, dignity) — 军队来点数不够 + 不细讲场面 (被砍手有大人有孩子/有当场被打死有带一只手活下来/伤口跟一辈子) + anti-fab 括号短句 (1904 照片/父亲盯着被杀害孩子被砍下的手和脚/后来很多人看见) + 砍手原因 (子弹证据→手抵账) + 「一个人的手跟一公斤橡胶在同一本账上算」',
