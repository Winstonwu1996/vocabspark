...
textbookAnchor:
  ...
  page: 380
standardsAlignment:
  - "CA HSS-7.4 (West African Empires + trans-Saharan trade + Islam in Africa)"
  - "AP World History · Unit 1.5 (state building in West Africa)"
  - "AP World History · Unit 2.1 (trade networks across Sahara)"
authorNotes: |
  English-language sister file to mali-empire-1235.md (Chinese kernel).
  Same 16 sections, same vivid-history density.
  Writing constraints: ① anchored to HM Ch.13 L2 p.380 (does not replace);
  ② AP/SAT-level rigor; ③ confronts directly that "Africa is not just a colonial
  object" — 14th-century Timbuktu was a world knowledge center;
  ④ Sundiata epic + Mansa Musa pilgrimage + Ibn Battuta travelogue all real
  primary materials; ⑤ contemporary Europe + China comparisons — 14th-century
  African empire ran parallel to European Crusades + Yuan/Ming China;
  ⑥ readable for 7th graders + vivid storytelling density + modern relevance
  (Black Lives Matter history reckoning / 21st-century African reclaim /
  Ghana + Mali + Senegal modern nations referencing Mali Empire in identity).
---

# The Mali Empire · 1235-1610

> **Lock status**: narrative kernel v0 — pending Winston review
>
> **HSS Standard**: HSS-7.4 (West African Empires + trans-Saharan trade + Islamic spread)
> **Textbook anchor**: Houghton Mifflin *Medieval & Early Modern Times* Ch.13 West African Empires
>
...
> - **Mali Empire was founded in 1235 by Sundiata**
> - **Capital Niani** (in modern southern Mali)
> - **Gold and salt trade made Mali wealthy**
> - **Mansa Musa's 1324 pilgrimage was the most lavish in history**
...
>   Western academia **didn't take it seriously until the 1960s** —
>   **Studying history** can't only use written sources — must **respect oral history** as equally valid
> - **Ibn Battuta traveled in Mali for 8 months in 1352-1353** — he was **the greatest traveler of the 14th century** —
>   **He covered more ground and wrote about more countries than Marco Polo** —
>   **His *Rihla* (Travels) is the first-hand source on 14th-century Mali** — but textbooks barely cite it
> - **Mali Empire collapsed in 1610** — but **its legacy**:
>   **Senegal / Mali / Guinea / Burkina Faso** — four modern African nations directly trace **names + flags** to Mali Empire —
>   **especially in 1960 when Mali gained independence** — they **chose the name "Mali"** as a deliberate tribute to the Empire —
>   **History is not the past — it's a living inheritance shaping modern national identity**
> - **Contemporary China**: **Yuan Dynasty + early Ming** —
>   **No direct contact with Mali** — **but** in 1336 Yuan China and Mali were indirectly linked via **Egypt + the Silk Road** —
>   **Yuan capital Dadu (Beijing) received Mali gold** — through **Mamluk middlemen**
> - **Contemporary Europe**: **Hundred Years' War + Black Death + Renaissance dawn** —
>   **Europe had almost no direct contact with Mali** — but **1320s Mali gold reached Cairo + Cairo traded with Italy** —
>   **Mali gold indirectly funded the early Renaissance**
>
> **Open your textbook to p.380 and read together** — this lesson uses **Ming Zheng He + Yuan + European Crusades same period** as comparison
> (Africa in the 14th century is not "backwards" — it's a high civilization parallel to Europe + China).

---

## 1. The One-Line Hook

**Early 1324 — on the streets of Cairo** —
**A 44-year-old African emperor walked past the Mamluk Sultan's palace** —
**Wearing **gold-trimmed silk and a golden crown** —
**His name was Mansa Musa — Emperor of the Mali Empire** —
...
**including** Portugal sending ships down the African coast in the 1430s** — **eventually triggering the Age of Exploration**.

---

## 2. The Stage: West Africa in the 1300s

### Geography (L0)

**Mali Empire in the 1300s covered what is today **8 modern African nations**:**
- **Mali**
- **Senegal**
- **Gambia**
- **Guinea-Bissau**
...
**Total area: 1,800,000 km²** — five times the size of **England + France combined** at the time —
**seven times the size of England + Scotland + Wales combined**.

**Three core geographic zones:**

**1. North — edge of the Sahara Desert**
- **Salt mines** (Taghaza, Taoudenni) — **one of the world's largest salt sources**
- **Desert trade hubs** (Taghaza, Walata, Timbuktu)
- **Climate**: extremely dry + extremely hot — caravans **moved by camel**

**2. Central — Niger River valley**
- **Niger River** (4,180 km long) — **lifeline of Mali Empire**
- **Capital Niani** (on a Niger tributary)
- **Timbuktu** (on the Niger) — **northern trade terminal**
- **Djenné** (mosque city) — **handicraft + commerce center**

**3. South — Gold Forest (Bambuk + Bure)**
- **Bambuk + Bure goldfields** — **one of the world's largest gold sources**
- **Climate**: forest → savanna — **agricultural foundation**

— These three zones formed **Mali Empire's economic engine**:
- **Southern gold → central Niger River transport → northern Sahara trade**
- **Northern salt → moves south to gold zones for exchange**
- **Salt and gold traded 1:1 by weight** — **this "gold = salt" relationship** shaped a thousand years of West African trade
...
**This parallels the same Little Ice Age impact on Reformation-era Europe (1517)**:
**Climate change** has **deep structural impact** on **any political system**.

### Society (L2)

**Mali Empire's social structure had 5 layers:**

**1. Mansa (Emperor) + Royal family**
- **Mansa = "Emperor"** — this is the **Manding word** — not Arabic
- **The Mansa held both worldly and religious authority** — but **unlike European or Chinese** systems —
- **The Mansa accepted Islam** — but **also retained traditional African religious elements** — this was distinctively Mali

**2. Nobility + Army**
- **The Mansa commanded the army directly** — but managed through **regional governors** indirectly
- **Army**: **100,000+ cavalry + several hundred thousand infantry** — one of the largest armies in the 14th-century world
- **Weapons**: **iron spears + long swords + bows + some imported steel armor**

**3. Marabout (Islamic scholars) + Educated class**
- **Marabout = Islamic religious scholar** — **this class was uniquely powerful in Mali**
- **Marabout at Sankoré University** were **among the most respected scholars in the entire Islamic world**
- **They wrote laws + interpreted Quran + taught** — many Mali government decisions relied on their advice

**4. Merchants + Artisans + Farmers**
- **Merchants**: trans-Saharan trade caravans — many **Berber + Arab middlemen**
- **Artisans**: weavers + blacksmiths + potters + woodcarvers — **Djenné was the handicraft center**
- **Farmers**: **80% of population** — grew **sorghum / millet / rice / cotton**
...
### Institutions (L3) — Several Key Pieces

**1. Manding Law:**
- **Traditional Manding law fused with Islamic law (Sharia)**
- **Sundiata's 1235 Kurukan Fuga charter** — **one of humanity's earliest human rights charters**

**2. Trans-Saharan trade routes:**
- **Caravans (caravan)** — each had **1,000-2,000 camels**
- **From Sahara north (Sijilmasa, Morocco) to Mali north (Walata, Timbuktu)**
- **40-90 days** — crossing **1,500-2,500 km of desert**
- **Goods**: salt ↔ gold + enslaved people + ivory + ebony + dates

**3. Gold monopoly:**
- **Mali government policy**: **All gold nuggets belonged to the Mansa** — **gold dust** could be kept by ordinary people**
- **This monopoly gave Mali government **several tons of gold income per year**** — **one of the wealthiest governments in the world**

**4. Islam + traditional religion fusion:**
- **Mali emperors from the 1240s accepted Islam** — but **the common people** retained **traditional religion** — **polytheistic + ancestor worship**
- **Mansa Musa's pilgrimage tightened Mali-Arab world ties** — but **ordinary people** still practiced **traditional religion**
- **This dual track** made Mali culture **more complex than purely Islamic states**

### Events (L4)

**Mali Empire's 375-year complete timeline:**

```
1100s         Mande tribal confederation rises along upper Niger
1235          Sundiata Keita defeats Soumaoro Kanté at Battle of Kirina — Mali Empire founded
1235          Kurukan Fuga charter promulgated
1255          Sundiata dies — son Mansa Wali succeeds
1280-1300     Mali expands — conquers Wagadou + parts of Songhai region
1312          Mansa Musa ascends at age 32
1324-1325     Mansa Musa pilgrimage — Cairo inflation event
1327          Sankoré Mosque + University rebuilt (financed by Mansa Musa)
late 1330s    Mansa Musa dies — successor Mansa Maghan
1352-1353     Ibn Battuta travels in Mali for 8 months — writes Rihla
1370s         Mali Empire begins decline — internal succession conflicts
1430s         Songhai Empire breaks away from Mali
1468          Sonni Ali captures Timbuktu — Mali loses the north
1492-1591     Mali shrinks to core region — Songhai takes over
1591          Moroccan Sa'di dynasty captures Timbuktu — West African gold trade permanently restructured
1600s         Mali Empire nominally exists — but only as a regional chieftaincy
1610s         Mali Empire fully disappears
```

---

## 3. The Main Characters (Inside Mali + External Observers)

### The Mali Royal Faction

#### Sundiata Keita (c. 1217-1255) — Founder of Mali Empire

##### Origins: The Cursed Paralyzed Prince

**Born around 1217 near Niani in modern southern Mali** —
**His father, Naré Maghan, was king of the Mande tribes** —
**His mother, Sogolon Kédjou, was a hunchbacked, ugly woman** — but she had **enormous spiritual power** —

**At Sundiata's birth**, **he was Naré Maghan's second son** (his older brother Dankaran Touman was the queen's son) —
**Naré Maghan, guided by a marabout's prophecy, said**: "**The second son will become the greatest African emperor**" —
**Naré Maghan chose Sundiata as heir** — which **enraged the queen**.

**But**: **after Sundiata's birth he was paralyzed** — **he couldn't walk by age 7** —
**He used his arms to drag himself around** —
**His mother Sogolon was **mocked by the village** —** they **laughed that she had given birth to a "crippled heir"** —

##### The Moment at Age 7 — From Paralyzed to Rising

**At age 7 Sundiata heard villagers mocking his mother** —
**He was **furious** — he wanted to **bring his mother a baobab leaf** (because in the village **only royalty could pluck the large baobab leaves**) —
**He **crawled to the tree** — **grabbed the trunk** —
**He **stood up for the first time** —
**Then he **uprooted the entire baobab tree** — **carried it on his shoulders** —
**Walked home and gave it to his mother** —

**The villagers were **stunned** — **this is one of the most famous scenes in the Sundiata Epic** —
**This "from paralyzed to powerful"** story is at the heart of **Mali national identity** —
**Today in 21st-century Mali, schoolchildren still learn this story** —
**It represents**: **true power comes from adversity** —
**Anyone who is mocked or oppressed** — **can rise + change destiny**.

##### Seven Years of Exile (1224-1234)

**After Sundiata stood up** — **the queen sent assassins** —
**Sogolon took Sundiata + his younger brother Manding Bory** **and fled** —
**They were exiled for 7 years** — **passing through several city-states** — **learning + martial arts training + political diplomacy** —
**This **"exile + learning + return"** pattern is the **classic structure of hero epics**:
- **Moses**: Egypt → Midian → Exodus
- **Odysseus**: Trojan War → exile → return to Ithaca
- **King Arthur**: leaves court → finds Excalibur → returns
- **Sundiata**: Niani → 7 years exile → returns

— **The Sundiata Epic is **the African version of the hero's return journey****.

##### 1235 — The Battle of Kirina

**In the 1230s — King Soumaoro Kanté of Sosso conquered Mali's homeland** —
**Soumaoro was a **brutal ruler** — **he killed several of Sundiata's brothers** — **he boasted**: "**I am king of nine kingdoms**" —
**He wore **a cape of human skin** — **drums of human bone** — **he was believed to wield **black magic**** —

**In 1234 — Mande tribes sent envoys to Sundiata in exile** —
**They said**: "**Soumaoro has brought us endless suffering — only you can save us**" —
**Sundiata returned to the Mande homeland** — **gathered armies** —
**At the Plain of Kirina in 1235 — Sundiata vs. Soumaoro showdown** —

**Before battle Sundiata did **3 things**:**
1. **Found a marabout** — **prepared spiritually**
2. **Took a **white rooster** — **sacrificed it**
3. **Dipped arrowhead in white rooster's blood**

**Because the marabout said**: "**Soumaoro can only die if struck by an arrow dipped in white rooster's blood**" —

**The battle began** — **Soumaoro used magic** — **his arrows missed Sundiata** —
**Sundiata fired the **white-rooster-blood arrow** at Soumaoro's shoulder** —
**Soumaoro **immediately lost his magic** — **he fled into a cave** — **disappeared** —

**This is the climax of the Sundiata Epic** — **the founding moment of Mali Empire**.

##### 1235 — The Kurukan Fuga Charter

**After victory at Kirina — Sundiata called the heads of all Mande tribes** —
**At Kurukan Fuga (a plain) they held a **grand assembly**** —
...
3. **Child protection** — children **cannot** be **abused or abandoned**
4. **Environmental protection** — **protect** trees + water + animals
5. **Ethnic peace** — different tribes **do not invade each other**
6. **Humane treatment of war captives** — captives **cannot** be **abused or killed**
7. **The emperor is bound by law** — the emperor **cannot** kill arbitrarily

— Compared to England's 1215 Magna Carta:
- **Magna Carta 1215 — only protected nobles — did not protect commoners**
- **Kurukan Fuga 1235 — directly protected **everyone****
- **Magna Carta concerned king vs. nobles**
...
**Sundiata died in 1255** — **cause uncertain** —
**The Sundiata Epic says**: he was **on a boat on the Niger River** — **the boat capsized** — **he drowned** —
**Scholars suspect this is poetic** — likely **heart failure or natural causes** —

**He was buried in Niani** — **for the next 700 years his tomb was repeatedly maintained and rebuilt** —
**Today in the 21st century the Mali government still funds restoration of Sundiata's tomb** —
**He **as Mali's national hero** has been remembered continuously**.

> ⚠️ **Teaching point**: The Sundiata Epic is **one of humanity's greatest oral epics** —
> **Until the 1960s** it **was systematically collected and academically respected** —
> **Textbooks barely cover it** — leaving kids with the impression "Africa has no great epics" — **completely false**.
>
> **Studying history** can't only use **written sources** — must **respect oral history equally** —
> **The Sundiata Epic** has been transmitted longer + with greater oral consistency than the Iliad or Odyssey —
> **Today's Mali jeli (oral griot singers) still sing the Sundiata Epic** — this is **living history**.

---

#### Mansa Musa (c. 1280-1337) — The "Golden Pilgrimage" Emperor

##### Origins: A Sundiata Descendant

**Born around 1280 in Mali** —
**His **great-great-grandfather** was **Sundiata's brother Manding Bory** —
**So Mansa Musa was a Sundiata dynasty heir** —

**His full name: Mansa Musa I Keita** —
- **Mansa = Emperor** (Manding language)
- **Musa = Moses** (Arabic Mūsā)
- **Keita = family name** — the Sundiata-descendant surname

**He grew up receiving:**
- **Traditional Manding education** — oral history + martial arts + hunting
- **Islamic education** — **Quran + Arabic + Sharia law**
- **Political training** — he witnessed the Mali imperial court from childhood
...
**Mansa Musa reigned 25 years — what he did:**

**1. Territorial expansion:**
- **West to the Atlantic** (modern Senegal)
- **North to Walata + Timbuktu** — captured **the northern trade hub**
...
- **Tax + military + judicial** — centralized through **governors**
- **Resembles Chinese imperial system** — but **retains tribal traditions**

**3. Promoting Islam + education:**
- **Mansa Musa was personally devout Muslim**
- **He funded **mosques + schools + Sankoré University**
- **He invited Arab scholars to Mali** — and sent **Mali scholars to Arabia** — bidirectional exchange

##### 1324-1325 — Pilgrimage to Mecca

**This is the most famous event of Mansa Musa's life** —
**Early 1324** — he **44 years old — decided to make Hajj to Mecca** —
...
**Total value: about **18 tons of gold**** — **today's value: $400 million to $1 billion** —

##### Route — From Niani to Mecca

**8,000+ km** — round trip **18 months** —
**Cities he passed through:**
- **Niani** (Mali capital) →
- **Walata + Timbuktu** (northern Mali) →
- **Taghaza salt mines** →
- **Sahara Desert 70-day camel journey** →
- **Sijilmasa** (southern Morocco) →
- **Fez** (Morocco capital) →
- **Tlemcen + Tunis** (North Africa) →
- **Cairo** (Egypt — 3-month stay) →
- **Sinai Desert** →
- **Medina + Mecca** (pilgrimage) →
- **Return**

##### July-September 1324 — Three Months in Cairo

**In July 1324 Mansa Musa arrived in Cairo** —
**He stayed in Cairo for **3 months** —
**What he did:**
- **Every Friday gave gold coins to the poor**
- **Sent gifts to Mamluk Sultan al-Nasir Muhammad** — **hundreds of gold coins**
...
**Mansa Musa met Mamluk Sultan al-Nasir Muhammad** —
**Mamluk etiquette**: **foreign guests must kiss the sultan's foot + prostrate** —
**Mansa Musa **refused** —
**He said**: "**As Emperor of Mali — I bow only to God** — **I do not kneel to any man**" —

**The Mamluk Sultan was **enraged** — but **Mansa Musa's wealth + retinue** prevented him from **forcing** —
**Eventually they compromised** — **Mansa Musa used **Islamic ritual prostration** (toward Mecca, not toward the sultan) —
**Preserved **his own dignity** — **and demonstrated **fidelity to true faith**** —

— **This etiquette dispute** prompted Arab scholars to **write detailed accounts** —
**They were **astonished**: **An African emperor** — **dared** to stand firm against the Mamluk Sultan, the Islamic world's strongest authority of the time** —
**This **assertion of subjectivity** made the Arab world **rethink Africa** —
**Mali was not a "tribe"** — it was a **real empire**.

##### Mecca + Medina — The Pilgrimage

**Mansa Musa reached Mecca + Medina in November-December 1324** —
**He completed **the 5 core rites of Hajj**:**
1. **Tawaf** (circling the Kaaba 7 times)
2. **Sa'i** (running between Safa and Marwa hills)
3. **Wuquf** (a day of prayer at Mount Arafat)
4. **Ramy** (throwing stones at 3 pillars symbolizing the Devil)
5. **Idiyya** (sacrifice)

**He **also left massive gold gifts** for Mecca + Medina —
**What he brought back to Mali was **not wealth** — it was **spiritual fulfillment**** —

**He **also brought back**:**
- **Several Arab scholars** — later teaching in Mali
- **Architect Abu Ishaq al-Sahili** (from Andalusia, Spain) —
  **He designed for Mali the **Djinguereber Mosque (Timbuktu Grand Mosque) + Sankoré University**** —
  **This **Andalusian style + West African tradition** fusion is the core of 14th-century Mali architecture

##### 1325 — Return to Mali

**In 1325 Mansa Musa returned to Mali** — **he **entered Timbuktu** —
**He **officially designated Timbuktu as the empire's second capital** —
**He **funded the expansion of Sankoré University** —
**He **invited Muslim scholars from across the world to Mali** —

**For the next 12 years until his death in 1337 — he ruled Mali** —
**He **didn't pilgrimage again** — but **his late years focused on**:**
- **Education investment** (schools + universities + libraries)
- **Architecture** (mosques + palaces)
- **Legal reform** (fusing Sharia + Manding traditional law)

##### 1337 — Dies at 57

**Mansa Musa's **cause of death uncertain** — likely **natural causes** —
**He **was buried in Niani** —
**His **legacy**:**
- **Mali Empire at peak** — **stronger than before or after**
- **Timbuktu became the knowledge center** for **the next 250 years**
...
### The Scholar + Traveler Faction

#### Ibn Battuta (1304-1369) — The Greatest Traveler of the 14th Century

##### Origins: Tangier Legal Scholar Family

**Born in 1304 in Tangier** (northern Morocco, near the Strait of Gibraltar) —
**His father was a **Maliki legal scholar**** —
**Ibn Battuta in 1325 at age 21 made Hajj to Mecca** — but **he didn't return home** —
**For the next 30 years he **traveled almost without stopping**:**
- **1325-1326**: **Morocco → North Africa → Egypt → Holy Land → Mecca**
- **1326-1330**: **Iraq + Persia + Persian Gulf + Arabia**
- **1330-1332**: **East Africa (Mogadishu + Mombasa + Kilwa)**
- **1332-1346**: **Anatolia + Central Asia + Afghanistan + India** (served 8 years as judge in Delhi Sultanate)
- **1346-1349**: **China (including Quanzhou + Hangzhou + Dadu (Beijing))** — **this trip is academically debated** — some scholars think he didn't actually go to China — but his accounts are detailed
- **1349-1351**: **back to Morocco** — encountered Black Death — most family members died
...
**Ibn Battuta in 1352 at 48 — after pilgrimage to Mecca, he traveled south from North Africa to Mali** —
**He **crossed 8,000 km of desert** — **a 90-day camel caravan** —
**He **stayed in Mali for 8 months** — he **was received in court by Mansa Sulayman** (Mansa Musa's nephew, who had been on the throne for 11 years) —

**He wrote a **detailed description of Mali**** — **this is **a primary source on 14th-century Mali**:**

**He recorded:**

> "**Mali is **safe** — **safer than any country I have visited** —
> **Robbery + violence are **almost nonexistent** — **the people **truly believe in Islam** —
>
> **Mansa Sulayman received me in his court formally** —
> **Court etiquette was **strict** — but **simpler than the Arab courts** —
>
> **Three things stand out about the Mali people**:
> **First — strict observance of Friday prayer** — everyone goes to mosque
> **Second — Quran education is universal** — **children who don't memorize Quran get caned**
> **Third — justice** — **the Mansa's court** judges **with rules** — **noble + commoner are treated equally**
>
> **But Mali also has 3 customs that surprised me**:
> **First — women do not wear veils** — completely different from Arab lands
> **Second — some traditional religious customs persist** — like **wearing animal skull masks in performances**
> **Third — food is strange** — they **eat yam (tuber) + sorghum porridge** — not **wheat** —
>
> **Overall**: **Mali is **a true Islamic country** — **but retains African traditions** — **this dual track impresses me**."

##### Five Layers of Meaning in This Account

**Layer 1: Mali was safe + had rule of law**

**Ibn Battuta compared Mali to other countries he had visited** — **he said Mali was safer than any other country** —
**This **completely contradicts Eurocentric narratives** —
**14th-century Europe's **fabricated "African savagery" image** is **completely false** —
**Mali was one of the most orderly places in the 14th-century world**.

**Layer 2: Women did **not** wear veils**

**Ibn Battuta as a strict Maliki legal scholar — was **surprised** by women not wearing veils** —
**But he **didn't directly condemn** — he **recorded** —
**This reflects Mali Islam's **uniqueness**: **accepting core doctrine + retaining African tradition of female autonomy** —
**Today in 21st-century Mali — women have more freedom than in some Arab countries** —
**This **14th-century tradition is partly continuing today** — **this **deep cultural continuity is striking**.

**Layer 3: Universal Quran education**

**Ibn Battuta described how **strict** Mali's Quran education for children was** — this shows 14th-century Mali's education level —
**Higher than common European rural education at the time** —
**14th-century Europe had 5-10% literacy — Mali Empire's Islamic core regions had no exact figure but **literacy should have been higher**** —
**Saying "Africa was illiterate" inverts 14th-century reality** — **14th-century Mali was more literate than rural England**.

**Layer 4: His criticism**

**Ibn Battuta did **not only praise** — **he also criticized**:**
- **Women not wearing veils** — he **felt** violated Islam
- **Traditional religious customs** — he **felt** were paganism
- **Food** — he **didn't like yam + sorghum**

**This **mixture of criticism + praise** makes his record **credible** — **he was not writing a praise essay** — **he was a real observer** —
**"Critical + appreciative" mix** — this is the hallmark of **a serious traveler**.

**Layer 5: Mali's dual-track culture**

**He summarized Mali as**: "**A true Islamic country** — but **retaining African traditions**" —
**This is the **core of Mali culture** —
**Today Mali in the 21st century **still maintains this dual track**:**
- **90% Muslim** — but **retain ancestor worship + tribal rituals + traditional medicine**
- **Government uses Sharia law** — **everyday life uses **Manding customary law**

**Mali is the most successful fusion of Islam + African tradition** — **continuous for 700 years**.

##### Ibn Battuta Dies in 1369

**He died at 65 in Morocco** —
**He was buried in Tangier** —
**He **left behind his ***Rihla* (Travels)** —
**This book**:**
- **120,000 words in Arabic**
...
#### The Marabout (Scholars) of Sankoré University
...
- **Looted Sankoré University library**
- **Arrested major scholars** — **50+ marabout were marched to Marrakech, Morocco** — some **died on the desert journey**
- **Timbuktu's academic life **was wiped out almost overnight**

**For the next 30 years — Timbuktu's scholars **fled**:**
- **Some went to **Egypt's Al-Azhar**
- **Some went to **Mecca / Medina**
- **Some **kept manuscripts buried in the desert** — **hidden for 400 years**

##### 21st Century — The Resurrection of Timbuktu Manuscripts

**From the 1990s — scholars began **excavating Timbuktu manuscripts** —
**Manuscripts buried in the desert **were well-preserved** (dry climate) —
**By 2010 — discovery: **700,000 documents** —
**Research + digitization in progress** —

**2012 — Islamist extremist groups Ansar Dine + AQIM occupied Timbuktu** —
**They **burned a portion of manuscripts** — but **Timbuktu residents **risked their lives**** to **rescue** — **hiding millions of manuscripts in Bamako (Mali capital)** —
**This is the 21st-century "Dunhuang moment" of Mali** — civilians **risked their lives to protect cultural heritage** —

**2013 — French troops retook Timbuktu** — but **manuscripts were never fully restored** —
**Today Timbuktu manuscripts**:**
- **30% digitized**
- **5% translated**
- **<10% academically studied**
- **The next 50 years — Timbuktu manuscripts will **rewrite 14th-16th century African intellectual history**

> ⚠️ **Teaching point**: **14th-century Timbuktu was **one of the world's knowledge centers**** —
> **At the same level as contemporary Oxford / Bologna / Cairo / Baghdad / Constantinople** —
> **Textbooks barely write about it** —
> **This is one of the **most severe Eurocentric biases**** —
> **Studying history** — must **recognize that the 14th century was NOT "European Renaissance + everywhere else backwards"** —
> **It was **multiple world knowledge centers** — **Timbuktu was one of them**.

---

### Common-People Perspective (for cosplay use)

#### Timbuktu Merchant Yusuf, 1352

**Yusuf — 35 years old — a trans-Saharan merchant from Timbuktu** —
**His father was a Berber desert guide — his mother was a Mali Songhai woman** — **he himself spoke 3 languages**: **Manding + Arabic + Berber** —
**This **multilingual + cross-cultural** identity made him **one of the most valuable middlemen**.

**Yusuf in April 1352 led a **caravan of 200 camels**:**
- **From Timbuktu**
- **Carrying**: **500 kg of Bambuk gold + cotton cloth + 30 enslaved people + dates**
- **Destination**: **Sijilmasa, Morocco**
- **Estimated 90 days** — **return another 90 days** — total **6 months**

**Along the way he passed:**
- **Walata** (northern Mali) — **rest + resupply 1 week**
- **Taghaza salt mines** — **buy 1,000 kg of salt** (paid in half the gold)
- **70-day Sahara desert** — **most dangerous**:
  **sandstorms + no water + bandits**
  **2 camels died** — **1 enslaved person escaped**
- **Sijilmasa** — **arrived** — **late May 1352**

**He sold in Sijilmasa**: **gold + salt + cotton + enslaved people** —
**He bought**:**
- **Iron tools + steel swords + gunpowder** — for Mali weapons
- **European glass** — for Mali wealthy
- **Horses** — for Mali army
- **Pottery + spices**

**Late June he left Sijilmasa to return to Timbuktu** — **arrived late August** —
**He **earned the equivalent of 200 kg of gold** — **enough to **support his family for 5 years** —
**But he **also nearly died 3 times**:**
- **Sandstorm** **almost swallowed him and his camels**
- **Robbery** — **5 Tuareg bandits tried to attack** — **he drove them off with a gun**
- **Return journey** — **1 enslaved person killed his second-in-command** — **he killed that enslaved person** — this was **the only time he directly killed someone in his life**

**He was in Timbuktu in September 1352** — **he heard**:
**Mansa Sulayman had received Ibn Battuta** — **he **as a merchant had no chance to meet **the Mansa** —
**But in the mosque he **glimpsed Ibn Battuta + Mansa Sulayman's retinue from afar** —
**He **realized**: **He** was **a node in the 14th-century world economy** —

**Yusuf in his lifetime made **18 round trips** across the Sahara —
**By the 1380s he was 65 — died at home** —
**His grandson continued the family caravan business** — **for the next 200 years this family became **one of Timbuktu's largest merchants** —
**Until the 1591 Moroccan invasion ended the family's prosperity** —

> ⚠️ **Teaching point**: Yusuf's kind of **multilingual + cross-cultural merchant** — was **the real engine of the 14th-century world economy** —
> **Not Mansa Musa, one emperor** — but **tens of thousands of merchants like Yusuf made Mali Empire actually function** —
> **Studying history** can't only look at **emperors** — **must look at **ordinary merchants + artisans + scholars** —
> **The real economy + culture is what they make**.

---

#### Timbuktu Schoolgirl Aisha, 1413

**Aisha — 15 years old — daughter of a Timbuktu marabout family** —
**Mali's female education was more universal than contemporary Europe**:**
- **Mali middle-class + upper-class women learned Quran + Arabic + some mathematics**
- **Her father, Sheikh Abu Bakr, was a **Sankoré University marabout**
- **From age 5 she **learned Quran** — by 15 she could recite the entire 30 chapters of Quran**

**A day in Aisha's life:**
- **Wake at 5 AM, pray**
- **6-9 AM **learn Quran + Arabic with mother**
- **9-12 AM **household chores + weaving + cooking**
- **4-7 PM **self-study** — read **father's library**: law + history + poetry**
- **Evening prayer + sleep**

**At 15 she began wanting to **become a marabout** — but**: **Mali tradition didn't allow women to be formal marabout** —
**She **debated her father**: "**The Quran does not say women cannot teach**" —
**Father **was silent** — he **acknowledged** that the Quran did not forbid it — but **social custom** forbade —
**Aisha **persisted** —
**Her father eventually relented** — **he let Aisha **teach Quran to other girls in their home**
**At 18 she began **teaching Quran** — **for the next 50 years she taught 200+ girls** —
**She was not a formal marabout** — but she was **in practice a teacher** —

**Aisha died in 1463 at 65** —
**She left **no books** — **she left no name in history** —
**But she **shaped 5 generations of Timbuktu women's literacy** —
**Today Mali in the 21st century has **higher female literacy than most contemporary African countries** — **partly because of this 14th-16th century Aisha-type women's tradition**.

> ⚠️ **Teaching point**: Mali Empire was **not a fully equal society** — **women were not formal marabout** —
> **But Mali's female education was **more universal than contemporary Europe** —
> **This **partial equality** — is closer to truth than "completely unequal" or "completely equal" —
> **Studying history** — can't apply **21st-century standards** to the 14th century — but **also can't ignore **the female subjectivity of the time** —
> **Aisha's kind of "informal female teacher"** — was **the root of 5 generations of African female literacy tradition**.

---

## 4. The Story: Mali Empire 375 Years (1235-1610)

### 1100s — Origin Myths

**Mande tribal confederation rose along the upper Niger River** —
**Oral history says **the Mande originated in **Egypt** or **ancient Berber civilization** —
**Academic view**: **the Mande originated locally in West Africa** — **a tradition of thousands of years**.

### 1235 — Sundiata Founds Mali

**1235 Sundiata defeats Soumaoro Kanté at the **Battle of Kirina**** —
**Promulgates the **Kurukan Fuga charter** — Mali Empire is officially founded**.
...
**Mansa Musa crowned at 32** — **Mali Empire enters its peak**.
...
### 1325-1337 — Mansa Musa's Final 12 Years in Mali

**Mansa Musa funded **Sankoré University expansion** — **Timbuktu became the knowledge center** —
**He **brought back Andalusian architect Abu Ishaq al-Sahili** —
...
**After Mansa Musa's death in 1337 — successor emperors lacked his **talent**
**1370s onward** — **succession conflicts + administrative corruption** — **the empire begins to decline** —
**The biggest problem**: **no clear "primogeniture" rule** — every emperor's death — **multiple princes civil war** —

### 1430s — Songhai Empire Splits from Mali

**1430s — Songhai tribes** (eastern Mali) **declared independence** — **Songhai Empire founded** —
**For the next 60 years — Mali vs. Songhai mutual conflict** — **Mali weakened**.

### 1468 — Sonni Ali Captures Timbuktu

**Songhai Emperor Sonni Ali captured Timbuktu** — **Mali lost its **most important northern city** —
**Songhai took over Timbuktu + Sankoré University** —
**For the next 100 years Songhai was West Africa's strongest** — but **they inherited Mali traditions** — **they didn't completely break the culture**.

### 1492-1591 — Mali Shrinks to Core

**1492-1591** — Mali Empire **only retained its core** — **today's southern Mali** —
...
**But **firearms + cannon let Morocco win** —
**Songhai Empire **almost collapsed in one battle** —

**Battle of Tondibi** — **one of the most unequal battles in human history**:**
**4,000 firearms vs. 40,000 spears** — **completely one-sided** —
**This foreshadows **the next 300 years**: **as long as Europe / North Africa has gunpowder technology** — **traditional African armies cannot resist** —
**This is the **technological foundation for 19th-century European total colonization of Africa**.

### 1591-1610 — Timbuktu Scholar Diaspora + Mali Total Collapse

**Morocco occupied Timbuktu** — **Sankoré University was looted** — **scholars were marched to Marrakech or killed** —
**By the 1610s — Mali Empire **completely disappeared** —
**375 years of empire **ended**.

### 1700-1800 — Bambara Kingdom + Trans-Atlantic Slave Trade

**After Mali Empire's collapse — this region was **partly inherited by the Bambara Kingdom** —
**For the next 200 years** — **Mali region was **deeply impacted by trans-Atlantic slave trade**:**
- **Mali's coast** (modern Senegal + Gambia) became slave trade ports
- **Several million Mali people **were taken to the Americas as slaves** —
- **Especially during 1700-1800 — many enslaved people in the Caribbean + American South came from the Mali region**
- **Today in 21st-century US, African-American population — many trace ancestry to Mali region** — **detectable via DNA testing**

### 1893 — French Colonization

**1893 France captured Bamako** — **Mali region entered **French West African colonization** —
**For the next 67 years** — **French colonization** — **Mali resources + culture were stripped**.

### September 22, 1960 — Mali Independence + Choosing the Name "Mali"

**On September 22, 1960 Mali gained independence** — **the new nation **chose the name "Mali"** —
**This is the **"resurrection" of Mali Empire 600+ years later** —
**Deliberately commemorating **Mansa Musa + Sundiata + Timbuktu scholars** —
...
### 2012 — The Timbuktu Crisis

**2012 Islamist extremist groups occupied Timbuktu** — **burning some manuscripts** —
**Timbuktu residents **risked their lives to rescue** — **hiding millions of manuscripts in Bamako** —
**2013 French troops retook Timbuktu** — **manuscripts were partly saved** —
**This is one of the **greatest cultural-protection events of the 21st century** — but **textbooks don't write about it** —
