...
export var getHistoryAutoRecommend = function() {
  var all = loadAll();
  if (!all || all.historyAutoRecommend === undefined || all.historyAutoRecommend === null) return true;
  return all.historyAutoRecommend !== false;
};

export var setHistoryAutoRecommend = function(enabled) {
  saveAll({ historyAutoRecommend: !!enabled });
};
